...
import Kt, { app as ft, BrowserWindow as vc, Notification as fp, ipcMain as qe, dialog as fo } from "electron";
...
const Np = Pe.fromPromise, { makeDir: Fp, makeDirSync: aa } = ds, sa = Np(Fp);
var st = {
  mkdirs: sa,
  mkdirsSync: aa,
  // alias
...
const Le = ke, Xr = oe, qp = st.mkdirs, Xp = er.pathExists, Wp = Pc.utimesMillis, Wr = br;
function Vp(e, t, r, n) {
...
function ih(e, t, r, n, i, a) {
  ...
  Wr.checkPaths(s, o, "copy", i, (l, d) => {
    if (l) return a(l);
    const { destStat: c } = d;
    Yp(c, s, o, i, (f) => f ? a(f) : Uc(e, r, n, i, a));
  });
}
...
var oh = Vp;
const Se = ke, Vr = oe, lh = st.mkdirsSync, ch = Pc.utimesMillisSync, Yr = br;
function uh(e, t, r) {
...
var Ch = gs;
gs.sync = Hc;
const li = ke, Rh = Pe.fromCallback, qc = Ch;
function Oh(e, t) {
...
const Ph = Pe.fromPromise, Xc = Zt, Wc = oe, Vc = st, Yc = Si, _o = Ph(async function(t) {
  let r;
  try {
...
const Nh = Pe.fromCallback, Kc = oe, Tt = ke, Jc = st;
function Fh(e, t) {
  function r() {
    Tt.writeFile(e, "", (n) => {
      if (n) return t(n);
...
const Uh = Pe.fromCallback, Qc = oe, vt = ke, Zc = st, Mh = er.pathExists, { areIdentical: eu } = br;
function Bh(e, t, r) {
  function n(i, a) {
    vt.link(i, a, (s) => {
      if (s) return r(s);
...
const _t = oe, zr = ke, Gh = er.pathExists;
function Hh(e, t, r) {
  if (_t.isAbsolute(e))
...
const Kh = Pe.fromCallback, ru = oe, Ye = Zt, nu = st, Jh = nu.mkdirs, Qh = nu.mkdirsSync, iu = Xh, Zh = iu.symlinkPaths, em = iu.symlinkPathsSync, au = Yh, tm = au.symlinkType, rm = au.symlinkTypeSync, nm = er.pathExists, { areIdentical: su } = br;
function im(e, t, r, n) {
...
const xm = Pe.fromCallback, Gr = ke, cu = oe, uu = st, wm = er.pathExists;
function Em(e, t, r, n) {
...
var Rm = Cm;
const Om = Pe.fromPromise, De = ym;
De.outputJson = Om(Sm);
De.outputJsonSync = Rm;
...
var Dm = De;
const Pm = ke, Ba = oe, km = ms.copy, fu = Si.remove, Nm = st.mkdirp, Fm = er.pathExists, Po = br;
function $m(e, t, r, n) {
...
var Mm = $m;
const du = ke, ja = oe, Bm = ms.copySync, pu = Si.removeSync, jm = st.mkdirpSync, No = br;
function zm(e, t, r) {
  r = r || {};
...
function hu() {
  ...
  $o = 1;
  function e(t) {
    n.debug = n, n.default = n, n.coerce = d, n.disable = o, n.enable = a, n.enabled = l, n.humanize = Qm(), n.destroy = c, Object.keys(t).forEach((f) => {
      n[f] = t[f];
...
` ? (u.line++, u.column = 0) : u.column++);
          ...
          case y.CLOSE_TAG:
            if (u.tagName)
              ...
              if ($(E))
                continue;
              Me(T, E) ? u.script ? (u.script += "</" + E, u.state = y.SCRIPT) : A(u, "Invalid tagname in closing tag.") : u.tagName = E;
            }
            continue;
...
var Iu = Xa, j0 = Ne, Cu = new j0("tag:yaml.org,2002:str", {
  kind: "scalar",
...
}), G0 = Ne, Ou = new G0("tag:yaml.org,2002:map", {
  kind: "mapping",
  construct: function(e) {
    return e !== null ? e : {};
  }
...
var zu = new xg("tag:yaml.org,2002:merge", {
  kind: "scalar",
  resolve: wg
}), Eg = Ne, bs = `ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789+/=
\r`;
function vg(e) {
  if (e === null) return !1;
...
var Gu = new Eg("tag:yaml.org,2002:binary", {
  ...
  predicate: bg,
  represent: _g
}), Sg = Ne, Ag = Object.prototype.hasOwnProperty, Ig = Object.prototype.toString;
function Cg(e) {
  if (e === null) return !0;
  var t = [], r, n, i, a, s, o = e;
...
var Hu = new Sg("tag:yaml.org,2002:omap", {
  ...
  resolve: Cg,
  construct: Rg
}), Og = Ne, Dg = Object.prototype.toString;
function Pg(e) {
  if (e === null) return !0;
  var t, r, n, i, a, s = e;
...
var qu = new Og("tag:yaml.org,2002:pairs", {
  ...
  resolve: Pg,
  construct: kg
}), Ng = Ne, Fg = Object.prototype.hasOwnProperty;
function $g(e) {
  if (e === null) return !0;
  var t, r = e;
  for (t in r)
...
function Zg(e, t) {
  ...
  for (e.kind = "scalar", e.result = ""; f !== 0; )
    if (f = e.input.charCodeAt(++e.position), f === 43 || f === 45)
      ga === i ? i = f === 43 ? Wo : Bg : L(e, "repeat of a chomping mode identifier");
    else if ((c = Xg(f)) >= 0)
  ...
  for (e.anchor !== null && (e.anchorMap[e.anchor] = f), _ = e.input.charCodeAt(e.position); _ !== 0; ) {
    if (!T && e.firstTabInLine !== -1 && (e.position = e.firstTabInLine, L(e, "tab characters must not be used in indentation")), n = e.input.charCodeAt(e.position + 1), a = e.line, (_ === 63 || _ === 58) && Ue(n))
      ...
      if (e.line === a) {
        ...
        if (_ === 58)
          _ = e.input.charCodeAt(++e.position), Ue(_) || L(e, "a whitespace character is expected after the key-value separator within a block mapping"), T && (dr(e, f, p, g, v, null, s, o, l), g = v = x = null), b = !0, T = !1, i = !1, g = e.tag, v = e.result;
        else if (b)
...
function ky(e, t, r, n, i, a, s, o) {
  var l, d = 0, c = null, f = !1, p = !1, g = n !== -1, v = -1, x = Dy(Br(e, 0)) && Py(Br(e, e.length - 1));
  if (t || s)
...
function dt(e, t, r, n, i, a, s) {
  ...
  if (c && (f = e.duplicates.indexOf(r), p = f !== -1), (e.tag !== null && e.tag !== "?" || p || e.indent !== 2 && t > 0) && (i = !1), p && e.usedDuplicates[f])
    ...
    if (c && p && !e.usedDuplicates[f] && (e.usedDuplicates[f] = !0), o === "[object Object]")
      n && Object.keys(e.dump).length !== 0 ? (My(e, t, e.dump, i), p && (e.dump = "&ref_" + f + e.dump)) : (Uy(e, t, e.dump), p && (e.dump = "&ref_" + f + " " + e.dump));
    else if (o === "[object Array]")
      n && e.dump.length !== 0 ? (e.noArrayIndent && !s && t > 0 ? al(e, t - 1, e.dump, i) : al(e, t, e.dump, i), p && (e.dump = "&ref_" + f + e.dump)) : (Ly(e, t, e.dump), p && (e.dump = "&ref_" + f + " " + e.dump));
...
var dx = fx;
const px = Fe, hx = (e, t) => new px(e, t).major;
var mx = hx;
const gx = Fe, yx = (e, t) => new gx(e, t).minor;
var xx = yx;
const wx = Fe, Ex = (e, t) => new wx(e, t).patch;
var vx = Ex;
const Tx = Ir, _x = (e, t) => {
  const r = Tx(e, t);
...
var bx = _x;
const dl = Fe, Sx = (e, t, r) => new dl(e, r).compare(new dl(t, r));
var Je = Sx;
const Ax = Je, Ix = (e, t, r) => Ax(t, e, r);
var Cx = Ix;
const Rx = Je, Ox = (e, t) => Rx(e, t, !0);
var Dx = Ox;
const pl = Fe, Px = (e, t, r) => {
...
var Tf = nw;
const iw = Fe, aw = Ir, { safeRe: zn, t: Gn } = mn, sw = (e, t) => {
  if (e instanceof iw)
    return e;
...
function Qe() {
  ...
  xa = t;
  const r = cw, n = new r(), i = Os, a = Fi(), s = ki, o = Fe, {
    safeRe: l,
    t: d,
...
var Tw = vw;
const Ea = Fe, _w = Qe(), gl = Ni, bw = (e, t) => {
  e = new _w(e, t);
  let r = new Ea("0.0.0");
...
var Cw = Iw;
const Rw = Fe, _f = Fi(), { ANY: Ow } = _f, Dw = Qe(), Pw = $i, yl = Ni, xl = Ps, kw = Ns, Nw = ks, Fw = (e, t, r, n) => {
  ...
  for (let d = 0; d < t.set.length; ++d) {
    ...
    let f = null, p = null;
    if (c.forEach((g) => {
      g.semver === Ow && (g = new _f(">=0.0.0")), f = f || g, p = p || g, i(g.semver, f.semver, n) ? f = g : s(g.semver, p.semver, n) && (p = g);
...
var Kw = Ww;
const Ta = mn, bl = Pi, Jw = Fe, Sl = wf, Qw = Ir, Zw = ax, eE = lx, tE = ux, rE = dx, nE = mx, iE = xx, aE = vx, sE = bx, oE = Je, lE = Cx, cE = Dx, uE = Ds, fE = Fx, dE = Ux, pE = Ni, hE = Ps, mE = Ef, gE = vf, yE = ks, xE = Ns, wE = Tf, EE = ow, vE = Fi(), TE = Qe(), _E = $i, bE = hw, SE = xw, AE = Tw, IE = Sw, CE = Cw, RE = Fs, OE = Uw, DE = jw, PE = Gw, kE = Xw, NE = Kw;
var bf = {
  parse: Qw,
  valid: Zw,
  clean: eE,
...
var yn = {}, Xe = {}, qE = "[object Symbol]", Af = /[\\^$.*+?()[\]{}|]/g, XE = RegExp(Af.source), WE = typeof Re == "object" && Re && Re.Object === Object && Re, VE = typeof self == "object" && self && self.Object === Object && self, YE = WE || VE || Function("return this")(), KE = Object.prototype, JE = KE.toString, Cl = YE.Symbol, Rl = Cl ? Cl.prototype : void 0, Ol = Rl ? Rl.toString : void 0;
function QE(e) {
  if (typeof e == "string")
    return e;
  if (ev(e))
...
const ct = xe, pr = bf, mv = _r, hr = Xe, Za = pe, Ca = /\/tag\/([^/]+)$/;
  ...
  async differentialDownloadInstaller(t, r, n, i, a) {
    try {
      ...
      const o = async (c) => {
        ...
        try {
          return JSON.parse((0, Zv.gunzipSync)(f).toString());
        } catch (p) {
...
const Lb = {
  ...
  async load() {
    return (await import("./MpegParser-CMX62cjg.js")).MpegParser;
  }
}, Ub = {
  parserType: "apev2",
  extensions: [".ape"],
  ...
  async load() {
    return (await import("./AsfParser-D-oj6xAd.js")).AsfParser;
  }
}, Bb = {
  parserType: "dsdiff",
  extensions: [".dff"],
  ...
  async load() {
    return (await import("./DsdiffParser-Lwqmf6Gs.js")).DsdiffParser;
  }
}, jb = {
  parserType: "aiff",
  ...
  async load() {
    return (await import("./AiffParser-D3g-Vi_c.js")).AIFFParser;
  }
}, zb = {
  parserType: "dsf",
  extensions: [".dsf"],
  mimeTypes: ["audio/dsf"],
  async load() {
    return (await import("./DsfParser-DM3e5xHl.js")).DsfParser;
  }
}, Gb = {
  parserType: "flac",
  extensions: [".flac"],
  ...
  async load() {
    return (await import("./FlacParser-BMuXWvNl.js").then((e) => e.d)).FlacParser;
  }
}, Hb = {
  parserType: "matroska",
  ...
  async load() {
    return (await import("./MatroskaParser-B5iwjn1J.js")).MatroskaParser;
  }
}, qb = {
  parserType: "mp4",
  ...
  async load() {
    return (await import("./MP4Parser-CkADFh6s.js")).MP4Parser;
  }
}, Xb = {
  parserType: "musepack",
  extensions: [".mpc"],
  ...
  async load() {
    return (await import("./MusepackParser-CtA3MwtO.js")).MusepackParser;
  }
}, Wb = {
  parserType: "ogg",
  ...
  async load() {
    return (await import("./OggParser-BjnevOhF.js")).OggParser;
  }
}, Vb = {
  parserType: "wavpack",
  extensions: [".wv", ".wvp"],
  ...
  async load() {
    return (await import("./WavPackParser-BITO0ea6.js")).WavPackParser;
  }
}, Yb = {
  parserType: "riff",
  ...
  async load() {
    return (await import("./WaveParser-CS2X5XQb.js")).WaveParser;
  }
...
const TS = ft.requestSingleInstanceLock();
TS ? ft.on("second-instance", () => {
  J && (J.isMinimized() && J.restore(), J.focus());
}) : ft.quit();
const id = $e.dirname(dp(import.meta.url));
process.env.APP_ROOT = $e.join(id, "..");
const ls = process.env.VITE_DEV_SERVER_URL, nA = $e.join(process.env.APP_ROOT, "dist-electron"), ad = $e.join(process.env.APP_ROOT, "dist");
process.env.VITE_PUBLIC = ls ? $e.join(process.env.APP_ROOT, "public") : ad;
let J;
function sd() {
  J = new vc({
    width: 1200,
  ...
  }), ls ? J.loadURL(ls) : J.loadFile($e.join(ad, "index.html"));
}
...
ft.whenReady().then(() => {
  sd(), qe.handle("dialog:openDirectory", async () => {
    ...
    try {
      ...
      return i.filter((s) => a.includes($e.extname(s).toLowerCase())).map((s) => $e.join(n, s));
    } catch (i) {
    ...
    const r = $e.join(process.env.APP_ROOT, "scripts/get-active-window.ps1");
    return await vS(r);
  });
  const e = po(import.meta.url)("yt-dlp-wrap").default, t = async () => {
    const r = process.platform === "win32" ? "yt-dlp.exe" : "yt-dlp", n = $e.join(ft.getPath("userData"), r);
    try {
      await ia.access(n);
    } catch {
...
`).map((o) => {
    ...
    try {
      ...
      if (a) {
        const o = $e.basename(a, $e.extname(a)), l = `https://lrclib.net/api/search?q=${encodeURIComponent(o)}`, d = await fetch(l);
        if (d.ok) {
