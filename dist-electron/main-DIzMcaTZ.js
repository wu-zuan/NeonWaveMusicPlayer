...
import Kt, { app as St, BrowserWindow as wc, ipcMain as Ve, dialog as cp } from "electron";
...
const Yh = Pe.fromCallback, eu = oe, Ye = Zt, tu = st, Kh = tu.mkdirs, Jh = tu.mkdirsSync, ru = qh, Qh = ru.symlinkPaths, Zh = ru.symlinkPathsSync, nu = Vh, em = nu.symlinkType, tm = nu.symlinkTypeSync, rm = er.pathExists, { areIdentical: iu } = br;
function nm(e, t, r, n) {
    ...
    function X(p, u) {
      if (p.opt.xmlns) {
        ...
        for (var re = 0, le = p.attribList.length; re < le; re++) {
          var we = p.attribList[re], _e = we[0], pt = we[1], de = O(_e, !0), Xe = de.prefix, Yi = de.local, Tn = Xe === "" ? "" : S.ns[Xe] || "", Rr = {
            name: _e,
            value: pt,
            prefix: Xe,
            local: Yi,
          ...
          ), Rr.uri = Xe), p.tag.attributes[_e] = Rr, B(p, "onattribute", Rr);
        }
    ...
    function j(p) {
      ...
      for (var re = p.tags.length; re-- > u; ) {
        ...
        p.opt.xmlns && le.ns !== pt.ns && Object.keys(le.ns).forEach(function(de) {
          var Xe = le.ns[de];
          B(p, "onclosenamespace", { prefix: de, uri: Xe });
        });
      }
...
}), Ht = Ke, qu = pn, Lg = N0, Ug = bs, Ct = Object.prototype.hasOwnProperty, di = 1, Xu = 2, Wu = 3, pi = 4, ma = 1, Mg = 2, qo = 3, Bg = /[\x00-\x08\x0B\x0C\x0E-\x1F\x7F-\x84\x86-\x9F\uFFFE\uFFFF]|[\uD800-\uDBFF](?![\uDC00-\uDFFF])|(?:[^\uD800-\uDBFF]|^)[\uDC00-\uDFFF]/, zg = /[\x85\u2028\u2029]/, jg = /[,\[\]\{\}]/, Vu = /^(?:!|!!|![a-z\-]+!)$/i, Yu = /^(?:!|[^,\[\]\{\}])(?:%[0-9a-f]{2}|[0-9a-z\-#;\/\?:@&=\+\$,_\.!~\*'\(\)\[\]])*$/i;
function Xo(e) {
...
Ts.loadAll = ix;
Ts.load = ax;
var tf = {}, Oi = Ke, hn = pn, sx = bs, rf = Object.prototype.toString, nf = Object.prototype.hasOwnProperty, Is = 65279, ox = 9, Qr = 10, lx = 13, cx = 32, ux = 33, fx = 34, Xa = 35, dx = 37, px = 38, hx = 39, mx = 42, af = 44, gx = 45, mi = 58, xx = 61, yx = 62, wx = 63, Ex = 64, sf = 91, of = 93, vx = 96, lf = 123, Tx = 124, cf = 125, Ie = {};
Ie[0] = "\\0";
Ie[7] = "\\a";
Ie[8] = "\\b";
Ie[9] = "\\t";
...
var Je = by;
const Sy = Je, Ay = (e, t, r) => Sy(t, e, r);
var Iy = Ay;
const Cy = Je, Ry = (e, t) => Cy(e, t, !0);
var Oy = Ry;
...
var Ly = $y;
const Uy = Je, My = (e, t, r) => Uy(e, t, r) > 0;
var Ni = My;
const By = Je, zy = (e, t, r) => By(e, t, r) < 0;
var Ds = zy;
const jy = Je, Gy = (e, t, r) => jy(e, t, r) === 0;
var yf = Gy;
const Hy = Je, qy = (e, t, r) => Hy(e, t, r) !== 0;
var wf = qy;
const Xy = Je, Wy = (e, t, r) => Xy(e, t, r) >= 0;
var Ps = Wy;
const Vy = Je, Yy = (e, t, r) => Vy(e, t, r) <= 0;
var ks = Yy;
...
function Fi() {
  ...
  ya = t;
  const r = Rs, { safeRe: n, t: i } = mn, a = Ef, s = ki, o = Fe, l = Qe();
  return ya;
}
...
var vw = Ew;
const wa = Fe, Tw = Qe(), hl = Ni, _w = (e, t) => {
  e = new Tw(e, t);
  let r = new wa("0.0.0");
...
var Iw = Aw;
const Cw = Fe, vf = Fi(), { ANY: Rw } = vf, Ow = Qe(), Dw = $i, ml = Ni, gl = Ds, Pw = ks, kw = Ps, Nw = (e, t, r, n) => {
...
var Bw = Mw;
const xl = Qe(), zw = (e, t, r) => (e = new xl(e, r), t = new xl(t, r), e.intersects(t, r));
var jw = zw;
const Gw = $i, Hw = Je;
var qw = (e, t, r) => {
  const n = [];
...
const yl = Qe(), Fs = Fi(), { ANY: Ea } = Fs, $r = $i, $s = Je, Xw = (e, t, r = {}) => {
  if (e === t)
    return !0;
...
var Yw = Xw;
const va = mn, Tl = Pi, Kw = Fe, _l = xf, Jw = Ir, Qw = iy, Zw = oy, eE = cy, tE = fy, rE = hy, nE = xy, iE = Ey, aE = _y, sE = Je, oE = Iy, lE = Oy, cE = Os, uE = Ny, fE = Ly, dE = Ni, pE = Ds, hE = yf, mE = wf, gE = Ps, xE = ks, yE = Ef, wE = sw, EE = Fi(), vE = Qe(), TE = $i, _E = pw, bE = xw, SE = vw, AE = bw, IE = Iw, CE = Ns, RE = Lw, OE = Bw, DE = jw, PE = qw, kE = Yw;
var Tf = {
  parse: Jw,
  valid: Qw,
  clean: Zw,
...
(function(e, t) {
  ...
  var od = Array.prototype, ld = Function.prototype, bn = Object.prototype, Ki = u["__core-js_shared__"], Xs = ld.toString, et = bn.hasOwnProperty, Ws = function() {
  ...
  function Bd(m, w) {
    var C = Rn(m), F = !C && tp(m), ne = !C && !F && ra(m), H = !C && !F && !ne && lo(m), ce = C || F || ne || H, me = ce ? Xe(m.length, String) : [], Ee = me.length;
    for (var ae in m)
  ...
  function jd(m, w, C, F, ne, H) {
    ...
    if (!(C & i)) {
      var je = Me && et.call(m, "__wrapped__"), Ge = We && et.call(w, "__wrapped__");
      if (je || Ge) {
  ...
  function ro(m, w, C, F, ne, H) {
    ...
    if (ae && H.get(w))
      return ae == w;
    var Me = -1, We = !0, be = C & a ? new An() : void 0;
    ...
    return H.delete(m), H.delete(w), We;
  }
...
var xn = {}, qe = {}, HE = "[object Symbol]", bf = /[\\^$.*+?()[\]{}|]/g, qE = RegExp(bf.source), XE = typeof Re == "object" && Re && Re.Object === Object && Re, WE = typeof self == "object" && self && self.Object === Object && self, VE = XE || WE || Function("return this")(), YE = Object.prototype, KE = YE.toString, Al = VE.Symbol, Il = Al ? Al.prototype : void 0, Cl = Il ? Il.toString : void 0;
function JE(e) {
  if (typeof e == "string")
    return e;
  if (ZE(e))
...
qe.newBaseUrl = iv;
qe.newUrlFromBase = Ja;
qe.getChannelFilename = av;
qe.blockmapFiles = sv;
const Sf = _r, nv = rv;
function iv(e) {
...
const ct = ye, pr = Tf, hv = _r, hr = qe, Qa = pe, Ia = /\/tag\/([^/]+)$/;
...
const ar = ye, xv = Te, yv = oe, Nl = _r, Fl = qe, wv = Ot, Ev = pe;
...
const Ce = ye, Xv = cn, Wv = Ti, Vv = vc, sr = Pt, Yv = Te, Da = Di, Mt = oe, Gt = Tf, Hl = gn, Kv = Li, ql = _f, Jv = xn, Pa = Ui, Qv = _c, Zv = qe, eT = ji, or = kt;
...
const tt = Ar("tokenizer:inflate"), Fa = 256 * 1024, __ = Bf(gr.DataDescriptor), Vn = Bf(gr.EndOfCentralDirectory);
class zs {
  constructor(t) {
  ...
  async unzip(t) {
    ...
    do {
      ...
      if (tt(`Reading data-descriptor at pos=${this.tokenizer.position}`), i.dataDescriptor && (await this.tokenizer.readToken(cc)).signature !== 134695760)
...
const $b = {
  ...
  async load() {
    return (await import("./MpegParser-2hdta449.js")).MpegParser;
  }
}, Lb = {
  parserType: "apev2",
  extensions: [".ape"],
  ...
  async load() {
    return (await import("./AsfParser-BGgBgOLX.js")).AsfParser;
  }
}, Mb = {
  parserType: "dsdiff",
  extensions: [".dff"],
  ...
  async load() {
    return (await import("./DsdiffParser-DWNAL3Vw.js")).DsdiffParser;
  }
}, Bb = {
  parserType: "aiff",
  ...
  async load() {
    return (await import("./AiffParser-KfkfgUhT.js")).AIFFParser;
  }
}, zb = {
  parserType: "dsf",
  extensions: [".dsf"],
  mimeTypes: ["audio/dsf"],
  async load() {
    return (await import("./DsfParser-DG4IcRZw.js")).DsfParser;
  }
}, jb = {
  parserType: "flac",
  extensions: [".flac"],
  ...
  async load() {
    return (await import("./FlacParser-D17LiB1x.js").then((e) => e.d)).FlacParser;
  }
}, Gb = {
  parserType: "matroska",
  ...
  async load() {
    return (await import("./MatroskaParser-Dxr-27cy.js")).MatroskaParser;
  }
}, Hb = {
  parserType: "mp4",
  ...
  async load() {
    return (await import("./MP4Parser-eOf7oscD.js")).MP4Parser;
  }
}, qb = {
  parserType: "musepack",
  extensions: [".mpc"],
  ...
  async load() {
    return (await import("./MusepackParser-BIaf9NNh.js")).MusepackParser;
  }
}, Xb = {
  parserType: "ogg",
  ...
  async load() {
    return (await import("./OggParser-oBEJyCbL.js")).OggParser;
  }
}, Wb = {
  parserType: "wavpack",
  extensions: [".wv", ".wvp"],
  ...
  async load() {
    return (await import("./WavPackParser-0CXZaE4J.js")).WavPackParser;
  }
}, Vb = {
  parserType: "riff",
  ...
  async load() {
    return (await import("./WaveParser-CsWMkhwH.js")).WaveParser;
  }
...
const rd = He.dirname(fp(import.meta.url));
process.env.APP_ROOT = He.join(rd, "..");
const os = process.env.VITE_DEV_SERVER_URL, rA = He.join(process.env.APP_ROOT, "dist-electron"), nd = He.join(process.env.APP_ROOT, "dist");
process.env.VITE_PUBLIC = os ? He.join(process.env.APP_ROOT, "public") : nd;
let J;
function id() {
  J = new wc({
    width: 1200,
    ...
    webPreferences: {
      preload: He.join(rd, "preload.mjs"),
      webSecurity: !1,
  ...
  }), os ? J.loadURL(os) : J.loadFile(He.join(nd, "index.html"));
}
...
St.whenReady().then(() => {
  ...
  }), Ve.handle("app:active-window", async () => {
    const e = He.join(process.env.APP_ROOT, "scripts/get-active-window.ps1");
    return await ES(e);
  }), Ve.handle("search:youtube", async (e, t) => {
    try {
  ...
  }), Ve.handle("search:artistImage", async (e, t) => {
    try {
  ...
  }), Ve.handle("search:lyrics", async (e, t, r, n) => {
    try {
      ...
      if (n) {
        const a = He.basename(n, He.extname(n)), s = `https://lrclib.net/api/search?q=${encodeURIComponent(a)}`, o = await fetch(s);
        if (o.ok) {
  ...
  }), Ve.handle("update:check", () => {
    at.autoUpdater.checkForUpdatesAndNotify();
  }), Ve.handle("update:install", () => {
    at.autoUpdater.quitAndInstall(!0, !0);
  }), Ve.handle("app:version", () => St.getVersion());
});
export {
  QS as A,
  Kf as B,
