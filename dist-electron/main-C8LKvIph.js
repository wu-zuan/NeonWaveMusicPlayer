...
var Xe = (e, t, r) => yp(e, typeof t != "symbol" ? t + "" : t, r);
import Jt, { app as We, BrowserWindow as Cc, Notification as wp, ipcMain as re, dialog as go } from "electron";
import { createRequire as jr } from "node:module";
import { fileURLToPath as xp } from "node:url";
import _e from "node:path";
import Fr, { open as Ep } from "node:fs/promises";
import Dt from "fs";
...
import { createAudioPlayer as Ap, joinVoiceChannel as Cp, createAudioResource as Fn, StreamType as la } from "@discordjs/voice";
import { PassThrough as Ip } from "node:stream";
...
var xt = vp, Pp = process.cwd, ai = null, Op = process.env.GRACEFUL_FS_PLATFORM || process.platform;
process.cwd = function() {
  return ai || (ai = Pp.call(process)), ai;
};
try {
  process.cwd();
} catch {
...
function kp(e) {
  xt.hasOwnProperty("O_SYMLINK") && process.version.match(/^v0\.6\.[0-2]|^v0\.5\./) && t(e), e.lutimes || r(e), e.chown = a(e.chown), e.fchown = a(e.fchown), e.lchown = a(e.lchown), e.chmod = n(e.chmod), e.fchmod = n(e.fchmod), e.lchmod = n(e.lchmod), e.chownSync = s(e.chownSync), e.fchownSync = s(e.fchownSync), e.lchownSync = s(e.lchownSync), e.chmodSync = i(e.chmodSync), e.fchmodSync = i(e.fchmodSync), e.lchmodSync = i(e.lchmodSync), e.stat = o(e.stat), e.fstat = o(e.fstat), e.lstat = o(e.lstat), e.statSync = l(e.statSync), e.fstatSync = l(e.fstatSync), e.lstatSync = l(e.lstatSync), e.chmod && !e.lchmod && (e.lchmod = function(c, u, p) {
    ...
    function u(p, m, x) {
      var w = Date.now(), T = 0;
      c(p, m, function _(b) {
        if (b && (b.code === "EACCES" || b.code === "EPERM" || b.code === "EBUSY") && Date.now() - w < 6e4) {
          setTimeout(function() {
            e.stat(m, function(P, F) {
              P && P.code === "ENOENT" ? c(p, m, _) : x(b);
            });
          }, T), T < 100 && (T += 10);
          return;
        }
    ...
    function u(p, m, x, w, T, _) {
      var b;
      if (_ && typeof _ == "function") {
        var P = 0;
        b = function(F, U, k) {
          if (F && F.code === "EAGAIN" && P < 10)
            return P++, c.call(e, p, m, x, w, T, b);
          _.apply(this, arguments);
        };
      }
      return c.call(e, p, m, x, w, T, b);
    }
    return Object.setPrototypeOf && Object.setPrototypeOf(u, c), u;
...
var ce = Dt, Mp = Dp, Bp = Np, jp = $p, $n = ps, be, ui;
typeof Symbol == "function" && typeof Symbol.for == "function" ? (be = Symbol.for("graceful-fs.queue"), ui = Symbol.for("graceful-fs.previous")) : (be = "___graceful-fs.queue", ui = "___graceful-fs.previous");
function Gp() {
}
function Dc(e, t) {
...
if (!ce[be]) {
  ...
  Dc(ce, zp), ce.close = function(e) {
    ...
    Vt(ce[be]), Ic.equal(ce[be].length, 0);
  });
}
De[be] || Dc(De, ce[be]);
var $e = hs(jp(ce));
...
function hs(e) {
  Mp(e), e.gracefulify = hs, e.createReadStream = U, e.createWriteStream = k;
  var t = e.readFile;
  e.readFile = r;
  function r(y, B, M) {
    return typeof B == "function" && (M = B, B = null), L(y, B, M);
    function L(X, R, S, D) {
      return t(X, R, function(A) {
        A && (A.code === "EMFILE" || A.code === "ENFILE") ? ir([L, [X, R, S], A, D || Date.now(), Date.now()]) : typeof S == "function" && S.apply(this, arguments);
      });
    }
  }
  var n = e.writeFile;
  e.writeFile = i;
  function i(y, B, M, L) {
    return typeof M == "function" && (L = M, M = null), X(y, B, M, L);
    function X(R, S, D, A, $) {
      return n(R, S, D, function(O) {
        O && (O.code === "EMFILE" || O.code === "ENFILE") ? ir([X, [R, S, D, A], O, $ || Date.now(), Date.now()]) : typeof A == "function" && A.apply(this, arguments);
      });
    }
  }
  var a = e.appendFile;
  ...
  o && (e.copyFile = l);
  function l(y, B, M, L) {
    return typeof M == "function" && (L = M, M = 0), X(y, B, M, L);
    function X(R, S, D, A, $) {
  ...
  function u(y, B, M) {
    ...
    var L = c.test(process.version) ? function(S, D, A, $) {
      return d(S, X(
        S,
        D,
        A,
    ...
    function X(R, S, D, A) {
      return function($, O) {
        $ && ($.code === "EMFILE" || $.code === "ENFILE") ? ir([
          ...
          A || Date.now(),
          Date.now()
        ]) : (O && O.sort && O.sort(), typeof D == "function" && D.call(this, $, O));
      };
    }
  }
  if (process.version.substr(0, 4) === "v0.8") {
    var p = Bp(e);
    _ = p.ReadStream, P = p.WriteStream;
  }
  var m = e.ReadStream;
  m && (_.prototype = Object.create(m.prototype), _.prototype.open = b);
  var x = e.WriteStream;
  x && (P.prototype = Object.create(x.prototype), P.prototype.open = F), Object.defineProperty(e, "ReadStream", {
    get: function() {
      return _;
    },
    set: function(y) {
  ...
  function b() {
    var y = this;
    Q(y.path, y.flags, y.mode, function(B, M) {
      B ? (y.autoClose && y.destroy(), y.emit("error", B)) : (y.fd = M, y.emit("open", M), y.read());
    });
  }
  function P(y, B) {
    return this instanceof P ? (x.apply(this, arguments), this) : P.apply(Object.create(P.prototype), arguments);
  }
  function F() {
    var y = this;
    Q(y.path, y.flags, y.mode, function(B, M) {
      B ? (y.destroy(), y.emit("error", B)) : (y.fd = M, y.emit("open", M));
    });
  }
  function U(y, B) {
    return new e.ReadStream(y, B);
  }
  function k(y, B) {
    return new e.WriteStream(y, B);
  }
  var G = e.open;
  e.open = Q;
  function Q(y, B, M, L) {
...
function ir(e) {
  Vt("ENQUEUE", e[0].name, e[1]), ce[be].push(e), ms();
}
var Ln;
function vo() {
...
function ms() {
  if (clearTimeout(Ln), Ln = void 0, ce[be].length !== 0) {
    ...
    if (i === void 0)
      ...
      o >= d ? (Vt("RETRY", t.name, r), t.apply(null, r.concat([i]))) : ce[be].push(e);
    }
    Ln === void 0 && (Ln = setTimeout(ms, 0));
  }
}
(function(e) {
...
function eh(e, t, r, n, i) {
  Jp.callbackify(Qp)(e, t, n, (a, s) => {
    ...
    return o.isDirectory() && ys(e, t) ? i(new Error(Ii(e, t, r))) : i(null, { srcStat: o, destStat: l });
  });
}
function th(e, t, r, n) {
...
function Mc(e, t, r, n, i) {
  ...
  Er.stat(s, { bigint: !0 }, (o, l) => o ? o.code === "ENOENT" ? i() : i(o) : pn(t, l) ? i(new Error(Ii(e, r, n))) : Mc(e, t, s, n, i));
}
function Bc(e, t, r, n) {
...
const Me = $e, Yr = ue, rh = lt.mkdirs, nh = tr.pathExists, ih = Uc.utimesMillis, Kr = Sr;
function ah(e, t, r, n) {
  typeof r == "function" && !n ? (n = r, r = {}) : typeof r == "function" && (r = { filter: r }), n = n || function() {
    ...
    Kr.checkParentPaths(e, s, t, "copy", (l) => l ? n(l) : r.filter ? jc(To, o, e, t, r, n) : To(o, e, t, r, n));
  });
}
...
function oh(e, t, r, n, i, a) {
  return t ? lh(e, r, n, i, a) : Gc(e, r, n, i, a);
}
function lh(e, t, r, n, i) {
  if (n.overwrite)
    Me.unlink(r, (a) => a ? i(a) : Gc(e, t, r, n, i));
...
function ph(e, t, r, n, i, a) {
  return t ? zc(r, n, i, a) : hh(e.mode, r, n, i, a);
}
function hh(e, t, r, n, i) {
  Me.mkdir(r, (a) => {
    if (a) return i(a);
    zc(t, r, n, (s) => s ? i(s) : Ri(r, e, i));
  });
}
function zc(e, t, r, n) {
...
var wh = ah;
const Ie = $e, Jr = ue, xh = lt.mkdirsSync, Eh = Uc.utimesMillisSync, Qr = Sr;
function vh(e, t, r) {
...
function qc(e, t, r, n) {
  ...
  if (a.isDirectory()) return Ph(a, e, t, r, n);
...
function Xc(e, t, r, n) {
  return Ie.copyFileSync(t, r), n.preserveTimestamps && Ah(e.mode, t, r), ws(r, e.mode);
}
function Ah(e, t, r) {
  return Ch(e) && Ih(r, e), Rh(t, r);
}
function Ch(e) {
  return (e & 128) === 0;
}
...
function Oh(e, t, r, n) {
  return Ie.mkdirSync(r), Wc(t, r, n), ws(r, e);
}
function Wc(e, t, r) {
...
const bo = $e, Vc = ue, ie = Ic, Zr = process.platform === "win32";
function Yc(e) {
  [
    "unlink",
    "chmod",
...
function Es(e, t, r) {
  let n = 0;
  typeof t == "function" && (r = t, t = {}), ie(e, "rimraf: missing path"), ie.strictEqual(typeof e, "string", "rimraf: path should be a string"), ie.strictEqual(typeof r, "function", "rimraf: callback function required"), ie(t, "rimraf: invalid options argument provided"), ie.strictEqual(typeof t, "object", "rimraf: options should be object"), Yc(t), So(e, t, function i(a) {
    if (a) {
    ...
    t.unlink(e, (a) => {
      if (a) {
        if (a.code === "ENOENT")
          return r(null);
        if (a.code === "EPERM")
          return Zr ? Ao(e, t, a, r) : si(e, t, a, r);
        if (a.code === "EISDIR")
          return si(e, t, a, r);
      }
      return r(a);
...
function Kc(e, t) {
  let r;
  t = t || {}, Yc(t), ie(e, "rimraf: missing path"), ie.strictEqual(typeof e, "string", "rimraf: path should be a string"), ie(t, "rimraf: missing options"), ie.strictEqual(typeof t, "object", "rimraf: options should be object");
  try {
    r = t.lstatSync(e);
  } catch (n) {
    if (n.code === "ENOENT")
...
function Uh(e, t) {
  if (ie(e), ie(t), t.readdirSync(e).forEach((r) => Kc(Vc.join(e, r), t)), Zr) {
    const r = Date.now();
    do
      try {
...
const zh = Fe.fromPromise, Qc = er, Zc = ue, eu = lt, tu = Pi, Io = zh(async function(t) {
  let r;
  try {
...
const { createFile: Oo, createFileSync: Do } = Vh, { createLink: ko, createLinkSync: No } = Zh, { createSymlink: Fo, createSymlinkSync: $o } = ym;
var wm = {
  // file
  createFile: Oo,
  createFileSync: Do,
...
const Oi = Fe, { stringify: pu, stripBom: hu } = vs;
...
const Rm = Fe.fromCallback, Xr = $e, mu = ue, gu = lt, Pm = tr.pathExists;
function Om(e, t, r, n) {
...
const { stringify: km } = vs, { outputFile: Nm } = Ts;
...
var Gm = Ne;
const zm = $e, Ha = ue, Hm = xs.copy, yu = Pi.remove, qm = lt.mkdirp, Xm = tr.pathExists, Lo = Sr;
function Wm(e, t, r, n) {
...
function fa(e, t, r, n) {
  zm.rename(e, t, (i) => i ? i.code !== "EXDEV" ? n(i) : Ym(e, t, r, n) : n());
}
function Ym(e, t, r, n) {
  Hm(e, t, {
    overwrite: r,
...
var Km = Wm;
const wu = $e, qa = ue, Jm = xs.copySync, xu = Pi.removeSync, Qm = lt.mkdirpSync, Mo = Sr;
function Zm(e, t, r) {
  r = r || {};
...
It.CancellationToken = o0;
class Xa extends Error {
  constructor() {
    super("cancelled");
  }
}
It.CancellationError = Xa;
var Ar = {};
...
var ke = {}, Wa = { exports: {} }, Mn = { exports: {} }, pa, Bo;
function c0() {
  if (Bo) return pa;
  Bo = 1;
  ...
  function e(t) {
    ...
    function n(u) {
      ...
      function T(..._) {
        if (!T.enabled)
          return;
        const b = T, P = Number(/* @__PURE__ */ new Date()), F = P - (p || P);
        b.diff = F, b.prev = p, b.curr = P, p = P, _[0] = n.coerce(_[0]), typeof _[0] != "string" && _.unshift("%O");
        let U = 0;
        _[0] = _[0].replace(/%([a-zA-Z%])/g, (G, Q) => {
          if (G === "%%")
            return "%";
          U++;
...
var Bn = { exports: {} }, ma, zo;
function f0() {
  return zo || (zo = 1, ma = (e, t = process.argv) => {
...
function d0() {
  if (Ho) return ga;
  Ho = 1;
  const e = Ci, t = Pc, r = f0(), { env: n } = process;
  let i;
...
function p0() {
  return qo || (qo = 1, function(e, t) {
    ...
    t.inspectOpts = Object.keys(process.env).filter((p) => /^debug_/i.test(p)).reduce((p, m) => {
      const x = m.substring(6).toLowerCase().replace(/_([a-z])/g, (T, _) => _.toUpperCase());
      let w = process.env[m];
    ...
    function a(p) {
      ...
      if (x) {
        const w = this.color, T = "\x1B[3" + (w < 8 ? w : "8;5;" + w), _ = `  ${T};1m${m} \x1B[0m`;
        p[0] = _ + p[0].split(`
`).join(`
...
ke.createHttpError = Va;
ke.parseJson = _0;
ke.configureRequestOptionsFromUrl = _u;
ke.configureRequestUrl = bs;
ke.safeGetHeader = xr;
ke.configureRequestOptions = hi;
ke.safeStringifyJson = mi;
const g0 = dn, y0 = vu, w0 = Dt, x0 = fn, Tu = br, E0 = It, Xo = Ar, v0 = hn, $r = (0, y0.default)("electron-builder");
...
class pi {
  ...
  doApiRequest(t, r, n, i = 0) {
    return $r.enabled && $r(`Request: ${mi(t)}`), r.createPromise((a, s, o) => {
    ...
    t.on("error", a), t.on("data", (m) => p += m), t.on("end", () => {
      try {
        if (t.statusCode != null && t.statusCode >= 400) {
          const m = xr(t, "content-type"), x = m != null && (Array.isArray(m) ? m.find((w) => w.includes("json")) != null : m.includes("json"));
          a(Va(t, `method: ${r.method || "GET"} url: ${r.protocol || "https:"}//${r.hostname}${r.port ? `:${r.port}` : ""}${r.path}
...
ki.githubUrl = C0;
ki.getS3LikeProviderBaseUrl = I0;
function C0(e, t = "github.com") {
...
const Cu = dn, Iu = Ar, k0 = "options.name must be either a string or a Buffer", Wo = (0, Cu.randomBytes)(16);
Wo[0] = Wo[0] | 1;
const li = {}, Z = [];
for (let e = 0; e < 256; e++) {
...
function N0(e, t, r, n, i = Wr.ASCII) {
  ...
  if (typeof e != "string" && !Buffer.isBuffer(e))
    throw (0, Iu.newError)(k0, "ERR_INVALID_UUID_NAME");
  ...
  switch (i) {
    ...
    case Wr.OBJECT:
      ...
      break;
    default:
      l = Z[o[0]] + Z[o[1]] + Z[o[2]] + Z[o[3]] + "-" + Z[o[4]] + Z[o[5]] + "-" + Z[o[6] & 15 | r] + Z[o[7]] + "-" + Z[o[8] & 63 | 128] + Z[o[9]] + "-" + Z[o[10]] + Z[o[11]] + Z[o[12]] + Z[o[13]] + Z[o[14]] + Z[o[15]];
      break;
  }
  return l;
}
...
(function(e) {
  (function(t) {
    ...
    function i(h) {
      for (var f = Math.max(t.MAX_BUFFER_LENGTH, 10), C = 0, v = 0, ee = r.length; v < ee; v++) {
        var se = h[r[v]].length;
        if (se > f)
          switch (r[v]) {
            case "textNode":
              ...
              break;
            case "cdata":
              L(h, "oncdata", h.cdata), h.cdata = "";
              break;
            case "script":
              L(h, "onscript", h.script), h.script = "";
              break;
            default:
    ...
    function s(h) {
      X(h), h.cdata !== "" && (L(h, "oncdata", h.cdata), h.cdata = ""), h.script !== "" && (L(h, "onscript", h.script), h.script = "");
    }
    n.prototype = {
      end: function() {
        D(this);
    ...
    function c(h, f) {
      ...
      this._parser.onend = function() {
        ...
        Object.defineProperty(C, "on" + v, {
          ...
          set: function(ee) {
            if (!ee)
              return C.removeAllListeners(v), C._parser["on" + v] = ee, ee;
            C.on(v, ee);
          },
          enumerable: !0,
          configurable: !1
    ...
    c.prototype = Object.create(o.prototype, {
      ...
      return !C._parser["on" + h] && l.indexOf(h) !== -1 && (C._parser["on" + h] = function() {
        ...
        v.splice(0, 0, h), C.emit.apply(C, v);
      }), o.prototype.on.call(C, h, f);
    };
    var u = "[CDATA[", p = "DOCTYPE", m = "http://www.w3.org/XML/1998/namespace", x = "http://www.w3.org/2000/xmlns/", w = { xml: m, xmlns: x }, T = /[:_A-Za-z\u00C0-\u00D6\u00D8-\u00F6\u00F8-\u02FF\u0370-\u037D\u037F-\u1FFF\u200C-\u200D\u2070-\u218F\u2C00-\u2FEF\u3001-\uD7FF\uF900-\uFDCF\uFDF0-\uFFFD]/, _ = /[:_A-Za-z\u00C0-\u00D6\u00D8-\u00F6\u00F8-\u02FF\u0370-\u037D\u037F-\u1FFF\u200C-\u200D\u2070-\u218F\u2C00-\u2FEF\u3001-\uD7FF\uF900-\uFDCF\uFDF0-\uFFFD\u00B7\u0300-\u036F\u203F-\u2040.\d-]/, b = /[#:_A-Za-z\u00C0-\u00D6\u00D8-\u00F6\u00F8-\u02FF\u0370-\u037D\u037F-\u1FFF\u200C-\u200D\u2070-\u218F\u2C00-\u2FEF\u3001-\uD7FF\uF900-\uFDCF\uFDF0-\uFFFD]/, P = /[#:_A-Za-z\u00C0-\u00D6\u00D8-\u00F6\u00F8-\u02FF\u0370-\u037D\u037F-\u1FFF\u200C-\u200D\u2070-\u218F\u2C00-\u2FEF\u3001-\uD7FF\uF900-\uFDCF\uFDF0-\uFFFD\u00B7\u0300-\u036F\u203F-\u2040.\d-]/;
    function F(h) {
      return h === " " || h === `
` || h === "\r" || h === "	";
    }
    ...
    function L(h, f, C) {
      h.textNode && X(h), M(h, f, C);
    }
    function X(h) {
      h.textNode = R(h.opt, h.textNode), h.textNode && M(h, "ontext", h.textNode), h.textNode = "";
    }
    function R(h, f) {
      return h.trim && (f = f.trim()), h.normalize && (f = f.replace(/\s+/g, " ")), f;
    }
    function S(h, f) {
      return X(h), h.trackPosition && (f += `
Line: ` + h.line + `
Column: ` + h.column + `
Char: ` + h.c), f = new Error(f), h.error = f, M(h, "onerror", f), h;
    }
    function D(h) {
      return h.sawRoot && !h.closedRoot && A(h, "Unclosed root tag"), h.state !== y.BEGIN && h.state !== y.BEGIN_WHITESPACE && h.state !== y.TEXT && S(h, "Unexpected end"), X(h), h.c = "", h.closed = !0, M(h, "onend"), n.call(h, h.strict, h.opt), h;
    }
    function A(h, f) {
    ...
    function $(h) {
      ...
      h.opt.xmlns && (C.ns = f.ns), h.attribList.length = 0, L(h, "onopentagstart", C);
    }
    function O(h, f) {
      var C = h.indexOf(":"), v = C < 0 ? ["", h] : h.split(":"), ee = v[0], se = v[1];
      return f && h === "xmlns" && (ee = "xmlns", se = ""), { prefix: ee, local: se };
    }
    function q(h) {
      ...
      if (h.opt.xmlns) {
        var f = O(h.attribName, !0), C = f.prefix, v = f.local;
        if (C === "xmlns")
...
Actual: ` + h.attribValue
            ...
            var ee = h.tag, se = h.tags[h.tags.length - 1] || h;
            ee.ns === se.ns && (ee.ns = Object.create(se.ns)), ee.ns[v] = h.attribValue;
          }
        h.attribList.push([h.attribName, h.attribValue]);
      } else
        h.tag.attributes[h.attribName] = h.attribValue, L(h, "onattribute", {
          name: h.attribName,
          value: h.attribValue
        });
      h.attribName = h.attribValue = "";
    ...
    function K(h, f) {
      if (h.opt.xmlns) {
        var C = h.tag, v = O(h.tagName);
        C.prefix = v.prefix, C.local = v.local, C.uri = C.ns[v.prefix] || "", C.prefix && !C.uri && (A(
          h,
          "Unbound namespace prefix: " + JSON.stringify(h.tagName)
        ), C.uri = v.prefix);
        var ee = h.tags[h.tags.length - 1] || h;
        C.ns && ee.ns !== C.ns && Object.keys(C.ns).forEach(function(An) {
          L(h, "onopennamespace", {
            prefix: An,
            uri: C.ns[An]
          });
        ...
        for (var se = 0, fe = h.attribList.length; se < fe; se++) {
          var ve = h.attribList[se], Ae = ve[0], mt = ve[1], he = O(Ae, !0), Ye = he.prefix, ea = he.local, Sn = Ye === "" ? "" : C.ns[Ye] || "", Pr = {
            name: Ae,
            value: mt,
            prefix: Ye,
            local: ea,
          ...
          ), Pr.uri = Ye), h.tag.attributes[Ae] = Pr, L(h, "onattribute", Pr);
        }
        h.attribList.length = 0;
      }
      h.tag.isSelfClosing = !!f, h.sawRoot = !0, h.tags.push(h.tag), L(h, "onopentag", h.tag), f || (!h.noscript && h.tagName.toLowerCase() === "script" ? h.state = y.SCRIPT : h.state = y.TEXT, h.tag = null, h.tagName = ""), h.attribName = h.attribValue = "", h.attribList.length = 0;
    }
    function W(h) {
      if (!h.tagName) {
      ...
      for (var se = h.tags.length; se-- > f; ) {
        ...
        h.tagName = h.tag.name, L(h, "onclosetag", h.tagName);
        var ve = {};
        for (var Ae in fe.ns)
          ve[Ae] = fe.ns[Ae];
        ...
        h.opt.xmlns && fe.ns !== mt.ns && Object.keys(fe.ns).forEach(function(he) {
          var Ye = fe.ns[he];
          L(h, "onclosenamespace", { prefix: he, uri: Ye });
        });
      }
      f === 0 && (h.closedRoot = !0), h.tagName = h.attribValue = h.attribName = "", h.attribList.length = 0, h.state = y.TEXT;
    }
    function ne(h) {
      var f = h.entity, C = f.toLowerCase(), v, ee = "";
      return h.ENTITIES[f] ? h.ENTITIES[f] : h.ENTITIES[C] ? h.ENTITIES[C] : (f = C, f.charAt(0) === "#" && (f.charAt(1) === "x" ? (f = f.slice(2), v = parseInt(f, 16), ee = v.toString(16)) : (f = f.slice(1), v = parseInt(f, 10), ee = v.toString(10))), f = f.replace(/^0+/, ""), isNaN(v) || ee.toLowerCase() !== f || v < 0 || v > 1114111 ? (A(h, "Invalid character entity"), "&" + h.entity + ";") : String.fromCodePoint(v));
    }
    function ge(h, f) {
      f === "<" ? (h.state = y.OPEN_WAKA, h.startTagPosition = h.position) : F(f) || (A(h, "Non-whitespace before first tag."), h.textNode = f, h.state = y.TEXT);
    }
    function H(h, f) {
      var C = "";
...
` ? (f.line++, f.column = 0) : f.column++), f.state) {
          ...
          case y.TEXT:
            if (f.sawRoot && !f.closedRoot) {
              for (var se = C - 1; v && v !== "<" && v !== "&"; )
                v = H(h, C++), v && f.trackPosition && (f.position++, v === `
` ? (f.line++, f.column = 0) : f.column++);
              f.textNode += h.substring(se, C - 1);
            }
            v === "<" && !(f.sawRoot && f.closedRoot && !f.strict) ? (f.state = y.OPEN_WAKA, f.startTagPosition = f.position) : (!F(v) && (!f.sawRoot || f.closedRoot) && A(f, "Text data outside of root node."), v === "&" ? f.state = y.TEXT_ENTITY : f.textNode += v);
            continue;
          case y.SCRIPT:
          ...
          case y.OPEN_WAKA:
            if (v === "!")
              ...
              if (A(f, "Unencoded <"), f.startTagPosition + 1 < f.position) {
                var ee = f.position - f.startTagPosition;
                v = new Array(ee).join(" ") + v;
              }
          ...
          case y.SGML_DECL:
            ...
            f.doctype && f.doctype !== !0 && f.sgmlDecl ? (f.state = y.DOCTYPE_DTD, f.doctype += "<!" + f.sgmlDecl + v, f.sgmlDecl = "") : (f.sgmlDecl + v).toUpperCase() === u ? (L(f, "onopencdata"), f.state = y.CDATA, f.sgmlDecl = "", f.cdata = "") : (f.sgmlDecl + v).toUpperCase() === p ? (f.state = y.DOCTYPE, (f.doctype || f.sawRoot) && A(
              f,
              "Inappropriately located doctype declaration"
            ), f.doctype = "", f.sgmlDecl = "") : v === ">" ? (L(f, "onsgmldeclaration", f.sgmlDecl), f.sgmlDecl = "", f.state = y.TEXT) : (U(v) && (f.state = y.SGML_DECL_QUOTED), f.sgmlDecl += v);
            continue;
          case y.SGML_DECL_QUOTED:
            v === f.q && (f.state = y.SGML_DECL, f.q = ""), f.sgmlDecl += v;
            continue;
          case y.DOCTYPE:
            v === ">" ? (f.state = y.TEXT, L(f, "ondoctype", f.doctype), f.doctype = !0) : (f.doctype += v, v === "[" ? f.state = y.DOCTYPE_DTD : U(v) && (f.state = y.DOCTYPE_QUOTED, f.q = v));
            continue;
          case y.DOCTYPE_QUOTED:
            f.doctype += v, v === f.q && (f.q = "", f.state = y.DOCTYPE);
            continue;
          case y.DOCTYPE_DTD:
            v === "]" ? (f.doctype += v, f.state = y.DOCTYPE) : v === "<" ? (f.state = y.OPEN_WAKA, f.startTagPosition = f.position) : U(v) ? (f.doctype += v, f.state = y.DOCTYPE_DTD_QUOTED, f.q = v) : f.doctype += v;
            continue;
          ...
          case y.COMMENT_ENDING:
            v === "-" ? (f.state = y.COMMENT_ENDED, f.comment = R(f.opt, f.comment), f.comment && L(f, "oncomment", f.comment), f.comment = "") : (f.comment += "-" + v, f.state = y.COMMENT);
            continue;
          ...
          case y.CDATA:
            for (var se = C - 1; v && v !== "]"; )
              v = H(h, C++), v && f.trackPosition && (f.position++, v === `
` ? (f.line++, f.column = 0) : f.column++);
            f.cdata += h.substring(se, C - 1), v === "]" && (f.state = y.CDATA_ENDING);
            continue;
          case y.CDATA_ENDING:
            v === "]" ? f.state = y.CDATA_ENDING_2 : (f.cdata += "]" + v, f.state = y.CDATA);
            continue;
          case y.CDATA_ENDING_2:
            v === ">" ? (f.cdata && L(f, "oncdata", f.cdata), L(f, "onclosecdata"), f.cdata = "", f.state = y.TEXT) : v === "]" ? f.cdata += "]" : (f.cdata += "]]" + v, f.state = y.CDATA);
            continue;
          case y.PROC_INST:
            v === "?" ? f.state = y.PROC_INST_ENDING : F(v) ? f.state = y.PROC_INST_BODY : f.procInstName += v;
            continue;
          case y.PROC_INST_BODY:
            if (!f.procInstBody && F(v))
              continue;
            v === "?" ? f.state = y.PROC_INST_ENDING : f.procInstBody += v;
            continue;
          case y.PROC_INST_ENDING:
            v === ">" ? (L(f, "onprocessinginstruction", {
              name: f.procInstName,
              body: f.procInstBody
            }), f.procInstName = f.procInstBody = "", f.state = y.TEXT) : (f.procInstBody += "?" + v, f.state = y.PROC_INST_BODY);
            continue;
          case y.OPEN_TAG:
            G(_, v) ? f.tagName += v : ($(f), v === ">" ? K(f) : v === "/" ? f.state = y.OPEN_TAG_SLASH : (F(v) || A(f, "Invalid character in tag name"), f.state = y.ATTRIB));
            continue;
          ...
          case y.ATTRIB:
            ...
            continue;
          case y.ATTRIB_NAME:
            v === "=" ? f.state = y.ATTRIB_VALUE : v === ">" ? (A(f, "Attribute without value"), f.attribValue = f.attribName, q(f), K(f)) : F(v) ? f.state = y.ATTRIB_NAME_SAW_WHITE : G(_, v) ? f.attribName += v : A(f, "Invalid attribute name");
            continue;
          case y.ATTRIB_NAME_SAW_WHITE:
            if (v === "=")
              ...
              if (F(v))
                continue;
              A(f, "Attribute without value"), f.tag.attributes[f.attribName] = "", f.attribValue = "", L(f, "onattribute", {
                name: f.attribName,
                value: ""
          ...
          case y.ATTRIB_VALUE:
            if (F(v))
              continue;
            U(v) ? (f.q = v, f.state = y.ATTRIB_VALUE_QUOTED) : (f.opt.unquotedAttributeValues || S(f, "Unquoted attribute value"), f.state = y.ATTRIB_VALUE_UNQUOTED, f.attribValue = v);
            continue;
          ...
          case y.ATTRIB_VALUE_CLOSED:
            F(v) ? f.state = y.ATTRIB : v === ">" ? K(f) : v === "/" ? f.state = y.OPEN_TAG_SLASH : G(T, v) ? (A(f, "No whitespace between attributes"), f.attribName = v, f.attribValue = "", f.state = y.ATTRIB_NAME) : A(f, "Invalid attribute name");
            continue;
          ...
          case y.CLOSE_TAG:
            if (f.tagName)
              v === ">" ? W(f) : G(_, v) ? f.tagName += v : f.script ? (f.script += "</" + f.tagName, f.tagName = "", f.state = y.SCRIPT) : (F(v) || A(f, "Invalid tagname in closing tag"), f.state = y.CLOSE_TAG_SAW_WHITE);
            else {
              if (F(v))
                continue;
              Q(T, v) ? f.script ? (f.script += "</" + v, f.state = y.SCRIPT) : A(f, "Invalid tagname in closing tag.") : f.tagName = v;
            }
            continue;
          case y.CLOSE_TAG_SAW_WHITE:
            if (F(v))
              continue;
            v === ">" ? W(f) : A(f, "Invalid characters in closing tag");
            continue;
          case y.TEXT_ENTITY:
          ...
          case y.ATTRIB_VALUE_ENTITY_U:
            ...
            if (v === ";") {
              var Ae = ne(f);
              f.opt.unparsedEntities && !Object.values(t.XML_ENTITIES).includes(Ae) ? (f.entity = "", f.state = fe, f.write(Ae)) : (f[ve] += Ae, f.entity = "", f.state = fe);
            } else G(f.entity.length ? P : b, v) ? f.entity += v : (A(f, "Invalid character in entity name"), f[ve] += "&" + f.entity + v, f.entity = "", f.state = fe);
            continue;
          default:
    ...
    String.fromCodePoint || function() {
      var h = String.fromCharCode, f = Math.floor, C = function() {
        var v = 16384, ee = [], se, fe, ve = -1, Ae = arguments.length;
        if (!Ae)
          return "";
        for (var mt = ""; ++ve < Ae; ) {
          ...
          he <= 65535 ? ee.push(he) : (he -= 65536, se = (he >> 10) + 55296, fe = he % 1024 + 56320, ee.push(se, fe)), (ve + 1 === Ae || ee.length > v) && (mt += h.apply(null, ee), ee.length = 0);
        }
        return mt;
      };
...
function en(e, t) {
  Error.call(this), this.name = "YAMLException", this.reason = e, this.mark = t, this.message = Du(this, !1), Error.captureStackTrace ? Error.captureStackTrace(this, this.constructor) : this.stack = new Error().stack || "";
}
en.prototype = Object.create(Error.prototype);
en.prototype.constructor = en;
en.prototype.toString = function(t) {
  return this.name + ": " + Du(this, t);
};
var gn = en, Gr = Qe;
...
function q0(e, t) {
  ...
  for (l = 1; l <= t.linesBefore && !(s - l < 0); l++)
    d = ya(
      ...
      u
    ), o = Gr.repeat(" ", t.indent) + wa((e.line - l + 1).toString(), c) + " | " + d.str + `
` + o;
  for (d = ya(e.buffer, n[s], i[s], e.position, u), o += Gr.repeat(" ", t.indent) + wa((e.line + 1).toString(), c) + " | " + d.str + `
`, o += Gr.repeat("-", t.indent + c + 3 + d.pos) + `^
...
var ku = Ka, Q0 = Le, Nu = new Q0("tag:yaml.org,2002:str", {
  kind: "scalar",
...
var Gu = new wg("tag:yaml.org,2002:float", {
  kind: "scalar",
  resolve: Eg,
  construct: vg,
  predicate: bg,
...
var Vu = new Rg("tag:yaml.org,2002:merge", {
  kind: "scalar",
  resolve: Pg
}), Og = Le, Is = `ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789+/=
\r`;
function Dg(e) {
  if (e === null) return !1;
  var t, r, n = 0, i = e.length, a = Is;
  for (r = 0; r < i; r++)
...
var Ku = new $g("tag:yaml.org,2002:omap", {
  ...
  resolve: Mg,
  construct: Bg
}), jg = Le, Gg = Object.prototype.toString;
function zg(e) {
  if (e === null) return !0;
  var t, r, n, i, a, s = e;
  for (a = new Array(s.length), t = 0, r = s.length; t < r; t += 1) {
    if (n = s[t], Gg.call(n) !== "[object Object]" || (i = Object.keys(n), i.length !== 1)) return !1;
    a[t] = [i[0], n[i[0]]];
  }
  return !0;
}
...
}), qt = Qe, Zu = gn, Yg = X0, Kg = Rs, Rt = Object.prototype.hasOwnProperty, gi = 1, ef = 2, tf = 3, yi = 4, Ea = 1, Jg = 2, Qo = 3, Qg = /[\x00-\x08\x0B\x0C\x0E-\x1F\x7F-\x84\x86-\x9F\uFFFE\uFFFF]|[\uD800-\uDBFF](?![\uDC00-\uDFFF])|(?:[^\uD800-\uDBFF]|^)[\uDC00-\uDFFF]/, Zg = /[\x85\u2028\u2029]/, ey = /[,\[\]\{\}]/, rf = /^(?:!|!!|![a-z\-]+!)$/i, nf = /^(?:!|[^,\[\]\{\}])(?:%[0-9a-f]{2}|[0-9a-z\-#;\/\?:@&=\+\$,_\.!~\*'\(\)\[\]])*$/i;
function Zo(e) {
...
function sy(e, t, r) {
  ...
  for (e.kind = "scalar", e.result = "", a = s = e.position, o = !1; m !== 0; ) {
    ...
    o && (St(e, a, s, !1), Os(e, e.line - l), a = s = e.position, o = !1), Yt(m) || (s = e.position + 1), m = e.input.charCodeAt(++e.position);
  }
  ...
  for (e.kind = "scalar", e.result = "", e.position++, n = i = e.position; (r = e.input.charCodeAt(e.position)) !== 0; )
    if (r === 39)
      if (St(e, n, e.position, !0), r = e.input.charCodeAt(++e.position), r === 39)
        ...
        return !0;
    else st(r) ? (St(e, n, i, !0), Os(e, pe(e, !1, t)), n = i = e.position) : e.position === e.lineStart && Ni(e) ? z(e, "unexpected end of the document within a single quoted scalar") : (e.position++, i = e.position);
...
function ly(e, t) {
  ...
  for (e.kind = "scalar", e.result = "", e.position++, r = n = e.position; (o = e.input.charCodeAt(e.position)) !== 0; ) {
    ...
    if (o === 92) {
      ...
      r = n = e.position;
    } else st(o) ? (St(e, r, n, !0), Os(e, pe(e, !1, t)), r = n = e.position) : e.position === e.lineStart && Ni(e) ? z(e, "unexpected end of the document within a double quoted scalar") : (e.position++, n = e.position);
  }
  z(e, "unexpected end of the stream within a double quoted scalar");
}
function cy(e, t) {
  var r = !0, n, i, a, s = e.tag, o, l = e.anchor, d, c, u, p, m, x = /* @__PURE__ */ Object.create(null), w, T, _, b;
  ...
  for (e.anchor !== null && (e.anchorMap[e.anchor] = o), b = e.input.charCodeAt(++e.position); b !== 0; ) {
    if (pe(e, !0, t), b = e.input.charCodeAt(e.position), b === c)
      return e.position++, e.tag = s, e.anchor = l, e.kind = m ? "mapping" : "sequence", e.result = o, !0;
    r ? b === 44 && z(e, "expected the node content, but found ','") : z(e, "missed comma between flow collection entries"), T = w = _ = null, u = p = !1, b === 63 && (d = e.input.charCodeAt(e.position + 1), Be(d) && (u = p = !0, e.position++, pe(e, !0, t))), n = e.line, i = e.lineStart, a = e.position, _r(e, t, gi, !1, !0), T = e.tag, w = e.result, pe(e, !0, t), b = e.input.charCodeAt(e.position), (p || e.line === n) && b === 58 && (u = !0, b = e.input.charCodeAt(++e.position), pe(e, !0, t), _r(e, t, gi, !1, !0), _ = e.result), m ? pr(e, o, x, T, w, _, n, i, a) : u ? o.push(pr(e, null, x, T, w, _, n, i, a)) : o.push(w), pe(e, !0, t), b = e.input.charCodeAt(e.position), b === 44 ? (r = !0, b = e.input.charCodeAt(++e.position)) : r = !1;
  }
...
function uy(e, t) {
  ...
  for (; u !== 0; ) {
    for (Ps(e), e.lineIndent = 0, u = e.input.charCodeAt(e.position); (!s || e.lineIndent < o) && u === 32; )
...
function fy(e, t, r) {
  var n, i, a, s, o, l, d = e.tag, c = e.anchor, u = {}, p = /* @__PURE__ */ Object.create(null), m = null, x = null, w = null, T = !1, _ = !1, b;
  if (e.firstTabInLine !== -1) return !1;
  for (e.anchor !== null && (e.anchorMap[e.anchor] = u), b = e.input.charCodeAt(e.position); b !== 0; ) {
    if (!T && e.firstTabInLine !== -1 && (e.position = e.firstTabInLine, z(e, "tab characters must not be used in indentation")), n = e.input.charCodeAt(e.position + 1), a = e.line, (b === 63 || b === 58) && Be(n))
      b === 63 ? (T && (pr(e, u, p, m, x, null, s, o, l), m = x = w = null), _ = !0, T = !0, i = !0) : T ? (T = !1, i = !0) : z(e, "incomplete explicit mapping pair; a key node is missed; or followed by a non-tabulated empty line"), e.position += 1, b = n;
    else {
      if (s = e.line, o = e.lineStart, l = e.position, !_r(e, r, ef, !1, !0))
        break;
      if (e.line === a) {
        for (b = e.input.charCodeAt(e.position); Yt(b); )
          b = e.input.charCodeAt(++e.position);
        if (b === 58)
          b = e.input.charCodeAt(++e.position), Be(b) || z(e, "a whitespace character is expected after the key-value separator within a block mapping"), T && (pr(e, u, p, m, x, null, s, o, l), m = x = w = null), _ = !0, T = !1, i = !1, m = e.tag, x = e.result;
        else if (_)
    ...
    if ((e.line === a || e.lineIndent > t) && (T && (s = e.line, o = e.lineStart, l = e.position), _r(e, t, yi, !0, i) && (T ? x = e.result : w = e.result), T || (pr(e, u, p, m, x, w, s, o, l), m = x = w = null), pe(e, !0, -1), b = e.input.charCodeAt(e.position)), (e.line === a || e.lineIndent > t) && b !== 0)
      z(e, "bad indentation of a mapping entry");
    else if (e.lineIndent < t)
      break;
  }
  return T && pr(e, u, p, m, x, null, s, o, l), _ && (e.tag = d, e.anchor = c, e.kind = "mapping", e.result = u), _;
}
function dy(e) {
  var t, r = !1, n = !1, i, a, s;
...
function my(e) {
  ...
  for (e.version = null, e.checkLineBreaks = e.legacy, e.tagMap = /* @__PURE__ */ Object.create(null), e.anchorMap = /* @__PURE__ */ Object.create(null); (s = e.input.charCodeAt(e.position)) !== 0 && (pe(e, !0, -1), s = e.input.charCodeAt(e.position), !(e.lineIndent > 0 || s !== 37)); ) {
    ...
    s !== 0 && Ps(e), Rt.call(tl, n) ? tl[n](e, n, i) : wi(e, 'unknown document directive "' + n + '"');
  }
...
Cs.loadAll = gy;
Cs.load = yy;
var uf = {}, Fi = Qe, yn = gn, wy = Rs, ff = Object.prototype.toString, df = Object.prototype.hasOwnProperty, Ds = 65279, xy = 9, tn = 10, Ey = 13, vy = 32, Ty = 33, _y = 34, Ja = 35, by = 37, Sy = 38, Ay = 39, Cy = 42, pf = 44, Iy = 45, xi = 58, Ry = 61, Py = 62, Oy = 63, Dy = 64, hf = 91, mf = 93, ky = 96, gf = 123, Ny = 124, yf = 125, Pe = {};
Pe[0] = "\\0";
Pe[7] = "\\a";
Pe[8] = "\\b";
Pe[9] = "\\t";
...
function Gy(e) {
  return nn(e) && e !== Ds && !Ei(e) && e !== Iy && e !== Oy && e !== xi && e !== pf && e !== hf && e !== mf && e !== gf && e !== yf && e !== Ja && e !== Sy && e !== Cy && e !== Ty && e !== Ny && e !== Ry && e !== Py && e !== Ay && e !== _y && e !== by && e !== Dy && e !== ky;
}
function zy(e) {
  return !Ei(e) && e !== xi;
}
...
function Hy(e, t, r, n, i, a, s, o) {
  var l, d = 0, c = null, u = !1, p = !1, m = n !== -1, x = -1, w = Gy(zr(e, 0)) && zy(zr(e, e.length - 1));
  if (t || s)
  ...
  return !u && !p ? w && !s && !i(e) ? xf : a === rn ? fr : Za : r > 9 && wf(e) ? fr : s ? a === rn ? fr : Za : p ? vf : Ef;
}
...
function Wy(e) {
  for (var t = "", r = 0, n, i = 0; i < e.length; r >= 65536 ? i += 2 : i++)
    r = zr(e, i), n = Pe[r], !n && nn(r) ? (t += e[i], r >= 65536 && (t += e[i + 1])) : t += n || Uy(r);
  return t;
}
function Vy(e, t, r) {
  var n = "", i = e.tag, a, s, o;
...
function ul(e, t, r, n) {
  ...
  for (s = 0, o = r.length; s < o; s += 1)
    l = r[s], e.replacer && (l = e.replacer.call(r, String(s), l)), (pt(e, t + 1, l, !0, !0, !1, !0) || typeof l > "u" && pt(e, t + 1, null, !0, !0, !1, !0)) && ((!n || i !== "") && (i += Qa(e, t)), e.dump && tn === e.dump.charCodeAt(0) ? i += "-" : i += "- ", i += e.dump);
  e.tag = a, e.dump = i || "[]";
}
function Yy(e, t, r) {
...
function Ky(e, t, r, n) {
  ...
  for (o = 0, l = s.length; o < l; o += 1)
    p = "", (!n || i !== "") && (p += Qa(e, t)), d = s[o], c = r[d], e.replacer && (c = e.replacer.call(r, d, c)), pt(e, t + 1, d, !0, !0, !0) && (u = e.tag !== null && e.tag !== "?" || e.dump && e.dump.length > 1024, u && (e.dump && tn === e.dump.charCodeAt(0) ? p += "?" : p += "? "), p += e.dump, u && (p += Qa(e, t)), pt(e, t + 1, c, !0, u) && (e.dump && tn === e.dump.charCodeAt(0) ? p += ":" : p += ": ", p += e.dump, i += p));
  e.tag = a, e.dump = i || "{}";
}
function fl(e, t, r) {
  var n, i, a, s, o, l;
...
Se.Type = Le;
Se.Schema = ku;
Se.FAILSAFE_SCHEMA = Lu;
Se.JSON_SCHEMA = zu;
Se.CORE_SCHEMA = Hu;
Se.DEFAULT_SCHEMA = Rs;
Se.load = Tf.load;
Se.loadAll = Tf.loadAll;
Se.dump = Zy.dump;
Se.YAMLException = gn;
Se.types = {
  binary: Yu,
...
Se.safeLoad = ks("safeLoad", "load");
Se.safeLoadAll = ks("safeLoadAll", "loadAll");
Se.safeDump = ks("safeDump", "dump");
var $i = {};
...
(function(e, t) {
  ...
  const p = "[a-zA-Z0-9-]", m = [
    ...
    const P = x(_), F = u++;
    a(T, F, _), c[T] = F, l[F] = _, d[F] = P, s[F] = new RegExp(_, b ? "g" : void 0), o[F] = new RegExp(P, b ? "g" : void 0);
  };
...
const Gn = Ui, { MAX_LENGTH: pl, MAX_SAFE_INTEGER: zn } = Li, { safeRe: Hn, t: qn } = wn, fw = Ns, { compareIdentifiers: va } = Sf;
let dw = class at {
  constructor(t, r) {
  ...
  compare(t) {
    if (Gn("SemVer.compare", this.version, this.options, t), !(t instanceof at)) {
...
var Aw = Sw;
const Cw = Ue, Iw = (e, t) => new Cw(e, t).minor;
var Rw = Iw;
const Pw = Ue, Ow = (e, t) => new Pw(e, t).patch;
var Dw = Ow;
const kw = Ir, Nw = (e, t) => {
  const r = kw(e, t);
...
var Us = ox;
const lx = Af, cx = Cf, ux = Mi, fx = Ls, dx = $s, px = Us, hx = (e, t, r, n) => {
  switch (t) {
    case "===":
...
var If = hx;
const mx = Ue, gx = Ir, { safeRe: Xn, t: Wn } = wn, yx = (e, t) => {
  if (e instanceof mx)
    return e;
...
function et() {
  ...
  class t {
    ...
    parseRange(S) {
      const A = ((this.options.includePrerelease && m) | (this.options.loose && x)) + ":" + S, $ = n.get(A);
      if ($)
        return $;
      const O = this.options.loose, q = O ? l[d.HYPHENRANGELOOSE] : l[d.HYPHENRANGE];
      S = S.replace(q, L(this.options.includePrerelease)), s("hyphen replace", S), S = S.replace(l[d.COMPARATORTRIM], c), s("comparator trim", S), S = S.replace(l[d.TILDETRIM], u), s("tilde trim", S), S = S.replace(l[d.CARETTRIM], p), s("caret trim", S);
      let K = S.split(" ").map((H) => b(H, this.options)).join(" ").split(/\s+/).map((H) => M(H, this.options));
      O && (K = K.filter((H) => (s("loose invalid filter", H, this.options), !!H.match(l[d.COMPARATORLOOSE])))), s("range list", K);
      const W = /* @__PURE__ */ new Map(), ne = K.map((H) => new a(H, this.options));
      for (const H of ne) {
        if (w(H))
          return [H];
        W.set(H.value, H);
    ...
    intersects(S, D) {
      ...
      return this.set.some((A) => _(A, D) && S.set.some(($) => _($, D) && A.every((O) => $.every((q) => O.intersects(q, D)))));
    }
    ...
    test(S) {
      ...
      for (let D = 0; D < this.set.length; D++)
        if (X(this.set[D], S, this.options))
          return !0;
      return !1;
    }
  }
  ...
  const r = Ex, n = new r(), i = Ns, a = Bi(), s = Ui, o = Ue, {
    ...
    tildeTrimReplace: u,
    caretTrimReplace: p
  } = wn, { FLAG_INCLUDE_PRERELEASE: m, FLAG_LOOSE: x } = Li, w = (R) => R.value === "<0.0.0-0", T = (R) => R.value === "", _ = (R, S) => {
    let D = !0;
    const A = R.slice();
    let $ = A.pop();
    for (; D && A.length; )
      D = A.every((O) => $.intersects(O, S)), $ = A.pop();
    return D;
  }, b = (R, S) => (R = R.replace(l[d.BUILD], ""), s("comp", R, S), R = k(R, S), s("caret", R), R = F(R, S), s("tildes", R), R = Q(R, S), s("xrange", R), R = B(R, S), s("stars", R), R), P = (R) => !R || R.toLowerCase() === "x" || R === "*", F = (R, S) => R.trim().split(/\s+/).map((D) => U(D, S)).join(" "), U = (R, S) => {
    const D = S.loose ? l[d.TILDELOOSE] : l[d.TILDE];
    return R.replace(D, (A, $, O, q, K) => {
      s("tilde", R, A, $, O, q, K);
      let W;
      return P($) ? W = "" : P(O) ? W = `>=${$}.0.0 <${+$ + 1}.0.0-0` : P(q) ? W = `>=${$}.${O}.0 <${$}.${+O + 1}.0-0` : K ? (s("replaceTilde pr", K), W = `>=${$}.${O}.${q}-${K} <${$}.${+O + 1}.0-0`) : W = `>=${$}.${O}.${q} <${$}.${+O + 1}.0-0`, s("tilde return", W), W;
    });
  }, k = (R, S) => R.trim().split(/\s+/).map((D) => G(D, S)).join(" "), G = (R, S) => {
    s("caret", R, S);
    const D = S.loose ? l[d.CARETLOOSE] : l[d.CARET], A = S.includePrerelease ? "-0" : "";
    return R.replace(D, ($, O, q, K, W) => {
      s("caret", R, $, O, q, K, W);
      let ne;
      return P(O) ? ne = "" : P(q) ? ne = `>=${O}.0.0${A} <${+O + 1}.0.0-0` : P(K) ? O === "0" ? ne = `>=${O}.${q}.0${A} <${O}.${+q + 1}.0-0` : ne = `>=${O}.${q}.0${A} <${+O + 1}.0.0-0` : W ? (s("replaceCaret pr", W), O === "0" ? q === "0" ? ne = `>=${O}.${q}.${K}-${W} <${O}.${q}.${+K + 1}-0` : ne = `>=${O}.${q}.${K}-${W} <${O}.${+q + 1}.0-0` : ne = `>=${O}.${q}.${K}-${W} <${+O + 1}.0.0-0`) : (s("no pr"), O === "0" ? q === "0" ? ne = `>=${O}.${q}.${K}${A} <${O}.${q}.${+K + 1}-0` : ne = `>=${O}.${q}.${K}${A} <${O}.${+q + 1}.0-0` : ne = `>=${O}.${q}.${K} <${+O + 1}.0.0-0`), s("caret return", ne), ne;
    });
  }, Q = (R, S) => (s("replaceXRanges", R, S), R.split(/\s+/).map((D) => y(D, S)).join(" ")), y = (R, S) => {
    R = R.trim();
    const D = S.loose ? l[d.XRANGELOOSE] : l[d.XRANGE];
    return R.replace(D, (A, $, O, q, K, W) => {
      s("xRange", R, A, $, O, q, K, W);
      const ne = P(O), ge = ne || P(q), H = ge || P(K), tt = H;
      return $ === "=" && tt && ($ = ""), W = S.includePrerelease ? "-0" : "", ne ? $ === ">" || $ === "<" ? A = "<0.0.0-0" : A = "*" : $ && tt ? (ge && (q = 0), K = 0, $ === ">" ? ($ = ">=", ge ? (O = +O + 1, q = 0, K = 0) : (q = +q + 1, K = 0)) : $ === "<=" && ($ = "<", ge ? O = +O + 1 : q = +q + 1), $ === "<" && (W = "-0"), A = `${$ + O}.${q}.${K}${W}`) : ge ? A = `>=${O}.0.0${W} <${+O + 1}.0.0-0` : H && (A = `>=${O}.${q}.0${W} <${O}.${+q + 1}.0-0`), s("xRange return", A), A;
    });
  }, B = (R, S) => (s("replaceStars", R, S), R.trim().replace(l[d.STAR], "")), M = (R, S) => (s("replaceGTE0", R, S), R.trim().replace(l[S.includePrerelease ? d.GTE0PRE : d.GTE0], "")), L = (R) => (S, D, A, $, O, q, K, W, ne, ge, H, tt) => (P(A) ? D = "" : P($) ? D = `>=${A}.0.0${R ? "-0" : ""}` : P(O) ? D = `>=${A}.${$}.0${R ? "-0" : ""}` : q ? D = `>=${D}` : D = `>=${D}${R ? "-0" : ""}`, P(ne) ? W = "" : P(ge) ? W = `<${+ne + 1}.0.0-0` : P(H) ? W = `<${ne}.${+ge + 1}.0-0` : tt ? W = `<=${ne}.${ge}.${H}-${tt}` : R ? W = `<${ne}.${ge}.${+H + 1}-0` : W = `<=${W}`, `${D} ${W}`.trim()), X = (R, S, D) => {
...
function Bi() {
  ...
  _a = t;
  const r = Ns, { safeRe: n, t: i } = wn, a = If, s = Ui, o = Ue, l = et();
  return _a;
}
...
const Px = Ue, Ox = et(), Dx = (e, t, r) => {
  ...
  return e.forEach((s) => {
    a.test(s) && (!n || i.compare(s) === 1) && (n = s, i = new Px(n, r));
  }), n;
};
var kx = Dx;
...
var Mx = Ux;
const Bx = Ue, Rf = Bi(), { ANY: jx } = Rf, Gx = et(), zx = ji, Tl = Mi, _l = $s, Hx = Us, qx = Ls, Xx = (e, t, r, n) => {
  e = new Bx(e, n), t = new Gx(t, n);
  let i, a, s, o, l;
  switch (r) {
    case ">":
      i = Tl, a = Hx, s = _l, o = ">", l = ">=";
...
const Sl = et(), Bs = Bi(), { ANY: Sa } = Bs, Ur = ji, js = Ze, iE = (e, t, r = {}) => {
  if (e === t)
    return !0;
  ...
  let i, a;
  for (const m of e)
    m.operator === ">" || m.operator === ">=" ? i = Cl(i, m, r) : m.operator === "<" || m.operator === "<=" ? a = Il(a, m, r) : n.add(m.semver);
  if (n.size > 1)
    return null;
  let s;
  if (i && a) {
  ...
  for (const m of n) {
    if (i && !Ur(m, String(i), r) || a && !Ur(m, String(a), r))
      return null;
    for (const x of t)
      if (!Ur(m, String(x), r))
        return !1;
    ...
    if (c = c || m.operator === ">" || m.operator === ">=", d = d || m.operator === "<" || m.operator === "<=", i) {
      if (p && m.semver.prerelease && m.semver.prerelease.length && m.semver.major === p.major && m.semver.minor === p.minor && m.semver.patch === p.patch && (p = !1), m.operator === ">" || m.operator === ">=") {
        if (o = Cl(i, m, r), o === m && o !== i)
          return !1;
      } else if (i.operator === ">=" && !Ur(i.semver, String(m), r))
        return !1;
    }
    if (a) {
      if (u && m.semver.prerelease && m.semver.prerelease.length && m.semver.major === u.major && m.semver.minor === u.minor && m.semver.patch === u.patch && (u = !1), m.operator === "<" || m.operator === "<=") {
        if (l = Il(a, m, r), l === m && l !== a)
          return !1;
      } else if (a.operator === "<=" && !Ur(a.semver, String(m), r))
        return !1;
    }
...
var oE = iE;
const Aa = wn, Rl = Li, lE = Ue, Pl = Sf, cE = Ir, uE = gw, fE = xw, dE = vw, pE = _w, hE = Aw, mE = Rw, gE = Dw, yE = Fw, wE = Ze, xE = Mw, EE = Gw, vE = Fs, TE = Xw, _E = Yw, bE = Mi, SE = $s, AE = Af, CE = Cf, IE = Ls, RE = Us, PE = If, OE = wx, DE = Bi(), kE = et(), NE = ji, FE = Sx, $E = Rx, LE = kx, UE = $x, ME = Mx, BE = Ms, jE = Yx, GE = Qx, zE = eE, HE = nE, qE = oE;
var Pf = {
  parse: cE,
  valid: uE,
  clean: fE,
...
vi.exports;
(function(e, t) {
  var r = 200, n = "__lodash_hash_undefined__", i = 1, a = 2, s = 9007199254740991, o = "[object Arguments]", l = "[object Array]", d = "[object AsyncFunction]", c = "[object Boolean]", u = "[object Date]", p = "[object Error]", m = "[object Function]", x = "[object GeneratorFunction]", w = "[object Map]", T = "[object Number]", _ = "[object Null]", b = "[object Object]", P = "[object Promise]", F = "[object Proxy]", U = "[object RegExp]", k = "[object Set]", G = "[object String]", Q = "[object Symbol]", y = "[object Undefined]", B = "[object WeakMap]", M = "[object ArrayBuffer]", L = "[object DataView]", X = "[object Float32Array]", R = "[object Float64Array]", S = "[object Int8Array]", D = "[object Int16Array]", A = "[object Int32Array]", $ = "[object Uint8Array]", O = "[object Uint8ClampedArray]", q = "[object Uint16Array]", K = "[object Uint32Array]", W = /[\\^$.*+?()[\]{}|]/g, ne = /^\[object .+?Constructor\]$/, ge = /^(?:0|[1-9]\d*)$/, H = {};
  H[X] = H[R] = H[S] = H[D] = H[A] = H[$] = H[O] = H[q] = H[K] = !0, H[o] = H[l] = H[M] = H[c] = H[L] = H[u] = H[p] = H[m] = H[w] = H[T] = H[b] = H[U] = H[k] = H[G] = H[B] = !1;
  var tt = typeof De == "object" && De && De.Object === Object && De, h = typeof self == "object" && self && self.Object === Object && self, f = tt || h || Function("return this")(), C = t && !t.nodeType && t, v = C && !0 && e && !e.nodeType && e, ee = v && v.exports === C, se = ee && tt.process, fe = function() {
    try {
  ...
  function Ae(g, E) {
    for (var I = -1, j = g == null ? 0 : g.length, oe = 0, Y = []; ++I < j; ) {
      var de = g[I];
      E(de, I, g) && (Y[oe++] = de);
    }
    return Y;
  ...
  function mt(g, E) {
    for (var I = -1, j = E.length, oe = g.length; ++I < j; )
      g[oe + I] = E[I];
    return g;
  }
  function he(g, E) {
    for (var I = -1, j = g == null ? 0 : g.length; ++I < j; )
      if (E(g[I], I, g))
        return !0;
    return !1;
  }
  ...
  function An(g) {
    var E = -1, I = Array(g.size);
    return g.forEach(function(j, oe) {
      I[++E] = [oe, j];
    }), I;
  }
  function hd(g, E) {
  ...
  var gd = Array.prototype, yd = Function.prototype, Cn = Object.prototype, ta = f["__core-js_shared__"], Js = yd.toString, rt = Cn.hasOwnProperty, Qs = function() {
    var g = /[^.]+$/.exec(ta && ta.keys && ta.keys.IE_PROTO || "");
    return g ? "Symbol(src)_1." + g : "";
  }(), Zs = Cn.toString, wd = RegExp(
    "^" + Js.call(rt).replace(W, "\\$&").replace(/hasOwnProperty|(function).*?(?=\\\()| for .+?(?=\\\])/g, "$1.*?") + "$"
  ), eo = ee ? f.Buffer : void 0, In = f.Symbol, to = f.Uint8Array, ro = Cn.propertyIsEnumerable, xd = gd.splice, Ft = In ? In.toStringTag : void 0, no = Object.getOwnPropertySymbols, Ed = eo ? eo.isBuffer : void 0, vd = hd(Object.keys, Object), ra = nr(f, "DataView"), Or = nr(f, "Map"), na = nr(f, "Promise"), ia = nr(f, "Set"), aa = nr(f, "WeakMap"), Dr = nr(Object, "create"), Td = Ut(ra), _d = Ut(Or), bd = Ut(na), Sd = Ut(ia), Ad = Ut(aa), io = In ? In.prototype : void 0, sa = io ? io.valueOf : void 0;
  function $t(g) {
    var E = -1, I = g == null ? 0 : g.length;
    for (this.clear(); ++E < I; ) {
      var j = g[E];
      this.set(j[0], j[1]);
    }
  ...
  function Pd(g) {
    var E = this.__data__;
    return Dr ? E[g] !== void 0 : rt.call(E, g);
  }
  function Od(g, E) {
    var I = this.__data__;
    return this.size += this.has(g) ? 0 : 1, I[g] = Dr && E === void 0 ? n : E, this;
  }
  $t.prototype.clear = Cd, $t.prototype.delete = Id, $t.prototype.get = Rd, $t.prototype.has = Pd, $t.prototype.set = Od;
  function ct(g) {
    var E = -1, I = g == null ? 0 : g.length;
    for (this.clear(); ++E < I; ) {
      var j = g[E];
  ...
  function kd(g) {
    var E = this.__data__, I = Pn(E, g);
    if (I < 0)
      return !1;
    var j = E.length - 1;
    return I == j ? E.pop() : xd.call(E, I, 1), --this.size, !0;
  }
  function Nd(g) {
    var E = this.__data__, I = Pn(E, g);
  ...
  function $d(g, E) {
    var I = this.__data__, j = Pn(I, g);
    return j < 0 ? (++this.size, I.push([g, E])) : I[j][1] = E, this;
  }
  ct.prototype.clear = Dd, ct.prototype.delete = kd, ct.prototype.get = Nd, ct.prototype.has = Fd, ct.prototype.set = $d;
  function Lt(g) {
    var E = -1, I = g == null ? 0 : g.length;
    for (this.clear(); ++E < I; ) {
      var j = g[E];
  ...
  Rn.prototype.add = Rn.prototype.push = Gd, Rn.prototype.has = zd;
  function gt(g) {
  ...
  function qd(g) {
    var E = this.__data__, I = E.delete(g);
  ...
  function Vd(g, E) {
    ...
    if (I instanceof ct) {
      var j = I.__data__;
      if (!Or || j.length < r - 1)
        return j.push([g, E]), this.size = ++I.size, this;
      I = this.__data__ = new Lt(j);
    }
  ...
  function Yd(g, E) {
    var I = Dn(g), j = !I && up(g), oe = !I && !j && oa(g), Y = !I && !j && !oe && ho(g), de = I || j || oe || Y, ye = de ? Ye(g.length, String) : [], Te = ye.length;
    for (var le in g)
      ...
      Y && (le == "buffer" || le == "byteLength" || le == "byteOffset") || // Skip index properties.
      ap(le, Te))) && ye.push(le);
    return ye;
  }
  function Pn(g, E) {
  ...
  function Kd(g, E, I) {
    var j = E(g);
    return Dn(g) ? j : mt(j, I(g));
  }
  function kr(g) {
    return g == null ? g === void 0 ? y : _ : Ft && Ft in Object(g) ? np(g) : cp(g);
  }
  function ao(g) {
    return Nr(g) && kr(g) == o;
  }
  function so(g, E, I, j, oe) {
    return g === E ? !0 : g == null || E == null || !Nr(g) && !Nr(E) ? g !== g && E !== E : Jd(g, E, I, j, so, oe);
  }
  function Jd(g, E, I, j, oe, Y) {
    var de = Dn(g), ye = Dn(E), Te = de ? l : yt(g), le = ye ? l : yt(E);
    Te = Te == o ? b : Te, le = le == o ? b : le;
    var je = Te == b, Ke = le == b, Ce = Te == le;
    if (Ce && oa(g)) {
      if (!oa(E))
        return !1;
      de = !0, je = !1;
    ...
    if (Ce && !je)
      return Y || (Y = new gt()), de || ho(g) ? oo(g, E, I, j, oe, Y) : tp(g, E, Te, I, j, oe, Y);
    if (!(I & i)) {
      var He = je && rt.call(g, "__wrapped__"), qe = Ke && rt.call(E, "__wrapped__");
      if (He || qe) {
        var wt = He ? g.value() : g, ut = qe ? E.value() : E;
        return Y || (Y = new gt()), oe(wt, ut, I, j, Y);
      }
    }
    return Ce ? (Y || (Y = new gt()), rp(g, E, I, j, oe, Y)) : !1;
  }
  function Qd(g) {
    if (!po(g) || op(g))
      return !1;
  ...
  function Zd(g) {
    return Nr(g) && fo(g.length) && !!H[kr(g)];
  }
  function ep(g) {
    if (!lp(g))
      return vd(g);
    ...
    for (var I in Object(g))
      rt.call(g, I) && I != "constructor" && E.push(I);
    return E;
  }
  function oo(g, E, I, j, oe, Y) {
    var de = I & i, ye = g.length, Te = E.length;
    if (ye != Te && !(de && Te > ye))
      return !1;
    var le = Y.get(g);
    if (le && Y.get(E))
      return le == E;
    var je = -1, Ke = !0, Ce = I & a ? new Rn() : void 0;
    for (Y.set(g, E), Y.set(E, g); ++je < ye; ) {
      var He = g[je], qe = E[je];
      if (j)
        var wt = de ? j(qe, He, je, E, g, Y) : j(He, qe, je, g, E, Y);
      if (wt !== void 0) {
        if (wt)
          continue;
        Ke = !1;
      ...
      if (Ce) {
        if (!he(E, function(ut, Mt) {
          if (!Sn(Ce, Mt) && (He === ut || oe(He, ut, I, j, Y)))
            return Ce.push(Mt);
        })) {
          Ke = !1;
          break;
        }
      } else if (!(He === qe || oe(He, qe, I, j, Y))) {
        Ke = !1;
        break;
      }
    }
    return Y.delete(g), Y.delete(E), Ke;
  }
  function tp(g, E, I, j, oe, Y, de) {
    switch (I) {
      case L:
      ...
      case M:
        return !(g.byteLength != E.byteLength || !Y(new to(g), new to(E)));
      case c:
      case u:
      case T:
        return co(+g, +E);
      ...
      case k:
        ...
        if (le)
          return le == E;
        j |= a, de.set(g, E);
        var je = oo(ye(g), ye(E), j, oe, Y, de);
        return de.delete(g), je;
      case Q:
        if (sa)
          return sa.call(g) == sa.call(E);
    }
    return !1;
  }
  function rp(g, E, I, j, oe, Y) {
    var de = I & i, ye = lo(g), Te = ye.length, le = lo(E), je = le.length;
    if (Te != je && !de)
      return !1;
    for (var Ke = Te; Ke--; ) {
      var Ce = ye[Ke];
      if (!(de ? Ce in E : rt.call(E, Ce)))
        return !1;
    }
    var He = Y.get(g);
    if (He && Y.get(E))
    ...
    for (var wt = de; ++Ke < Te; ) {
      ...
      var ut = g[Ce], Mt = E[Ce];
      if (j)
        var mo = de ? j(Mt, ut, Ce, E, g, Y) : j(ut, Mt, Ce, g, E, Y);
      if (!(mo === void 0 ? ut === Mt || oe(ut, Mt, I, j, Y) : mo)) {
        qe = !1;
        break;
      }
      wt || (wt = Ce == "constructor");
    }
    if (qe && !wt) {
    ...
    return Y.delete(g), Y.delete(E), qe;
  }
  function lo(g) {
    return Kd(g, pp, ip);
  }
  function On(g, E) {
    var I = g.__data__;
    return sp(E) ? I[typeof E == "string" ? "string" : "hash"] : I.map;
  }
  function nr(g, E) {
    var I = Pr(g, E);
    return Qd(I) ? I : void 0;
  }
  function np(g) {
    var E = rt.call(g, Ft), I = g[Ft];
    try {
      g[Ft] = void 0;
      var j = !0;
    } catch {
    ...
    var oe = Zs.call(g);
    return j && (E ? g[Ft] = I : delete g[Ft]), oe;
  }
  var ip = no ? function(g) {
    return g == null ? [] : (g = Object(g), Ae(no(g), function(E) {
      return ro.call(g, E);
    }));
  } : hp, yt = kr;
  (ra && yt(new ra(new ArrayBuffer(1))) != L || Or && yt(new Or()) != w || na && yt(na.resolve()) != P || ia && yt(new ia()) != k || aa && yt(new aa()) != B) && (yt = function(g) {
    var E = kr(g), I = E == b ? g.constructor : void 0, j = I ? Ut(I) : "";
    if (j)
      switch (j) {
        case Td:
          return L;
  ...
  function lp(g) {
    var E = g && g.constructor, I = typeof E == "function" && E.prototype || Cn;
    return g === I;
  }
  function cp(g) {
    return Zs.call(g);
...
const WE = dn, VE = Dt, Ol = XE, zt = kt, Vr = ue;
class YE {
  constructor(t) {
...
var En = {}, Ve = {}, rv = "[object Symbol]", Df = /[\\^$.*+?()[\]{}|]/g, nv = RegExp(Df.source), iv = typeof De == "object" && De && De.Object === Object && De, av = typeof self == "object" && self && self.Object === Object && self, sv = iv || av || Function("return this")(), ov = Object.prototype, lv = ov.toString, kl = sv.Symbol, Nl = kl ? kl.prototype : void 0, Fl = Nl ? Nl.toString : void 0;
function cv(e) {
  if (typeof e == "string")
    return e;
  if (fv(e))
...
function pv(e) {
  return e = dv(e), e && nv.test(e) ? e.replace(Df, "\\$&") : e;
}
var hv = pv;
Object.defineProperty(Ve, "__esModule", { value: !0 });
Ve.newBaseUrl = gv;
Ve.newUrlFromBase = rs;
Ve.getChannelFilename = yv;
Ve.blockmapFiles = wv;
const kf = br, mv = hv;
function gv(e) {
...
function _v(e, t, r = (n) => n) {
  const i = Nf(e).map((o) => {
    if (o.sha2 == null && o.sha512 == null)
      throw (0, Pt.newError)(`Update info doesn't contain nor sha256 neither sha512 checksum: ${(0, Pt.safeStringifyJson)(o)}`, "ERR_UPDATER_NO_CHECKSUM");
    return {
...
const Ul = Ee, Pa = Ve, Oa = me;
class Sv extends Oa.Provider {
  constructor(t, r, n) {
    super({
      ...n,
    ...
    this.baseUrl = (0, Pa.newBaseUrl)(`https://api.bitbucket.org/2.0/repositories/${i}/${a}/downloads`);
  }
  get channel() {
    return this.updater.channel || this.configuration.channel || "latest";
  }
  async getLatestVersion() {
    const t = new Ul.CancellationToken(), r = (0, Pa.getChannelFilename)(this.getCustomChannelName(this.channel)), n = (0, Pa.newUrlFromBase)(r, this.baseUrl, this.updater.isAddNoCacheQuery);
    try {
...
const ft = Ee, hr = Pf, Av = br, mr = Ve, ns = me, Da = /\/tag\/([^/]+)$/;
  ...
  async getLatestVersion() {
    ...
    try {
      if (this.updater.allowPrerelease) {
        ...
        if (T === null)
          c = Da.exec(d.element("link").attribute("href"))[1];
        else
          for (const _ of l.getElements("entry")) {
            const b = Da.exec(_.element("link").attribute("href"));
            if (b === null)
              continue;
            const P = b[1], F = ((n = hr.prerelease(P)) === null || n === void 0 ? void 0 : n[0]) || null, U = !T || ["alpha", "beta"].includes(T), k = F !== null && !["alpha", "beta"].includes(String(F));
            if (U && !k && !(T === "beta" && F === "alpha")) {
              c = P;
              break;
            }
            if (F && F === T) {
        ...
        for (const T of l.getElements("entry"))
          if (Da.exec(T.element("link").attribute("href"))[1] === c) {
            d = T;
            break;
          }
      }
...
${o}`, "ERR_UPDATER_INVALID_RELEASE_FEED");
    ...
    const x = async (T) => {
      ...
      const _ = this.createRequestOptions(m);
      try {
        return await this.executor.request(_, s);
      } catch (b) {
        throw b instanceof ft.HttpError && b.statusCode === 404 ? (0, ft.newError)(`Cannot find ${p} in the latest release artifacts (${m}): ${b.stack || b.message}`, "ERR_UPDATER_CHANNEL_FILE_NOT_FOUND") : b;
      }
    };
    try {
      let T = this.channel;
      this.updater.allowPrerelease && (!((i = hr.prerelease(c)) === null || i === void 0) && i[0]) && (T = this.getCustomChannelName(String((a = hr.prerelease(c)) === null || a === void 0 ? void 0 : a[0]))), u = await x(T);
    } catch (T) {
      if (this.updater.allowPrerelease)
...
const Bl = Ee, ka = Ve, Na = me;
class Iv extends Na.Provider {
  constructor(t, r, n) {
    super({
      ...n,
      isUseMultipleRangeRequest: !1
  ...
  async getLatestVersion() {
    const t = new Bl.CancellationToken(), r = (0, ka.getChannelFilename)(this.getCustomChannelName(this.channel)), n = (0, ka.newUrlFromBase)(r, this.baseUrl, this.updater.isAddNoCacheQuery);
    try {
...
qi.KeygenProvider = Iv;
var Xi = {};
Object.defineProperty(Xi, "__esModule", { value: !0 });
Xi.PrivateGitHubProvider = void 0;
const sr = Ee, Rv = Se, Pv = ue, jl = br, Gl = Ve, Ov = Ot, Dv = me;
class kv extends Ov.BaseGitHubProvider {
  ...
  async getLatestVersion() {
    const t = new sr.CancellationToken(), r = (0, Gl.getChannelFilename)(this.getDefaultChannelName()), n = await this.getLatestVersionInfo(t), i = n.assets.find((o) => o.name === r);
    if (i == null)
  ...
  resolveFiles(t) {
    return (0, Dv.getFileList)(t).map((r) => {
      const n = Pv.posix.basename(r.url).replace(/ /g, "-"), i = t.assets.find((a) => a != null && a.name === n);
      if (i == null)
...
Xi.PrivateGitHubProvider = kv;
Object.defineProperty(zi, "__esModule", { value: !0 });
zi.isUrlProbablySupportMultiRangeRequests = Lf;
zi.createClient = Uv;
const Vn = Ee, Nv = Hi, zl = En, Fv = Ot, $v = qi, Lv = Xi;
function Lf(e) {
...
function Mv(e, t, r) {
  ...
  for (let w = 0; w < c.checksums.length; x += c.sizes[w], w++) {
    const T = c.sizes[w], _ = c.checksums[w];
    let b = p.get(_);
    b != null && m.get(_) !== T && (r.warn(`Checksum ("${_}") matches, but size differs (old: ${m.get(_)}, new: ${T})`), b = void 0), b === void 0 ? (u++, a != null && a.kind === Wt.DOWNLOAD && a.end === x ? a.end += T : (a = {
      kind: Wt.DOWNLOAD,
      start: x,
      end: x + T
      // oldBlocks: null,
    }, Hl(a, o, _, w))) : a != null && a.kind === Wt.COPY && a.end === b ? a.end += T : (a = {
      kind: Wt.COPY,
      start: b,
      end: b + T
      // oldBlocks: [checksum]
...
Rr.copyData = Uf;
const Yn = Ee, Gv = Dt, zv = fn, Hv = rr, Xl = Buffer.from(`\r
\r
`);
var vt;
(function(e) {
...
function Wv(e, t, r, n, i) {
  ...
  const c = e.httpExecutor.createRequest(d, (u) => {
    ...
    const x = new Wl.DataSplitter(r, t, o, m[1] || m[2], l, n);
...
const Mr = Ee, Fa = kt, Kv = Dt, Jv = Rr, Qv = br, Kn = rr, Yl = Vi, Zv = Yi;
class eT {
  ...
  async doDownloadFile(t, r) {
    ...
    await new Promise((s, o) => {
      ...
      if (!this.options.isUseMultipleRangeRequest && this.options.onProgress) {
        ...
        let b = 0;
        for (const F of t)
          F.kind === Kn.OperationKind.DOWNLOAD && (_.push(F.end - F.start), b += F.end - F.start);
        const P = {
          expectedByteCounts: _,
          grandTotal: b
        };
        d = new Zv.ProgressDifferentialDownloadCallbackTransform(P, this.options.cancellationToken, this.options.onProgress), l.push(d);
      }
      ...
      T.redirect = "manual", m = (_) => {
        ...
        const F = t[_++];
        if (F.kind === Kn.OperationKind.COPY) {
          d && d.beginFileCopy(), (0, Jv.copyData)(F, p, n, o, () => m(_));
          return;
        }
        const U = `bytes=${F.start}-${F.end - 1}`;
        T.headers.range = U, (P = (b = this.logger) === null || b === void 0 ? void 0 : b.debug) === null || P === void 0 || P.call(b, `download range: ${U}`), d && d.beginRangeDownload();
        const k = this.httpExecutor.createRequest(T, (G) => {
          G.on("error", o), G.on("aborted", () => {
            o(new Error("response has been aborted by the server"));
          }), G.statusCode >= 400 && o((0, Mr.createHttpError)(G)), G.pipe(p, {
            end: !1
          }), G.once("end", () => {
            d && d.endRangeDownload(), ++x === 100 ? (x = 0, setTimeout(() => m(_), 1e3)) : m(_);
          });
        });
        k.on("redirect", (G, Q, y) => {
          this.logger.info(`Redirect to ${tT(y)}`), w = y, (0, Mr.configureRequestUrl)(new Qv.URL(w), T), k.followRedirect();
...
const Oe = Ee, iT = dn, aT = Ci, sT = Rc, or = kt, oT = Se, $a = $i, Bt = ue, Ht = Pf, Jl = xn, lT = Gi, Ql = Of, cT = En, La = zi, uT = Oc, fT = Ve, dT = Wi, lr = Nt;
class zs extends sT.EventEmitter {
  /**
  ...
  async getOrCreateStagingUserId() {
    ...
    const r = Oe.UUID.v5((0, iT.randomBytes)(4096), Oe.UUID.OID);
  ...
  async executeDownload(t) {
    ...
    function o() {
      ...
      return b.endsWith(`.${t.fileExtension}`) ? Bt.basename(b) : t.fileInfo.info.url;
    }
    const l = await this.getOrCreateDownloadHelper(), d = l.cacheDirForPendingUpdate;
    await (0, or.mkdir)(d, { recursive: !0 });
    const c = o();
    let u = Bt.join(d, c);
    const p = s == null ? null : Bt.join(d, `package-${a}${Bt.extname(s.path) || ".7z"}`), m = async (b) => (await l.setDownloadedFile(u, p, i, r, c, b), await t.done({
      ...i,
      downloadedFile: u
    ...
    })), _ = await (0, Jl.createTempUpdateFile)(`temp-${c}`, d, x);
    try {
      await t.task(_, n, p, T), await (0, Oe.retry)(() => (0, or.rename)(_, u), 60, 500, 0, 0, (b) => b instanceof Error && /^EBUSY:/.test(b.message));
    } catch (b) {
      throw await T(), b instanceof Oe.CancellationError && (x.info("cancelled"), this.emit("update-cancelled", i)), b;
    }
...
const ec = Ee, tc = Ai, ET = kt, vT = Dt, Br = ue, TT = ht, _T = Tn, bT = me, rc = Nt;
...
const AT = ht, CT = me, nc = Nt;
class IT extends AT.BaseUpdater {
  constructor(t, r) {
    super(t, r);
  }
  /*** @private */
...
class OT extends RT.BaseUpdater {
  ...
  /*** @private */
  doDownloadUpdate(t) {
    const r = t.updateInfoAndProvider.provider, n = (0, PT.findFile)(r.resolveFiles(t.updateInfoAndProvider.info), "pacman", ["AppImage", "deb", "rpm"]);
    return this.executeDownload({
...
const DT = ht, ac = Nt, kT = me;
class NT extends DT.BaseUpdater {
  constructor(t, r) {
    super(t, r);
  }
  /*** @private */
...
const sc = Ee, Ua = kt, FT = Dt, oc = ue, $T = _p, LT = Ct, UT = me, lc = Ai, cc = dn;
class MT extends LT.AppUpdater {
  ...
  async doDownloadUpdate(t) {
    ...
    return this.executeDownload({
      ...
      downloadUpdateOptions: t,
      task: async (u, p) => {
        const m = oc.join(this.downloadedUpdateHelper.cacheDir, c), x = () => (0, Ua.pathExistsSync)(m) ? !t.disableDifferentialDownload : (n.info("Unable to locate previous update.zip for differential download (is this first install?), falling back to full download"), !1);
        let w = !0;
    ...
    return await new Promise((d, c) => {
      ...
      this.server.on("request", (x, w) => {
        ...
        if (s.info(`${T} requested`), T === "/") {
          ...
          const P = x.headers.authorization.split(" ")[1], F = Buffer.from(P, "base64").toString("ascii"), [U, k] = F.split(":");
        ...
        const b = (0, FT.createReadStream)(i);
        b.on("error", (P) => {
          try {
            w.end();
          } catch (F) {
            s.warn(`cannot end response: ${F}`);
          }
          _ = !0, this.nativeUpdater.removeListener("error", c), c(new Error(`Cannot pipe "${i}": ${P}`));
        }), w.writeHead(200, {
        ...
        if (c.Status === 0) {
          try {
            ...
            if (r.info(`LiteralPath: ${x}. Update Path: ${w}`), x !== w) {
              Ma(r, new Error(`LiteralPath of ${x} is different than ${w}`), l, i), n(null);
              return;
            }
          } catch (x) {
          ...
          for (const x of e) {
            ...
            if (w.size ? m = Array.from(w.keys()).every((_) => w.get(_) === p.get(_)) : x === p.get("CN") && (r.warn(`Signature validated using only CN ${x}. Please add your full Distinguished Name (DN) to publisherNames configuration`), m = !0), m) {
              n(null);
              return;
            }
          }
...
const Jn = Ee, dc = ue, HT = ht, qT = Tn, pc = Nt, XT = me, WT = kt, VT = Hs, hc = br;
  ...
  async differentialDownloadWebPackage(t, r, n, i) {
    ...
    try {
      const a = {
        ...
        oldFile: dc.join(this.downloadedUpdateHelper.cacheDir, Jn.CURRENT_APP_PACKAGE_FILE_NAME),
        logger: this._logger,
        newFile: n,
...
un.NsisUpdater = YT;
(function(e) {
  var t = De && De.__createBinding || (Object.create ? function(T, _, b, P) {
    P === void 0 && (P = b);
    var F = Object.getOwnPropertyDescriptor(_, b);
    (!F || ("get" in F ? !_.__esModule : F.writable || F.configurable)) && (F = { enumerable: !0, get: function() {
      return _[b];
    } }), Object.defineProperty(T, P, F);
  } : function(T, _, b, P) {
    P === void 0 && (P = b), T[P] = _[b];
  }), r = De && De.__exportStar || function(T, _) {
...
const Kt = {
  ...
  put(e, t, r) {
    return V(e).setUint16(t, r, !0), t + 2;
  }
}, Xt = {
  len: 2,
  get(e, t) {
  ...
  put(e, t, r) {
    return V(e).setUint32(t, r, !0), t + 4;
  }
}, Ti = {
  len: 4,
  get(e, t) {
  ...
  put(e, t, r) {
    return V(e).setUint32(t, r), t + 4;
  }
}, ls = {
  len: 1,
  get(e, t) {
    return V(e).getInt8(t);
  },
  put(e, t, r) {
    return V(e).setInt8(t, r), t + 1;
  }
}, h_ = {
  len: 2,
  get(e, t) {
    return V(e).getInt16(t);
  },
  put(e, t, r) {
    return V(e).setInt16(t, r), t + 2;
  }
}, m_ = {
  len: 2,
  get(e, t) {
    return V(e).getInt16(t, !0);
  },
  put(e, t, r) {
    return V(e).setInt16(t, r, !0), t + 2;
  }
}, g_ = {
  len: 3,
  get(e, t) {
  ...
  put(e, t, r) {
    return V(e).setInt32(t, r), t + 4;
  }
}, w_ = {
  len: 4,
  get(e, t) {
    return V(e).getInt32(t, !0);
  },
  put(e, t, r) {
    return V(e).setInt32(t, r, !0), t + 4;
  }
}, Xf = {
  len: 8,
  get(e, t) {
  ...
  put(e, t, r) {
    return V(e).setBigUint64(t, r, !0), t + 8;
  }
}, x_ = {
  len: 8,
  get(e, t) {
    return V(e).getBigInt64(t, !0);
  },
  put(e, t, r) {
    return V(e).setBigInt64(t, r, !0), t + 8;
  }
}, E_ = {
  len: 8,
  get(e, t) {
    return V(e).getBigUint64(t);
  },
  put(e, t, r) {
    return V(e).setBigUint64(t, r), t + 8;
  }
}, v_ = {
  len: 8,
  get(e, t) {
    return V(e).getBigInt64(t);
  },
  put(e, t, r) {
    return V(e).setBigInt64(t, r), t + 8;
  }
}, T_ = {
  len: 2,
  get(e, t) {
  ...
  len: 4,
  get(e, t) {
    return V(e).getFloat32(t);
  },
  put(e, t, r) {
    return V(e).setFloat32(t, r), t + 4;
  }
}, S_ = {
  len: 4,
  get(e, t) {
    return V(e).getFloat32(t, !0);
  },
  put(e, t, r) {
    return V(e).setFloat32(t, r, !0), t + 4;
  }
}, A_ = {
  len: 8,
  get(e, t) {
    return V(e).getFloat64(t);
  },
  put(e, t, r) {
    return V(e).setFloat64(t, r), t + 8;
  }
}, C_ = {
  len: 8,
  get(e, t) {
    return V(e).getFloat64(t, !0);
  },
  put(e, t, r) {
    return V(e).setFloat64(t, r, !0), t + 8;
  }
}, I_ = {
  len: 10,
  get(e, t) {
...
const aA = /* @__PURE__ */ Object.freeze(/* @__PURE__ */ Object.defineProperty({
  ...
  get(e) {
    ...
    return {
      signature: J.get(e, 0),
      minVersion: ae.get(e, 4),
      dataDescriptor: !!(t & 8),
      compressedMethod: ae.get(e, 8),
      compressedSize: J.get(e, 18),
      uncompressedSize: J.get(e, 22),
      filenameLength: ae.get(e, 26),
      extraFieldLength: ae.get(e, 28),
      filename: null
    };
  },
  len: 30
  ...
  get(e) {
    return {
      signature: J.get(e, 0),
      nrOfThisDisk: ae.get(e, 4),
      nrOfThisDiskWithTheStart: ae.get(e, 6),
      nrOfEntriesOnThisDisk: ae.get(e, 8),
      nrOfEntriesOfSize: ae.get(e, 10),
      sizeOfCd: J.get(e, 12),
      offsetOfStartOfCd: J.get(e, 16),
      zipFileCommentLength: ae.get(e, 20)
    };
  },
  len: 22
}, N_ = {
  get(e) {
    ...
    return {
      signature: J.get(e, 0),
      minVersion: ae.get(e, 6),
      dataDescriptor: !!(t & 8),
      compressedMethod: ae.get(e, 10),
      compressedSize: J.get(e, 20),
      uncompressedSize: J.get(e, 24),
      filenameLength: ae.get(e, 28),
      extraFieldLength: ae.get(e, 30),
      fileCommentLength: ae.get(e, 32),
...
const nt = Cr("tokenizer:inflate"), Ba = 256 * 1024, F_ = Vf(yr.DataDescriptor), Qn = Vf(yr.EndOfCentralDirectory);
class Xs {
  constructor(t) {
...
class J_ {
  constructor(t) {
    ...
    Xe(this, "detectConfident", async (t) => {
...
`, { offset: 2, encoding: r }) ? {
    ...
    Xe(this, "detectImprecise", async (t) => {
  ...
  async readTiffTag(t) {
    const r = await this.tokenizer.readToken(t ? Xt : ae);
  ...
  async readTiffHeader(t) {
    const r = (t ? Xt : ae).get(this.buffer, 2), n = (t ? Ti : J).get(this.buffer, 4);
    if (r === 42) {
      if (n >= 6) {
        ...
        if (n >= 8) {
          const a = (t ? Xt : ae).get(this.buffer, 8), s = (t ? Xt : ae).get(this.buffer, 10);
...
class Vs extends _n("FieldDecodingError") {
}
  ...
  async postMap(t, r) {
    switch (r.id) {
      ...
      case "comment":
        ...
        break;
      case "lyrics":
        typeof r.value == "string" && (r.value = Gb(r.value));
        break;
    }
...
const Vb = {
  ...
  async load() {
    return (await import("./MpegParser-rj6zY9z5.js")).MpegParser;
  }
}, Yb = {
  parserType: "apev2",
  extensions: [".ape"],
  ...
  async load() {
    return (await import("./AsfParser-BeJRkkPy.js")).AsfParser;
  }
}, Jb = {
  parserType: "dsdiff",
  extensions: [".dff"],
  ...
  async load() {
    return (await import("./DsdiffParser-Hguicjxt.js")).DsdiffParser;
  }
}, Qb = {
  parserType: "aiff",
  ...
  async load() {
    return (await import("./AiffParser-DXVwcqVJ.js")).AIFFParser;
  }
}, Zb = {
  parserType: "dsf",
  extensions: [".dsf"],
  mimeTypes: ["audio/dsf"],
  async load() {
    return (await import("./DsfParser-BGp9dWOR.js")).DsfParser;
  }
}, eS = {
  parserType: "flac",
  extensions: [".flac"],
  ...
  async load() {
    return (await import("./FlacParser-DHVeK__o.js").then((e) => e.d)).FlacParser;
  }
}, tS = {
  parserType: "matroska",
  ...
  async load() {
    return (await import("./MatroskaParser-04r7WBUC.js")).MatroskaParser;
  }
}, rS = {
  parserType: "mp4",
  ...
  async load() {
    return (await import("./MP4Parser-DdD-YJef.js")).MP4Parser;
  }
}, nS = {
  parserType: "musepack",
  extensions: [".mpc"],
  ...
  async load() {
    return (await import("./MusepackParser-DD3broCq.js")).MusepackParser;
  }
}, iS = {
  parserType: "ogg",
  ...
  async load() {
    return (await import("./OggParser-CJMjFt02.js")).OggParser;
  }
}, aS = {
  parserType: "wavpack",
  extensions: [".wv", ".wvp"],
  ...
  async load() {
    return (await import("./WavPackParser-CrA9CpWt.js")).WavPackParser;
  }
}, sS = {
  parserType: "riff",
  ...
  async load() {
    return (await import("./WaveParser-DsSfgmYg.js")).WaveParser;
  }
...
class lS {
  ...
  async parse(t, r, n) {
    if (t.supportsRandomAccess() ? (Gt("tokenizer supports random-access, scanning for appending headers"), await PS(t, n)) : Gt("tokenizer does not support random-access, cannot scan for appending headers"), !r) {
...
const _S = /^[\x21-\x7e©][\x20-\x7e\x00()]{3}/, od = {
  ...
  get: (e, t) => ({
    ...
    compressionLevel: ae.get(e, t),
    // any format flags (for future use)
    formatFlags: ae.get(e, t + 2),
    ...
    bitsPerSample: ae.get(e, t + 16),
    // the number of channels (1 or 2)
    channel: ae.get(e, t + 18),
...
class At extends id {
  ...
  async parseTags(t) {
    ...
    for (let i = 0; i < t.fields; i++) {
      ...
      const a = await this.tokenizer.readToken(za);
      n -= za.len + a.size, await this.tokenizer.peekBuffer(r, { length: Math.min(r.length, n) });
...
}, Symbol.toStringTag, { value: "Module" })), ni = Cr("music-metadata:parser:ID3v1"), bc = [
  "Blues",
  "Classic Rock",
  "Country",
  "Dance",
...
class OS {
  constructor() {
    Xe(this, "client", null);
    Xe(this, "player", Ap());
    Xe(this, "currentResource", null);
    Xe(this, "currentConnection", null);
    Xe(this, "streamInput", null);
    Xe(this, "currentProcess", null);
    Xe(this, "isConnected", !1);
    Xe(this, "currentGuildId", null);
    Xe(this, "currentChannelId", null);
  ...
  async joinChannel(t, r) {
    ...
    try {
      return this.currentConnection = Cp({
        channelId: r,
        guildId: t,
        adapterCreator: n.voiceAdapterCreator,
        selfDeaf: !0,
        selfMute: !1
      }), this.currentConnection.on("stateChange", async (a, s) => {
        const o = s.status;
        if (o === "disconnected")
          try {
            await Promise.race([
              import("@discordjs/voice").then((l) => l.entersState(this.currentConnection, l.VoiceConnectionStatus.Signalling, 5e3)),
              import("@discordjs/voice").then((l) => l.entersState(this.currentConnection, l.VoiceConnectionStatus.Connecting, 5e3))
            ]);
          } catch {
            try {
            ...
            this.currentConnection = null, this.currentChannelId = null, this.currentGuildId = null;
          }
        else o === "destroyed" && (this.currentConnection = null, this.currentChannelId = null, this.currentGuildId = null, this.stop());
  ...
  async leaveChannel() {
    return this.stop(), this.currentConnection ? (this.currentConnection.destroy(), this.currentConnection = null, this.currentGuildId = null, this.currentChannelId = null, !0) : !1;
  }
  async disconnect() {
  ...
  async playFile(t, r) {
    var n, i, a;
    try {
      if (this.killCurrentProcess(), !this.currentConnection)
      ...
      this.currentProcess = d;
      let c = !1;
      d.on("error", (p) => {
        console.error("[DiscordBot] FFmpeg Spawn Error:", p);
      }), d.on("close", () => {
        this.currentProcess === d && (this.currentProcess = null);
  ...
  stop() {
    this.player.stop(), this.killCurrentProcess();
  }
  setVolume(t) {
  ...
  async playReceiverStream(t) {
    ...
    if (this.killCurrentProcess(), this.streamInput = new Ip(), t) {
      ...
      this.currentProcess = s, s.stdin.on("error", () => {
      }), this.streamInput.pipe(s.stdin), this.streamInput.on("error", () => {
      }), s.on("error", () => {
        this.streamInput && this.streamInput.destroy();
      }), s.on("close", () => {
        this.streamInput && this.streamInput.destroy(), this.currentProcess === s && (this.currentProcess = null);
      });
      const o = Fn(s.stdout, {
        inputType: la.Raw,
        inlineVolume: !0
...
const ud = jr(import.meta.url);
let Si = ud("ffmpeg-static");
We.isPackaged && (Si = Si.replace("app.asar", "app.asar.unpacked"));
function DS(e) {
...
const kS = We.requestSingleInstanceLock();
kS ? We.on("second-instance", () => {
  te && (te.isMinimized() && te.restore(), te.focus());
}) : We.quit();
const fd = _e.dirname(xp(import.meta.url));
process.env.APP_ROOT = _e.join(fd, "..");
const ds = process.env.VITE_DEV_SERVER_URL, yA = _e.join(process.env.APP_ROOT, "dist-electron"), dd = _e.join(process.env.APP_ROOT, "dist");
process.env.VITE_PUBLIC = ds ? _e.join(process.env.APP_ROOT, "public") : dd;
let te;
function pd() {
  te = new Cc({
    width: 1200,
    ...
    minWidth: 800,
    minHeight: 600,
    icon: _e.join(process.env.VITE_PUBLIC, "logo.png"),
    ...
    webPreferences: {
      preload: _e.join(fd, "preload.mjs"),
      webSecurity: !1,
  ...
  }), ds ? te.loadURL(ds) : te.loadFile(_e.join(dd, "index.html"));
}
We.on("window-all-closed", () => {
  process.platform !== "darwin" && (We.quit(), te = null);
});
We.on("activate", () => {
  Cc.getAllWindows().length === 0 && pd();
});
ot.autoUpdater.on("checking-for-update", () => {
  te == null || te.webContents.send("update-status", { status: "checking" });
});
ot.autoUpdater.on("update-available", (e) => {
  te == null || te.webContents.send("update-status", { status: "available", info: e });
});
ot.autoUpdater.on("update-not-available", (e) => {
  te == null || te.webContents.send("update-status", { status: "not-available", info: e });
});
ot.autoUpdater.on("error", (e) => {
  te == null || te.webContents.send("update-status", { status: "error", error: e.message });
});
ot.autoUpdater.on("download-progress", (e) => {
  te == null || te.webContents.send("update-status", { status: "downloading", progress: e });
});
ot.autoUpdater.on("update-downloaded", (e) => {
  te == null || te.webContents.send("update-status", { status: "downloaded", info: e }), new wp({
    title: "NeonWave 更新",
...
We.whenReady().then(() => {
  process.platform === "win32" && We.setAppUserModelId("NeonWave"), pd();
  const e = new OS();
  re.handle("discord:login", async (i, a) => await e.login(a)), re.handle("discord:getGuilds", () => e.getGuilds()), re.handle("discord:getChannels", (i, a) => e.getChannels(a)), re.handle("discord:join", async (i, a, s) => await e.joinChannel(a, s)), re.handle("discord:leave", async () => await e.leaveChannel()), re.handle("discord:disconnect", async () => await e.disconnect()), re.handle("discord:play", async (i, a) => await e.playFile(a, Si)), re.handle("discord:stop", () => e.stop()), re.handle("discord:pause", () => e.pause()), re.handle("discord:resume", () => e.resume()), re.handle("discord:setVolume", (i, a) => e.setVolume(a)), re.handle("discord:status", () => e.getStatus()), re.handle("discord:startStreamMode", async () => await e.playReceiverStream(Si)), re.on("discord:audio-chunk", (i, a) => {
    ...
    const { canceled: i, filePaths: a } = await go.showOpenDialog(te, {
    ...
    if (!a) return [];
    try {
      const s = await Fr.readdir(a), o = [".mp3", ".wav", ".wma", ".m4a", ".flac", ".ogg", ".mp4", ".mov", ".wmv", ".avi"];
      return (await Promise.all(s.map(async (d) => {
        const c = _e.join(a, d), u = _e.extname(d).toLowerCase();
        if (!o.includes(u)) return null;
        try {
          const p = await Fr.stat(c);
          return {
            fullPath: c,
    ...
    const i = _e.join(process.env.APP_ROOT, "scripts/get-active-window.ps1");
    return await DS(i);
  });
  const t = jr(import.meta.url)("yt-dlp-wrap").default, r = async () => {
    const i = process.platform === "win32" ? "yt-dlp.exe" : "yt-dlp", a = _e.join(We.getPath("userData"), i);
    try {
      const s = new t(a);
...
`).map((d) => {
  ...
  }), re.handle("search:youtubePreview", async (i, a, s, o) => {
    try {
      const d = await (await n()).execPromise([a, "-J", "--js-runtimes", "node"]), c = JSON.parse(d);
      let u = 0, p = !1;
      if (c.heatmap && c.heatmap.length > 0) {
        const T = c.duration || 0, _ = c.heatmap.filter((F) => F.start_time >= 15 && (T === 0 || F.start_time <= T - 15));
        u = [..._.length > 0 ? _ : c.heatmap].sort((F, U) => U.value - F.value)[0].start_time, p = !0;
      }
      if (!p && s)
        try {
          const T = o ? `${s} ${o}` : s, _ = await fetch(`https://lrclib.net/api/search?q=${encodeURIComponent(T)}`);
          if (_.ok) {
            const b = await _.json();
            if (b && b.length > 0 && b[0].syncedLyrics) {
              const F = b[0].syncedLyrics.split(`
`), U = [], k = /\[(\d{2}):(\d{2}\.\d{2})\]\s*(.*)/;
              for (const G of F) {
                const Q = G.match(k);
                if (Q) {
                  const y = parseInt(Q[1]), B = parseFloat(Q[2]), M = Q[3].trim();
                  M.length > 2 && U.push({ time: y * 60 + B, text: M });
                }
              }
              if (U.length > 0) {
                ...
                let Q = 0, y = -1;
                const B = 4;
                for (let M = 0; M <= U.length - B; M++) {
                  let L = 0;
                  for (let X = 0; X < B; X++) {
                    const R = U[M + X].text.toLowerCase(), S = G.get(R) || 0;
                    S > 1 && (L += S);
                  }
                  L > Q && (Q = L, y = M);
                }
                y !== -1 && Q >= 4 ? u = U[y].time : c.duration && (u = Math.floor(c.duration / 3));
              }
            }
          }
        } catch {
        }
      u === 0 && c.duration && (u = Math.floor(c.duration / 3));
      const m = c.formats || [];
      let x = m.filter((T) => T.acodec !== "none" && T.vcodec === "none"), w = "";
      if (x.length > 0) {
        const T = x.filter((_) => _.ext === "m4a");
        T.length > 0 && (x = T), x.sort((_, b) => (b.tbr || 0) - (_.tbr || 0)), w = x[0].url;
      } else
        m.sort((T, _) => (_.tbr || 0) - (T.tbr || 0)), m.length > 0 && (w = m[0].url);
      return {
        url: w,
        startTime: u
      };
    } catch (l) {
      return console.error("Youtube preview error:", l), null;
    }
  }), re.handle("download:youtube", async (i, a, s, o) => {
    try {
      const l = await n(), d = jr(import.meta.url)("ffmpeg-static").replace("app.asar", "app.asar.unpacked");
      let c = s.replace(/[\\/:*?"<>|]/g, "_").trim();
      const { filePath: u } = await go.showSaveDialog(te, {
        title: "下載歌曲",
        defaultPath: `${c}.m4a`,
  ...
  }), re.handle("download:youtubeToDir", async (i, a, s, o, l, d, c) => {
    try {
      const u = await n(), p = jr(import.meta.url)("ffmpeg-static").replace("app.asar", "app.asar.unpacked");
      let m = s.replace(/[\\/:*?"<>|]/g, "_").trim();
      const x = _e.join(l, `${m}.m4a`);
      return new Promise((w, T) => {
        ...
        d && d !== "0" && _.push("--limit-rate", d), _.push(
          "--js-runtimes",
          "node",
          "--ffmpeg-location",
          p,
          ...
          "-o",
          x
        ), o && (_.push("--parse-metadata", `${o}:%(artist)s`), _.push("--parse-metadata", `${o}:%(album_artist)s`)), s && _.push("--parse-metadata", `${s}:%(title)s`);
        const b = u.exec(_);
        b.on("error", (P) => {
          console.error("yt-dlp error:", P), T(new Error(`下載錯誤: ${P.message}`));
        }), b.on("close", async () => {
          if (c)
            try {
              const P = new Date(c);
              await Fr.utimes(x, P, P);
            } catch (P) {
              console.error("Failed to set file timestamp:", P);
            }
          w(x);
        });
      });
    } catch (u) {
      throw console.error("Download fatal error:", u), new Error(u.message);
    }
    ...
    try {
      const d = jr(import.meta.url)("get-artist-title");
      ...
      const c = (U) => {
        ...
        const G = [
          ...
          "乘風破浪",
          "披荊斬棘"
        ], Q = (L) => G.some((X) => L.toLowerCase().includes(X)), y = (L, X, R) => {
          const S = (A) => "\\" + A, D = new RegExp(`${S(X)}([^${S(R)}]*)?${S(R)}`, "gi");
          return L.replace(D, (A, $) => !$ || Q($) ? " " : " " + $ + " ");
        };
        return k = y(k, "(", ")"), k = y(k, "（", "）"), k = y(k, "[", "]"), k = y(k, "【", "】"), k = y(k, "{", "}"), k = y(k, "《", "》"), [
          ...
          const X = new RegExp(L.replace(/[.*+?^${}()|[\]\\]/g, "\\$&"), "gi");
          k = k.replace(X, " ");
        }), [
          "official",
          "mv",
          ...
          /^[a-z0-9]+$/i.test(L) ? k = k.replace(new RegExp(`\\b${L}\\b`, "gi"), " ") : k = k.replace(new RegExp(L, "gi"), " ");
        }), k = k.replace(/[:"'_\|\.,!@#$%^&*+=?\/\\♪♫~`\-]/g, " "), k.replace(/\s+/g, " ").trim();
      }, u = (U, k) => k ? Math.abs(U - k) : 0, p = async (U, k) => {
        try {
          const G = `https://lrclib.net/api/search?q=${encodeURIComponent(U)}`, Q = await fetch(G);
          if (!Q.ok) return [];
          const y = await Q.json();
          return Array.isArray(y) ? y.filter((B) => B.syncedLyrics && B.syncedLyrics.length > 0).map((B) => ({
            source: "LRCLib",
            id: B.id,
            track: B.trackName,
            artist: B.artistName,
            duration: B.duration,
            // in seconds
            lyrics: B.syncedLyrics,
            diff: k ? u(B.duration, k) : 0
          })) : [];
        } catch (G) {
        ...
        try {
          const G = `https://music.163.com/api/search/get/web?s=${encodeURIComponent(U)}&type=1&offset=0&total=true&limit=5`, Q = await fetch(G, {
            headers: { Referer: "https://music.163.com/", Cookie: "appver=2.0.2" }
          });
          if (!Q.ok) return [];
          const y = await Q.json();
          if (!y.result || !y.result.songs) return [];
          let B = y.result.songs.map((S) => {
            var D, A;
            return {
              id: S.id,
              track: S.name,
          ...
          if (k && (B = B.filter((S) => S.diff <= 5), B.sort((S, D) => S.diff - D.diff)), B.length === 0) return [];
          const M = B[0], L = `https://music.163.com/api/song/lyric?id=${M.id}&lv=1&kv=1&tv=-1`, R = await (await fetch(L, {
            headers: { Referer: "https://music.163.com/", Cookie: "appver=2.0.2" }
          })).json();
        ...
        if (!U) return null;
        try {
          return ud("opencc-js").Converter({ from: "cn", to: "tw" })(U);
        } catch {
          return U;
        }
      };
      ...
      if (a && s) {
        const U = `${a} ${s}`;
        console.log(`[Lyrics] Strategy A: ${U}`);
      ...
      if (T && (T !== a || _ !== s)) {
        const U = `${T} ${_}`;
        console.log(`[Lyrics] Strategy B: ${U}`);
        const [k, G] = await Promise.all([
          p(U, l),
          m(U, l)
        ]);
      ...
      if (o) {
        let U = _e.basename(o, _e.extname(o));
        const k = U.match(/(.+?)《(.+?)》(.*)/);
        if (k) {
          const y = k[1], B = k[2], M = c(y).replace(/合唱/g, "").trim(), L = c(B);
          if (L) {
            const X = `${L} ${M}`;
            console.log(`[Lyrics] Strategy C-0 (Variety Pattern): ${X}`), w.push(...await p(X, l)), w.push(...await m(X, l)), M.length > 0 && (console.log(`[Lyrics] Strategy C-0 (Title + Duration): ${L}`), w.push(...await p(L, l)), w.push(...await m(L, l)));
          }
        }
        const G = d(U.replace(/_/g, " "));
        if (G && G.length === 2) {
          const [y, B] = G, M = `${B} ${y}`;
          console.log(`[Lyrics] Strategy C-1 (Parsed): ${M}`), w.push(...await p(M, l)), w.push(...await m(M, l));
        }
        const Q = c(U);
        console.log(`[Lyrics] Strategy C-2 (Raw Cleaned): ${Q}`), w.push(...await p(Q, l)), w.push(...await m(Q, l));
      }
      if (w.length === 0)
        return console.log("[Lyrics] No candidates found."), null;
      const b = /* @__PURE__ */ new Map();
      w.forEach((U) => {
        const k = `${U.source}-${U.id}`;
        b.has(k) || b.set(k, U);
      });
      let P = Array.from(b.values());
      if (l && l > 0) {
        const U = P.filter((k) => k.diff <= 4);
        if (U.length > 0)
          console.log(`[Lyrics] Calibration: Found ${U.length} strict duration matches.`), P = U;
        else {
          const k = P.filter((G) => G.diff <= 10);
          k.length > 0 ? (console.log(`[Lyrics] Calibration: Found ${k.length} lenient duration matches.`), P = k) : console.log(`[Lyrics] Calibration: No duration matches found. Closest is ${Math.min(...P.map((G) => G.diff))}s off.`);
        }
      }
      P.sort((U, k) => Math.abs(U.diff - k.diff) > 0.5 ? U.diff - k.diff : 0);
      const F = P[0];
      return console.log(`[Lyrics] Selected: ${F.track} (${F.artist}) [${F.source}] Diff=${F.diff.toFixed(2)}s`), x(F.lyrics);
    } catch (d) {
  ...
  }), re.handle("app:version", () => We.getVersion());
});
export {
  pA as A,
  id as B,
