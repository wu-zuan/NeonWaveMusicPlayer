...
import Kt, { app as Xe, BrowserWindow as Tc, Notification as dp, ipcMain as je, dialog as ho } from "electron";
import { createRequire as Ba } from "node:module";
import { fileURLToPath as pp } from "node:url";
import Se from "node:path";
import Nr, { open as hp } from "node:fs/promises";
import Dt from "fs";
...
import Ac from "zlib";
import yp from "http";
import { execFile as xp, exec as wp } from "node:child_process";
...
var xt = mp, vp = process.cwd, ri = null, Tp = process.env.GRACEFUL_FS_PLATFORM || process.platform;
process.cwd = function() {
  return ri || (ri = vp.call(process)), ri;
};
try {
  process.cwd();
} catch {
...
function bp(e) {
  xt.hasOwnProperty("O_SYMLINK") && process.version.match(/^v0\.6\.[0-2]|^v0\.5\./) && t(e), e.lutimes || r(e), e.chown = a(e.chown), e.fchown = a(e.fchown), e.lchown = a(e.lchown), e.chmod = n(e.chmod), e.fchmod = n(e.fchmod), e.lchmod = n(e.lchmod), e.chownSync = s(e.chownSync), e.fchownSync = s(e.fchownSync), e.lchownSync = s(e.lchownSync), e.chmodSync = i(e.chmodSync), e.fchmodSync = i(e.fchmodSync), e.lchmodSync = i(e.lchmodSync), e.stat = o(e.stat), e.fstat = o(e.fstat), e.lstat = o(e.lstat), e.statSync = l(e.statSync), e.fstatSync = l(e.fstatSync), e.lstatSync = l(e.lstatSync), e.chmod && !e.lchmod && (e.lchmod = function(c, u, p) {
    ...
    function u(p, m, w, x, T, b) {
      var _;
      if (b && typeof b == "function") {
        var N = 0;
        _ = function($, ie, ue) {
          if ($ && $.code === "EAGAIN" && N < 10)
            return N++, c.call(e, p, m, w, x, T, _);
          b.apply(this, arguments);
        };
      }
      return c.call(e, p, m, w, x, T, _);
    }
    return Object.setPrototypeOf && Object.setPrototypeOf(u, c), u;
...
var se = Dt, Op = _p, Dp = Sp, Pp = Ip, kn = fs, ve, oi;
...
function ds(e) {
  Op(e), e.gracefulify = ds, e.createReadStream = ie, e.createWriteStream = ue;
  var t = e.readFile;
  e.readFile = r;
  function r(y, q, j) {
...
const $p = ke.fromPromise, { makeDir: Lp, makeDirSync: aa } = hs, sa = $p(Lp);
var ot = {
  mkdirs: sa,
  mkdirsSync: aa,
  // alias
...
const Le = Ne, Wr = oe, Wp = ot.mkdirs, Vp = er.pathExists, Yp = kc.utimesMillis, Vr = br;
function Kp(e, t, r, n) {
...
function li(e, t, r, n, i) {
  (n.dereference ? Le.stat : Le.lstat)(t, (s, o) => s ? i(s) : o.isDirectory() ? ih(o, e, t, r, n, i) : o.isFile() || o.isCharacterDevice() || o.isBlockDevice() ? Qp(o, e, t, r, n, i) : o.isSymbolicLink() ? oh(e, t, r, n, i) : o.isSocket() ? i(new Error(`Cannot copy a socket file: ${t}`)) : o.isFIFO() ? i(new Error(`Cannot copy a FIFO pipe: ${t}`)) : i(new Error(`Unknown file: ${t}`)));
}
...
function Lc(e, t, r, n, i) {
  Le.copyFile(t, r, (a) => a ? i(a) : n.preserveTimestamps ? eh(e.mode, t, r, i) : Si(r, e.mode, i));
}
function eh(e, t, r, n) {
  return th(e) ? rh(r, e, (i) => i ? n(i) : wo(e, t, r, n)) : wo(e, t, r, n);
}
function th(e) {
  return (e & 128) === 0;
}
...
function wo(e, t, r, n) {
  nh(t, r, (i) => i ? n(i) : Si(r, e, n));
}
function Si(e, t, r) {
  return Le.chmod(e, t, r);
}
function nh(e, t, r) {
  Le.stat(e, (n, i) => n ? r(n) : Yp(t, i.atime, i.mtime, r));
}
...
function oh(e, t, r, n, i) {
  Le.readlink(t, (a, s) => {
    ...
    if (n.dereference && (s = Wr.resolve(process.cwd(), s)), e)
      Le.readlink(r, (o, l) => o ? o.code === "EINVAL" || o.code === "UNKNOWN" ? Le.symlink(s, r, i) : i(o) : (n.dereference && (l = Wr.resolve(process.cwd(), l)), Vr.isSrcSubdir(s, l) ? i(new Error(`Cannot copy '${s}' to a subdirectory of itself, '${l}'.`)) : e.isDirectory() && Vr.isSrcSubdir(l, s) ? i(new Error(`Cannot overwrite '${l}' with '${s}'.`)) : lh(s, r, i)));
    else
...
var ch = Kp;
const Ae = Ne, Yr = oe, uh = ot.mkdirsSync, fh = kc.utimesMillisSync, Kr = br;
function dh(e, t, r) {
  ...
  return Kr.checkParentPathsSync(e, n, t, "copy"), ph(i, e, t, r);
}
function ph(e, t, r, n) {
...
function jc(e, t, r, n) {
  return Ae.copyFileSync(t, r), n.preserveTimestamps && yh(e.mode, t, r), gs(r, e.mode);
}
function yh(e, t, r) {
...
function Th(e, t, r, n) {
  return Ae.mkdirSync(r), zc(t, r, n), gs(r, e);
}
function zc(e, t, r) {
...
var Oh = xs;
xs.sync = qc;
const ci = Ne, Dh = ke.fromCallback, Xc = Oh;
function Ph(e, t) {
...
const Nh = ke.fromPromise, Wc = Zt, Vc = oe, Yc = ot, Kc = Ai, bo = Nh(async function(t) {
  let r;
  try {
...
const $h = ke.fromCallback, Jc = oe, Tt = Ne, Qc = ot;
function Lh(e, t) {
  function r() {
    Tt.writeFile(e, "", (n) => {
      if (n) return t(n);
...
const Bh = ke.fromCallback, Zc = oe, vt = Ne, eu = ot, jh = er.pathExists, { areIdentical: tu } = br;
function zh(e, t, r) {
  function n(i, a) {
    vt.link(i, a, (s) => {
      if (s) return r(s);
...
const _t = oe, Gr = Ne, qh = er.pathExists;
function Xh(e, t, r) {
  if (_t.isAbsolute(e))
...
const Qh = ke.fromCallback, nu = oe, Ke = Zt, iu = ot, Zh = iu.mkdirs, em = iu.mkdirsSync, au = Vh, tm = au.symlinkPaths, rm = au.symlinkPathsSync, su = Jh, nm = su.symlinkType, im = su.symlinkTypeSync, am = er.pathExists, { areIdentical: ou } = br;
function sm(e, t, r, n) {
...
function om(e, t, r) {
  ...
  return Ke.existsSync(a) || em(a), Ke.symlinkSync(e, t, r);
}
var lm = {
  createSymlink: Qh(sm),
  createSymlinkSync: om
};
const { createFile: Io, createFileSync: Co } = Mh, { createLink: Ro, createLinkSync: Oo } = Hh, { createSymlink: Do, createSymlinkSync: Po } = lm;
var cm = {
  // file
  createFile: Io,
  createFileSync: Co,
...
var ws = { stringify: um, stripBom: fm };
let Er;
try {
  Er = Ne;
} catch {
...
const Em = ke.fromCallback, Hr = Ne, uu = oe, fu = ot, vm = er.pathExists;
function Tm(e, t, r, n) {
...
const { stringify: bm } = ws, { outputFile: Sm } = Es;
async function Am(e, t, r = {}) {
  const n = bm(t, r);
  await Sm(e, n, r);
}
var Im = Am;
const { stringify: Cm } = ws, { outputFileSync: Rm } = Es;
function Om(e, t, r) {
  const n = Cm(t, r);
  Rm(e, n, r);
}
var Dm = Om;
const Pm = ke.fromPromise, Pe = wm;
Pe.outputJson = Pm(Im);
Pe.outputJsonSync = Dm;
...
var km = Pe;
const Nm = Ne, ja = oe, Fm = ys.copy, du = Ai.remove, $m = ot.mkdirp, Lm = er.pathExists, ko = br;
function Um(e, t, r, n) {
  ...
  ko.checkPaths(e, t, "move", r, (a, s) => {
    ...
    ko.checkParentPaths(e, o, t, "move", (d) => {
      if (d) return n(d);
      if (Mm(t)) return No(e, t, i, l, n);
      $m(ja.dirname(t), (c) => c ? n(c) : No(e, t, i, l, n));
    });
  });
}
function Mm(e) {
...
function No(e, t, r, n, i) {
  ...
  Lm(t, (a, s) => a ? i(a) : s ? i(new Error("dest already exists.")) : oa(e, t, r, i));
}
function oa(e, t, r, n) {
...
var jm = Um;
const pu = Ne, za = oe, zm = ys.copySync, hu = Ai.removeSync, Gm = ot.mkdirpSync, Fo = br;
function Hm(e, t, r) {
  r = r || {};
  const n = r.overwrite || r.clobber || !1, { srcStat: i, isChangingCase: a = !1 } = Fo.checkPathsSync(e, t, "move", r);
  return Fo.checkParentPathsSync(e, i, t, "move"), qm(t) || Gm(za.dirname(t)), Xm(e, t, n, a);
}
function qm(e) {
...
function n0() {
  if (Bo) return da;
  Bo = 1;
  const e = _i, t = Sc, r = r0(), { env: n } = process;
  let i;
...
dn.ProgressCallbackTransform = s0;
...
const o0 = un, l0 = gu, c0 = Dt, u0 = cn, yu = _r, f0 = It, zo = Sr, d0 = dn, Fr = (0, l0.default)("electron-builder");
...
Ri.githubUrl = x0;
Ri.getS3LikeProviderBaseUrl = w0;
...
const Tu = un, _u = Sr, b0 = "options.name must be either a string or a Buffer", Go = (0, Tu.randomBytes)(16);
Go[0] = Go[0] | 1;
const ai = {}, V = [];
for (let e = 0; e < 256; e++) {
...
function S0(e, t, r, n, i = qr.ASCII) {
...
(function(e) {
  (function(t) {
    ...
    var u = "[CDATA[", p = "DOCTYPE", m = "http://www.w3.org/XML/1998/namespace", w = "http://www.w3.org/2000/xmlns/", x = { xml: m, xmlns: w }, T = /[:_A-Za-z\u00C0-\u00D6\u00D8-\u00F6\u00F8-\u02FF\u0370-\u037D\u037F-\u1FFF\u200C-\u200D\u2070-\u218F\u2C00-\u2FEF\u3001-\uD7FF\uF900-\uFDCF\uFDF0-\uFFFD]/, b = /[:_A-Za-z\u00C0-\u00D6\u00D8-\u00F6\u00F8-\u02FF\u0370-\u037D\u037F-\u1FFF\u200C-\u200D\u2070-\u218F\u2C00-\u2FEF\u3001-\uD7FF\uF900-\uFDCF\uFDF0-\uFFFD\u00B7\u0300-\u036F\u203F-\u2040.\d-]/, _ = /[#:_A-Za-z\u00C0-\u00D6\u00D8-\u00F6\u00F8-\u02FF\u0370-\u037D\u037F-\u1FFF\u200C-\u200D\u2070-\u218F\u2C00-\u2FEF\u3001-\uD7FF\uF900-\uFDCF\uFDF0-\uFFFD]/, N = /[#:_A-Za-z\u00C0-\u00D6\u00D8-\u00F6\u00F8-\u02FF\u0370-\u037D\u037F-\u1FFF\u200C-\u200D\u2070-\u218F\u2C00-\u2FEF\u3001-\uD7FF\uF900-\uFDCF\uFDF0-\uFFFD\u00B7\u0300-\u036F\u203F-\u2040.\d-]/;
    function $(h) {
      return h === " " || h === `
` || h === "\r" || h === "	";
    }
    ...
    function X(h, f) {
      if (h.opt.xmlns) {
        ...
        for (var re = 0, le = h.attribList.length; re < le; re++) {
          var we = h.attribList[re], _e = we[0], ht = we[1], de = O(_e, !0), Ve = de.prefix, Ki = de.local, _n = Ve === "" ? "" : S.ns[Ve] || "", Rr = {
            name: _e,
            value: ht,
            prefix: Ve,
            local: Ki,
          ...
          ), Rr.uri = Ve), h.tag.attributes[_e] = Rr, B(h, "onattribute", Rr);
        }
...
` ? (f.line++, f.column = 0) : f.column++);
          ...
          case y.PROC_INST_ENDING:
            ...
            continue;
          case y.OPEN_TAG:
            Y(b, v) ? f.tagName += v : (k(f), v === ">" ? X(f) : v === "/" ? f.state = y.OPEN_TAG_SLASH : ($(v) || A(f, "Invalid character in tag name"), f.state = y.ATTRIB));
            continue;
          ...
          case y.ATTRIB_VALUE_ENTITY_U:
            ...
            } else Y(f.entity.length ? N : _, v) ? f.entity += v : (A(f, "Invalid character in entity name"), f[we] += "&" + f.entity + v, f.entity = "", f.state = le);
            continue;
          default:
...
Wa.prototype.extend = function(t) {
  ...
  return i.implicit = (this.implicit || []).concat(r), i.explicit = (this.explicit || []).concat(n), i.compiledImplicit = Wo(i, "implicit"), i.compiledExplicit = Wo(i, "explicit"), i.compiledTypeMap = z0(i.compiledImplicit, i.compiledExplicit), i;
};
var Cu = Wa, G0 = Fe, Ru = new G0("tag:yaml.org,2002:str", {
  kind: "scalar",
  construct: function(e) {
    return e !== null ? e : "";
  }
}), H0 = Fe, Ou = new H0("tag:yaml.org,2002:seq", {
  kind: "sequence",
  construct: function(e) {
    return e !== null ? e : [];
  }
}), q0 = Fe, Du = new q0("tag:yaml.org,2002:map", {
  kind: "mapping",
  construct: function(e) {
    return e !== null ? e : {};
  }
...
var Gu = new Eg("tag:yaml.org,2002:merge", {
  kind: "scalar",
  resolve: vg
}), Tg = Fe, As = `ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789+/=
\r`;
function _g(e) {
  if (e === null) return !1;
...
var Hu = new Tg("tag:yaml.org,2002:binary", {
  ...
  predicate: Ag,
  represent: Sg
}), Ig = Fe, Cg = Object.prototype.hasOwnProperty, Rg = Object.prototype.toString;
function Og(e) {
  if (e === null) return !0;
  var t = [], r, n, i, a, s, o = e;
...
var qu = new Ig("tag:yaml.org,2002:omap", {
  ...
  resolve: Og,
  construct: Dg
}), Pg = Fe, kg = Object.prototype.toString;
function Ng(e) {
  if (e === null) return !0;
  var t, r, n, i, a, s = e;
...
var Xu = new Pg("tag:yaml.org,2002:pairs", {
  ...
  resolve: Ng,
  construct: Fg
}), $g = Fe, Lg = Object.prototype.hasOwnProperty;
function Ug(e) {
  if (e === null) return !0;
  var t, r = e;
  for (t in r)
...
}), Ht = Je, Vu = hn, Bg = L0, jg = Is, Ct = Object.prototype.hasOwnProperty, pi = 1, Yu = 2, Ku = 3, hi = 4, ga = 1, zg = 2, Vo = 3, Gg = /[\x00-\x08\x0B\x0C\x0E-\x1F\x7F-\x84\x86-\x9F\uFFFE\uFFFF]|[\uD800-\uDBFF](?![\uDC00-\uDFFF])|(?:[^\uD800-\uDBFF]|^)[\uDC00-\uDFFF]/, Hg = /[\x85\u2028\u2029]/, qg = /[,\[\]\{\}]/, Ju = /^(?:!|!!|![a-z\-]+!)$/i, Qu = /^(?:!|[^,\[\]\{\}])(?:%[0-9a-f]{2}|[0-9a-z\-#;\/\?:@&=\+\$,_\.!~\*'\(\)\[\]])*$/i;
function Yo(e) {
...
function Jg(e, t, r) {
  ...
  for (e.kind = "scalar", e.result = "", a = s = e.position, o = !1; m !== 0; ) {
    ...
    o && (bt(e, a, s, !1), Rs(e, e.line - l), a = s = e.position, o = !1), Vt(m) || (s = e.position + 1), m = e.input.charCodeAt(++e.position);
  }
...
function ey(e, t) {
  var r = !0, n, i, a, s = e.tag, o, l = e.anchor, d, c, u, p, m, w = /* @__PURE__ */ Object.create(null), x, T, b, _;
...
function ty(e, t) {
  ...
  for (e.kind = "scalar", e.result = ""; u !== 0; )
    if (u = e.input.charCodeAt(++e.position), u === 43 || u === 45)
      ga === i ? i = u === 43 ? Vo : zg : L(e, "repeat of a chomping mode identifier");
    else if ((c = Vg(u)) >= 0)
...
function ry(e, t, r) {
  var n, i, a, s, o, l, d = e.tag, c = e.anchor, u = {}, p = /* @__PURE__ */ Object.create(null), m = null, w = null, x = null, T = !1, b = !1, _;
  if (e.firstTabInLine !== -1) return !1;
  for (e.anchor !== null && (e.anchorMap[e.anchor] = u), _ = e.input.charCodeAt(e.position); _ !== 0; ) {
    if (!T && e.firstTabInLine !== -1 && (e.position = e.firstTabInLine, L(e, "tab characters must not be used in indentation")), n = e.input.charCodeAt(e.position + 1), a = e.line, (_ === 63 || _ === 58) && Ue(n))
      _ === 63 ? (T && (dr(e, u, p, m, w, null, s, o, l), m = w = x = null), b = !0, T = !0, i = !0) : T ? (T = !1, i = !0) : L(e, "incomplete explicit mapping pair; a key node is missed; or followed by a non-tabulated empty line"), e.position += 1, _ = n;
    else {
      ...
      if (e.line === a) {
        ...
        if (_ === 58)
          _ = e.input.charCodeAt(++e.position), Ue(_) || L(e, "a whitespace character is expected after the key-value separator within a block mapping"), T && (dr(e, u, p, m, w, null, s, o, l), m = w = x = null), b = !0, T = !1, i = !1, m = e.tag, w = e.result;
        else if (b)
    ...
    if ((e.line === a || e.lineIndent > t) && (T && (s = e.line, o = e.lineStart, l = e.position), Tr(e, t, hi, !0, i) && (T ? w = e.result : x = e.result), T || (dr(e, u, p, m, w, x, s, o, l), m = w = x = null), fe(e, !0, -1), _ = e.input.charCodeAt(e.position)), (e.line === a || e.lineIndent > t) && _ !== 0)
      L(e, "bad indentation of a mapping entry");
    else if (e.lineIndent < t)
      break;
  }
  return T && dr(e, u, p, m, w, null, s, o, l), b && (e.tag = d, e.anchor = c, e.kind = "mapping", e.result = u), b;
}
function ny(e) {
  var t, r = !1, n = !1, i, a, s;
...
function Tr(e, t, r, n, i) {
  ...
  if (o && (o = d || i), (l === 1 || hi === r) && (pi === r || Yu === r ? x = t : x = t + 1, T = e.position - e.lineStart, l === 1 ? o && (Zo(e, T) || ry(e, T, x)) || ey(e, x) ? c = !0 : (s && ty(e, x) || Qg(e, x) || Zg(e, x) ? c = !0 : ay(e) ? (c = !0, (e.tag !== null || e.anchor !== null) && L(e, "alias node should not have any properties")) : Jg(e, x, pi === r) && (c = !0, e.tag === null && (e.tag = "?")), e.anchor !== null && (e.anchorMap[e.anchor] = e.result)) : l === 0 && (c = o && Zo(e, T))), e.tag === null)
...
function sy(e) {
  ...
  if (fe(e, !0, -1), e.lineIndent === 0 && e.input.charCodeAt(e.position) === 45 && e.input.charCodeAt(e.position + 1) === 45 && e.input.charCodeAt(e.position + 2) === 45 ? (e.position += 3, fe(e, !0, -1)) : a && L(e, "directives end mark is expected"), Tr(e, e.lineIndent - 1, hi, !1, !0), fe(e, !0, -1), e.checkLineBreaks && Hg.test(e.input.slice(t, e.position)) && mi(e, "non-ASCII line breaks are interpreted as content"), e.documents.push(e.result), e.position === e.lineStart && Oi(e)) {
...
Ss.loadAll = oy;
Ss.load = ly;
var af = {}, Di = Je, mn = hn, cy = Is, sf = Object.prototype.toString, of = Object.prototype.hasOwnProperty, Os = 65279, uy = 9, Zr = 10, fy = 13, dy = 32, py = 33, hy = 34, Va = 35, my = 37, gy = 38, yy = 39, xy = 42, lf = 44, wy = 45, gi = 58, Ey = 61, vy = 62, Ty = 63, _y = 64, cf = 91, uf = 93, by = 96, ff = 123, Sy = 124, df = 125, Ce = {};
Ce[0] = "\\0";
Ce[7] = "\\a";
Ce[8] = "\\b";
Ce[9] = "\\t";
...
var Oy = 1, en = 2;
function Dy(e) {
  this.schema = e.schema || cy, this.indent = Math.max(1, e.indent || 2), this.noArrayIndent = e.noArrayIndent || !1, this.skipInvalid = e.skipInvalid || !1, this.flowLevel = Di.isNothing(e.flowLevel) ? -1 : e.flowLevel, this.styleMap = Cy(this.schema, e.styles || null), this.sortKeys = e.sortKeys || !1, this.lineWidth = e.lineWidth || 80, this.noRefs = e.noRefs || !1, this.noCompatMode = e.noCompatMode || !1, this.condenseFlow = e.condenseFlow || !1, this.quotingType = e.quotingType === '"' ? en : Oy, this.forceQuotes = e.forceQuotes || !1, this.replacer = typeof e.replacer == "function" ? e.replacer : null, this.implicitTypes = this.schema.compiledImplicit, this.explicitTypes = this.schema.compiledExplicit, this.tag = null, this.result = "", this.duplicates = [], this.usedDuplicates = null;
}
function el(e, t) {
...
function ky(e) {
  return tn(e) && e !== Os && !yi(e) && e !== wy && e !== Ty && e !== gi && e !== lf && e !== cf && e !== uf && e !== ff && e !== df && e !== Va && e !== gy && e !== xy && e !== py && e !== Sy && e !== Ey && e !== vy && e !== yy && e !== hy && e !== my && e !== _y && e !== by;
}
function Ny(e) {
  return !yi(e) && e !== gi;
}
...
function Fy(e, t, r, n, i, a, s, o) {
  var l, d = 0, c = null, u = !1, p = !1, m = n !== -1, w = -1, x = ky(jr(e, 0)) && Ny(jr(e, e.length - 1));
  if (t || s)
...
function $y(e, t, r, n, i) {
  e.dump = function() {
    ...
    switch (Fy(
      ...
      case gf:
        return ">" + nl(t, e.indent) + il(el(Ly(t, s), a));
      case ur:
        return '"' + Uy(t) + '"';
      default:
...
function Uy(e) {
  for (var t = "", r = 0, n, i = 0; i < e.length; r >= 65536 ? i += 2 : i++)
    r = jr(e, i), n = Ce[r], !n && tn(r) ? (t += e[i], r >= 65536 && (t += e[i + 1])) : t += n || Ry(r);
  return t;
}
function My(e, t, r) {
  var n = "", i = e.tag, a, s, o;
...
function dt(e, t, r, n, i, a, s) {
  ...
  if (c && (u = e.duplicates.indexOf(r), p = u !== -1), (e.tag !== null && e.tag !== "?" || p || e.indent !== 2 && t > 0) && (i = !1), p && e.usedDuplicates[u])
    ...
    if (c && p && !e.usedDuplicates[u] && (e.usedDuplicates[u] = !0), o === "[object Object]")
      ...
      n && e.dump.length !== 0 ? (e.noArrayIndent && !s && t > 0 ? sl(e, t - 1, e.dump, i) : sl(e, t, e.dump, i), p && (e.dump = "&ref_" + u + e.dump)) : (My(e, t, e.dump), p && (e.dump = "&ref_" + u + " " + e.dump));
...
const Mn = Ni, { MAX_LENGTH: cl, MAX_SAFE_INTEGER: Bn } = ki, { safeRe: jn, t: zn } = gn, rx = Ps, { compareIdentifiers: ya } = Ef;
let nx = class it {
  constructor(t, r) {
...
var hx = px;
const mx = $e, gx = (e, t) => new mx(e, t).major;
var yx = gx;
const xx = $e, wx = (e, t) => new xx(e, t).minor;
var Ex = wx;
const vx = $e, Tx = (e, t) => new vx(e, t).patch;
var _x = Tx;
const bx = Ir, Sx = (e, t) => {
  const r = bx(e, t);
...
var Ax = Sx;
const pl = $e, Ix = (e, t, r) => new pl(e, r).compare(new pl(t, r));
var Qe = Ix;
...
var ks = Nx;
const Fx = ks, $x = (e, t) => e.sort((r, n) => Fx(r, n, t));
var Lx = $x;
const Ux = ks, Mx = (e, t) => e.sort((r, n) => Ux(n, r, t));
var Bx = Mx;
...
var $s = Qx;
const Zx = vf, ew = Tf, tw = Fi, rw = Fs, nw = Ns, iw = $s, aw = (e, t, r, n) => {
  switch (t) {
    case "===":
...
var _f = aw;
const sw = $e, ow = Ir, { safeRe: Gn, t: Hn } = gn, lw = (e, t) => {
  if (e instanceof sw)
    return e;
...
function Ze() {
  ...
  class t {
    ...
    parseRange(I) {
      const A = ((this.options.includePrerelease && m) | (this.options.loose && w)) + ":" + I, k = n.get(A);
      if (k)
        return k;
  ...
  xa = t;
  const r = fw, n = new r(), i = Ps, a = $i(), s = Ni, o = $e, {
    safeRe: l,
    t: d,
    ...
    return R.replace(D, (A, k, O, M, X, z) => {
      ...
      return k === "=" && et && (k = ""), z = I.includePrerelease ? "-0" : "", Z ? k === ">" || k === "<" ? A = "<0.0.0-0" : A = "*" : k && et ? (he && (M = 0), X = 0, k === ">" ? (k = ">=", he ? (O = +O + 1, M = 0, X = 0) : (M = +M + 1, X = 0)) : k === "<=" && (k = "<", he ? O = +O + 1 : M = +M + 1), k === "<" && (z = "-0"), A = `${k + O}.${M}.${X}${z}`) : he ? A = `>=${O}.0.0${z} <${+O + 1}.0.0-0` : U && (A = `>=${O}.${M}.0${z} <${O}.${+M + 1}.0-0`), s("xRange return", A), A;
    });
  }, q = (R, I) => (s("replaceStars", R, I), R.trim().replace(l[d.STAR], "")), j = (R, I) => (s("replaceGTE0", R, I), R.trim().replace(l[I.includePrerelease ? d.GTE0PRE : d.GTE0], "")), B = (R) => (I, D, A, k, O, M, X, z, Z, he, U, et) => (N(A) ? D = "" : N(k) ? D = `>=${A}.0.0${R ? "-0" : ""}` : N(O) ? D = `>=${A}.${k}.0${R ? "-0" : ""}` : M ? D = `>=${D}` : D = `>=${D}${R ? "-0" : ""}`, N(Z) ? z = "" : N(he) ? z = `<${+Z + 1}.0.0-0` : N(U) ? z = `<${Z}.${+he + 1}.0-0` : et ? z = `<=${Z}.${he}.${U}-${et}` : R ? z = `<${Z}.${he}.${+U + 1}-0` : z = `<=${z}`, `${D} ${z}`.trim()), Q = (R, I, D) => {
...
var Ow = Rw;
const Dw = $e, bf = $i(), { ANY: Pw } = bf, kw = Ze(), Nw = Li, xl = Fi, wl = Ns, Fw = $s, $w = Fs, Lw = (e, t, r, n) => {
  ...
  for (let d = 0; d < t.set.length; ++d) {
    ...
    let u = null, p = null;
    if (c.forEach((m) => {
      m.semver === Pw && (m = new bf(">=0.0.0")), u = u || m, p = p || m, i(m.semver, u.semver, n) ? u = m : s(m.semver, p.semver, n) && (p = m);
...
var Ls = Lw;
const Uw = Ls, Mw = (e, t, r) => Uw(e, t, ">", r);
var Bw = Mw;
const jw = Ls, zw = (e, t, r) => jw(e, t, "<", r);
var Gw = zw;
const El = Ze(), Hw = (e, t, r) => (e = new El(e, r), t = new El(t, r), e.intersects(t, r));
var qw = Hw;
const Xw = Li, Ww = Qe;
var Vw = (e, t, r) => {
  const n = [];
...
const vl = Ze(), Us = $i(), { ANY: va } = Us, Lr = Li, Ms = Qe, Yw = (e, t, r = {}) => {
  if (e === t)
    return !0;
  ...
  return !0;
}, Kw = [new Us(">=0.0.0-0")], Tl = [new Us(">=0.0.0")], Jw = (e, t, r) => {
  if (e === t)
    return !0;
  if (e.length === 1 && e[0].semver === va) {
    if (t.length === 1 && t[0].semver === va)
      return !0;
    r.includePrerelease ? e = Kw : e = Tl;
  }
  if (t.length === 1 && t[0].semver === va) {
  ...
  let i, a;
  for (const m of e)
    m.operator === ">" || m.operator === ">=" ? i = _l(i, m, r) : m.operator === "<" || m.operator === "<=" ? a = bl(a, m, r) : n.add(m.semver);
  if (n.size > 1)
    return null;
  let s;
  if (i && a) {
...
var Qw = Yw;
const Ta = gn, Sl = ki, Zw = $e, Al = Ef, eE = Ir, tE = ox, rE = ux, nE = dx, iE = hx, aE = yx, sE = Ex, oE = _x, lE = Ax, cE = Qe, uE = Ox, fE = kx, dE = ks, pE = Lx, hE = Bx, mE = Fi, gE = Ns, yE = vf, xE = Tf, wE = Fs, EE = $s, vE = _f, TE = cw, _E = $i(), bE = Ze(), SE = Li, AE = gw, IE = Ew, CE = bw, RE = Iw, OE = Ow, DE = Ls, PE = Bw, kE = Gw, NE = qw, FE = Vw, $E = Qw;
var Sf = {
  parse: eE,
  valid: tE,
  clean: rE,
...
(function(e, t) {
  ...
  function _e(g, E) {
    for (var C = -1, F = g == null ? 0 : g.length, ne = 0, H = []; ++C < F; ) {
      var ce = g[C];
      E(ce, C, g) && (H[ne++] = ce);
    }
    return H;
  ...
  function ht(g, E) {
    for (var C = -1, F = E.length, ne = g.length; ++C < F; )
      g[ne + C] = E[C];
    return g;
  }
  function de(g, E) {
  ...
  var ud = Array.prototype, fd = Function.prototype, Sn = Object.prototype, Ji = f["__core-js_shared__"], Ys = fd.toString, tt = Sn.hasOwnProperty, Ks = function() {
    var g = /[^.]+$/.exec(Ji && Ji.keys && Ji.keys.IE_PROTO || "");
    return g ? "Symbol(src)_1." + g : "";
  }(), Js = Sn.toString, dd = RegExp(
    "^" + Ys.call(tt).replace(z, "\\$&").replace(/hasOwnProperty|(function).*?(?=\\\()| for .+?(?=\\\])/g, "$1.*?") + "$"
  ), Qs = K ? f.Buffer : void 0, An = f.Symbol, Zs = f.Uint8Array, eo = Sn.propertyIsEnumerable, pd = ud.splice, Nt = An ? An.toStringTag : void 0, to = Object.getOwnPropertySymbols, hd = Qs ? Qs.isBuffer : void 0, md = ld(Object.keys, Object), Qi = rr(f, "DataView"), Or = rr(f, "Map"), Zi = rr(f, "Promise"), ea = rr(f, "Set"), ta = rr(f, "WeakMap"), Dr = rr(Object, "create"), gd = Lt(Qi), yd = Lt(Or), xd = Lt(Zi), wd = Lt(ea), Ed = Lt(ta), ro = An ? An.prototype : void 0, ra = ro ? ro.valueOf : void 0;
  function Ft(g) {
  ...
  function Gd(g, E) {
    var C = On(g), F = !C && ip(g), ne = !C && !F && na(g), H = !C && !F && !ne && fo(g), ce = C || F || ne || H, me = ce ? Ve(g.length, String) : [], Ee = me.length;
    for (var ae in g)
  ...
  function io(g, E, C, F, ne) {
    return g === E ? !0 : g == null || E == null || !kr(g) && !kr(E) ? g !== g && E !== E : qd(g, E, C, F, io, ne);
  }
  function qd(g, E, C, F, ne, H) {
    var ce = On(g), me = On(E), Ee = ce ? l : gt(g), ae = me ? l : gt(E);
    Ee = Ee == o ? _ : Ee, ae = ae == o ? _ : ae;
    var Be = Ee == _, Ye = ae == _, be = Ee == ae;
    if (be && na(g)) {
      if (!na(E))
        return !1;
      ce = !0, Be = !1;
    ...
    if (be && !Be)
      return H || (H = new mt()), ce || fo(g) ? ao(g, E, C, F, ne, H) : Yd(g, E, Ee, C, F, ne, H);
    if (!(C & i)) {
      var He = Be && tt.call(g, "__wrapped__"), qe = Ye && tt.call(E, "__wrapped__");
      if (He || qe) {
        var yt = He ? g.value() : g, ct = qe ? E.value() : E;
        return H || (H = new mt()), ne(yt, ct, C, F, H);
      }
    }
    return be ? (H || (H = new mt()), Kd(g, E, C, F, ne, H)) : !1;
  }
  function Xd(g) {
    if (!uo(g) || tp(g))
      return !1;
  ...
  function Wd(g) {
    return kr(g) && co(g.length) && !!U[Pr(g)];
  }
  function Vd(g) {
    if (!rp(g))
      return md(g);
  ...
  function ao(g, E, C, F, ne, H) {
    ...
    for (H.set(g, E), H.set(E, g); ++Be < me; ) {
      var He = g[Be], qe = E[Be];
      if (F)
        var yt = ce ? F(qe, He, Be, E, g, H) : F(He, qe, Be, g, E, H);
      if (yt !== void 0) {
        if (yt)
          continue;
        Ye = !1;
    ...
    return H.delete(g), H.delete(E), Ye;
  }
  function Yd(g, E, C, F, ne, H, ce) {
    switch (C) {
      case B:
      ...
      case j:
        return !(g.byteLength != E.byteLength || !H(new Zs(g), new Zs(E)));
      case c:
      case u:
      case T:
        return oo(+g, +E);
  ...
  function Kd(g, E, C, F, ne, H) {
    var ce = C & i, me = so(g), Ee = me.length, ae = so(E), Be = ae.length;
    if (Ee != Be && !ce)
      return !1;
    for (var Ye = Ee; Ye--; ) {
      var be = me[Ye];
    ...
    for (var yt = ce; ++Ye < Ee; ) {
      ...
      var ct = g[be], Ut = E[be];
      if (F)
        var po = ce ? F(Ut, ct, be, E, g, H) : F(ct, Ut, be, g, E, H);
    ...
    if (qe && !yt) {
      ...
      Dn != Pn && "constructor" in g && "constructor" in E && !(typeof Dn == "function" && Dn instanceof Dn && typeof Pn == "function" && Pn instanceof Pn) && (qe = !1);
    }
    return H.delete(g), H.delete(E), qe;
  }
  function so(g) {
    return Hd(g, op, Qd);
  }
  ...
  function Jd(g) {
    ...
    var ne = Js.call(g);
    return F && (E ? g[Nt] = C : delete g[Nt]), ne;
  }
  var Qd = to ? function(g) {
    return g == null ? [] : (g = Object(g), _e(to(g), function(E) {
      return eo.call(g, E);
    }));
  } : lp, gt = Pr;
  (Qi && gt(new Qi(new ArrayBuffer(1))) != B || Or && gt(new Or()) != x || Zi && gt(Zi.resolve()) != N || ea && gt(new ea()) != ue || ta && gt(new ta()) != q) && (gt = function(g) {
  ...
  var ip = no(/* @__PURE__ */ function() {
    return arguments;
  }()) ? no : function(g) {
    return kr(g) && tt.call(g, "callee") && !eo.call(g, "callee");
  }, On = Array.isArray;
  function ap(g) {
    return g != null && co(g.length) && !lo(g);
  }
  var na = hd || cp;
  function sp(g, E) {
    return io(g, E);
...
yn.createTempUpdateFile = zE;
const UE = un, ME = Dt, Il = LE, zt = Pt, Xr = oe;
class BE {
  constructor(t) {
  ...
  async validateDownloadedPath(t, r, n, i) {
    if (this.versionInfo != null && this.file === t && this.fileInfo != null)
      return Il(this.versionInfo, r) && Il(this.fileInfo.info, n.info) && await (0, zt.pathExists)(t) ? t : null;
...
var xn = {}, We = {}, WE = "[object Symbol]", If = /[\\^$.*+?()[\]{}|]/g, VE = RegExp(If.source), YE = typeof Oe == "object" && Oe && Oe.Object === Object && Oe, KE = typeof self == "object" && self && self.Object === Object && self, JE = YE || KE || Function("return this")(), QE = Object.prototype, ZE = QE.toString, Rl = JE.Symbol, Ol = Rl ? Rl.prototype : void 0, Dl = Ol ? Ol.toString : void 0;
function ev(e) {
  if (typeof e == "string")
    return e;
  if (rv(e))
...
${o}`, "ERR_UPDATER_INVALID_RELEASE_FEED");
    ...
    const w = async (T) => {
      ...
      try {
        ...
        throw _ instanceof ut.HttpError && _.statusCode === 404 ? (0, ut.newError)(`Cannot find ${p} in the latest release artifacts (${m}): ${_.stack || _.message}`, "ERR_UPDATER_CHANNEL_FILE_NOT_FOUND") : _;
      }
    };
    try {
      let T = this.channel;
...
ji.KeygenProvider = wv;
var zi = {};
Object.defineProperty(zi, "__esModule", { value: !0 });
zi.PrivateGitHubProvider = void 0;
const ar = xe, Ev = Te, vv = oe, Ll = _r, Ul = We, Tv = Ot, _v = pe;
class bv extends Tv.BaseGitHubProvider {
  ...
  async getLatestVersion() {
    const t = new ar.CancellationToken(), r = (0, Ul.getChannelFilename)(this.getDefaultChannelName()), n = await this.getLatestVersionInfo(t), i = n.assets.find((o) => o.name === r);
    if (i == null)
...
zi.PrivateGitHubProvider = bv;
Object.defineProperty(Mi, "__esModule", { value: !0 });
Mi.isUrlProbablySupportMultiRangeRequests = Pf;
Mi.createClient = Rv;
const qn = xe, Sv = Bi, Ml = xn, Av = Ot, Iv = ji, Cv = zi;
function Pf(e) {
...
function Ov(e, t, r) {
  const n = jl(e.files), i = jl(t.files);
  let a = null;
  ...
  for (let x = 0; x < c.checksums.length; w += c.sizes[x], x++) {
    ...
    _ != null && m.get(b) !== T && (r.warn(`Checksum ("${b}") matches, but size differs (old: ${m.get(b)}, new: ${T})`), _ = void 0), _ === void 0 ? (u++, a != null && a.kind === Xt.DOWNLOAD && a.end === w ? a.end += T : (a = {
      ...
      // oldBlocks: null,
    }, Bl(a, o, b, x))) : a != null && a.kind === Xt.COPY && a.end === _ ? a.end += T : (a = {
      kind: Xt.COPY,
      start: _,
      end: _ + T
      // oldBlocks: [checksum]
...
Cr.copyData = kf;
const Xn = xe, kv = Dt, Nv = cn, Fv = tr, zl = Buffer.from(`\r
\r
`);
var Et;
(function(e) {
...
Hi.executeTasksUsingMultipleRangeRequests = Lv;
Hi.checkIsRangesSupported = rs;
const ts = xe, Gl = Cr, Hl = tr;
...
function Uv(e, t, r, n, i) {
  ...
  if (s <= 1) {
    const u = (p) => {
      ...
      const m = t.tasks[p++];
      if (m.kind === Hl.OperationKind.COPY)
        (0, Gl.copyData)(m, r, t.oldFileFd, i, () => u(p));
      else {
  ...
  const c = e.httpExecutor.createRequest(d, (u) => {
    ...
    const w = new Gl.DataSplitter(r, t, o, m[1] || m[2], l, n);
...
qi.ProgressDifferentialDownloadCallbackTransform = Bv;
Object.defineProperty(wn, "__esModule", { value: !0 });
wn.DifferentialDownloader = void 0;
const Ur = xe, Da = Pt, jv = Dt, zv = Cr, Gv = _r, Wn = tr, ql = Hi, Hv = qi;
class qv {
  ...
  async doDownloadFile(t, r) {
    ...
    await new Promise((s, o) => {
      ...
      if (!this.options.isUseMultipleRangeRequest && this.options.onProgress) {
        ...
        d = new Hv.ProgressDifferentialDownloadCallbackTransform(N, this.options.cancellationToken, this.options.onProgress), l.push(d);
      }
      ...
      if (this.options.isUseMultipleRangeRequest) {
        m = (0, ql.executeTasksUsingMultipleRangeRequests)(this, t, p, n, o), m(0);
        return;
      }
      let w = 0, x = null;
      ...
      T.redirect = "manual", m = (b) => {
        ...
        if ($.kind === Wn.OperationKind.COPY) {
          d && d.beginFileCopy(), (0, zv.copyData)($, p, n, o, () => m(b));
          return;
        }
        ...
        const ue = this.httpExecutor.createRequest(T, (Y) => {
          Y.on("error", o), Y.on("aborted", () => {
            ...
            d && d.endRangeDownload(), ++w === 100 ? (w = 0, setTimeout(() => m(b), 1e3)) : m(b);
          });
        });
        ue.on("redirect", (Y, Me, y) => {
          this.logger.info(`Redirect to ${Xv(y)}`), x = y, (0, Ur.configureRequestUrl)(new Gv.URL(x), T), ue.followRedirect();
...
Gi.GenericDifferentialDownloader = Vv;
var kt = {};
(function(e) {
...
const Re = xe, Yv = un, Kv = _i, Jv = bc, sr = Pt, Qv = Te, Pa = Pi, Mt = oe, Gt = Sf, Wl = yn, Zv = Ui, Vl = Af, eT = xn, ka = Mi, tT = Ac, rT = We, nT = Gi, or = kt;
class js extends Jv.EventEmitter {
  /**
  ...
  constructor(t, r) {
    ...
    }), r == null ? (this.app = new Zv.ElectronAppAdapter(), this.httpExecutor = new Vl.ElectronHttpExecutor((a, s) => this.emit("login", a, s))) : (this.app = r, this.httpExecutor = null);
  ...
  checkForUpdatesAndNotify(t) {
    return this.checkForUpdates().then((r) => r != null && r.downloadPromise ? (r.downloadPromise.then(() => {
      const n = js.formatDownloadNotification(r.updateInfo.version, this.app.name, t);
  ...
  async executeDownload(t) {
    ...
    const c = o();
    let u = Mt.join(d, c);
    const p = s == null ? null : Mt.join(d, `package-${a}${Mt.extname(s.path) || ".7z"}`), m = async (_) => (await l.setDownloadedFile(u, p, i, r, c, _), await t.done({
      ...i,
      downloadedFile: u
    ...
    })), b = await (0, Wl.createTempUpdateFile)(`temp-${c}`, d, w);
    try {
...
En.FileWithEmbeddedBlockMapDifferentialDownloader = cT;
function Ff(e) {
...
const Kl = xe, Jl = Ti, fT = Pt, dT = Dt, Mr = oe, pT = pt, hT = En, mT = pe, Ql = kt;
class gT extends pT.BaseUpdater {
  ...
  async downloadDifferential(t, r, n, i, a) {
    try {
      ...
      return this.listenerCount(Ql.DOWNLOAD_PROGRESS) > 0 && (s.onProgress = (o) => this.emit(Ql.DOWNLOAD_PROGRESS, o)), await new hT.FileWithEmbeddedBlockMapDifferentialDownloader(t.info, this.httpExecutor, s).download(), !1;
    } catch (s) {
...
rn.AppImageUpdater = gT;
var nn = {};
Object.defineProperty(nn, "__esModule", { value: !0 });
nn.DebUpdater = void 0;
const yT = pt, xT = pe, Zl = kt;
...
const rc = xe, Na = Pt, AT = Dt, nc = oe, IT = yp, CT = At, RT = pe, ic = Ti, ac = un;
class OT extends CT.AppUpdater {
  ...
  async doDownloadUpdate(t) {
    ...
    return this.executeDownload({
      ...
      downloadUpdateOptions: t,
      task: async (u, p) => {
        const m = nc.join(this.downloadedUpdateHelper.cacheDir, c), w = () => (0, Na.pathExistsSync)(m) ? !t.disableDifferentialDownload : (n.info("Unable to locate previous update.zip for differential download (is this first install?), falling back to full download"), !1);
        let x = !0;
  ...
  async updateDownloaded(t, r) {
    ...
    return await new Promise((d, c) => {
      const u = (0, ac.randomBytes)(64).toString("base64").replace(/\//g, "_").replace(/\+/g, "-"), p = Buffer.from(`autoupdater:${u}`, "ascii"), m = `/${(0, ac.randomBytes)(64).toString("hex")}.zip`;
...
zs.verifySignature = PT;
const sc = xe, $f = Ti, DT = _i, oc = oe;
function PT(e, t, r) {
  return new Promise((n, i) => {
    const a = t.replace(/'/g, "''");
      ...
      try {
        ...
        if (c.Status === 0) {
          ...
          for (const w of e) {
            ...
            if (x.size ? m = Array.from(x.keys()).every((b) => x.get(b) === p.get(b)) : w === p.get("CN") && (r.warn(`Signature validated using only CN ${w}. Please add your full Distinguished Name (DN) to publisherNames configuration`), m = !0), m) {
              n(null);
              return;
            }
          }
...
const Vn = xe, lc = oe, FT = pt, $T = En, cc = kt, LT = pe, UT = Pt, MT = zs, uc = _r;
class BT extends FT.BaseUpdater {
  ...
  async differentialDownloadWebPackage(t, r, n, i) {
    ...
    try {
      ...
      this.listenerCount(cc.DOWNLOAD_PROGRESS) > 0 && (a.onProgress = (s) => this.emit(cc.DOWNLOAD_PROGRESS, s)), await new $T.FileWithEmbeddedBlockMapDifferentialDownloader(r, this.httpExecutor, a).download();
    } catch (a) {
...
function qT(e) {
  try {
    ...
    return t instanceof ReadableStreamDefaultReader ? new fc(t) : new HT(t);
  } catch (t) {
...
const rt = Ar("tokenizer:inflate"), $a = 256 * 1024, A_ = Gf(gr.DataDescriptor), Yn = Gf(gr.EndOfCentralDirectory);
class Hs {
  constructor(t) {
 ...
 * MIT Licensed
 */
var hc = /; *([!#$%&'*+.^_`|~0-9A-Za-z-]+) *= *("(?:[\u000b\u0020\u0021\u0023-\u005b\u005d-\u007e\u0080-\u00ff]|\\[\u000b\u0020-\u00ff])*"|[!#$%&'*+.^_`|~0-9A-Za-z-]+) */g, G_ = /^[\u000b\u0020-\u007e\u0080-\u00ff]+$/, qf = /^[!#$%&'*+.^_`|~0-9A-Za-z-]+$/, H_ = /\\([\u000b\u0020-\u00ff])/g, q_ = /([\\"])/g, Xf = /^[!#$%&'*+.^_`|~0-9A-Za-z-]+\/[!#$%&'*+.^_`|~0-9A-Za-z-]+$/;
qs.format = X_;
qs.parse = W_;
function X_(e) {
...
class rb extends vn("UnexpectedFileContentError") {
  constructor(t, r) {
...
const Mb = {
  ...
  async load() {
    return (await import("./MpegParser-CfS90Or1.js")).MpegParser;
  }
}, Bb = {
  parserType: "apev2",
  extensions: [".ape"],
  ...
  async load() {
    return (await import("./AsfParser-CCabuJPx.js")).AsfParser;
  }
}, zb = {
  parserType: "dsdiff",
  extensions: [".dff"],
  ...
  async load() {
    return (await import("./DsdiffParser-BJT8Ob1r.js")).DsdiffParser;
  }
}, Gb = {
  parserType: "aiff",
  ...
  async load() {
    return (await import("./AiffParser-C2FWcd-z.js")).AIFFParser;
  }
}, Hb = {
  parserType: "dsf",
  extensions: [".dsf"],
  mimeTypes: ["audio/dsf"],
  async load() {
    return (await import("./DsfParser-B5jJKEaC.js")).DsfParser;
  }
}, qb = {
  parserType: "flac",
  extensions: [".flac"],
  ...
  async load() {
    return (await import("./FlacParser-q9QhLc7R.js").then((e) => e.d)).FlacParser;
  }
}, Xb = {
  parserType: "matroska",
  ...
  async load() {
    return (await import("./MatroskaParser-CkLgPPZ4.js")).MatroskaParser;
  }
}, Wb = {
  parserType: "mp4",
  ...
  async load() {
    return (await import("./MP4Parser-8sjxfY7Y.js")).MP4Parser;
  }
}, Vb = {
  parserType: "musepack",
  extensions: [".mpc"],
  ...
  async load() {
    return (await import("./MusepackParser-NqbH5Yc6.js")).MusepackParser;
  }
}, Yb = {
  parserType: "ogg",
  ...
  async load() {
    return (await import("./OggParser-BEPDQg_e.js")).OggParser;
  }
}, Kb = {
  parserType: "wavpack",
  extensions: [".wv", ".wvp"],
  ...
  async load() {
    return (await import("./WavPackParser-saeqdYUz.js")).WavPackParser;
  }
}, Jb = {
  parserType: "riff",
  ...
  async load() {
    return (await import("./WaveParser-Dtv6askh.js")).WaveParser;
  }
}, jt = Ar("music-metadata:parser:factory");
function Qb(e) {
  const t = qs.parse(e), r = Q_(t.type);
  return {
    type: r.type,
    subtype: r.subtype,
    suffix: r.suffix,
...
const hS = /^[\x21-\x7e©][\x20-\x7e\x00()]{3}/, rd = {
  ...
  get: (e, t) => {
    ...
    if (!r.match(hS))
      throw new Xs(`FourCC contains invalid characters: ${sb(r)} "${r}"`);
    return r;
  },
  put: (e, t, r) => {
    const n = nS(r, "latin1");
...
const wt = Ar("music-metadata:parser:APEv2"), xc = "APEv2", wc = "APETAGEX";
class si extends nb("APEv2") {
}
function gS(e, t, r) {
...
class St extends Zf {
  ...
  static async findApeFooterOffset(t, r) {
    ...
    if (r > ze.len) {
      ...
      const a = ze.get(n, 0);
      if (a.ID === "APETAGEX")
        return a.flags.isHeader ? wt(`APE Header found at offset=${r - ze.len}`) : (wt(`APE Footer found at offset=${r - ze.len}`), r -= a.size), { footer: a, offset: r };
    }
  }
...
}, Symbol.toStringTag, { value: "Module" })), ei = Ar("music-metadata:parser:ID3v1"), Ec = [
  "Blues",
  "Classic Rock",
  "Country",
  "Dance",
...
const vc = Ar("music-metadata:parser");
...
const _S = Ba(import.meta.url);
let cs = _S("ffmpeg-static");
...
const ad = Se.dirname(pp(import.meta.url));
process.env.APP_ROOT = Se.join(ad, "..");
const us = process.env.VITE_DEV_SERVER_URL, sA = Se.join(process.env.APP_ROOT, "dist-electron"), sd = Se.join(process.env.APP_ROOT, "dist");
process.env.VITE_PUBLIC = us ? Se.join(process.env.APP_ROOT, "public") : sd;
let J;
function od() {
  J = new Tc({
    width: 1200,
    ...
    webPreferences: {
      preload: Se.join(ad, "preload.mjs"),
      webSecurity: !1,
  ...
  }), us ? J.loadURL(us) : J.loadFile(Se.join(sd, "index.html"));
}
...
Xe.whenReady().then(() => {
  process.platform === "win32" && Xe.setAppUserModelId("NeonWave"), od(), je.handle("dialog:openDirectory", async () => {
    const { canceled: r, filePaths: n } = await ho.showOpenDialog(J, {
      properties: ["openDirectory"]
    });
    return r ? null : n[0];
  }), je.handle("files:listMusic", async (r, n) => {
    if (!n) return [];
    try {
      const i = await Nr.readdir(n), a = [".mp3", ".wav", ".wma", ".m4a", ".flac", ".ogg", ".mp4", ".mov", ".wmv", ".avi"];
      return i.filter((s) => a.includes(Se.extname(s).toLowerCase())).map((s) => Se.join(n, s));
    } catch (i) {
      return console.error("Error reading directory:", i), [];
    }
  }), je.handle("files:readBuffer", async (r, n) => {
    try {
      return await Nr.readFile(n);
    } catch (i) {
      return console.error("Error reading file:", i), null;
    }
  }), je.handle("files:getMetadata", async (r, n) => {
    try {
      const i = await TS(n);
      let a = null;
  ...
  }), je.handle("app:active-window", async () => {
    const r = Se.join(process.env.APP_ROOT, "scripts/get-active-window.ps1");
    return await bS(r);
  });
  const e = Ba(import.meta.url)("yt-dlp-wrap").default, t = async () => {
    const r = process.platform === "win32" ? "yt-dlp.exe" : "yt-dlp", n = Se.join(Xe.getPath("userData"), r);
    try {
      await Nr.access(n);
    } catch {
  ...
  je.handle("search:youtube", async (r, n) => {
    try {
...
`).map((o) => {
  ...
  }), je.handle("download:youtube", async (r, n, i, a) => {
    try {
      const s = await t(), o = Ba(import.meta.url)("ffmpeg-static").replace("app.asar", "app.asar.unpacked");
      let l = i.replace(/[\\/:*?"<>|]/g, "_").trim();
      const { filePath: d } = await ho.showSaveDialog(J, {
        title: "下載歌曲",
        defaultPath: `${l}.m4a`,
  ...
  }), je.handle("search:artistImage", async (r, n) => {
    try {
  ...
  }), je.handle("search:lyrics", async (r, n, i, a) => {
    try {
      const s = async (c) => {
        try {
          const u = `https://lrclib.net/api/search?q=${encodeURIComponent(c)}`, p = await fetch(u);
          if (p.ok) {
            const m = await p.json();
            if (Array.isArray(m) && m.length > 0) {
              const w = (i || "").split(" ")[0].toLowerCase(), x = m.find((T) => T.syncedLyrics && (!w || T.artistName.toLowerCase().includes(w))) || m.find((T) => T.syncedLyrics) || m[0];
              return x.syncedLyrics || x.plainLyrics;
            }
          }
        } catch (u) {
          console.error("LRC Search Error", c, u);
        }
        return null;
      }, o = n.match(/【(.*?)】/);
      if (o) {
      ...
      let l = n.replace(/【.*?】/g, " ").replace(/\[.*?\]/g, " ").replace(/\(.*?\)/g, " ").replace(/-?\s*official\s*music\s*video/gi, "").replace(/-?\s*official\s*video/gi, "").replace(/-?\s*mv/gi, "").replace(/[^a-zA-Z0-9\u4e00-\u9fa5 ]/g, " ").replace(/\s+/g, " ").trim();
      const d = (i || "").split(" ")[0];
      if (d && l.toLowerCase().includes(d.toLowerCase()) && (l = l.replace(new RegExp(d, "gi"), "").trim()), l) {
        const c = await s(`${l} ${i}`);
        if (c) return c;
      }
      if (a) {
        const c = Se.basename(a, Se.extname(a)).replace(/-?\s*official\s*video/gi, "").replace(/\(.*\)/g, ""), u = await s(c);
        if (u) return u;
      }
      return null;
    } catch (s) {
  ...
  }), je.handle("lyrics:generate", async (r, n, i) => {
    if (!i) throw new Error("API Key Missing");
    const a = Se.join(Xe.getPath("temp"), `whisper_${Date.now()}.mp3`);
    try {
      ...
      const s = await Nr.readFile(a), o = new Blob([s], { type: "audio/mp3" }), l = new FormData();
      l.append("file", o, "audio.mp3"), l.append("model", "whisper-1"), l.append("response_format", "verbose_json"), l.append("timestamp_granularities[]", "segment");
      ...
      if (!d.ok) {
        ...
        throw new Error(`OpenAI Error: ${u}`);
      }
      const c = await d.json();
      return c.segments ? c.segments.map((u) => {
        const p = u.start, m = Math.floor(p / 60).toString().padStart(2, "0"), w = Math.floor(p % 60).toString().padStart(2, "0"), x = Math.floor(p % 1 * 100).toString().padStart(2, "0");
        return `[${m}:${w}.${x}]${u.text.trim()}`;
      }).join(`
`) : null;
    } catch (s) {
      throw console.error("Whisper Error:", s), s;
    } finally {
      try {
        await Nr.unlink(a);
      } catch {
  ...
  }), je.handle("update:check", () => {
    st.autoUpdater.checkForUpdates();
  }), je.handle("update:install", () => {
    st.autoUpdater.quitAndInstall(!0, !0);
  }), je.handle("app:version", () => Xe.getVersion());
});
export {
  rA as A,
  Zf as B,
