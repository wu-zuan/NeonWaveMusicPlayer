...
var _p = bp;
function bp(e) {
  xt.hasOwnProperty("O_SYMLINK") && process.version.match(/^v0\.6\.[0-2]|^v0\.5\./) && t(e), e.lutimes || r(e), e.chown = a(e.chown), e.fchown = a(e.fchown), e.lchown = a(e.lchown), e.chmod = n(e.chmod), e.fchmod = n(e.fchmod), e.lchmod = n(e.lchmod), e.chownSync = s(e.chownSync), e.fchownSync = s(e.fchownSync), e.lchownSync = s(e.lchownSync), e.chmodSync = i(e.chmodSync), e.fchmodSync = i(e.fchmodSync), e.lchmodSync = i(e.lchmodSync), e.stat = o(e.stat), e.fstat = o(e.fstat), e.lstat = o(e.lstat), e.statSync = l(e.statSync), e.fstatSync = l(e.fstatSync), e.lstatSync = l(e.lstatSync), e.chmod && !e.lchmod && (e.lchmod = function(c, f, p) {
    p && process.nextTick(p);
  }, e.lchmodSync = function() {
  }), e.chown && !e.lchown && (e.lchown = function(c, f, p, m) {
    ...
    function f(p, m, E) {
      ...
      c(p, m, function _(b) {
        if (b && (b.code === "EACCES" || b.code === "EPERM" || b.code === "EBUSY") && Date.now() - x < 6e4) {
          setTimeout(function() {
            e.stat(m, function(O, S) {
              O && O.code === "ENOENT" ? c(p, m, _) : E(b);
            });
          }, T), T < 100 && (T += 10);
          return;
        }
    ...
    function f(p, m, E, x, T, _) {
      var b;
      if (_ && typeof _ == "function") {
        var O = 0;
        b = function(S, G, te) {
          if (S && S.code === "EAGAIN" && O < 10)
            return O++, c.call(e, p, m, E, x, T, b);
          _.apply(this, arguments);
        };
      }
      return c.call(e, p, m, E, x, T, b);
    }
    return Object.setPrototypeOf && Object.setPrototypeOf(f, c), f;
  }(e.read), e.readSync = typeof e.readSync != "function" ? e.readSync : /* @__PURE__ */ function(c) {
    return function(f, p, m, E, x) {
      for (var T = 0; ; )
        try {
          return c.call(e, f, p, m, E, x);
        } catch (_) {
  ...
  function t(c) {
    c.lchmod = function(f, p, m) {
      ...
      var m = c.openSync(f, xt.O_WRONLY | xt.O_SYMLINK, p), E = !0, x;
      try {
        x = c.fchmodSync(m, p), E = !1;
      } finally {
        if (E)
          try {
            c.closeSync(m);
  ...
  function r(c) {
    xt.hasOwnProperty("O_SYMLINK") && c.futimes ? (c.lutimes = function(f, p, m, E) {
    ...
    }, c.lutimesSync = function(f, p, m) {
      var E = c.openSync(f, xt.O_SYMLINK), x, T = !0;
      try {
        x = c.futimesSync(E, p, m), T = !1;
      } finally {
        if (T)
          try {
            c.closeSync(E);
      ...
      return x;
    }) : c.futimes && (c.lutimes = function(f, p, m, E) {
      E && process.nextTick(E);
    }, c.lutimesSync = function() {
    });
  }
  function n(c) {
    return c && function(f, p, m) {
      return c.call(e, f, p, function(E) {
  ...
  function a(c) {
    return c && function(f, p, m, E) {
      return c.call(e, f, p, m, function(x) {
        d(x) && (x = null), E && E.apply(this, arguments);
      });
    };
  }
  function s(c) {
  ...
  function o(c) {
    return c && function(f, p, m) {
      ...
      return p ? c.call(e, f, p, E) : c.call(e, f, E);
    };
  }
  function l(c) {
    return c && function(f, p) {
      var m = p ? c.call(e, f, p) : c.call(e, f);
...
var le = Dt, Op = _p, Dp = Sp, Pp = Ip, kn = us, Te, li;
...
if (!le[Te]) {
  ...
  Ic(le, Np), le.close = function(e) {
    ...
    function t(r) {
      e.apply(le, arguments), go();
    }
    return Object.defineProperty(t, li, {
      value: e
    }), t;
  }(le.closeSync), /\bgfs4\b/i.test(process.env.NODE_DEBUG || "") && process.on("exit", function() {
    Wt(le[Te]), _c.equal(le[Te].length, 0);
  });
}
De[Te] || Ic(De, le[Te]);
var Fe = fs(Pp(le));
process.env.TEST_GRACEFUL_FS_GLOBAL_PATCH && !le.__patched && (Fe = fs(le), le.__patched = !0);
function fs(e) {
  Op(e), e.gracefulify = fs, e.createReadStream = G, e.createWriteStream = te;
  var t = e.readFile;
  e.readFile = r;
  function r(y, U, j) {
    return typeof U == "function" && (j = U, U = null), M(y, U, j);
    function M(W, D, I, k) {
      return t(W, D, function(C) {
        C && (C.code === "EMFILE" || C.code === "ENFILE") ? nr([M, [W, D, I], C, k || Date.now(), Date.now()]) : typeof I == "function" && I.apply(this, arguments);
      });
    }
  }
  var n = e.writeFile;
  e.writeFile = i;
  function i(y, U, j, M) {
    return typeof j == "function" && (M = j, j = null), W(y, U, j, M);
    function W(D, I, k, C, F) {
      return n(D, I, k, function(P) {
        P && (P.code === "EMFILE" || P.code === "ENFILE") ? nr([W, [D, I, k, C], P, F || Date.now(), Date.now()]) : typeof C == "function" && C.apply(this, arguments);
      });
    }
  }
  var a = e.appendFile;
  ...
  o && (e.copyFile = l);
  function l(y, U, j, M) {
    return typeof j == "function" && (M = j, j = 0), W(y, U, j, M);
    function W(D, I, k, C, F) {
      return o(D, I, k, function(P) {
        P && (P.code === "EMFILE" || P.code === "ENFILE") ? nr([W, [D, I, k, C], P, F || Date.now(), Date.now()]) : typeof C == "function" && C.apply(this, arguments);
      });
    }
  }
  ...
  var c = /^v[0-5]\./;
  function f(y, U, j) {
    typeof U == "function" && (j = U, U = null);
    var M = c.test(process.version) ? function(I, k, C, F) {
      return d(I, W(
        I,
        k,
        C,
    ...
    function W(D, I, k, C) {
      return function(F, P) {
        F && (F.code === "EMFILE" || F.code === "ENFILE") ? nr([
          ...
          C || Date.now(),
          Date.now()
        ]) : (P && P.sort && P.sort(), typeof k == "function" && k.call(this, F, P));
      };
    }
  }
  if (process.version.substr(0, 4) === "v0.8") {
    var p = Dp(e);
    _ = p.ReadStream, O = p.WriteStream;
  }
  var m = e.ReadStream;
  m && (_.prototype = Object.create(m.prototype), _.prototype.open = b);
  var E = e.WriteStream;
  E && (O.prototype = Object.create(E.prototype), O.prototype.open = S), Object.defineProperty(e, "ReadStream", {
    get: function() {
      return _;
    },
    set: function(y) {
  ...
  function b() {
    var y = this;
    J(y.path, y.flags, y.mode, function(U, j) {
      U ? (y.autoClose && y.destroy(), y.emit("error", U)) : (y.fd = j, y.emit("open", j), y.read());
    });
  }
  function O(y, U) {
    return this instanceof O ? (E.apply(this, arguments), this) : O.apply(Object.create(O.prototype), arguments);
  }
  function S() {
    var y = this;
    J(y.path, y.flags, y.mode, function(U, j) {
      U ? (y.destroy(), y.emit("error", U)) : (y.fd = j, y.emit("open", j));
    });
  }
  function G(y, U) {
    return new e.ReadStream(y, U);
  }
  function te(y, U) {
    return new e.WriteStream(y, U);
  }
  var z = e.open;
  e.open = J;
  function J(y, U, j, M) {
...
function nr(e) {
  Wt("ENQUEUE", e[0].name, e[1]), le[Te].push(e), ds();
}
var Nn;
function go() {
  for (var e = Date.now(), t = 0; t < le[Te].length; ++t)
    le[Te][t].length > 2 && (le[Te][t][3] = e, le[Te][t][4] = e);
  ds();
}
function ds() {
  if (clearTimeout(Nn), Nn = void 0, le[Te].length !== 0) {
    var e = le[Te].shift(), t = e[0], r = e[1], n = e[2], i = e[3], a = e[4];
    if (i === void 0)
      ...
      o >= d ? (Wt("RETRY", t.name, r), t.apply(null, r.concat([i]))) : le[Te].push(e);
    }
...
const Ue = Fe, Xr = ce, Wp = ot.mkdirs, Vp = er.pathExists, Yp = kc.utimesMillis, Wr = br;
function Kp(e, t, r, n) {
...
function sh(e, t, r, n, i, a) {
  ...
  Wr.checkPaths(s, o, "copy", i, (l, d) => {
    if (l) return a(l);
    const { destStat: c } = d;
    Jp(c, s, o, i, (f) => f ? a(f) : Mc(e, r, n, i, a));
  });
}
...
var ch = Kp;
const Ae = Fe, Vr = ce, uh = ot.mkdirsSync, fh = kc.utimesMillisSync, Yr = br;
function dh(e, t, r) {
...
const wo = Fe, Gc = ce, ne = _c, Kr = process.platform === "win32";
function Hc(e) {
  [
    "unlink",
    "chmod",
...
function ys(e, t, r) {
  let n = 0;
  typeof t == "function" && (r = t, t = {}), ne(e, "rimraf: missing path"), ne.strictEqual(typeof e, "string", "rimraf: path should be a string"), ne.strictEqual(typeof r, "function", "rimraf: callback function required"), ne(t, "rimraf: invalid options argument provided"), ne.strictEqual(typeof t, "object", "rimraf: options should be object"), Hc(t), Eo(e, t, function i(a) {
    if (a) {
...
function qc(e, t) {
  let r;
  t = t || {}, Hc(t), ne(e, "rimraf: missing path"), ne.strictEqual(typeof e, "string", "rimraf: path should be a string"), ne(t, "rimraf: missing options"), ne.strictEqual(typeof t, "object", "rimraf: options should be object");
  try {
    r = t.lstatSync(e);
  } catch (n) {
    if (n.code === "ENOENT")
...
function Rh(e, t) {
  if (ne(e), ne(t), t.readdirSync(e).forEach((r) => qc(Gc.join(e, r), t)), Kr) {
    const r = Date.now();
    do
      try {
...
const Nh = Ne.fromPromise, Wc = Zt, Vc = ce, Yc = ot, Kc = Ii, _o = Nh(async function(t) {
  let r;
  try {
...
const $h = Ne.fromCallback, Jc = ce, Tt = Fe, Qc = ot;
function Lh(e, t) {
  function r() {
    Tt.writeFile(e, "", (n) => {
      if (n) return t(n);
...
const Bh = Ne.fromCallback, Zc = ce, vt = Fe, eu = ot, jh = er.pathExists, { areIdentical: tu } = br;
function zh(e, t, r) {
  function n(i, a) {
    vt.link(i, a, (s) => {
      if (s) return r(s);
...
const _t = ce, zr = Fe, qh = er.pathExists;
function Xh(e, t, r) {
  if (_t.isAbsolute(e))
...
const Qh = Ne.fromCallback, nu = ce, Ye = Zt, iu = ot, Zh = iu.mkdirs, em = iu.mkdirsSync, au = Vh, tm = au.symlinkPaths, rm = au.symlinkPathsSync, su = Jh, nm = su.symlinkType, im = su.symlinkTypeSync, am = er.pathExists, { areIdentical: ou } = br;
function sm(e, t, r, n) {
...
const Em = Ne.fromCallback, Gr = Fe, uu = ce, fu = ot, vm = er.pathExists;
function Tm(e, t, r, n) {
...
var km = ke;
const Nm = Fe, ja = ce, Fm = gs.copy, du = Ii.remove, $m = ot.mkdirp, Lm = er.pathExists, Po = br;
function Um(e, t, r, n) {
...
var jm = Um;
const pu = Fe, za = ce, zm = gs.copySync, hu = Ii.removeSync, Gm = ot.mkdirpSync, No = br;
function Hm(e, t, r) {
  r = r || {};
...
function mu() {
  ...
  $o = 1;
  function e(t) {
    n.debug = n, n.default = n, n.coerce = d, n.disable = o, n.enable = a, n.enabled = l, n.humanize = e0(), n.destroy = c, Object.keys(t).forEach((f) => {
      n[f] = t[f];
    }), n.names = [], n.skips = [], n.formatters = {};
    function r(f) {
      let p = 0;
      for (let m = 0; m < f.length; m++)
        p = (p << 5) - p + f.charCodeAt(m), p |= 0;
    ...
    function n(f) {
      ...
      function T(..._) {
        if (!T.enabled)
          return;
        const b = T, O = Number(/* @__PURE__ */ new Date()), S = O - (p || O);
        b.diff = S, b.prev = p, b.curr = O, p = O, _[0] = n.coerce(_[0]), typeof _[0] != "string" && _.unshift("%O");
        let G = 0;
        _[0] = _[0].replace(/%([a-zA-Z%])/g, (z, J) => {
          if (z === "%%")
            return "%";
          G++;
          const y = n.formatters[J];
          if (typeof y == "function") {
            const U = _[G];
            z = y.call(b, U), _.splice(G, 1), G--;
          }
          return z;
      ...
      return T.namespace = f, T.useColors = n.useColors(), T.color = n.selectColor(f), T.extend = i, T.destroy = n.destroy, Object.defineProperty(T, "enabled", {
        enumerable: !0,
        configurable: !1,
        get: () => m !== null ? m : (E !== n.namespaces && (E = n.namespaces, x = n.enabled(f)), x),
        set: (_) => {
          m = _;
        }
    ...
    function i(f, p) {
      const m = n(this.namespace + (typeof p > "u" ? ":" : p) + f);
...
function i0() {
  return Bo || (Bo = 1, function(e, t) {
    ...
    t.inspectOpts = Object.keys(process.env).filter((p) => /^debug_/i.test(p)).reduce((p, m) => {
      const E = m.substring(6).toLowerCase().replace(/_([a-z])/g, (T, _) => _.toUpperCase());
      let x = process.env[m];
      return /^(yes|on|true|enabled)$/i.test(x) ? x = !0 : /^(no|off|false|disabled)$/i.test(x) ? x = !1 : x === "null" ? x = null : x = Number(x), p[E] = x, p;
    }, {});
    function i() {
    ...
    function a(p) {
      ...
      if (E) {
        const x = this.color, T = "\x1B[3" + (x < 8 ? x : "8;5;" + x), _ = `  ${T};1m${m} \x1B[0m`;
        p[0] = _ + p[0].split(`
`).join(`
...
`));
    ...
    if (c && f != null) {
      ...
      this.doApiRequest(fi.prepareRedirectUrlOptions(f, r), n, o, s).then(i).catch(a);
      return;
    }
    t.setEncoding("utf8");
    let p = "";
    t.on("error", a), t.on("data", (m) => p += m), t.on("end", () => {
      try {
        if (t.statusCode != null && t.statusCode >= 400) {
          const m = xr(t, "content-type"), E = m != null && (Array.isArray(m) ? m.find((x) => x.includes("json")) != null : m.includes("json"));
          a(qa(t, `method: ${r.method || "GET"} url: ${r.protocol || "https:"}//${r.hostname}${r.port ? `:${r.port}` : ""}${r.path}
  ...
  (function(t) {
    ...
    function n(h, u) {
      if (!(this instanceof n))
        return new n(h, u);
      var A = this;
      a(A), A.q = A.c = "", A.bufferCheckPosition = t.MAX_BUFFER_LENGTH, A.opt = u || {}, A.opt.lowercase = A.opt.lowercase || A.opt.lowercasetags, A.looseCase = A.opt.lowercase ? "toLowerCase" : "toUpperCase", A.tags = [], A.closed = A.closedRoot = A.sawRoot = !1, A.tag = A.error = null, A.strict = !!h, A.noscript = !!(h || A.opt.noscript), A.state = y.BEGIN, A.strictEntities = A.opt.strictEntities, A.ENTITIES = A.strictEntities ? Object.create(t.XML_ENTITIES) : Object.create(t.ENTITIES), A.attribList = [], A.opt.xmlns && (A.ns = Object.create(x)), A.opt.unquotedAttributeValues === void 0 && (A.opt.unquotedAttributeValues = !h), A.trackPosition = A.opt.position !== !1, A.trackPosition && (A.position = A.line = A.column = 0), j(A, "onready");
    }
    ...
    function i(h) {
      for (var u = Math.max(t.MAX_BUFFER_LENGTH, 10), A = 0, v = 0, Z = r.length; v < Z; v++) {
        var ae = h[r[v]].length;
        if (ae > u)
          switch (r[v]) {
            case "textNode":
    ...
    function s(h) {
      W(h), h.cdata !== "" && (M(h, "oncdata", h.cdata), h.cdata = ""), h.script !== "" && (M(h, "onscript", h.script), h.script = "");
    }
    n.prototype = {
      end: function() {
        k(this);
    ...
    function c(h, u) {
      if (!(this instanceof c))
        return new c(h, u);
      o.apply(this), this._parser = new n(h, u), this.writable = !0, this.readable = !0;
      var A = this;
    ...
    var f = "[CDATA[", p = "DOCTYPE", m = "http://www.w3.org/XML/1998/namespace", E = "http://www.w3.org/2000/xmlns/", x = { xml: m, xmlns: E }, T = /[:_A-Za-z\u00C0-\u00D6\u00D8-\u00F6\u00F8-\u02FF\u0370-\u037D\u037F-\u1FFF\u200C-\u200D\u2070-\u218F\u2C00-\u2FEF\u3001-\uD7FF\uF900-\uFDCF\uFDF0-\uFFFD]/, _ = /[:_A-Za-z\u00C0-\u00D6\u00D8-\u00F6\u00F8-\u02FF\u0370-\u037D\u037F-\u1FFF\u200C-\u200D\u2070-\u218F\u2C00-\u2FEF\u3001-\uD7FF\uF900-\uFDCF\uFDF0-\uFFFD\u00B7\u0300-\u036F\u203F-\u2040.\d-]/, b = /[#:_A-Za-z\u00C0-\u00D6\u00D8-\u00F6\u00F8-\u02FF\u0370-\u037D\u037F-\u1FFF\u200C-\u200D\u2070-\u218F\u2C00-\u2FEF\u3001-\uD7FF\uF900-\uFDCF\uFDF0-\uFFFD]/, O = /[#:_A-Za-z\u00C0-\u00D6\u00D8-\u00F6\u00F8-\u02FF\u0370-\u037D\u037F-\u1FFF\u200C-\u200D\u2070-\u218F\u2C00-\u2FEF\u3001-\uD7FF\uF900-\uFDCF\uFDF0-\uFFFD\u00B7\u0300-\u036F\u203F-\u2040.\d-]/;
    function S(h) {
      return h === " " || h === `
` || h === "\r" || h === "	";
    }
    ...
    t.STATE = {
      ...
      var u = t.ENTITIES[h], A = typeof u == "number" ? String.fromCharCode(u) : u;
      t.ENTITIES[h] = A;
    });
    ...
    function M(h, u, A) {
      h.textNode && W(h), j(h, u, A);
    }
    function W(h) {
      h.textNode = D(h.opt, h.textNode), h.textNode && j(h, "ontext", h.textNode), h.textNode = "";
    }
    function D(h, u) {
      return h.trim && (u = u.trim()), h.normalize && (u = u.replace(/\s+/g, " ")), u;
    }
    function I(h, u) {
      return W(h), h.trackPosition && (u += `
Line: ` + h.line + `
Column: ` + h.column + `
Char: ` + h.c), u = new Error(u), h.error = u, j(h, "onerror", u), h;
    }
    function k(h) {
      return h.sawRoot && !h.closedRoot && C(h, "Unclosed root tag"), h.state !== y.BEGIN && h.state !== y.BEGIN_WHITESPACE && h.state !== y.TEXT && I(h, "Unexpected end"), W(h), h.c = "", h.closed = !0, j(h, "onend"), n.call(h, h.strict, h.opt), h;
    }
    function C(h, u) {
    ...
    function F(h) {
      ...
      var u = h.tags[h.tags.length - 1] || h, A = h.tag = { name: h.tagName, attributes: {} };
      h.opt.xmlns && (A.ns = u.ns), h.attribList.length = 0, M(h, "onopentagstart", A);
    }
    function P(h, u) {
      var A = h.indexOf(":"), v = A < 0 ? ["", h] : h.split(":"), Z = v[0], ae = v[1];
      return u && h === "xmlns" && (Z = "xmlns", ae = ""), { prefix: Z, local: ae };
    }
    function H(h) {
      ...
      if (h.opt.xmlns) {
        var u = P(h.attribName, !0), A = u.prefix, v = u.local;
        if (A === "xmlns")
...
Actual: ` + h.attribValue
    ...
    function Y(h, u) {
      if (h.opt.xmlns) {
        var A = h.tag, v = P(h.tagName);
        A.prefix = v.prefix, A.local = v.local, A.uri = A.ns[v.prefix] || "", A.prefix && !A.uri && (C(
          h,
          "Unbound namespace prefix: " + JSON.stringify(h.tagName)
        ), A.uri = v.prefix);
        var Z = h.tags[h.tags.length - 1] || h;
        A.ns && Z.ns !== A.ns && Object.keys(A.ns).forEach(function(_n) {
          M(h, "onopennamespace", {
            prefix: _n,
            uri: A.ns[_n]
          });
        ...
        for (var ae = 0, ue = h.attribList.length; ae < ue; ae++) {
          var Ee = h.attribList[ae], be = Ee[0], ht = Ee[1], pe = P(be, !0), We = pe.prefix, Ji = pe.local, Tn = We === "" ? "" : A.ns[We] || "", Rr = {
            name: be,
            value: ht,
            prefix: We,
            local: Ji,
          ...
          ), Rr.uri = We), h.tag.attributes[be] = Rr, M(h, "onattribute", Rr);
        }
    ...
    function q(h) {
      ...
      var u = h.tags.length, A = h.tagName;
      ...
      for (var ae = h.tags.length; ae-- > u; ) {
        ...
        h.opt.xmlns && ue.ns !== ht.ns && Object.keys(ue.ns).forEach(function(pe) {
          var We = ue.ns[pe];
          M(h, "onclosenamespace", { prefix: pe, uri: We });
        });
      }
      u === 0 && (h.closedRoot = !0), h.tagName = h.attribValue = h.attribName = "", h.attribList.length = 0, h.state = y.TEXT;
    }
    function re(h) {
      var u = h.entity, A = u.toLowerCase(), v, Z = "";
      return h.ENTITIES[u] ? h.ENTITIES[u] : h.ENTITIES[A] ? h.ENTITIES[A] : (u = A, u.charAt(0) === "#" && (u.charAt(1) === "x" ? (u = u.slice(2), v = parseInt(u, 16), Z = v.toString(16)) : (u = u.slice(1), v = parseInt(u, 10), Z = v.toString(10))), u = u.replace(/^0+/, ""), isNaN(v) || Z.toLowerCase() !== u || v < 0 || v > 1114111 ? (C(h, "Invalid character entity"), "&" + h.entity + ";") : String.fromCodePoint(v));
    }
    function me(h, u) {
      u === "<" ? (h.state = y.OPEN_WAKA, h.startTagPosition = h.position) : S(u) || (C(h, "Non-whitespace before first tag."), h.textNode = u, h.state = y.TEXT);
    }
    function B(h, u) {
      var A = "";
          ...
          case y.TEXT:
            if (u.sawRoot && !u.closedRoot) {
              for (var ae = A - 1; v && v !== "<" && v !== "&"; )
                v = B(h, A++), v && u.trackPosition && (u.position++, v === `
` ? (u.line++, u.column = 0) : u.column++);
              u.textNode += h.substring(ae, A - 1);
            }
            v === "<" && !(u.sawRoot && u.closedRoot && !u.strict) ? (u.state = y.OPEN_WAKA, u.startTagPosition = u.position) : (!S(v) && (!u.sawRoot || u.closedRoot) && C(u, "Text data outside of root node."), v === "&" ? u.state = y.TEXT_ENTITY : u.textNode += v);
            continue;
          case y.SCRIPT:
          ...
          case y.SGML_DECL:
            ...
            u.doctype && u.doctype !== !0 && u.sgmlDecl ? (u.state = y.DOCTYPE_DTD, u.doctype += "<!" + u.sgmlDecl + v, u.sgmlDecl = "") : (u.sgmlDecl + v).toUpperCase() === f ? (M(u, "onopencdata"), u.state = y.CDATA, u.sgmlDecl = "", u.cdata = "") : (u.sgmlDecl + v).toUpperCase() === p ? (u.state = y.DOCTYPE, (u.doctype || u.sawRoot) && C(
              u,
              "Inappropriately located doctype declaration"
            ), u.doctype = "", u.sgmlDecl = "") : v === ">" ? (M(u, "onsgmldeclaration", u.sgmlDecl), u.sgmlDecl = "", u.state = y.TEXT) : (G(v) && (u.state = y.SGML_DECL_QUOTED), u.sgmlDecl += v);
            continue;
          case y.SGML_DECL_QUOTED:
            v === u.q && (u.state = y.SGML_DECL, u.q = ""), u.sgmlDecl += v;
            continue;
          case y.DOCTYPE:
            v === ">" ? (u.state = y.TEXT, M(u, "ondoctype", u.doctype), u.doctype = !0) : (u.doctype += v, v === "[" ? u.state = y.DOCTYPE_DTD : G(v) && (u.state = y.DOCTYPE_QUOTED, u.q = v));
            continue;
          case y.DOCTYPE_QUOTED:
            u.doctype += v, v === u.q && (u.q = "", u.state = y.DOCTYPE);
            continue;
          case y.DOCTYPE_DTD:
            v === "]" ? (u.doctype += v, u.state = y.DOCTYPE) : v === "<" ? (u.state = y.OPEN_WAKA, u.startTagPosition = u.position) : G(v) ? (u.doctype += v, u.state = y.DOCTYPE_DTD_QUOTED, u.q = v) : u.doctype += v;
            continue;
          ...
          case y.COMMENT_ENDING:
            v === "-" ? (u.state = y.COMMENT_ENDED, u.comment = D(u.opt, u.comment), u.comment && M(u, "oncomment", u.comment), u.comment = "") : (u.comment += "-" + v, u.state = y.COMMENT);
            continue;
          case y.COMMENT_ENDED:
            v !== ">" ? (C(u, "Malformed comment"), u.comment += "--" + v, u.state = y.COMMENT) : u.doctype && u.doctype !== !0 ? u.state = y.DOCTYPE_DTD : u.state = y.TEXT;
            continue;
          case y.CDATA:
            for (var ae = A - 1; v && v !== "]"; )
              v = B(h, A++), v && u.trackPosition && (u.position++, v === `
` ? (u.line++, u.column = 0) : u.column++);
            u.cdata += h.substring(ae, A - 1), v === "]" && (u.state = y.CDATA_ENDING);
            continue;
          case y.CDATA_ENDING:
            v === "]" ? u.state = y.CDATA_ENDING_2 : (u.cdata += "]" + v, u.state = y.CDATA);
            continue;
          case y.CDATA_ENDING_2:
            v === ">" ? (u.cdata && M(u, "oncdata", u.cdata), M(u, "onclosecdata"), u.cdata = "", u.state = y.TEXT) : v === "]" ? u.cdata += "]" : (u.cdata += "]]" + v, u.state = y.CDATA);
            continue;
          case y.PROC_INST:
            v === "?" ? u.state = y.PROC_INST_ENDING : S(v) ? u.state = y.PROC_INST_BODY : u.procInstName += v;
            continue;
          case y.PROC_INST_BODY:
            if (!u.procInstBody && S(v))
              continue;
            v === "?" ? u.state = y.PROC_INST_ENDING : u.procInstBody += v;
            continue;
          case y.PROC_INST_ENDING:
            v === ">" ? (M(u, "onprocessinginstruction", {
              name: u.procInstName,
              body: u.procInstBody
            }), u.procInstName = u.procInstBody = "", u.state = y.TEXT) : (u.procInstBody += "?" + v, u.state = y.PROC_INST_BODY);
            continue;
          case y.OPEN_TAG:
            z(_, v) ? u.tagName += v : (F(u), v === ">" ? Y(u) : v === "/" ? u.state = y.OPEN_TAG_SLASH : (S(v) || C(u, "Invalid character in tag name"), u.state = y.ATTRIB));
            continue;
          ...
          case y.ATTRIB:
            if (S(v))
              continue;
            v === ">" ? Y(u) : v === "/" ? u.state = y.OPEN_TAG_SLASH : z(T, v) ? (u.attribName = v, u.attribValue = "", u.state = y.ATTRIB_NAME) : C(u, "Invalid attribute name");
            continue;
          case y.ATTRIB_NAME:
            v === "=" ? u.state = y.ATTRIB_VALUE : v === ">" ? (C(u, "Attribute without value"), u.attribValue = u.attribName, H(u), Y(u)) : S(v) ? u.state = y.ATTRIB_NAME_SAW_WHITE : z(_, v) ? u.attribName += v : C(u, "Invalid attribute name");
            continue;
          case y.ATTRIB_NAME_SAW_WHITE:
            if (v === "=")
              ...
              C(u, "Attribute without value"), u.tag.attributes[u.attribName] = "", u.attribValue = "", M(u, "onattribute", {
                name: u.attribName,
                value: ""
              }), u.attribName = "", v === ">" ? Y(u) : z(T, v) ? (u.attribName = v, u.state = y.ATTRIB_NAME) : (C(u, "Invalid attribute name"), u.state = y.ATTRIB);
            }
            continue;
          case y.ATTRIB_VALUE:
            if (S(v))
              continue;
            G(v) ? (u.q = v, u.state = y.ATTRIB_VALUE_QUOTED) : (u.opt.unquotedAttributeValues || I(u, "Unquoted attribute value"), u.state = y.ATTRIB_VALUE_UNQUOTED, u.attribValue = v);
            continue;
          case y.ATTRIB_VALUE_QUOTED:
            ...
            H(u), u.q = "", u.state = y.ATTRIB_VALUE_CLOSED;
            continue;
          case y.ATTRIB_VALUE_CLOSED:
            S(v) ? u.state = y.ATTRIB : v === ">" ? Y(u) : v === "/" ? u.state = y.OPEN_TAG_SLASH : z(T, v) ? (C(u, "No whitespace between attributes"), u.attribName = v, u.attribValue = "", u.state = y.ATTRIB_NAME) : C(u, "Invalid attribute name");
            continue;
          case y.ATTRIB_VALUE_UNQUOTED:
            ...
            H(u), v === ">" ? Y(u) : u.state = y.ATTRIB;
            continue;
          case y.CLOSE_TAG:
            if (u.tagName)
              v === ">" ? q(u) : z(_, v) ? u.tagName += v : u.script ? (u.script += "</" + u.tagName, u.tagName = "", u.state = y.SCRIPT) : (S(v) || C(u, "Invalid tagname in closing tag"), u.state = y.CLOSE_TAG_SAW_WHITE);
            else {
              if (S(v))
                continue;
              J(T, v) ? u.script ? (u.script += "</" + v, u.state = y.SCRIPT) : C(u, "Invalid tagname in closing tag.") : u.tagName = v;
            }
            continue;
          case y.CLOSE_TAG_SAW_WHITE:
            if (S(v))
              continue;
            v === ">" ? q(u) : C(u, "Invalid characters in closing tag");
            continue;
          case y.TEXT_ENTITY:
          ...
          case y.ATTRIB_VALUE_ENTITY_U:
            ...
            switch (u.state) {
              case y.TEXT_ENTITY:
                ue = y.TEXT, Ee = "textNode";
                break;
              case y.ATTRIB_VALUE_ENTITY_Q:
                ue = y.ATTRIB_VALUE_QUOTED, Ee = "attribValue";
                break;
              case y.ATTRIB_VALUE_ENTITY_U:
                ue = y.ATTRIB_VALUE_UNQUOTED, Ee = "attribValue";
                break;
            }
            if (v === ";") {
              var be = re(u);
              u.opt.unparsedEntities && !Object.values(t.XML_ENTITIES).includes(be) ? (u.entity = "", u.state = ue, u.write(be)) : (u[Ee] += be, u.entity = "", u.state = ue);
            } else z(u.entity.length ? O : b, v) ? u.entity += v : (C(u, "Invalid character in entity name"), u[Ee] += "&" + u.entity + v, u.entity = "", u.state = ue);
            continue;
          default:
    ...
    String.fromCodePoint || function() {
      var h = String.fromCharCode, u = Math.floor, A = function() {
        var v = 16384, Z = [], ae, ue, Ee = -1, be = arguments.length;
        if (!be)
          return "";
        for (var ht = ""; ++Ee < be; ) {
          ...
          pe <= 65535 ? Z.push(pe) : (pe -= 65536, ae = (pe >> 10) + 55296, ue = pe % 1024 + 56320, Z.push(ae, ue)), (Ee + 1 === be || Z.length > v) && (ht += h.apply(null, Z), Z.length = 0);
        }
        return ht;
      };
...
` + o;
  for (d = ha(e.buffer, n[s], i[s], e.position, f), o += Mr.repeat(" ", t.indent) + ma((e.line + 1).toString(), c) + " | " + d.str + `
...
function xg(e) {
  var t, r, n, i, a, s, o, l = 0, d = null, c, f, p;
  ...
  return t[9] && (c = +t[10], f = +(t[11] || 0), d = (c * 60 + f) * 6e4, t[9] === "-" && (d = -d)), p = new Date(Date.UTC(r, n, i, a, s, o, l)), d && p.setTime(p.getTime() - d), p;
}
function wg(e) {
...
function Jg(e, t, r) {
  var n, i, a, s, o, l, d, c, f = e.kind, p = e.result, m;
  if (m = e.input.charCodeAt(e.position), Me(m) || fr(m) || m === 35 || m === 38 || m === 42 || m === 33 || m === 124 || m === 62 || m === 39 || m === 34 || m === 37 || m === 64 || m === 96 || (m === 63 || m === 45) && (i = e.input.charCodeAt(e.position + 1), Me(i) || r && fr(i)))
    return !1;
  for (e.kind = "scalar", e.result = "", a = s = e.position, o = !1; m !== 0; ) {
    if (m === 58) {
      ...
      if (e.position === e.lineStart && Di(e) || r && fr(m))
        break;
      if (at(m))
        if (l = e.line, d = e.lineStart, c = e.lineIndent, de(e, !1, -1), e.lineIndent >= t) {
  ...
  return bt(e, a, s, !1), e.result ? !0 : (e.kind = f, e.result = p, !1);
}
function Qg(e, t) {
  var r, n, i;
  ...
  for (e.kind = "scalar", e.result = "", e.position++, n = i = e.position; (r = e.input.charCodeAt(e.position)) !== 0; )
    if (r === 39)
      if (bt(e, n, e.position, !0), r = e.input.charCodeAt(++e.position), r === 39)
        ...
        return !0;
    else at(r) ? (bt(e, n, i, !0), Cs(e, de(e, !1, t)), n = i = e.position) : e.position === e.lineStart && Di(e) ? L(e, "unexpected end of the document within a single quoted scalar") : (e.position++, i = e.position);
...
function Zg(e, t) {
  ...
  for (e.kind = "scalar", e.result = "", e.position++, r = n = e.position; (o = e.input.charCodeAt(e.position)) !== 0; ) {
    ...
    if (o === 92) {
      ...
      r = n = e.position;
    } else at(o) ? (bt(e, r, n, !0), Cs(e, de(e, !1, t)), r = n = e.position) : e.position === e.lineStart && Di(e) ? L(e, "unexpected end of the document within a double quoted scalar") : (e.position++, n = e.position);
  }
  L(e, "unexpected end of the stream within a double quoted scalar");
}
function ey(e, t) {
  var r = !0, n, i, a, s = e.tag, o, l = e.anchor, d, c, f, p, m, E = /* @__PURE__ */ Object.create(null), x, T, _, b;
  ...
  for (e.anchor !== null && (e.anchorMap[e.anchor] = o), b = e.input.charCodeAt(++e.position); b !== 0; ) {
    if (de(e, !0, t), b = e.input.charCodeAt(e.position), b === c)
      return e.position++, e.tag = s, e.anchor = l, e.kind = m ? "mapping" : "sequence", e.result = o, !0;
    r ? b === 44 && L(e, "expected the node content, but found ','") : L(e, "missed comma between flow collection entries"), T = x = _ = null, f = p = !1, b === 63 && (d = e.input.charCodeAt(e.position + 1), Me(d) && (f = p = !0, e.position++, de(e, !0, t))), n = e.line, i = e.lineStart, a = e.position, Tr(e, t, hi, !1, !0), T = e.tag, x = e.result, de(e, !0, t), b = e.input.charCodeAt(e.position), (p || e.line === n) && b === 58 && (f = !0, b = e.input.charCodeAt(++e.position), de(e, !0, t), Tr(e, t, hi, !1, !0), _ = e.result), m ? dr(e, o, E, T, x, _, n, i, a) : f ? o.push(dr(e, null, E, T, x, _, n, i, a)) : o.push(x), de(e, !0, t), b = e.input.charCodeAt(e.position), b === 44 ? (r = !0, b = e.input.charCodeAt(++e.position)) : r = !1;
  }
  L(e, "unexpected end of the stream within a flow collection");
}
function ty(e, t) {
  var r, n, i = ya, a = !1, s = !1, o = t, l = 0, d = !1, c, f;
  ...
  for (e.kind = "scalar", e.result = ""; f !== 0; )
    if (f = e.input.charCodeAt(++e.position), f === 43 || f === 45)
      ya === i ? i = f === 43 ? Wo : zg : L(e, "repeat of a chomping mode identifier");
    else if ((c = Vg(f)) >= 0)
  ...
  for (; f !== 0; ) {
    for (Is(e), e.lineIndent = 0, f = e.input.charCodeAt(e.position); (!s || e.lineIndent < o) && f === 32; )
      e.lineIndent++, f = e.input.charCodeAt(++e.position);
    if (!s && e.lineIndent > o && (o = e.lineIndent), at(f)) {
      l++;
      continue;
    }
    if (e.lineIndent < o) {
...
`, a ? 1 + l : l), a = !0, s = !0, l = 0, r = e.position; !at(f) && f !== 0; )
      f = e.input.charCodeAt(++e.position);
    bt(e, r, e.position, !1);
  }
  return !0;
...
function Qo(e, t) {
  ...
  for (e.anchor !== null && (e.anchorMap[e.anchor] = a), l = e.input.charCodeAt(e.position); l !== 0 && (e.firstTabInLine !== -1 && (e.position = e.firstTabInLine, L(e, "tab characters must not be used in indentation")), !(l !== 45 || (s = e.input.charCodeAt(e.position + 1), !Me(s)))); ) {
    ...
    if (r = e.line, Tr(e, t, Ku, !1, !0), a.push(e.result), de(e, !0, -1), l = e.input.charCodeAt(e.position), (e.line === r || e.lineIndent > t) && l !== 0)
...
function ry(e, t, r) {
  var n, i, a, s, o, l, d = e.tag, c = e.anchor, f = {}, p = /* @__PURE__ */ Object.create(null), m = null, E = null, x = null, T = !1, _ = !1, b;
  if (e.firstTabInLine !== -1) return !1;
  for (e.anchor !== null && (e.anchorMap[e.anchor] = f), b = e.input.charCodeAt(e.position); b !== 0; ) {
    if (!T && e.firstTabInLine !== -1 && (e.position = e.firstTabInLine, L(e, "tab characters must not be used in indentation")), n = e.input.charCodeAt(e.position + 1), a = e.line, (b === 63 || b === 58) && Me(n))
      b === 63 ? (T && (dr(e, f, p, m, E, null, s, o, l), m = E = x = null), _ = !0, T = !0, i = !0) : T ? (T = !1, i = !0) : L(e, "incomplete explicit mapping pair; a key node is missed; or followed by a non-tabulated empty line"), e.position += 1, b = n;
    else {
      ...
      if (e.line === a) {
        ...
        if (b === 58)
          b = e.input.charCodeAt(++e.position), Me(b) || L(e, "a whitespace character is expected after the key-value separator within a block mapping"), T && (dr(e, f, p, m, E, null, s, o, l), m = E = x = null), _ = !0, T = !1, i = !1, m = e.tag, E = e.result;
        else if (_)
    ...
    if ((e.line === a || e.lineIndent > t) && (T && (s = e.line, o = e.lineStart, l = e.position), Tr(e, t, mi, !0, i) && (T ? E = e.result : x = e.result), T || (dr(e, f, p, m, E, x, s, o, l), m = E = x = null), de(e, !0, -1), b = e.input.charCodeAt(e.position)), (e.line === a || e.lineIndent > t) && b !== 0)
      L(e, "bad indentation of a mapping entry");
    else if (e.lineIndent < t)
      break;
  }
  return T && dr(e, f, p, m, E, null, s, o, l), _ && (e.tag = d, e.anchor = c, e.kind = "mapping", e.result = f), _;
}
function ny(e) {
  var t, r = !1, n = !1, i, a, s;
...
function ay(e) {
  ...
  return e.position === t && L(e, "name of an alias node must contain at least one character"), r = e.input.slice(t, e.position), Ct.call(e.anchorMap, r) || L(e, 'unidentified alias "' + r + '"'), e.result = e.anchorMap[r], de(e, !0, -1), !0;
}
function Tr(e, t, r, n, i) {
  var a, s, o, l = 1, d = !1, c = !1, f, p, m, E, x, T;
  if (e.listener !== null && e.listener("open", e), e.tag = null, e.anchor = null, e.kind = null, e.result = null, a = s = o = mi === r || Ku === r, n && de(e, !0, -1) && (d = !0, e.lineIndent > t ? l = 1 : e.lineIndent === t ? l = 0 : e.lineIndent < t && (l = -1)), l === 1)
    for (; ny(e) || iy(e); )
      de(e, !0, -1) ? (d = !0, o = a, e.lineIndent > t ? l = 1 : e.lineIndent === t ? l = 0 : e.lineIndent < t && (l = -1)) : o = !1;
  if (o && (o = d || i), (l === 1 || mi === r) && (hi === r || Yu === r ? x = t : x = t + 1, T = e.position - e.lineStart, l === 1 ? o && (Qo(e, T) || ry(e, T, x)) || ey(e, x) ? c = !0 : (s && ty(e, x) || Qg(e, x) || Zg(e, x) ? c = !0 : ay(e) ? (c = !0, (e.tag !== null || e.anchor !== null) && L(e, "alias node should not have any properties")) : Jg(e, x, hi === r) && (c = !0, e.tag === null && (e.tag = "?")), e.anchor !== null && (e.anchorMap[e.anchor] = e.result)) : l === 0 && (c = o && Qo(e, T))), e.tag === null)
    ...
    if (Ct.call(e.typeMap[e.kind || "fallback"], e.tag))
      ...
      for (E = null, m = e.typeMap.multi[e.kind || "fallback"], f = 0, p = m.length; f < p; f += 1)
...
function sy(e) {
  ...
  for (e.version = null, e.checkLineBreaks = e.legacy, e.tagMap = /* @__PURE__ */ Object.create(null), e.anchorMap = /* @__PURE__ */ Object.create(null); (s = e.input.charCodeAt(e.position)) !== 0 && (de(e, !0, -1), s = e.input.charCodeAt(e.position), !(e.lineIndent > 0 || s !== 37)); ) {
  ...
  if (de(e, !0, -1), e.lineIndent === 0 && e.input.charCodeAt(e.position) === 45 && e.input.charCodeAt(e.position + 1) === 45 && e.input.charCodeAt(e.position + 2) === 45 ? (e.position += 3, de(e, !0, -1)) : a && L(e, "directives end mark is expected"), Tr(e, e.lineIndent - 1, mi, !1, !0), de(e, !0, -1), e.checkLineBreaks && Hg.test(e.input.slice(t, e.position)) && gi(e, "non-ASCII line breaks are interpreted as content"), e.documents.push(e.result), e.position === e.lineStart && Di(e)) {
...
function Fy(e, t, r, n, i, a, s, o) {
  var l, d = 0, c = null, f = !1, p = !1, m = n !== -1, E = -1, x = ky(Br(e, 0)) && Ny(Br(e, e.length - 1));
  if (t || s)
    ...
    for (l = 0; l < e.length; d >= 65536 ? l += 2 : l++) {
      if (d = Br(e, l), d === Qr)
        f = !0, m && (p = p || // Foldable line = too long, and not more-indented.
        l - E - 1 > n && e[E + 1] !== " ", E = l);
      else if (!en(d))
        return ur;
      x = x && tl(d, c, o), c = d;
  ...
  return !f && !p ? x && !s && !i(e) ? hf : a === Zr ? ur : Ka : r > 9 && pf(e) ? ur : s ? a === Zr ? ur : Ka : p ? gf : mf;
}
...
function jy(e, t, r, n) {
  var i = "", a = e.tag, s = Object.keys(r), o, l, d, c, f, p;
  if (e.sortKeys === !0)
    s.sort();
  ...
  for (o = 0, l = s.length; o < l; o += 1)
    p = "", (!n || i !== "") && (p += Ya(e, t)), d = s[o], c = r[d], e.replacer && (c = e.replacer.call(r, d, c)), dt(e, t + 1, d, !0, !0, !0) && (f = e.tag !== null && e.tag !== "?" || e.dump && e.dump.length > 1024, f && (e.dump && Qr === e.dump.charCodeAt(0) ? p += "?" : p += "? "), p += e.dump, f && (p += Ya(e, t)), dt(e, t + 1, c, !0, f) && (e.dump && Qr === e.dump.charCodeAt(0) ? p += ":" : p += ": ", p += e.dump, i += p));
  e.tag = a, e.dump = i || "{}";
}
function sl(e, t, r) {
  var n, i, a, s, o, l;
...
function dt(e, t, r, n, i, a, s) {
  ...
  var c = o === "[object Object]" || o === "[object Array]", f, p;
  if (c && (f = e.duplicates.indexOf(r), p = f !== -1), (e.tag !== null && e.tag !== "?" || p || e.indent !== 2 && t > 0) && (i = !1), p && e.usedDuplicates[f])
    e.dump = "*ref_" + f;
  else {
    if (c && p && !e.usedDuplicates[f] && (e.usedDuplicates[f] = !0), o === "[object Object]")
      n && Object.keys(e.dump).length !== 0 ? (jy(e, t, e.dump, i), p && (e.dump = "&ref_" + f + e.dump)) : (By(e, t, e.dump), p && (e.dump = "&ref_" + f + " " + e.dump));
    else if (o === "[object Array]")
      n && e.dump.length !== 0 ? (e.noArrayIndent && !s && t > 0 ? al(e, t - 1, e.dump, i) : al(e, t, e.dump, i), p && (e.dump = "&ref_" + f + e.dump)) : (My(e, t, e.dump), p && (e.dump = "&ref_" + f + " " + e.dump));
...
(function(e, t) {
  ...
  const p = "[a-zA-Z0-9-]", m = [
    ...
    const O = E(_), S = f++;
    a(T, S, _), c[T] = S, l[S] = _, d[S] = O, s[S] = new RegExp(_, b ? "g" : void 0), o[S] = new RegExp(O, b ? "g" : void 0);
  };
...
function Ze() {
  ...
  class t {
    constructor(I, k) {
      ...
      if (this.options = k, this.loose = !!k.loose, this.includePrerelease = !!k.includePrerelease, this.raw = I.trim().replace(e, " "), this.set = this.raw.split("||").map((C) => this.parseRange(C.trim())).filter((C) => C.length), !this.set.length)
        throw new TypeError(`Invalid SemVer Range: ${this.raw}`);
      if (this.set.length > 1) {
        const C = this.set[0];
        if (this.set = this.set.filter((F) => !x(F[0])), this.set.length === 0)
          this.set = [C];
      ...
      if (this.formatted === void 0) {
        ...
        for (let I = 0; I < this.set.length; I++) {
          ...
          for (let C = 0; C < k.length; C++)
            C > 0 && (this.formatted += " "), this.formatted += k[C].toString().trim();
        }
      }
    ...
    parseRange(I) {
      const C = ((this.options.includePrerelease && m) | (this.options.loose && E)) + ":" + I, F = n.get(C);
      if (F)
        return F;
      const P = this.options.loose, H = P ? l[d.HYPHENRANGELOOSE] : l[d.HYPHENRANGE];
      I = I.replace(H, M(this.options.includePrerelease)), s("hyphen replace", I), I = I.replace(l[d.COMPARATORTRIM], c), s("comparator trim", I), I = I.replace(l[d.TILDETRIM], f), s("tilde trim", I), I = I.replace(l[d.CARETTRIM], p), s("caret trim", I);
      let Y = I.split(" ").map((B) => b(B, this.options)).join(" ").split(/\s+/).map((B) => j(B, this.options));
      P && (Y = Y.filter((B) => (s("loose invalid filter", B, this.options), !!B.match(l[d.COMPARATORLOOSE])))), s("range list", Y);
      const q = /* @__PURE__ */ new Map(), re = Y.map((B) => new a(B, this.options));
      for (const B of re) {
        if (x(B))
          return [B];
        q.set(B.value, B);
      ...
      const me = [...q.values()];
      return n.set(C, me), me;
    }
    intersects(I, k) {
      if (!(I instanceof t))
        throw new TypeError("a Range is required");
      return this.set.some((C) => _(C, k) && I.set.some((F) => _(F, k) && C.every((P) => F.every((H) => P.intersects(H, k)))));
    }
    ...
    test(I) {
      ...
      for (let k = 0; k < this.set.length; k++)
        if (W(this.set[k], I, this.options))
          return !0;
      return !1;
    }
  }
  ...
  const r = fw, n = new r(), i = Ds, a = Li(), s = Fi, o = Le, {
    ...
    tildeTrimReplace: f,
    caretTrimReplace: p
  } = mn, { FLAG_INCLUDE_PRERELEASE: m, FLAG_LOOSE: E } = Ni, x = (D) => D.value === "<0.0.0-0", T = (D) => D.value === "", _ = (D, I) => {
    let k = !0;
    const C = D.slice();
    let F = C.pop();
    for (; k && C.length; )
      k = C.every((P) => F.intersects(P, I)), F = C.pop();
    return k;
  }, b = (D, I) => (D = D.replace(l[d.BUILD], ""), s("comp", D, I), D = te(D, I), s("caret", D), D = S(D, I), s("tildes", D), D = J(D, I), s("xrange", D), D = U(D, I), s("stars", D), D), O = (D) => !D || D.toLowerCase() === "x" || D === "*", S = (D, I) => D.trim().split(/\s+/).map((k) => G(k, I)).join(" "), G = (D, I) => {
    const k = I.loose ? l[d.TILDELOOSE] : l[d.TILDE];
    return D.replace(k, (C, F, P, H, Y) => {
      s("tilde", D, C, F, P, H, Y);
      let q;
      return O(F) ? q = "" : O(P) ? q = `>=${F}.0.0 <${+F + 1}.0.0-0` : O(H) ? q = `>=${F}.${P}.0 <${F}.${+P + 1}.0-0` : Y ? (s("replaceTilde pr", Y), q = `>=${F}.${P}.${H}-${Y} <${F}.${+P + 1}.0-0`) : q = `>=${F}.${P}.${H} <${F}.${+P + 1}.0-0`, s("tilde return", q), q;
    });
  }, te = (D, I) => D.trim().split(/\s+/).map((k) => z(k, I)).join(" "), z = (D, I) => {
    s("caret", D, I);
    const k = I.loose ? l[d.CARETLOOSE] : l[d.CARET], C = I.includePrerelease ? "-0" : "";
    return D.replace(k, (F, P, H, Y, q) => {
      s("caret", D, F, P, H, Y, q);
      let re;
      return O(P) ? re = "" : O(H) ? re = `>=${P}.0.0${C} <${+P + 1}.0.0-0` : O(Y) ? P === "0" ? re = `>=${P}.${H}.0${C} <${P}.${+H + 1}.0-0` : re = `>=${P}.${H}.0${C} <${+P + 1}.0.0-0` : q ? (s("replaceCaret pr", q), P === "0" ? H === "0" ? re = `>=${P}.${H}.${Y}-${q} <${P}.${H}.${+Y + 1}-0` : re = `>=${P}.${H}.${Y}-${q} <${P}.${+H + 1}.0-0` : re = `>=${P}.${H}.${Y}-${q} <${+P + 1}.0.0-0`) : (s("no pr"), P === "0" ? H === "0" ? re = `>=${P}.${H}.${Y}${C} <${P}.${H}.${+Y + 1}-0` : re = `>=${P}.${H}.${Y}${C} <${P}.${+H + 1}.0-0` : re = `>=${P}.${H}.${Y} <${+P + 1}.0.0-0`), s("caret return", re), re;
    });
  }, J = (D, I) => (s("replaceXRanges", D, I), D.split(/\s+/).map((k) => y(k, I)).join(" ")), y = (D, I) => {
    D = D.trim();
    const k = I.loose ? l[d.XRANGELOOSE] : l[d.XRANGE];
    return D.replace(k, (C, F, P, H, Y, q) => {
      s("xRange", D, C, F, P, H, Y, q);
      const re = O(P), me = re || O(H), B = me || O(Y), et = B;
      return F === "=" && et && (F = ""), q = I.includePrerelease ? "-0" : "", re ? F === ">" || F === "<" ? C = "<0.0.0-0" : C = "*" : F && et ? (me && (H = 0), Y = 0, F === ">" ? (F = ">=", me ? (P = +P + 1, H = 0, Y = 0) : (H = +H + 1, Y = 0)) : F === "<=" && (F = "<", me ? P = +P + 1 : H = +H + 1), F === "<" && (q = "-0"), C = `${F + P}.${H}.${Y}${q}`) : me ? C = `>=${P}.0.0${q} <${+P + 1}.0.0-0` : B && (C = `>=${P}.${H}.0${q} <${P}.${+H + 1}.0-0`), s("xRange return", C), C;
    });
  }, U = (D, I) => (s("replaceStars", D, I), D.trim().replace(l[d.STAR], "")), j = (D, I) => (s("replaceGTE0", D, I), D.trim().replace(l[I.includePrerelease ? d.GTE0PRE : d.GTE0], "")), M = (D) => (I, k, C, F, P, H, Y, q, re, me, B, et) => (O(C) ? k = "" : O(F) ? k = `>=${C}.0.0${D ? "-0" : ""}` : O(P) ? k = `>=${C}.${F}.0${D ? "-0" : ""}` : H ? k = `>=${k}` : k = `>=${k}${D ? "-0" : ""}`, O(re) ? q = "" : O(me) ? q = `<${+re + 1}.0.0-0` : O(B) ? q = `<${re}.${+me + 1}.0-0` : et ? q = `<=${re}.${me}.${B}-${et}` : D ? q = `<${re}.${me}.${+B + 1}-0` : q = `<=${q}`, `${k} ${q}`.trim()), W = (D, I, k) => {
    for (let C = 0; C < D.length; C++)
      if (!D[C].test(I))
        return !1;
    if (I.prerelease.length && !k.includePrerelease) {
      for (let C = 0; C < D.length; C++)
        if (s(D[C].semver), D[C].semver !== a.ANY && D[C].semver.prerelease.length > 0) {
          const F = D[C].semver;
...
const Dw = Le, bf = Li(), { ANY: Pw } = bf, kw = Ze(), Nw = Ui, yl = $i, xl = ks, Fw = Fs, $w = Ns, Lw = (e, t, r, n) => {
  ...
  for (let d = 0; d < t.set.length; ++d) {
    ...
    let f = null, p = null;
    if (c.forEach((m) => {
      m.semver === Pw && (m = new bf(">=0.0.0")), f = f || m, p = p || m, i(m.semver, f.semver, n) ? f = m : s(m.semver, p.semver, n) && (p = m);
    }), f.operator === o || f.operator === l || (!p.operator || p.operator === o) && a(e, p.semver))
      return !1;
...
const El = Ze(), Ls = Li(), { ANY: Ta } = Ls, $r = Ui, Us = Qe, Yw = (e, t, r = {}) => {
  ...
  let o, l, d, c, f = a && !r.includePrerelease && a.semver.prerelease.length ? a.semver : !1, p = i && !r.includePrerelease && i.semver.prerelease.length ? i.semver : !1;
  ...
  return !(i && d && !a && s !== 0 || a && c && !i && s !== 0 || p || f);
}, Tl = (e, t, r) => {
  if (!e)
    return t;
...
wi.exports;
(function(e, t) {
  var r = 200, n = "__lodash_hash_undefined__", i = 1, a = 2, s = 9007199254740991, o = "[object Arguments]", l = "[object Array]", d = "[object AsyncFunction]", c = "[object Boolean]", f = "[object Date]", p = "[object Error]", m = "[object Function]", E = "[object GeneratorFunction]", x = "[object Map]", T = "[object Number]", _ = "[object Null]", b = "[object Object]", O = "[object Promise]", S = "[object Proxy]", G = "[object RegExp]", te = "[object Set]", z = "[object String]", J = "[object Symbol]", y = "[object Undefined]", U = "[object WeakMap]", j = "[object ArrayBuffer]", M = "[object DataView]", W = "[object Float32Array]", D = "[object Float64Array]", I = "[object Int8Array]", k = "[object Int16Array]", C = "[object Int32Array]", F = "[object Uint8Array]", P = "[object Uint8ClampedArray]", H = "[object Uint16Array]", Y = "[object Uint32Array]", q = /[\\^$.*+?()[\]{}|]/g, re = /^\[object .+?Constructor\]$/, me = /^(?:0|[1-9]\d*)$/, B = {};
  B[W] = B[D] = B[I] = B[k] = B[C] = B[F] = B[P] = B[H] = B[Y] = !0, B[o] = B[l] = B[j] = B[c] = B[M] = B[f] = B[p] = B[m] = B[x] = B[T] = B[b] = B[G] = B[te] = B[z] = B[U] = !1;
  var et = typeof De == "object" && De && De.Object === Object && De, h = typeof self == "object" && self && self.Object === Object && self, u = et || h || Function("return this")(), A = t && !t.nodeType && t, v = A && !0 && e && !e.nodeType && e, Z = v && v.exports === A, ae = Z && et.process, ue = function() {
    try {
  ...
  function be(g, w) {
    for (var R = -1, $ = g == null ? 0 : g.length, se = 0, V = []; ++R < $; ) {
      var fe = g[R];
      w(fe, R, g) && (V[se++] = fe);
    }
    return V;
  ...
  function ht(g, w) {
    for (var R = -1, $ = w.length, se = g.length; ++R < $; )
      g[se + R] = w[R];
    return g;
  }
  function pe(g, w) {
    for (var R = -1, $ = g == null ? 0 : g.length; ++R < $; )
      if (w(g[R], R, g))
        return !0;
    return !1;
  }
  function We(g, w) {
    for (var R = -1, $ = Array(g); ++R < g; )
      $[R] = w(R);
    return $;
  }
  function Ji(g) {
  ...
  var fd = Array.prototype, dd = Function.prototype, bn = Object.prototype, Qi = u["__core-js_shared__"], Vs = dd.toString, tt = bn.hasOwnProperty, Ys = function() {
    var g = /[^.]+$/.exec(Qi && Qi.keys && Qi.keys.IE_PROTO || "");
    return g ? "Symbol(src)_1." + g : "";
  }(), Ks = bn.toString, pd = RegExp(
    "^" + Vs.call(tt).replace(q, "\\$&").replace(/hasOwnProperty|(function).*?(?=\\\()| for .+?(?=\\\])/g, "$1.*?") + "$"
  ), Js = Z ? u.Buffer : void 0, Sn = u.Symbol, Qs = u.Uint8Array, Zs = bn.propertyIsEnumerable, hd = fd.splice, Nt = Sn ? Sn.toStringTag : void 0, eo = Object.getOwnPropertySymbols, md = Js ? Js.isBuffer : void 0, gd = cd(Object.keys, Object), Zi = rr(u, "DataView"), Or = rr(u, "Map"), ea = rr(u, "Promise"), ta = rr(u, "Set"), ra = rr(u, "WeakMap"), Dr = rr(Object, "create"), yd = Lt(Zi), xd = Lt(Or), wd = Lt(ea), Ed = Lt(ta), vd = Lt(ra), to = Sn ? Sn.prototype : void 0, na = to ? to.valueOf : void 0;
  function Ft(g) {
  ...
  function bd(g) {
    ...
    return tt.call(w, g) ? w[g] : void 0;
  }
  function Sd(g) {
    var w = this.__data__;
    return Dr ? w[g] !== void 0 : tt.call(w, g);
  }
  function Ad(g, w) {
    var R = this.__data__;
    return this.size += this.has(g) ? 0 : 1, R[g] = Dr && w === void 0 ? n : w, this;
  }
  ...
  function Cd(g) {
    var w = this.__data__, R = In(w, g);
    if (R < 0)
      return !1;
    var $ = w.length - 1;
    return R == $ ? w.pop() : hd.call(w, R, 1), --this.size, !0;
  }
  function Rd(g) {
    var w = this.__data__, R = In(w, g);
  ...
  function Dd(g, w) {
    var R = this.__data__, $ = In(R, g);
    return $ < 0 ? (++this.size, R.push([g, w])) : R[$][1] = w, this;
  }
  ...
  function Gd(g, w) {
    ...
    if (R instanceof lt) {
      var $ = R.__data__;
      if (!Or || $.length < r - 1)
        return $.push([g, w]), this.size = ++R.size, this;
      R = this.__data__ = new $t($);
    }
  ...
  function Hd(g, w) {
    var R = Rn(g), $ = !R && ap(g), se = !R && !$ && ia(g), V = !R && !$ && !se && uo(g), fe = R || $ || se || V, ge = fe ? We(g.length, String) : [], ve = ge.length;
    for (var oe in g)
      tt.call(g, oe) && !(fe && // Safari 9 has enumerable `arguments.length` in strict mode.
  ...
  function Pr(g) {
    return g == null ? g === void 0 ? y : _ : Nt && Nt in Object(g) ? Qd(g) : ip(g);
  }
  function ro(g) {
    return kr(g) && Pr(g) == o;
  }
  function no(g, w, R, $, se) {
    return g === w ? !0 : g == null || w == null || !kr(g) && !kr(w) ? g !== g && w !== w : Xd(g, w, R, $, no, se);
  }
  function Xd(g, w, R, $, se, V) {
    var fe = Rn(g), ge = Rn(w), ve = fe ? l : gt(g), oe = ge ? l : gt(w);
    ve = ve == o ? b : ve, oe = oe == o ? b : oe;
    var Be = ve == b, Ve = oe == b, Se = ve == oe;
    if (Se && ia(g)) {
      if (!ia(w))
        return !1;
      fe = !0, Be = !1;
    ...
    if (Se && !Be)
      return V || (V = new mt()), fe || uo(g) ? io(g, w, R, $, se, V) : Kd(g, w, ve, R, $, se, V);
    if (!(R & i)) {
      var Ge = Be && tt.call(g, "__wrapped__"), He = Ve && tt.call(w, "__wrapped__");
      if (Ge || He) {
        var yt = Ge ? g.value() : g, ct = He ? w.value() : w;
        return V || (V = new mt()), se(yt, ct, R, $, V);
      }
    }
    return Se ? (V || (V = new mt()), Jd(g, w, R, $, se, V)) : !1;
  }
  function Wd(g) {
    if (!co(g) || rp(g))
      return !1;
  ...
  function Vd(g) {
    return kr(g) && lo(g.length) && !!B[Pr(g)];
  }
  function Yd(g) {
    if (!np(g))
      return gd(g);
    ...
    for (var R in Object(g))
      tt.call(g, R) && R != "constructor" && w.push(R);
    return w;
  }
  function io(g, w, R, $, se, V) {
    var fe = R & i, ge = g.length, ve = w.length;
    if (ge != ve && !(fe && ve > ge))
      return !1;
    var oe = V.get(g);
    if (oe && V.get(w))
      return oe == w;
    var Be = -1, Ve = !0, Se = R & a ? new An() : void 0;
    for (V.set(g, w), V.set(w, g); ++Be < ge; ) {
      var Ge = g[Be], He = w[Be];
      if ($)
        var yt = fe ? $(He, Ge, Be, w, g, V) : $(Ge, He, Be, g, w, V);
      if (yt !== void 0) {
        if (yt)
          continue;
        Ve = !1;
      ...
      if (Se) {
        if (!pe(w, function(ct, Ut) {
          if (!Tn(Se, Ut) && (Ge === ct || se(Ge, ct, R, $, V)))
            return Se.push(Ut);
        })) {
          Ve = !1;
          break;
        }
      } else if (!(Ge === He || se(Ge, He, R, $, V))) {
        Ve = !1;
        break;
      }
    }
    return V.delete(g), V.delete(w), Ve;
  }
  function Kd(g, w, R, $, se, V, fe) {
    switch (R) {
      case M:
      ...
      case j:
        return !(g.byteLength != w.byteLength || !V(new Qs(g), new Qs(w)));
      case c:
      case f:
      case T:
        return so(+g, +w);
      ...
      case te:
        var ve = $ & i;
        if (ge || (ge = ud), g.size != w.size && !ve)
          return !1;
        var oe = fe.get(g);
        if (oe)
          return oe == w;
        $ |= a, fe.set(g, w);
        var Be = io(ge(g), ge(w), $, se, V, fe);
        return fe.delete(g), Be;
      case J:
        if (na)
          return na.call(g) == na.call(w);
    }
    return !1;
  }
  function Jd(g, w, R, $, se, V) {
    var fe = R & i, ge = ao(g), ve = ge.length, oe = ao(w), Be = oe.length;
    if (ve != Be && !fe)
      return !1;
    for (var Ve = ve; Ve--; ) {
      var Se = ge[Ve];
      if (!(fe ? Se in w : tt.call(w, Se)))
        return !1;
    }
    var Ge = V.get(g);
    if (Ge && V.get(w))
    ...
    for (var yt = fe; ++Ve < ve; ) {
      ...
      var ct = g[Se], Ut = w[Se];
      if ($)
        var fo = fe ? $(Ut, ct, Se, w, g, V) : $(ct, Ut, Se, g, w, V);
      if (!(fo === void 0 ? ct === Ut || se(ct, Ut, R, $, V) : fo)) {
        He = !1;
        break;
      }
    ...
    if (He && !yt) {
      var On = g.constructor, Dn = w.constructor;
      On != Dn && "constructor" in g && "constructor" in w && !(typeof On == "function" && On instanceof On && typeof Dn == "function" && Dn instanceof Dn) && (He = !1);
    }
    return V.delete(g), V.delete(w), He;
  }
  function ao(g) {
    return qd(g, lp, Zd);
  }
  function Cn(g, w) {
    var R = g.__data__;
    return tp(w) ? R[typeof w == "string" ? "string" : "hash"] : R.map;
  }
  function rr(g, w) {
    var R = Rr(g, w);
  ...
  function Qd(g) {
    ...
    var se = Ks.call(g);
    return $ && (w ? g[Nt] = R : delete g[Nt]), se;
  }
  var Zd = eo ? function(g) {
    return g == null ? [] : (g = Object(g), be(eo(g), function(w) {
      return Zs.call(g, w);
    }));
  } : cp, gt = Pr;
  (Zi && gt(new Zi(new ArrayBuffer(1))) != M || Or && gt(new Or()) != x || ea && gt(ea.resolve()) != O || ta && gt(new ta()) != te || ra && gt(new ra()) != U) && (gt = function(g) {
    var w = Pr(g), R = w == b ? g.constructor : void 0, $ = R ? Lt(R) : "";
    if ($)
      switch ($) {
        case yd:
          return M;
  ...
  function ep(g, w) {
    return w = w ?? s, !!w && (typeof g == "number" || me.test(g)) && g > -1 && g % 1 == 0 && g < w;
  }
  function tp(g) {
    var w = typeof g;
  ...
  function np(g) {
    var w = g && g.constructor, R = typeof w == "function" && w.prototype || bn;
    return g === R;
  }
  function ip(g) {
    return Ks.call(g);
...
const UE = cn, ME = Dt, Al = LE, zt = Pt, qr = ce;
class BE {
  constructor(t) {
...
he.Provider = void 0;
he.findFile = dv;
he.parseUpdateInfo = pv;
he.getFileList = Rf;
he.resolveFiles = hv;
const Rt = we, uv = _e, Dl = Xe;
class fv {
  constructor(t) {
...
const ut = we, pr = Sf, yv = _r, hr = Xe, es = he, Ra = /\/tag\/([^/]+)$/;
      ...
      if (this.updater.allowPrerelease) {
        ...
        if (T === null)
          ...
          for (const _ of l.getElements("entry")) {
            const b = Ra.exec(_.element("link").attribute("href"));
            if (b === null)
              continue;
            const O = b[1], S = ((n = pr.prerelease(O)) === null || n === void 0 ? void 0 : n[0]) || null, G = !T || ["alpha", "beta"].includes(T), te = S !== null && !["alpha", "beta"].includes(String(S));
            if (G && !te && !(T === "beta" && S === "alpha")) {
              c = O;
              break;
            }
            if (S && S === T) {
...
${o}`, "ERR_UPDATER_INVALID_RELEASE_FEED");
    ...
    let f, p = "", m = "";
    const E = async (T) => {
      p = (0, hr.getChannelFilename)(T), m = (0, hr.newUrlFromBase)(this.getBaseDownloadPath(String(c), p), this.baseUrl);
      const _ = this.createRequestOptions(m);
      try {
        return await this.executor.request(_, s);
      } catch (b) {
        throw b instanceof ut.HttpError && b.statusCode === 404 ? (0, ut.newError)(`Cannot find ${p} in the latest release artifacts (${m}): ${b.stack || b.message}`, "ERR_UPDATER_CHANNEL_FILE_NOT_FOUND") : b;
      }
    };
    try {
      let T = this.channel;
      this.updater.allowPrerelease && (!((i = pr.prerelease(c)) === null || i === void 0) && i[0]) && (T = this.getCustomChannelName(String((a = pr.prerelease(c)) === null || a === void 0 ? void 0 : a[0]))), f = await E(T);
    } catch (T) {
      if (this.updater.allowPrerelease)
    ...
    const x = (0, es.parseUpdateInfo)(f, p, m);
...
const ar = we, Ev = _e, vv = ce, $l = _r, Ll = Xe, Tv = Ot, _v = he;
...
Bi.createClient = Rv;
const qn = we, Sv = ji, Ul = yn, Av = Ot, Iv = zi, Cv = Gi;
function Pf(e) {
...
function Ov(e, t, r) {
  ...
  const c = i.get(l);
  let f = 0;
  const { checksumToOffset: p, checksumToOldSize: m } = Pv(n.get(l), d.offset, r);
  let E = s.offset;
  for (let x = 0; x < c.checksums.length; E += c.sizes[x], x++) {
    const T = c.sizes[x], _ = c.checksums[x];
    let b = p.get(_);
    b != null && m.get(_) !== T && (r.warn(`Checksum ("${_}") matches, but size differs (old: ${m.get(_)}, new: ${T})`), b = void 0), b === void 0 ? (f++, a != null && a.kind === Xt.DOWNLOAD && a.end === E ? a.end += T : (a = {
      kind: Xt.DOWNLOAD,
      start: E,
      end: E + T
      // oldBlocks: null,
    }, Ml(a, o, _, x))) : a != null && a.kind === Xt.COPY && a.end === b ? a.end += T : (a = {
      kind: Xt.COPY,
      start: b,
      end: b + T
      // oldBlocks: [checksum]
...
Cr.copyData = kf;
const Xn = we, kv = Dt, Nv = ln, Fv = tr, jl = Buffer.from(`\r
\r
`);
var Et;
(function(e) {
...
function Uv(e, t, r, n, i) {
  ...
  for (let f = t.start; f < t.end; f++) {
    const p = t.tasks[f];
    p.kind === Gl.OperationKind.DOWNLOAD && (a += `${p.start}-${p.end - 1}, `, o.set(s, f), s++, l.push(p.end - p.start));
  }
  if (s <= 1) {
    const f = (p) => {
      if (p >= t.end) {
      ...
      if (m.kind === Gl.OperationKind.COPY)
        (0, zl.copyData)(m, r, t.oldFileFd, i, () => f(p));
      else {
        const E = e.createRequestOptions();
        E.headers.Range = `bytes=${m.start}-${m.end - 1}`;
        const x = e.httpExecutor.createRequest(E, (T) => {
          rs(T, i) && (T.pipe(r, {
            end: !1
          }), T.once("end", () => f(p)));
        });
  ...
  const c = e.httpExecutor.createRequest(d, (f) => {
    if (!rs(f, i))
      return;
    const p = (0, ts.safeGetHeader)(f, "content-type"), m = /^multipart\/.+?(?:; boundary=(?:(?:"(.+)")|(?:([^\s]+))))$/i.exec(p);
    if (m == null) {
      i(new Error(`Content-Type "multipart/byteranges" is expected, but got "${p}"`));
      return;
    }
    const E = new zl.DataSplitter(r, t, o, m[1] || m[2], l, n);
    E.on("error", i), f.pipe(E), f.on("end", () => {
      setTimeout(() => {
...
const Lr = we, Pa = Pt, jv = Dt, zv = Cr, Gv = _r, Wn = tr, Hl = qi, Hv = Xi;
class qv {
  ...
  async doDownloadFile(t, r) {
    ...
    await new Promise((s, o) => {
      ...
      if (!this.options.isUseMultipleRangeRequest && this.options.onProgress) {
        ...
        let b = 0;
        for (const S of t)
          S.kind === Wn.OperationKind.DOWNLOAD && (_.push(S.end - S.start), b += S.end - S.start);
        const O = {
          expectedByteCounts: _,
          grandTotal: b
        };
        d = new Hv.ProgressDifferentialDownloadCallbackTransform(O, this.options.cancellationToken, this.options.onProgress), l.push(d);
      }
      ...
      let f = null;
      for (const _ of l)
        _.on("error", o), f == null ? f = _ : f = f.pipe(_);
      const p = l[0];
      let m;
      if (this.options.isUseMultipleRangeRequest) {
        m = (0, Hl.executeTasksUsingMultipleRangeRequests)(this, t, p, n, o), m(0);
        return;
      }
      let E = 0, x = null;
      ...
      T.redirect = "manual", m = (_) => {
        ...
        const S = t[_++];
        if (S.kind === Wn.OperationKind.COPY) {
          d && d.beginFileCopy(), (0, zv.copyData)(S, p, n, o, () => m(_));
          return;
        }
        const G = `bytes=${S.start}-${S.end - 1}`;
        T.headers.range = G, (O = (b = this.logger) === null || b === void 0 ? void 0 : b.debug) === null || O === void 0 || O.call(b, `download range: ${G}`), d && d.beginRangeDownload();
        const te = this.httpExecutor.createRequest(T, (z) => {
          z.on("error", o), z.on("aborted", () => {
            o(new Error("response has been aborted by the server"));
          }), z.statusCode >= 400 && o((0, Lr.createHttpError)(z)), z.pipe(p, {
            end: !1
          }), z.once("end", () => {
            d && d.endRangeDownload(), ++E === 100 ? (E = 0, setTimeout(() => m(_), 1e3)) : m(_);
          });
        });
        te.on("redirect", (z, J, y) => {
          this.logger.info(`Redirect to ${Xv(y)}`), x = y, (0, Lr.configureRequestUrl)(new Gv.URL(x), T), te.followRedirect();
        }), this.httpExecutor.addErrorAndTimeoutHandlers(te, o), te.end();
      }, m(0);
    });
  }
...
const Re = we, Yv = cn, Kv = bi, Jv = bc, sr = Pt, Qv = _e, ka = ki, Mt = ce, Gt = Sf, Xl = gn, Zv = Mi, Wl = Af, eT = yn, Na = Bi, tT = Ac, rT = Xe, nT = Hi, or = kt;
class Bs extends Jv.EventEmitter {
  ...
  async executeDownload(t) {
    ...
    this.listenerCount(or.DOWNLOAD_PROGRESS) > 0 && (n.onProgress = (b) => this.emit(or.DOWNLOAD_PROGRESS, b));
    ...
    const c = o();
    let f = Mt.join(d, c);
    const p = s == null ? null : Mt.join(d, `package-${a}${Mt.extname(s.path) || ".7z"}`), m = async (b) => (await l.setDownloadedFile(f, p, i, r, c, b), await t.done({
      ...i,
      downloadedFile: f
    }), p == null ? [f] : [f, p]), E = this._logger, x = await l.validateDownloadedPath(f, i, r, E);
    if (x != null)
      return f = x, await m(!1);
    const T = async () => (await l.clear().catch(() => {
    }), await (0, sr.unlink)(f).catch(() => {
    })), _ = await (0, Xl.createTempUpdateFile)(`temp-${c}`, d, E);
    try {
      await t.task(_, n, p, T), await (0, Re.retry)(() => (0, sr.rename)(_, f), 60, 500, 0, 0, (b) => b instanceof Error && /^EBUSY:/.test(b.message));
    } catch (b) {
      throw await T(), b instanceof Re.CancellationError && (E.info("cancelled"), this.emit("update-cancelled", i)), b;
    }
    return E.info(`New version ${a} has been downloaded to ${f}`), await m(!0);
  }
  async differentialDownloadInstaller(t, r, n, i, a) {
    try {
      ...
      const o = async (c) => {
        ...
        try {
          return JSON.parse((0, tT.gunzipSync)(f).toString());
        } catch (p) {
...
const Yl = we, Kl = _i, fT = Pt, dT = Dt, Ur = ce, pT = pt, hT = wn, mT = he, Jl = kt;
...
const tc = we, Fa = Pt, AT = Dt, rc = ce, IT = xp, CT = At, RT = he, nc = _i, ic = cn;
class OT extends CT.AppUpdater {
  ...
  async doDownloadUpdate(t) {
    ...
    return this.executeDownload({
      ...
      downloadUpdateOptions: t,
      task: async (f, p) => {
        const m = rc.join(this.downloadedUpdateHelper.cacheDir, c), E = () => (0, Fa.pathExistsSync)(m) ? !t.disableDifferentialDownload : (n.info("Unable to locate previous update.zip for differential download (is this first install?), falling back to full download"), !1);
        let x = !0;
        E() && (x = await this.differentialDownloadInstaller(l, t, f, d, c)), x && await this.httpExecutor.download(l.url, f, p);
      },
      done: async (f) => {
        if (!t.disableDifferentialDownload)
          try {
            const p = rc.join(this.downloadedUpdateHelper.cacheDir, c);
            await (0, Fa.copyFile)(f.downloadedFile, p);
          } catch (p) {
  ...
  async updateDownloaded(t, r) {
    ...
    return await new Promise((d, c) => {
      const f = (0, ic.randomBytes)(64).toString("base64").replace(/\//g, "_").replace(/\+/g, "-"), p = Buffer.from(`autoupdater:${f}`, "ascii"), m = `/${(0, ic.randomBytes)(64).toString("hex")}.zip`;
      this.server.on("request", (E, x) => {
        const T = E.url;
        if (s.info(`${T} requested`), T === "/") {
          ...
          const O = E.headers.authorization.split(" ")[1], S = Buffer.from(O, "base64").toString("ascii"), [G, te] = S.split(":");
          ...
          x.writeHead(200, { "Content-Type": "application/json", "Content-Length": z.length }), x.end(z);
          return;
        }
        if (!T.startsWith(m)) {
        ...
        const b = (0, AT.createReadStream)(i);
        b.on("error", (O) => {
          try {
            x.end();
          } catch (S) {
          ...
          _ = !0, this.nativeUpdater.removeListener("error", c), c(new Error(`Cannot pipe "${i}": ${O}`));
        }), x.writeHead(200, {
  ...
  return new Promise((n, i) => {
    ...
    r.info(`Verifying signature ${a}`), (0, $f.execFile)('set "PSModulePath=" & chcp 65001 >NUL & powershell.exe', ["-NoProfile", "-NonInteractive", "-InputFormat", "None", "-Command", `"Get-AuthenticodeSignature -LiteralPath '${a}' | ConvertTo-Json -Compress"`], {
      ...
      try {
        ...
        if (c.Status === 0) {
          try {
            const E = sc.normalize(c.Path), x = sc.normalize(t);
            if (r.info(`LiteralPath: ${E}. Update Path: ${x}`), E !== x) {
              $a(r, new Error(`LiteralPath of ${E} is different than ${x}`), l, i), n(null);
              return;
            }
          } catch (E) {
          ...
          let m = !1;
          for (const E of e) {
            const x = (0, ac.parseDn)(E);
            if (x.size ? m = Array.from(x.keys()).every((_) => x.get(_) === p.get(_)) : E === p.get("CN") && (r.warn(`Signature validated using only CN ${E}. Please add your full Distinguished Name (DN) to publisherNames configuration`), m = !0), m) {
              n(null);
              return;
            }
          }
        }
        const f = `publisherNames: ${e.join(" | ")}, raw info: ` + JSON.stringify(c, (p, m) => p === "RawData" ? void 0 : m, 2);
...
const Vn = we, oc = ce, FT = pt, $T = wn, lc = kt, LT = he, UT = Pt, MT = js, cc = _r;
...
on.NsisUpdater = BT;
(function(e) {
  var t = De && De.__createBinding || (Object.create ? function(T, _, b, O) {
    O === void 0 && (O = b);
  ...
  function x() {
    if (process.platform === "win32")
      E = new on.NsisUpdater();
    else if (process.platform === "darwin")
      E = new sn.MacUpdater();
    else {
      E = new tn.AppImageUpdater();
      try {
...
var Vi = function(e, t, r, n, i) {
  var a, s, o = i * 8 - n - 1, l = (1 << o) - 1, d = l >> 1, c = -7, f = r ? i - 1 : 0, p = r ? -1 : 1, m = e[t + f];
  for (f += p, a = m & (1 << -c) - 1, m >>= -c, c += o; c > 0; a = a * 256 + e[t + f], f += p, c -= 8)
    ;
  for (s = a & (1 << -c) - 1, a >>= -c, c += n; c > 0; s = s * 256 + e[t + f], f += p, c -= 8)
    ;
  if (a === 0)
    a = 1 - d;
  else {
  ...
  var s, o, l, d = a * 8 - i - 1, c = (1 << d) - 1, f = c >> 1, p = i === 23 ? Math.pow(2, -24) - Math.pow(2, -77) : 0, m = n ? 0 : a - 1, E = n ? 1 : -1, x = t < 0 || t === 0 && 1 / t < 0 ? 1 : 0;
  for (t = Math.abs(t), isNaN(t) || t === 1 / 0 ? (o = isNaN(t) ? 1 : 0, s = c) : (s = Math.floor(Math.log(t) / Math.LN2), t * (l = Math.pow(2, -s)) < 1 && (s--, l *= 2), s + f >= 1 ? t += p / l : t += p * Math.pow(2, 1 - f), t * l >= 2 && (s++, l /= 2), s + f >= c ? (o = 0, s = c) : s + f >= 1 ? (o = (t * l - 1) * Math.pow(2, i), s = s + f) : (o = t * Math.pow(2, f - 1) * Math.pow(2, i), s = 0)); i >= 8; e[r + m] = o & 255, m += E, o /= 256, i -= 8)
    ;
...
const Yt = {
  len: 1,
  get(e, t) {
    return X(e).getUint8(t);
  },
  put(e, t, r) {
    return X(e).setUint8(t, r), t + 1;
  }
}, ie = {
  len: 2,
  get(e, t) {
    return X(e).getUint16(t, !0);
  },
  put(e, t, r) {
    return X(e).setUint16(t, r, !0), t + 2;
  }
}, qt = {
  len: 2,
  get(e, t) {
    return X(e).getUint16(t);
  },
  put(e, t, r) {
    return X(e).setUint16(t, r), t + 2;
  }
}, Uf = {
  len: 3,
  get(e, t) {
  ...
  len: 4,
  get(e, t) {
    return X(e).getUint32(t, !0);
  },
  put(e, t, r) {
    return X(e).setUint32(t, r, !0), t + 4;
  }
}, Ei = {
  len: 4,
  get(e, t) {
    return X(e).getUint32(t);
  },
  put(e, t, r) {
    return X(e).setUint32(t, r), t + 4;
  }
}, as = {
  len: 1,
  get(e, t) {
    return X(e).getInt8(t);
  },
  put(e, t, r) {
    return X(e).setInt8(t, r), t + 1;
  }
}, a_ = {
  len: 2,
  get(e, t) {
    return X(e).getInt16(t);
  },
  put(e, t, r) {
    return X(e).setInt16(t, r), t + 2;
  }
}, s_ = {
  len: 2,
  get(e, t) {
    return X(e).getInt16(t, !0);
  },
  put(e, t, r) {
    return X(e).setInt16(t, r, !0), t + 2;
  }
}, o_ = {
  len: 3,
  get(e, t) {
  ...
  len: 4,
  get(e, t) {
    return X(e).getInt32(t);
  },
  put(e, t, r) {
    return X(e).setInt32(t, r), t + 4;
  }
}, c_ = {
  len: 4,
  get(e, t) {
    return X(e).getInt32(t, !0);
  },
  put(e, t, r) {
    return X(e).setInt32(t, r, !0), t + 4;
  }
}, jf = {
  len: 8,
  get(e, t) {
    return X(e).getBigUint64(t, !0);
  },
  put(e, t, r) {
    return X(e).setBigUint64(t, r, !0), t + 8;
  }
}, u_ = {
  len: 8,
  get(e, t) {
    return X(e).getBigInt64(t, !0);
  },
  put(e, t, r) {
    return X(e).setBigInt64(t, r, !0), t + 8;
  }
}, f_ = {
  len: 8,
  get(e, t) {
    return X(e).getBigUint64(t);
  },
  put(e, t, r) {
    return X(e).setBigUint64(t, r), t + 8;
  }
}, d_ = {
  len: 8,
  get(e, t) {
    return X(e).getBigInt64(t);
  },
  put(e, t, r) {
    return X(e).setBigInt64(t, r), t + 8;
  }
}, p_ = {
  len: 2,
  get(e, t) {
  ...
  len: 4,
  get(e, t) {
    return X(e).getFloat32(t);
  },
  put(e, t, r) {
    return X(e).setFloat32(t, r), t + 4;
  }
}, g_ = {
  len: 4,
  get(e, t) {
    return X(e).getFloat32(t, !0);
  },
  put(e, t, r) {
    return X(e).setFloat32(t, r, !0), t + 4;
  }
}, y_ = {
  len: 8,
  get(e, t) {
    return X(e).getFloat64(t);
  },
  put(e, t, r) {
    return X(e).setFloat64(t, r), t + 8;
  }
}, x_ = {
  len: 8,
  get(e, t) {
    return X(e).getFloat64(t, !0);
  },
  put(e, t, r) {
    return X(e).setFloat64(t, r, !0), t + 8;
  }
}, w_ = {
  len: 10,
  get(e, t) {
  ...
  async readCentralDirectory() {
    ...
    if (r > 0) {
      ...
      for (let a = 0; a < n.nrOfEntriesOfSize; ++a) {
        ...
        s.filename = await this.tokenizer.readToken(new ye(s.filenameLength, "utf-8")), await this.tokenizer.ignore(s.extraFieldLength), await this.tokenizer.ignore(s.fileCommentLength), i.push(s), rt(`Add central-directory file-entry: n=${a + 1}/${i.length}: filename=${i[a].filename}`);
      }
...
function U_(e, t = 0) {
  const r = Number.parseInt(new ye(6).get(e, 148).replace(/\0.*$/, "").trim(), 8);
  if (Number.isNaN(r))
    return !1;
  let n = 8 * 32;
  ...
  constructor(t) {
    ...
    aa(this, "detectConfident", async (t) => {
      ...
      if (this.check([26, 69, 223, 163])) {
        ...
        async function i(o) {
          for (; o > 0; ) {
            const l = await n();
            if (l.id === 17026)
              return (await t.readToken(new ye(l.len))).replaceAll(/\00.*$/g, "");
      ...
      if (this.checkString("AC")) {
        const r = new ye(4, "latin1").get(this.buffer, 2);
      ...
      if (this.checkString("!<arch>"))
        return await t.ignore(8), await t.readToken(new ye(13, "ascii")) === "debian-binary" ? {
          ext: "deb",
...
`, "\r", "	", " ", "\0"].some((r) => this.checkString(r, { offset: 6 })))
      ...
      if (this.check([137, 80, 78, 71, 13, 10, 26, 10])) {
        ...
        async function r() {
          return {
            ...
            type: await t.readToken(new ye(4, "latin1"))
          };
        }
        do {
          const n = await r();
      ...
      if (this.checkString("ftyp", { offset: 4 }) && this.buffer[8] & 96) {
        const r = new ye(4, "latin1").get(this.buffer, 8).replace("\0", " ").trim();
        switch (r) {
          case "avif":
          case "avis":
...
`))
      ...
      if (this.check([0, 0, 0, 12, 106, 80, 32, 32, 13, 10, 135, 10]))
        switch (await t.ignore(20), await t.readToken(new ye(4, "ascii"))) {
          case "jp2 ":
            return {
              ext: "jp2",
              mime: "image/jp2"
...
`, { offset: 2, encoding: r }) ? {
  ...
  async readTiffTag(t) {
    const r = await this.tokenizer.readToken(t ? qt : ie);
  ...
  async readTiffHeader(t) {
    const r = (t ? qt : ie).get(this.buffer, 2), n = (t ? Ei : K).get(this.buffer, 4);
    if (r === 42) {
      if (n >= 6) {
        ...
        if (n >= 8) {
          const a = (t ? qt : ie).get(this.buffer, 8), s = (t ? qt : ie).get(this.buffer, 10);
...
function os(e, t) {
  ...
  return new ye(e.length, t).get(e, 0);
}
function QS(e) {
...
const tA = {
  ...
  get: (e, t) => ({
    ...
    fileIdentifier: new ye(3, "ascii").get(e, t),
    // ID3v2 versionIndex
    version: {
      major: as.get(e, t + 3),
  ...
  get: (e, t) => ({
    encoding: fb.get(e, t),
    language: new ye(3, "latin1").get(e, t + 1)
  })
}, iA = {
  len: 6,
  get: (e, t) => {
...
const Mb = {
  ...
  async load() {
    return (await import("./MpegParser-nkK5k06X.js")).MpegParser;
  }
}, Bb = {
  parserType: "apev2",
  extensions: [".ape"],
  ...
  async load() {
    return (await import("./AsfParser-BrrYfpd1.js")).AsfParser;
  }
}, zb = {
  parserType: "dsdiff",
  extensions: [".dff"],
  ...
  async load() {
    return (await import("./DsdiffParser-C-IHxtCJ.js")).DsdiffParser;
  }
}, Gb = {
  parserType: "aiff",
  ...
  async load() {
    return (await import("./AiffParser-D9D6PAtI.js")).AIFFParser;
  }
}, Hb = {
  parserType: "dsf",
  extensions: [".dsf"],
  mimeTypes: ["audio/dsf"],
  async load() {
    return (await import("./DsfParser-CsDQDuLv.js")).DsfParser;
  }
}, qb = {
  parserType: "flac",
  extensions: [".flac"],
  ...
  async load() {
    return (await import("./FlacParser-BQSC7VN5.js").then((e) => e.d)).FlacParser;
  }
}, Xb = {
  parserType: "matroska",
  ...
  async load() {
    return (await import("./MatroskaParser-Dzs6-0Tj.js")).MatroskaParser;
  }
}, Wb = {
  parserType: "mp4",
  ...
  async load() {
    return (await import("./MP4Parser-BlkpdIry.js")).MP4Parser;
  }
}, Vb = {
  parserType: "musepack",
  extensions: [".mpc"],
  ...
  async load() {
    return (await import("./MusepackParser-uj2onb_O.js")).MusepackParser;
  }
}, Yb = {
  parserType: "ogg",
  ...
  async load() {
    return (await import("./OggParser-ardN3Goi.js")).OggParser;
  }
}, Kb = {
  parserType: "wavpack",
  extensions: [".wv", ".wvp"],
  ...
  async load() {
    return (await import("./WavPackParser-ENg_LA8Y.js")).WavPackParser;
  }
}, Jb = {
  parserType: "riff",
  ...
  async load() {
    return (await import("./WaveParser-BkPWnMPl.js")).WaveParser;
  }
...
class St extends Zf {
  ...
  async parseTags(t) {
    ...
    for (let i = 0; i < t.fields; i++) {
      ...
      const o = await this.tokenizer.readToken(new ye(s, "ascii"));
      switch (await this.tokenizer.ignore(1), n -= o.length + 1, a.flags.dataType) {
        case Qn.text_utf8: {
          const d = (await this.tokenizer.readToken(new ye(a.size, "utf8"))).split(/\x00/g);
...
class cr {
  constructor(t) {
    this.len = t, this.stringType = new ye(t, "latin1");
  }
  get(t, r) {
...
function ld() {
  ...
  }), cs ? ee.loadURL(cs) : ee.loadFile(Oe.join(od, "index.html"));
}
...
st.autoUpdater.on("update-downloaded", (e) => {
  ee == null || ee.webContents.send("update-status", { status: "downloaded", info: e }), new pp({
    title: "NeonWave 更新",
...
Ke.whenReady().then(() => {
  process.platform === "win32" && Ke.setAppUserModelId("NeonWave"), ld(), qe.handle("dialog:openDirectory", async () => {
    const { canceled: r, filePaths: n } = await po.showOpenDialog(ee, {
...
`).map((o) => {
    ...
    try {
      ...
      const { filePath: d } = await po.showSaveDialog(ee, {
        title: "下載歌曲",
        defaultPath: `${l}.m4a`,
        // Force m4a for best playback
        filters: [{ name: "Audio (m4a)", extensions: ["m4a"] }]
      });
      return d ? new Promise((c, f) => {
        const p = [
          n,
          "-f",
          "bestaudio[ext=m4a]",
        ...
        m.on("progress", () => {
          ...
          console.error("yt-dlp error:", E), f(new Error(`下載錯誤: ${E.message}`));
        }), m.on("close", () => {
          c(d);
        });
      }) : null;
    ...
    try {
      ...
      console.log(`[Lyrics] Search Request: Title="${n}", Artist="${i}", Duration=${s}`);
      const l = (O) => {
        if (!O) return "";
        let S = O;
        ...
        const G = [
          ...
          "時光音樂會",
          "时光音乐会"
        ], te = (U) => G.some((j) => U.toLowerCase().includes(j)), z = (U, j, M) => {
          const W = (I) => "\\" + I, D = new RegExp(`${W(j)}([^${W(M)}]*)?${W(M)}`, "gi");
          return U.replace(D, (I, k) => !k || te(k) ? " " : " " + k + " ");
        };
        return S = z(S, "(", ")"), S = z(S, "（", "）"), S = z(S, "[", "]"), S = z(S, "【", "】"), S = z(S, "{", "}"), S = z(S, "《", "》"), [
          ...
          const j = new RegExp(U.replace(/[.*+?^${}()|[\]\\]/g, "\\$&"), "gi");
          S = S.replace(j, " ");
        }), [
          "official",
          "mv",
          ...
          /^[a-z0-9]+$/i.test(U) ? S = S.replace(new RegExp(`\\b${U}\\b`, "gi"), " ") : S = S.replace(new RegExp(U, "gi"), " ");
        }), S = S.replace(/[:"'_\|\.,!@#$%^&*+=?\/\\♪♫~`\-]/g, " "), S.replace(/\s+/g, " ").trim();
      }, d = (O, S) => S ? Math.abs(O - S) : 0, c = async (O, S) => {
        try {
          const G = `https://lrclib.net/api/search?q=${encodeURIComponent(O)}`, te = await fetch(G);
          if (!te.ok) return [];
          const z = await te.json();
          return Array.isArray(z) ? z.filter((J) => J.syncedLyrics && J.syncedLyrics.length > 0).map((J) => ({
            source: "LRCLib",
            id: J.id,
            track: J.trackName,
            artist: J.artistName,
            duration: J.duration,
            // in seconds
            lyrics: J.syncedLyrics,
            diff: S ? d(J.duration, S) : 0
          })) : [];
        } catch (G) {
        ...
        try {
          const G = `https://music.163.com/api/search/get/web?s=${encodeURIComponent(O)}&type=1&offset=0&total=true&limit=5`, te = await fetch(G, {
            headers: { Referer: "https://music.163.com/", Cookie: "appver=2.0.2" }
          });
          if (!te.ok) return [];
          const z = await te.json();
          if (!z.result || !z.result.songs) return [];
          let J = z.result.songs.map((W) => {
            var D, I;
            return {
              id: W.id,
              track: W.name,
              artist: ((I = (D = W.artists) == null ? void 0 : D[0]) == null ? void 0 : I.name) || "Unknown",
              duration: W.duration / 1e3,
              // ms to s
              diff: S ? d(W.duration / 1e3, S) : 0
            };
          });
          if (S && (J = J.filter((W) => W.diff <= 5), J.sort((W, D) => W.diff - D.diff)), J.length === 0) return [];
          const y = J[0], U = `https://music.163.com/api/song/lyric?id=${y.id}&lv=1&kv=1&tv=-1`, M = await (await fetch(U, {
            headers: { Referer: "https://music.163.com/", Cookie: "appver=2.0.2" }
          })).json();
          if (M.lrc && M.lrc.lyric)
            return [{
              source: "Netease",
              id: y.id,
              track: y.track,
        ...
        if (!O) return null;
        try {
          return ad("opencc-js").Converter({ from: "cn", to: "tw" })(O);
        } catch {
          return O;
        }
      };
      ...
      if (n && i) {
        const O = `${n} ${i}`;
        console.log(`[Lyrics] Strategy A: ${O}`);
      ...
      if (E && (E !== n || x !== i)) {
        const O = `${E} ${x}`;
        console.log(`[Lyrics] Strategy B: ${O}`);
        const [S, G] = await Promise.all([
          c(O, s),
          f(O, s)
        ]);
      ...
      if (a) {
        let O = Oe.basename(a, Oe.extname(a));
        const S = o(O);
        if (S && S.length === 2) {
          const [te, z] = S, J = `${z} ${te}`;
          console.log(`[Lyrics] Strategy C-1 (Parsed): ${J}`), m.push(...await c(J, s)), m.push(...await f(J, s));
        }
        const G = l(O);
        console.log(`[Lyrics] Strategy C-2 (Raw Cleaned): ${G}`), m.push(...await c(G, s)), m.push(...await f(G, s));
      }
      if (m.length === 0)
        return console.log("[Lyrics] No candidates found."), null;
      const T = /* @__PURE__ */ new Map();
      m.forEach((O) => {
        const S = `${O.source}-${O.id}`;
        T.has(S) || T.set(S, O);
      });
      let _ = Array.from(T.values());
      if (s && s > 0) {
        const O = _.filter((S) => S.diff <= 4);
        if (O.length > 0)
          console.log(`[Lyrics] Calibration: Found ${O.length} strict duration matches.`), _ = O;
        else {
          const S = _.filter((G) => G.diff <= 10);
          S.length > 0 ? (console.log(`[Lyrics] Calibration: Found ${S.length} lenient duration matches.`), _ = S) : console.log(`[Lyrics] Calibration: No duration matches found. Closest is ${Math.min(..._.map((G) => G.diff))}s off.`);
        }
      }
      _.sort((O, S) => Math.abs(O.diff - S.diff) > 0.5 ? O.diff - S.diff : 0);
      const b = _[0];
      return console.log(`[Lyrics] Selected: ${b.track} (${b.artist}) [${b.source}] Diff=${b.diff.toFixed(2)}s`), p(b.lyrics);
    } catch (o) {
