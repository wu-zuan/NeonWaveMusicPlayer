...
import { createRequire as ti } from "node:module";
...
function _p(e) {
  xt.hasOwnProperty("O_SYMLINK") && process.version.match(/^v0\.6\.[0-2]|^v0\.5\./) && t(e), e.lutimes || r(e), e.chown = a(e.chown), e.fchown = a(e.fchown), e.lchown = a(e.lchown), e.chmod = n(e.chmod), e.fchmod = n(e.fchmod), e.lchmod = n(e.lchmod), e.chownSync = s(e.chownSync), e.fchownSync = s(e.fchownSync), e.lchownSync = s(e.lchownSync), e.chmodSync = i(e.chmodSync), e.fchmodSync = i(e.fchmodSync), e.lchmodSync = i(e.lchmodSync), e.stat = o(e.stat), e.fstat = o(e.fstat), e.lstat = o(e.lstat), e.statSync = l(e.statSync), e.fstatSync = l(e.fstatSync), e.lstatSync = l(e.lstatSync), e.chmod && !e.lchmod && (e.lchmod = function(c, u, p) {
    ...
    function u(p, g, v, y, T, b) {
      var _;
      if (b && typeof b == "function") {
        var D = 0;
        _ = function($, Q, ue) {
          if ($ && $.code === "EAGAIN" && D < 10)
            return D++, c.call(e, p, g, v, y, T, _);
          b.apply(this, arguments);
        };
      }
      return c.call(e, p, g, v, y, T, _);
    }
    return Object.setPrototypeOf && Object.setPrototypeOf(u, c), u;
  }(e.read), e.readSync = typeof e.readSync != "function" ? e.readSync : /* @__PURE__ */ function(c) {
    return function(u, p, g, v, y) {
      for (var T = 0; ; )
        try {
          return c.call(e, u, p, g, v, y);
        } catch (b) {
  ...
  function t(c) {
    c.lchmod = function(u, p, g) {
      ...
      var g = c.openSync(u, xt.O_WRONLY | xt.O_SYMLINK, p), v = !0, y;
      try {
        y = c.fchmodSync(g, p), v = !1;
      } finally {
        if (v)
          try {
            c.closeSync(g);
  ...
  function r(c) {
    xt.hasOwnProperty("O_SYMLINK") && c.futimes ? (c.lutimes = function(u, p, g, v) {
      ...
      var v = c.openSync(u, xt.O_SYMLINK), y, T = !0;
      try {
        y = c.futimesSync(v, p, g), T = !1;
      } finally {
        if (T)
          try {
            c.closeSync(v);
...
var se = Dt, Rp = Tp, Op = bp, Dp = Ap, Pn = us, ve, oi;
...
function fs(e) {
  Rp(e), e.gracefulify = fs, e.createReadStream = Q, e.createWriteStream = ue;
  var t = e.readFile;
  e.readFile = r;
  function r(x, q, j) {
    return typeof q == "function" && (j = q, q = null), B(x, q, j);
    function B(Z, R, I, P) {
      return t(Z, R, function(A) {
        A && (A.code === "EMFILE" || A.code === "ENFILE") ? nr([B, [Z, R, I], A, P || Date.now(), Date.now()]) : typeof I == "function" && I.apply(this, arguments);
      });
    }
  }
  var n = e.writeFile;
  e.writeFile = i;
  function i(x, q, j, B) {
    return typeof j == "function" && (B = j, j = null), Z(x, q, j, B);
    function Z(R, I, P, A, N) {
      return n(R, I, P, function(O) {
        O && (O.code === "EMFILE" || O.code === "ENFILE") ? nr([Z, [R, I, P, A], O, N || Date.now(), Date.now()]) : typeof A == "function" && A.apply(this, arguments);
      });
    }
  }
  var a = e.appendFile;
  ...
  o && (e.copyFile = l);
  function l(x, q, j, B) {
    return typeof j == "function" && (B = j, j = 0), Z(x, q, j, B);
    function Z(R, I, P, A, N) {
  ...
  function u(x, q, j) {
    ...
    var B = c.test(process.version) ? function(I, P, A, N) {
      return d(I, Z(
        I,
        P,
        A,
  ...
  if (process.version.substr(0, 4) === "v0.8") {
    var p = Op(e);
    b = p.ReadStream, D = p.WriteStream;
  }
  var g = e.ReadStream;
  g && (b.prototype = Object.create(g.prototype), b.prototype.open = _);
  var v = e.WriteStream;
  v && (D.prototype = Object.create(v.prototype), D.prototype.open = $), Object.defineProperty(e, "ReadStream", {
    get: function() {
      return b;
    },
    set: function(x) {
  ...
  function _() {
    var x = this;
    Me(x.path, x.flags, x.mode, function(q, j) {
...
function nr(e) {
  Wt("ENQUEUE", e[0].name, e[1]), se[ve].push(e), ds();
}
var kn;
function go() {
...
function Nc(e, t, r, n, i) {
  ...
  wr.stat(s, { bigint: !0 }, (o, l) => o ? o.code === "ENOENT" ? i() : i(o) : un(t, l) ? i(new Error(bi(e, r, n))) : Nc(e, t, s, n, i));
}
function Fc(e, t, r, n) {
...
const Le = Ne, Xr = oe, Xp = ot.mkdirs, Wp = er.pathExists, Vp = kc.utimesMillis, Wr = br;
function Yp(e, t, r, n) {
...
function sh(e, t, r, n, i) {
  Le.readlink(t, (a, s) => {
    ...
    if (n.dereference && (s = Xr.resolve(process.cwd(), s)), e)
      Le.readlink(r, (o, l) => o ? o.code === "EINVAL" || o.code === "UNKNOWN" ? Le.symlink(s, r, i) : i(o) : (n.dereference && (l = Xr.resolve(process.cwd(), l)), Wr.isSrcSubdir(s, l) ? i(new Error(`Cannot copy '${s}' to a subdirectory of itself, '${l}'.`)) : e.isDirectory() && Wr.isSrcSubdir(l, s) ? i(new Error(`Cannot overwrite '${l}' with '${s}'.`)) : oh(s, r, i)));
    else
...
var lh = Yp;
const Se = Ne, Vr = oe, ch = ot.mkdirsSync, uh = kc.utimesMillisSync, Yr = br;
function fh(e, t, r) {
  ...
  return Yr.checkParentPathsSync(e, n, t, "copy"), dh(i, e, t, r);
}
function dh(e, t, r, n) {
...
const wo = Ne, Gc = oe, te = _c, Kr = process.platform === "win32";
function Hc(e) {
  [
    "unlink",
    "chmod",
    ...
    t.unlink(e, (a) => {
      if (a) {
        if (a.code === "ENOENT")
          return r(null);
        if (a.code === "EPERM")
          return Kr ? vo(e, t, a, r) : ni(e, t, a, r);
        if (a.code === "EISDIR")
          return ni(e, t, a, r);
      }
      return r(a);
...
function Ch(e, t) {
  if (te(e), te(t), t.readdirSync(e).forEach((r) => qc(Gc.join(e, r), t)), Kr) {
    const r = Date.now();
    do
      try {
...
const _t = oe, zr = Ne, Hh = er.pathExists;
function qh(e, t, r) {
  if (_t.isAbsolute(e))
...
const wm = ke.fromCallback, Gr = Ne, uu = oe, fu = ot, Em = er.pathExists;
function vm(e, t, r, n) {
...
var De = {}, Ha = { exports: {} }, Fn = { exports: {} }, ua, Fo;
function Zm() {
  if (Fo) return ua;
  Fo = 1;
  ...
  function e(t) {
    ...
    function n(u) {
      ...
      function T(...b) {
        if (!T.enabled)
          return;
        const _ = T, D = Number(/* @__PURE__ */ new Date()), $ = D - (p || D);
        _.diff = $, _.prev = p, _.curr = D, p = D, b[0] = n.coerce(b[0]), typeof b[0] != "string" && b.unshift("%O");
        let Q = 0;
        b[0] = b[0].replace(/%([a-zA-Z%])/g, (Y, Me) => {
          if (Y === "%%")
            return "%";
          Q++;
          const x = n.formatters[Me];
          if (typeof x == "function") {
            const q = b[Q];
            Y = x.call(_, q), b.splice(Q, 1), Q--;
          }
          return Y;
      ...
      return T.namespace = u, T.useColors = n.useColors(), T.color = n.selectColor(u), T.extend = i, T.destroy = n.destroy, Object.defineProperty(T, "enabled", {
        enumerable: !0,
        configurable: !1,
        get: () => g !== null ? g : (v !== n.namespaces && (v = n.namespaces, y = n.enabled(u)), y),
        set: (b) => {
          g = b;
        }
...
function n0() {
  return Bo || (Bo = 1, function(e, t) {
    ...
    t.inspectOpts = Object.keys(process.env).filter((p) => /^debug_/i.test(p)).reduce((p, g) => {
      ...
      let y = process.env[g];
      return /^(yes|on|true|enabled)$/i.test(y) ? y = !0 : /^(no|off|false|disabled)$/i.test(y) ? y = !1 : y === "null" ? y = null : y = Number(y), p[v] = y, p;
    }, {});
    function i() {
...
fn.ProgressCallbackTransform = a0;
...
const s0 = cn, o0 = gu, l0 = Dt, c0 = ln, yu = _r, u0 = It, jo = Sr, f0 = fn, Nr = (0, o0.default)("electron-builder");
    ...
    t.on("error", a), t.on("data", (g) => p += g), t.on("end", () => {
      try {
        if (t.statusCode != null && t.statusCode >= 400) {
          const g = xr(t, "content-type"), v = g != null && (Array.isArray(g) ? g.find((y) => y.includes("json")) != null : g.includes("json"));
          a(qa(t, `method: ${r.method || "GET"} url: ${r.protocol || "https:"}//${r.hostname}${r.port ? `:${r.port}` : ""}${r.path}
...
const Tu = cn, _u = Sr, _0 = "options.name must be either a string or a Buffer", zo = (0, Tu.randomBytes)(16);
zo[0] = zo[0] | 1;
const ai = {}, V = [];
for (let e = 0; e < 256; e++) {
...
function b0(e, t, r, n, i = Hr.ASCII) {
...
(function(e) {
  (function(t) {
    ...
    var u = "[CDATA[", p = "DOCTYPE", g = "http://www.w3.org/XML/1998/namespace", v = "http://www.w3.org/2000/xmlns/", y = { xml: g, xmlns: v }, T = /[:_A-Za-z\u00C0-\u00D6\u00D8-\u00F6\u00F8-\u02FF\u0370-\u037D\u037F-\u1FFF\u200C-\u200D\u2070-\u218F\u2C00-\u2FEF\u3001-\uD7FF\uF900-\uFDCF\uFDF0-\uFFFD]/, b = /[:_A-Za-z\u00C0-\u00D6\u00D8-\u00F6\u00F8-\u02FF\u0370-\u037D\u037F-\u1FFF\u200C-\u200D\u2070-\u218F\u2C00-\u2FEF\u3001-\uD7FF\uF900-\uFDCF\uFDF0-\uFFFD\u00B7\u0300-\u036F\u203F-\u2040.\d-]/, _ = /[#:_A-Za-z\u00C0-\u00D6\u00D8-\u00F6\u00F8-\u02FF\u0370-\u037D\u037F-\u1FFF\u200C-\u200D\u2070-\u218F\u2C00-\u2FEF\u3001-\uD7FF\uF900-\uFDCF\uFDF0-\uFFFD]/, D = /[#:_A-Za-z\u00C0-\u00D6\u00D8-\u00F6\u00F8-\u02FF\u0370-\u037D\u037F-\u1FFF\u200C-\u200D\u2070-\u218F\u2C00-\u2FEF\u3001-\uD7FF\uF900-\uFDCF\uFDF0-\uFFFD\u00B7\u0300-\u036F\u203F-\u2040.\d-]/;
    function $(h) {
      return h === " " || h === `
` || h === "\r" || h === "	";
    }
...
Char: ` + h.c), f = new Error(f), h.error = f, j(h, "onerror", f), h;
    ...
    function P(h) {
      return h.sawRoot && !h.closedRoot && A(h, "Unclosed root tag"), h.state !== x.BEGIN && h.state !== x.BEGIN_WHITESPACE && h.state !== x.TEXT && I(h, "Unexpected end"), Z(h), h.c = "", h.closed = !0, j(h, "onend"), n.call(h, h.strict, h.opt), h;
    }
    function A(h, f) {
    ...
    function O(h, f) {
      var S = h.indexOf(":"), E = S < 0 ? ["", h] : h.split(":"), K = E[0], ne = E[1];
      return f && h === "xmlns" && (K = "xmlns", ne = ""), { prefix: K, local: ne };
    }
    function M(h) {
...
Actual: ` + h.attribValue
            ...
            K.ns === ne.ns && (K.ns = Object.create(ne.ns)), K.ns[E] = h.attribValue;
          }
    ...
    function X(h, f) {
      if (h.opt.xmlns) {
        ...
        for (var ne = 0, le = h.attribList.length; ne < le; ne++) {
          var we = h.attribList[ne], _e = we[0], ht = we[1], de = O(_e, !0), We = de.prefix, Ki = de.local, Tn = We === "" ? "" : S.ns[We] || "", Rr = {
            name: _e,
            value: ht,
            prefix: We,
            local: Ki,
      ...
      h.tag.isSelfClosing = !!f, h.sawRoot = !0, h.tags.push(h.tag), B(h, "onopentag", h.tag), f || (!h.noscript && h.tagName.toLowerCase() === "script" ? h.state = x.SCRIPT : h.state = x.TEXT, h.tag = null, h.tagName = ""), h.attribName = h.attribValue = "", h.attribList.length = 0;
    }
    function z(h) {
      if (!h.tagName) {
    ...
    function he(h, f) {
      f === "<" ? (h.state = x.OPEN_WAKA, h.startTagPosition = h.position) : $(f) || (A(h, "Non-whitespace before first tag."), h.textNode = f, h.state = x.TEXT);
    }
    function U(h, f) {
      var S = "";
...
` ? (f.line++, f.column = 0) : f.column++), f.state) {
          case x.BEGIN:
            if (f.state = x.BEGIN_WHITESPACE, E === "\uFEFF")
              continue;
            he(f, E);
            continue;
          ...
          case x.TEXT:
            if (f.sawRoot && !f.closedRoot) {
              for (var ne = S - 1; E && E !== "<" && E !== "&"; )
                E = U(h, S++), E && f.trackPosition && (f.position++, E === `
` ? (f.line++, f.column = 0) : f.column++);
              f.textNode += h.substring(ne, S - 1);
            }
            E === "<" && !(f.sawRoot && f.closedRoot && !f.strict) ? (f.state = x.OPEN_WAKA, f.startTagPosition = f.position) : (!$(E) && (!f.sawRoot || f.closedRoot) && A(f, "Text data outside of root node."), E === "&" ? f.state = x.TEXT_ENTITY : f.textNode += E);
            continue;
          case x.SCRIPT:
            E === "<" ? f.state = x.SCRIPT_ENDING : f.script += E;
            continue;
          case x.SCRIPT_ENDING:
            E === "/" ? f.state = x.CLOSE_TAG : (f.script += "<" + E, f.state = x.SCRIPT);
            continue;
          case x.OPEN_WAKA:
            if (E === "!")
              f.state = x.SGML_DECL, f.sgmlDecl = "";
            else if (!$(E)) if (Y(T, E))
              f.state = x.OPEN_TAG, f.tagName = E;
            else if (E === "/")
          ...
          case x.SGML_DECL:
            ...
            f.doctype && f.doctype !== !0 && f.sgmlDecl ? (f.state = x.DOCTYPE_DTD, f.doctype += "<!" + f.sgmlDecl + E, f.sgmlDecl = "") : (f.sgmlDecl + E).toUpperCase() === u ? (B(f, "onopencdata"), f.state = x.CDATA, f.sgmlDecl = "", f.cdata = "") : (f.sgmlDecl + E).toUpperCase() === p ? (f.state = x.DOCTYPE, (f.doctype || f.sawRoot) && A(
              f,
              "Inappropriately located doctype declaration"
            ), f.doctype = "", f.sgmlDecl = "") : E === ">" ? (B(f, "onsgmldeclaration", f.sgmlDecl), f.sgmlDecl = "", f.state = x.TEXT) : (Q(E) && (f.state = x.SGML_DECL_QUOTED), f.sgmlDecl += E);
            continue;
          case x.SGML_DECL_QUOTED:
            E === f.q && (f.state = x.SGML_DECL, f.q = ""), f.sgmlDecl += E;
            continue;
          case x.DOCTYPE:
            E === ">" ? (f.state = x.TEXT, B(f, "ondoctype", f.doctype), f.doctype = !0) : (f.doctype += E, E === "[" ? f.state = x.DOCTYPE_DTD : Q(E) && (f.state = x.DOCTYPE_QUOTED, f.q = E));
            continue;
          case x.DOCTYPE_QUOTED:
            f.doctype += E, E === f.q && (f.q = "", f.state = x.DOCTYPE);
            continue;
          case x.DOCTYPE_DTD:
            E === "]" ? (f.doctype += E, f.state = x.DOCTYPE) : E === "<" ? (f.state = x.OPEN_WAKA, f.startTagPosition = f.position) : Q(E) ? (f.doctype += E, f.state = x.DOCTYPE_DTD_QUOTED, f.q = E) : f.doctype += E;
            continue;
          case x.DOCTYPE_DTD_QUOTED:
            f.doctype += E, E === f.q && (f.state = x.DOCTYPE_DTD, f.q = "");
            continue;
          case x.COMMENT:
            E === "-" ? f.state = x.COMMENT_ENDING : f.comment += E;
            continue;
          case x.COMMENT_ENDING:
            E === "-" ? (f.state = x.COMMENT_ENDED, f.comment = R(f.opt, f.comment), f.comment && B(f, "oncomment", f.comment), f.comment = "") : (f.comment += "-" + E, f.state = x.COMMENT);
            continue;
          case x.COMMENT_ENDED:
            E !== ">" ? (A(f, "Malformed comment"), f.comment += "--" + E, f.state = x.COMMENT) : f.doctype && f.doctype !== !0 ? f.state = x.DOCTYPE_DTD : f.state = x.TEXT;
            continue;
          case x.CDATA:
            for (var ne = S - 1; E && E !== "]"; )
              E = U(h, S++), E && f.trackPosition && (f.position++, E === `
` ? (f.line++, f.column = 0) : f.column++);
            f.cdata += h.substring(ne, S - 1), E === "]" && (f.state = x.CDATA_ENDING);
            continue;
          case x.CDATA_ENDING:
            E === "]" ? f.state = x.CDATA_ENDING_2 : (f.cdata += "]" + E, f.state = x.CDATA);
            continue;
          case x.CDATA_ENDING_2:
            E === ">" ? (f.cdata && B(f, "oncdata", f.cdata), B(f, "onclosecdata"), f.cdata = "", f.state = x.TEXT) : E === "]" ? f.cdata += "]" : (f.cdata += "]]" + E, f.state = x.CDATA);
            continue;
          case x.PROC_INST:
            E === "?" ? f.state = x.PROC_INST_ENDING : $(E) ? f.state = x.PROC_INST_BODY : f.procInstName += E;
            continue;
          case x.PROC_INST_BODY:
            if (!f.procInstBody && $(E))
              continue;
            E === "?" ? f.state = x.PROC_INST_ENDING : f.procInstBody += E;
            continue;
          case x.PROC_INST_ENDING:
            E === ">" ? (B(f, "onprocessinginstruction", {
              name: f.procInstName,
              body: f.procInstBody
            }), f.procInstName = f.procInstBody = "", f.state = x.TEXT) : (f.procInstBody += "?" + E, f.state = x.PROC_INST_BODY);
            continue;
          case x.OPEN_TAG:
            Y(b, E) ? f.tagName += E : (N(f), E === ">" ? X(f) : E === "/" ? f.state = x.OPEN_TAG_SLASH : ($(E) || A(f, "Invalid character in tag name"), f.state = x.ATTRIB));
            continue;
          ...
          case x.ATTRIB:
            if ($(E))
              continue;
            E === ">" ? X(f) : E === "/" ? f.state = x.OPEN_TAG_SLASH : Y(T, E) ? (f.attribName = E, f.attribValue = "", f.state = x.ATTRIB_NAME) : A(f, "Invalid attribute name");
            continue;
          case x.ATTRIB_NAME:
            E === "=" ? f.state = x.ATTRIB_VALUE : E === ">" ? (A(f, "Attribute without value"), f.attribValue = f.attribName, M(f), X(f)) : $(E) ? f.state = x.ATTRIB_NAME_SAW_WHITE : Y(b, E) ? f.attribName += E : A(f, "Invalid attribute name");
            continue;
          case x.ATTRIB_NAME_SAW_WHITE:
            if (E === "=")
              ...
              A(f, "Attribute without value"), f.tag.attributes[f.attribName] = "", f.attribValue = "", B(f, "onattribute", {
                name: f.attribName,
                value: ""
              }), f.attribName = "", E === ">" ? X(f) : Y(T, E) ? (f.attribName = E, f.state = x.ATTRIB_NAME) : (A(f, "Invalid attribute name"), f.state = x.ATTRIB);
            }
            continue;
          case x.ATTRIB_VALUE:
            if ($(E))
              continue;
            Q(E) ? (f.q = E, f.state = x.ATTRIB_VALUE_QUOTED) : (f.opt.unquotedAttributeValues || I(f, "Unquoted attribute value"), f.state = x.ATTRIB_VALUE_UNQUOTED, f.attribValue = E);
            continue;
          case x.ATTRIB_VALUE_QUOTED:
            if (E !== f.q) {
              E === "&" ? f.state = x.ATTRIB_VALUE_ENTITY_Q : f.attribValue += E;
              continue;
            }
            M(f), f.q = "", f.state = x.ATTRIB_VALUE_CLOSED;
            continue;
          case x.ATTRIB_VALUE_CLOSED:
            $(E) ? f.state = x.ATTRIB : E === ">" ? X(f) : E === "/" ? f.state = x.OPEN_TAG_SLASH : Y(T, E) ? (A(f, "No whitespace between attributes"), f.attribName = E, f.attribValue = "", f.state = x.ATTRIB_NAME) : A(f, "Invalid attribute name");
            continue;
          case x.ATTRIB_VALUE_UNQUOTED:
            if (!ue(E)) {
              E === "&" ? f.state = x.ATTRIB_VALUE_ENTITY_U : f.attribValue += E;
              continue;
            }
            M(f), E === ">" ? X(f) : f.state = x.ATTRIB;
            continue;
          case x.CLOSE_TAG:
            if (f.tagName)
              E === ">" ? z(f) : Y(b, E) ? f.tagName += E : f.script ? (f.script += "</" + f.tagName, f.tagName = "", f.state = x.SCRIPT) : ($(E) || A(f, "Invalid tagname in closing tag"), f.state = x.CLOSE_TAG_SAW_WHITE);
            else {
              if ($(E))
                continue;
              Me(T, E) ? f.script ? (f.script += "</" + E, f.state = x.SCRIPT) : A(f, "Invalid tagname in closing tag.") : f.tagName = E;
            }
            continue;
          ...
          case x.ATTRIB_VALUE_ENTITY_U:
            ...
            } else Y(f.entity.length ? D : _, E) ? f.entity += E : (A(f, "Invalid character in entity name"), f[we] += "&" + f.entity + E, f.entity = "", f.state = le);
            continue;
          default:
    ...
    String.fromCodePoint || function() {
      var h = String.fromCharCode, f = Math.floor, S = function() {
        var E = 16384, K = [], ne, le, we = -1, _e = arguments.length;
        if (!_e)
          return "";
        for (var ht = ""; ++we < _e; ) {
          ...
          de <= 65535 ? K.push(de) : (de -= 65536, ne = (de >> 10) + 55296, le = de % 1024 + 56320, K.push(ne, le)), (we + 1 === _e || K.length > E) && (ht += h.apply(null, K), K.length = 0);
        }
        return ht;
      };
...
}), Ht = Je, Vu = pn, Mg = $0, Bg = As, Ct = Object.prototype.hasOwnProperty, pi = 1, Yu = 2, Ku = 3, hi = 4, ya = 1, jg = 2, Wo = 3, zg = /[\x00-\x08\x0B\x0C\x0E-\x1F\x7F-\x84\x86-\x9F\uFFFE\uFFFF]|[\uD800-\uDBFF](?![\uDC00-\uDFFF])|(?:[^\uD800-\uDBFF]|^)[\uDC00-\uDFFF]/, Gg = /[\x85\u2028\u2029]/, Hg = /[,\[\]\{\}]/, Ju = /^(?:!|!!|![a-z\-]+!)$/i, Qu = /^(?:!|[^,\[\]\{\}])(?:%[0-9a-f]{2}|[0-9a-z\-#;\/\?:@&=\+\$,_\.!~\*'\(\)\[\]])*$/i;
function Vo(e) {
...
function Zg(e, t) {
  var r = !0, n, i, a, s = e.tag, o, l = e.anchor, d, c, u, p, g, v = /* @__PURE__ */ Object.create(null), y, T, b, _;
  ...
  for (e.anchor !== null && (e.anchorMap[e.anchor] = o), _ = e.input.charCodeAt(++e.position); _ !== 0; ) {
    ...
    r ? _ === 44 && L(e, "expected the node content, but found ','") : L(e, "missed comma between flow collection entries"), T = y = b = null, u = p = !1, _ === 63 && (d = e.input.charCodeAt(e.position + 1), Ue(d) && (u = p = !0, e.position++, fe(e, !0, t))), n = e.line, i = e.lineStart, a = e.position, Tr(e, t, pi, !1, !0), T = e.tag, y = e.result, fe(e, !0, t), _ = e.input.charCodeAt(e.position), (p || e.line === n) && _ === 58 && (u = !0, _ = e.input.charCodeAt(++e.position), fe(e, !0, t), Tr(e, t, pi, !1, !0), b = e.result), g ? dr(e, o, v, T, y, b, n, i, a) : u ? o.push(dr(e, null, v, T, y, b, n, i, a)) : o.push(y), fe(e, !0, t), _ = e.input.charCodeAt(e.position), _ === 44 ? (r = !0, _ = e.input.charCodeAt(++e.position)) : r = !1;
  }
...
function ty(e, t, r) {
  var n, i, a, s, o, l, d = e.tag, c = e.anchor, u = {}, p = /* @__PURE__ */ Object.create(null), g = null, v = null, y = null, T = !1, b = !1, _;
  if (e.firstTabInLine !== -1) return !1;
  for (e.anchor !== null && (e.anchorMap[e.anchor] = u), _ = e.input.charCodeAt(e.position); _ !== 0; ) {
    if (!T && e.firstTabInLine !== -1 && (e.position = e.firstTabInLine, L(e, "tab characters must not be used in indentation")), n = e.input.charCodeAt(e.position + 1), a = e.line, (_ === 63 || _ === 58) && Ue(n))
      _ === 63 ? (T && (dr(e, u, p, g, v, null, s, o, l), g = v = y = null), b = !0, T = !0, i = !0) : T ? (T = !1, i = !0) : L(e, "incomplete explicit mapping pair; a key node is missed; or followed by a non-tabulated empty line"), e.position += 1, _ = n;
    else {
      ...
      if (e.line === a) {
        ...
        if (_ === 58)
          _ = e.input.charCodeAt(++e.position), Ue(_) || L(e, "a whitespace character is expected after the key-value separator within a block mapping"), T && (dr(e, u, p, g, v, null, s, o, l), g = v = y = null), b = !0, T = !1, i = !1, g = e.tag, v = e.result;
        else if (b)
    ...
    if ((e.line === a || e.lineIndent > t) && (T && (s = e.line, o = e.lineStart, l = e.position), Tr(e, t, hi, !0, i) && (T ? v = e.result : y = e.result), T || (dr(e, u, p, g, v, y, s, o, l), g = v = y = null), fe(e, !0, -1), _ = e.input.charCodeAt(e.position)), (e.line === a || e.lineIndent > t) && _ !== 0)
...
function Tr(e, t, r, n, i) {
  var a, s, o, l = 1, d = !1, c = !1, u, p, g, v, y, T;
  ...
  if (o && (o = d || i), (l === 1 || hi === r) && (pi === r || Yu === r ? y = t : y = t + 1, T = e.position - e.lineStart, l === 1 ? o && (Qo(e, T) || ty(e, T, y)) || Zg(e, y) ? c = !0 : (s && ey(e, y) || Jg(e, y) || Qg(e, y) ? c = !0 : iy(e) ? (c = !0, (e.tag !== null || e.anchor !== null) && L(e, "alias node should not have any properties")) : Kg(e, y, pi === r) && (c = !0, e.tag === null && (e.tag = "?")), e.anchor !== null && (e.anchorMap[e.anchor] = e.result)) : l === 0 && (c = o && Qo(e, T))), e.tag === null)
...
bs.loadAll = sy;
bs.load = oy;
var af = {}, Di = Je, hn = pn, ly = As, sf = Object.prototype.toString, of = Object.prototype.hasOwnProperty, Rs = 65279, cy = 9, Qr = 10, uy = 13, fy = 32, dy = 33, py = 34, Va = 35, hy = 37, my = 38, gy = 39, yy = 42, lf = 44, xy = 45, gi = 58, wy = 61, Ey = 62, vy = 63, Ty = 64, cf = 91, uf = 93, _y = 96, ff = 123, by = 124, df = 125, Ie = {};
Ie[0] = "\\0";
Ie[7] = "\\a";
Ie[8] = "\\b";
Ie[9] = "\\t";
...
var Ry = 1, Zr = 2;
function Oy(e) {
  this.schema = e.schema || ly, this.indent = Math.max(1, e.indent || 2), this.noArrayIndent = e.noArrayIndent || !1, this.skipInvalid = e.skipInvalid || !1, this.flowLevel = Di.isNothing(e.flowLevel) ? -1 : e.flowLevel, this.styleMap = Iy(this.schema, e.styles || null), this.sortKeys = e.sortKeys || !1, this.lineWidth = e.lineWidth || 80, this.noRefs = e.noRefs || !1, this.noCompatMode = e.noCompatMode || !1, this.condenseFlow = e.condenseFlow || !1, this.quotingType = e.quotingType === '"' ? Zr : Ry, this.forceQuotes = e.forceQuotes || !1, this.replacer = typeof e.replacer == "function" ? e.replacer : null, this.implicitTypes = this.schema.compiledImplicit, this.explicitTypes = this.schema.compiledExplicit, this.tag = null, this.result = "", this.duplicates = [], this.usedDuplicates = null;
}
function Zo(e, t) {
...
function Py(e) {
  return en(e) && e !== Rs && !yi(e) && e !== xy && e !== vy && e !== gi && e !== lf && e !== cf && e !== uf && e !== ff && e !== df && e !== Va && e !== my && e !== yy && e !== dy && e !== by && e !== wy && e !== Ey && e !== gy && e !== py && e !== hy && e !== Ty && e !== _y;
}
function ky(e) {
  return !yi(e) && e !== gi;
}
...
function Ny(e, t, r, n, i, a, s, o) {
  var l, d = 0, c = null, u = !1, p = !1, g = n !== -1, v = -1, y = Py(Br(e, 0)) && ky(Br(e, e.length - 1));
  if (t || s)
...
function Ly(e) {
  for (var t = "", r = 0, n, i = 0; i < e.length; r >= 65536 ? i += 2 : i++)
    r = Br(e, i), n = Ie[r], !n && en(r) ? (t += e[i], r >= 65536 && (t += e[i + 1])) : t += n || Cy(r);
  return t;
}
function Uy(e, t, r) {
  var n = "", i = e.tag, a, s, o;
...
(function(e, t) {
  ...
  const p = "[a-zA-Z0-9-]", g = [
    ...
    const D = v(b), $ = u++;
    a(T, $, b), c[T] = $, l[$] = b, d[$] = D, s[$] = new RegExp(b, _ ? "g" : void 0), o[$] = new RegExp(D, _ ? "g" : void 0);
  };
...
const Un = Ni, { MAX_LENGTH: ll, MAX_SAFE_INTEGER: Mn } = ki, { safeRe: Bn, t: jn } = mn, tx = Ds, { compareIdentifiers: xa } = Ef;
let rx = class it {
  constructor(t, r) {
  ...
  compare(t) {
    if (Un("SemVer.compare", this.version, this.options, t), !(t instanceof it)) {
...
var _f = iw;
const aw = $e, sw = Ir, { safeRe: zn, t: Gn } = mn, ow = (e, t) => {
  if (e instanceof aw)
    return e;
...
function Ze() {
  ...
  class t {
    ...
    parseRange(I) {
      const A = ((this.options.includePrerelease && g) | (this.options.loose && v)) + ":" + I, N = n.get(A);
      if (N)
        return N;
    ...
    intersects(I, P) {
      ...
      return this.set.some((A) => b(A, P) && I.set.some((N) => b(N, P) && A.every((O) => N.every((M) => O.intersects(M, P)))));
    }
    ...
    test(I) {
      ...
      for (let P = 0; P < this.set.length; P++)
        if (Z(this.set[P], I, this.options))
          return !0;
      return !1;
    }
  }
  ...
  const r = uw, n = new r(), i = Ds, a = $i(), s = Ni, o = $e, {
    ...
    tildeTrimReplace: u,
    caretTrimReplace: p
  } = mn, { FLAG_INCLUDE_PRERELEASE: g, FLAG_LOOSE: v } = ki, y = (R) => R.value === "<0.0.0-0", T = (R) => R.value === "", b = (R, I) => {
    let P = !0;
    const A = R.slice();
    let N = A.pop();
    for (; P && A.length; )
      P = A.every((O) => N.intersects(O, I)), N = A.pop();
    return P;
  }, _ = (R, I) => (R = R.replace(l[d.BUILD], ""), s("comp", R, I), R = ue(R, I), s("caret", R), R = $(R, I), s("tildes", R), R = Me(R, I), s("xrange", R), R = q(R, I), s("stars", R), R), D = (R) => !R || R.toLowerCase() === "x" || R === "*", $ = (R, I) => R.trim().split(/\s+/).map((P) => Q(P, I)).join(" "), Q = (R, I) => {
    const P = I.loose ? l[d.TILDELOOSE] : l[d.TILDE];
    return R.replace(P, (A, N, O, M, X) => {
      s("tilde", R, A, N, O, M, X);
      let z;
      return D(N) ? z = "" : D(O) ? z = `>=${N}.0.0 <${+N + 1}.0.0-0` : D(M) ? z = `>=${N}.${O}.0 <${N}.${+O + 1}.0-0` : X ? (s("replaceTilde pr", X), z = `>=${N}.${O}.${M}-${X} <${N}.${+O + 1}.0-0`) : z = `>=${N}.${O}.${M} <${N}.${+O + 1}.0-0`, s("tilde return", z), z;
    });
  }, ue = (R, I) => R.trim().split(/\s+/).map((P) => Y(P, I)).join(" "), Y = (R, I) => {
    s("caret", R, I);
    const P = I.loose ? l[d.CARETLOOSE] : l[d.CARET], A = I.includePrerelease ? "-0" : "";
    return R.replace(P, (N, O, M, X, z) => {
      s("caret", R, N, O, M, X, z);
      let ee;
      return D(O) ? ee = "" : D(M) ? ee = `>=${O}.0.0${A} <${+O + 1}.0.0-0` : D(X) ? O === "0" ? ee = `>=${O}.${M}.0${A} <${O}.${+M + 1}.0-0` : ee = `>=${O}.${M}.0${A} <${+O + 1}.0.0-0` : z ? (s("replaceCaret pr", z), O === "0" ? M === "0" ? ee = `>=${O}.${M}.${X}-${z} <${O}.${M}.${+X + 1}-0` : ee = `>=${O}.${M}.${X}-${z} <${O}.${+M + 1}.0-0` : ee = `>=${O}.${M}.${X}-${z} <${+O + 1}.0.0-0`) : (s("no pr"), O === "0" ? M === "0" ? ee = `>=${O}.${M}.${X}${A} <${O}.${M}.${+X + 1}-0` : ee = `>=${O}.${M}.${X}${A} <${O}.${+M + 1}.0-0` : ee = `>=${O}.${M}.${X} <${+O + 1}.0.0-0`), s("caret return", ee), ee;
    });
  }, Me = (R, I) => (s("replaceXRanges", R, I), R.split(/\s+/).map((P) => x(P, I)).join(" ")), x = (R, I) => {
    R = R.trim();
    const P = I.loose ? l[d.XRANGELOOSE] : l[d.XRANGE];
    return R.replace(P, (A, N, O, M, X, z) => {
      s("xRange", R, A, N, O, M, X, z);
      const ee = D(O), he = ee || D(M), U = he || D(X), et = U;
  ...
  }, q = (R, I) => (s("replaceStars", R, I), R.trim().replace(l[d.STAR], "")), j = (R, I) => (s("replaceGTE0", R, I), R.trim().replace(l[I.includePrerelease ? d.GTE0PRE : d.GTE0], "")), B = (R) => (I, P, A, N, O, M, X, z, ee, he, U, et) => (D(A) ? P = "" : D(N) ? P = `>=${A}.0.0${R ? "-0" : ""}` : D(O) ? P = `>=${A}.${N}.0${R ? "-0" : ""}` : M ? P = `>=${P}` : P = `>=${P}${R ? "-0" : ""}`, D(ee) ? z = "" : D(he) ? z = `<${+ee + 1}.0.0-0` : D(U) ? z = `<${ee}.${+he + 1}.0-0` : et ? z = `<=${ee}.${he}.${U}-${et}` : R ? z = `<${ee}.${he}.${+U + 1}-0` : z = `<=${z}`, `${P} ${z}`.trim()), Z = (R, I, P) => {
...
function $i() {
  ...
  Ea = t;
  const r = Ds, { safeRe: n, t: i } = mn, a = _f, s = Ni, o = $e, l = Ze();
  return Ea;
}
...
const Ow = $e, bf = $i(), { ANY: Dw } = bf, Pw = Ze(), kw = Li, yl = Fi, xl = ks, Nw = Fs, Fw = Ns, $w = (e, t, r, n) => {
  ...
  for (let d = 0; d < t.set.length; ++d) {
    ...
    let u = null, p = null;
    if (c.forEach((g) => {
      g.semver === Dw && (g = new bf(">=0.0.0")), u = u || g, p = p || g, i(g.semver, u.semver, n) ? u = g : s(g.semver, p.semver, n) && (p = g);
...
var Jw = Vw;
const _a = mn, bl = ki, Qw = $e, Sl = Ef, Zw = Ir, eE = sx, tE = cx, rE = fx, nE = px, iE = gx, aE = wx, sE = Tx, oE = Sx, lE = Qe, cE = Rx, uE = Px, fE = Ps, dE = $x, pE = Mx, hE = Fi, mE = ks, gE = vf, yE = Tf, xE = Ns, wE = Fs, EE = _f, vE = lw, TE = $i(), _E = Ze(), bE = Li, SE = mw, AE = ww, IE = _w, CE = Aw, RE = Rw, OE = $s, DE = Mw, PE = zw, kE = Hw, NE = Ww, FE = Jw;
var Sf = {
  parse: Zw,
  valid: eE,
  clean: tE,
...
xi.exports;
(function(e, t) {
  var r = 200, n = "__lodash_hash_undefined__", i = 1, a = 2, s = 9007199254740991, o = "[object Arguments]", l = "[object Array]", d = "[object AsyncFunction]", c = "[object Boolean]", u = "[object Date]", p = "[object Error]", g = "[object Function]", v = "[object GeneratorFunction]", y = "[object Map]", T = "[object Number]", b = "[object Null]", _ = "[object Object]", D = "[object Promise]", $ = "[object Proxy]", Q = "[object RegExp]", ue = "[object Set]", Y = "[object String]", Me = "[object Symbol]", x = "[object Undefined]", q = "[object WeakMap]", j = "[object ArrayBuffer]", B = "[object DataView]", Z = "[object Float32Array]", R = "[object Float64Array]", I = "[object Int8Array]", P = "[object Int16Array]", A = "[object Int32Array]", N = "[object Uint8Array]", O = "[object Uint8ClampedArray]", M = "[object Uint16Array]", X = "[object Uint32Array]", z = /[\\^$.*+?()[\]{}|]/g, ee = /^\[object .+?Constructor\]$/, he = /^(?:0|[1-9]\d*)$/, U = {};
  U[Z] = U[R] = U[I] = U[P] = U[A] = U[N] = U[O] = U[M] = U[X] = !0, U[o] = U[l] = U[j] = U[c] = U[B] = U[u] = U[p] = U[g] = U[y] = U[T] = U[_] = U[Q] = U[ue] = U[Y] = U[q] = !1;
  var et = typeof Oe == "object" && Oe && Oe.Object === Object && Oe, h = typeof self == "object" && self && self.Object === Object && self, f = et || h || Function("return this")(), S = t && !t.nodeType && t, E = S && !0 && e && !e.nodeType && e, K = E && E.exports === S, ne = K && et.process, le = function() {
    try {
  ...
  function _e(m, w) {
    for (var C = -1, F = m == null ? 0 : m.length, ie = 0, H = []; ++C < F; ) {
      var ce = m[C];
      w(ce, C, m) && (H[ie++] = ce);
    }
    return H;
  ...
  function ht(m, w) {
    for (var C = -1, F = w.length, ie = m.length; ++C < F; )
      m[ie + C] = w[C];
    return m;
  }
  function de(m, w) {
  ...
  function _n(m) {
    ...
    return m.forEach(function(F, ie) {
      C[++w] = [ie, F];
    }), C;
  }
  function ld(m, w) {
  ...
  var ud = Array.prototype, fd = Function.prototype, bn = Object.prototype, Ji = f["__core-js_shared__"], Vs = fd.toString, tt = bn.hasOwnProperty, Ys = function() {
    var m = /[^.]+$/.exec(Ji && Ji.keys && Ji.keys.IE_PROTO || "");
    return m ? "Symbol(src)_1." + m : "";
  }(), Ks = bn.toString, dd = RegExp(
    "^" + Vs.call(tt).replace(z, "\\$&").replace(/hasOwnProperty|(function).*?(?=\\\()| for .+?(?=\\\])/g, "$1.*?") + "$"
  ), Js = K ? f.Buffer : void 0, Sn = f.Symbol, Qs = f.Uint8Array, Zs = bn.propertyIsEnumerable, pd = ud.splice, Nt = Sn ? Sn.toStringTag : void 0, eo = Object.getOwnPropertySymbols, hd = Js ? Js.isBuffer : void 0, md = ld(Object.keys, Object), Qi = rr(f, "DataView"), Or = rr(f, "Map"), Zi = rr(f, "Promise"), ea = rr(f, "Set"), ta = rr(f, "WeakMap"), Dr = rr(Object, "create"), gd = Lt(Qi), yd = Lt(Or), xd = Lt(Zi), wd = Lt(ea), Ed = Lt(ta), to = Sn ? Sn.prototype : void 0, ra = to ? to.valueOf : void 0;
  function Ft(m) {
  ...
  function _d(m) {
    ...
    return tt.call(w, m) ? w[m] : void 0;
  }
  function bd(m) {
    var w = this.__data__;
    return Dr ? w[m] !== void 0 : tt.call(w, m);
  }
  function Sd(m, w) {
    var C = this.__data__;
  ...
  function Id(m) {
    ...
    if (C < 0)
      return !1;
    var F = w.length - 1;
    return C == F ? w.pop() : pd.call(w, C, 1), --this.size, !0;
  }
  function Cd(m) {
    var w = this.__data__, C = In(w, m);
  ...
  An.prototype.add = An.prototype.push = $d, An.prototype.has = Ld;
  function mt(m) {
  ...
  function Gd(m, w) {
    var C = Rn(m), F = !C && ip(m), ie = !C && !F && na(m), H = !C && !F && !ie && uo(m), ce = C || F || ie || H, me = ce ? We(m.length, String) : [], Ee = me.length;
    for (var ae in m)
      ...
      ie && (ae == "offset" || ae == "parent") || // PhantomJS 2 has enumerable non-index properties on typed arrays.
  ...
  function Pr(m) {
    return m == null ? m === void 0 ? x : b : Nt && Nt in Object(m) ? Jd(m) : np(m);
  }
  function ro(m) {
    return kr(m) && Pr(m) == o;
  }
  function no(m, w, C, F, ie) {
    return m === w ? !0 : m == null || w == null || !kr(m) && !kr(w) ? m !== m && w !== w : qd(m, w, C, F, no, ie);
  }
  function qd(m, w, C, F, ie, H) {
    ...
    if (be && !Be)
      return H || (H = new mt()), ce || uo(m) ? io(m, w, C, F, ie, H) : Yd(m, w, Ee, C, F, ie, H);
    if (!(C & i)) {
      var Ge = Be && tt.call(m, "__wrapped__"), He = Ve && tt.call(w, "__wrapped__");
      if (Ge || He) {
        var yt = Ge ? m.value() : m, ct = He ? w.value() : w;
        return H || (H = new mt()), ie(yt, ct, C, F, H);
      }
    }
    return be ? (H || (H = new mt()), Kd(m, w, C, F, ie, H)) : !1;
  }
  function Xd(m) {
    if (!co(m) || tp(m))
      return !1;
  ...
  function Vd(m) {
    ...
    for (var C in Object(m))
      tt.call(m, C) && C != "constructor" && w.push(C);
    return w;
  }
  function io(m, w, C, F, ie, H) {
    ...
    for (H.set(m, w), H.set(w, m); ++Be < me; ) {
      ...
      if (be) {
        if (!de(w, function(ct, Ut) {
          if (!Tn(be, Ut) && (Ge === ct || ie(Ge, ct, C, F, H)))
            return be.push(Ut);
        })) {
          Ve = !1;
          break;
        }
      } else if (!(Ge === He || ie(Ge, He, C, F, H))) {
        Ve = !1;
        break;
      }
    }
  ...
  function Yd(m, w, C, F, ie, H, ce) {
    switch (C) {
      ...
      case j:
        return !(m.byteLength != w.byteLength || !H(new Qs(m), new Qs(w)));
      case c:
      case u:
      case T:
        return so(+m, +w);
      ...
      case ue:
        var Ee = F & i;
        if (me || (me = cd), m.size != w.size && !Ee)
          return !1;
        var ae = ce.get(m);
        if (ae)
          return ae == w;
        F |= a, ce.set(m, w);
        var Be = io(me(m), me(w), F, ie, H, ce);
        return ce.delete(m), Be;
      case Me:
        if (ra)
          return ra.call(m) == ra.call(w);
    }
    return !1;
  }
  function Kd(m, w, C, F, ie, H) {
    var ce = C & i, me = ao(m), Ee = me.length, ae = ao(w), Be = ae.length;
    if (Ee != Be && !ce)
      return !1;
    for (var Ve = Ee; Ve--; ) {
      var be = me[Ve];
      if (!(ce ? be in w : tt.call(w, be)))
        return !1;
    }
    var Ge = H.get(m);
    if (Ge && H.get(w))
    ...
    for (var yt = ce; ++Ve < Ee; ) {
      ...
      var ct = m[be], Ut = w[be];
      if (F)
        var fo = ce ? F(Ut, ct, be, w, m, H) : F(ct, Ut, be, m, w, H);
      if (!(fo === void 0 ? ct === Ut || ie(ct, Ut, C, F, H) : fo)) {
        He = !1;
        break;
      }
  ...
  function Cn(m, w) {
    var C = m.__data__;
    return ep(w) ? C[typeof w == "string" ? "string" : "hash"] : C.map;
  }
  function rr(m, w) {
    var C = Rr(m, w);
  ...
  function Jd(m) {
    ...
    var ie = Ks.call(m);
    return F && (w ? m[Nt] = C : delete m[Nt]), ie;
  }
  var Qd = eo ? function(m) {
    return m == null ? [] : (m = Object(m), _e(eo(m), function(w) {
      return Zs.call(m, w);
    }));
  } : lp, gt = Pr;
  (Qi && gt(new Qi(new ArrayBuffer(1))) != B || Or && gt(new Or()) != y || Zi && gt(Zi.resolve()) != D || ea && gt(new ea()) != ue || ta && gt(new ta()) != q) && (gt = function(m) {
...
gn.createTempUpdateFile = jE;
const LE = cn, UE = Dt, Al = $E, zt = Pt, qr = oe;
class ME {
  constructor(t) {
...
var yn = {}, Xe = {}, XE = "[object Symbol]", If = /[\\^$.*+?()[\]{}|]/g, WE = RegExp(If.source), VE = typeof Oe == "object" && Oe && Oe.Object === Object && Oe, YE = typeof self == "object" && self && self.Object === Object && self, KE = VE || YE || Function("return this")(), JE = Object.prototype, QE = JE.toString, Cl = KE.Symbol, Rl = Cl ? Cl.prototype : void 0, Ol = Rl ? Rl.toString : void 0;
function ZE(e) {
  if (typeof e == "string")
    return e;
  if (tv(e))
      ...
      if (this.updater.allowPrerelease) {
        ...
        if (T === null)
          ...
          for (const b of l.getElements("entry")) {
            ...
            if (_ === null)
              continue;
            const D = _[1], $ = ((n = pr.prerelease(D)) === null || n === void 0 ? void 0 : n[0]) || null, Q = !T || ["alpha", "beta"].includes(T), ue = $ !== null && !["alpha", "beta"].includes(String($));
            if (Q && !ue && !(T === "beta" && $ === "alpha")) {
              c = D;
              break;
            }
            if ($ && $ === T) {
...
const ar = xe, wv = Te, Ev = oe, $l = _r, Ll = Xe, vv = Ot, Tv = pe;
...
Mi.createClient = Cv;
const Hn = xe, bv = Bi, Ul = yn, Sv = Ot, Av = ji, Iv = zi;
function Pf(e) {
...
Cr.copyData = kf;
const qn = xe, Pv = Dt, kv = ln, Nv = tr, jl = Buffer.from(`\r
\r
`);
var Et;
(function(e) {
...
const Lr = xe, Pa = Pt, Bv = Dt, jv = Cr, zv = _r, Xn = tr, Hl = Hi, Gv = qi;
class Hv {
    ...
    await new Promise((s, o) => {
      ...
      T.redirect = "manual", g = (b) => {
        ...
        if ($.kind === Xn.OperationKind.COPY) {
          d && d.beginFileCopy(), (0, jv.copyData)($, p, n, o, () => g(b));
          return;
        }
        const Q = `bytes=${$.start}-${$.end - 1}`;
        T.headers.range = Q, (D = (_ = this.logger) === null || _ === void 0 ? void 0 : _.debug) === null || D === void 0 || D.call(_, `download range: ${Q}`), d && d.beginRangeDownload();
        ...
        ue.on("redirect", (Y, Me, x) => {
          this.logger.info(`Redirect to ${qv(x)}`), y = x, (0, Lr.configureRequestUrl)(new zv.URL(y), T), ue.followRedirect();
...
const Ce = xe, Vv = cn, Yv = _i, Kv = bc, sr = Pt, Jv = Te, ka = Pi, Mt = oe, Gt = Sf, Xl = gn, Qv = Ui, Wl = Af, Zv = yn, Na = Mi, eT = Ac, tT = Xe, rT = Gi, or = kt;
class Bs extends Kv.EventEmitter {
  ...
  async executeDownload(t) {
    ...
    const p = s == null ? null : Mt.join(d, `package-${a}${Mt.extname(s.path) || ".7z"}`), g = async (_) => (await l.setDownloadedFile(u, p, i, r, c, _), await t.done({
      ...i,
      downloadedFile: u
    }), p == null ? [u] : [u, p]), v = this._logger, y = await l.validateDownloadedPath(u, i, r, v);
    if (y != null)
...
wn.FileWithEmbeddedBlockMapDifferentialDownloader = lT;
function Ff(e) {
...
const Yl = xe, Kl = Ti, uT = Pt, fT = Dt, Ur = oe, dT = pt, pT = wn, hT = pe, Jl = kt;
...
const tc = xe, Fa = Pt, ST = Dt, rc = oe, AT = yp, IT = At, CT = pe, nc = Ti, ic = cn;
class RT extends IT.AppUpdater {
  ...
  async doDownloadUpdate(t) {
    ...
    return this.executeDownload({
      ...
      downloadUpdateOptions: t,
      task: async (u, p) => {
        const g = rc.join(this.downloadedUpdateHelper.cacheDir, c), v = () => (0, Fa.pathExistsSync)(g) ? !t.disableDifferentialDownload : (n.info("Unable to locate previous update.zip for differential download (is this first install?), falling back to full download"), !1);
        let y = !0;
        v() && (y = await this.differentialDownloadInstaller(l, t, u, d, c)), y && await this.httpExecutor.download(l.url, u, p);
      },
      done: async (u) => {
    ...
    return await new Promise((d, c) => {
      ...
      this.server.on("request", (v, y) => {
        ...
        if (s.info(`${T} requested`), T === "/") {
          ...
          const D = v.headers.authorization.split(" ")[1], $ = Buffer.from(D, "base64").toString("ascii"), [Q, ue] = $.split(":");
          if (Q !== "autoupdater" || ue !== u) {
        ...
        _.on("error", (D) => {
          ...
          b = !0, this.nativeUpdater.removeListener("error", c), c(new Error(`Cannot pipe "${i}": ${D}`));
        }), y.writeHead(200, {
  ...
  return new Promise((n, i) => {
    ...
    r.info(`Verifying signature ${a}`), (0, $f.execFile)('set "PSModulePath=" & chcp 65001 >NUL & powershell.exe', ["-NoProfile", "-NonInteractive", "-InputFormat", "None", "-Command", `"Get-AuthenticodeSignature -LiteralPath '${a}' | ConvertTo-Json -Compress"`], {
      ...
      try {
        ...
        if (c.Status === 0) {
          try {
            const v = sc.normalize(c.Path), y = sc.normalize(t);
            if (r.info(`LiteralPath: ${v}. Update Path: ${y}`), v !== y) {
              $a(r, new Error(`LiteralPath of ${v} is different than ${y}`), l, i), n(null);
              return;
            }
          } catch (v) {
          ...
          let g = !1;
          for (const v of e) {
            const y = (0, ac.parseDn)(v);
            if (y.size ? g = Array.from(y.keys()).every((b) => y.get(b) === p.get(b)) : v === p.get("CN") && (r.warn(`Signature validated using only CN ${v}. Please add your full Distinguished Name (DN) to publisherNames configuration`), g = !0), g) {
              n(null);
              return;
            }
          }
...
const Wn = xe, oc = oe, NT = pt, FT = wn, lc = kt, $T = pe, LT = Pt, UT = js, cc = _r;
...
on.NsisUpdater = MT;
(function(e) {
  var t = Oe && Oe.__createBinding || (Object.create ? function(T, b, _, D) {
    D === void 0 && (D = _);
...
var Wi = function(e, t, r, n, i) {
  ...
  var s, o, l, d = a * 8 - i - 1, c = (1 << d) - 1, u = c >> 1, p = i === 23 ? Math.pow(2, -24) - Math.pow(2, -77) : 0, g = n ? 0 : a - 1, v = n ? 1 : -1, y = t < 0 || t === 0 && 1 / t < 0 ? 1 : 0;
...
const rt = Ar("tokenizer:inflate"), La = 256 * 1024, S_ = Gf(gr.DataDescriptor), Vn = Gf(gr.EndOfCentralDirectory);
class Gs {
  constructor(t) {
...
class tb extends En("UnexpectedFileContentError") {
  constructor(t, r) {
...
const Ub = {
  ...
  async load() {
    return (await import("./MpegParser-BTSuE1L0.js")).MpegParser;
  }
}, Mb = {
  parserType: "apev2",
  extensions: [".ape"],
  ...
  async load() {
    return (await import("./AsfParser-KYxmu-Ts.js")).AsfParser;
  }
}, jb = {
  parserType: "dsdiff",
  extensions: [".dff"],
  ...
  async load() {
    return (await import("./DsdiffParser-CPiv-MSB.js")).DsdiffParser;
  }
}, zb = {
  parserType: "aiff",
  ...
  async load() {
    return (await import("./AiffParser-BwMJH58J.js")).AIFFParser;
  }
}, Gb = {
  parserType: "dsf",
  extensions: [".dsf"],
  mimeTypes: ["audio/dsf"],
  async load() {
    return (await import("./DsfParser-BqtNoelk.js")).DsfParser;
  }
}, Hb = {
  parserType: "flac",
  extensions: [".flac"],
  ...
  async load() {
    return (await import("./FlacParser-a9W42rrB.js").then((e) => e.d)).FlacParser;
  }
}, qb = {
  parserType: "matroska",
  ...
  async load() {
    return (await import("./MatroskaParser-CnksXyyk.js")).MatroskaParser;
  }
}, Xb = {
  parserType: "mp4",
  ...
  async load() {
    return (await import("./MP4Parser-yyY9jOPp.js")).MP4Parser;
  }
}, Wb = {
  parserType: "musepack",
  extensions: [".mpc"],
  ...
  async load() {
    return (await import("./MusepackParser-CoslbHzv.js")).MusepackParser;
  }
}, Vb = {
  parserType: "ogg",
  ...
  async load() {
    return (await import("./OggParser-DeAWnZGn.js")).OggParser;
  }
}, Yb = {
  parserType: "wavpack",
  extensions: [".wv", ".wvp"],
  ...
  async load() {
    return (await import("./WavPackParser-Cc8aj4Fs.js")).WavPackParser;
  }
}, Kb = {
  parserType: "riff",
  ...
  async load() {
    return (await import("./WaveParser-DyBEeK5f.js")).WaveParser;
  }
...
Ke.whenReady().then(() => {
  ...
  const e = ti(import.meta.url)("yt-dlp-wrap").default, t = async () => {
...
`).map((o) => {
    ...
    try {
      const s = await t(), o = ti(import.meta.url)("ffmpeg-static").replace("app.asar", "app.asar.unpacked");
    ...
    try {
      const o = ti(import.meta.url)("get-artist-title");
      console.log(`[Lyrics] Search: ${n} / ${i}`);
      const l = async (y) => {
        try {
          let T = "https://lrclib.net/api/search?";
          y.q ? T += `q=${encodeURIComponent(y.q)}` : (y.track_name && (T += `track_name=${encodeURIComponent(y.track_name)}&`), y.artist_name && (T += `artist_name=${encodeURIComponent(y.artist_name)}`));
          const b = await fetch(T);
          if (b.ok) {
            const _ = await b.json();
            if (Array.isArray(_) && _.length > 0) {
              const D = _.find((Q) => Q.syncedLyrics);
              if (D) return { type: "synced", text: D.syncedLyrics };
              const $ = _.find((Q) => Q.plainLyrics);
              if ($) return { type: "text", text: $.plainLyrics };
            }
          }
        } catch (T) {
          console.error("LRC Search Error", y, T);
        }
        return null;
      }, d = (y) => y ? y.split(`
...
`) : null;
      let c = n, u = i, p = "";
      if (a) {
        let y = Re.basename(a, Re.extname(a));
        p = y, console.log(`[Lyrics] Raw Filename: ${y}`), y = y.replace(/『.+?』/g, ""), y = y.replace(/【(.*?)】/g, (_, D) => /\b(Official|MV|Music Video|Lyrics|動態歌詞|Video|Live|Cover)\b/i.test(D) ? "" : _), y = y.replace(/[_|]/g, " ");
        const T = y.match(/《(.+?)》/);
        if (T) {
          c = T[1].trim();
          const D = y.replace(T[0], "").trim().split(/[-]/)[0].trim();
          D.length > 1 && (u = D);
        } else {
          const _ = y.replace(/[\[\]【】]/g, " ").replace(/\s+/g, " ").trim(), D = o(_);
          D && D.length === 2 && D[1] && ((!u || u === i) && (u = D[0]), c = D[1]);
        }
        const b = /\b(Official|Music Video|MV|Live|Cover|4K|1080p|Lyric|Video|動態歌詞)\b/gi;
        c && (c = c.replace(b, "").trim()), u && (u = u.replace(b, "").trim()), console.log(`[Lyrics] Cleaned Metadata: Title="${c}", Artist="${u}"`);
      }
      let g = null;
      const v = [
        // Attempt 1: Title Only (Crucial for Covers/Live where Artist differs)
        // "如果可以" -> search ignores "JJ Lin", finds "WeiBird" version
        { track_name: c, artist_name: "" },
        // Attempt 2: Standard (Title + Artist)
        { track_name: c, artist_name: u },
      ...
      for (const y of v) {
        if (y.track_name === void 0 && y.q === void 0 || y.track_name === "") continue;
        console.log(`[Lyrics] Attempt: ${JSON.stringify(y)}`);
        const T = await l(y);
        if (T) {
          if (T.type === "synced")
            return console.log("[Lyrics] SYNCED Lyrics found! Returning immediately."), T.text;
          g || (g = T);
        }
      }
      return g ? (console.log("[Lyrics] Returning Plain Text fallback."), d(g.text)) : (console.log("[Lyrics] No lyrics found after all attempts."), null);
    } catch (o) {
