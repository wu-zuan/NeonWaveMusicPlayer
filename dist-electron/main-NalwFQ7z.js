...
const Gp = Fe.fromPromise, { makeDir: Hp, makeDirSync: sa } = ps, oa = Gp(Hp);
var ot = {
  mkdirs: oa,
  mkdirsSync: sa,
  // alias
...
function fh(e, t, r, n, i, a) {
  return t ? zc(r, n, i, a) : dh(e.mode, r, n, i, a);
}
function dh(e, t, r, n, i) {
  Me.mkdir(r, (a) => {
    if (a) return i(a);
    zc(t, r, n, (s) => s ? i(s) : Ii(r, e, i));
  });
}
function zc(e, t, r, n) {
...
function ph(e, t, r, n, i, a) {
  ...
  Vr.checkPaths(s, o, "copy", i, (l, d) => {
    if (l) return a(l);
    const { destStat: c } = d;
    ih(c, s, o, i, (u) => u ? a(u) : Gc(e, r, n, i, a));
  });
}
...
const Gh = Fe.fromCallback, tu = ce, _t = $e, ru = ot;
function Hh(e, t) {
  function r() {
    _t.writeFile(e, "", (n) => {
      if (n) return t(n);
...
const bt = ce, Gr = $e, Qh = tr.pathExists;
function Zh(e, t, r) {
  if (bt.isAbsolute(e))
...
var Bm = Ne;
const jm = $e, ja = ce, zm = gs.copy, gu = Ci.remove, Gm = ot.mkdirp, Hm = tr.pathExists, $o = Sr;
function qm(e, t, r, n) {
  ...
  $o.checkPaths(e, t, "move", r, (a, s) => {
    ...
    $o.checkParentPaths(e, o, t, "move", (d) => {
      ...
      Gm(ja.dirname(t), (c) => c ? n(c) : Lo(e, t, i, l, n));
    });
  });
}
function Xm(e) {
...
var Vm = qm;
const yu = $e, za = ce, Ym = gs.copySync, xu = Ci.removeSync, Km = ot.mkdirpSync, Uo = Sr;
function Jm(e, t, r) {
  r = r || {};
  const n = r.overwrite || r.clobber || !1, { srcStat: i, isChangingCase: a = !1 } = Uo.checkPathsSync(e, t, "move", r);
  return Uo.checkParentPathsSync(e, i, t, "move"), Qm(t) || Km(za.dirname(t)), Zm(e, t, n, a);
}
function Qm(e) {
...
var Un = { exports: {} }, da, zo;
function c0() {
  return zo || (zo = 1, da = (e, t = process.argv) => {
...
var Ku = new Mg("tag:yaml.org,2002:pairs", {
  ...
  resolve: jg,
  construct: zg
}), Gg = Le, Hg = Object.prototype.hasOwnProperty;
function qg(e) {
  if (e === null) return !0;
  var t, r = e;
  for (t in r)
...
var Ju = new Gg("tag:yaml.org,2002:set", {
  kind: "mapping",
  resolve: qg,
  construct: Xg
}), As = Gu.extend({
...
const Bn = $i, { MAX_LENGTH: dl, MAX_SAFE_INTEGER: jn } = Fi, { safeRe: zn, t: Gn } = gn, cx = Os, { compareIdentifiers: xa } = bf;
let ux = class it {
  constructor(t, r) {
    ...
    const n = t.trim().match(r.loose ? zn[Gn.LOOSE] : zn[Gn.FULL]);
    if (!n)
  ...
  inc(t, r, n) {
    if (t.startsWith("pre")) {
      ...
      if (r) {
        const i = `-${r}`.match(this.options.loose ? zn[Gn.PRERELEASELOOSE] : zn[Gn.PRERELEASE]);
        if (!i || i[1] !== r)
...
var Ps = jx;
const zx = Ps, Gx = (e, t) => e.sort((r, n) => zx(r, n, t));
var Hx = Gx;
...
function Ze() {
  ...
  const r = xw, n = new r(), i = Os, a = Ui(), s = $i, o = Ue, {
    ...
    return R.replace(P, (S, $, O, G, Y, X) => {
      ...
      const re = F(O), ge = re || F(G), z = ge || F(Y), et = z;
      return $ === "=" && et && ($ = ""), X = I.includePrerelease ? "-0" : "", re ? $ === ">" || $ === "<" ? S = "<0.0.0-0" : S = "*" : $ && et ? (ge && (G = 0), Y = 0, $ === ">" ? ($ = ">=", ge ? (O = +O + 1, G = 0, Y = 0) : (G = +G + 1, Y = 0)) : $ === "<=" && ($ = "<", ge ? O = +O + 1 : G = +G + 1), $ === "<" && (X = "-0"), S = `${$ + O}.${G}.${Y}${X}`) : ge ? S = `>=${O}.0.0${X} <${+O + 1}.0.0-0` : z && (S = `>=${O}.${G}.0${X} <${O}.${+G + 1}.0-0`), s("xRange return", S), S;
    });
  }, j = (R, I) => (s("replaceStars", R, I), R.trim().replace(l[d.STAR], "")), U = (R, I) => (s("replaceGTE0", R, I), R.trim().replace(l[I.includePrerelease ? d.GTE0PRE : d.GTE0], "")), M = (R) => (I, P, S, $, O, G, Y, X, re, ge, z, et) => (F(S) ? P = "" : F($) ? P = `>=${S}.0.0${R ? "-0" : ""}` : F(O) ? P = `>=${S}.${$}.0${R ? "-0" : ""}` : G ? P = `>=${P}` : P = `>=${P}${R ? "-0" : ""}`, F(re) ? X = "" : F(ge) ? X = `<${+re + 1}.0.0-0` : F(z) ? X = `<${re}.${+ge + 1}.0-0` : et ? X = `<=${re}.${ge}.${z}-${et}` : R ? X = `<${re}.${ge}.${+z + 1}-0` : X = `<=${X}`, `${P} ${X}`.trim()), J = (R, I, P) => {
...
var Lw = $w;
const Uw = Ue, Cf = Ui(), { ANY: Mw } = Cf, Bw = Ze(), jw = Mi, vl = Li, Tl = ks, zw = Fs, Gw = Ns, Hw = (e, t, r, n) => {
...
var aE = rE;
const _a = gn, Cl = Fi, sE = Ue, Rl = bf, oE = Cr, lE = hx, cE = yx, uE = wx, fE = vx, dE = bx, pE = Ix, hE = Dx, mE = kx, gE = Qe, yE = Lx, xE = Bx, wE = Ps, EE = Hx, vE = Wx, TE = Li, _E = ks, bE = Sf, SE = Af, AE = Ns, IE = Fs, CE = If, RE = gw, DE = Ui(), OE = Ze(), PE = Mi, kE = _w, NE = Iw, FE = Ow, $E = Nw, LE = Lw, UE = $s, ME = Ww, BE = Kw, jE = Qw, zE = tE, GE = aE;
var Rf = {
  parse: oE,
  valid: lE,
  clean: cE,
...
(function(e, t) {
  ...
  z[J] = z[R] = z[I] = z[P] = z[S] = z[$] = z[O] = z[G] = z[Y] = !0, z[o] = z[l] = z[U] = z[c] = z[M] = z[u] = z[p] = z[g] = z[x] = z[T] = z[_] = z[k] = z[H] = z[q] = z[j] = !1;
  ...
  function Qd(m) {
    return Nr(m) && lo(m.length) && !!z[kr(m)];
  }
  function Zd(m) {
    if (!op(m))
      return Ed(m);
...
const qE = un, XE = Pt, Dl = HE, Gt = kt, Xr = ce;
class WE {
  constructor(t) {
...
ji.createClient = $v;
const Xn = Ee, Pv = zi, zl = xn, kv = Ot, Nv = Gi, Fv = Hi;
function $f(e) {
...
function Lv(e, t, r) {
  ...
  for (let x = 0; x < c.checksums.length; w += c.sizes[x], x++) {
    ...
    _ != null && g.get(b) !== T && (r.warn(`Checksum ("${b}") matches, but size differs (old: ${g.get(b)}, new: ${T})`), _ = void 0), _ === void 0 ? (u++, a != null && a.kind === Wt.DOWNLOAD && a.end === w ? a.end += T : (a = {
      ...
      // oldBlocks: null,
    }, Gl(a, o, b, x))) : a != null && a.kind === Wt.COPY && a.end === _ ? a.end += T : (a = {
      kind: Wt.COPY,
      start: _,
      end: _ + T
      // oldBlocks: [checksum]
...
Rr.copyData = Lf;
const Wn = Ee, Bv = Pt, jv = cn, zv = rr, ql = Buffer.from(`\r
\r
`);
var vt;
(function(e) {
...
const Yn = Ee, fc = ce, zT = ht, GT = En, dc = Nt, HT = me, qT = kt, XT = js, pc = br;
class WT extends zT.BaseUpdater {
  constructor(t, r) {
  ...
  async differentialDownloadWebPackage(t, r, n, i) {
    ...
    try {
      ...
      this.listenerCount(dc.DOWNLOAD_PROGRESS) > 0 && (a.onProgress = (s) => this.emit(dc.DOWNLOAD_PROGRESS, s)), await new GT.FileWithEmbeddedBlockMapDifferentialDownloader(r, this.httpExecutor, a).download();
    } catch (a) {
...
const G_ = Array.from({ length: 256 }, (e, t) => t.toString(16).padStart(2, "0"));
function iA(e) {
  j_(e);
  let t = "";
...
const jt = Ir("music-metadata:collector"), Gb = ["matroska", "APEv2", "vorbis", "ID3v2.4", "ID3v2.3", "ID3v2.2", "exif", "asf", "iTunes", "AIFF", "ID3v1"];
class Hb {
  constructor(t) {
    this.format = {
      tagTypes: [],
...
const Xb = {
  ...
  async load() {
    return (await import("./MpegParser-bqAQdc_b.js")).MpegParser;
  }
}, Wb = {
  parserType: "apev2",
  extensions: [".ape"],
  ...
  async load() {
    return (await import("./AsfParser-CF8MeUiy.js")).AsfParser;
  }
}, Yb = {
  parserType: "dsdiff",
  extensions: [".dff"],
  ...
  async load() {
    return (await import("./DsdiffParser-hSQs_8S1.js")).DsdiffParser;
  }
}, Kb = {
  parserType: "aiff",
  ...
  async load() {
    return (await import("./AiffParser-8AG_YNAG.js")).AIFFParser;
  }
}, Jb = {
  parserType: "dsf",
  extensions: [".dsf"],
  mimeTypes: ["audio/dsf"],
  async load() {
    return (await import("./DsfParser-CHw8BTXt.js")).DsfParser;
  }
}, Qb = {
  parserType: "flac",
  extensions: [".flac"],
  ...
  async load() {
    return (await import("./FlacParser-D3af1Mjl.js").then((e) => e.d)).FlacParser;
  }
}, Zb = {
  parserType: "matroska",
  ...
  async load() {
    return (await import("./MatroskaParser-Dup7LGYd.js")).MatroskaParser;
  }
}, eS = {
  parserType: "mp4",
  ...
  async load() {
    return (await import("./MP4Parser-BGy4e2Ad.js")).MP4Parser;
  }
}, tS = {
  parserType: "musepack",
  extensions: [".mpc"],
  ...
  async load() {
    return (await import("./MusepackParser-DKrVaScP.js")).MusepackParser;
  }
}, rS = {
  parserType: "ogg",
  ...
  async load() {
    return (await import("./OggParser-CxD5sY2o.js")).OggParser;
  }
}, nS = {
  parserType: "wavpack",
  extensions: [".wv", ".wvp"],
  ...
  async load() {
    return (await import("./WavPackParser-C8O3TzTA.js")).WavPackParser;
  }
}, iS = {
  parserType: "riff",
  ...
  async load() {
    return (await import("./WaveParser-T0OugXOo.js")).WaveParser;
  }
...
class sS {
  ...
  async parse(t, r, n) {
    if (t.supportsRandomAccess() ? (zt("tokenizer supports random-access, scanning for appending headers"), await CS(t, n)) : zt("tokenizer does not support random-access, cannot scan for appending headers"), !r) {
