...
var Ye = (e, t, r) => gp(e, typeof t != "symbol" ? t + "" : t, r);
import Jt, { app as Je, BrowserWindow as Ac, Notification as yp, ipcMain as ne, dialog as go } from "electron";
import { createRequire as ii } from "node:module";
import { fileURLToPath as wp } from "node:url";
import De from "node:path";
import kn, { open as xp } from "node:fs/promises";
import Pt from "fs";
...
import { Client as bp, GatewayIntentBits as yo, ChannelType as wo } from "discord.js";
import { createAudioPlayer as Sp, joinVoiceChannel as Ap, createAudioResource as Nn, StreamType as la } from "@discordjs/voice";
...
var xt = Ep, Rp = process.cwd, ai = null, Op = process.env.GRACEFUL_FS_PLATFORM || process.platform;
...
var ce = Pt, Up = Dp, Mp = kp, Bp = Fp, Fn = ps, _e, ui;
...
function hs(e) {
  Up(e), e.gracefulify = hs, e.createReadStream = B, e.createWriteStream = P;
  var t = e.readFile;
  e.readFile = r;
  function r(y, M, j) {
...
gs.makeDir = async (e, t) => (Nc(e), kc.mkdir(e, {
  mode: Fc(t),
  recursive: !0
}));
gs.makeDirSync = (e, t) => (Nc(e), kc.mkdirSync(e, {
  mode: Fc(t),
  recursive: !0
}));
const Hp = Fe.fromPromise, { makeDir: qp, makeDirSync: ca } = gs, ua = Hp(qp);
var lt = {
  mkdirs: ua,
  mkdirsSync: ca,
  // alias
...
function Uc(e, t, r, n, i) {
  ...
  Er.stat(s, { bigint: !0 }, (o, l) => o ? o.code === "ENOENT" ? i() : i(o) : fn(t, l) ? i(new Error(Ci(e, r, n))) : Uc(e, t, s, n, i));
}
function Mc(e, t, r, n) {
...
const Me = $e, Wr = ue, th = lt.mkdirs, rh = tr.pathExists, nh = Lc.utimesMillis, Vr = Sr;
function ih(e, t, r, n) {
  typeof r == "function" && !n ? (n = r, r = {}) : typeof r == "function" && (r = { filter: r }), n = n || function() {
    ...
    Vr.checkParentPaths(e, s, t, "copy", (l) => l ? n(l) : r.filter ? Bc(To, o, e, t, r, n) : To(o, e, t, r, n));
  });
}
...
function fi(e, t, r, n, i) {
  (n.dereference ? Me.stat : Me.lstat)(t, (s, o) => s ? i(s) : o.isDirectory() ? dh(o, e, t, r, n, i) : o.isFile() || o.isCharacterDevice() || o.isBlockDevice() ? sh(o, e, t, r, n, i) : o.isSymbolicLink() ? mh(e, t, r, n, i) : o.isSocket() ? i(new Error(`Cannot copy a socket file: ${t}`)) : o.isFIFO() ? i(new Error(`Cannot copy a FIFO pipe: ${t}`)) : i(new Error(`Unknown file: ${t}`)));
}
function sh(e, t, r, n, i, a) {
  return t ? oh(e, r, n, i, a) : jc(e, r, n, i, a);
}
...
function jc(e, t, r, n, i) {
  Me.copyFile(t, r, (a) => a ? i(a) : n.preserveTimestamps ? lh(e.mode, t, r, i) : Ri(r, e.mode, i));
}
function lh(e, t, r, n) {
  return ch(e) ? uh(r, e, (i) => i ? n(i) : _o(e, t, r, n)) : _o(e, t, r, n);
}
function ch(e) {
  return (e & 128) === 0;
}
...
function dh(e, t, r, n, i, a) {
  return t ? zc(r, n, i, a) : ph(e.mode, r, n, i, a);
}
...
function zc(e, t, r, n) {
  Me.readdir(e, (i, a) => i ? n(i) : Gc(a, e, t, r, n));
}
...
function hh(e, t, r, n, i, a) {
  ...
  Vr.checkPaths(s, o, "copy", i, (l, d) => {
    if (l) return a(l);
    const { destStat: c } = d;
    ah(c, s, o, i, (u) => u ? a(u) : Gc(e, r, n, i, a));
  });
}
function mh(e, t, r, n, i) {
  Me.readlink(t, (a, s) => {
    ...
    if (n.dereference && (s = Wr.resolve(process.cwd(), s)), e)
      Me.readlink(r, (o, l) => o ? o.code === "EINVAL" || o.code === "UNKNOWN" ? Me.symlink(s, r, i) : i(o) : (n.dereference && (l = Wr.resolve(process.cwd(), l)), Vr.isSrcSubdir(s, l) ? i(new Error(`Cannot copy '${s}' to a subdirectory of itself, '${l}'.`)) : e.isDirectory() && Vr.isSrcSubdir(l, s) ? i(new Error(`Cannot overwrite '${l}' with '${s}'.`)) : gh(s, r, i)));
    else
...
var yh = ih;
const Ie = $e, Yr = ue, wh = lt.mkdirsSync, xh = Lc.utimesMillisSync, Kr = Sr;
function Eh(e, t, r) {
  ...
  return Kr.checkParentPathsSync(e, n, t, "copy"), vh(i, e, t, r);
}
function vh(e, t, r, n) {
...
function qc(e, t, r, n) {
  return Ie.copyFileSync(t, r), n.preserveTimestamps && Sh(e.mode, t, r), ws(r, e.mode);
}
function Sh(e, t, r) {
...
function Rh(e, t, r, n, i) {
  return t ? Xc(r, n, i) : Oh(e.mode, r, n, i);
}
function Oh(e, t, r, n) {
  return Ie.mkdirSync(r), Xc(t, r, n), ws(r, e);
}
function Xc(e, t, r) {
...
const bo = $e, Wc = ue, re = Ic, Jr = process.platform === "win32";
function Vc(e) {
  [
    "unlink",
    "chmod",
...
function Es(e, t, r) {
  let n = 0;
  typeof t == "function" && (r = t, t = {}), re(e, "rimraf: missing path"), re.strictEqual(typeof e, "string", "rimraf: path should be a string"), re.strictEqual(typeof r, "function", "rimraf: callback function required"), re(t, "rimraf: invalid options argument provided"), re.strictEqual(typeof t, "object", "rimraf: options should be object"), Vc(t), So(e, t, function i(a) {
    if (a) {
...
function Yc(e, t) {
  let r;
  t = t || {}, Vc(t), re(e, "rimraf: missing path"), re.strictEqual(typeof e, "string", "rimraf: path should be a string"), re(t, "rimraf: missing options"), re.strictEqual(typeof t, "object", "rimraf: options should be object");
  try {
    r = t.lstatSync(e);
  } catch (n) {
    if (n.code === "ENOENT")
...
function Lh(e, t) {
  if (re(e), re(t), t.readdirSync(e).forEach((r) => Yc(Wc.join(e, r), t)), Jr) {
    const r = Date.now();
    do
      try {
...
const zh = Fe.fromPromise, Jc = er, Qc = ue, Zc = lt, eu = Oi, Co = zh(async function(t) {
  let r;
  try {
...
const Vh = Fe.fromCallback, nu = ue, Tt = $e, iu = lt, Yh = tr.pathExists, { areIdentical: au } = Sr;
function Kh(e, t, r) {
  function n(i, a) {
    Tt.link(i, a, (s) => {
      if (s) return r(s);
...
const bt = ue, Gr = $e, Zh = tr.pathExists;
function em(e, t, r) {
  if (bt.isAbsolute(e))
...
const sm = Fe.fromCallback, ou = ue, Ke = er, lu = lt, om = lu.mkdirs, lm = lu.mkdirsSync, cu = rm, cm = cu.symlinkPaths, um = cu.symlinkPathsSync, uu = am, fm = uu.symlinkType, dm = uu.symlinkTypeSync, pm = tr.pathExists, { areIdentical: fu } = Sr;
function hm(e, t, r, n) {
...
function mm(e, t, r) {
  ...
  return Ke.existsSync(a) || lm(a), Ke.symlinkSync(e, t, r);
}
var gm = {
  createSymlink: sm(hm),
  createSymlinkSync: mm
};
const { createFile: Do, createFileSync: Po } = Wh, { createLink: ko, createLinkSync: No } = Qh, { createSymlink: Fo, createSymlinkSync: $o } = gm;
var ym = {
  // file
  createFile: Do,
  createFileSync: Po,
...
var vs = { stringify: wm, stripBom: xm };
let vr;
try {
  vr = $e;
} catch {
...
const Di = Fe, { stringify: du, stripBom: pu } = vs;
...
const Cm = Fe.fromCallback, Hr = $e, hu = ue, mu = lt, Rm = tr.pathExists;
function Om(e, t, r, n) {
...
const { stringify: Pm } = vs, { outputFile: km } = Ts;
async function Nm(e, t, r = {}) {
  const n = Pm(t, r);
  await km(e, n, r);
}
var Fm = Nm;
const { stringify: $m } = vs, { outputFileSync: Lm } = Ts;
function Um(e, t, r) {
  const n = $m(t, r);
  Lm(e, n, r);
}
...
var jm = Ne;
const zm = $e, Ha = ue, Gm = xs.copy, gu = Oi.remove, Hm = lt.mkdirp, qm = tr.pathExists, Lo = Sr;
function Xm(e, t, r, n) {
  ...
  Lo.checkPaths(e, t, "move", r, (a, s) => {
    ...
    Lo.checkParentPaths(e, o, t, "move", (d) => {
      if (d) return n(d);
      if (Wm(t)) return Uo(e, t, i, l, n);
      Hm(Ha.dirname(t), (c) => c ? n(c) : Uo(e, t, i, l, n));
    });
  });
}
function Wm(e) {
...
function Uo(e, t, r, n, i) {
  ...
  if (r)
    return gu(t, (a) => a ? i(a) : fa(e, t, r, i));
  qm(t, (a, s) => a ? i(a) : s ? i(new Error("dest already exists.")) : fa(e, t, r, i));
}
function fa(e, t, r, n) {
  zm.rename(e, t, (i) => i ? i.code !== "EXDEV" ? n(i) : Vm(e, t, r, n) : n());
}
function Vm(e, t, r, n) {
  Gm(e, t, {
    overwrite: r,
...
var Ym = Xm;
const yu = $e, qa = ue, Km = xs.copySync, wu = Oi.removeSync, Jm = lt.mkdirpSync, Mo = Sr;
function Qm(e, t, r) {
  r = r || {};
  const n = r.overwrite || r.clobber || !1, { srcStat: i, isChangingCase: a = !1 } = Mo.checkPathsSync(e, t, "move", r);
  return Mo.checkParentPathsSync(e, i, t, "move"), Zm(t) || Jm(qa.dirname(t)), e0(e, t, n, a);
}
function Zm(e) {
...
function xu() {
  ...
  jo = 1;
  function e(t) {
    n.debug = n, n.default = n, n.coerce = d, n.disable = o, n.enable = a, n.enabled = l, n.humanize = l0(), n.destroy = c, Object.keys(t).forEach((u) => {
      n[u] = t[u];
...
function f0() {
  if (Ho) return ga;
  Ho = 1;
  const e = Ii, t = Rc, r = u0(), { env: n } = process;
  let i;
...
typeof process > "u" || process.type === "renderer" || process.browser === !0 || process.__nwjs ? Wa.exports = c0() : Wa.exports = d0();
var Eu = Wa.exports;
const Ir = /* @__PURE__ */ Cp(Eu);
var dn = {};
...
dn.ProgressCallbackTransform = h0;
...
const m0 = un, g0 = Eu, y0 = Pt, w0 = cn, vu = br, x0 = Ct, Xo = Ar, E0 = dn, Fr = (0, g0.default)("electron-builder");
...
function Tu(e, t) {
  const r = hi(t);
  return bs(new vu.URL(e), r), r;
}
function bs(e, t) {
  t.protocol = e.protocol, t.hostname = e.hostname, e.port ? t.port = e.port : t.port && delete t.port, t.path = e.pathname + e.search;
}
class Ya extends w0.Transform {
...
function b0(e, t) {
  if (!_0(xr(t, "X-Checksum-Sha2"), e.options.sha2, e.callback))
    return;
  const r = [];
  if (e.options.onProgress != null) {
    const s = xr(t, "content-length");
    s != null && r.push(new E0.ProgressCallbackTransform(parseInt(s, 10), e.options.cancellationToken, e.options.onProgress));
  }
...
const Au = un, Iu = Ar, P0 = "options.name must be either a string or a Buffer", Wo = (0, Au.randomBytes)(16);
Wo[0] = Wo[0] | 1;
const li = {}, Q = [];
for (let e = 0; e < 256; e++) {
...
function k0(e, t, r, n, i = qr.ASCII) {
    ...
    function K(h, f) {
      if (h.opt.xmlns) {
        ...
        for (var se = 0, fe = h.attribList.length; se < fe; se++) {
          var ve = h.attribList[se], Se = ve[0], mt = ve[1], he = O(Se, !0), We = he.prefix, ea = he.local, _n = We === "" ? "" : I.ns[We] || "", Or = {
            name: Se,
            value: mt,
            prefix: We,
            local: ea,
...
Ka.prototype.extend = function(t) {
  ...
  return i.implicit = (this.implicit || []).concat(r), i.explicit = (this.explicit || []).concat(n), i.compiledImplicit = Jo(i, "implicit"), i.compiledExplicit = Jo(i, "explicit"), i.compiledTypeMap = K0(i.compiledImplicit, i.compiledExplicit), i;
};
var Pu = Ka, J0 = Le, ku = new J0("tag:yaml.org,2002:str", {
  kind: "scalar",
...
var Vu = new Og("tag:yaml.org,2002:binary", {
  kind: "scalar",
  resolve: Dg,
  construct: Pg,
  predicate: Ng,
...
function Ug(e) {
  ...
  for (r = 0, n = o.length; r < n; r += 1) {
    if (i = o[r], s = !1, Lg.call(i) !== "[object Object]") return !1;
    for (a in i)
      if ($g.call(i, a))
        if (!s) s = !0;
        else return !1;
...
function zg(e) {
  ...
  for (a = new Array(s.length), t = 0, r = s.length; t < r; t += 1) {
    if (n = s[t], jg.call(n) !== "[object Object]" || (i = Object.keys(n), i.length !== 1)) return !1;
    a[t] = [i[0], n[i[0]]];
  }
  return !0;
}
...
}), qt = Qe, Qu = hn, Vg = q0, Yg = Rs, Rt = Object.prototype.hasOwnProperty, gi = 1, Zu = 2, ef = 3, yi = 4, Ea = 1, Kg = 2, Qo = 3, Jg = /[\x00-\x08\x0B\x0C\x0E-\x1F\x7F-\x84\x86-\x9F\uFFFE\uFFFF]|[\uD800-\uDBFF](?![\uDC00-\uDFFF])|(?:[^\uD800-\uDBFF]|^)[\uDC00-\uDFFF]/, Qg = /[\x85\u2028\u2029]/, Zg = /[,\[\]\{\}]/, tf = /^(?:!|!!|![a-z\-]+!)$/i, rf = /^(?:!|[^,\[\]\{\}])(?:%[0-9a-f]{2}|[0-9a-z\-#;\/\?:@&=\+\$,_\.!~\*'\(\)\[\]])*$/i;
function Zo(e) {
...
var tl = {
  ...
  TAG: function(t, r, n) {
    var i, a;
    n.length !== 2 && z(t, "TAG directive accepts exactly two arguments"), i = n[0], a = n[1], tf.test(i) || z(t, "ill-formed tag handle (first argument) of the TAG directive"), Rt.call(t.tagMap, i) && z(t, 'there is a previously declared suffix for "' + i + '" tag handle'), rf.test(a) || z(t, "ill-formed tag prefix (second argument) of the TAG directive");
    try {
...
function St(e, t, r, n) {
  ...
  if (t < r) {
    ...
    else Jg.test(o) && z(e, "the stream contains non-printable characters");
    e.result += o;
  }
}
function rl(e, t, r, n) {
...
function pr(e, t, r, n, i, a, s, o, l) {
  ...
  if (typeof i == "object" && Zo(i) === "[object Object]" && (i = "[object Object]"), i = String(i), t === null && (t = {}), n === "tag:yaml.org,2002:merge")
    ...
    !e.json && !Rt.call(r, i) && Rt.call(t, i) && (e.line = s || e.line, e.lineStart = o || e.lineStart, e.position = l || e.position, z(e, "duplicated mapping key")), nf(t, i, a), delete r[i];
  return t;
}
function Os(e) {
  var t;
  ...
  for (e.kind = "scalar", e.result = "", e.position++, r = n = e.position; (o = e.input.charCodeAt(e.position)) !== 0; ) {
    ...
    if (o === 92) {
      if (St(e, r, e.position, !0), o = e.input.charCodeAt(++e.position), st(o))
        ...
        for (i = s, a = 0; i > 0; i--)
          o = e.input.charCodeAt(++e.position), (s = ey(o)) >= 0 ? a = (a << 4) + s : z(e, "expected hexadecimal character");
...
function cy(e, t) {
  ...
  for (e.kind = "scalar", e.result = ""; u !== 0; )
    if (u = e.input.charCodeAt(++e.position), u === 43 || u === 45)
      Ea === i ? i = u === 43 ? Qo : Kg : z(e, "repeat of a chomping mode identifier");
    else if ((c = ry(u)) >= 0)
...
function fy(e) {
  ...
  if (e.tag !== null && z(e, "duplication of a tag property"), s = e.input.charCodeAt(++e.position), s === 60 ? (r = !0, s = e.input.charCodeAt(++e.position)) : s === 33 ? (n = !0, i = "!!", s = e.input.charCodeAt(++e.position)) : i = "!", t = e.position, r) {
    ...
    for (; s !== 0 && !Be(s); )
      s === 33 && (n ? z(e, "tag suffix cannot contain exclamation marks") : (i = e.input.slice(t - 1, e.position + 1), tf.test(i) || z(e, "named tag handle cannot contain such characters"), n = !0, t = e.position + 1)), s = e.input.charCodeAt(++e.position);
    a = e.input.slice(t, e.position), Zg.test(a) && z(e, "tag suffix cannot contain flow indicator characters");
  }
  a && !rf.test(a) && z(e, "tag name cannot contain such characters: " + a);
  try {
    a = decodeURIComponent(a);
  } catch {
...
function _r(e, t, r, n, i) {
  ...
  if (e.listener !== null && e.listener("open", e), e.tag = null, e.anchor = null, e.kind = null, e.result = null, a = s = o = yi === r || ef === r, n && pe(e, !0, -1) && (d = !0, e.lineIndent > t ? l = 1 : e.lineIndent === t ? l = 0 : e.lineIndent < t && (l = -1)), l === 1)
    for (; fy(e) || dy(e); )
      pe(e, !0, -1) ? (d = !0, o = a, e.lineIndent > t ? l = 1 : e.lineIndent === t ? l = 0 : e.lineIndent < t && (l = -1)) : o = !1;
  if (o && (o = d || i), (l === 1 || yi === r) && (gi === r || Zu === r ? w = t : w = t + 1, T = e.position - e.lineStart, l === 1 ? o && (nl(e, T) || uy(e, T, w)) || ly(e, w) ? c = !0 : (s && cy(e, w) || sy(e, w) || oy(e, w) ? c = !0 : py(e) ? (c = !0, (e.tag !== null || e.anchor !== null) && z(e, "alias node should not have any properties")) : ay(e, w, gi === r) && (c = !0, e.tag === null && (e.tag = "?")), e.anchor !== null && (e.anchorMap[e.anchor] = e.result)) : l === 0 && (c = o && nl(e, T))), e.tag === null)
...
function hy(e) {
  ...
  if (pe(e, !0, -1), e.lineIndent === 0 && e.input.charCodeAt(e.position) === 45 && e.input.charCodeAt(e.position + 1) === 45 && e.input.charCodeAt(e.position + 2) === 45 ? (e.position += 3, pe(e, !0, -1)) : a && z(e, "directives end mark is expected"), _r(e, e.lineIndent - 1, yi, !1, !0), pe(e, !0, -1), e.checkLineBreaks && Qg.test(e.input.slice(t, e.position)) && wi(e, "non-ASCII line breaks are interpreted as content"), e.documents.push(e.result), e.position === e.lineStart && Ni(e)) {
...
Is.loadAll = my;
Is.load = gy;
var cf = {}, Fi = Qe, mn = hn, yy = Rs, uf = Object.prototype.toString, ff = Object.prototype.hasOwnProperty, Ps = 65279, wy = 9, Zr = 10, xy = 13, Ey = 32, vy = 33, Ty = 34, Ja = 35, _y = 37, by = 38, Sy = 39, Ay = 42, df = 44, Iy = 45, xi = 58, Cy = 61, Ry = 62, Oy = 63, Dy = 64, pf = 91, hf = 93, Py = 96, mf = 123, ky = 124, gf = 125, Re = {};
Re[0] = "\\0";
Re[7] = "\\a";
Re[8] = "\\b";
Re[9] = "\\t";
...
var Uy = 1, en = 2;
function My(e) {
  this.schema = e.schema || yy, this.indent = Math.max(1, e.indent || 2), this.noArrayIndent = e.noArrayIndent || !1, this.skipInvalid = e.skipInvalid || !1, this.flowLevel = Fi.isNothing(e.flowLevel) ? -1 : e.flowLevel, this.styleMap = $y(this.schema, e.styles || null), this.sortKeys = e.sortKeys || !1, this.lineWidth = e.lineWidth || 80, this.noRefs = e.noRefs || !1, this.noCompatMode = e.noCompatMode || !1, this.condenseFlow = e.condenseFlow || !1, this.quotingType = e.quotingType === '"' ? en : Uy, this.forceQuotes = e.forceQuotes || !1, this.replacer = typeof e.replacer == "function" ? e.replacer : null, this.implicitTypes = this.schema.compiledImplicit, this.explicitTypes = this.schema.compiledExplicit, this.tag = null, this.result = "", this.duplicates = [], this.usedDuplicates = null;
}
function il(e, t) {
...
function sl(e, t, r) {
  ...
  return (
    ...
    (r ? (
      // c = flow-in
      n
    ) : n && e !== df && e !== pf && e !== hf && e !== mf && e !== gf) && e !== Ja && !(t === xi && !i) || al(t) && !Ei(t) && e === Ja || t === xi && i
  );
}
function jy(e) {
  return tn(e) && e !== Ps && !Ei(e) && e !== Iy && e !== Oy && e !== xi && e !== df && e !== pf && e !== hf && e !== mf && e !== gf && e !== Ja && e !== by && e !== Ay && e !== vy && e !== ky && e !== Cy && e !== Ry && e !== Sy && e !== Ty && e !== _y && e !== Dy && e !== Py;
}
function zy(e) {
  return !Ei(e) && e !== xi;
}
...
var wf = 1, Za = 2, xf = 3, Ef = 4, fr = 5;
function Gy(e, t, r, n, i, a, s, o) {
  var l, d = 0, c = null, u = !1, p = !1, m = n !== -1, E = -1, w = jy(jr(e, 0)) && zy(jr(e, e.length - 1));
  if (t || s)
  ...
  return !u && !p ? w && !s && !i(e) ? wf : a === en ? fr : Za : r > 9 && yf(e) ? fr : s ? a === en ? fr : Za : p ? Ef : xf;
}
function Hy(e, t, r, n, i) {
  e.dump = function() {
    ...
    switch (Gy(
      ...
      case Ef:
        return ">" + ol(t, e.indent) + ll(il(qy(t, s), a));
      case fr:
        return '"' + Xy(t) + '"';
      default:
...
function Xy(e) {
  for (var t = "", r = 0, n, i = 0; i < e.length; r >= 65536 ? i += 2 : i++)
    r = jr(e, i), n = Re[r], !n && tn(r) ? (t += e[i], r >= 65536 && (t += e[i + 1])) : t += n || Ly(r);
  return t;
}
function Wy(e, t, r) {
  var n = "", i = e.tag, a, s, o;
...
function pt(e, t, r, n, i, a, s) {
  ...
  if (c && (u = e.duplicates.indexOf(r), p = u !== -1), (e.tag !== null && e.tag !== "?" || p || e.indent !== 2 && t > 0) && (i = !1), p && e.usedDuplicates[u])
    ...
    if (c && p && !e.usedDuplicates[u] && (e.usedDuplicates[u] = !0), o === "[object Object]")
      ...
      n && e.dump.length !== 0 ? (e.noArrayIndent && !s && t > 0 ? ul(e, t - 1, e.dump, i) : ul(e, t, e.dump, i), p && (e.dump = "&ref_" + u + e.dump)) : (Wy(e, t, e.dump), p && (e.dump = "&ref_" + u + " " + e.dump));
...
var gn = ts.exports;
const sw = Object.freeze({ loose: !0 }), ow = Object.freeze({}), lw = (e) => e ? typeof e != "object" ? sw : e : ow;
var Ns = lw;
const dl = /^[0-9]+$/, _f = (e, t) => {
...
const jn = Ui, { MAX_LENGTH: pl, MAX_SAFE_INTEGER: zn } = Li, { safeRe: Gn, t: Hn } = gn, uw = Ns, { compareIdentifiers: va } = bf;
let fw = class at {
  constructor(t, r) {
...
var Cw = Iw;
const Rw = Ue, Ow = (e, t) => new Rw(e, t).patch;
var Dw = Ow;
const Pw = Cr, kw = (e, t) => {
  const r = Pw(e, t);
...
var Ze = Fw;
const $w = Ze, Lw = (e, t, r) => $w(t, e, r);
var Uw = Lw;
const Mw = Ze, Bw = (e, t) => Mw(e, t, !0);
var jw = Bw;
...
var Fs = zw;
const Gw = Fs, Hw = (e, t) => e.sort((r, n) => Gw(r, n, t));
var qw = Hw;
const Xw = Fs, Ww = (e, t) => e.sort((r, n) => Xw(n, r, t));
var Vw = Ww;
const Yw = Ze, Kw = (e, t, r) => Yw(e, t, r) > 0;
var Mi = Kw;
const Jw = Ze, Qw = (e, t, r) => Jw(e, t, r) < 0;
var $s = Qw;
const Zw = Ze, ex = (e, t, r) => Zw(e, t, r) === 0;
var Sf = ex;
const tx = Ze, rx = (e, t, r) => tx(e, t, r) !== 0;
var Af = rx;
const nx = Ze, ix = (e, t, r) => nx(e, t, r) >= 0;
var Ls = ix;
const ax = Ze, sx = (e, t, r) => ax(e, t, r) <= 0;
var Us = sx;
const ox = Sf, lx = Af, cx = Mi, ux = Ls, fx = $s, dx = Us, px = (e, t, r, n) => {
  switch (t) {
    case "===":
...
var If = px;
const hx = Ue, mx = Cr, { safeRe: qn, t: Xn } = gn, gx = (e, t) => {
  if (e instanceof hx)
    return e;
...
function et() {
  ...
  Ta = t;
  const r = xx, n = new r(), i = Ns, a = Bi(), s = Ui, o = Ue, {
    safeRe: l,
    t: d,
    ...
    return D;
  }, _ = (R, S) => (R = R.replace(l[d.BUILD], ""), s("comp", R, S), R = P(R, S), s("caret", R), R = $(R, S), s("tildes", R), R = ae(R, S), s("xrange", R), R = M(R, S), s("stars", R), R), N = (R) => !R || R.toLowerCase() === "x" || R === "*", $ = (R, S) => R.trim().split(/\s+/).map((D) => B(D, S)).join(" "), B = (R, S) => {
  ...
  }, P = (R, S) => R.trim().split(/\s+/).map((D) => G(D, S)).join(" "), G = (R, S) => {
    s("caret", R, S);
...
var ji = vx;
const Tx = et(), _x = (e, t) => new Tx(e, t).set.map((r) => r.map((n) => n.value).join(" ").trim().split(" "));
var bx = _x;
const Sx = Ue, Ax = et(), Ix = (e, t, r) => {
  ...
  return e.forEach((s) => {
    a.test(s) && (!n || i.compare(s) === -1) && (n = s, i = new Sx(n, r));
  }), n;
};
var Cx = Ix;
const Rx = Ue, Ox = et(), Dx = (e, t, r) => {
  let n = null, i = null, a = null;
  try {
    a = new Ox(t, r);
  } catch {
  ...
  return e.forEach((s) => {
    a.test(s) && (!n || i.compare(s) === 1) && (n = s, i = new Rx(n, r));
  }), n;
};
var Px = Dx;
const ba = Ue, kx = et(), vl = Mi, Nx = (e, t) => {
  e = new kx(e, t);
  let r = new ba("0.0.0");
...
var Ux = Lx;
const Mx = Ue, Cf = Bi(), { ANY: Bx } = Cf, jx = et(), zx = ji, Tl = Mi, _l = $s, Gx = Us, Hx = Ls, qx = (e, t, r, n) => {
  ...
  for (let d = 0; d < t.set.length; ++d) {
    ...
    let u = null, p = null;
    if (c.forEach((m) => {
      m.semver === Bx && (m = new Cf(">=0.0.0")), u = u || m, p = p || m, i(m.semver, u.semver, n) ? u = m : s(m.semver, p.semver, n) && (p = m);
...
var Ms = qx;
const Xx = Ms, Wx = (e, t, r) => Xx(e, t, ">", r);
var Vx = Wx;
const Yx = Ms, Kx = (e, t, r) => Yx(e, t, "<", r);
var Jx = Kx;
const bl = et(), Qx = (e, t, r) => (e = new bl(e, r), t = new bl(t, r), e.intersects(t, r));
var Zx = Qx;
const eE = ji, tE = Ze;
var rE = (e, t, r) => {
  const n = [];
  let i = null, a = null;
  const s = e.sort((c, u) => tE(c, u, r));
  for (const c of s)
...
const Sl = et(), Bs = Bi(), { ANY: Sa } = Bs, Lr = ji, js = Ze, nE = (e, t, r = {}) => {
  if (e === t)
    return !0;
  ...
  return !0;
}, iE = [new Bs(">=0.0.0-0")], Al = [new Bs(">=0.0.0")], aE = (e, t, r) => {
  if (e === t)
    return !0;
...
var sE = nE;
const Aa = gn, Rl = Li, oE = Ue, Ol = bf, lE = Cr, cE = mw, uE = ww, fE = Ew, dE = Tw, pE = Sw, hE = Cw, mE = Dw, gE = Nw, yE = Ze, wE = Uw, xE = jw, EE = Fs, vE = qw, TE = Vw, _E = Mi, bE = $s, SE = Sf, AE = Af, IE = Ls, CE = Us, RE = If, OE = yx, DE = Bi(), PE = et(), kE = ji, NE = bx, FE = Cx, $E = Px, LE = Fx, UE = Ux, ME = Ms, BE = Vx, jE = Jx, zE = Zx, GE = rE, HE = sE;
var Rf = {
  parse: lE,
  valid: cE,
  clean: uE,
...
(function(e, t) {
  ...
  H[Y] = H[R] = H[S] = H[D] = H[A] = H[F] = H[O] = H[q] = H[K] = !0, H[o] = H[l] = H[j] = H[c] = H[U] = H[u] = H[p] = H[m] = H[w] = H[T] = H[_] = H[B] = H[P] = H[G] = H[M] = !1;
  ...
  var md = Array.prototype, gd = Function.prototype, Sn = Object.prototype, ta = f["__core-js_shared__"], Js = gd.toString, rt = Sn.hasOwnProperty, Qs = function() {
    var g = /[^.]+$/.exec(ta && ta.keys && ta.keys.IE_PROTO || "");
    return g ? "Symbol(src)_1." + g : "";
  }(), Zs = Sn.toString, yd = RegExp(
    "^" + Js.call(rt).replace(X, "\\$&").replace(/hasOwnProperty|(function).*?(?=\\\()| for .+?(?=\\\])/g, "$1.*?") + "$"
  ), eo = Z ? f.Buffer : void 0, An = f.Symbol, to = f.Uint8Array, ro = Sn.propertyIsEnumerable, wd = md.splice, Ft = An ? An.toStringTag : void 0, no = Object.getOwnPropertySymbols, xd = eo ? eo.isBuffer : void 0, Ed = pd(Object.keys, Object), ra = nr(f, "DataView"), Dr = nr(f, "Map"), na = nr(f, "Promise"), ia = nr(f, "Set"), aa = nr(f, "WeakMap"), Pr = nr(Object, "create"), vd = Ut(ra), Td = Ut(Dr), _d = Ut(na), bd = Ut(ia), Sd = Ut(aa), io = An ? An.prototype : void 0, sa = io ? io.valueOf : void 0;
  function $t(g) {
  ...
  function Rd(g) {
    var x = this.__data__;
    return Pr ? x[g] !== void 0 : rt.call(x, g);
  }
  function Od(g, x) {
    var C = this.__data__;
    return this.size += this.has(g) ? 0 : 1, C[g] = Pr && x === void 0 ? n : x, this;
  }
  $t.prototype.clear = Ad, $t.prototype.delete = Id, $t.prototype.get = Cd, $t.prototype.has = Rd, $t.prototype.set = Od;
  function ct(g) {
    var x = -1, C = g == null ? 0 : g.length;
    for (this.clear(); ++x < C; ) {
      var L = g[x];
  ...
  function Pd(g) {
    ...
    if (C < 0)
      return !1;
    var L = x.length - 1;
    return C == L ? x.pop() : wd.call(x, C, 1), --this.size, !0;
  }
  function kd(g) {
    var x = this.__data__, C = Cn(x, g);
  ...
  ct.prototype.clear = Dd, ct.prototype.delete = Pd, ct.prototype.get = kd, ct.prototype.has = Nd, ct.prototype.set = Fd;
  function Lt(g) {
    var x = -1, C = g == null ? 0 : g.length;
    for (this.clear(); ++x < C; ) {
      var L = g[x];
  ...
  In.prototype.add = In.prototype.push = jd, In.prototype.has = zd;
  function gt(g) {
  ...
  gt.prototype.clear = Gd, gt.prototype.delete = Hd, gt.prototype.get = qd, gt.prototype.has = Xd, gt.prototype.set = Wd;
  function Vd(g, x) {
    var C = On(g), L = !C && cp(g), oe = !C && !L && oa(g), V = !C && !L && !oe && ho(g), de = C || L || oe || V, ye = de ? We(g.length, String) : [], Te = ye.length;
    for (var le in g)
  ...
  function kr(g) {
    return g == null ? g === void 0 ? y : b : Ft && Ft in Object(g) ? rp(g) : lp(g);
  }
  function ao(g) {
    return Nr(g) && kr(g) == o;
  }
  function so(g, x, C, L, oe) {
    return g === x ? !0 : g == null || x == null || !Nr(g) && !Nr(x) ? g !== g && x !== x : Kd(g, x, C, L, so, oe);
  }
  function Kd(g, x, C, L, oe, V) {
    ...
    if (Ae && !je)
      return V || (V = new gt()), de || ho(g) ? oo(g, x, C, L, oe, V) : ep(g, x, Te, C, L, oe, V);
    if (!(C & i)) {
      var He = je && rt.call(g, "__wrapped__"), qe = Ve && rt.call(x, "__wrapped__");
      if (He || qe) {
        var wt = He ? g.value() : g, ut = qe ? x.value() : x;
        return V || (V = new gt()), oe(wt, ut, C, L, V);
      }
    }
    return Ae ? (V || (V = new gt()), tp(g, x, C, L, oe, V)) : !1;
  }
  function Jd(g) {
    if (!po(g) || sp(g))
      return !1;
  ...
  function oo(g, x, C, L, oe, V) {
    ...
    return V.delete(g), V.delete(x), Ve;
  }
  function ep(g, x, C, L, oe, V, de) {
    switch (C) {
      case U:
  ...
  function tp(g, x, C, L, oe, V) {
    ...
    if (qe && !wt) {
      var Dn = g.constructor, Pn = x.constructor;
      Dn != Pn && "constructor" in g && "constructor" in x && !(typeof Dn == "function" && Dn instanceof Dn && typeof Pn == "function" && Pn instanceof Pn) && (qe = !1);
    }
  ...
  function Rn(g, x) {
    var C = g.__data__;
    return ap(x) ? C[typeof x == "string" ? "string" : "hash"] : C.map;
  }
  function nr(g, x) {
    var C = Or(g, x);
  ...
  var np = no ? function(g) {
    return g == null ? [] : (g = Object(g), Se(no(g), function(x) {
      return ro.call(g, x);
    }));
  } : pp, yt = kr;
  (ra && yt(new ra(new ArrayBuffer(1))) != U || Dr && yt(new Dr()) != w || na && yt(na.resolve()) != N || ia && yt(new ia()) != P || aa && yt(new aa()) != M) && (yt = function(g) {
    var x = kr(g), C = x == _ ? g.constructor : void 0, L = C ? Ut(C) : "";
    if (L)
      switch (L) {
        case vd:
          return U;
...
yn.createTempUpdateFile = KE;
const XE = un, WE = Pt, Dl = qE, Gt = kt, Xr = ue;
class VE {
  constructor(t) {
...
yn.DownloadedUpdateHelper = VE;
function YE(e, t = "sha512", r = "base64", n) {
  return new Promise((i, a) => {
    const s = (0, XE.createHash)(t);
    s.on("error", a).setEncoding(r), (0, WE.createReadStream)(e, {
      ...n,
...
var wn = {}, Xe = {}, tv = "[object Symbol]", Df = /[\\^$.*+?()[\]{}|]/g, rv = RegExp(Df.source), nv = typeof Pe == "object" && Pe && Pe.Object === Object && Pe, iv = typeof self == "object" && self && self.Object === Object && self, av = nv || iv || Function("return this")(), sv = Object.prototype, ov = sv.toString, kl = av.Symbol, Nl = kl ? kl.prototype : void 0, Fl = Nl ? Nl.toString : void 0;
function lv(e) {
  if (typeof e == "string")
    return e;
  if (uv(e))
...
function uv(e) {
  return typeof e == "symbol" || cv(e) && ov.call(e) == tv;
}
function fv(e) {
  return e == null ? "" : lv(e);
}
function dv(e) {
  return e = fv(e), e && rv.test(e) ? e.replace(Df, "\\$&") : e;
}
var pv = dv;
Object.defineProperty(Xe, "__esModule", { value: !0 });
Xe.newBaseUrl = mv;
Xe.newUrlFromBase = rs;
...
function yv(e, t, r) {
  ...
  return [rs(`${e.pathname.replace(new RegExp(hv(r), "g"), t)}.blockmap`, e), n];
}
var me = {};
...
const Ll = Ee, Ca = Xe, Ra = me;
class _v extends Ra.Provider {
  constructor(t, r, n) {
...
wn.GenericProvider = _v;
var Gi = {}, Hi = {};
Object.defineProperty(Hi, "__esModule", { value: !0 });
Hi.BitbucketProvider = void 0;
const Ul = Ee, Oa = Xe, Da = me;
...
Hi.BitbucketProvider = bv;
var Dt = {};
Object.defineProperty(Dt, "__esModule", { value: !0 });
Dt.GitHubProvider = Dt.BaseGitHubProvider = void 0;
Dt.computeReleaseNotes = Ff;
const ft = Ee, hr = Rf, Sv = br, mr = Xe, ns = me, Pa = /\/tag\/([^/]+)$/;
class Nf extends ns.Provider {
  constructor(t, r, n) {
    super({
      ...n,
  ...
  async getLatestVersion() {
    ...
    try {
      if (this.updater.allowPrerelease) {
        ...
        if (T === null)
          c = Pa.exec(d.element("link").attribute("href"))[1];
        else
          for (const b of l.getElements("entry")) {
            const _ = Pa.exec(b.element("link").attribute("href"));
            if (_ === null)
              continue;
            const N = _[1], $ = ((n = hr.prerelease(N)) === null || n === void 0 ? void 0 : n[0]) || null, B = !T || ["alpha", "beta"].includes(T), P = $ !== null && !["alpha", "beta"].includes(String($));
            if (B && !P && !(T === "beta" && $ === "alpha")) {
              c = N;
              break;
            }
        ...
        for (const T of l.getElements("entry"))
          if (Pa.exec(T.element("link").attribute("href"))[1] === c) {
            d = T;
            break;
          }
      }
...
${o}`, "ERR_UPDATER_INVALID_RELEASE_FEED");
  ...
  async getLatestTagName(t) {
    const r = this.options, n = r.host == null || r.host === "github.com" ? (0, mr.newUrlFromBase)(`${this.basePath}/latest`, this.baseUrl) : new Sv.URL(`${this.computeGithubBasePath(`/repos/${r.owner}/${r.repo}/releases`)}/latest`, this.baseApiUrl);
    try {
...
const sr = Ee, Cv = be, Rv = ue, jl = br, zl = Xe, Ov = Dt, Dv = me;
class Pv extends Ov.BaseGitHubProvider {
  constructor(t, r, n, i) {
  ...
  async getLatestVersion() {
    ...
    let s;
    try {
      s = (0, Cv.load)(await this.httpRequest(a, this.configureHeaders("application/octet-stream"), t));
    } catch (o) {
...
Gi.createClient = Lv;
const Wn = Ee, kv = Hi, Gl = wn, Nv = Dt, Fv = qi, $v = Xi;
function $f(e) {
...
function Uv(e, t, r) {
  ...
  const c = i.get(l);
  let u = 0;
  const { checksumToOffset: p, checksumToOldSize: m } = Bv(n.get(l), d.offset, r);
  let E = s.offset;
...
Rr.copyData = Lf;
const Vn = Ee, jv = Pt, zv = cn, Gv = rr, Xl = Buffer.from(`\r
\r
`);
var vt;
(function(e) {
...
Vi.executeTasksUsingMultipleRangeRequests = qv;
...
Yi.ProgressDifferentialDownloadCallbackTransform = Vv;
Object.defineProperty(xn, "__esModule", { value: !0 });
xn.DifferentialDownloader = void 0;
const Ur = Ee, Fa = kt, Yv = Pt, Kv = Rr, Jv = br, Yn = rr, Yl = Vi, Qv = Yi;
class Zv {
    ...
    await new Promise((s, o) => {
      ...
      T.redirect = "manual", m = (b) => {
        ...
        if ($.kind === Yn.OperationKind.COPY) {
          d && d.beginFileCopy(), (0, Kv.copyData)($, p, n, o, () => m(b));
          return;
        }
        ...
        P.on("redirect", (G, ae, y) => {
          this.logger.info(`Redirect to ${eT(y)}`), w = y, (0, Ur.configureRequestUrl)(new Jv.URL(w), T), P.followRedirect();
...
Wi.GenericDifferentialDownloader = rT;
var Nt = {};
(function(e) {
...
const Oe = Ee, nT = un, iT = Ii, aT = Cc, or = kt, sT = be, $a = $i, Bt = ue, Ht = Rf, Jl = yn, oT = zi, Ql = Of, lT = wn, La = Gi, cT = Oc, uT = Xe, fT = Wi, lr = Nt;
class Gs extends aT.EventEmitter {
  /**
  ...
  constructor(t, r) {
    ...
    }), r == null ? (this.app = new oT.ElectronAppAdapter(), this.httpExecutor = new Ql.ElectronHttpExecutor((a, s) => this.emit("login", a, s))) : (this.app = r, this.httpExecutor = null);
  ...
  async loadUpdateConfig() {
    return this._appUpdateConfigPath == null && (this._appUpdateConfigPath = this.app.appUpdateConfigPath), (0, sT.load)(await (0, or.readFile)(this._appUpdateConfigPath, "utf-8"));
  }
  ...
  async getOrCreateStagingUserId() {
    ...
    const r = Oe.UUID.v5((0, nT.randomBytes)(4096), Oe.UUID.OID);
  ...
  async differentialDownloadInstaller(t, r, n, i, a) {
    try {
      if (this._testOnlyOptions != null && !this._testOnlyOptions.isUseDifferentialDownload)
        return !0;
      const s = (0, uT.blockmapFiles)(t.url, this.app.version, r.updateInfoAndProvider.info.version);
...
En.FileWithEmbeddedBlockMapDifferentialDownloader = yT;
function Mf(e) {
...
const ec = Ee, tc = Ai, xT = kt, ET = Pt, Mr = ue, vT = ht, TT = En, _T = me, rc = Nt;
class bT extends vT.BaseUpdater {
  ...
  async downloadDifferential(t, r, n, i, a) {
    try {
      ...
      return this.listenerCount(rc.DOWNLOAD_PROGRESS) > 0 && (s.onProgress = (o) => this.emit(rc.DOWNLOAD_PROGRESS, o)), await new TT.FileWithEmbeddedBlockMapDifferentialDownloader(t.info, this.httpExecutor, s).download(), !1;
    } catch (s) {
...
class OT extends CT.BaseUpdater {
  constructor(t, r) {
    super(t, r);
  }
  /*** @private */
...
const DT = ht, ac = Nt, PT = me;
class kT extends DT.BaseUpdater {
  constructor(t, r) {
    super(t, r);
  }
  /*** @private */
...
const sc = Ee, Ua = kt, NT = Pt, oc = ue, FT = Tp, $T = It, LT = me, lc = Ai, cc = un;
class UT extends $T.AppUpdater {
  ...
  async updateDownloaded(t, r) {
    ...
    this.closeServerIfExists(), this.debug(`Creating proxy server for native Squirrel.Mac (${o})`), this.server = (0, FT.createServer)(), this.debug(`Proxy server for native Squirrel.Mac is created (${o})`), this.server.on("close", () => {
    ...
    return await new Promise((d, c) => {
      ...
      this.server.on("request", (E, w) => {
        ...
        if (s.info(`${T} requested`), T === "/") {
          ...
          const N = E.headers.authorization.split(" ")[1], $ = Buffer.from(N, "base64").toString("ascii"), [B, P] = $.split(":");
...
Hs.verifySignature = BT;
const uc = Ee, Bf = Ai, MT = Ii, fc = ue;
function BT(e, t, r) {
  return new Promise((n, i) => {
    const a = t.replace(/'/g, "''");
...
const Kn = Ee, dc = ue, GT = ht, HT = En, pc = Nt, qT = me, XT = kt, WT = Hs, hc = br;
class VT extends GT.BaseUpdater {
  constructor(t, r) {
  ...
  async differentialDownloadWebPackage(t, r, n, i) {
    ...
    try {
      ...
      this.listenerCount(pc.DOWNLOAD_PROGRESS) > 0 && (a.onProgress = (s) => this.emit(pc.DOWNLOAD_PROGRESS, s)), await new HT.FileWithEmbeddedBlockMapDifferentialDownloader(r, this.httpExecutor, a).download();
    } catch (a) {
...
const nt = Ir("tokenizer:inflate"), Ba = 256 * 1024, N_ = Wf(yr.DataDescriptor), Jn = Wf(yr.EndOfCentralDirectory);
class Xs {
  constructor(t) {
  ...
  async readCentralDirectory() {
    ...
    if (r > 0) {
      ...
      for (let a = 0; a < n.nrOfEntriesOfSize; ++a) {
        const s = await this.tokenizer.readToken(k_);
  ...
  async unzip(t) {
    ...
    do {
      ...
      if (await this.tokenizer.ignore(i.extraFieldLength), i.dataDescriptor && i.compressedSize === 0) {
        ...
        nt(`Found data-descriptor-signature at pos=${this.tokenizer.position}`), a.handler && await this.inflate(i, $_(o), a.handler);
      } else
 ...
 * MIT Licensed
 */
var ab = /^ *([A-Za-z0-9][A-Za-z0-9!#$&^_-]{0,126})\/([A-Za-z0-9][A-Za-z0-9!#$&^_.+-]{0,126}) *$/, sb = ob;
function ob(e) {
  if (!e)
    throw new TypeError("argument string is required");
  if (typeof e != "string")
...
class ub extends vn("UnexpectedFileContentError") {
  constructor(t, r) {
...
const jt = Ir("music-metadata:collector"), Hb = ["matroska", "APEv2", "vorbis", "ID3v2.4", "ID3v2.3", "ID3v2.2", "exif", "asf", "iTunes", "AIFF", "ID3v1"];
class qb {
  constructor(t) {
    this.format = {
      tagTypes: [],
...
const Wb = {
  ...
  async load() {
    return (await import("./MpegParser-DTlTeMS5.js")).MpegParser;
  }
}, Vb = {
  parserType: "apev2",
  extensions: [".ape"],
  ...
  async load() {
    return (await import("./AsfParser-dENjkmT0.js")).AsfParser;
  }
}, Kb = {
  parserType: "dsdiff",
  extensions: [".dff"],
  ...
  async load() {
    return (await import("./DsdiffParser-DfFl_oDV.js")).DsdiffParser;
  }
}, Jb = {
  parserType: "aiff",
  ...
  async load() {
    return (await import("./AiffParser-U-pAapir.js")).AIFFParser;
  }
}, Qb = {
  parserType: "dsf",
  extensions: [".dsf"],
  mimeTypes: ["audio/dsf"],
  async load() {
    return (await import("./DsfParser-DO_P8IiV.js")).DsfParser;
  }
}, Zb = {
  parserType: "flac",
  extensions: [".flac"],
  ...
  async load() {
    return (await import("./FlacParser-Dd2B3v1O.js").then((e) => e.d)).FlacParser;
  }
}, eS = {
  parserType: "matroska",
  ...
  async load() {
    return (await import("./MatroskaParser-CCjEfgt6.js")).MatroskaParser;
  }
}, tS = {
  parserType: "mp4",
  ...
  async load() {
    return (await import("./MP4Parser-Cp35LLF5.js")).MP4Parser;
  }
}, rS = {
  parserType: "musepack",
  extensions: [".mpc"],
  ...
  async load() {
    return (await import("./MusepackParser-jWB9j3B6.js")).MusepackParser;
  }
}, nS = {
  parserType: "ogg",
  ...
  async load() {
    return (await import("./OggParser-1GfB4tHt.js")).OggParser;
  }
}, iS = {
  parserType: "wavpack",
  extensions: [".wv", ".wvp"],
  ...
  async load() {
    return (await import("./WavPackParser-qoOvbdKP.js")).WavPackParser;
  }
}, aS = {
  parserType: "riff",
  ...
  async load() {
    return (await import("./WaveParser-DKg0VhDV.js")).WaveParser;
  }
}, zt = Ir("music-metadata:parser:factory");
function sS(e) {
  const t = Ws.parse(e), r = sb(t.type);
  return {
    type: r.type,
    subtype: r.subtype,
    suffix: r.suffix,
...
class oS {
  ...
  async parse(t, r, n) {
    if (t.supportsRandomAccess() ? (zt("tokenizer supports random-access, scanning for appending headers"), await RS(t, n)) : zt("tokenizer does not support random-access, cannot scan for appending headers"), !r) {
    ...
    const i = new qb(n), a = await r.load(), s = new a(i, t, n ?? {});
...
const TS = /^[\x21-\x7e©][\x20-\x7e\x00()]{3}/, sd = {
  len: 4,
  get: (e, t) => {
    const r = Zi(e.subarray(t, t + sd.len), "latin1");
    if (!r.match(TS))
      throw new Vs(`FourCC contains invalid characters: ${hb(r)} "${r}"`);
    return r;
  },
  put: (e, t, r) => {
    const n = fS(r, "latin1");
...
let Si = cd("ffmpeg-static");
Je.isPackaged && (Si = Si.replace("app.asar", "app.asar.unpacked"));
function PS(e) {
...
const kS = Je.requestSingleInstanceLock();
kS ? Je.on("second-instance", () => {
  ee && (ee.isMinimized() && ee.restore(), ee.focus());
}) : Je.quit();
const ud = De.dirname(wp(import.meta.url));
process.env.APP_ROOT = De.join(ud, "..");
const ds = process.env.VITE_DEV_SERVER_URL, yA = De.join(process.env.APP_ROOT, "dist-electron"), fd = De.join(process.env.APP_ROOT, "dist");
process.env.VITE_PUBLIC = ds ? De.join(process.env.APP_ROOT, "public") : fd;
let ee;
function dd() {
  ee = new Ac({
    width: 1200,
    ...
    webPreferences: {
      preload: De.join(ud, "preload.mjs"),
      webSecurity: !1,
  ...
  }), ds ? ee.loadURL(ds) : ee.loadFile(De.join(fd, "index.html"));
}
...
Je.whenReady().then(() => {
  process.platform === "win32" && Je.setAppUserModelId("NeonWave"), dd();
  const e = new DS();
  ne.handle("discord:login", async (i, a) => await e.login(a)), ne.handle("discord:getGuilds", () => e.getGuilds()), ne.handle("discord:getChannels", (i, a) => e.getChannels(a)), ne.handle("discord:join", async (i, a, s) => await e.joinChannel(a, s)), ne.handle("discord:leave", async () => await e.leaveChannel()), ne.handle("discord:disconnect", async () => await e.disconnect()), ne.handle("discord:play", async (i, a) => await e.playFile(a, Si)), ne.handle("discord:stop", () => e.stop()), ne.handle("discord:pause", () => e.pause()), ne.handle("discord:resume", () => e.resume()), ne.handle("discord:setVolume", (i, a) => e.setVolume(a)), ne.handle("discord:status", () => e.getStatus()), ne.handle("discord:startStreamMode", async () => await e.playReceiverStream(Si)), ne.on("discord:audio-chunk", (i, a) => {
    ...
    try {
      ...
      return (await Promise.all(s.map(async (d) => {
        const c = De.join(a, d), u = De.extname(d).toLowerCase();
    ...
    const i = De.join(process.env.APP_ROOT, "scripts/get-active-window.ps1");
    return await PS(i);
  });
  const t = ii(import.meta.url)("yt-dlp-wrap").default;
  let r = !1;
  const n = async () => {
    const i = process.platform === "win32" ? "yt-dlp.exe" : "yt-dlp", a = De.join(Je.getPath("userData"), i);
    try {
      await kn.access(a);
    } catch {
    ...
    try {
      ...
      const c = (B) => {
        ...
        try {
          ...
          if (P && (M = M.filter((S) => S.diff <= 5), M.sort((S, D) => S.diff - D.diff)), M.length === 0) return [];
        ...
        if (!B) return null;
        try {
          return cd("opencc-js").Converter({ from: "cn", to: "tw" })(B);
        } catch {
          return B;
        }
      };
      ...
      if (o) {
        let B = De.basename(o, De.extname(o));
        const P = B.match(/(.+?)《(.+?)》(.*)/);
        if (P) {
