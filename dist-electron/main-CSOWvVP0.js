...
import aa, { open as mp } from "node:fs/promises";
import Dt from "fs";
...
var xt = gp, vp = process.cwd, ri = null, Tp = process.env.GRACEFUL_FS_PLATFORM || process.platform;
...
var oe = Dt, Op = _p, Dp = Sp, Pp = Ip, Pn = us, ve, oi;
...
function fs(e) {
  Op(e), e.gracefulify = fs, e.createReadStream = Q, e.createWriteStream = ne;
  var t = e.readFile;
  e.readFile = r;
  function r(y, q, j) {
  ...
  function i(y, q, j, B) {
    ...
    function Z(R, I, P, A, F) {
      return n(R, I, P, function(O) {
        O && (O.code === "EMFILE" || O.code === "ENFILE") ? nr([Z, [R, I, P, A], O, F || Date.now(), Date.now()]) : typeof A == "function" && A.apply(this, arguments);
      });
    }
  }
  var a = e.appendFile;
  ...
  var w = e.WriteStream;
  w && (N.prototype = Object.create(w.prototype), N.prototype.open = D), Object.defineProperty(e, "ReadStream", {
    get: function() {
      return _;
    },
    set: function(y) {
...
function ds() {
  if (clearTimeout(kn), kn = void 0, oe[ve].length !== 0) {
    ...
    if (i === void 0)
      ...
      o >= d ? (Wt("RETRY", t.name, r), t.apply(null, r.concat([i]))) : oe[ve].push(e);
    }
...
const $p = ke.fromPromise, { makeDir: Lp, makeDirSync: sa } = ps, oa = $p(Lp);
var ot = {
  mkdirs: oa,
  mkdirsSync: sa,
  // alias
...
const Le = Ne, Xr = le, Wp = ot.mkdirs, Vp = er.pathExists, Yp = kc.utimesMillis, Wr = br;
function Kp(e, t, r, n) {
...
function oh(e, t, r, n, i) {
  Le.readlink(t, (a, s) => {
    ...
    if (n.dereference && (s = Xr.resolve(process.cwd(), s)), e)
      Le.readlink(r, (o, l) => o ? o.code === "EINVAL" || o.code === "UNKNOWN" ? Le.symlink(s, r, i) : i(o) : (n.dereference && (l = Xr.resolve(process.cwd(), l)), Wr.isSrcSubdir(s, l) ? i(new Error(`Cannot copy '${s}' to a subdirectory of itself, '${l}'.`)) : e.isDirectory() && Wr.isSrcSubdir(l, s) ? i(new Error(`Cannot overwrite '${l}' with '${s}'.`)) : lh(s, r, i)));
    else
...
var ch = Kp;
const Se = Ne, Vr = le, uh = ot.mkdirsSync, fh = kc.utimesMillisSync, Yr = br;
function dh(e, t, r) {
...
function ph(e, t, r, n) {
  ...
  return Se.existsSync(i) || uh(i), Bc(e, t, r, n);
}
function hh(e, t, r, n) {
...
function jc(e, t, r, n) {
  return Se.copyFileSync(t, r), n.preserveTimestamps && yh(e.mode, t, r), ms(r, e.mode);
}
function yh(e, t, r) {
...
function zc(e, t, r) {
  Se.readdirSync(e).forEach((n) => _h(n, e, t, r));
}
function _h(e, t, r, n) {
...
const wo = Ne, Gc = le, te = _c, Kr = process.platform === "win32";
function Hc(e) {
  [
    "unlink",
    "chmod",
...
const Nh = ke.fromPromise, Wc = Zt, Vc = le, Yc = ot, Kc = Ai, _o = Nh(async function(t) {
  let r;
  try {
...
const $h = ke.fromCallback, Jc = le, Tt = Ne, Qc = ot;
function Lh(e, t) {
  function r() {
    Tt.writeFile(e, "", (n) => {
      if (n) return t(n);
...
const Bh = ke.fromCallback, Zc = le, vt = Ne, eu = ot, jh = er.pathExists, { areIdentical: tu } = br;
function zh(e, t, r) {
  function n(i, a) {
    vt.link(i, a, (s) => {
      if (s) return r(s);
...
const _t = le, zr = Ne, qh = er.pathExists;
function Xh(e, t, r) {
  if (_t.isAbsolute(e))
...
const Qh = ke.fromCallback, nu = le, Ye = Zt, iu = ot, Zh = iu.mkdirs, em = iu.mkdirsSync, au = Vh, tm = au.symlinkPaths, rm = au.symlinkPathsSync, su = Jh, nm = su.symlinkType, im = su.symlinkTypeSync, am = er.pathExists, { areIdentical: ou } = br;
function sm(e, t, r, n) {
...
const Em = ke.fromCallback, Gr = Ne, uu = le, fu = ot, vm = er.pathExists;
function Tm(e, t, r, n) {
...
var km = Pe;
const Nm = Ne, ja = le, Fm = gs.copy, du = Ai.remove, $m = ot.mkdirp, Lm = er.pathExists, Po = br;
function Um(e, t, r, n) {
...
var jm = Um;
const pu = Ne, za = le, zm = gs.copySync, hu = Ai.removeSync, Gm = ot.mkdirpSync, No = br;
function Hm(e, t, r) {
  r = r || {};
  ...
  function e(t) {
    ...
    function n(u) {
      ...
      function T(..._) {
        if (!T.enabled)
          return;
        const b = T, N = Number(/* @__PURE__ */ new Date()), D = N - (p || N);
        b.diff = D, b.prev = p, b.curr = N, p = N, _[0] = n.coerce(_[0]), typeof _[0] != "string" && _.unshift("%O");
        let Q = 0;
...
Actual: ` + h.attribValue
    ...
    function X(h, f) {
      if (h.opt.xmlns) {
        ...
        for (var ie = 0, ce = h.attribList.length; ie < ce; ie++) {
          var we = h.attribList[ie], _e = we[0], ht = we[1], de = O(_e, !0), We = de.prefix, Ki = de.local, Tn = We === "" ? "" : S.ns[We] || "", Rr = {
            name: _e,
            value: ht,
            prefix: We,
            local: Ki,
    ...
    function he(h, f) {
      f === "<" ? (h.state = y.OPEN_WAKA, h.startTagPosition = h.position) : D(f) || (A(h, "Non-whitespace before first tag."), h.textNode = f, h.state = y.TEXT);
    }
    function U(h, f) {
      var S = "";
...
` ? (f.line++, f.column = 0) : f.column++);
            ...
            v === "<" && !(f.sawRoot && f.closedRoot && !f.strict) ? (f.state = y.OPEN_WAKA, f.startTagPosition = f.position) : (!D(v) && (!f.sawRoot || f.closedRoot) && A(f, "Text data outside of root node."), v === "&" ? f.state = y.TEXT_ENTITY : f.textNode += v);
            continue;
          case y.SCRIPT:
...
` ? (f.line++, f.column = 0) : f.column++);
          ...
          case y.PROC_INST_ENDING:
            ...
            continue;
          case y.OPEN_TAG:
            Y(_, v) ? f.tagName += v : (F(f), v === ">" ? X(f) : v === "/" ? f.state = y.OPEN_TAG_SLASH : (D(v) || A(f, "Invalid character in tag name"), f.state = y.ATTRIB));
            continue;
          ...
          case y.ATTRIB:
            ...
            continue;
          case y.ATTRIB_NAME:
            v === "=" ? f.state = y.ATTRIB_VALUE : v === ">" ? (A(f, "Attribute without value"), f.attribValue = f.attribName, M(f), X(f)) : D(v) ? f.state = y.ATTRIB_NAME_SAW_WHITE : Y(_, v) ? f.attribName += v : A(f, "Invalid attribute name");
            continue;
          ...
          case y.ATTRIB_VALUE_CLOSED:
            D(v) ? f.state = y.ATTRIB : v === ">" ? X(f) : v === "/" ? f.state = y.OPEN_TAG_SLASH : Y(T, v) ? (A(f, "No whitespace between attributes"), f.attribName = v, f.attribValue = "", f.state = y.ATTRIB_NAME) : A(f, "Invalid attribute name");
            continue;
          ...
          case y.CLOSE_TAG:
            if (f.tagName)
              v === ">" ? z(f) : Y(_, v) ? f.tagName += v : f.script ? (f.script += "</" + f.tagName, f.tagName = "", f.state = y.SCRIPT) : (D(v) || A(f, "Invalid tagname in closing tag"), f.state = y.CLOSE_TAG_SAW_WHITE);
            else {
              if (D(v))
                continue;
          ...
          case y.ATTRIB_VALUE_ENTITY_U:
            ...
            } else Y(f.entity.length ? N : b, v) ? f.entity += v : (A(f, "Invalid character in entity name"), f[we] += "&" + f.entity + v, f.entity = "", f.state = ce);
            continue;
          default:
...
var Gu = new Eg("tag:yaml.org,2002:merge", {
  kind: "scalar",
  resolve: vg
}), Tg = Fe, Ss = `ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789+/=
\r`;
function _g(e) {
  if (e === null) return !1;
...
}), Ht = Je, Vu = pn, Bg = L0, jg = As, Ct = Object.prototype.hasOwnProperty, pi = 1, Yu = 2, Ku = 3, hi = 4, ya = 1, zg = 2, Wo = 3, Gg = /[\x00-\x08\x0B\x0C\x0E-\x1F\x7F-\x84\x86-\x9F\uFFFE\uFFFF]|[\uD800-\uDBFF](?![\uDC00-\uDFFF])|(?:[^\uD800-\uDBFF]|^)[\uDC00-\uDFFF]/, Hg = /[\x85\u2028\u2029]/, qg = /[,\[\]\{\}]/, Ju = /^(?:!|!!|![a-z\-]+!)$/i, Qu = /^(?:!|[^,\[\]\{\}])(?:%[0-9a-f]{2}|[0-9a-z\-#;\/\?:@&=\+\$,_\.!~\*'\(\)\[\]])*$/i;
function Vo(e) {
...
function ry(e, t, r) {
  ...
  for (e.anchor !== null && (e.anchorMap[e.anchor] = u), b = e.input.charCodeAt(e.position); b !== 0; ) {
    if (!T && e.firstTabInLine !== -1 && (e.position = e.firstTabInLine, L(e, "tab characters must not be used in indentation")), n = e.input.charCodeAt(e.position + 1), a = e.line, (b === 63 || b === 58) && Ue(n))
      b === 63 ? (T && (dr(e, u, p, g, w, null, s, o, l), g = w = x = null), _ = !0, T = !0, i = !0) : T ? (T = !1, i = !0) : L(e, "incomplete explicit mapping pair; a key node is missed; or followed by a non-tabulated empty line"), e.position += 1, b = n;
    else {
      ...
      if (e.line === a) {
        ...
        if (b === 58)
          b = e.input.charCodeAt(++e.position), Ue(b) || L(e, "a whitespace character is expected after the key-value separator within a block mapping"), T && (dr(e, u, p, g, w, null, s, o, l), g = w = x = null), _ = !0, T = !1, i = !1, g = e.tag, w = e.result;
        else if (_)
    ...
    if ((e.line === a || e.lineIndent > t) && (T && (s = e.line, o = e.lineStart, l = e.position), Tr(e, t, hi, !0, i) && (T ? w = e.result : x = e.result), T || (dr(e, u, p, g, w, x, s, o, l), g = w = x = null), fe(e, !0, -1), b = e.input.charCodeAt(e.position)), (e.line === a || e.lineIndent > t) && b !== 0)
      L(e, "bad indentation of a mapping entry");
    else if (e.lineIndent < t)
      break;
  }
  return T && dr(e, u, p, g, w, null, s, o, l), _ && (e.tag = d, e.anchor = c, e.kind = "mapping", e.result = u), _;
}
function ny(e) {
  var t, r = !1, n = !1, i, a, s;
...
function Tr(e, t, r, n, i) {
  ...
  if (o && (o = d || i), (l === 1 || hi === r) && (pi === r || Yu === r ? x = t : x = t + 1, T = e.position - e.lineStart, l === 1 ? o && (Qo(e, T) || ry(e, T, x)) || ey(e, x) ? c = !0 : (s && ty(e, x) || Qg(e, x) || Zg(e, x) ? c = !0 : ay(e) ? (c = !0, (e.tag !== null || e.anchor !== null) && L(e, "alias node should not have any properties")) : Jg(e, x, pi === r) && (c = !0, e.tag === null && (e.tag = "?")), e.anchor !== null && (e.anchorMap[e.anchor] = e.result)) : l === 0 && (c = o && Qo(e, T))), e.tag === null)
...
bs.loadAll = oy;
bs.load = ly;
var af = {}, Di = Je, hn = pn, cy = As, sf = Object.prototype.toString, of = Object.prototype.hasOwnProperty, Rs = 65279, uy = 9, Qr = 10, fy = 13, dy = 32, py = 33, hy = 34, Va = 35, my = 37, gy = 38, yy = 39, xy = 42, lf = 44, wy = 45, gi = 58, Ey = 61, vy = 62, Ty = 63, _y = 64, cf = 91, uf = 93, by = 96, ff = 123, Sy = 124, df = 125, Ie = {};
Ie[0] = "\\0";
Ie[7] = "\\a";
Ie[8] = "\\b";
Ie[9] = "\\t";
...
function ky(e) {
  return en(e) && e !== Rs && !yi(e) && e !== wy && e !== Ty && e !== gi && e !== lf && e !== cf && e !== uf && e !== ff && e !== df && e !== Va && e !== gy && e !== xy && e !== py && e !== Sy && e !== Ey && e !== vy && e !== yy && e !== hy && e !== my && e !== _y && e !== by;
}
function Ny(e) {
  return !yi(e) && e !== gi;
}
...
function Fy(e, t, r, n, i, a, s, o) {
  var l, d = 0, c = null, u = !1, p = !1, g = n !== -1, w = -1, x = ky(Br(e, 0)) && Ny(Br(e, e.length - 1));
  if (t || s)
  ...
  return !u && !p ? x && !s && !i(e) ? hf : a === Zr ? ur : Ka : r > 9 && pf(e) ? ur : s ? a === Zr ? ur : Ka : p ? gf : mf;
}
...
function Uy(e) {
  for (var t = "", r = 0, n, i = 0; i < e.length; r >= 65536 ? i += 2 : i++)
    r = Br(e, i), n = Ie[r], !n && en(r) ? (t += e[i], r >= 65536 && (t += e[i + 1])) : t += n || Ry(r);
  return t;
}
function My(e, t, r) {
  var n = "", i = e.tag, a, s, o;
...
(function(e, t) {
  ...
  const p = "[a-zA-Z0-9-]", g = [
    ...
    const N = w(_), D = u++;
    a(T, D, _), c[T] = D, l[D] = _, d[D] = N, s[D] = new RegExp(_, b ? "g" : void 0), o[D] = new RegExp(N, b ? "g" : void 0);
  };
...
const Un = Ni, { MAX_LENGTH: ll, MAX_SAFE_INTEGER: Mn } = ki, { safeRe: Bn, t: jn } = mn, rx = Ds, { compareIdentifiers: xa } = Ef;
let nx = class it {
  constructor(t, r) {
...
var Ax = Sx;
const dl = $e, Ix = (e, t, r) => new dl(e, r).compare(new dl(t, r));
var Qe = Ix;
...
var Fs = Qx;
const Zx = vf, ew = Tf, tw = Fi, rw = Ns, nw = ks, iw = Fs, aw = (e, t, r, n) => {
  switch (t) {
    case "===":
...
var _f = aw;
const sw = $e, ow = Ir, { safeRe: zn, t: Gn } = mn, lw = (e, t) => {
  if (e instanceof sw)
    return e;
...
function Ze() {
  ...
  wa = t;
  const r = fw, n = new r(), i = Ds, a = $i(), s = Ni, o = $e, {
    safeRe: l,
    t: d,
    comparatorTrimReplace: c,
    tildeTrimReplace: u,
    caretTrimReplace: p
  } = mn, { FLAG_INCLUDE_PRERELEASE: g, FLAG_LOOSE: w } = ki, x = (R) => R.value === "<0.0.0-0", T = (R) => R.value === "", _ = (R, I) => {
    let P = !0;
    const A = R.slice();
    let F = A.pop();
    for (; P && A.length; )
    ...
    return P;
  }, b = (R, I) => (R = R.replace(l[d.BUILD], ""), s("comp", R, I), R = ne(R, I), s("caret", R), R = D(R, I), s("tildes", R), R = Me(R, I), s("xrange", R), R = q(R, I), s("stars", R), R), N = (R) => !R || R.toLowerCase() === "x" || R === "*", D = (R, I) => R.trim().split(/\s+/).map((P) => Q(P, I)).join(" "), Q = (R, I) => {
    const P = I.loose ? l[d.TILDELOOSE] : l[d.TILDE];
    return R.replace(P, (A, F, O, M, X) => {
      s("tilde", R, A, F, O, M, X);
      let z;
      return N(F) ? z = "" : N(O) ? z = `>=${F}.0.0 <${+F + 1}.0.0-0` : N(M) ? z = `>=${F}.${O}.0 <${F}.${+O + 1}.0-0` : X ? (s("replaceTilde pr", X), z = `>=${F}.${O}.${M}-${X} <${F}.${+O + 1}.0-0`) : z = `>=${F}.${O}.${M} <${F}.${+O + 1}.0-0`, s("tilde return", z), z;
    });
  }, ne = (R, I) => R.trim().split(/\s+/).map((P) => Y(P, I)).join(" "), Y = (R, I) => {
    s("caret", R, I);
    const P = I.loose ? l[d.CARETLOOSE] : l[d.CARET], A = I.includePrerelease ? "-0" : "";
    return R.replace(P, (F, O, M, X, z) => {
      s("caret", R, F, O, M, X, z);
      let ee;
      return N(O) ? ee = "" : N(M) ? ee = `>=${O}.0.0${A} <${+O + 1}.0.0-0` : N(X) ? O === "0" ? ee = `>=${O}.${M}.0${A} <${O}.${+M + 1}.0-0` : ee = `>=${O}.${M}.0${A} <${+O + 1}.0.0-0` : z ? (s("replaceCaret pr", z), O === "0" ? M === "0" ? ee = `>=${O}.${M}.${X}-${z} <${O}.${M}.${+X + 1}-0` : ee = `>=${O}.${M}.${X}-${z} <${O}.${+M + 1}.0-0` : ee = `>=${O}.${M}.${X}-${z} <${+O + 1}.0.0-0`) : (s("no pr"), O === "0" ? M === "0" ? ee = `>=${O}.${M}.${X}${A} <${O}.${M}.${+X + 1}-0` : ee = `>=${O}.${M}.${X}${A} <${O}.${+M + 1}.0-0` : ee = `>=${O}.${M}.${X} <${+O + 1}.0.0-0`), s("caret return", ee), ee;
    });
    ...
    return R.replace(P, (A, F, O, M, X, z) => {
      ...
      const ee = N(O), he = ee || N(M), U = he || N(X), et = U;
      return F === "=" && et && (F = ""), z = I.includePrerelease ? "-0" : "", ee ? F === ">" || F === "<" ? A = "<0.0.0-0" : A = "*" : F && et ? (he && (M = 0), X = 0, F === ">" ? (F = ">=", he ? (O = +O + 1, M = 0, X = 0) : (M = +M + 1, X = 0)) : F === "<=" && (F = "<", he ? O = +O + 1 : M = +M + 1), F === "<" && (z = "-0"), A = `${F + O}.${M}.${X}${z}`) : he ? A = `>=${O}.0.0${z} <${+O + 1}.0.0-0` : U && (A = `>=${O}.${M}.0${z} <${O}.${+M + 1}.0-0`), s("xRange return", A), A;
    });
  }, q = (R, I) => (s("replaceStars", R, I), R.trim().replace(l[d.STAR], "")), j = (R, I) => (s("replaceGTE0", R, I), R.trim().replace(l[I.includePrerelease ? d.GTE0PRE : d.GTE0], "")), B = (R) => (I, P, A, F, O, M, X, z, ee, he, U, et) => (N(A) ? P = "" : N(F) ? P = `>=${A}.0.0${R ? "-0" : ""}` : N(O) ? P = `>=${A}.${F}.0${R ? "-0" : ""}` : M ? P = `>=${P}` : P = `>=${P}${R ? "-0" : ""}`, N(ee) ? z = "" : N(he) ? z = `<${+ee + 1}.0.0-0` : N(U) ? z = `<${ee}.${+he + 1}.0-0` : et ? z = `<=${ee}.${he}.${U}-${et}` : R ? z = `<${ee}.${he}.${+U + 1}-0` : z = `<=${z}`, `${P} ${z}`.trim()), Z = (R, I, P) => {
...
var Ow = Rw;
const Dw = $e, bf = $i(), { ANY: Pw } = bf, kw = Ze(), Nw = Li, yl = Fi, xl = ks, Fw = Fs, $w = Ns, Lw = (e, t, r, n) => {
...
const El = Ze(), Ls = $i(), { ANY: Ta } = Ls, $r = Li, Us = Qe, Yw = (e, t, r = {}) => {
  if (e === t)
    return !0;
...
var Qw = Yw;
const _a = mn, bl = ki, Zw = $e, Sl = Ef, eE = Ir, tE = ox, rE = ux, nE = dx, iE = hx, aE = yx, sE = Ex, oE = _x, lE = Ax, cE = Qe, uE = Ox, fE = kx, dE = Ps, pE = Lx, hE = Bx, mE = Fi, gE = ks, yE = vf, xE = Tf, wE = Ns, EE = Fs, vE = _f, TE = cw, _E = $i(), bE = Ze(), SE = Li, AE = gw, IE = Ew, CE = bw, RE = Iw, OE = Ow, DE = $s, PE = Bw, kE = Gw, NE = qw, FE = Vw, $E = Qw;
var Sf = {
  parse: eE,
  valid: tE,
  clean: rE,
...
(function(e, t) {
  ...
  function _e(m, E) {
    for (var C = -1, $ = m == null ? 0 : m.length, ae = 0, H = []; ++C < $; ) {
      var ue = m[C];
      E(ue, C, m) && (H[ae++] = ue);
    }
    return H;
  ...
  var fd = Array.prototype, dd = Function.prototype, bn = Object.prototype, Ji = f["__core-js_shared__"], Vs = dd.toString, tt = bn.hasOwnProperty, Ys = function() {
  ...
  ), Js = K ? f.Buffer : void 0, Sn = f.Symbol, Qs = f.Uint8Array, Zs = bn.propertyIsEnumerable, hd = fd.splice, Nt = Sn ? Sn.toStringTag : void 0, eo = Object.getOwnPropertySymbols, md = Js ? Js.isBuffer : void 0, gd = cd(Object.keys, Object), Qi = rr(f, "DataView"), Or = rr(f, "Map"), Zi = rr(f, "Promise"), ea = rr(f, "Set"), ta = rr(f, "WeakMap"), Dr = rr(Object, "create"), yd = Lt(Qi), xd = Lt(Or), wd = Lt(Zi), Ed = Lt(ea), vd = Lt(ta), to = Sn ? Sn.prototype : void 0, ra = to ? to.valueOf : void 0;
  function Ft(m) {
  ...
  function Hd(m, E) {
    var C = Rn(m), $ = !C && ap(m), ae = !C && !$ && na(m), H = !C && !$ && !ae && uo(m), ue = C || $ || ae || H, me = ue ? We(m.length, String) : [], Ee = me.length;
    for (var se in m)
  ...
  function Xd(m, E, C, $, ae, H) {
    var ue = Rn(m), me = Rn(E), Ee = ue ? l : gt(m), se = me ? l : gt(E);
    Ee = Ee == o ? b : Ee, se = se == o ? b : se;
    var Be = Ee == b, Ve = se == b, be = Ee == se;
    if (be && na(m)) {
      if (!na(E))
        return !1;
      ue = !0, Be = !1;
    ...
    if (be && !Be)
      return H || (H = new mt()), ue || uo(m) ? io(m, E, C, $, ae, H) : Kd(m, E, Ee, C, $, ae, H);
    if (!(C & i)) {
    ...
    return be ? (H || (H = new mt()), Jd(m, E, C, $, ae, H)) : !1;
  }
  function Wd(m) {
    if (!co(m) || rp(m))
      return !1;
    ...
    for (H.set(m, E), H.set(E, m); ++Be < me; ) {
      ...
      if (be) {
        if (!de(E, function(ct, Ut) {
          if (!Tn(be, Ut) && (Ge === ct || ae(Ge, ct, C, $, H)))
            return be.push(Ut);
        })) {
          Ve = !1;
          break;
  ...
  function Jd(m, E, C, $, ae, H) {
    ...
    for (var yt = ue; ++Ve < Ee; ) {
      ...
      var ct = m[be], Ut = E[be];
      if ($)
        var fo = ue ? $(Ut, ct, be, E, m, H) : $(ct, Ut, be, m, E, H);
  ...
  var Zd = eo ? function(m) {
    return m == null ? [] : (m = Object(m), _e(eo(m), function(E) {
      return Zs.call(m, E);
    }));
  } : cp, gt = Pr;
  (Qi && gt(new Qi(new ArrayBuffer(1))) != B || Or && gt(new Or()) != x || Zi && gt(Zi.resolve()) != N || ea && gt(new ea()) != ne || ta && gt(new ta()) != q) && (gt = function(m) {
    var E = Pr(m), C = E == b ? m.constructor : void 0, $ = C ? Lt(C) : "";
    if ($)
      switch ($) {
        case yd:
          return B;
...
var yn = {}, Xe = {}, WE = "[object Symbol]", If = /[\\^$.*+?()[\]{}|]/g, VE = RegExp(If.source), YE = typeof Oe == "object" && Oe && Oe.Object === Object && Oe, KE = typeof self == "object" && self && self.Object === Object && self, JE = YE || KE || Function("return this")(), QE = Object.prototype, ZE = QE.toString, Cl = JE.Symbol, Rl = Cl ? Cl.prototype : void 0, Ol = Rl ? Rl.toString : void 0;
function ev(e) {
  if (typeof e == "string")
    return e;
  if (rv(e))
      ...
      if (this.updater.allowPrerelease) {
        ...
        if (T === null)
          ...
          for (const _ of l.getElements("entry")) {
            ...
            if (b === null)
              continue;
            const N = b[1], D = ((n = pr.prerelease(N)) === null || n === void 0 ? void 0 : n[0]) || null, Q = !T || ["alpha", "beta"].includes(T), ne = D !== null && !["alpha", "beta"].includes(String(D));
            if (Q && !ne && !(T === "beta" && D === "alpha")) {
              c = N;
              break;
            }
            if (D && D === T) {
...
const ar = xe, Ev = Te, vv = le, $l = _r, Ll = Xe, Tv = Ot, _v = pe;
...
Mi.createClient = Rv;
const Hn = xe, Sv = Bi, Ul = yn, Av = Ot, Iv = ji, Cv = zi;
function Pf(e) {
...
Cr.copyData = kf;
const qn = xe, kv = Dt, Nv = ln, Fv = tr, jl = Buffer.from(`\r
\r
`);
var Et;
(function(e) {
...
const Lr = xe, Pa = Pt, jv = Dt, zv = Cr, Gv = _r, Xn = tr, Hl = Hi, Hv = qi;
class qv {
  ...
  async doDownloadFile(t, r) {
    ...
    await new Promise((s, o) => {
      ...
      if (!this.options.isUseMultipleRangeRequest && this.options.onProgress) {
        ...
        let b = 0;
        for (const D of t)
          D.kind === Xn.OperationKind.DOWNLOAD && (_.push(D.end - D.start), b += D.end - D.start);
        const N = {
      ...
      T.redirect = "manual", g = (_) => {
        ...
        const D = t[_++];
        if (D.kind === Xn.OperationKind.COPY) {
          d && d.beginFileCopy(), (0, zv.copyData)(D, p, n, o, () => g(_));
          return;
        }
        const Q = `bytes=${D.start}-${D.end - 1}`;
        T.headers.range = Q, (N = (b = this.logger) === null || b === void 0 ? void 0 : b.debug) === null || N === void 0 || N.call(b, `download range: ${Q}`), d && d.beginRangeDownload();
        const ne = this.httpExecutor.createRequest(T, (Y) => {
        ...
        ne.on("redirect", (Y, Me, y) => {
          this.logger.info(`Redirect to ${Xv(y)}`), x = y, (0, Lr.configureRequestUrl)(new Gv.URL(x), T), ne.followRedirect();
        }), this.httpExecutor.addErrorAndTimeoutHandlers(ne, o), ne.end();
      }, g(0);
    });
  }
...
const Ce = xe, Yv = cn, Kv = _i, Jv = bc, sr = Pt, Qv = Te, ka = Pi, Mt = le, Gt = Sf, Xl = gn, Zv = Ui, Wl = Af, eT = yn, Na = Mi, tT = Ac, rT = Xe, nT = Gi, or = kt;
class Bs extends Jv.EventEmitter {
  ...
  async getOrCreateStagingUserId() {
    ...
    const r = Ce.UUID.v5((0, Yv.randomBytes)(4096), Ce.UUID.OID);
  ...
  async executeDownload(t) {
    ...
    try {
      ...
      throw await T(), b instanceof Ce.CancellationError && (w.info("cancelled"), this.emit("update-cancelled", i)), b;
    }
...
const Yl = xe, Kl = Ti, fT = Pt, dT = Dt, Ur = le, pT = pt, hT = wn, mT = pe, Jl = kt;
...
const tc = xe, Fa = Pt, AT = Dt, rc = le, IT = xp, CT = At, RT = pe, nc = Ti, ic = cn;
    ...
    return await new Promise((d, c) => {
      ...
      this.server.on("request", (w, x) => {
        ...
        if (s.info(`${T} requested`), T === "/") {
          ...
          const N = w.headers.authorization.split(" ")[1], D = Buffer.from(N, "base64").toString("ascii"), [Q, ne] = D.split(":");
          if (Q !== "autoupdater" || ne !== u) {
...
const Wn = xe, oc = le, FT = pt, $T = wn, lc = kt, LT = pe, UT = Pt, MT = js, cc = _r;
...
(function(e) {
  var t = Oe && Oe.__createBinding || (Object.create ? function(T, _, b, N) {
    N === void 0 && (N = b);
    var D = Object.getOwnPropertyDescriptor(_, b);
...
const rt = Ar("tokenizer:inflate"), La = 256 * 1024, A_ = Gf(gr.DataDescriptor), Vn = Gf(gr.EndOfCentralDirectory);
class Gs {
  constructor(t) {
...
const Mb = {
  ...
  async load() {
    return (await import("./MpegParser-Cb1ffPRY.js")).MpegParser;
  }
}, Bb = {
  parserType: "apev2",
  extensions: [".ape"],
  ...
  async load() {
    return (await import("./AsfParser-Deg6XWOv.js")).AsfParser;
  }
}, zb = {
  parserType: "dsdiff",
  extensions: [".dff"],
  ...
  async load() {
    return (await import("./DsdiffParser-Didoy-qG.js")).DsdiffParser;
  }
}, Gb = {
  parserType: "aiff",
  ...
  async load() {
    return (await import("./AiffParser-ChNz5Pcz.js")).AIFFParser;
  }
}, Hb = {
  parserType: "dsf",
  extensions: [".dsf"],
  mimeTypes: ["audio/dsf"],
  async load() {
    return (await import("./DsfParser-27AOjWck.js")).DsfParser;
  }
}, qb = {
  parserType: "flac",
  extensions: [".flac"],
  ...
  async load() {
    return (await import("./FlacParser-lj65K_9C.js").then((e) => e.d)).FlacParser;
  }
}, Xb = {
  parserType: "matroska",
  ...
  async load() {
    return (await import("./MatroskaParser-CRpFG_xM.js")).MatroskaParser;
  }
}, Wb = {
  parserType: "mp4",
  ...
  async load() {
    return (await import("./MP4Parser-E68olQ9T.js")).MP4Parser;
  }
}, Vb = {
  parserType: "musepack",
  extensions: [".mpc"],
  ...
  async load() {
    return (await import("./MusepackParser-03ot_3ex.js")).MusepackParser;
  }
}, Yb = {
  parserType: "ogg",
  ...
  async load() {
    return (await import("./OggParser-B_h-o6dO.js")).OggParser;
  }
}, Kb = {
  parserType: "wavpack",
  extensions: [".wv", ".wvp"],
  ...
  async load() {
    return (await import("./WavPackParser-Apr3lJon.js")).WavPackParser;
  }
}, Jb = {
  parserType: "riff",
  ...
  async load() {
    return (await import("./WaveParser-CDmlN9Pt.js")).WaveParser;
  }
...
const sd = Re.dirname(hp(import.meta.url));
process.env.APP_ROOT = Re.join(sd, "..");
const cs = process.env.VITE_DEV_SERVER_URL, aA = Re.join(process.env.APP_ROOT, "dist-electron"), od = Re.join(process.env.APP_ROOT, "dist");
process.env.VITE_PUBLIC = cs ? Re.join(process.env.APP_ROOT, "public") : od;
let J;
function ld() {
  J = new Tc({
    width: 1200,
    ...
    webPreferences: {
      preload: Re.join(sd, "preload.mjs"),
      webSecurity: !1,
  ...
  }), cs ? J.loadURL(cs) : J.loadFile(Re.join(od, "index.html"));
}
...
`).map((o) => {
    ...
    try {
      ...
      const l = (w) => w ? w.replace(/\([^\)]*\)/g, "").replace(/\[[^\]]*\]/g, "").replace(/\{[^\}]*\}/g, "").replace(/\s*ft\..*$/i, "").replace(/\s*feat\..*$/i, "").replace(/official video/gi, "").replace(/official audio/gi, "").replace(/lyrics/gi, "").replace(/mv/gi, "").trim() : "", d = async (w, x) => {
        try {
          const T = `https://lrclib.net/api/search?q=${encodeURIComponent(w)}`, _ = await fetch(T);
          if (!_.ok) return null;
          const b = await _.json();
          if (Array.isArray(b) && b.length > 0) {
            let N = b.filter((D) => D.syncedLyrics && D.syncedLyrics.length > 0);
            if (N.length > 0) {
              if (x) {
                const D = N.find((Q) => Q.artistName.toLowerCase().includes(x.toLowerCase()));
                if (D)
                  return console.log(`[Lyrics] LRCLib Strict Match: ${D.trackName}`), D.syncedLyrics;
              }
              return N[0].syncedLyrics;
            }
          }
        } catch (T) {
        ...
        try {
          const x = `https://music.163.com/api/search/get/web?s=${encodeURIComponent(w)}&type=1&offset=0&total=true&limit=5`, T = await fetch(x, {
            headers: {
          ...
          if (_.result && _.result.songs && _.result.songs.length > 0) {
            const b = _.result.songs[0], D = `https://music.163.com/api/song/lyric?id=${b.id}&lv=1&kv=1&tv=-1`, Q = await fetch(D, {
              headers: { Referer: "https://music.163.com/", Cookie: "appver=2.0.2" }
            });
            if (!Q.ok) return null;
            const ne = await Q.json();
            if (ne.lrc && ne.lrc.lyric)
              return console.log(`[Lyrics] Netease Match: ${b.name}`), ne.lrc.lyric;
          }
        } catch (x) {
          console.error("Netease Error:", x);
        }
        return null;
      }, u = (w) => {
        if (!w) return null;
        try {
          ...
          return console.error("OpenCC conversion failed:", x), w;
        }
      };
      if (n && i) {
        const w = `${n} ${i}`, x = await d(w, i);
        if (x) return u(x);
      }
      const p = l(n), g = l(i);
      if (p && (p !== n || g !== i)) {
        console.log(`[Lyrics] Retry with cleaned metadata: ${p} ${g}`);
        const w = `${p} ${g}`, x = await d(w, g);
        if (x) return u(x);
      }
      if (n && i) {
      ...
      if (a) {
        let w = Re.basename(a, Re.extname(a));
        w = w.replace(/_/g, " ");
        const x = o(w);
        if (x && x.length === 2) {
          const [b, N] = x;
          console.log(`[Lyrics] Parsed Filename: ${N} - ${b}`);
          let D = await d(`${N} ${b}`, b);
          if (D || (D = await c(`${N} ${b}`), D)) return u(D);
        }
        const T = l(w);
        console.log(`[Lyrics] Raw Filename: ${T}`);
        let _ = await d(T);
        if (_ || (_ = await c(T), _)) return u(_);
      }
