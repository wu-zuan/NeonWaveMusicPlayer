...
import Jt, { app as Je, BrowserWindow as Ic, Notification as wp, ipcMain as ie, dialog as yo } from "electron";
...
function ms(e) {
  Mp(e), e.gracefulify = ms, e.createReadStream = k, e.createWriteStream = H;
  var t = e.readFile;
  e.readFile = r;
  function r(y, j, U) {
...
const So = $e, Vc = ue, ne = Cc, Zr = process.platform === "win32";
function Yc(e) {
  [
    "unlink",
    "chmod",
...
function vs(e, t, r) {
  let n = 0;
  typeof t == "function" && (r = t, t = {}), ne(e, "rimraf: missing path"), ne.strictEqual(typeof e, "string", "rimraf: path should be a string"), ne.strictEqual(typeof r, "function", "rimraf: callback function required"), ne(t, "rimraf: invalid options argument provided"), ne.strictEqual(typeof t, "object", "rimraf: options should be object"), Yc(t), Ao(e, t, function i(a) {
    if (a) {
...
Char: ` + h.c), f = new Error(f), h.error = f, U(h, "onerror", f), h;
    ...
    function O(h, f) {
      var A = h.indexOf(":"), v = A < 0 ? ["", h] : h.split(":"), Z = v[0], se = v[1];
    ...
    function Y(h, f) {
      if (h.opt.xmlns) {
        ...
        for (var se = 0, fe = h.attribList.length; se < fe; se++) {
          var ve = h.attribList[se], Se = ve[0], mt = ve[1], he = O(Se, !0), We = he.prefix, ta = he.local, Sn = We === "" ? "" : A.ns[We] || "", Or = {
            name: Se,
            value: mt,
            prefix: We,
            local: ta,
...
` ? (f.line++, f.column = 0) : f.column++);
          ...
          case y.CDATA:
            for (var se = A - 1; v && v !== "]"; )
              v = z(h, A++), v && f.trackPosition && (f.position++, v === `
` ? (f.line++, f.column = 0) : f.column++);
            f.cdata += h.substring(se, A - 1), v === "]" && (f.state = y.CDATA_ENDING);
            continue;
          case y.CDATA_ENDING:
...
var rl = {
  YAML: function(t, r, n) {
    var i, a, s;
    t.version !== null && B(t, "duplication of %YAML directive"), n.length !== 1 && B(t, "YAML directive accepts exactly one argument"), i = /^([0-9]+)\.([0-9]+)$/.exec(n[0]), i === null && B(t, "ill-formed argument of the YAML directive"), a = parseInt(i[1], 10), s = parseInt(i[2], 10), a !== 1 && B(t, "unacceptable YAML version of the document"), t.version = n[0], t.checkLineBreaks = s < 2, s !== 1 && s !== 2 && xi(t, "unsupported YAML version of the document");
  },
  TAG: function(t, r, n) {
    var i, a;
...
function St(e, t, r, n) {
  ...
  if (t < r) {
    ...
    else Qg.test(o) && B(e, "the stream contains non-printable characters");
    e.result += o;
  }
}
function nl(e, t, r, n) {
...
function hr(e, t, r, n, i, a, s, o, l) {
  ...
  if (typeof i == "object" && el(i) === "[object Object]" && (i = "[object Object]"), i = String(i), t === null && (t = {}), n === "tag:yaml.org,2002:merge")
    ...
    !e.json && !Rt.call(r, i) && Rt.call(t, i) && (e.line = s || e.line, e.lineStart = o || e.lineStart, e.position = l || e.position, B(e, "duplicated mapping key")), af(t, i, a), delete r[i];
  return t;
}
function Os(e) {
  var t;
...
function sy(e, t, r) {
  ...
  for (e.kind = "scalar", e.result = "", a = s = e.position, o = !1; g !== 0; ) {
    ...
    o && (St(e, a, s, !1), Ps(e, e.line - l), a = s = e.position, o = !1), Yt(g) || (s = e.position + 1), g = e.input.charCodeAt(++e.position);
  }
  ...
  for (e.kind = "scalar", e.result = "", e.position++, n = i = e.position; (r = e.input.charCodeAt(e.position)) !== 0; )
    if (r === 39)
      if (St(e, n, e.position, !0), r = e.input.charCodeAt(++e.position), r === 39)
        ...
        return !0;
    else st(r) ? (St(e, n, i, !0), Ps(e, pe(e, !1, t)), n = i = e.position) : e.position === e.lineStart && Fi(e) ? B(e, "unexpected end of the document within a single quoted scalar") : (e.position++, i = e.position);
  ...
  for (e.kind = "scalar", e.result = "", e.position++, r = n = e.position; (o = e.input.charCodeAt(e.position)) !== 0; ) {
    ...
    if (o === 92) {
      if (St(e, r, e.position, !0), o = e.input.charCodeAt(++e.position), st(o))
        ...
        for (i = s, a = 0; i > 0; i--)
          o = e.input.charCodeAt(++e.position), (s = ty(o)) >= 0 ? a = (a << 4) + s : B(e, "expected hexadecimal character");
        e.result += iy(a), e.position++;
      } else
        B(e, "unknown escape sequence");
      r = n = e.position;
    } else st(o) ? (St(e, r, n, !0), Ps(e, pe(e, !1, t)), r = n = e.position) : e.position === e.lineStart && Fi(e) ? B(e, "unexpected end of the document within a double quoted scalar") : (e.position++, n = e.position);
  }
  B(e, "unexpected end of the stream within a double quoted scalar");
}
function cy(e, t) {
  var r = !0, n, i, a, s = e.tag, o, l = e.anchor, d, c, u, p, g, x = /* @__PURE__ */ Object.create(null), w, T, b, _;
...
function uy(e, t) {
  ...
  for (e.kind = "scalar", e.result = ""; u !== 0; )
    if (u = e.input.charCodeAt(++e.position), u === 43 || u === 45)
      va === i ? i = u === 43 ? Zo : Jg : B(e, "repeat of a chomping mode identifier");
    else if ((c = ny(u)) >= 0)
...
function fy(e, t, r) {
  var n, i, a, s, o, l, d = e.tag, c = e.anchor, u = {}, p = /* @__PURE__ */ Object.create(null), g = null, x = null, w = null, T = !1, b = !1, _;
  if (e.firstTabInLine !== -1) return !1;
  for (e.anchor !== null && (e.anchorMap[e.anchor] = u), _ = e.input.charCodeAt(e.position); _ !== 0; ) {
    if (!T && e.firstTabInLine !== -1 && (e.position = e.firstTabInLine, B(e, "tab characters must not be used in indentation")), n = e.input.charCodeAt(e.position + 1), a = e.line, (_ === 63 || _ === 58) && Be(n))
      _ === 63 ? (T && (hr(e, u, p, g, x, null, s, o, l), g = x = w = null), b = !0, T = !0, i = !0) : T ? (T = !1, i = !0) : B(e, "incomplete explicit mapping pair; a key node is missed; or followed by a non-tabulated empty line"), e.position += 1, _ = n;
    else {
      ...
      if (e.line === a) {
        ...
        if (_ === 58)
          _ = e.input.charCodeAt(++e.position), Be(_) || B(e, "a whitespace character is expected after the key-value separator within a block mapping"), T && (hr(e, u, p, g, x, null, s, o, l), g = x = w = null), b = !0, T = !1, i = !1, g = e.tag, x = e.result;
        else if (b)
    ...
    if ((e.line === a || e.lineIndent > t) && (T && (s = e.line, o = e.lineStart, l = e.position), br(e, t, wi, !0, i) && (T ? x = e.result : w = e.result), T || (hr(e, u, p, g, x, w, s, o, l), g = x = w = null), pe(e, !0, -1), _ = e.input.charCodeAt(e.position)), (e.line === a || e.lineIndent > t) && _ !== 0)
      B(e, "bad indentation of a mapping entry");
    else if (e.lineIndent < t)
      break;
  }
  return T && hr(e, u, p, g, x, null, s, o, l), b && (e.tag = d, e.anchor = c, e.kind = "mapping", e.result = u), b;
}
function dy(e) {
  var t, r = !1, n = !1, i, a, s;
  ...
  if (e.tag !== null && B(e, "duplication of a tag property"), s = e.input.charCodeAt(++e.position), s === 60 ? (r = !0, s = e.input.charCodeAt(++e.position)) : s === 33 ? (n = !0, i = "!!", s = e.input.charCodeAt(++e.position)) : i = "!", t = e.position, r) {
    ...
    for (; s !== 0 && !Be(s); )
      s === 33 && (n ? B(e, "tag suffix cannot contain exclamation marks") : (i = e.input.slice(t - 1, e.position + 1), rf.test(i) || B(e, "named tag handle cannot contain such characters"), n = !0, t = e.position + 1)), s = e.input.charCodeAt(++e.position);
...
function br(e, t, r, n, i) {
  var a, s, o, l = 1, d = !1, c = !1, u, p, g, x, w, T;
  ...
  if (o && (o = d || i), (l === 1 || wi === r) && (yi === r || ef === r ? w = t : w = t + 1, T = e.position - e.lineStart, l === 1 ? o && (il(e, T) || fy(e, T, w)) || cy(e, w) ? c = !0 : (s && uy(e, w) || oy(e, w) || ly(e, w) ? c = !0 : hy(e) ? (c = !0, (e.tag !== null || e.anchor !== null) && B(e, "alias node should not have any properties")) : sy(e, w, yi === r) && (c = !0, e.tag === null && (e.tag = "?")), e.anchor !== null && (e.anchorMap[e.anchor] = e.result)) : l === 0 && (c = o && il(e, T))), e.tag === null)
...
function et() {
  ...
  class t {
    ...
    parseRange(I) {
      ...
      I = I.replace(G, M(this.options.includePrerelease)), s("hyphen replace", I), I = I.replace(l[d.COMPARATORTRIM], c), s("comparator trim", I), I = I.replace(l[d.TILDETRIM], u), s("tilde trim", I), I = I.replace(l[d.CARETTRIM], p), s("caret trim", I);
      let Y = I.split(" ").map((z) => _(z, this.options)).join(" ").split(/\s+/).map((z) => U(z, this.options));
      O && (Y = Y.filter((z) => (s("loose invalid filter", z, this.options), !!z.match(l[d.COMPARATORLOOSE])))), s("range list", Y);
  ...
  const r = Ex, n = new r(), i = Fs, a = ji(), s = Mi, o = Ue, {
    ...
    return R.replace(P, (S, $, O, G, Y) => {
      s("tilde", R, S, $, O, G, Y);
      let X;
      return F($) ? X = "" : F(O) ? X = `>=${$}.0.0 <${+$ + 1}.0.0-0` : F(G) ? X = `>=${$}.${O}.0 <${$}.${+O + 1}.0-0` : Y ? (s("replaceTilde pr", Y), X = `>=${$}.${O}.${G}-${Y} <${$}.${+O + 1}.0-0`) : X = `>=${$}.${O}.${G} <${$}.${+O + 1}.0-0`, s("tilde return", X), X;
    });
    ...
    return R.replace(P, ($, O, G, Y, X) => {
      s("caret", R, $, O, G, Y, X);
      let re;
      return F(O) ? re = "" : F(G) ? re = `>=${O}.0.0${S} <${+O + 1}.0.0-0` : F(Y) ? O === "0" ? re = `>=${O}.${G}.0${S} <${O}.${+G + 1}.0-0` : re = `>=${O}.${G}.0${S} <${+O + 1}.0.0-0` : X ? (s("replaceCaret pr", X), O === "0" ? G === "0" ? re = `>=${O}.${G}.${Y}-${X} <${O}.${G}.${+Y + 1}-0` : re = `>=${O}.${G}.${Y}-${X} <${O}.${+G + 1}.0-0` : re = `>=${O}.${G}.${Y}-${X} <${+O + 1}.0.0-0`) : (s("no pr"), O === "0" ? G === "0" ? re = `>=${O}.${G}.${Y}${S} <${O}.${G}.${+Y + 1}-0` : re = `>=${O}.${G}.${Y}${S} <${O}.${+G + 1}.0-0` : re = `>=${O}.${G}.${Y} <${+O + 1}.0.0-0`), s("caret return", re), re;
    });
    ...
    return R.replace(P, (S, $, O, G, Y, X) => {
      s("xRange", R, S, $, O, G, Y, X);
      const re = F(O), ge = re || F(G), z = ge || F(Y), tt = z;
      return $ === "=" && tt && ($ = ""), X = I.includePrerelease ? "-0" : "", re ? $ === ">" || $ === "<" ? S = "<0.0.0-0" : S = "*" : $ && tt ? (ge && (G = 0), Y = 0, $ === ">" ? ($ = ">=", ge ? (O = +O + 1, G = 0, Y = 0) : (G = +G + 1, Y = 0)) : $ === "<=" && ($ = "<", ge ? O = +O + 1 : G = +G + 1), $ === "<" && (X = "-0"), S = `${$ + O}.${G}.${Y}${X}`) : ge ? S = `>=${O}.0.0${X} <${+O + 1}.0.0-0` : z && (S = `>=${O}.${G}.0${X} <${O}.${+G + 1}.0-0`), s("xRange return", S), S;
    });
  }, j = (R, I) => (s("replaceStars", R, I), R.trim().replace(l[d.STAR], "")), U = (R, I) => (s("replaceGTE0", R, I), R.trim().replace(l[I.includePrerelease ? d.GTE0PRE : d.GTE0], "")), M = (R) => (I, P, S, $, O, G, Y, X, re, ge, z, tt) => (F(S) ? P = "" : F($) ? P = `>=${S}.0.0${R ? "-0" : ""}` : F(O) ? P = `>=${S}.${$}.0${R ? "-0" : ""}` : G ? P = `>=${P}` : P = `>=${P}${R ? "-0" : ""}`, F(re) ? X = "" : F(ge) ? X = `<${+re + 1}.0.0-0` : F(z) ? X = `<${re}.${+ge + 1}.0-0` : tt ? X = `<=${re}.${ge}.${z}-${tt}` : R ? X = `<${re}.${ge}.${+z + 1}-0` : X = `<=${X}`, `${P} ${X}`.trim()), J = (R, I, P) => {
...
const Bx = Ue, Rf = ji(), { ANY: jx } = Rf, zx = et(), Gx = zi, _l = Bi, bl = Ls, Hx = Ms, qx = Us, Xx = (e, t, r, n) => {
  ...
  for (let d = 0; d < t.set.length; ++d) {
    ...
    let u = null, p = null;
    if (c.forEach((g) => {
      g.semver === jx && (g = new Rf(">=0.0.0")), u = u || g, p = p || g, i(g.semver, u.semver, n) ? u = g : s(g.semver, p.semver, n) && (p = g);
...
(function(e, t) {
  ...
  z[J] = z[R] = z[I] = z[P] = z[S] = z[$] = z[O] = z[G] = z[Y] = !0, z[o] = z[l] = z[U] = z[c] = z[M] = z[u] = z[p] = z[g] = z[w] = z[T] = z[_] = z[k] = z[H] = z[q] = z[j] = !1;
  var tt = typeof Pe == "object" && Pe && Pe.Object === Object && Pe, h = typeof self == "object" && self && self.Object === Object && self, f = tt || h || Function("return this")(), A = t && !t.nodeType && t, v = A && !0 && e && !e.nodeType && e, Z = v && v.exports === A, se = Z && tt.process, fe = function() {
    try {
  ...
  function Yd(m, E) {
    var C = Pn(m), L = !C && up(m), oe = !C && !L && la(m), V = !C && !L && !oe && mo(m), de = C || L || oe || V, ye = de ? We(m.length, String) : [], Te = ye.length;
    for (var le in m)
  ...
  function oo(m, E, C, L, oe) {
    return m === E ? !0 : m == null || E == null || !Fr(m) && !Fr(E) ? m !== m && E !== E : Jd(m, E, C, L, oo, oe);
  }
  function Jd(m, E, C, L, oe, V) {
    ...
    if (Ae && !je)
      return V || (V = new gt()), de || mo(m) ? lo(m, E, C, L, oe, V) : tp(m, E, Te, C, L, oe, V);
    if (!(C & i)) {
  ...
  function Zd(m) {
    return Fr(m) && po(m.length) && !!z[Nr(m)];
  }
  function ep(m) {
    if (!lp(m))
      return vd(m);
  ...
  function tp(m, E, C, L, oe, V, de) {
    switch (C) {
      ...
      case U:
        return !(m.byteLength != E.byteLength || !V(new ro(m), new ro(E)));
      case c:
      case u:
      case T:
        return uo(+m, +E);
      ...
      case H:
        ...
        if (le)
          return le == E;
        L |= a, de.set(m, E);
        var je = lo(ye(m), ye(E), L, oe, V, de);
        return de.delete(m), je;
      case te:
        if (oa)
          return oa.call(m) == oa.call(E);
    }
    return !1;
  }
  function rp(m, E, C, L, oe, V) {
    var de = C & i, ye = co(m), Te = ye.length, le = co(E), je = le.length;
    if (Te != je && !de)
      return !1;
    for (var Ve = Te; Ve--; ) {
      var Ae = ye[Ve];
    ...
    for (var wt = de; ++Ve < Te; ) {
      ...
      var ut = m[Ae], Mt = E[Ae];
      if (L)
        var go = de ? L(Mt, ut, Ae, E, m, V) : L(ut, Mt, Ae, m, E, V);
  ...
  var ip = io ? function(m) {
    return m == null ? [] : (m = Object(m), Se(io(m), function(E) {
      return no.call(m, E);
    }));
  } : hp, yt = Nr;
  (na && yt(new na(new ArrayBuffer(1))) != M || Pr && yt(new Pr()) != w || ia && yt(ia.resolve()) != F || aa && yt(new aa()) != H || sa && yt(new sa()) != j) && (yt = function(m) {
  ...
  var up = so(/* @__PURE__ */ function() {
    ...
    return Fr(m) && rt.call(m, "callee") && !no.call(m, "callee");
  }, Pn = Array.isArray;
  function fp(m) {
    return m != null && po(m.length) && !fo(m);
  }
  var la = Ed || mp;
  function dp(m, E) {
    return oo(m, E);
...
${o}`, "ERR_UPDATER_INVALID_RELEASE_FEED");
    ...
    const w = (0, is.parseUpdateInfo)(u, p, g);
...
function Wv(e, t, r, n, i) {
  ...
  const c = e.httpExecutor.createRequest(d, (u) => {
    if (!ss(u, i))
      return;
    const p = (0, as.safeGetHeader)(u, "content-type"), g = /^multipart\/.+?(?:; boundary=(?:(?:"(.+)")|(?:([^\s]+))))$/i.exec(p);
    if (g == null) {
      i(new Error(`Content-Type "multipart/byteranges" is expected, but got "${p}"`));
      return;
    }
    const x = new Vl.DataSplitter(r, t, o, g[1] || g[2], l, n);
  ...
  async doDownloadFile(t, r) {
    ...
    await new Promise((s, o) => {
      ...
      if (this.options.isUseMultipleRangeRequest) {
        g = (0, Kl.executeTasksUsingMultipleRangeRequests)(this, t, p, n, o), g(0);
        return;
      }
      let x = 0, w = null;
      ...
      T.redirect = "manual", g = (b) => {
        ...
        if (D.kind === Kn.OperationKind.COPY) {
          d && d.beginFileCopy(), (0, Jv.copyData)(D, p, n, o, () => g(b));
          return;
        }
        ...
        const H = this.httpExecutor.createRequest(T, (q) => {
          ...
          }), q.statusCode >= 400 && o((0, Br.createHttpError)(q)), q.pipe(p, {
            end: !1
          }), q.once("end", () => {
...
var Qi = function(e, t, r, n, i) {
  ...
  var s, o, l, d = a * 8 - i - 1, c = (1 << d) - 1, u = c >> 1, p = i === 23 ? Math.pow(2, -24) - Math.pow(2, -77) : 0, g = n ? 0 : a - 1, x = n ? 1 : -1, w = t < 0 || t === 0 && 1 / t < 0 ? 1 : 0;
  for (t = Math.abs(t), isNaN(t) || t === 1 / 0 ? (o = isNaN(t) ? 1 : 0, s = c) : (s = Math.floor(Math.log(t) / Math.LN2), t * (l = Math.pow(2, -s)) < 1 && (s--, l *= 2), s + u >= 1 ? t += p / l : t += p * Math.pow(2, 1 - u), t * l >= 2 && (s++, l /= 2), s + u >= c ? (o = 0, s = c) : s + u >= 1 ? (o = (t * l - 1) * Math.pow(2, i), s = s + u) : (o = t * Math.pow(2, u - 1) * Math.pow(2, i), s = 0)); i >= 8; e[r + g] = o & 255, g += x, o /= 256, i -= 8)
    ;
  for (s = s << i | o, d += i; d > 0; e[r + g] = s & 255, g += x, s /= 256, d -= 8)
    ;
  e[r + g - x] |= w * 128;
};
const ls = {
...
`, { offset: 2, encoding: r }) ? {
  ...
  async readTiffHeader(t) {
    const r = (t ? Xt : ae).get(this.buffer, 2), n = (t ? _i : K).get(this.buffer, 4);
    if (r === 42) {
      if (n >= 6) {
...
const Vb = {
  ...
  async load() {
    return (await import("./MpegParser-DLk4Z98Y.js")).MpegParser;
  }
}, Yb = {
  parserType: "apev2",
  extensions: [".ape"],
  ...
  async load() {
    return (await import("./AsfParser-DknZmNgy.js")).AsfParser;
  }
}, Jb = {
  parserType: "dsdiff",
  extensions: [".dff"],
  ...
  async load() {
    return (await import("./DsdiffParser-DYi6tAZA.js")).DsdiffParser;
  }
}, Qb = {
  parserType: "aiff",
  ...
  async load() {
    return (await import("./AiffParser-DQ4D9Xdo.js")).AIFFParser;
  }
}, Zb = {
  parserType: "dsf",
  extensions: [".dsf"],
  mimeTypes: ["audio/dsf"],
  async load() {
    return (await import("./DsfParser-ClEbLnv4.js")).DsfParser;
  }
}, eS = {
  parserType: "flac",
  extensions: [".flac"],
  ...
  async load() {
    return (await import("./FlacParser-BqujFzvx.js").then((e) => e.d)).FlacParser;
  }
}, tS = {
  parserType: "matroska",
  ...
  async load() {
    return (await import("./MatroskaParser-DoG9DgBZ.js")).MatroskaParser;
  }
}, rS = {
  parserType: "mp4",
  ...
  async load() {
    return (await import("./MP4Parser-BqF4lgSy.js")).MP4Parser;
  }
}, nS = {
  parserType: "musepack",
  extensions: [".mpc"],
  ...
  async load() {
    return (await import("./MusepackParser-DkArxulX.js")).MusepackParser;
  }
}, iS = {
  parserType: "ogg",
  ...
  async load() {
    return (await import("./OggParser-AQVnCn4I.js")).OggParser;
  }
}, aS = {
  parserType: "wavpack",
  extensions: [".wv", ".wvp"],
  ...
  async load() {
    return (await import("./WavPackParser-YSGRUyxf.js")).WavPackParser;
  }
}, sS = {
  parserType: "riff",
  ...
  async load() {
    return (await import("./WaveParser-S30tRxL9.js")).WaveParser;
  }
...
Je.whenReady().then(() => {
  ...
  const e = new PS();
  ie.handle("discord:login", async (n, i) => await e.login(i)), ie.handle("discord:getGuilds", () => e.getGuilds()), ie.handle("discord:getChannels", (n, i) => e.getChannels(i)), ie.handle("discord:join", async (n, i, a) => await e.joinChannel(i, a)), ie.handle("discord:leave", async () => await e.leaveChannel()), ie.handle("discord:disconnect", async () => await e.disconnect()), ie.handle("discord:play", async (n, i) => await e.playFile(i, Ai)), ie.handle("discord:stop", () => e.stop()), ie.handle("discord:pause", () => e.pause()), ie.handle("discord:resume", () => e.resume()), ie.handle("discord:setVolume", (n, i) => e.setVolume(i)), ie.handle("discord:status", () => e.getStatus()), ie.handle("discord:startStreamMode", async () => await e.playReceiverStream(Ai)), ie.on("discord:audio-chunk", (n, i) => {
    e.writeAudioChunk(new Uint8Array(i));
  }), ie.handle("dialog:openDirectory", async () => {
    const { canceled: n, filePaths: i } = await yo.showOpenDialog(ee, {
      properties: ["openDirectory"]
    });
    return n ? null : i[0];
  }), ie.handle("files:listMusic", async (n, i) => {
    if (!i) return [];
    try {
      const a = await Fn.readdir(i), s = [".mp3", ".wav", ".wma", ".m4a", ".flac", ".ogg", ".mp4", ".mov", ".wmv", ".avi"];
  ...
  }), ie.handle("files:readBuffer", async (n, i) => {
    try {
      return await Fn.readFile(i);
    } catch (a) {
      return console.error("Error reading file:", a), null;
    }
  }), ie.handle("files:getMetadata", async (n, i) => {
    try {
      const a = await OS(i);
      let s = null;
  ...
  }), ie.handle("app:active-window", async () => {
  ...
  ie.handle("search:youtube", async (n, i) => {
    try {
...
`).map((l) => {
  ...
  }), ie.handle("download:youtube", async (n, i, a, s) => {
    try {
      const o = await r(), l = ai(import.meta.url)("ffmpeg-static").replace("app.asar", "app.asar.unpacked");
      let d = a.replace(/[\\/:*?"<>|]/g, "_").trim();
      const { filePath: c } = await yo.showSaveDialog(ee, {
        title: "下載歌曲",
        defaultPath: `${d}.m4a`,
  ...
  }), ie.handle("search:artistImage", async (n, i) => {
    try {
  ...
  }), ie.handle("search:lyrics", async (n, i, a, s, o) => {
    try {
      ...
      if (s) {
        ...
        if (k) {
          ...
          if (U) {
            const M = `${U} ${j}`;
            console.log(`[Lyrics] Strategy C-0 (Variety Pattern): ${M}`), x.push(...await u(M, o)), x.push(...await p(M, o)), j.length > 0 && (console.log(`[Lyrics] Strategy C-0 (Title + Duration): ${U}`), x.push(...await u(U, o)), x.push(...await p(U, o)));
          }
        }
        const H = l(D.replace(/_/g, " "));
        if (H && H.length === 2) {
          const [te, y] = H, j = `${y} ${te}`;
          console.log(`[Lyrics] Strategy C-1 (Parsed): ${j}`), x.push(...await u(j, o)), x.push(...await p(j, o));
        }
        const q = d(D);
        console.log(`[Lyrics] Strategy C-2 (Raw Cleaned): ${q}`), x.push(...await u(q, o)), x.push(...await p(q, o));
      }
      if (x.length === 0)
