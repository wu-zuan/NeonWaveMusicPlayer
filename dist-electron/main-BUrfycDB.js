...
import Kt, { app as St, BrowserWindow as vc, ipcMain as He, dialog as uo } from "electron";
import { createRequire as fo } from "node:module";
import { fileURLToPath as fp } from "node:url";
import qe from "node:path";
import po, { open as dp } from "node:fs/promises";
import Dt from "fs";
...
var yt = pp, xp = process.cwd, ti = null, wp = process.env.GRACEFUL_FS_PLATFORM || process.platform;
...
var Ep = vp;
function vp(e) {
  yt.hasOwnProperty("O_SYMLINK") && process.version.match(/^v0\.6\.[0-2]|^v0\.5\./) && t(e), e.lutimes || r(e), e.chown = a(e.chown), e.fchown = a(e.fchown), e.lchown = a(e.lchown), e.chmod = n(e.chmod), e.fchmod = n(e.fchmod), e.lchmod = n(e.lchmod), e.chownSync = s(e.chownSync), e.fchownSync = s(e.fchownSync), e.lchownSync = s(e.lchownSync), e.chmodSync = i(e.chmodSync), e.fchmodSync = i(e.fchmodSync), e.lchmodSync = i(e.lchmodSync), e.stat = o(e.stat), e.fstat = o(e.fstat), e.lstat = o(e.lstat), e.statSync = l(e.statSync), e.fstatSync = l(e.fstatSync), e.lstatSync = l(e.lstatSync), e.chmod && !e.lchmod && (e.lchmod = function(c, f, h) {
  ...
  function t(c) {
    c.lchmod = function(f, h, g) {
      ...
      var g = c.openSync(f, yt.O_WRONLY | yt.O_SYMLINK, h), v = !0, x;
      try {
  ...
  function r(c) {
    yt.hasOwnProperty("O_SYMLINK") && c.futimes ? (c.lutimes = function(f, h, g, v) {
      c.open(f, yt.O_SYMLINK, function(x, T) {
        if (x) {
          v && v(x);
          return;
        }
      ...
      var v = c.openSync(f, yt.O_SYMLINK), x, T = !0;
      try {
...
function cs(e) {
  ...
  function _() {
    var y = this;
    Ue(y.path, y.flags, y.mode, function(q, z) {
...
fs.makeDir = async (e, t) => (Rc(e), Cc.mkdir(e, {
  mode: Oc(t),
  recursive: !0
}));
fs.makeDirSync = (e, t) => (Rc(e), Cc.mkdirSync(e, {
  mode: Oc(t),
  recursive: !0
}));
...
function xh(e, t, r, n, i) {
  return t ? zc(r, n, i) : wh(e.mode, r, n, i);
}
function wh(e, t, r, n) {
  return Se.mkdirSync(r), zc(t, r, n), ps(r, e);
}
function zc(e, t, r) {
...
const wo = ke, jc = oe, ee = Tc, Kr = process.platform === "win32";
function Gc(e) {
  [
    "unlink",
    "chmod",
...
function Ah(e, t) {
  if (ee(e), ee(t), t.readdirSync(e).forEach((r) => Hc(jc.join(e, r), t)), Kr) {
    const r = Date.now();
    do
      try {
...
const kh = Pe.fromCallback, Kc = oe, vt = ke, Jc = st;
function Nh(e, t) {
  function r() {
    vt.writeFile(e, "", (n) => {
      if (n) return t(n);
...
const Lh = Pe.fromCallback, Qc = oe, Et = ke, Zc = st, Uh = er.pathExists, { areIdentical: eu } = br;
function Mh(e, t, r) {
  function n(i, a) {
    Et.link(i, a, (s) => {
      if (s) return r(s);
...
function Bh(e, t) {
  ...
  return Et.existsSync(n) || Zc.mkdirsSync(n), Et.linkSync(e, t);
}
var zh = {
  createLink: Lh(Mh),
  createLinkSync: Bh
...
const { createFile: Ao, createFileSync: Io } = $h, { createLink: Co, createLinkSync: Ro } = zh, { createSymlink: Oo, createSymlinkSync: Do } = am;
var sm = {
  // file
  createFile: Ao,
  createFileSync: Io,
...
const Ai = Pe, { stringify: ou, stripBom: lu } = gs;
...
const { stringify: vm } = gs, { outputFile: Tm } = ys;
async function _m(e, t, r = {}) {
  const n = vm(t, r);
  await Tm(e, n, r);
}
var bm = _m;
const { stringify: Sm } = gs, { outputFileSync: Am } = ys;
function Im(e, t, r) {
  const n = Sm(t, r);
  Am(e, n, r);
}
...
var Om = De;
const Dm = ke, Ma = oe, Pm = hs.copy, fu = Si.remove, km = st.mkdirp, Nm = er.pathExists, Po = br;
function Fm(e, t, r, n) {
  ...
  Po.checkPaths(e, t, "move", r, (a, s) => {
    ...
    Po.checkParentPaths(e, o, t, "move", (d) => {
      ...
      km(Ma.dirname(t), (c) => c ? n(c) : ko(e, t, i, l, n));
    });
  });
}
function $m(e) {
...
function ko(e, t, r, n, i) {
  ...
  if (r)
    return fu(t, (a) => a ? i(a) : sa(e, t, r, i));
...
var Um = Fm;
const du = ke, Ba = oe, Mm = hs.copySync, pu = Si.removeSync, Bm = st.mkdirpSync, No = br;
function zm(e, t, r) {
  r = r || {};
  const n = r.overwrite || r.clobber || !1, { srcStat: i, isChangingCase: a = !1 } = No.checkPathsSync(e, t, "move", r);
  return No.checkParentPathsSync(e, i, t, "move"), jm(t) || Bm(Ba.dirname(t)), Gm(e, t, n, a);
}
function jm(e) {
...
var Oe = {}, ja = { exports: {} }, Fn = { exports: {} }, la, Fo;
function Jm() {
  if (Fo) return la;
  Fo = 1;
...
var $n = { exports: {} }, ua, Uo;
function Zm() {
  return Uo || (Uo = 1, ua = (e, t = process.argv) => {
...
const i0 = cn, a0 = mu, s0 = Dt, o0 = ln, gu = _r, l0 = It, zo = Sr, c0 = fn, Nr = (0, a0.default)("electron-builder");
function Ga(e, t = null) {
  return new xs(e.statusCode || -1, `${e.statusCode} ${e.statusMessage}` + (t == null ? "" : `
  ...
  static retryOnServerError(t, r = 3) {
    for (let n = 0; ; n++)
      try {
        ...
        if (n < r && (i instanceof xs && i.isServerError() || i.code === "EPIPE"))
          continue;
        throw i;
      }
  }
...
const vu = cn, Tu = Sr, v0 = "options.name must be either a string or a Buffer", jo = (0, vu.randomBytes)(16);
jo[0] = jo[0] | 1;
const ii = {}, V = [];
for (let e = 0; e < 256; e++) {
...
Char: ` + p.c), u = new Error(u), p.error = u, z(p, "onerror", u), p;
    ...
    function D(p) {
      return p.sawRoot && !p.closedRoot && A(p, "Unclosed root tag"), p.state !== y.BEGIN && p.state !== y.BEGIN_WHITESPACE && p.state !== y.TEXT && I(p, "Unexpected end"), Q(p), p.c = "", p.closed = !0, z(p, "onend"), n.call(p, p.strict, p.opt), p;
    }
    function A(p, u) {
    ...
    function X(p, u) {
      if (p.opt.xmlns) {
        ...
        for (var re = 0, le = p.attribList.length; re < le; re++) {
          var we = p.attribList[re], _e = we[0], pt = we[1], de = O(_e, !0), We = de.prefix, Yi = de.local, Tn = We === "" ? "" : S.ns[We] || "", Rr = {
            name: _e,
            value: pt,
            prefix: We,
            local: Yi,
...
` ? (u.line++, u.column = 0) : u.column++);
          ...
          case y.CLOSE_TAG:
            if (u.tagName)
              E === ">" ? j(u) : Y(b, E) ? u.tagName += E : u.script ? (u.script += "</" + u.tagName, u.tagName = "", u.state = y.SCRIPT) : ($(E) || A(u, "Invalid tagname in closing tag"), u.state = y.CLOSE_TAG_SAW_WHITE);
            else {
              if ($(E))
                continue;
...
var Iu = qa, B0 = Ne, Cu = new B0("tag:yaml.org,2002:str", {
  kind: "scalar",
  construct: function(e) {
    return e !== null ? e : "";
  }
}), z0 = Ne, Ru = new z0("tag:yaml.org,2002:seq", {
  kind: "sequence",
  construct: function(e) {
    return e !== null ? e : [];
  }
}), j0 = Ne, Ou = new j0("tag:yaml.org,2002:map", {
  kind: "mapping",
  construct: function(e) {
    return e !== null ? e : {};
  }
...
var zu = new pg("tag:yaml.org,2002:timestamp", {
  kind: "scalar",
  resolve: hg,
  construct: mg,
  instanceOf: Date,
...
}), Ht = Ke, Wu = pn, Lg = N0, Ug = bs, Ct = Object.prototype.hasOwnProperty, di = 1, Vu = 2, Yu = 3, pi = 4, ma = 1, Mg = 2, Wo = 3, Bg = /[\x00-\x08\x0B\x0C\x0E-\x1F\x7F-\x84\x86-\x9F\uFFFE\uFFFF]|[\uD800-\uDBFF](?![\uDC00-\uDFFF])|(?:[^\uD800-\uDBFF]|^)[\uDC00-\uDFFF]/, zg = /[\x85\u2028\u2029]/, jg = /[,\[\]\{\}]/, Ku = /^(?:!|!!|![a-z\-]+!)$/i, Ju = /^(?:!|[^,\[\]\{\}])(?:%[0-9a-f]{2}|[0-9a-z\-#;\/\?:@&=\+\$,_\.!~\*'\(\)\[\]])*$/i;
function Vo(e) {
  ...
  for (e.kind = "scalar", e.result = "", e.position++, n = i = e.position; (r = e.input.charCodeAt(e.position)) !== 0; )
    if (r === 39)
      if (_t(e, n, e.position, !0), r = e.input.charCodeAt(++e.position), r === 39)
        ...
        return !0;
    else it(r) ? (_t(e, n, i, !0), As(e, fe(e, !1, t)), n = i = e.position) : e.position === e.lineStart && Ri(e) ? L(e, "unexpected end of the document within a single quoted scalar") : (e.position++, i = e.position);
...
function Kg(e, t) {
  ...
  for (e.kind = "scalar", e.result = "", e.position++, r = n = e.position; (o = e.input.charCodeAt(e.position)) !== 0; ) {
    ...
    if (o === 92) {
      if (_t(e, r, e.position, !0), o = e.input.charCodeAt(++e.position), it(o))
        fe(e, !1, t);
      else if (o < 256 && Zu[o])
      ...
      r = n = e.position;
    } else it(o) ? (_t(e, r, n, !0), As(e, fe(e, !1, t)), r = n = e.position) : e.position === e.lineStart && Ri(e) ? L(e, "unexpected end of the document within a double quoted scalar") : (e.position++, n = e.position);
  }
...
function Qg(e, t) {
  ...
  for (e.kind = "scalar", e.result = ""; f !== 0; )
    if (f = e.input.charCodeAt(++e.position), f === 43 || f === 45)
      ma === i ? i = f === 43 ? Wo : Mg : L(e, "repeat of a chomping mode identifier");
    else if ((c = qg(f)) >= 0)
...
function ny(e) {
  ...
  for (e.version = null, e.checkLineBreaks = e.legacy, e.tagMap = /* @__PURE__ */ Object.create(null), e.anchorMap = /* @__PURE__ */ Object.create(null); (s = e.input.charCodeAt(e.position)) !== 0 && (fe(e, !0, -1), s = e.input.charCodeAt(e.position), !(e.lineIndent > 0 || s !== 37)); ) {
    ...
    s !== 0 && Ss(e), Ct.call(Ko, n) ? Ko[n](e, n, i) : hi(e, 'unknown document directive "' + n + '"');
  }
...
Ts.loadAll = iy;
Ts.load = ay;
var nf = {}, Oi = Ke, hn = pn, sy = bs, af = Object.prototype.toString, sf = Object.prototype.hasOwnProperty, Is = 65279, oy = 9, Qr = 10, ly = 13, cy = 32, uy = 33, fy = 34, Xa = 35, dy = 37, py = 38, hy = 39, my = 42, of = 44, gy = 45, mi = 58, yy = 61, xy = 62, wy = 63, Ey = 64, lf = 91, cf = 93, vy = 96, uf = 123, Ty = 124, ff = 125, Ie = {};
Ie[0] = "\\0";
Ie[7] = "\\a";
Ie[8] = "\\b";
Ie[9] = "\\t";
...
function tl(e, t, r) {
  ...
  return (
    ...
    (r ? (
      // c = flow-in
      n
    ) : n && e !== of && e !== lf && e !== cf && e !== uf && e !== ff) && e !== Xa && !(t === mi && !i) || el(t) && !gi(t) && e === Xa || t === mi && i
  );
}
function Oy(e) {
  return en(e) && e !== Is && !gi(e) && e !== gy && e !== wy && e !== mi && e !== of && e !== lf && e !== cf && e !== uf && e !== ff && e !== Xa && e !== py && e !== my && e !== uy && e !== Ty && e !== yy && e !== xy && e !== hy && e !== fy && e !== dy && e !== Ey && e !== vy;
}
function Dy(e) {
  return !gi(e) && e !== mi;
}
...
function Py(e, t, r, n, i, a, s, o) {
  ...
  return !f && !h ? x && !s && !i(e) ? pf : a === Zr ? ur : Va : r > 9 && df(e) ? ur : s ? a === Zr ? ur : Va : h ? mf : hf;
}
...
function ft(e, t, r, n, i, a, s) {
  ...
  if (c && (f = e.duplicates.indexOf(r), h = f !== -1), (e.tag !== null && e.tag !== "?" || h || e.indent !== 2 && t > 0) && (i = !1), h && e.usedDuplicates[f])
    ...
    if (c && h && !e.usedDuplicates[f] && (e.usedDuplicates[f] = !0), o === "[object Object]")
      ...
      n && e.dump.length !== 0 ? (e.noArrayIndent && !s && t > 0 ? al(e, t - 1, e.dump, i) : al(e, t, e.dump, i), h && (e.dump = "&ref_" + f + e.dump)) : ($y(e, t, e.dump), h && (e.dump = "&ref_" + f + " " + e.dump));
...
const Un = ki, { MAX_LENGTH: ll, MAX_SAFE_INTEGER: Mn } = Pi, { safeRe: Bn, t: zn } = mn, Zy = Rs, { compareIdentifiers: ga } = wf;
let ex = class nt {
  constructor(t, r) {
...
var Os = Dx;
const Px = Os, kx = (e, t) => e.sort((r, n) => Px(r, n, t));
var Nx = kx;
const Fx = Os, $x = (e, t) => e.sort((r, n) => Fx(n, r, t));
var Lx = $x;
const Ux = Je, Mx = (e, t, r) => Ux(e, t, r) > 0;
var Ni = Mx;
const Bx = Je, zx = (e, t, r) => Bx(e, t, r) < 0;
var Ds = zx;
const jx = Je, Gx = (e, t, r) => jx(e, t, r) === 0;
var Ef = Gx;
...
var ks = Yx;
const Kx = Ef, Jx = vf, Qx = Ni, Zx = Ps, ew = Ds, tw = ks, rw = (e, t, r, n) => {
  switch (t) {
    case "===":
...
function Qe() {
  ...
  const r = lw, n = new r(), i = Rs, a = Fi(), s = ki, o = Fe, {
    ...
    return R.replace(D, (A, k, O, M, X, j) => {
      ...
      return k === "=" && Ze && (k = ""), j = I.includePrerelease ? "-0" : "", Z ? k === ">" || k === "<" ? A = "<0.0.0-0" : A = "*" : k && Ze ? (he && (M = 0), X = 0, k === ">" ? (k = ">=", he ? (O = +O + 1, M = 0, X = 0) : (M = +M + 1, X = 0)) : k === "<=" && (k = "<", he ? O = +O + 1 : M = +M + 1), k === "<" && (j = "-0"), A = `${k + O}.${M}.${X}${j}`) : he ? A = `>=${O}.0.0${j} <${+O + 1}.0.0-0` : U && (A = `>=${O}.${M}.0${j} <${O}.${+M + 1}.0-0`), s("xRange return", A), A;
    });
  }, q = (R, I) => (s("replaceStars", R, I), R.trim().replace(l[d.STAR], "")), z = (R, I) => (s("replaceGTE0", R, I), R.trim().replace(l[I.includePrerelease ? d.GTE0PRE : d.GTE0], "")), B = (R) => (I, D, A, k, O, M, X, j, Z, he, U, Ze) => (N(A) ? D = "" : N(k) ? D = `>=${A}.0.0${R ? "-0" : ""}` : N(O) ? D = `>=${A}.${k}.0${R ? "-0" : ""}` : M ? D = `>=${D}` : D = `>=${D}${R ? "-0" : ""}`, N(Z) ? j = "" : N(he) ? j = `<${+Z + 1}.0.0-0` : N(U) ? j = `<${Z}.${+he + 1}.0-0` : Ze ? j = `<=${Z}.${he}.${U}-${Ze}` : R ? j = `<${Z}.${he}.${+U + 1}-0` : j = `<=${j}`, `${D} ${j}`.trim()), Q = (R, I, D) => {
...
function Fi() {
  ...
  xa = t;
  const r = Rs, { safeRe: n, t: i } = mn, a = Tf, s = ki, o = Fe, l = Qe();
  return xa;
}
...
var vw = Ew;
const wa = Fe, Tw = Qe(), gl = Ni, _w = (e, t) => {
  e = new Tw(e, t);
  let r = new wa("0.0.0");
...
var Iw = Aw;
const Cw = Fe, _f = Fi(), { ANY: Rw } = _f, Ow = Qe(), Dw = $i, yl = Ni, xl = Ds, Pw = ks, kw = Ps, Nw = (e, t, r, n) => {
  ...
  for (let d = 0; d < t.set.length; ++d) {
    ...
    let f = null, h = null;
    if (c.forEach((g) => {
      g.semver === Rw && (g = new _f(">=0.0.0")), f = f || g, h = h || g, i(g.semver, f.semver, n) ? f = g : s(g.semver, h.semver, n) && (h = g);
...
const El = Qe(), Fs = Fi(), { ANY: Ea } = Fs, $r = $i, $s = Je, Xw = (e, t, r = {}) => {
  if (e === t)
    return !0;
  ...
  return !0;
}, Ww = [new Fs(">=0.0.0-0")], vl = [new Fs(">=0.0.0")], Vw = (e, t, r) => {
  if (e === t)
    return !0;
...
var Yw = Xw;
const va = mn, bl = Pi, Kw = Fe, Sl = wf, Jw = Ir, Qw = ix, Zw = ox, eE = cx, tE = fx, rE = hx, nE = yx, iE = Ex, aE = _x, sE = Je, oE = Ix, lE = Ox, cE = Os, uE = Nx, fE = Lx, dE = Ni, pE = Ds, hE = Ef, mE = vf, gE = Ps, yE = ks, xE = Tf, wE = sw, EE = Fi(), vE = Qe(), TE = $i, _E = pw, bE = yw, SE = vw, AE = bw, IE = Iw, CE = Ns, RE = Lw, OE = Bw, DE = jw, PE = qw, kE = Yw;
var bf = {
  parse: Jw,
  valid: Qw,
  clean: Zw,
...
(function(e, t) {
  ...
  var cd = Array.prototype, ud = Function.prototype, bn = Object.prototype, Ki = u["__core-js_shared__"], Xs = ud.toString, et = bn.hasOwnProperty, Ws = function() {
    var m = /[^.]+$/.exec(Ki && Ki.keys && Ki.keys.IE_PROTO || "");
    return m ? "Symbol(src)_1." + m : "";
  }(), Vs = bn.toString, fd = RegExp(
    "^" + Xs.call(et).replace(j, "\\$&").replace(/hasOwnProperty|(function).*?(?=\\\()| for .+?(?=\\\])/g, "$1.*?") + "$"
  ), Ys = K ? u.Buffer : void 0, Sn = u.Symbol, Ks = u.Uint8Array, Js = bn.propertyIsEnumerable, dd = cd.splice, Nt = Sn ? Sn.toStringTag : void 0, Qs = Object.getOwnPropertySymbols, pd = Ys ? Ys.isBuffer : void 0, hd = od(Object.keys, Object), Ji = rr(u, "DataView"), Or = rr(u, "Map"), Qi = rr(u, "Promise"), Zi = rr(u, "Set"), ea = rr(u, "WeakMap"), Dr = rr(Object, "create"), md = Lt(Ji), gd = Lt(Or), yd = Lt(Qi), xd = Lt(Zi), wd = Lt(ea), Zs = Sn ? Sn.prototype : void 0, ta = Zs ? Zs.valueOf : void 0;
  function Ft(m) {
  ...
  ht.prototype.clear = Ld, ht.prototype.delete = Ud, ht.prototype.get = Md, ht.prototype.has = Bd, ht.prototype.set = zd;
  function jd(m, w) {
    var C = Rn(m), F = !C && np(m), ne = !C && !F && ra(m), H = !C && !F && !ne && lo(m), ce = C || F || ne || H, me = ce ? We(m.length, String) : [], Ee = me.length;
    for (var ae in m)
  ...
  function to(m, w, C, F, ne) {
    return m === w ? !0 : m == null || w == null || !kr(m) && !kr(w) ? m !== m && w !== w : Hd(m, w, C, F, to, ne);
  }
  function Hd(m, w, C, F, ne, H) {
    ...
    if (be && !Me)
      return H || (H = new ht()), ce || lo(m) ? ro(m, w, C, F, ne, H) : Vd(m, w, Ee, C, F, ne, H);
    if (!(C & i)) {
      var je = Me && et.call(m, "__wrapped__"), Ge = Ve && et.call(w, "__wrapped__");
      if (je || Ge) {
        var gt = je ? m.value() : m, lt = Ge ? w.value() : w;
        return H || (H = new ht()), ne(gt, lt, C, F, H);
      }
    }
    return be ? (H || (H = new ht()), Yd(m, w, C, F, ne, H)) : !1;
  }
  function qd(m) {
    if (!oo(m) || ep(m))
      return !1;
    ...
    for (H.set(m, w), H.set(w, m); ++Me < me; ) {
      ...
      if (be) {
        if (!de(w, function(lt, Ut) {
          if (!Tn(be, Ut) && (je === lt || ne(je, lt, C, F, H)))
            return be.push(Ut);
        })) {
          Ve = !1;
          break;
  ...
  function Yd(m, w, C, F, ne, H) {
    ...
    for (var gt = ce; ++Ve < Ee; ) {
      ...
      var lt = m[be], Ut = w[be];
      if (F)
        var co = ce ? F(Ut, lt, be, w, m, H) : F(lt, Ut, be, m, w, H);
      if (!(co === void 0 ? lt === Ut || ne(lt, Ut, C, F, H) : co)) {
        Ge = !1;
        break;
      }
  ...
  var Jd = Qs ? function(m) {
    return m == null ? [] : (m = Object(m), _e(Qs(m), function(w) {
      return Js.call(m, w);
    }));
  } : op, mt = Pr;
  (Ji && mt(new Ji(new ArrayBuffer(1))) != B || Or && mt(new Or()) != x || Qi && mt(Qi.resolve()) != N || Zi && mt(new Zi()) != ue || ea && mt(new ea()) != q) && (mt = function(m) {
  ...
  var np = eo(/* @__PURE__ */ function() {
    return arguments;
  }()) ? eo : function(m) {
    return kr(m) && et.call(m, "callee") && !Js.call(m, "callee");
  }, Rn = Array.isArray;
  function ip(m) {
...
const FE = cn, $E = Dt, Al = NE, jt = Pt, qr = oe;
class LE {
  constructor(t) {
  ...
  async validateDownloadedPath(t, r, n, i) {
    if (this.versionInfo != null && this.file === t && this.fileInfo != null)
      return Al(this.versionInfo, r) && Al(this.fileInfo.info, n.info) && await (0, jt.pathExists)(t) ? t : null;
...
class pv extends Aa.Provider {
  ...
  async getLatestVersion() {
    const t = new kl.CancellationToken(), r = (0, Sa.getChannelFilename)(this.getCustomChannelName(this.channel)), n = (0, Sa.newUrlFromBase)(r, this.baseUrl, this.updater.isAddNoCacheQuery);
    try {
...
const ct = xe, pr = bf, hv = _r, hr = Xe, Qa = pe, Ia = /\/tag\/([^/]+)$/;
class Rf extends Qa.Provider {
  constructor(t, r, n) {
    super({
      ...n,
...
${o}`, "ERR_UPDATER_INVALID_RELEASE_FEED");
    ...
    const x = (0, Qa.parseUpdateInfo)(f, h, g);
...
class gv extends Ra.Provider {
  ...
  async getLatestVersion() {
    const t = new Fl.CancellationToken(), r = (0, Ca.getChannelFilename)(this.getCustomChannelName(this.channel)), n = (0, Ca.newUrlFromBase)(r, this.baseUrl, this.updater.isAddNoCacheQuery);
    try {
...
Ui.createClient = Av;
const Hn = xe, Tv = Mi, Ul = yn, _v = Ot, bv = Bi, Sv = zi;
function Df(e) {
...
Cr.copyData = Pf;
const qn = xe, Ov = Dt, Dv = ln, Pv = tr, zl = Buffer.from(`\r
\r
`);
var wt;
(function(e) {
...
function Fv(e, t, r, n, i) {
  ...
  for (let f = t.start; f < t.end; f++) {
    const h = t.tasks[f];
    h.kind === Gl.OperationKind.DOWNLOAD && (a += `${h.start}-${h.end - 1}, `, o.set(s, f), s++, l.push(h.end - h.start));
  }
  if (s <= 1) {
    const f = (h) => {
      if (h >= t.end) {
...
const Lr = xe, Oa = Pt, Uv = Dt, Mv = Cr, Bv = _r, Xn = tr, Hl = Gi, zv = Hi;
class jv {
  ...
  async doDownloadFile(t, r) {
    ...
    await new Promise((s, o) => {
      ...
      if (this.options.isUseMultipleRangeRequest) {
        g = (0, Hl.executeTasksUsingMultipleRangeRequests)(this, t, h, n, o), g(0);
        return;
      }
      let v = 0, x = null;
...
const Ce = xe, Xv = cn, Wv = Ti, Vv = _c, sr = Pt, Yv = Te, Da = Di, Mt = oe, Gt = bf, Xl = gn, Kv = Li, Wl = Sf, Jv = yn, Pa = Ui, Qv = Sc, Zv = Xe, eT = ji, or = kt;
...
const Yl = xe, Kl = vi, lT = Pt, cT = Dt, Ur = oe, uT = dt, fT = wn, dT = pe, Jl = kt;
...
const tc = xe, ka = Pt, _T = Dt, rc = oe, bT = mp, ST = At, AT = pe, nc = vi, ic = cn;
class IT extends ST.AppUpdater {
  ...
  async doDownloadUpdate(t) {
    ...
    try {
      ...
      const h = (0, nc.execFileSync)("uname", ["-a"], { encoding: "utf8" }).includes("ARM");
    ...
    return this.executeDownload({
      ...
      downloadUpdateOptions: t,
      task: async (f, h) => {
        const g = rc.join(this.downloadedUpdateHelper.cacheDir, c), v = () => (0, ka.pathExistsSync)(g) ? !t.disableDifferentialDownload : (n.info("Unable to locate previous update.zip for differential download (is this first install?), falling back to full download"), !1);
        let x = !0;
        ...
        if (!t.disableDifferentialDownload)
          try {
            const h = rc.join(this.downloadedUpdateHelper.cacheDir, c);
  ...
  async updateDownloaded(t, r) {
    ...
    return await new Promise((d, c) => {
      const f = (0, ic.randomBytes)(64).toString("base64").replace(/\//g, "_").replace(/\+/g, "-"), h = Buffer.from(`autoupdater:${f}`, "ascii"), g = `/${(0, ic.randomBytes)(64).toString("hex")}.zip`;
        ...
        if (c.Status === 0) {
          try {
            ...
            if (r.info(`LiteralPath: ${v}. Update Path: ${x}`), v !== x) {
              Na(r, new Error(`LiteralPath of ${v} is different than ${x}`), l, i), n(null);
              return;
            }
          } catch (v) {
          ...
          const h = (0, ac.parseDn)(c.SignerCertificate.Subject);
          let g = !1;
          for (const v of e) {
...
const Wn = xe, oc = oe, PT = dt, kT = wn, lc = kt, NT = pe, FT = Pt, $T = Ms, cc = _r;
...
const tt = Ar("tokenizer:inflate"), Fa = 256 * 1024, __ = jf(gr.DataDescriptor), Vn = jf(gr.EndOfCentralDirectory);
class zs {
  constructor(t) {
 ...
 * MIT Licensed
 */
var pc = /; *([!#$%&'*+.^_`|~0-9A-Za-z-]+) *= *("(?:[\u000b\u0020\u0021\u0023-\u005b\u005d-\u007e\u0080-\u00ff]|\\[\u000b\u0020-\u00ff])*"|[!#$%&'*+.^_`|~0-9A-Za-z-]+) */g, B_ = /^[\u000b\u0020-\u007e\u0080-\u00ff]+$/, Hf = /^[!#$%&'*+.^_`|~0-9A-Za-z-]+$/, z_ = /\\([\u000b\u0020-\u00ff])/g, j_ = /([\\"])/g, qf = /^[!#$%&'*+.^_`|~0-9A-Za-z-]+\/[!#$%&'*+.^_`|~0-9A-Za-z-]+$/;
js.format = G_;
js.parse = H_;
function G_(e) {
...
const $b = {
  ...
  async load() {
    return (await import("./MpegParser-DYCiFoIr.js")).MpegParser;
  }
}, Lb = {
  parserType: "apev2",
  extensions: [".ape"],
  ...
  async load() {
    return (await import("./AsfParser-mzCorAaL.js")).AsfParser;
  }
}, Mb = {
  parserType: "dsdiff",
  extensions: [".dff"],
  ...
  async load() {
    return (await import("./DsdiffParser-BW4Y-tqD.js")).DsdiffParser;
  }
}, Bb = {
  parserType: "aiff",
  ...
  async load() {
    return (await import("./AiffParser-CuHn0nVQ.js")).AIFFParser;
  }
}, zb = {
  parserType: "dsf",
  extensions: [".dsf"],
  mimeTypes: ["audio/dsf"],
  async load() {
    return (await import("./DsfParser-CPXOwchT.js")).DsfParser;
  }
}, jb = {
  parserType: "flac",
  extensions: [".flac"],
  ...
  async load() {
    return (await import("./FlacParser-C96Off7p.js").then((e) => e.d)).FlacParser;
  }
}, Gb = {
  parserType: "matroska",
  ...
  async load() {
    return (await import("./MatroskaParser-DCg564XP.js")).MatroskaParser;
  }
}, Hb = {
  parserType: "mp4",
  ...
  async load() {
    return (await import("./MP4Parser-CZlor05Z.js")).MP4Parser;
  }
}, qb = {
  parserType: "musepack",
  extensions: [".mpc"],
  ...
  async load() {
    return (await import("./MusepackParser-BwfguejM.js")).MusepackParser;
  }
}, Xb = {
  parserType: "ogg",
  ...
  async load() {
    return (await import("./OggParser-CgenQTIU.js")).OggParser;
  }
}, Wb = {
  parserType: "wavpack",
  extensions: [".wv", ".wvp"],
  ...
  async load() {
    return (await import("./WavPackParser-CCJvQP9f.js")).WavPackParser;
  }
}, Vb = {
  parserType: "riff",
  ...
  async load() {
    return (await import("./WaveParser-CgQRTjtW.js")).WaveParser;
  }
...
class Kb {
  ...
  async parse(t, r, n) {
    if (t.supportsRandomAccess() ? (zt("tokenizer supports random-access, scanning for appending headers"), await xS(t, n)) : zt("tokenizer does not support random-access, cannot scan for appending headers"), !r) {
...
const xt = Ar("music-metadata:parser:APEv2"), yc = "APEv2", xc = "APETAGEX";
...
class bt extends Qf {
  ...
  static async findApeFooterOffset(t, r) {
    ...
    if (r <= Be.len) {
      xt(`Offset is too small to read APE footer: offset=${r}`);
      return;
    }
    if (r > Be.len) {
      ...
      const a = Be.get(n, 0);
      if (a.ID === "APETAGEX")
        return a.flags.isHeader ? xt(`APE Header found at offset=${r - Be.len}`) : (xt(`APE Footer found at offset=${r - Be.len}`), r -= a.size), { footer: a, offset: r };
    }
  }
  ...
  async tryParseApeHeader() {
    if (this.tokenizer.fileInfo.size && this.tokenizer.fileInfo.size - this.tokenizer.position < Be.len) {
      xt("No APEv2 header found, end-of-file reached");
      return;
    }
    const t = await this.tokenizer.peekToken(Be);
    if (t.ID === xc)
      return await this.tokenizer.ignore(Be.len), this.parseTags(t);
    if (xt(`APEv2 header not found at offset=${this.tokenizer.position}`), this.tokenizer.fileInfo.size) {
  ...
  async parseTags(t) {
    ...
    let n = t.size - Be.len;
    xt(`Parse APE tags at offset=${this.tokenizer.position}, size=${n}`);
    for (let i = 0; i < t.fields; i++) {
      ...
      switch (await this.tokenizer.ignore(1), n -= o.length + 1, a.flags.dataType) {
        ...
        case Jn.external_info:
          xt(`Ignore external info ${o}`), await this.tokenizer.ignore(a.size);
          break;
        case Jn.reserved:
          xt(`Ignore external info ${o}`), this.metadata.addWarning(`APEv2 header declares a reserved datatype for "${o}"`), await this.tokenizer.ignore(a.size);
          break;
      }
    }
  }
...
const id = qe.dirname(fp(import.meta.url));
process.env.APP_ROOT = qe.join(id, "..");
const os = process.env.VITE_DEV_SERVER_URL, rA = qe.join(process.env.APP_ROOT, "dist-electron"), ad = qe.join(process.env.APP_ROOT, "dist");
process.env.VITE_PUBLIC = os ? qe.join(process.env.APP_ROOT, "public") : ad;
let J;
function sd() {
  J = new vc({
    width: 1200,
    ...
    webPreferences: {
      preload: qe.join(id, "preload.mjs"),
      webSecurity: !1,
  ...
  }), os ? J.loadURL(os) : J.loadFile(qe.join(ad, "index.html"));
}
...
St.whenReady().then(() => {
  sd(), He.handle("dialog:openDirectory", async () => {
    const { canceled: e, filePaths: t } = await uo.showOpenDialog(J, {
      properties: ["openDirectory"]
    });
    return e ? null : t[0];
  }), He.handle("files:listMusic", async (e, t) => {
    if (!t) return [];
    try {
      const r = await po.readdir(t), n = [".mp3", ".wav", ".wma", ".m4a", ".flac", ".ogg", ".mp4", ".mov", ".wmv", ".avi"];
      return r.filter((i) => n.includes(qe.extname(i).toLowerCase())).map((i) => qe.join(t, i));
    } catch (r) {
      return console.error("Error reading directory:", r), [];
    }
  }), He.handle("files:readBuffer", async (e, t) => {
    try {
      return await po.readFile(t);
    } catch (r) {
      return console.error("Error reading file:", r), null;
    }
  }), He.handle("files:getMetadata", async (e, t) => {
    try {
      const r = await wS(t);
      return {
  ...
  }), He.handle("app:active-window", async () => {
    const e = qe.join(process.env.APP_ROOT, "scripts/get-active-window.ps1");
    return await ES(e);
  }), He.handle("search:youtube", async (e, t) => {
    try {
      return (await fo(import.meta.url)("yt-search")(t)).videos.slice(0, 20).map((a) => ({
        id: a.videoId,
        title: a.title,
  ...
  }), He.handle("download:youtube", async (e, t, r) => {
    try {
      const n = fo(import.meta.url), i = n("fs"), a = n("@distube/ytdl-core");
      if (!a.validateURL(t)) throw new Error("無效的 YouTube 網址");
      let s;
      try {
        s = await a.getInfo(t);
      } catch (d) {
        throw console.error("Info Fetch Error:", d), new Error("無法取得影片資訊 (可能受限或連結無效)");
      }
      const o = (s.videoDetails.title || r).replace(/[\\/:*?"<>|]/g, "_").trim(), { filePath: l } = await uo.showSaveDialog(J, {
        title: "下載歌曲",
        defaultPath: `${o}.mp3`,
        filters: [{ name: "Audio", extensions: ["mp3"] }]
      });
      return l ? new Promise((d, c) => {
        const f = a.downloadFromInfo(s, {
          quality: "highestaudio"
        }), h = i.createWriteStream(l);
        f.pipe(h), f.on("error", (g) => {
          console.error("Download Stream Error:", g), c(new Error(`串流錯誤: ${g.message}`));
        }), h.on("finish", () => d(l)), h.on("error", (g) => {
          console.error("File Write Error:", g), c(new Error(`寫入錯誤: ${g.message}`));
        });
      }) : null;
    } catch (n) {
      throw console.error("Download fatal error:", n), new Error(n.message);
    }
  }), He.handle("search:artistImage", async (e, t) => {
    try {
      const r = `https://api.deezer.com/search/artist?q=${encodeURIComponent(t)}&limit=1`;
      try {
        const a = await fetch(r);
        if (a.ok) {
          const s = await a.json();
          if (s && s.data && s.data.length > 0) {
            const o = s.data[0].picture_medium || s.data[0].picture_big;
            if (o) return o;
          }
        }
      } catch {
      }
      const n = `https://itunes.apple.com/search?term=${encodeURIComponent(t)}&media=music&entity=album&limit=1`, i = await fetch(n);
      if (i.ok) {
        const a = await i.json();
        if (a && a.results && a.results.length > 0) {
          const s = a.results[0].artworkUrl100;
          if (s)
            return s.replace("100x100bb", "600x600bb");
        }
      }
      try {
        const a = `https://www.theaudiodb.com/api/v1/json/2/search.php?s=${encodeURIComponent(t)}`, s = await fetch(a);
        if (s.ok) {
          const o = await s.json();
          if (o && o.artists && o.artists.length > 0) {
            const l = o.artists[0], d = l.strArtistThumb || l.strArtistFanart;
            if (d) return d;
          }
        }
      } catch {
      ...
      return console.error("Error fetching artist image:", r), null;
    }
  }), He.handle("search:lyrics", async (e, t, r, n) => {
    try {
      if (!(!t || !r || t.includes("Unknown") || r.includes("Unknown"))) {
        const a = `https://lrclib.net/api/get?artist_name=${encodeURIComponent(r)}&track_name=${encodeURIComponent(t)}`, s = await fetch(a);
        if (s.ok) {
          const o = await s.json();
          return o.syncedLyrics || o.plainLyrics || null;
        }
      }
      if (n) {
        const a = qe.basename(n, qe.extname(n)), s = `https://lrclib.net/api/search?q=${encodeURIComponent(a)}`, o = await fetch(s);
        if (o.ok) {
          const l = await o.json();
          if (l && l.length > 0) {
            const d = l.find((c) => c.syncedLyrics) || l[0];
      ...
      return console.error("Error fetching lyrics:", i), null;
    }
  }), He.handle("update:check", () => {
    at.autoUpdater.checkForUpdatesAndNotify();
  }), He.handle("update:install", () => {
    at.autoUpdater.quitAndInstall(!0, !0);
  }), He.handle("app:version", () => St.getVersion());
});
export {
  QS as A,
  Qf as B,
