...
function fy(e, t, r) {
  ...
  for (e.anchor !== null && (e.anchorMap[e.anchor] = u), _ = e.input.charCodeAt(e.position); _ !== 0; ) {
    if (!T && e.firstTabInLine !== -1 && (e.position = e.firstTabInLine, G(e, "tab characters must not be used in indentation")), n = e.input.charCodeAt(e.position + 1), a = e.line, (_ === 63 || _ === 58) && Be(n))
      _ === 63 ? (T && (pr(e, u, p, m, E, null, s, o, l), m = E = w = null), b = !0, T = !0, i = !0) : T ? (T = !1, i = !0) : G(e, "incomplete explicit mapping pair; a key node is missed; or followed by a non-tabulated empty line"), e.position += 1, _ = n;
    else {
      ...
      if (e.line === a) {
        ...
        if (_ === 58)
          _ = e.input.charCodeAt(++e.position), Be(_) || G(e, "a whitespace character is expected after the key-value separator within a block mapping"), T && (pr(e, u, p, m, E, null, s, o, l), m = E = w = null), b = !0, T = !1, i = !1, m = e.tag, E = e.result;
        else if (b)
...
function _r(e, t, r, n, i) {
  ...
  if (o && (o = d || i), (l === 1 || yi === r) && (gi === r || ef === r ? w = t : w = t + 1, T = e.position - e.lineStart, l === 1 ? o && (nl(e, T) || fy(e, T, w)) || cy(e, w) ? c = !0 : (s && uy(e, w) || oy(e, w) || ly(e, w) ? c = !0 : hy(e) ? (c = !0, (e.tag !== null || e.anchor !== null) && G(e, "alias node should not have any properties")) : sy(e, w, gi === r) && (c = !0, e.tag === null && (e.tag = "?")), e.anchor !== null && (e.anchorMap[e.anchor] = e.result)) : l === 0 && (c = o && nl(e, T))), e.tag === null)
    ...
    E || G(e, "unknown tag !<" + e.tag + ">"), e.result !== null && E.kind !== e.kind && G(e, "unacceptable node kind for !<" + e.tag + '> tag; it should be "' + E.kind + '", not "' + e.kind + '"'), E.resolve(e.result, e.tag) ? (e.result = E.construct(e.result, e.tag), e.anchor !== null && (e.anchorMap[e.anchor] = e.result)) : G(e, "cannot resolve a node with !<" + e.tag + "> explicit tag");
  }
...
function Hy(e, t, r, n, i, a, s, o) {
  var l, d = 0, c = null, u = !1, p = !1, m = n !== -1, E = -1, w = Gy(jr(e, 0)) && zy(jr(e, e.length - 1));
  if (t || s)
...
function et() {
  ...
  const r = Ex, n = new r(), i = Ns, a = Bi(), s = Ui, o = Ue, {
    ...
    return R.replace(O, (F, P, q, K, X) => {
      s("caret", R, F, P, q, K, X);
      let te;
      return N(P) ? te = "" : N(q) ? te = `>=${P}.0.0${A} <${+P + 1}.0.0-0` : N(K) ? P === "0" ? te = `>=${P}.${q}.0${A} <${P}.${+q + 1}.0-0` : te = `>=${P}.${q}.0${A} <${+P + 1}.0.0-0` : X ? (s("replaceCaret pr", X), P === "0" ? q === "0" ? te = `>=${P}.${q}.${K}-${X} <${P}.${q}.${+K + 1}-0` : te = `>=${P}.${q}.${K}-${X} <${P}.${+q + 1}.0-0` : te = `>=${P}.${q}.${K}-${X} <${+P + 1}.0.0-0`) : (s("no pr"), P === "0" ? q === "0" ? te = `>=${P}.${q}.${K}${A} <${P}.${q}.${+K + 1}-0` : te = `>=${P}.${q}.${K}${A} <${P}.${+q + 1}.0-0` : te = `>=${P}.${q}.${K} <${+P + 1}.0.0-0`), s("caret return", te), te;
    });
    ...
    return R.replace(O, (A, F, P, q, K, X) => {
      ...
      const te = N(P), ge = te || N(q), H = ge || N(K), tt = H;
      return F === "=" && tt && (F = ""), X = S.includePrerelease ? "-0" : "", te ? F === ">" || F === "<" ? A = "<0.0.0-0" : A = "*" : F && tt ? (ge && (q = 0), K = 0, F === ">" ? (F = ">=", ge ? (P = +P + 1, q = 0, K = 0) : (q = +q + 1, K = 0)) : F === "<=" && (F = "<", ge ? P = +P + 1 : q = +q + 1), F === "<" && (X = "-0"), A = `${F + P}.${q}.${K}${X}`) : ge ? A = `>=${P}.0.0${X} <${+P + 1}.0.0-0` : H && (A = `>=${P}.${q}.0${X} <${P}.${+q + 1}.0-0`), s("xRange return", A), A;
    });
  }, M = (R, S) => (s("replaceStars", R, S), R.trim().replace(l[d.STAR], "")), j = (R, S) => (s("replaceGTE0", R, S), R.trim().replace(l[S.includePrerelease ? d.GTE0PRE : d.GTE0], "")), U = (R) => (S, O, A, F, P, q, K, X, te, ge, H, tt) => (N(A) ? O = "" : N(F) ? O = `>=${A}.0.0${R ? "-0" : ""}` : N(P) ? O = `>=${A}.${F}.0${R ? "-0" : ""}` : q ? O = `>=${O}` : O = `>=${O}${R ? "-0" : ""}`, N(te) ? X = "" : N(ge) ? X = `<${+te + 1}.0.0-0` : N(H) ? X = `<${te}.${+ge + 1}.0-0` : tt ? X = `<=${te}.${ge}.${H}-${tt}` : R ? X = `<${te}.${ge}.${+H + 1}-0` : X = `<=${X}`, `${O} ${X}`.trim()), Y = (R, S, O) => {
...
(function(e, t) {
  ...
  function mt(g, x) {
    for (var I = -1, L = x.length, oe = g.length; ++I < L; )
      g[oe + I] = x[I];
    return g;
  }
  function he(g, x) {
  ...
  function Pd(g) {
    var x = this.__data__;
    return Dr ? x[g] !== void 0 : rt.call(x, g);
  }
  function Od(g, x) {
    var I = this.__data__;
    return this.size += this.has(g) ? 0 : 1, I[g] = Dr && x === void 0 ? n : x, this;
  }
  ...
  function kd(g) {
    var x = this.__data__, I = In(x, g);
    if (I < 0)
      return !1;
    var L = x.length - 1;
    return I == L ? x.pop() : xd.call(x, I, 1), --this.size, !0;
  }
  function Nd(g) {
    var x = this.__data__, I = In(x, g);
    return I < 0 ? void 0 : x[I][1];
  }
  function Fd(g) {
  ...
  function $d(g, x) {
    ...
    return L < 0 ? (++this.size, I.push([g, x])) : I[L][1] = x, this;
  }
  ...
  function qd(g) {
    var x = this.__data__, I = x.delete(g);
    return this.size = x.size, I;
  }
  function Xd(g) {
  ...
  function Vd(g, x) {
    ...
    if (I instanceof ct) {
      var L = I.__data__;
      if (!Or || L.length < r - 1)
        return L.push([g, x]), this.size = ++I.size, this;
      I = this.__data__ = new Lt(L);
    }
    return I.set(g, x), this.size = I.size, this;
  }
  ...
  function so(g, x, I, L, oe) {
    return g === x ? !0 : g == null || x == null || !Nr(g) && !Nr(x) ? g !== g && x !== x : Jd(g, x, I, L, so, oe);
  }
  function Jd(g, x, I, L, oe, V) {
    var de = Pn(g), ye = Pn(x), Te = de ? l : yt(g), le = ye ? l : yt(x);
    ...
    if (Ae && !je)
      return V || (V = new gt()), de || ho(g) ? oo(g, x, I, L, oe, V) : tp(g, x, Te, I, L, oe, V);
    if (!(I & i)) {
      var He = je && rt.call(g, "__wrapped__"), qe = Ke && rt.call(x, "__wrapped__");
      if (He || qe) {
        var wt = He ? g.value() : g, ut = qe ? x.value() : x;
        return V || (V = new gt()), oe(wt, ut, I, L, V);
      }
    }
    return Ae ? (V || (V = new gt()), rp(g, x, I, L, oe, V)) : !1;
  }
  function Qd(g) {
    if (!po(g) || op(g))
      return !1;
  ...
  function ep(g) {
    ...
    for (var I in Object(g))
      rt.call(g, I) && I != "constructor" && x.push(I);
    return x;
  }
  function oo(g, x, I, L, oe, V) {
    var de = I & i, ye = g.length, Te = x.length;
    if (ye != Te && !(de && Te > ye))
      return !1;
    var le = V.get(g);
    if (le && V.get(x))
    ...
    return V.delete(g), V.delete(x), Ke;
  }
  function tp(g, x, I, L, oe, V, de) {
    switch (I) {
      case U:
  ...
  function rp(g, x, I, L, oe, V) {
    var de = I & i, ye = lo(g), Te = ye.length, le = lo(x), je = le.length;
    if (Te != je && !de)
      return !1;
    for (var Ke = Te; Ke--; ) {
      var Ae = ye[Ke];
    ...
    if (qe && !wt) {
      var On = g.constructor, Dn = x.constructor;
      On != Dn && "constructor" in g && "constructor" in x && !(typeof On == "function" && On instanceof On && typeof Dn == "function" && Dn instanceof Dn) && (qe = !1);
    }
  ...
  function Rn(g, x) {
    var I = g.__data__;
    return sp(x) ? I[typeof x == "string" ? "string" : "hash"] : I.map;
  }
  function nr(g, x) {
    var I = Pr(g, x);
  ...
  function np(g) {
    ...
    var oe = Zs.call(g);
    return L && (x ? g[Ft] = I : delete g[Ft]), oe;
  }
  ...
  (ra && yt(new ra(new ArrayBuffer(1))) != U || Or && yt(new Or()) != w || na && yt(na.resolve()) != N || ia && yt(new ia()) != D || aa && yt(new aa()) != M) && (yt = function(g) {
    var x = kr(g), I = x == _ ? g.constructor : void 0, L = I ? Ut(I) : "";
    if (L)
      switch (L) {
        case Td:
          return U;
  ...
  function lp(g) {
    var x = g && g.constructor, I = typeof x == "function" && x.prototype || Sn;
    return g === I;
  }
  function cp(g) {
    return Zs.call(g);
...
class zs extends sT.EventEmitter {
  ...
  async executeDownload(t) {
    ...
    try {
      ...
      throw await T(), _ instanceof Oe.CancellationError && (E.info("cancelled"), this.emit("update-cancelled", i)), _;
    }
    ...
    return await new Promise((d, c) => {
      ...
      this.server.on("request", (E, w) => {
        ...
        if (s.info(`${T} requested`), T === "/") {
          ...
          const N = E.headers.authorization.split(" ")[1], $ = Buffer.from(N, "base64").toString("ascii"), [B, D] = $.split(":");
...
const Vb = {
  ...
  async load() {
    return (await import("./MpegParser-B3Sx0pwW.js")).MpegParser;
  }
}, Yb = {
  parserType: "apev2",
  extensions: [".ape"],
  ...
  async load() {
    return (await import("./AsfParser-DSLq_4w3.js")).AsfParser;
  }
}, Jb = {
  parserType: "dsdiff",
  extensions: [".dff"],
  ...
  async load() {
    return (await import("./DsdiffParser-DAE-GEMm.js")).DsdiffParser;
  }
}, Qb = {
  parserType: "aiff",
  ...
  async load() {
    return (await import("./AiffParser-CO_wmpcb.js")).AIFFParser;
  }
}, Zb = {
  parserType: "dsf",
  extensions: [".dsf"],
  mimeTypes: ["audio/dsf"],
  async load() {
    return (await import("./DsfParser-ltDRK_7i.js")).DsfParser;
  }
}, eS = {
  parserType: "flac",
  extensions: [".flac"],
  ...
  async load() {
    return (await import("./FlacParser-B_myNPXX.js").then((e) => e.d)).FlacParser;
  }
}, tS = {
  parserType: "matroska",
  ...
  async load() {
    return (await import("./MatroskaParser-JfcB7btX.js")).MatroskaParser;
  }
}, rS = {
  parserType: "mp4",
  ...
  async load() {
    return (await import("./MP4Parser-B6E_ycia.js")).MP4Parser;
  }
}, nS = {
  parserType: "musepack",
  extensions: [".mpc"],
  ...
  async load() {
    return (await import("./MusepackParser-BZ-3mx1I.js")).MusepackParser;
  }
}, iS = {
  parserType: "ogg",
  ...
  async load() {
    return (await import("./OggParser-mY75aExX.js")).OggParser;
  }
}, aS = {
  parserType: "wavpack",
  extensions: [".wv", ".wvp"],
  ...
  async load() {
    return (await import("./WavPackParser-DMt_K4wp.js")).WavPackParser;
  }
}, sS = {
  parserType: "riff",
  ...
  async load() {
    return (await import("./WaveParser-C4h8StEK.js")).WaveParser;
  }
