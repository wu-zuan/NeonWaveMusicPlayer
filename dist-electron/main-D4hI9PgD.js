...
var Ye = (e, t, r) => yp(e, typeof t != "symbol" ? t + "" : t, r);
import Jt, { app as Je, BrowserWindow as Ic, Notification as wp, ipcMain as ne, dialog as yo } from "electron";
import { createRequire as ai } from "node:module";
import { fileURLToPath as xp } from "node:url";
import Oe from "node:path";
import Fn, { open as Ep } from "node:fs/promises";
import Pt from "fs";
...
import { Client as Sp, GatewayIntentBits as wo, ChannelType as xo } from "discord.js";
import { createAudioPlayer as Ap, AudioPlayerStatus as ir, joinVoiceChannel as Ip, createAudioResource as $r, StreamType as ca } from "@discordjs/voice";
...
var xt = vp, Dp = process.cwd, si = null, Op = process.env.GRACEFUL_FS_PLATFORM || process.platform;
process.cwd = function() {
  return si || (si = Dp.call(process)), si;
};
try {
  process.cwd();
} catch {
...
if (typeof process.chdir == "function") {
  var Eo = process.chdir;
  process.chdir = function(e) {
    si = null, Eo.call(process, e);
...
function kp(e) {
  xt.hasOwnProperty("O_SYMLINK") && process.version.match(/^v0\.6\.[0-2]|^v0\.5\./) && t(e), e.lutimes || r(e), e.chown = a(e.chown), e.fchown = a(e.fchown), e.lchown = a(e.lchown), e.chmod = n(e.chmod), e.fchmod = n(e.fchmod), e.lchmod = n(e.lchmod), e.chownSync = s(e.chownSync), e.fchownSync = s(e.fchownSync), e.lchownSync = s(e.lchownSync), e.chmodSync = i(e.chmodSync), e.fchmodSync = i(e.fchmodSync), e.lchmodSync = i(e.lchmodSync), e.stat = o(e.stat), e.fstat = o(e.fstat), e.lstat = o(e.lstat), e.statSync = l(e.statSync), e.fstatSync = l(e.fstatSync), e.lstatSync = l(e.lstatSync), e.chmod && !e.lchmod && (e.lchmod = function(c, u, p) {
  ...
  }), Op === "win32" && (e.rename = typeof e.rename != "function" ? e.rename : function(c) {
    function u(p, m, x) {
      var w = Date.now(), T = 0;
      c(p, m, function b(_) {
    ...
    function u(p, m, x, w, T, b) {
      var _;
      if (b && typeof b == "function") {
        var N = 0;
        _ = function($, B, P) {
          if ($ && $.code === "EAGAIN" && N < 10)
            return N++, c.call(e, p, m, x, w, T, _);
          b.apply(this, arguments);
        };
      }
      return c.call(e, p, m, x, w, T, _);
    }
    return Object.setPrototypeOf && Object.setPrototypeOf(u, c), u;
  }(e.read), e.readSync = typeof e.readSync != "function" ? e.readSync : /* @__PURE__ */ function(c) {
    return function(u, p, m, x, w) {
      for (var T = 0; ; )
        try {
          return c.call(e, u, p, m, x, w);
        } catch (b) {
  ...
  function t(c) {
    c.lchmod = function(u, p, m) {
      ...
      var m = c.openSync(u, xt.O_WRONLY | xt.O_SYMLINK, p), x = !0, w;
      try {
        w = c.fchmodSync(m, p), x = !1;
      } finally {
        if (x)
          try {
            c.closeSync(m);
  ...
  function r(c) {
    xt.hasOwnProperty("O_SYMLINK") && c.futimes ? (c.lutimes = function(u, p, m, x) {
      ...
      return w;
    }) : c.futimes && (c.lutimes = function(u, p, m, x) {
  ...
  function n(c) {
    return c && function(u, p, m) {
      return c.call(e, u, p, function(x) {
        d(x) && (x = null), m && m.apply(this, arguments);
      });
    };
  }
  function i(c) {
...
function Fp(e) {
  ...
  function r(n, i) {
    ...
    vo.call(this), this.path = n, this.fd = null, this.writable = !0, this.flags = "w", this.encoding = "binary", this.mode = 438, this.bytesWritten = 0, i = i || {};
...
var ce = Pt, Mp = Pp, Bp = Np, jp = $p, $n = hs, _e, fi;
typeof Symbol == "function" && typeof Symbol.for == "function" ? (_e = Symbol.for("graceful-fs.queue"), fi = Symbol.for("graceful-fs.previous")) : (_e = "___graceful-fs.queue", fi = "___graceful-fs.previous");
function zp() {
}
function Pc(e, t) {
...
var Vt = zp;
$n.debuglog ? Vt = $n.debuglog("gfs4") : /\bgfs4\b/i.test(process.env.NODE_DEBUG || "") && (Vt = function() {
...
if (!ce[_e]) {
  var Gp = Pe[_e] || [];
  Pc(ce, Gp), ce.close = function(e) {
    function t(r, n) {
      return e.call(ce, r, function(i) {
        i || To(), typeof n == "function" && n.apply(this, arguments);
      });
    }
...
Pe[_e] || Pc(Pe, ce[_e]);
var $e = ms(jp(ce));
process.env.TEST_GRACEFUL_FS_GLOBAL_PATCH && !ce.__patched && ($e = ms(ce), ce.__patched = !0);
function ms(e) {
  Mp(e), e.gracefulify = ms, e.createReadStream = B, e.createWriteStream = P;
  var t = e.readFile;
  e.readFile = r;
  function r(y, M, j) {
    ...
    function U(Y, R, S, O) {
      return t(Y, R, function(A) {
        A && (A.code === "EMFILE" || A.code === "ENFILE") ? ar([U, [Y, R, S], A, O || Date.now(), Date.now()]) : typeof S == "function" && S.apply(this, arguments);
      });
    }
  }
  var n = e.writeFile;
  ...
  function i(y, M, j, U) {
    ...
    function Y(R, S, O, A, F) {
      return n(R, S, O, function(D) {
        D && (D.code === "EMFILE" || D.code === "ENFILE") ? ar([Y, [R, S, O, A], D, F || Date.now(), Date.now()]) : typeof A == "function" && A.apply(this, arguments);
      });
    }
  }
  var a = e.appendFile;
  ...
  function u(y, M, j) {
    ...
    var U = c.test(process.version) ? function(S, O, A, F) {
      return d(S, Y(
        S,
        O,
        A,
    ...
    function Y(R, S, O, A) {
      return function(F, D) {
        F && (F.code === "EMFILE" || F.code === "ENFILE") ? ar([
          U,
          [R, S, O],
          F,
          A || Date.now(),
          Date.now()
        ]) : (D && D.sort && D.sort(), typeof O == "function" && O.call(this, F, D));
      };
    }
  }
  ...
  var x = e.WriteStream;
  x && (N.prototype = Object.create(x.prototype), N.prototype.open = $), Object.defineProperty(e, "ReadStream", {
    get: function() {
      return b;
    },
    set: function(y) {
  ...
  function N(y, M) {
    return this instanceof N ? (x.apply(this, arguments), this) : N.apply(Object.create(N.prototype), arguments);
  }
  function $() {
    var y = this;
    ae(y.path, y.flags, y.mode, function(M, j) {
...
function ar(e) {
  Vt("ENQUEUE", e[0].name, e[1]), ce[_e].push(e), gs();
}
var Ln;
function To() {
...
function gs() {
  if (clearTimeout(Ln), Ln = void 0, ce[_e].length !== 0) {
...
(function(e) {
  ...
  Object.assign(e, r), n.forEach((i) => {
    ...
    return typeof d == "function" ? r.read(i, a, s, o, l, d) : new Promise((c, u) => {
      r.read(i, a, s, o, l, (p, m, x) => {
        if (p) return u(p);
        c({ bytesRead: m, buffer: x });
      });
    });
...
var ys = {}, kc = {};
const Hp = ue;
kc.checkPath = function(t) {
  if (process.platform === "win32" && /[<>:"|?*]/.test(t.replace(Hp.parse(t).root, ""))) {
    const n = new Error(`Path contains invalid characters: ${t}`);
    throw n.code = "EINVAL", n;
  }
};
const Nc = er, { checkPath: Fc } = kc, $c = (e) => {
  const t = { mode: 511 };
  return typeof e == "number" ? e : { ...t, ...e }.mode;
};
ys.makeDir = async (e, t) => (Fc(e), Nc.mkdir(e, {
  mode: $c(t),
  recursive: !0
}));
ys.makeDirSync = (e, t) => (Fc(e), Nc.mkdirSync(e, {
  mode: $c(t),
  recursive: !0
}));
const qp = Fe.fromPromise, { makeDir: Xp, makeDirSync: ua } = ys, fa = qp(Xp);
var lt = {
  mkdirs: fa,
  mkdirsSync: ua,
  // alias
...
function Zp(e, t, r) {
  let n;
  const i = r.dereference ? (s) => vr.statSync(s, { bigint: !0 }) : (s) => vr.lstatSync(s, { bigint: !0 }), a = i(e);
  try {
    n = i(t);
  } catch (s) {
...
function eh(e, t, r, n, i) {
  Jp.callbackify(Qp)(e, t, n, (a, s) => {
    ...
    return o.isDirectory() && ws(e, t) ? i(new Error(Ri(e, t, r))) : i(null, { srcStat: o, destStat: l });
  });
}
function th(e, t, r, n) {
...
function Mc(e, t, r, n, i) {
  ...
  vr.stat(s, { bigint: !0 }, (o, l) => o ? o.code === "ENOENT" ? i() : i(o) : pn(t, l) ? i(new Error(Ri(e, r, n))) : Mc(e, t, s, n, i));
}
function Bc(e, t, r, n) {
...
const Me = $e, Yr = ue, rh = lt.mkdirs, nh = tr.pathExists, ih = Uc.utimesMillis, Kr = Ar;
function ah(e, t, r, n) {
  typeof r == "function" && !n ? (n = r, r = {}) : typeof r == "function" && (r = { filter: r }), n = n || function() {
    ...
    "Warning",
    "fs-extra-WARN0001"
  ), Kr.checkPaths(e, t, "copy", r, (i, a) => {
    if (i) return n(i);
    const { srcStat: s, destStat: o } = a;
    Kr.checkParentPaths(e, s, t, "copy", (l) => l ? n(l) : r.filter ? jc(_o, o, e, t, r, n) : _o(o, e, t, r, n));
  });
}
function _o(e, t, r, n, i) {
  const a = Yr.dirname(r);
  nh(a, (s, o) => {
    if (s) return i(s);
    if (o) return di(e, t, r, n, i);
    rh(a, (l) => l ? i(l) : di(e, t, r, n, i));
  });
}
...
function sh(e, t, r, n, i) {
  return n.filter ? jc(di, e, t, r, n, i) : di(e, t, r, n, i);
}
...
function zc(e, t, r, n, i) {
  Me.copyFile(t, r, (a) => a ? i(a) : n.preserveTimestamps ? ch(e.mode, t, r, i) : Di(r, e.mode, i));
}
function ch(e, t, r, n) {
  return uh(e) ? fh(r, e, (i) => i ? n(i) : bo(e, t, r, n)) : bo(e, t, r, n);
}
function uh(e) {
  return (e & 128) === 0;
}
...
function mh(e, t, r, n, i, a) {
  const s = Yr.join(r, t), o = Yr.join(n, t);
  Kr.checkPaths(s, o, "copy", i, (l, d) => {
    if (l) return a(l);
    const { destStat: c } = d;
...
function gh(e, t, r, n, i) {
  Me.readlink(t, (a, s) => {
    if (a) return i(a);
    if (n.dereference && (s = Yr.resolve(process.cwd(), s)), e)
      Me.readlink(r, (o, l) => o ? o.code === "EINVAL" || o.code === "UNKNOWN" ? Me.symlink(s, r, i) : i(o) : (n.dereference && (l = Yr.resolve(process.cwd(), l)), Kr.isSrcSubdir(s, l) ? i(new Error(`Cannot copy '${s}' to a subdirectory of itself, '${l}'.`)) : e.isDirectory() && Kr.isSrcSubdir(l, s) ? i(new Error(`Cannot overwrite '${l}' with '${s}'.`)) : yh(s, r, i)));
    else
...
var wh = ah;
const Ie = $e, Jr = ue, xh = lt.mkdirsSync, Eh = Uc.utimesMillisSync, Qr = Ar;
function vh(e, t, r) {
  ...
  const { srcStat: n, destStat: i } = Qr.checkPathsSync(e, t, "copy", r);
  return Qr.checkParentPathsSync(e, n, t, "copy"), Th(i, e, t, r);
}
function Th(e, t, r, n) {
  if (n.filter && !n.filter(t, r)) return;
  const i = Jr.dirname(r);
  return Ie.existsSync(i) || xh(i), qc(e, t, r, n);
}
function _h(e, t, r, n) {
...
function qc(e, t, r, n) {
  ...
  if (a.isDirectory()) return Dh(a, e, t, r, n);
...
function Sh(e, t, r, n) {
  if (n.overwrite)
    return Ie.unlinkSync(r), Xc(e, t, r, n);
  if (n.errorOnExist)
    throw new Error(`'${r}' already exists`);
}
function Xc(e, t, r, n) {
  return Ie.copyFileSync(t, r), n.preserveTimestamps && Ah(e.mode, t, r), xs(r, e.mode);
}
function Ah(e, t, r) {
...
function Dh(e, t, r, n, i) {
  return t ? Wc(r, n, i) : Oh(e.mode, r, n, i);
}
function Oh(e, t, r, n) {
  return Ie.mkdirSync(r), Wc(t, r, n), xs(r, e);
}
function Wc(e, t, r) {
  Ie.readdirSync(e).forEach((n) => Ph(n, e, t, r));
}
function Ph(e, t, r, n) {
  const i = Jr.join(t, e), a = Jr.join(r, e), { destStat: s } = Qr.checkPathsSync(i, a, "copy", n);
  return _h(s, i, a, n);
}
function kh(e, t, r, n) {
  ...
  if (n.dereference && (i = Jr.resolve(process.cwd(), i)), e) {
    ...
    if (n.dereference && (a = Jr.resolve(process.cwd(), a)), Qr.isSrcSubdir(i, a))
      throw new Error(`Cannot copy '${i}' to a subdirectory of itself, '${a}'.`);
    if (Ie.statSync(r).isDirectory() && Qr.isSrcSubdir(a, i))
...
const So = $e, Vc = ue, re = Cc, Zr = process.platform === "win32";
function Yc(e) {
  [
    "unlink",
    "chmod",
    ...
    e[r] = e[r] || So[r], r = r + "Sync", e[r] = e[r] || So[r];
  }), e.maxBusyTries = e.maxBusyTries || 3;
}
function vs(e, t, r) {
  let n = 0;
  typeof t == "function" && (r = t, t = {}), re(e, "rimraf: missing path"), re.strictEqual(typeof e, "string", "rimraf: path should be a string"), re.strictEqual(typeof r, "function", "rimraf: callback function required"), re(t, "rimraf: invalid options argument provided"), re.strictEqual(typeof t, "object", "rimraf: options should be object"), Yc(t), Ao(e, t, function i(a) {
    if (a) {
      if ((a.code === "EBUSY" || a.code === "ENOTEMPTY" || a.code === "EPERM") && n < t.maxBusyTries) {
        n++;
        const s = n * 100;
        return setTimeout(() => Ao(e, t, i), s);
      }
    ...
    t.unlink(e, (a) => {
      if (a) {
        if (a.code === "ENOENT")
          return r(null);
        if (a.code === "EPERM")
          return Zr ? Io(e, t, a, r) : oi(e, t, a, r);
        if (a.code === "EISDIR")
          return oi(e, t, a, r);
      }
      return r(a);
...
function Io(e, t, r, n) {
  re(e), re(t), re(typeof n == "function"), t.chmod(e, 438, (i) => {
    i ? n(i.code === "ENOENT" ? null : r) : t.stat(e, (a, s) => {
      a ? n(a.code === "ENOENT" ? null : r) : s.isDirectory() ? oi(e, t, r, n) : t.unlink(e, n);
    });
  });
}
function Co(e, t, r) {
  ...
  n.isDirectory() ? li(e, t, r) : t.unlinkSync(e);
}
function oi(e, t, r, n) {
...
function Kc(e, t) {
  let r;
  t = t || {}, Yc(t), re(e, "rimraf: missing path"), re.strictEqual(typeof e, "string", "rimraf: path should be a string"), re(t, "rimraf: missing options"), re.strictEqual(typeof t, "object", "rimraf: options should be object");
  try {
    r = t.lstatSync(e);
  } catch (n) {
    if (n.code === "ENOENT")
      return;
    n.code === "EPERM" && Zr && Co(e, t, n);
  }
  try {
    r && r.isDirectory() ? li(e, t, null) : t.unlinkSync(e);
  } catch (n) {
    if (n.code === "ENOENT")
      return;
    if (n.code === "EPERM")
      return Zr ? Co(e, t, n) : li(e, t, n);
    if (n.code !== "EISDIR")
      throw n;
    li(e, t, n);
  }
...
function Uh(e, t) {
  if (re(e), re(t), t.readdirSync(e).forEach((r) => Kc(Vc.join(e, r), t)), Zr) {
    const r = Date.now();
    do
      try {
...
var Mh = vs;
vs.sync = Kc;
const pi = $e, Bh = Fe.fromCallback, Jc = Mh;
function jh(e, t) {
...
const Gh = Fe.fromPromise, Qc = er, Zc = ue, eu = lt, tu = Oi, Ro = Gh(async function(t) {
  let r;
  try {
...
const Yh = Fe.fromCallback, iu = ue, Tt = $e, au = lt, Kh = tr.pathExists, { areIdentical: su } = Ar;
function Jh(e, t, r) {
  function n(i, a) {
    Tt.link(i, a, (s) => {
      if (s) return r(s);
...
const bt = ue, qr = $e, em = tr.pathExists;
function tm(e, t, r) {
  if (bt.isAbsolute(e))
    return qr.lstat(e, (n) => n ? (n.message = n.message.replace("lstat", "ensureSymlink"), r(n)) : r(null, {
      toCwd: e,
      toDst: e
    }));
  {
    ...
    return em(i, (a, s) => a ? r(a) : s ? r(null, {
      toCwd: i,
      toDst: e
    }) : qr.lstat(e, (o) => o ? (o.message = o.message.replace("lstat", "ensureSymlink"), r(o)) : r(null, {
      toCwd: e,
...
const om = Fe.fromCallback, lu = ue, Ke = er, cu = lt, lm = cu.mkdirs, cm = cu.mkdirsSync, uu = nm, um = uu.symlinkPaths, fm = uu.symlinkPathsSync, fu = sm, dm = fu.symlinkType, pm = fu.symlinkTypeSync, hm = tr.pathExists, { areIdentical: du } = Ar;
function mm(e, t, r, n) {
...
function gm(e, t, r) {
  ...
  return Ke.existsSync(a) || cm(a), Ke.symlinkSync(e, t, r);
}
var ym = {
  createSymlink: om(mm),
  createSymlinkSync: gm
};
const { createFile: Po, createFileSync: ko } = Vh, { createLink: No, createLinkSync: Fo } = Zh, { createSymlink: $o, createSymlinkSync: Lo } = ym;
var wm = {
  // file
  createFile: Po,
  createFileSync: ko,
  ...
  // symlink
  createSymlink: $o,
  createSymlinkSync: Lo,
  ensureSymlink: $o,
  ensureSymlinkSync: Lo
};
function xm(e, { EOL: t = `
...
var Ts = { stringify: xm, stripBom: Em };
let Tr;
try {
  Tr = $e;
} catch {
...
const Pi = Fe, { stringify: pu, stripBom: hu } = Ts;
...
async function bm(e, t, r = {}) {
  const n = r.fs || Tr, i = pu(t, r);
  await Pi.fromCallback(n.writeFile)(e, i, r);
}
const Sm = Pi.fromPromise(bm);
function Am(e, t, r = {}) {
  const n = r.fs || Tr, i = pu(t, r);
...
const Rm = Fe.fromCallback, Xr = $e, mu = ue, gu = lt, Dm = tr.pathExists;
function Om(e, t, r, n) {
...
function Pm(e, ...t) {
  ...
  gu.mkdirsSync(r), Xr.writeFileSync(e, ...t);
}
var _s = {
  outputFile: Rm(Om),
  outputFileSync: Pm
};
const { stringify: km } = Ts, { outputFile: Nm } = _s;
async function Fm(e, t, r = {}) {
  const n = km(t, r);
  await Nm(e, n, r);
}
var $m = Fm;
const { stringify: Lm } = Ts, { outputFileSync: Um } = _s;
function Mm(e, t, r) {
  const n = Lm(t, r);
  Um(e, n, r);
}
...
var zm = Ne;
const Gm = $e, qa = ue, Hm = Es.copy, yu = Oi.remove, qm = lt.mkdirp, Xm = tr.pathExists, Uo = Ar;
function Wm(e, t, r, n) {
  typeof r == "function" && (n = r, r = {}), r = r || {};
  const i = r.overwrite || r.clobber || !1;
  Uo.checkPaths(e, t, "move", r, (a, s) => {
    if (a) return n(a);
    const { srcStat: o, isChangingCase: l = !1 } = s;
    Uo.checkParentPaths(e, o, t, "move", (d) => {
      if (d) return n(d);
      if (Vm(t)) return Mo(e, t, i, l, n);
      qm(qa.dirname(t), (c) => c ? n(c) : Mo(e, t, i, l, n));
    });
  });
}
function Vm(e) {
...
function Mo(e, t, r, n, i) {
  if (n) return da(e, t, r, i);
  if (r)
    return yu(t, (a) => a ? i(a) : da(e, t, r, i));
  Xm(t, (a, s) => a ? i(a) : s ? i(new Error("dest already exists.")) : da(e, t, r, i));
}
function da(e, t, r, n) {
...
var Km = Wm;
const wu = $e, Xa = ue, Jm = Es.copySync, xu = Oi.removeSync, Qm = lt.mkdirpSync, Bo = Ar;
function Zm(e, t, r) {
  r = r || {};
  const n = r.overwrite || r.clobber || !1, { srcStat: i, isChangingCase: a = !1 } = Bo.checkPathsSync(e, t, "move", r);
  return Bo.checkParentPathsSync(e, i, t, "move"), e0(t) || Qm(Xa.dirname(t)), t0(e, t, n, a);
}
function e0(e) {
  const t = Xa.dirname(e);
  return Xa.parse(t).root === t;
}
function t0(e, t, r, n) {
  if (n) return pa(e, t, r);
  if (r)
    return xu(t), pa(e, t, r);
...
var ke = {}, Va = { exports: {} }, Mn = { exports: {} }, ha, jo;
function c0() {
  if (jo) return ha;
  jo = 1;
  ...
  function e(t) {
    ...
    function n(u) {
      ...
      return T.namespace = u, T.useColors = n.useColors(), T.color = n.selectColor(u), T.extend = i, T.destroy = n.destroy, Object.defineProperty(T, "enabled", {
        enumerable: !0,
        configurable: !1,
        get: () => m !== null ? m : (x !== n.namespaces && (x = n.namespaces, w = n.enabled(u)), w),
        set: (b) => {
          m = b;
        }
...
var Bn = { exports: {} }, ga, Ho;
function f0() {
  return Ho || (Ho = 1, ga = (e, t = process.argv) => {
...
function d0() {
  if (qo) return ya;
  qo = 1;
  const e = Ci, t = Dc, r = f0(), { env: n } = process;
  let i;
...
function p0() {
  return Xo || (Xo = 1, function(e, t) {
    ...
    t.inspectOpts = Object.keys(process.env).filter((p) => /^debug_/i.test(p)).reduce((p, m) => {
      const x = m.substring(6).toLowerCase().replace(/_([a-z])/g, (T, b) => b.toUpperCase());
      let w = process.env[m];
    ...
    function a(p) {
      const { namespace: m, useColors: x } = this;
      if (x) {
...
`);
    ...
    function c(p) {
      ...
      for (let x = 0; x < m.length; x++)
        p.inspectOpts[m[x]] = t.inspectOpts[m[x]];
    }
    e.exports = Eu()(t);
...
typeof process > "u" || process.type === "renderer" || process.browser === !0 || process.__nwjs ? Va.exports = u0() : Va.exports = p0();
var vu = Va.exports;
const Cr = /* @__PURE__ */ Rp(vu);
var hn = {};
...
hn.ProgressCallbackTransform = m0;
Object.defineProperty(ke, "__esModule", { value: !0 });
ke.DigestTransform = ke.HttpExecutor = ke.HttpError = void 0;
ke.createHttpError = Ya;
ke.parseJson = _0;
ke.configureRequestOptionsFromUrl = _u;
ke.configureRequestUrl = Ss;
ke.safeGetHeader = Er;
ke.configureRequestOptions = mi;
ke.safeStringifyJson = gi;
const g0 = dn, y0 = vu, w0 = Pt, x0 = fn, Tu = Sr, E0 = Ct, Wo = Ir, v0 = hn, Lr = (0, y0.default)("electron-builder");
function Ya(e, t = null) {
  return new bs(e.statusCode || -1, `${e.statusCode} ${e.statusMessage}` + (t == null ? "" : `
` + JSON.stringify(t, null, "  ")) + `
Headers: ` + gi(e.headers), t);
}
...
class hi {
  ...
  doApiRequest(t, r, n, i = 0) {
    return Lr.enabled && Lr(`Request: ${gi(t)}`), r.createPromise((a, s, o) => {
  ...
  handleResponse(t, r, n, i, a, s, o) {
    var l;
    if (Lr.enabled && Lr(`Response: ${t.statusCode} ${t.statusMessage}, request options: ${gi(r)}`), t.statusCode === 404) {
      a(Ya(t, `method: ${r.method || "GET"} url: ${r.protocol || "https:"}//${r.hostname}${r.port ? `:${r.port}` : ""}${r.path}
...
`));
    ...
    if (c && u != null) {
      ...
      this.doApiRequest(hi.prepareRedirectUrlOptions(u, r), n, o, s).then(i).catch(a);
      return;
    }
    t.setEncoding("utf8");
    let p = "";
    t.on("error", a), t.on("data", (m) => p += m), t.on("end", () => {
      try {
        if (t.statusCode != null && t.statusCode >= 400) {
          const m = Er(t, "content-type"), x = m != null && (Array.isArray(m) ? m.find((w) => w.includes("json")) != null : m.includes("json"));
          a(Ya(t, `method: ${r.method || "GET"} url: ${r.protocol || "https:"}//${r.hostname}${r.port ? `:${r.port}` : ""}${r.path}
  ...
  doDownload(t, r, n) {
    const i = this.createRequest(t, (a) => {
      ...
      if (s != null) {
        n < this.maxRedirects ? this.doDownload(hi.prepareRedirectUrlOptions(s, t), r, n++) : r.callback(this.createMaxRedirectError());
        return;
      }
  ...
  static retryOnServerError(t, r = 3) {
    for (let n = 0; ; n++)
      try {
        ...
        if (n < r && (i instanceof bs && i.isServerError() || i.code === "EPIPE"))
          continue;
        throw i;
      }
  }
...
function _u(e, t) {
  const r = mi(t);
  return Ss(new Tu.URL(e), r), r;
}
function Ss(e, t) {
  t.protocol = e.protocol, t.hostname = e.hostname, e.port ? t.port = e.port : t.port && delete t.port, t.path = e.pathname + e.search;
}
class Ka extends x0.Transform {
  ...
  validate() {
    if (this._actual == null)
      throw (0, Wo.newError)("Not finished yet", "ERR_STREAM_NOT_FINISHED");
    if (this._actual !== this.expected)
      throw (0, Wo.newError)(`${this.algorithm} checksum mismatch, expected ${this.expected}, got ${this._actual}`, "ERR_CHECKSUM_MISMATCH");
    return null;
  }
}
ke.DigestTransform = Ka;
function b0(e, t, r) {
...
function S0(e, t) {
  if (!b0(Er(t, "X-Checksum-Sha2"), e.options.sha2, e.callback))
    return;
  const r = [];
  ...
  n != null ? r.push(new Ka(n, "sha512", n.length === 128 && !n.includes("+") && !n.includes("Z") && !n.includes("=") ? "hex" : "base64")) : e.options.sha2 != null && r.push(new Ka(e.options.sha2, "sha256", "hex"));
...
Ni.githubUrl = I0;
Ni.getS3LikeProviderBaseUrl = C0;
...
async function Au(e, t, r, n = 0, i = 0, a) {
  var s;
  const o = new O0.CancellationToken();
  try {
    return await e();
  } catch (l) {
...
const Iu = dn, Cu = Ir, k0 = "options.name must be either a string or a Buffer", Vo = (0, Iu.randomBytes)(16);
Vo[0] = Vo[0] | 1;
const ci = {}, Q = [];
for (let e = 0; e < 256; e++) {
...
class Qt {
  ...
  static check(t, r = 0) {
    if (typeof t == "string")
      return t = t.toLowerCase(), /^[a-f0-9]{8}(-[a-f0-9]{4}){3}-([a-f0-9]{12})$/.test(t) ? t === "00000000-0000-0000-0000-000000000000" ? { version: void 0, variant: "nil", format: "ascii" } : {
        version: (ci[t[14] + t[15]] & 240) >> 4,
        variant: Yo((ci[t[19] + t[20]] & 224) >> 5),
        format: "ascii"
      } : !1;
  ...
  static parse(t) {
    ...
    let n = 0;
    for (let i = 0; i < 16; i++)
      r[i] = ci[t[n++] + t[n++]], (i === 3 || i === 5 || i === 7 || i === 9) && (n += 1);
    return r;
  }
}
_r.UUID = Qt;
...
function N0(e, t, r, n, i = Wr.ASCII) {
  const a = (0, Iu.createHash)(t);
  if (typeof e != "string" && !Buffer.isBuffer(e))
    throw (0, Cu.newError)(k0, "ERR_INVALID_UUID_NAME");
...
(function(e) {
  (function(t) {
    ...
    var u = "[CDATA[", p = "DOCTYPE", m = "http://www.w3.org/XML/1998/namespace", x = "http://www.w3.org/2000/xmlns/", w = { xml: m, xmlns: x }, T = /[:_A-Za-z\u00C0-\u00D6\u00D8-\u00F6\u00F8-\u02FF\u0370-\u037D\u037F-\u1FFF\u200C-\u200D\u2070-\u218F\u2C00-\u2FEF\u3001-\uD7FF\uF900-\uFDCF\uFDF0-\uFFFD]/, b = /[:_A-Za-z\u00C0-\u00D6\u00D8-\u00F6\u00F8-\u02FF\u0370-\u037D\u037F-\u1FFF\u200C-\u200D\u2070-\u218F\u2C00-\u2FEF\u3001-\uD7FF\uF900-\uFDCF\uFDF0-\uFFFD\u00B7\u0300-\u036F\u203F-\u2040.\d-]/, _ = /[#:_A-Za-z\u00C0-\u00D6\u00D8-\u00F6\u00F8-\u02FF\u0370-\u037D\u037F-\u1FFF\u200C-\u200D\u2070-\u218F\u2C00-\u2FEF\u3001-\uD7FF\uF900-\uFDCF\uFDF0-\uFFFD]/, N = /[#:_A-Za-z\u00C0-\u00D6\u00D8-\u00F6\u00F8-\u02FF\u0370-\u037D\u037F-\u1FFF\u200C-\u200D\u2070-\u218F\u2C00-\u2FEF\u3001-\uD7FF\uF900-\uFDCF\uFDF0-\uFFFD\u00B7\u0300-\u036F\u203F-\u2040.\d-]/;
    function $(h) {
      return h === " " || h === `
` || h === "\r" || h === "	";
    }
...
Char: ` + h.c), f = new Error(f), h.error = f, j(h, "onerror", f), h;
    ...
    function q(h) {
      ...
      if (h.opt.xmlns) {
        var f = D(h.attribName, !0), I = f.prefix, v = f.local;
        if (I === "xmlns")
...
Actual: ` + h.attribValue
    ...
    function K(h, f) {
      if (h.opt.xmlns) {
        ...
        I.ns && Z.ns !== I.ns && Object.keys(I.ns).forEach(function(An) {
          U(h, "onopennamespace", {
            prefix: An,
            uri: I.ns[An]
          });
        ...
        for (var se = 0, fe = h.attribList.length; se < fe; se++) {
          var ve = h.attribList[se], Se = ve[0], mt = ve[1], he = D(Se, !0), We = he.prefix, ta = he.local, Sn = We === "" ? "" : I.ns[We] || "", Or = {
            name: Se,
            value: mt,
            prefix: We,
            local: ta,
          ...
          ), Or.uri = We), h.tag.attributes[Se] = Or, U(h, "onattribute", Or);
        }
    ...
    function X(h) {
      ...
      for (var se = h.tags.length; se-- > f; ) {
        ...
        h.opt.xmlns && fe.ns !== mt.ns && Object.keys(fe.ns).forEach(function(he) {
          var We = fe.ns[he];
          U(h, "onclosenamespace", { prefix: he, uri: We });
        });
      }
...
class Du {
  ...
  getElements(t, r = !1) {
    return this.elements === null ? [] : this.elements.filter((n) => Ko(n, t, r));
  }
...
function j0(e) {
  return Array.isArray(e) ? e : Ou(e) ? [] : [e];
}
function z0(e, t) {
  var r, n, i, a;
  if (t)
...
function q0(e, t) {
  ...
  for (l = 1; l <= t.linesBefore && !(s - l < 0); l++)
    d = wa(
      ...
      u
    ), o = zr.repeat(" ", t.indent) + xa((e.line - l + 1).toString(), c) + " | " + d.str + `
` + o;
  for (d = wa(e.buffer, n[s], i[s], e.position, u), o += zr.repeat(" ", t.indent) + xa((e.line + 1).toString(), c) + " | " + d.str + `
`, o += zr.repeat("-", t.indent + c + 3 + d.pos) + `^
...
function K0(e, t) {
  if (t = t || {}, Object.keys(t).forEach(function(r) {
    if (W0.indexOf(r) === -1)
      throw new Jo('Unknown option "' + r + '" is met in definition of "' + e + '" YAML type.');
    ...
    throw new Jo('Unknown kind "' + this.kind + '" is specified for "' + e + '" YAML type.');
}
var Le = K0, Ur = gn, Ea = Le;
function Qo(e, t) {
  var r = [];
...
Ja.prototype.extend = function(t) {
  ...
  return i.implicit = (this.implicit || []).concat(r), i.explicit = (this.explicit || []).concat(n), i.compiledImplicit = Qo(i, "implicit"), i.compiledExplicit = Qo(i, "explicit"), i.compiledTypeMap = J0(i.compiledImplicit, i.compiledExplicit), i;
};
var ku = Ja, Q0 = Le, Nu = new Q0("tag:yaml.org,2002:str", {
  kind: "scalar",
...
var Vu = new Rg("tag:yaml.org,2002:merge", {
  kind: "scalar",
  resolve: Dg
}), Og = Le, Rs = `ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789+/=
\r`;
function Pg(e) {
  if (e === null) return !1;
  var t, r, n = 0, i = e.length, a = Rs;
  for (r = 0; r < i; r++)
...
var Yu = new Og("tag:yaml.org,2002:binary", {
  kind: "scalar",
  resolve: Pg,
  construct: kg,
  predicate: Fg,
...
}), qt = Qe, Zu = gn, Yg = X0, Kg = Ds, Rt = Object.prototype.hasOwnProperty, yi = 1, ef = 2, tf = 3, wi = 4, va = 1, Jg = 2, Zo = 3, Qg = /[\x00-\x08\x0B\x0C\x0E-\x1F\x7F-\x84\x86-\x9F\uFFFE\uFFFF]|[\uD800-\uDBFF](?![\uDC00-\uDFFF])|(?:[^\uD800-\uDBFF]|^)[\uDC00-\uDFFF]/, Zg = /[\x85\u2028\u2029]/, ey = /[,\[\]\{\}]/, rf = /^(?:!|!!|![a-z\-]+!)$/i, nf = /^(?:!|[^,\[\]\{\}])(?:%[0-9a-f]{2}|[0-9a-z\-#;\/\?:@&=\+\$,_\.!~\*'\(\)\[\]])*$/i;
function el(e) {
...
var rl = {
  YAML: function(t, r, n) {
    var i, a, s;
    t.version !== null && z(t, "duplication of %YAML directive"), n.length !== 1 && z(t, "YAML directive accepts exactly one argument"), i = /^([0-9]+)\.([0-9]+)$/.exec(n[0]), i === null && z(t, "ill-formed argument of the YAML directive"), a = parseInt(i[1], 10), s = parseInt(i[2], 10), a !== 1 && z(t, "unacceptable YAML version of the document"), t.version = n[0], t.checkLineBreaks = s < 2, s !== 1 && s !== 2 && xi(t, "unsupported YAML version of the document");
  },
  TAG: function(t, r, n) {
    var i, a;
...
function hr(e, t, r, n, i, a, s, o, l) {
  var d, c;
  if (Array.isArray(i))
    for (i = Array.prototype.slice.call(i), d = 0, c = i.length; d < c; d += 1)
      Array.isArray(i[d]) && z(e, "nested arrays are not supported inside keys"), typeof i == "object" && el(i[d]) === "[object Object]" && (i[d] = "[object Object]");
  if (typeof i == "object" && el(i) === "[object Object]" && (i = "[object Object]"), i = String(i), t === null && (t = {}), n === "tag:yaml.org,2002:merge")
    if (Array.isArray(a))
...
function pe(e, t, r) {
  ...
  return r !== -1 && n !== 0 && e.lineIndent < r && xi(e, "deficient indentation"), n;
}
function Fi(e) {
  var t = e.position, r;
...
function sy(e, t, r) {
  ...
  if (m = e.input.charCodeAt(e.position), Be(m) || pr(m) || m === 35 || m === 38 || m === 42 || m === 33 || m === 124 || m === 62 || m === 39 || m === 34 || m === 37 || m === 64 || m === 96 || (m === 63 || m === 45) && (i = e.input.charCodeAt(e.position + 1), Be(i) || r && pr(i)))
    return !1;
  for (e.kind = "scalar", e.result = "", a = s = e.position, o = !1; m !== 0; ) {
    if (m === 58) {
      ...
      if (e.position === e.lineStart && Fi(e) || r && pr(m))
        break;
      if (st(m))
    ...
    o && (St(e, a, s, !1), Ps(e, e.line - l), a = s = e.position, o = !1), Yt(m) || (s = e.position + 1), m = e.input.charCodeAt(++e.position);
  }
  ...
  for (e.kind = "scalar", e.result = "", e.position++, n = i = e.position; (r = e.input.charCodeAt(e.position)) !== 0; )
    if (r === 39)
      if (St(e, n, e.position, !0), r = e.input.charCodeAt(++e.position), r === 39)
        ...
        return !0;
    else st(r) ? (St(e, n, i, !0), Ps(e, pe(e, !1, t)), n = i = e.position) : e.position === e.lineStart && Fi(e) ? z(e, "unexpected end of the document within a single quoted scalar") : (e.position++, i = e.position);
...
function ly(e, t) {
  ...
  for (e.kind = "scalar", e.result = "", e.position++, r = n = e.position; (o = e.input.charCodeAt(e.position)) !== 0; ) {
    ...
    if (o === 92) {
      ...
      r = n = e.position;
    } else st(o) ? (St(e, r, n, !0), Ps(e, pe(e, !1, t)), r = n = e.position) : e.position === e.lineStart && Fi(e) ? z(e, "unexpected end of the document within a double quoted scalar") : (e.position++, n = e.position);
  }
  z(e, "unexpected end of the stream within a double quoted scalar");
}
function cy(e, t) {
  var r = !0, n, i, a, s = e.tag, o, l = e.anchor, d, c, u, p, m, x = /* @__PURE__ */ Object.create(null), w, T, b, _;
  ...
  for (e.anchor !== null && (e.anchorMap[e.anchor] = o), _ = e.input.charCodeAt(++e.position); _ !== 0; ) {
    ...
    r ? _ === 44 && z(e, "expected the node content, but found ','") : z(e, "missed comma between flow collection entries"), T = w = b = null, u = p = !1, _ === 63 && (d = e.input.charCodeAt(e.position + 1), Be(d) && (u = p = !0, e.position++, pe(e, !0, t))), n = e.line, i = e.lineStart, a = e.position, br(e, t, yi, !1, !0), T = e.tag, w = e.result, pe(e, !0, t), _ = e.input.charCodeAt(e.position), (p || e.line === n) && _ === 58 && (u = !0, _ = e.input.charCodeAt(++e.position), pe(e, !0, t), br(e, t, yi, !1, !0), b = e.result), m ? hr(e, o, x, T, w, b, n, i, a) : u ? o.push(hr(e, null, x, T, w, b, n, i, a)) : o.push(w), pe(e, !0, t), _ = e.input.charCodeAt(e.position), _ === 44 ? (r = !0, _ = e.input.charCodeAt(++e.position)) : r = !1;
  }
  z(e, "unexpected end of the stream within a flow collection");
}
function uy(e, t) {
  var r, n, i = va, a = !1, s = !1, o = t, l = 0, d = !1, c, u;
  ...
  for (e.kind = "scalar", e.result = ""; u !== 0; )
    if (u = e.input.charCodeAt(++e.position), u === 43 || u === 45)
      va === i ? i = u === 43 ? Zo : Jg : z(e, "repeat of a chomping mode identifier");
    else if ((c = ny(u)) >= 0)
  ...
  for (; u !== 0; ) {
    ...
    if (e.lineIndent < o) {
      i === Zo ? e.result += qt.repeat(`
`, a ? 1 + l : l) : i === va && a && (e.result += `
`);
      break;
    }
...
function il(e, t) {
  ...
  for (e.anchor !== null && (e.anchorMap[e.anchor] = a), l = e.input.charCodeAt(e.position); l !== 0 && (e.firstTabInLine !== -1 && (e.position = e.firstTabInLine, z(e, "tab characters must not be used in indentation")), !(l !== 45 || (s = e.input.charCodeAt(e.position + 1), !Be(s)))); ) {
    ...
    if (r = e.line, br(e, t, tf, !1, !0), a.push(e.result), pe(e, !0, -1), l = e.input.charCodeAt(e.position), (e.line === r || e.lineIndent > t) && l !== 0)
...
function fy(e, t, r) {
  var n, i, a, s, o, l, d = e.tag, c = e.anchor, u = {}, p = /* @__PURE__ */ Object.create(null), m = null, x = null, w = null, T = !1, b = !1, _;
  if (e.firstTabInLine !== -1) return !1;
  for (e.anchor !== null && (e.anchorMap[e.anchor] = u), _ = e.input.charCodeAt(e.position); _ !== 0; ) {
    if (!T && e.firstTabInLine !== -1 && (e.position = e.firstTabInLine, z(e, "tab characters must not be used in indentation")), n = e.input.charCodeAt(e.position + 1), a = e.line, (_ === 63 || _ === 58) && Be(n))
      _ === 63 ? (T && (hr(e, u, p, m, x, null, s, o, l), m = x = w = null), b = !0, T = !0, i = !0) : T ? (T = !1, i = !0) : z(e, "incomplete explicit mapping pair; a key node is missed; or followed by a non-tabulated empty line"), e.position += 1, _ = n;
    else {
      if (s = e.line, o = e.lineStart, l = e.position, !br(e, r, ef, !1, !0))
        break;
      if (e.line === a) {
        for (_ = e.input.charCodeAt(e.position); Yt(_); )
          _ = e.input.charCodeAt(++e.position);
        if (_ === 58)
          _ = e.input.charCodeAt(++e.position), Be(_) || z(e, "a whitespace character is expected after the key-value separator within a block mapping"), T && (hr(e, u, p, m, x, null, s, o, l), m = x = w = null), b = !0, T = !1, i = !1, m = e.tag, x = e.result;
        else if (b)
    ...
    if ((e.line === a || e.lineIndent > t) && (T && (s = e.line, o = e.lineStart, l = e.position), br(e, t, wi, !0, i) && (T ? x = e.result : w = e.result), T || (hr(e, u, p, m, x, w, s, o, l), m = x = w = null), pe(e, !0, -1), _ = e.input.charCodeAt(e.position)), (e.line === a || e.lineIndent > t) && _ !== 0)
      z(e, "bad indentation of a mapping entry");
    else if (e.lineIndent < t)
      break;
  }
  return T && hr(e, u, p, m, x, null, s, o, l), b && (e.tag = d, e.anchor = c, e.kind = "mapping", e.result = u), b;
}
function dy(e) {
  var t, r = !1, n = !1, i, a, s;
...
function py(e) {
  ...
  for (e.anchor !== null && z(e, "duplication of an anchor property"), r = e.input.charCodeAt(++e.position), t = e.position; r !== 0 && !Be(r) && !pr(r); )
...
function br(e, t, r, n, i) {
  var a, s, o, l = 1, d = !1, c = !1, u, p, m, x, w, T;
  if (e.listener !== null && e.listener("open", e), e.tag = null, e.anchor = null, e.kind = null, e.result = null, a = s = o = wi === r || tf === r, n && pe(e, !0, -1) && (d = !0, e.lineIndent > t ? l = 1 : e.lineIndent === t ? l = 0 : e.lineIndent < t && (l = -1)), l === 1)
    for (; dy(e) || py(e); )
      pe(e, !0, -1) ? (d = !0, o = a, e.lineIndent > t ? l = 1 : e.lineIndent === t ? l = 0 : e.lineIndent < t && (l = -1)) : o = !1;
  if (o && (o = d || i), (l === 1 || wi === r) && (yi === r || ef === r ? w = t : w = t + 1, T = e.position - e.lineStart, l === 1 ? o && (il(e, T) || fy(e, T, w)) || cy(e, w) ? c = !0 : (s && uy(e, w) || oy(e, w) || ly(e, w) ? c = !0 : hy(e) ? (c = !0, (e.tag !== null || e.anchor !== null) && z(e, "alias node should not have any properties")) : sy(e, w, yi === r) && (c = !0, e.tag === null && (e.tag = "?")), e.anchor !== null && (e.anchorMap[e.anchor] = e.result)) : l === 0 && (c = o && il(e, T))), e.tag === null)
    ...
    if (Rt.call(e.typeMap[e.kind || "fallback"], e.tag))
      ...
      for (x = null, m = e.typeMap.multi[e.kind || "fallback"], u = 0, p = m.length; u < p; u += 1)
        if (e.tag.slice(0, m[u].tag.length) === m[u].tag) {
          x = m[u];
          break;
        }
    x || z(e, "unknown tag !<" + e.tag + ">"), e.result !== null && x.kind !== e.kind && z(e, "unacceptable node kind for !<" + e.tag + '> tag; it should be "' + x.kind + '", not "' + e.kind + '"'), x.resolve(e.result, e.tag) ? (e.result = x.construct(e.result, e.tag), e.anchor !== null && (e.anchorMap[e.anchor] = e.result)) : z(e, "cannot resolve a node with !<" + e.tag + "> explicit tag");
  }
...
function my(e) {
  ...
  for (e.version = null, e.checkLineBreaks = e.legacy, e.tagMap = /* @__PURE__ */ Object.create(null), e.anchorMap = /* @__PURE__ */ Object.create(null); (s = e.input.charCodeAt(e.position)) !== 0 && (pe(e, !0, -1), s = e.input.charCodeAt(e.position), !(e.lineIndent > 0 || s !== 37)); ) {
    ...
    s !== 0 && Os(e), Rt.call(rl, n) ? rl[n](e, n, i) : xi(e, 'unknown document directive "' + n + '"');
  }
  if (pe(e, !0, -1), e.lineIndent === 0 && e.input.charCodeAt(e.position) === 45 && e.input.charCodeAt(e.position + 1) === 45 && e.input.charCodeAt(e.position + 2) === 45 ? (e.position += 3, pe(e, !0, -1)) : a && z(e, "directives end mark is expected"), br(e, e.lineIndent - 1, wi, !1, !0), pe(e, !0, -1), e.checkLineBreaks && Zg.test(e.input.slice(t, e.position)) && xi(e, "non-ASCII line breaks are interpreted as content"), e.documents.push(e.result), e.position === e.lineStart && Fi(e)) {
...
Cs.loadAll = gy;
Cs.load = yy;
var uf = {}, $i = Qe, yn = gn, wy = Ds, ff = Object.prototype.toString, df = Object.prototype.hasOwnProperty, ks = 65279, xy = 9, tn = 10, Ey = 13, vy = 32, Ty = 33, _y = 34, Qa = 35, by = 37, Sy = 38, Ay = 39, Iy = 42, pf = 44, Cy = 45, Ei = 58, Ry = 61, Dy = 62, Oy = 63, Py = 64, hf = 91, mf = 93, ky = 96, gf = 123, Ny = 124, yf = 125, Re = {};
Re[0] = "\\0";
Re[7] = "\\a";
Re[8] = "\\b";
Re[9] = "\\t";
...
function Uy(e) {
  ...
  if (t = e.toString(16).toUpperCase(), e <= 255)
    ...
    throw new yn("code point within a string may not be greater than 0xFFFFFFFF");
  return "\\" + r + $i.repeat("0", n - t.length) + t;
}
var My = 1, rn = 2;
function By(e) {
  this.schema = e.schema || wy, this.indent = Math.max(1, e.indent || 2), this.noArrayIndent = e.noArrayIndent || !1, this.skipInvalid = e.skipInvalid || !1, this.flowLevel = $i.isNothing(e.flowLevel) ? -1 : e.flowLevel, this.styleMap = Ly(this.schema, e.styles || null), this.sortKeys = e.sortKeys || !1, this.lineWidth = e.lineWidth || 80, this.noRefs = e.noRefs || !1, this.noCompatMode = e.noCompatMode || !1, this.condenseFlow = e.condenseFlow || !1, this.quotingType = e.quotingType === '"' ? rn : My, this.forceQuotes = e.forceQuotes || !1, this.replacer = typeof e.replacer == "function" ? e.replacer : null, this.implicitTypes = this.schema.compiledImplicit, this.explicitTypes = this.schema.compiledExplicit, this.tag = null, this.result = "", this.duplicates = [], this.usedDuplicates = null;
}
function al(e, t) {
  for (var r = $i.repeat(" ", t), n = 0, i = -1, a = "", s, o = e.length; n < o; )
    i = e.indexOf(`
...
function ol(e, t, r) {
  ...
  return (
    ...
    (r ? (
      // c = flow-in
      n
    ) : n && e !== pf && e !== hf && e !== mf && e !== gf && e !== yf) && e !== Qa && !(t === Ei && !i) || sl(t) && !vi(t) && e === Qa || t === Ei && i
  );
}
function zy(e) {
  return nn(e) && e !== ks && !vi(e) && e !== Cy && e !== Oy && e !== Ei && e !== pf && e !== hf && e !== mf && e !== gf && e !== yf && e !== Qa && e !== Sy && e !== Iy && e !== Ty && e !== Ny && e !== Ry && e !== Dy && e !== Ay && e !== _y && e !== by && e !== Py && e !== ky;
}
function Gy(e) {
  return !vi(e) && e !== Ei;
}
...
var xf = 1, es = 2, Ef = 3, vf = 4, dr = 5;
function Hy(e, t, r, n, i, a, s, o) {
  var l, d = 0, c = null, u = !1, p = !1, m = n !== -1, x = -1, w = zy(Gr(e, 0)) && Gy(Gr(e, e.length - 1));
  if (t || s)
  ...
  return !u && !p ? w && !s && !i(e) ? xf : a === rn ? dr : es : r > 9 && wf(e) ? dr : s ? a === rn ? dr : es : p ? vf : Ef;
}
function qy(e, t, r, n, i) {
  e.dump = function() {
    if (t.length === 0)
      return e.quotingType === rn ? '""' : "''";
    if (!e.noCompatMode && (Fy.indexOf(t) !== -1 || $y.test(t)))
      return e.quotingType === rn ? '"' + t + '"' : "'" + t + "'";
    ...
    switch (Hy(
      ...
      case es:
        return "'" + t.replace(/'/g, "''") + "'";
      case Ef:
        return "|" + ll(t, e.indent) + cl(al(t, a));
      case vf:
        return ">" + ll(t, e.indent) + cl(al(Xy(t, s), a));
      case dr:
        return '"' + Wy(t) + '"';
      default:
        throw new yn("impossible error: invalid scalar style");
    }
  }();
}
function ll(e, t) {
...
function Xy(e, t) {
  for (var r = /(\n+)([^\n]*)/g, n = function() {
    var d = e.indexOf(`
`);
    return d = d !== -1 ? d : e.length, r.lastIndex = d, ul(e.slice(0, d), t);
  }(), i = e[0] === `
` || e[0] === " ", a, s; s = r.exec(e); ) {
    var o = s[1], l = s[2];
    a = l[0] === " ", n += o + (!i && !a && l !== "" ? `
...
function Wy(e) {
  for (var t = "", r = 0, n, i = 0; i < e.length; r >= 65536 ? i += 2 : i++)
    r = Gr(e, i), n = Re[r], !n && nn(r) ? (t += e[i], r >= 65536 && (t += e[i + 1])) : t += n || Uy(r);
  return t;
}
function Vy(e, t, r) {
  var n = "", i = e.tag, a, s, o;
...
function fl(e, t, r, n) {
  ...
  for (s = 0, o = r.length; s < o; s += 1)
    l = r[s], e.replacer && (l = e.replacer.call(r, String(s), l)), (pt(e, t + 1, l, !0, !0, !1, !0) || typeof l > "u" && pt(e, t + 1, null, !0, !0, !1, !0)) && ((!n || i !== "") && (i += Za(e, t)), e.dump && tn === e.dump.charCodeAt(0) ? i += "-" : i += "- ", i += e.dump);
  e.tag = a, e.dump = i || "[]";
}
function Yy(e, t, r) {
...
function Ky(e, t, r, n) {
  ...
  if (e.sortKeys === !0)
    ...
    throw new yn("sortKeys must be a boolean or a function");
  for (o = 0, l = s.length; o < l; o += 1)
    p = "", (!n || i !== "") && (p += Za(e, t)), d = s[o], c = r[d], e.replacer && (c = e.replacer.call(r, d, c)), pt(e, t + 1, d, !0, !0, !0) && (u = e.tag !== null && e.tag !== "?" || e.dump && e.dump.length > 1024, u && (e.dump && tn === e.dump.charCodeAt(0) ? p += "?" : p += "? "), p += e.dump, u && (p += Za(e, t)), pt(e, t + 1, c, !0, u) && (e.dump && tn === e.dump.charCodeAt(0) ? p += ":" : p += ": ", p += e.dump, i += p));
  e.tag = a, e.dump = i || "{}";
}
function dl(e, t, r) {
  var n, i, a, s, o, l;
    ...
    if (o = i[a], (o.instanceOf || o.predicate) && (!o.instanceOf || typeof t == "object" && t instanceof o.instanceOf) && (!o.predicate || o.predicate(t))) {
      if (r ? o.multi && o.representName ? e.tag = o.representName(t) : e.tag = o.tag : e.tag = "?", o.represent) {
        if (l = e.styleMap[o.tag] || o.defaultStyle, ff.call(o.represent) === "[object Function]")
          ...
          throw new yn("!<" + o.tag + '> tag resolver accepts not "' + l + '" style');
        e.dump = n;
      }
      return !0;
    }
...
function pt(e, t, r, n, i, a, s) {
  e.tag = null, e.dump = r, dl(e, r, !1) || dl(e, r, !0);
  ...
  if (c && (u = e.duplicates.indexOf(r), p = u !== -1), (e.tag !== null && e.tag !== "?" || p || e.indent !== 2 && t > 0) && (i = !1), p && e.usedDuplicates[u])
    ...
    if (c && p && !e.usedDuplicates[u] && (e.usedDuplicates[u] = !0), o === "[object Object]")
      ...
      n && e.dump.length !== 0 ? (e.noArrayIndent && !s && t > 0 ? fl(e, t - 1, e.dump, i) : fl(e, t, e.dump, i), p && (e.dump = "&ref_" + u + e.dump)) : (Vy(e, t, e.dump), p && (e.dump = "&ref_" + u + " " + e.dump));
      ...
      throw new yn("unacceptable kind of an object to dump " + o);
    }
...
be.safeLoad = Ns("safeLoad", "load");
be.safeLoadAll = Ns("safeLoadAll", "loadAll");
be.safeDump = Ns("safeDump", "dump");
var Li = {};
...
const zn = Mi, { MAX_LENGTH: hl, MAX_SAFE_INTEGER: Gn } = Ui, { safeRe: Hn, t: qn } = wn, fw = Fs, { compareIdentifiers: Ta } = Sf;
let dw = class at {
  constructor(t, r) {
  ...
  inc(t, r, n) {
    if (t.startsWith("pre")) {
      ...
      if (r) {
        const i = `-${r}`.match(this.options.loose ? Hn[qn.PRERELEASELOOSE] : Hn[qn.PRERELEASE]);
        if (!i || i[1] !== r)
...
var xw = ww;
const gl = Ue, Ew = (e, t, r, n, i) => {
  typeof r == "string" && (i = n, n = r, r = void 0);
  try {
    return new gl(
      e instanceof gl ? e.version : e,
      r
    ).inc(t, n, i).version;
  } catch {
    return null;
...
var vw = Ew;
const yl = Rr, Tw = (e, t) => {
  const r = yl(e, null, !0), n = yl(t, null, !0), i = r.compare(n);
  if (i === 0)
    return null;
...
var Rw = Cw;
const Dw = Ue, Ow = (e, t) => new Dw(e, t).patch;
var Pw = Ow;
const kw = Rr, Nw = (e, t) => {
  const r = kw(e, t);
...
var Fw = Nw;
const wl = Ue, $w = (e, t, r) => new wl(e, r).compare(new wl(t, r));
var Ze = $w;
const Lw = Ze, Uw = (e, t, r) => Lw(t, e, r);
var Mw = Uw;
const Bw = Ze, jw = (e, t) => Bw(e, t, !0);
var zw = jw;
const xl = Ue, Gw = (e, t, r) => {
  const n = new xl(e, r), i = new xl(t, r);
  return n.compare(i) || n.compareBuild(i);
};
var $s = Gw;
const Hw = $s, qw = (e, t) => e.sort((r, n) => Hw(r, n, t));
var Xw = qw;
const Ww = $s, Vw = (e, t) => e.sort((r, n) => Ww(n, r, t));
var Yw = Vw;
...
var Ms = ox;
const lx = Af, cx = If, ux = Bi, fx = Us, dx = Ls, px = Ms, hx = (e, t, r, n) => {
  switch (t) {
    case "===":
...
var Cf = hx;
const mx = Ue, gx = Rr, { safeRe: Xn, t: Wn } = wn, yx = (e, t) => {
  if (e instanceof mx)
    return e;
  ...
  let r = null;
  if (!t.rtl)
    r = e.match(t.includePrerelease ? Xn[Wn.COERCEFULL] : Xn[Wn.COERCE]);
  else {
    const l = t.includePrerelease ? Xn[Wn.COERCERTLFULL] : Xn[Wn.COERCERTL];
    let d;
...
function et() {
  ...
  class t {
    constructor(S, O) {
      ...
      if (this.options = O, this.loose = !!O.loose, this.includePrerelease = !!O.includePrerelease, this.raw = S.trim().replace(e, " "), this.set = this.raw.split("||").map((A) => this.parseRange(A.trim())).filter((A) => A.length), !this.set.length)
    ...
    parseRange(S) {
      const A = ((this.options.includePrerelease && m) | (this.options.loose && x)) + ":" + S, F = n.get(A);
      if (F)
        return F;
      ...
      D && (K = K.filter((H) => (s("loose invalid filter", H, this.options), !!H.match(l[d.COMPARATORLOOSE])))), s("range list", K);
    ...
    intersects(S, O) {
      ...
      return this.set.some((A) => b(A, O) && S.set.some((F) => b(F, O) && A.every((D) => F.every((q) => D.intersects(q, O)))));
    }
    ...
    test(S) {
      ...
      for (let O = 0; O < this.set.length; O++)
        if (Y(this.set[O], S, this.options))
          return !0;
      return !1;
    }
  }
  _a = t;
  const r = Ex, n = new r(), i = Fs, a = ji(), s = Mi, o = Ue, {
    safeRe: l,
    t: d,
    comparatorTrimReplace: c,
    tildeTrimReplace: u,
    caretTrimReplace: p
  } = wn, { FLAG_INCLUDE_PRERELEASE: m, FLAG_LOOSE: x } = Ui, w = (R) => R.value === "<0.0.0-0", T = (R) => R.value === "", b = (R, S) => {
    let O = !0;
    const A = R.slice();
    let F = A.pop();
    for (; O && A.length; )
      O = A.every((D) => F.intersects(D, S)), F = A.pop();
    return O;
  }, _ = (R, S) => (R = R.replace(l[d.BUILD], ""), s("comp", R, S), R = P(R, S), s("caret", R), R = $(R, S), s("tildes", R), R = ae(R, S), s("xrange", R), R = M(R, S), s("stars", R), R), N = (R) => !R || R.toLowerCase() === "x" || R === "*", $ = (R, S) => R.trim().split(/\s+/).map((O) => B(O, S)).join(" "), B = (R, S) => {
    const O = S.loose ? l[d.TILDELOOSE] : l[d.TILDE];
    return R.replace(O, (A, F, D, q, K) => {
      s("tilde", R, A, F, D, q, K);
      let X;
      return N(F) ? X = "" : N(D) ? X = `>=${F}.0.0 <${+F + 1}.0.0-0` : N(q) ? X = `>=${F}.${D}.0 <${F}.${+D + 1}.0-0` : K ? (s("replaceTilde pr", K), X = `>=${F}.${D}.${q}-${K} <${F}.${+D + 1}.0-0`) : X = `>=${F}.${D}.${q} <${F}.${+D + 1}.0-0`, s("tilde return", X), X;
    });
  }, P = (R, S) => R.trim().split(/\s+/).map((O) => G(O, S)).join(" "), G = (R, S) => {
    s("caret", R, S);
    const O = S.loose ? l[d.CARETLOOSE] : l[d.CARET], A = S.includePrerelease ? "-0" : "";
    return R.replace(O, (F, D, q, K, X) => {
      s("caret", R, F, D, q, K, X);
      let te;
      return N(D) ? te = "" : N(q) ? te = `>=${D}.0.0${A} <${+D + 1}.0.0-0` : N(K) ? D === "0" ? te = `>=${D}.${q}.0${A} <${D}.${+q + 1}.0-0` : te = `>=${D}.${q}.0${A} <${+D + 1}.0.0-0` : X ? (s("replaceCaret pr", X), D === "0" ? q === "0" ? te = `>=${D}.${q}.${K}-${X} <${D}.${q}.${+K + 1}-0` : te = `>=${D}.${q}.${K}-${X} <${D}.${+q + 1}.0-0` : te = `>=${D}.${q}.${K}-${X} <${+D + 1}.0.0-0`) : (s("no pr"), D === "0" ? q === "0" ? te = `>=${D}.${q}.${K}${A} <${D}.${q}.${+K + 1}-0` : te = `>=${D}.${q}.${K}${A} <${D}.${+q + 1}.0-0` : te = `>=${D}.${q}.${K} <${+D + 1}.0.0-0`), s("caret return", te), te;
    });
  }, ae = (R, S) => (s("replaceXRanges", R, S), R.split(/\s+/).map((O) => y(O, S)).join(" ")), y = (R, S) => {
    R = R.trim();
    const O = S.loose ? l[d.XRANGELOOSE] : l[d.XRANGE];
    return R.replace(O, (A, F, D, q, K, X) => {
      s("xRange", R, A, F, D, q, K, X);
      const te = N(D), ge = te || N(q), H = ge || N(K), tt = H;
      return F === "=" && tt && (F = ""), X = S.includePrerelease ? "-0" : "", te ? F === ">" || F === "<" ? A = "<0.0.0-0" : A = "*" : F && tt ? (ge && (q = 0), K = 0, F === ">" ? (F = ">=", ge ? (D = +D + 1, q = 0, K = 0) : (q = +q + 1, K = 0)) : F === "<=" && (F = "<", ge ? D = +D + 1 : q = +q + 1), F === "<" && (X = "-0"), A = `${F + D}.${q}.${K}${X}`) : ge ? A = `>=${D}.0.0${X} <${+D + 1}.0.0-0` : H && (A = `>=${D}.${q}.0${X} <${D}.${+q + 1}.0-0`), s("xRange return", A), A;
    });
  }, M = (R, S) => (s("replaceStars", R, S), R.trim().replace(l[d.STAR], "")), j = (R, S) => (s("replaceGTE0", R, S), R.trim().replace(l[S.includePrerelease ? d.GTE0PRE : d.GTE0], "")), U = (R) => (S, O, A, F, D, q, K, X, te, ge, H, tt) => (N(A) ? O = "" : N(F) ? O = `>=${A}.0.0${R ? "-0" : ""}` : N(D) ? O = `>=${A}.${F}.0${R ? "-0" : ""}` : q ? O = `>=${O}` : O = `>=${O}${R ? "-0" : ""}`, N(te) ? X = "" : N(ge) ? X = `<${+te + 1}.0.0-0` : N(H) ? X = `<${te}.${+ge + 1}.0-0` : tt ? X = `<=${te}.${ge}.${H}-${tt}` : R ? X = `<${te}.${ge}.${+H + 1}-0` : X = `<=${X}`, `${O} ${X}`.trim()), Y = (R, S, O) => {
...
function ji() {
  ...
  ba = t;
  const r = Fs, { safeRe: n, t: i } = wn, a = Cf, s = Mi, o = Ue, l = et();
  return ba;
}
...
const Dx = Ue, Ox = et(), Px = (e, t, r) => {
  ...
  return e.forEach((s) => {
    a.test(s) && (!n || i.compare(s) === 1) && (n = s, i = new Dx(n, r));
  }), n;
};
var kx = Px;
const Sa = Ue, Nx = et(), Tl = Bi, Fx = (e, t) => {
  e = new Nx(e, t);
  let r = new Sa("0.0.0");
  ...
  for (let n = 0; n < e.set.length; ++n) {
    ...
    let a = null;
    i.forEach((s) => {
      const o = new Sa(s.semver.version);
      switch (s.operator) {
        case ">":
...
var Mx = Ux;
const Bx = Ue, Rf = ji(), { ANY: jx } = Rf, zx = et(), Gx = zi, _l = Bi, bl = Ls, Hx = Ms, qx = Us, Xx = (e, t, r, n) => {
...
var Bs = Xx;
const Wx = Bs, Vx = (e, t, r) => Wx(e, t, ">", r);
var Yx = Vx;
const Kx = Bs, Jx = (e, t, r) => Kx(e, t, "<", r);
var Qx = Jx;
const Sl = et(), Zx = (e, t, r) => (e = new Sl(e, r), t = new Sl(t, r), e.intersects(t, r));
var eE = Zx;
const tE = zi, rE = Ze;
var nE = (e, t, r) => {
  const n = [];
...
const Al = et(), js = ji(), { ANY: Aa } = js, Mr = zi, zs = Ze, iE = (e, t, r = {}) => {
  if (e === t)
    return !0;
  e = new Al(e, r), t = new Al(t, r);
  let n = !1;
  ...
  return !0;
}, aE = [new js(">=0.0.0-0")], Il = [new js(">=0.0.0")], sE = (e, t, r) => {
  if (e === t)
    return !0;
  if (e.length === 1 && e[0].semver === Aa) {
    if (t.length === 1 && t[0].semver === Aa)
      return !0;
    r.includePrerelease ? e = aE : e = Il;
  }
  if (t.length === 1 && t[0].semver === Aa) {
  ...
  let i, a;
  for (const m of e)
    m.operator === ">" || m.operator === ">=" ? i = Cl(i, m, r) : m.operator === "<" || m.operator === "<=" ? a = Rl(a, m, r) : n.add(m.semver);
  if (n.size > 1)
    return null;
  let s;
  if (i && a) {
    if (s = zs(i.semver, a.semver, r), s > 0)
      return null;
    if (s === 0 && (i.operator !== ">=" || a.operator !== "<="))
      return null;
  }
  for (const m of n) {
    if (i && !Mr(m, String(i), r) || a && !Mr(m, String(a), r))
      return null;
    for (const x of t)
      if (!Mr(m, String(x), r))
        return !1;
  ...
  for (const m of t) {
    if (c = c || m.operator === ">" || m.operator === ">=", d = d || m.operator === "<" || m.operator === "<=", i) {
      if (p && m.semver.prerelease && m.semver.prerelease.length && m.semver.major === p.major && m.semver.minor === p.minor && m.semver.patch === p.patch && (p = !1), m.operator === ">" || m.operator === ">=") {
        if (o = Cl(i, m, r), o === m && o !== i)
          return !1;
      } else if (i.operator === ">=" && !Mr(i.semver, String(m), r))
        return !1;
    }
    if (a) {
      if (u && m.semver.prerelease && m.semver.prerelease.length && m.semver.major === u.major && m.semver.minor === u.minor && m.semver.patch === u.patch && (u = !1), m.operator === "<" || m.operator === "<=") {
        if (l = Rl(a, m, r), l === m && l !== a)
          return !1;
      } else if (a.operator === "<=" && !Mr(a.semver, String(m), r))
        return !1;
    }
  ...
  if (!e)
    return t;
  const n = zs(e.semver, t.semver, r);
...
var oE = iE;
const Ia = wn, Dl = Ui, lE = Ue, Ol = Sf, cE = Rr, uE = gw, fE = xw, dE = vw, pE = _w, hE = Aw, mE = Rw, gE = Pw, yE = Fw, wE = Ze, xE = Mw, EE = zw, vE = $s, TE = Xw, _E = Yw, bE = Bi, SE = Ls, AE = Af, IE = If, CE = Us, RE = Ms, DE = Cf, OE = wx, PE = ji(), kE = et(), NE = zi, FE = Sx, $E = Rx, LE = kx, UE = $x, ME = Mx, BE = Bs, jE = Yx, zE = Qx, GE = eE, HE = nE, qE = oE;
var Df = {
  parse: cE,
  valid: uE,
  clean: fE,
...
Ti.exports;
(function(e, t) {
  var r = 200, n = "__lodash_hash_undefined__", i = 1, a = 2, s = 9007199254740991, o = "[object Arguments]", l = "[object Array]", d = "[object AsyncFunction]", c = "[object Boolean]", u = "[object Date]", p = "[object Error]", m = "[object Function]", x = "[object GeneratorFunction]", w = "[object Map]", T = "[object Number]", b = "[object Null]", _ = "[object Object]", N = "[object Promise]", $ = "[object Proxy]", B = "[object RegExp]", P = "[object Set]", G = "[object String]", ae = "[object Symbol]", y = "[object Undefined]", M = "[object WeakMap]", j = "[object ArrayBuffer]", U = "[object DataView]", Y = "[object Float32Array]", R = "[object Float64Array]", S = "[object Int8Array]", O = "[object Int16Array]", A = "[object Int32Array]", F = "[object Uint8Array]", D = "[object Uint8ClampedArray]", q = "[object Uint16Array]", K = "[object Uint32Array]", X = /[\\^$.*+?()[\]{}|]/g, te = /^\[object .+?Constructor\]$/, ge = /^(?:0|[1-9]\d*)$/, H = {};
  H[Y] = H[R] = H[S] = H[O] = H[A] = H[F] = H[D] = H[q] = H[K] = !0, H[o] = H[l] = H[j] = H[c] = H[U] = H[u] = H[p] = H[m] = H[w] = H[T] = H[_] = H[B] = H[P] = H[G] = H[M] = !1;
  var tt = typeof Pe == "object" && Pe && Pe.Object === Object && Pe, h = typeof self == "object" && self && self.Object === Object && self, f = tt || h || Function("return this")(), I = t && !t.nodeType && t, v = I && !0 && e && !e.nodeType && e, Z = v && v.exports === I, se = Z && tt.process, fe = function() {
    try {
  ...
  function mt(g, E) {
    for (var C = -1, L = E.length, oe = g.length; ++C < L; )
      g[oe + C] = E[C];
    return g;
  }
  function he(g, E) {
  ...
  var gd = Array.prototype, yd = Function.prototype, In = Object.prototype, ra = f["__core-js_shared__"], Qs = yd.toString, rt = In.hasOwnProperty, Zs = function() {
    var g = /[^.]+$/.exec(ra && ra.keys && ra.keys.IE_PROTO || "");
    return g ? "Symbol(src)_1." + g : "";
  }(), eo = In.toString, wd = RegExp(
    "^" + Qs.call(rt).replace(X, "\\$&").replace(/hasOwnProperty|(function).*?(?=\\\()| for .+?(?=\\\])/g, "$1.*?") + "$"
  ), to = Z ? f.Buffer : void 0, Cn = f.Symbol, ro = f.Uint8Array, no = In.propertyIsEnumerable, xd = gd.splice, Ft = Cn ? Cn.toStringTag : void 0, io = Object.getOwnPropertySymbols, Ed = to ? to.isBuffer : void 0, vd = hd(Object.keys, Object), na = nr(f, "DataView"), Pr = nr(f, "Map"), ia = nr(f, "Promise"), aa = nr(f, "Set"), sa = nr(f, "WeakMap"), kr = nr(Object, "create"), Td = Ut(na), _d = Ut(Pr), bd = Ut(ia), Sd = Ut(aa), Ad = Ut(sa), ao = Cn ? Cn.prototype : void 0, oa = ao ? ao.valueOf : void 0;
  function $t(g) {
  ...
  function Rd(g) {
    ...
    return rt.call(E, g) ? E[g] : void 0;
  }
  function Dd(g) {
    var E = this.__data__;
    return kr ? E[g] !== void 0 : rt.call(E, g);
  }
  function Od(g, E) {
    var C = this.__data__;
    return this.size += this.has(g) ? 0 : 1, C[g] = kr && E === void 0 ? n : E, this;
  }
  $t.prototype.clear = Id, $t.prototype.delete = Cd, $t.prototype.get = Rd, $t.prototype.has = Dd, $t.prototype.set = Od;
  function ct(g) {
    var E = -1, C = g == null ? 0 : g.length;
    for (this.clear(); ++E < C; ) {
      var L = g[E];
  ...
  function Fd(g) {
    return Dn(this.__data__, g) > -1;
  }
  function $d(g, E) {
    var C = this.__data__, L = Dn(C, g);
    return L < 0 ? (++this.size, C.push([g, E])) : C[L][1] = E, this;
  }
  ct.prototype.clear = Pd, ct.prototype.delete = kd, ct.prototype.get = Nd, ct.prototype.has = Fd, ct.prototype.set = $d;
  function Lt(g) {
    var E = -1, C = g == null ? 0 : g.length;
    for (this.clear(); ++E < C; ) {
      var L = g[E];
  ...
  function Ud(g) {
    var E = On(this, g).delete(g);
    return this.size -= E ? 1 : 0, E;
  }
  function Md(g) {
    return On(this, g).get(g);
  }
  function Bd(g) {
    return On(this, g).has(g);
  }
  function jd(g, E) {
    var C = On(this, g), L = C.size;
    return C.set(g, E), this.size += C.size == L ? 0 : 1, this;
  }
  ...
  Rn.prototype.add = Rn.prototype.push = zd, Rn.prototype.has = Gd;
  function gt(g) {
    var E = this.__data__ = new ct(g);
    this.size = E.size;
  }
  function Hd() {
  ...
  function Vd(g, E) {
    ...
    if (C instanceof ct) {
      var L = C.__data__;
      if (!Pr || L.length < r - 1)
        return L.push([g, E]), this.size = ++C.size, this;
  ...
  function Yd(g, E) {
    var C = Pn(g), L = !C && up(g), oe = !C && !L && la(g), V = !C && !L && !oe && mo(g), de = C || L || oe || V, ye = de ? We(g.length, String) : [], Te = ye.length;
    for (var le in g)
  ...
  function oo(g, E, C, L, oe) {
    return g === E ? !0 : g == null || E == null || !Fr(g) && !Fr(E) ? g !== g && E !== E : Jd(g, E, C, L, oo, oe);
  }
  function Jd(g, E, C, L, oe, V) {
    var de = Pn(g), ye = Pn(E), Te = de ? l : yt(g), le = ye ? l : yt(E);
    Te = Te == o ? _ : Te, le = le == o ? _ : le;
    var je = Te == _, Ve = le == _, Ae = Te == le;
    if (Ae && la(g)) {
      if (!la(E))
        return !1;
      de = !0, je = !1;
    ...
    if (Ae && !je)
      return V || (V = new gt()), de || mo(g) ? lo(g, E, C, L, oe, V) : tp(g, E, Te, C, L, oe, V);
    if (!(C & i)) {
      var He = je && rt.call(g, "__wrapped__"), qe = Ve && rt.call(E, "__wrapped__");
      if (He || qe) {
        var wt = He ? g.value() : g, ut = qe ? E.value() : E;
        return V || (V = new gt()), oe(wt, ut, C, L, V);
      }
    }
    return Ae ? (V || (V = new gt()), rp(g, E, C, L, oe, V)) : !1;
  }
  function Qd(g) {
    if (!ho(g) || op(g))
      return !1;
  ...
  function Zd(g) {
    return Fr(g) && po(g.length) && !!H[Nr(g)];
  }
  function ep(g) {
    if (!lp(g))
      return vd(g);
    ...
    for (var C in Object(g))
      rt.call(g, C) && C != "constructor" && E.push(C);
    return E;
  }
  function lo(g, E, C, L, oe, V) {
    var de = C & i, ye = g.length, Te = E.length;
    if (ye != Te && !(de && Te > ye))
      return !1;
    var le = V.get(g);
    if (le && V.get(E))
      return le == E;
    var je = -1, Ve = !0, Ae = C & a ? new Rn() : void 0;
    for (V.set(g, E), V.set(E, g); ++je < ye; ) {
      var He = g[je], qe = E[je];
      if (L)
        var wt = de ? L(qe, He, je, E, g, V) : L(He, qe, je, g, E, V);
      if (wt !== void 0) {
        if (wt)
          continue;
        Ve = !1;
      ...
      if (Ae) {
        if (!he(E, function(ut, Mt) {
          if (!Sn(Ae, Mt) && (He === ut || oe(He, ut, C, L, V)))
            return Ae.push(Mt);
        })) {
          Ve = !1;
          break;
    ...
    return V.delete(g), V.delete(E), Ve;
  }
  function tp(g, E, C, L, oe, V, de) {
    switch (C) {
      case U:
      ...
      case j:
        return !(g.byteLength != E.byteLength || !V(new ro(g), new ro(E)));
      case c:
      case u:
      case T:
        return uo(+g, +E);
      ...
      case P:
        var Te = L & i;
        if (ye || (ye = md), g.size != E.size && !Te)
          return !1;
        var le = de.get(g);
        if (le)
          return le == E;
        L |= a, de.set(g, E);
        var je = lo(ye(g), ye(E), L, oe, V, de);
        return de.delete(g), je;
      case ae:
        if (oa)
          return oa.call(g) == oa.call(E);
    }
    return !1;
  }
  function rp(g, E, C, L, oe, V) {
    var de = C & i, ye = co(g), Te = ye.length, le = co(E), je = le.length;
    if (Te != je && !de)
      return !1;
    for (var Ve = Te; Ve--; ) {
      var Ae = ye[Ve];
      if (!(de ? Ae in E : rt.call(E, Ae)))
        return !1;
    }
    var He = V.get(g);
    if (He && V.get(E))
    ...
    for (var wt = de; ++Ve < Te; ) {
      ...
      var ut = g[Ae], Mt = E[Ae];
      if (L)
        var go = de ? L(Mt, ut, Ae, E, g, V) : L(ut, Mt, Ae, g, E, V);
      if (!(go === void 0 ? ut === Mt || oe(ut, Mt, C, L, V) : go)) {
        qe = !1;
        break;
      }
    ...
    if (qe && !wt) {
      var kn = g.constructor, Nn = E.constructor;
      kn != Nn && "constructor" in g && "constructor" in E && !(typeof kn == "function" && kn instanceof kn && typeof Nn == "function" && Nn instanceof Nn) && (qe = !1);
    }
    return V.delete(g), V.delete(E), qe;
  }
  function co(g) {
    return Kd(g, pp, ip);
  }
  function On(g, E) {
    var C = g.__data__;
    return sp(E) ? C[typeof E == "string" ? "string" : "hash"] : C.map;
  }
  function nr(g, E) {
    var C = Or(g, E);
  ...
  function np(g) {
    ...
    var oe = eo.call(g);
    return L && (E ? g[Ft] = C : delete g[Ft]), oe;
  }
  var ip = io ? function(g) {
    return g == null ? [] : (g = Object(g), Se(io(g), function(E) {
      return no.call(g, E);
    }));
  } : hp, yt = Nr;
  (na && yt(new na(new ArrayBuffer(1))) != U || Pr && yt(new Pr()) != w || ia && yt(ia.resolve()) != N || aa && yt(new aa()) != P || sa && yt(new sa()) != M) && (yt = function(g) {
    var E = Nr(g), C = E == _ ? g.constructor : void 0, L = C ? Ut(C) : "";
    if (L)
      switch (L) {
        case Td:
          return U;
  ...
  function ap(g, E) {
    return E = E ?? s, !!E && (typeof g == "number" || ge.test(g)) && g > -1 && g % 1 == 0 && g < E;
  }
  function sp(g) {
    var E = typeof g;
  ...
  function lp(g) {
    var E = g && g.constructor, C = typeof E == "function" && E.prototype || In;
    return g === C;
  }
  function cp(g) {
    return eo.call(g);
  ...
  var up = so(/* @__PURE__ */ function() {
    return arguments;
  }()) ? so : function(g) {
    return Fr(g) && rt.call(g, "callee") && !no.call(g, "callee");
  }, Pn = Array.isArray;
  function fp(g) {
    return g != null && po(g.length) && !fo(g);
  }
  var la = Ed || mp;
  function dp(g, E) {
    return oo(g, E);
...
xn.DownloadedUpdateHelper = void 0;
xn.createTempUpdateFile = JE;
const WE = dn, VE = Pt, Pl = XE, Gt = kt, Vr = ue;
class YE {
  constructor(t) {
  ...
  async validateDownloadedPath(t, r, n, i) {
    if (this.versionInfo != null && this.file === t && this.fileInfo != null)
      return Pl(this.versionInfo, r) && Pl(this.fileInfo.info, n.info) && await (0, Gt.pathExists)(t) ? t : null;
  ...
  async getValidCachedUpdateFile(t, r) {
    ...
    const o = Vr.join(this.cacheDirForPendingUpdate, a.fileName);
...
async function JE(e, t, r) {
  ...
  for (let a = 0; a < 3; a++)
    try {
      ...
      if (s.code === "ENOENT")
        return i;
      r.warn(`Error on remove temp update file: ${s}`), i = Vr.join(t, `${n++}-${e}`);
    }
  return i;
}
var Gi = {}, Gs = {};
Object.defineProperty(Gs, "__esModule", { value: !0 });
Gs.getAppCacheDir = ZE;
const Ca = ue, QE = Ci;
function ZE() {
  const e = (0, QE.homedir)();
  let t;
  return process.platform === "win32" ? t = process.env.LOCALAPPDATA || Ca.join(e, "AppData", "Local") : process.platform === "darwin" ? t = Ca.join(e, "Library", "Caches") : t = process.env.XDG_CACHE_HOME || Ca.join(e, ".cache"), t;
}
...
var En = {}, Xe = {}, rv = "[object Symbol]", Pf = /[\\^$.*+?()[\]{}|]/g, nv = RegExp(Pf.source), iv = typeof Pe == "object" && Pe && Pe.Object === Object && Pe, av = typeof self == "object" && self && self.Object === Object && self, sv = iv || av || Function("return this")(), ov = Object.prototype, lv = ov.toString, Nl = sv.Symbol, Fl = Nl ? Nl.prototype : void 0, $l = Fl ? Fl.toString : void 0;
function cv(e) {
  if (typeof e == "string")
    return e;
  if (fv(e))
...
function pv(e) {
  return e = dv(e), e && nv.test(e) ? e.replace(Pf, "\\$&") : e;
}
var hv = pv;
Object.defineProperty(Xe, "__esModule", { value: !0 });
Xe.newBaseUrl = gv;
Xe.newUrlFromBase = ns;
Xe.getChannelFilename = yv;
Xe.blockmapFiles = wv;
const kf = Sr, mv = hv;
function gv(e) {
  const t = new kf.URL(e);
  return t.pathname.endsWith("/") || (t.pathname += "/"), t;
}
function ns(e, t, r = !1) {
  const n = new kf.URL(e, t), i = t.search;
...
function wv(e, t, r) {
  const n = ns(`${e.pathname}.blockmap`, e);
  return [ns(`${e.pathname.replace(new RegExp(mv(r), "g"), t)}.blockmap`, e), n];
}
var me = {};
...
function _v(e, t, r = (n) => n) {
  const i = Nf(e).map((o) => {
    ...
    return {
      url: (0, Ll.newUrlFromBase)(r(o.url), t),
      info: o
    };
...
class bv extends Da.Provider {
  constructor(t, r, n) {
    super(n), this.configuration = t, this.updater = r, this.baseUrl = (0, Ra.newBaseUrl)(this.configuration.url);
  }
  get channel() {
  ...
  async getLatestVersion() {
    const t = (0, Ra.getChannelFilename)(this.channel), r = (0, Ra.newUrlFromBase)(t, this.baseUrl, this.updater.isAddNoCacheQuery);
    for (let n = 0; ; n++)
      try {
        return (0, Da.parseUpdateInfo)(await this.httpRequest(r), t, r);
      } catch (i) {
...
En.GenericProvider = bv;
var Hi = {}, qi = {};
Object.defineProperty(qi, "__esModule", { value: !0 });
qi.BitbucketProvider = void 0;
const Ml = Ee, Oa = Xe, Pa = me;
class Sv extends Pa.Provider {
  constructor(t, r, n) {
    super({
      ...n,
  ...
  async getLatestVersion() {
    const t = new Ml.CancellationToken(), r = (0, Oa.getChannelFilename)(this.getCustomChannelName(this.channel)), n = (0, Oa.newUrlFromBase)(r, this.baseUrl, this.updater.isAddNoCacheQuery);
    try {
...
qi.BitbucketProvider = Sv;
var Ot = {};
Object.defineProperty(Ot, "__esModule", { value: !0 });
Ot.GitHubProvider = Ot.BaseGitHubProvider = void 0;
Ot.computeReleaseNotes = $f;
const ft = Ee, mr = Df, Av = Sr, gr = Xe, is = me, ka = /\/tag\/([^/]+)$/;
class Ff extends is.Provider {
  constructor(t, r, n) {
    super({
      ...n,
...
class Iv extends Ff {
  ...
  async getLatestVersion() {
    var t, r, n, i, a;
    const s = new ft.CancellationToken(), o = await this.httpRequest((0, gr.newUrlFromBase)(`${this.basePath}.atom`, this.baseUrl), {
      ...
      if (this.updater.allowPrerelease) {
        ...
        if (T === null)
          ...
          for (const b of l.getElements("entry")) {
            ...
            if (_ === null)
              continue;
            const N = _[1], $ = ((n = mr.prerelease(N)) === null || n === void 0 ? void 0 : n[0]) || null, B = !T || ["alpha", "beta"].includes(T), P = $ !== null && !["alpha", "beta"].includes(String($));
            if (B && !P && !(T === "beta" && $ === "alpha")) {
              c = N;
              break;
            }
...
${o}`, "ERR_UPDATER_INVALID_RELEASE_FEED");
    ...
    let u, p = "", m = "";
    const x = async (T) => {
      p = (0, gr.getChannelFilename)(T), m = (0, gr.newUrlFromBase)(this.getBaseDownloadPath(String(c), p), this.baseUrl);
    ...
    const w = (0, is.parseUpdateInfo)(u, p, m);
  ...
  async getLatestTagName(t) {
    const r = this.options, n = r.host == null || r.host === "github.com" ? (0, gr.newUrlFromBase)(`${this.basePath}/latest`, this.baseUrl) : new Av.URL(`${this.computeGithubBasePath(`/repos/${r.owner}/${r.repo}/releases`)}/latest`, this.baseApiUrl);
    try {
  ...
  resolveFiles(t) {
    return (0, is.resolveFiles)(t, this.baseUrl, (r) => this.getBaseDownloadPath(t.tag, r.replace(/ /g, "-")));
  }
  getBaseDownloadPath(t, r) {
    return `${this.basePath}/download/${t}/${r}`;
  }
}
Ot.GitHubProvider = Iv;
function Bl(e) {
...
function $f(e, t, r, n) {
  ...
  return i.sort((a, s) => mr.rcompare(a.version, s.version));
}
var Xi = {};
Object.defineProperty(Xi, "__esModule", { value: !0 });
Xi.KeygenProvider = void 0;
const jl = Ee, Na = Xe, Fa = me;
class Cv extends Fa.Provider {
  constructor(t, r, n) {
    super({
      ...n,
      isUseMultipleRangeRequest: !1
    ...
    this.baseUrl = (0, Na.newBaseUrl)(`https://${i}/v1/accounts/${this.configuration.account}/artifacts?product=${this.configuration.product}`);
  }
  get channel() {
    return this.updater.channel || this.configuration.channel || "stable";
  }
  async getLatestVersion() {
    const t = new jl.CancellationToken(), r = (0, Na.getChannelFilename)(this.getCustomChannelName(this.channel)), n = (0, Na.newUrlFromBase)(r, this.baseUrl, this.updater.isAddNoCacheQuery);
    try {
...
Xi.KeygenProvider = Cv;
var Wi = {};
Object.defineProperty(Wi, "__esModule", { value: !0 });
Wi.PrivateGitHubProvider = void 0;
const or = Ee, Rv = be, Dv = ue, zl = Sr, Gl = Xe, Ov = Ot, Pv = me;
class kv extends Ov.BaseGitHubProvider {
  constructor(t, r, n, i) {
  ...
  async getLatestVersion() {
    const t = new or.CancellationToken(), r = (0, Gl.getChannelFilename)(this.getDefaultChannelName()), n = await this.getLatestVersionInfo(t), i = n.assets.find((o) => o.name === r);
    if (i == null)
      throw (0, or.newError)(`Cannot find ${r} in the release ${n.html_url || n.name}`, "ERR_UPDATER_CHANNEL_FILE_NOT_FOUND");
    const a = new zl.URL(i.url);
    let s;
    try {
      s = (0, Rv.load)(await this.httpRequest(a, this.configureHeaders("application/octet-stream"), t));
    } catch (o) {
      throw o instanceof or.HttpError && o.statusCode === 404 ? (0, or.newError)(`Cannot find ${r} in the latest release artifacts (${a}): ${o.stack || o.message}`, "ERR_UPDATER_CHANNEL_FILE_NOT_FOUND") : o;
    }
  ...
  resolveFiles(t) {
    return (0, Pv.getFileList)(t).map((r) => {
      const n = Dv.posix.basename(r.url).replace(/ /g, "-"), i = t.assets.find((a) => a != null && a.name === n);
      if (i == null)
        throw (0, or.newError)(`Cannot find asset "${n}" in: ${JSON.stringify(t.assets, null, 2)}`, "ERR_UPDATER_ASSET_NOT_FOUND");
      return {
        url: new zl.URL(i.url),
        info: r
      };
    });
  }
}
Wi.PrivateGitHubProvider = kv;
Object.defineProperty(Hi, "__esModule", { value: !0 });
Hi.isUrlProbablySupportMultiRangeRequests = Lf;
Hi.createClient = Uv;
const Vn = Ee, Nv = qi, Hl = En, Fv = Ot, $v = Xi, Lv = Wi;
function Lf(e) {
  return !e.includes("s3.amazonaws.com");
}
function Uv(e, t, r) {
  if (typeof e == "string")
    throw (0, Vn.newError)("Please pass PublishConfiguration object", "ERR_UPDATER_INVALID_PROVIDER_CONFIGURATION");
  const n = e.provider;
  switch (n) {
    case "github": {
    ...
    case "spaces":
      return new Hl.GenericProvider({
        provider: "generic",
        url: (0, Vn.getS3LikeProviderBaseUrl)(e),
    ...
    case "custom": {
      ...
      if (!a)
        throw (0, Vn.newError)("Custom provider not specified", "ERR_UPDATER_INVALID_PROVIDER_CONFIGURATION");
      return new a(i, t, r);
    }
    default:
      throw (0, Vn.newError)(`Unsupported provider: ${n}`, "ERR_UPDATER_UNSUPPORTED_PROVIDER");
  }
}
var Vi = {}, vn = {}, Dr = {}, rr = {};
...
function Mv(e, t, r) {
  const n = Xl(e.files), i = Xl(t.files);
  let a = null;
  ...
  for (let w = 0; w < c.checksums.length; x += c.sizes[w], w++) {
    ...
    let _ = p.get(b);
    _ != null && m.get(b) !== T && (r.warn(`Checksum ("${b}") matches, but size differs (old: ${m.get(b)}, new: ${T})`), _ = void 0), _ === void 0 ? (u++, a != null && a.kind === Wt.DOWNLOAD && a.end === x ? a.end += T : (a = {
      kind: Wt.DOWNLOAD,
      start: x,
      end: x + T
      // oldBlocks: null,
    }, ql(a, o, b, w))) : a != null && a.kind === Wt.COPY && a.end === _ ? a.end += T : (a = {
      kind: Wt.COPY,
      start: _,
      end: _ + T
      // oldBlocks: [checksum]
...
Dr.copyData = Uf;
const Yn = Ee, zv = Pt, Gv = fn, Hv = rr, Wl = Buffer.from(`\r
\r
`);
var vt;
(function(e) {
...
class qv extends Gv.Writable {
  ...
  async handleData(t) {
    ...
    if (this.ignoreByteCount !== 0 && this.remainingPartDataCount !== 0)
      throw (0, Yn.newError)("Internal error", "ERR_DATA_SPLITTER_BYTE_COUNT_MISMATCH");
        ...
        if (this.readState === vt.BODY)
          ...
          if (s == null)
            if (this.isFinished)
              ...
              throw (0, Yn.newError)("taskIndex is null", "ERR_DATA_SPLITTER_TASK_INDEX_IS_NULL");
          ...
          if (o < s)
            ...
            throw (0, Yn.newError)("prevTaskIndex must be < taskIndex", "ERR_DATA_SPLITTER_TASK_INDEX_ASSERT_FAILED");
          if (this.isFinished) {
  ...
  onPartEnd() {
    ...
    if (this.actualPartLength !== t)
      throw (0, Yn.newError)(`Expected length: ${t} differs from actual: ${this.actualPartLength}`, "ERR_DATA_SPLITTER_LENGTH_MISMATCH");
...
Yi.executeTasksUsingMultipleRangeRequests = Xv;
Yi.checkIsRangesSupported = ss;
const as = Ee, Vl = Dr, Yl = rr;
...
function Wv(e, t, r, n, i) {
  ...
  for (let u = t.start; u < t.end; u++) {
    const p = t.tasks[u];
    p.kind === Yl.OperationKind.DOWNLOAD && (a += `${p.start}-${p.end - 1}, `, o.set(s, u), s++, l.push(p.end - p.start));
  }
  if (s <= 1) {
    const u = (p) => {
      if (p >= t.end) {
      ...
      const m = t.tasks[p++];
      if (m.kind === Yl.OperationKind.COPY)
        (0, Vl.copyData)(m, r, t.oldFileFd, i, () => u(p));
      else {
  ...
  const c = e.httpExecutor.createRequest(d, (u) => {
    if (!ss(u, i))
      return;
    const p = (0, as.safeGetHeader)(u, "content-type"), m = /^multipart\/.+?(?:; boundary=(?:(?:"(.+)")|(?:([^\s]+))))$/i.exec(p);
    if (m == null) {
      i(new Error(`Content-Type "multipart/byteranges" is expected, but got "${p}"`));
      return;
    }
    const x = new Vl.DataSplitter(r, t, o, m[1] || m[2], l, n);
...
Ki.ProgressDifferentialDownloadCallbackTransform = Yv;
Object.defineProperty(vn, "__esModule", { value: !0 });
vn.DifferentialDownloader = void 0;
const Br = Ee, $a = kt, Kv = Pt, Jv = Dr, Qv = Sr, Kn = rr, Kl = Yi, Zv = Ki;
class eT {
  ...
  doDownload(t, r) {
    ...
    for (const l of i) {
      ...
      l.kind === Kn.OperationKind.DOWNLOAD ? a += d : s += d;
    }
    ...
    return n.info(`Full: ${Jl(o)}, To download: ${Jl(a)} (${Math.round(a / (o / 100))}%)`), this.downloadFile(i);
  }
  downloadFile(t) {
    const r = [], n = () => Promise.all(r.map((i) => (0, $a.close)(i.descriptor).catch((a) => {
  ...
  async doDownloadFile(t, r) {
    const n = await (0, $a.open)(this.options.oldFile, "r");
    r.push({ descriptor: n, path: this.options.oldFile });
    const i = await (0, $a.open)(this.options.newFile, "w");
    ...
    await new Promise((s, o) => {
      ...
      if (!this.options.isUseMultipleRangeRequest && this.options.onProgress) {
        ...
        let _ = 0;
        for (const $ of t)
          $.kind === Kn.OperationKind.DOWNLOAD && (b.push($.end - $.start), _ += $.end - $.start);
        const N = {
      ...
      if (this.options.isUseMultipleRangeRequest) {
        m = (0, Kl.executeTasksUsingMultipleRangeRequests)(this, t, p, n, o), m(0);
        return;
      }
      let x = 0, w = null;
      ...
      T.redirect = "manual", m = (b) => {
        ...
        const P = this.httpExecutor.createRequest(T, (G) => {
          G.on("error", o), G.on("aborted", () => {
            o(new Error("response has been aborted by the server"));
          }), G.statusCode >= 400 && o((0, Br.createHttpError)(G)), G.pipe(p, {
            end: !1
          }), G.once("end", () => {
            d && d.endRangeDownload(), ++x === 100 ? (x = 0, setTimeout(() => m(b), 1e3)) : m(b);
          });
        });
        P.on("redirect", (G, ae, y) => {
          this.logger.info(`Redirect to ${tT(y)}`), w = y, (0, Br.configureRequestUrl)(new Qv.URL(w), T), P.followRedirect();
        }), this.httpExecutor.addErrorAndTimeoutHandlers(P, o), P.end();
      }, m(0);
    });
  }
...
Vi.GenericDifferentialDownloader = nT;
var Nt = {};
(function(e) {
...
const De = Ee, iT = dn, aT = Ci, sT = Rc, lr = kt, oT = be, La = Li, Bt = ue, Ht = Df, Ql = xn, lT = Gi, Zl = Of, cT = En, Ua = Hi, uT = Oc, fT = Xe, dT = Vi, cr = Nt;
class Hs extends sT.EventEmitter {
  /**
  ...
  set updateConfigPath(t) {
    this.clientPromise = null, this._appUpdateConfigPath = t, this.configOnDisk = new La.Lazy(() => this.loadUpdateConfig());
  }
  /**
  ...
  constructor(t, r) {
    super(), this.autoDownload = !0, this.autoInstallOnAppQuit = !0, this.autoRunAppAfterInstall = !0, this.allowPrerelease = !1, this.fullChangelog = !1, this.allowDowngrade = !1, this.disableWebInstaller = !1, this.disableDifferentialDownload = !1, this.forceDevUpdateConfig = !1, this._channel = null, this.downloadedUpdateHelper = null, this.requestHeaders = null, this._logger = console, this.signals = new cr.UpdaterSignal(this), this._appUpdateConfigPath = null, this._isUpdateSupported = (a) => this.checkIfUpdateSupported(a), this.clientPromise = null, this.stagingUserIdPromise = new La.Lazy(() => this.getOrCreateStagingUserId()), this.configOnDisk = new La.Lazy(() => this.loadUpdateConfig()), this.checkForUpdatesPromise = null, this.downloadPromise = null, this.updateInfoAndProvider = null, this._testOnlyOptions = null, this.on("error", (a) => {
      this._logger.error(`Error: ${a.stack || a.message}`);
    }), r == null ? (this.app = new lT.ElectronAppAdapter(), this.httpExecutor = new Zl.ElectronHttpExecutor((a, s) => this.emit("login", a, s))) : (this.app = r, this.httpExecutor = null);
  ...
  setFeedURL(t) {
    ...
    typeof t == "string" ? n = new cT.GenericProvider({ provider: "generic", url: t }, this, {
      ...r,
      isUseMultipleRangeRequest: (0, Ua.isUrlProbablySupportMultiRangeRequests)(t)
    }) : n = (0, Ua.createClient)(t, this, r), this.clientPromise = Promise.resolve(n);
  }
  /**
  ...
  checkForUpdatesAndNotify(t) {
    return this.checkForUpdates().then((r) => r != null && r.downloadPromise ? (r.downloadPromise.then(() => {
      const n = Hs.formatDownloadNotification(r.updateInfo.version, this.app.name, t);
  ...
  async getUpdateInfoAndProvider() {
    await this.app.whenReady(), this.clientPromise == null && (this.clientPromise = this.configOnDisk.value.then((n) => (0, Ua.createClient)(n, this, this.createProviderRuntimeOptions())));
  ...
  async getOrCreateDownloadHelper() {
    ...
    if (t == null) {
      ...
      n.debug != null && n.debug(`updater cache dir: ${i}`), t = new Ql.DownloadedUpdateHelper(i), this.downloadedUpdateHelper = t;
    }
    return t;
  }
  async executeDownload(t) {
    ...
    })), b = await (0, Ql.createTempUpdateFile)(`temp-${c}`, d, x);
    try {
    ...
    return x.info(`New version ${a} has been downloaded to ${u}`), await m(!0);
  }
...
class mT extends hT.AppUpdater {
  ...
  async spawnLog(t, r = [], n = void 0, i = "ignore") {
    return this._logger.info(`Executing: ${t} with args: ${r}`), new Promise((a, s) => {
      try {
        const o = { stdio: i, env: n, detached: !0 }, l = (0, ec.spawn)(t, r, o);
        l.on("error", (d) => {
          s(d);
...
Tn.FileWithEmbeddedBlockMapDifferentialDownloader = wT;
function Bf(e) {
...
async function xT(e) {
  ...
  try {
    ...
    return await (0, ur.read)(t, i, 0, i.length, r - n.length - i.length), await (0, ur.close)(t), Bf(i);
  } catch (r) {
    throw await (0, ur.close)(t), r;
  }
}
Object.defineProperty(an, "__esModule", { value: !0 });
an.AppImageUpdater = void 0;
const tc = Ee, rc = Ii, ET = kt, vT = Pt, jr = ue, TT = ht, _T = Tn, bT = me, nc = Nt;
class ST extends TT.BaseUpdater {
  ...
  doDownloadUpdate(t) {
    ...
    return this.executeDownload({
      ...
      task: async (i, a) => {
        ...
        if (s == null)
          throw (0, tc.newError)("APPIMAGE env is not defined", "ERR_UPDATER_OLD_FILE_NOT_FOUND");
  ...
  async downloadDifferential(t, r, n, i, a) {
    try {
      ...
      return this.listenerCount(nc.DOWNLOAD_PROGRESS) > 0 && (s.onProgress = (o) => this.emit(nc.DOWNLOAD_PROGRESS, o)), await new _T.FileWithEmbeddedBlockMapDifferentialDownloader(t.info, this.httpExecutor, s).download(), !1;
    } catch (s) {
  ...
  doInstall(t) {
    ...
    if (a == null)
      return this.dispatchError(new Error("No valid update available, can't quit and install")), !1;
    jr.basename(a) === i || !/\d+\.\d+\.\d+/.test(i) ? n = r : n = jr.join(jr.dirname(r), jr.basename(a)), (0, rc.execFileSync)("mv", ["-f", a, n]), n !== r && this.emit("appimage-filename-updated", n);
    const s = {
      ...process.env,
      APPIMAGE_SILENT_INSTALL: "true"
    };
    return t.isForceRunAfter ? this.spawnLog(n, [], s) : (s.APPIMAGE_EXIT_AFTER_INSTALL = "true", (0, rc.execFileSync)(n, [], { env: s })), !0;
  }
}
an.AppImageUpdater = ST;
var sn = {};
Object.defineProperty(sn, "__esModule", { value: !0 });
sn.DebUpdater = void 0;
const AT = ht, IT = me, ic = Nt;
...
const RT = ht, ac = Nt, DT = me;
class OT extends RT.BaseUpdater {
  constructor(t, r) {
    super(t, r);
  }
  /*** @private */
...
ln.RpmUpdater = void 0;
const PT = ht, sc = Nt, kT = me;
class NT extends PT.BaseUpdater {
  constructor(t, r) {
    super(t, r);
  }
  /*** @private */
  doDownloadUpdate(t) {
    const r = t.updateInfoAndProvider.provider, n = (0, kT.findFile)(r.resolveFiles(t.updateInfoAndProvider.info), "rpm", ["AppImage", "deb", "pacman"]);
    return this.executeDownload({
      fileExtension: "rpm",
      fileInfo: n,
      downloadUpdateOptions: t,
      task: async (i, a) => {
        this.listenerCount(sc.DOWNLOAD_PROGRESS) > 0 && (a.onProgress = (s) => this.emit(sc.DOWNLOAD_PROGRESS, s)), await this.httpExecutor.download(n.url, i, a);
      }
    });
  }
  get installerPath() {
...
cn.MacUpdater = void 0;
const oc = Ee, Ma = kt, FT = Pt, lc = ue, $T = _p, LT = It, UT = me, cc = Ii, uc = dn;
class MT extends LT.AppUpdater {
  ...
  async doDownloadUpdate(t) {
    ...
    let a = !1;
    try {
      this.debug("Checking for macOS Rosetta environment"), a = (0, cc.execFileSync)("sysctl", [i], { encoding: "utf8" }).includes(`${i}: 1`), n.info(`Checked for macOS Rosetta environment (isRosetta=${a})`);
    } catch (u) {
    ...
    try {
      ...
      const p = (0, cc.execFileSync)("uname", ["-a"], { encoding: "utf8" }).includes("ARM");
    ...
    return this.executeDownload({
      ...
      downloadUpdateOptions: t,
      task: async (u, p) => {
        const m = lc.join(this.downloadedUpdateHelper.cacheDir, c), x = () => (0, Ma.pathExistsSync)(m) ? !t.disableDifferentialDownload : (n.info("Unable to locate previous update.zip for differential download (is this first install?), falling back to full download"), !1);
        let w = !0;
        ...
        if (!t.disableDifferentialDownload)
          try {
            const p = lc.join(this.downloadedUpdateHelper.cacheDir, c);
            await (0, Ma.copyFile)(u.downloadedFile, p);
          } catch (p) {
  ...
  async updateDownloaded(t, r) {
    var n;
    const i = r.downloadedFile, a = (n = t.info.size) !== null && n !== void 0 ? n : (await (0, Ma.stat)(i)).size, s = this._logger, o = `fileToProxy=${t.url.href}`;
    ...
    return await new Promise((d, c) => {
      const u = (0, uc.randomBytes)(64).toString("base64").replace(/\//g, "_").replace(/\+/g, "-"), p = Buffer.from(`autoupdater:${u}`, "ascii"), m = `/${(0, uc.randomBytes)(64).toString("hex")}.zip`;
      this.server.on("request", (x, w) => {
        ...
        if (s.info(`${T} requested`), T === "/") {
          ...
          const N = x.headers.authorization.split(" ")[1], $ = Buffer.from(N, "base64").toString("ascii"), [B, P] = $.split(":");
          if (B !== "autoupdater" || P !== u) {
...
qs.verifySignature = jT;
const fc = Ee, jf = Ii, BT = Ci, dc = ue;
function jT(e, t, r) {
  return new Promise((n, i) => {
    const a = t.replace(/'/g, "''");
    r.info(`Verifying signature ${a}`), (0, jf.execFile)('set "PSModulePath=" & chcp 65001 >NUL & powershell.exe', ["-NoProfile", "-NonInteractive", "-InputFormat", "None", "-Command", `"Get-AuthenticodeSignature -LiteralPath '${a}' | ConvertTo-Json -Compress"`], {
      ...
      try {
        ...
        if (c.Status === 0) {
          try {
            const x = dc.normalize(c.Path), w = dc.normalize(t);
            if (r.info(`LiteralPath: ${x}. Update Path: ${w}`), x !== w) {
              Ba(r, new Error(`LiteralPath of ${x} is different than ${w}`), l, i), n(null);
              return;
            }
          } catch (x) {
          ...
          const p = (0, fc.parseDn)(c.SignerCertificate.Subject);
          let m = !1;
          for (const x of e) {
            const w = (0, fc.parseDn)(x);
            if (w.size ? m = Array.from(w.keys()).every((b) => w.get(b) === p.get(b)) : x === p.get("CN") && (r.warn(`Signature validated using only CN ${x}. Please add your full Distinguished Name (DN) to publisherNames configuration`), m = !0), m) {
              n(null);
              return;
            }
          }
...
un.NsisUpdater = void 0;
const Jn = Ee, pc = ue, HT = ht, qT = Tn, hc = Nt, XT = me, WT = kt, VT = qs, mc = Sr;
class YT extends HT.BaseUpdater {
  ...
  doDownloadUpdate(t) {
    ...
    return this.executeDownload({
      ...
      task: async (i, a, s, o) => {
        ...
        if (c != null)
          throw await o(), (0, Jn.newError)(`New version ${t.updateInfoAndProvider.info.version} is not signed by the application owner: ${c}`, "ERR_UPDATER_INVALID_SIGNATURE");
        if (d && await this.differentialDownloadWebPackage(t, l, s, r))
          try {
            await this.httpExecutor.download(new mc.URL(l.path), s, {
  ...
  doInstall(t) {
    ...
    const a = () => {
      this.spawnLog(pc.join(process.resourcesPath, "elevate.exe"), [r].concat(n)).catch((s) => this.dispatchError(s));
    };
  ...
  async differentialDownloadWebPackage(t, r, n, i) {
    ...
    try {
      const a = {
        newUrl: new mc.URL(r.path),
        oldFile: pc.join(this.downloadedUpdateHelper.cacheDir, Jn.CURRENT_APP_PACKAGE_FILE_NAME),
        logger: this._logger,
        newFile: n,
      ...
      this.listenerCount(hc.DOWNLOAD_PROGRESS) > 0 && (a.onProgress = (s) => this.emit(hc.DOWNLOAD_PROGRESS, s)), await new qT.FileWithEmbeddedBlockMapDifferentialDownloader(r, this.httpExecutor, a).download();
    } catch (a) {
...
un.NsisUpdater = YT;
(function(e) {
  var t = Pe && Pe.__createBinding || (Object.create ? function(T, b, _, N) {
    N === void 0 && (N = _);
  ...
  function w() {
    if (process.platform === "win32")
      x = new un.NsisUpdater();
    else if (process.platform === "darwin")
      x = new cn.MacUpdater();
    else {
      x = new an.AppImageUpdater();
      try {
...
function e_(e) {
  try {
    ...
    return t instanceof ReadableStreamDefaultReader ? new gc(t) : new ZT(t);
  } catch (t) {
    if (t instanceof TypeError)
      return new gc(e.getReader());
    throw t;
  }
}
class Ji {
...
class Xs extends Ji {
  ...
  static async fromFile(t) {
    ...
    return new Xs(r, { fileInfo: { path: t, size: n.size } });
  }
  constructor(t, r) {
...
const o_ = Xs.fromFile;
/*! ieee754. BSD-3-Clause License. Feross Aboukhadijeh <https://feross.org/opensource> */
var Qi = function(e, t, r, n, i) {
...
}, Zi = function(e, t, r, n, i, a) {
  var s, o, l, d = a * 8 - i - 1, c = (1 << d) - 1, u = c >> 1, p = i === 23 ? Math.pow(2, -24) - Math.pow(2, -77) : 0, m = n ? 0 : a - 1, x = n ? 1 : -1, w = t < 0 || t === 0 && 1 / t < 0 ? 1 : 0;
  for (t = Math.abs(t), isNaN(t) || t === 1 / 0 ? (o = isNaN(t) ? 1 : 0, s = c) : (s = Math.floor(Math.log(t) / Math.LN2), t * (l = Math.pow(2, -s)) < 1 && (s--, l *= 2), s + u >= 1 ? t += p / l : t += p * Math.pow(2, 1 - u), t * l >= 2 && (s++, l /= 2), s + u >= c ? (o = 0, s = c) : s + u >= 1 ? (o = (t * l - 1) * Math.pow(2, i), s = s + u) : (o = t * Math.pow(2, u - 1) * Math.pow(2, i), s = 0)); i >= 8; e[r + m] = o & 255, m += x, o /= 256, i -= 8)
    ;
  for (s = s << i | o, d += i; d > 0; e[r + m] = s & 255, m += x, s /= 256, d -= 8)
    ;
  e[r + m - x] |= w * 128;
};
const ls = {
...
for (const [e, t] of Object.entries(ls))
  ;
...
function p_(e) {
  let t = "";
  for (const r of e)
    r >= 128 && r <= 159 && ls[r] ? t += ls[r] : t += String.fromCharCode(r);
  return t;
}
function W(e) {
...
const Kt = {
  ...
  len: 2,
  get(e, t) {
    return Qi(e, t, !1, 10, this.len);
  },
  put(e, t, r) {
    return Zi(e, r, t, !1, 10, this.len), t + this.len;
  }
}, __ = {
  len: 2,
  get(e, t) {
    return Qi(e, t, !0, 10, this.len);
  },
  put(e, t, r) {
    return Zi(e, r, t, !0, 10, this.len), t + this.len;
  }
}, b_ = {
  len: 4,
  get(e, t) {
  ...
  len: 10,
  get(e, t) {
    return Qi(e, t, !1, 63, this.len);
  },
  put(e, t, r) {
    return Zi(e, r, t, !1, 63, this.len), t + this.len;
  }
}, R_ = {
  len: 10,
  get(e, t) {
    return Qi(e, t, !0, 63, this.len);
  },
  put(e, t, r) {
    return Zi(e, r, t, !0, 63, this.len), t + this.len;
  }
};
class D_ {
  /**
...
const nt = Cr("tokenizer:inflate"), ja = 256 * 1024, F_ = Vf(wr.DataDescriptor), Qn = Vf(wr.EndOfCentralDirectory);
class Ws {
  constructor(t) {
    this.tokenizer = t, this.syncBuffer = new Uint8Array(ja);
  }
  async isZip() {
  ...
  async findEndOfCentralDirectoryLocator() {
    ...
    for (let i = n.length - 4; i >= 0; i--)
      if (n[i] === Qn[0] && n[i + 1] === Qn[1] && n[i + 2] === Qn[2] && n[i + 3] === Qn[3])
  ...
  async readCentralDirectory() {
    ...
    if (r > 0) {
      ...
      const n = await this.tokenizer.readToken(k_, r), i = [];
      ...
      for (let a = 0; a < n.nrOfEntriesOfSize; ++a) {
        ...
        if (s.signature !== wr.CentralFileHeader)
  ...
  async unzip(t) {
    ...
    do {
      ...
      if (nt(`Reading data-descriptor at pos=${this.tokenizer.position}`), i.dataDescriptor && (await this.tokenizer.readToken(yc)).signature !== 134695760)
        throw new Error(`Expected data-descriptor-signature at position ${this.tokenizer.position - yc.len}`);
    } while (!n);
  }
  ...
  async inflate(t, r, n) {
    ...
    const i = await Ws.decompressDeflateRaw(r);
    return n(i);
  }
  ...
  async readLocalFileHeader() {
    ...
    if (t === wr.LocalFileHeader) {
      const r = await this.tokenizer.readToken(P_);
...
class J_ {
  constructor(t) {
    ...
    Ye(this, "detectConfident", async (t) => {
      if (this.buffer = new Uint8Array(za), t.fileInfo.size === void 0 && (t.fileInfo.size = Number.MAX_SAFE_INTEGER), this.tokenizer = t, await t.peekBuffer(this.buffer, { length: 32, mayBeLess: !0 }), this.check([66, 77]))
        return {
          ext: "bmp",
          mime: "image/bmp"
        };
              ...
              return {
                async handler(i) {
                  ...
                  if (s === -1) {
                    ...
                    a.includes(`ContentType="${o}"`) && (r = Ga(o));
                  } else {
...
`, { offset: 2, encoding: r }) ? {
    ...
    Ye(this, "detectImprecise", async (t) => {
      if (this.buffer = new Uint8Array(za), await t.peekBuffer(this.buffer, { length: Math.min(8, t.fileInfo.size), mayBeLess: !0 }), this.check([0, 0, 1, 186]) || this.check([0, 0, 1, 179]))
        return {
          ext: "mpg",
          mime: "video/mpeg"
        };
  ...
  async fromBuffer(t) {
    ...
    if ((r == null ? void 0 : r.length) > 1)
      return this.fromTokenizer(os(r, this.tokenizerOptions));
  }
  async fromBlob(t) {
  ...
  async readTiffHeader(t) {
    const r = (t ? Xt : ie).get(this.buffer, 2), n = (t ? _i : J).get(this.buffer, 4);
    if (r === 42) {
      if (n >= 6) {
 ...
 * MIT Licensed
 */
var xc = /; *([!#$%&'*+.^_`|~0-9A-Za-z-]+) *= *("(?:[\u000b\u0020\u0021\u0023-\u005b\u005d-\u007e\u0080-\u00ff]|\\[\u000b\u0020-\u00ff])*"|[!#$%&'*+.^_`|~0-9A-Za-z-]+) */g, Q_ = /^[\u000b\u0020-\u007e\u0080-\u00ff]+$/, Kf = /^[!#$%&'*+.^_`|~0-9A-Za-z-]+$/, Z_ = /\\([\u000b\u0020-\u00ff])/g, eb = /([\\"])/g, Jf = /^[!#$%&'*+.^_`|~0-9A-Za-z-]+\/[!#$%&'*+.^_`|~0-9A-Za-z-]+$/;
Vs.format = tb;
Vs.parse = rb;
function tb(e) {
...
function rb(e) {
  ...
  if (r !== -1) {
    var a, s, o;
    for (xc.lastIndex = r; s = xc.exec(t); ) {
      if (s.index !== r)
...
const cA = {
  ...
  [dt.button]: "button",
  [dt.control]: "control"
}, _n = (e) => class extends Error {
  constructor(r) {
    super(r), this.name = e;
  }
};
class Qf extends _n("CouldNotDetermineFileTypeError") {
}
class Zf extends _n("UnsupportedFileTypeError") {
}
class fb extends _n("UnexpectedFileContentError") {
  constructor(t, r) {
...
class Ys extends _n("FieldDecodingError") {
}
class ed extends _n("InternalParserError") {
}
...
function hb(e) {
  const t = e.length;
  if (t & 1)
    throw new Ys("Buffer length must be even");
  for (let r = 0; r < t; r += 2) {
    const n = e[r];
    e[r] = e[r + 1], e[r + 1] = n;
  }
...
function fs(e, t) {
  if (e[0] === 255 && e[1] === 254)
    return fs(e.subarray(2), t);
  if (t === "utf-16le" && e[0] === 254 && e[1] === 255) {
    if (e.length & 1)
      throw new Ys("Expected even number of octets for 16-bit unicode string");
    return fs(hb(e), t);
  }
...
const hA = {
  ...
  get: (e, t) => ({
    ...
    version: {
      major: cs.get(e, t + 3),
      revision: cs.get(e, t + 4)
    },
    // ID3v2 flags
    flags: {
      // Unsynchronisation
      unsynchronisation: Hr(e, t + 5, 7),
      // Extended header
      isExtendedHeader: Hr(e, t + 5, 6),
      // Experimental indicator
      expIndicator: Hr(e, t + 5, 5),
      footer: Hr(e, t + 5, 4)
    },
    size: xb.get(e, t + 6)
  })
  ...
  get: (e, t) => ({
    ...
    // Size of padding
    sizeOfPadding: _i.get(e, t + 6),
    // CRC data present
    crcDataPresent: Hr(e, t + 4, 31)
  })
}, Eb = {
  len: 1,
  get: (e, t) => {
  ...
  isrc: { multiple: !0 },
  asin: k,
  musicbrainz_recordingid: k,
  musicbrainz_trackid: k,
  musicbrainz_albumid: k,
  musicbrainz_artistid: { multiple: !0 },
  musicbrainz_albumartistid: { multiple: !0 },
  musicbrainz_releasegroupid: k,
  musicbrainz_workid: k,
  musicbrainz_trmid: k,
  musicbrainz_discid: k,
  acoustid_id: k,
  acoustid_fingerprint: k,
  musicip_puid: k,
  musicip_fingerprint: k,
  website: k,
  ...
  discogs_release_id: k,
  discogs_label_id: k,
  discogs_master_release_id: k,
  discogs_votes: k,
  discogs_rating: k,
  replaygain_track_peak: k,
  replaygain_track_gain: k,
  replaygain_album_peak: k,
  replaygain_album_gain: k,
  replaygain_track_minmax: k,
  replaygain_album_minmax: k,
  replaygain_undo: k,
...
function Tb(e) {
  return bi[e] && !bi[e].multiple;
}
function _b(e) {
  return !bi[e].multiple || bi[e].unique || !1;
}
class Ge {
  ...
  postMap(t, r) {
    switch (t.id) {
      case "UFID":
        {
          const n = t.value;
          n.owner_identifier === "http://musicbrainz.org" && (t.id += `:${n.owner_identifier}`, t.value = fs(n.identifier, "latin1"));
        }
        break;
      case "PRIV":
        {
  ...
  postMap(t) {
    switch (t.id) {
      case "WM/SharedUserRating": {
        const r = t.id.split(":");
        t.value = Js.toRating(t.value), t.id = r[0];
        break;
      }
    }
  }
...
class Si extends Ge {
  ...
  postMap(t) {
    if (t.id === "RATING")
      t.value = Si.toRating(void 0, t.value, 100);
    else if (t.id.indexOf("RATING:") === 0) {
      const r = t.id.split(":");
      t.value = Si.toRating(r[1], t.value, 1), t.id = r[0];
    }
  }
}
const Fb = {
...
const ds = /\[(\d{2}):(\d{2})\.(\d{2,3})]/;
function zb(e) {
  return ds.test(e) ? Hb(e) : Gb(e);
}
function Gb(e) {
  return {
...
`), r = [];
  for (const n of t) {
    const i = n.match(ds);
    if (i) {
      const a = Number.parseInt(i[1], 10), s = Number.parseInt(i[2], 10), o = i[3].length === 3 ? Number.parseInt(i[3], 10) : Number.parseInt(i[3], 10) * 10, l = (a * 60 + s) * 1e3 + o, d = n.replace(ds, "").trim();
...
const jt = Cr("music-metadata:collector"), qb = ["matroska", "APEv2", "vorbis", "ID3v2.4", "ID3v2.3", "ID3v2.2", "exif", "asf", "iTunes", "AIFF", "ID3v1"];
class Xb {
  constructor(t) {
    this.format = {
      tagTypes: [],
...
const Vb = {
  ...
  async load() {
    return (await import("./MpegParser-eDJED134.js")).MpegParser;
  }
}, Yb = {
  parserType: "apev2",
  extensions: [".ape"],
  ...
  async load() {
    return (await import("./AsfParser-CrLUniqy.js")).AsfParser;
  }
}, Jb = {
  parserType: "dsdiff",
  extensions: [".dff"],
  ...
  async load() {
    return (await import("./DsdiffParser-Cu_y9Uth.js")).DsdiffParser;
  }
}, Qb = {
  parserType: "aiff",
  ...
  async load() {
    return (await import("./AiffParser-Dv2ujF3K.js")).AIFFParser;
  }
}, Zb = {
  parserType: "dsf",
  extensions: [".dsf"],
  mimeTypes: ["audio/dsf"],
  async load() {
    return (await import("./DsfParser-B31tXTcv.js")).DsfParser;
  }
}, eS = {
  parserType: "flac",
  extensions: [".flac"],
  ...
  async load() {
    return (await import("./FlacParser-TAlZk2mX.js").then((e) => e.d)).FlacParser;
  }
}, tS = {
  parserType: "matroska",
  ...
  async load() {
    return (await import("./MatroskaParser-BeeyrZxT.js")).MatroskaParser;
  }
}, rS = {
  parserType: "mp4",
  ...
  async load() {
    return (await import("./MP4Parser-CQpmwUuV.js")).MP4Parser;
  }
}, nS = {
  parserType: "musepack",
  extensions: [".mpc"],
  ...
  async load() {
    return (await import("./MusepackParser-a-dhCtKH.js")).MusepackParser;
  }
}, iS = {
  parserType: "ogg",
  ...
  async load() {
    return (await import("./OggParser-Dlaz54lu.js")).OggParser;
  }
}, aS = {
  parserType: "wavpack",
  extensions: [".wv", ".wvp"],
  ...
  async load() {
    return (await import("./WavPackParser-DZKiCnon.js")).WavPackParser;
  }
}, sS = {
  parserType: "riff",
  ...
  async load() {
    return (await import("./WaveParser-DbeB7fw2.js")).WaveParser;
  }
}, zt = Cr("music-metadata:parser:factory");
function oS(e) {
  const t = Vs.parse(e), r = ob(t.type);
  return {
    type: r.type,
    subtype: r.subtype,
    suffix: r.suffix,
...
class lS {
  ...
  async parse(t, r, n) {
    if (t.supportsRandomAccess() ? (zt("tokenizer supports random-access, scanning for appending headers"), await DS(t, n)) : zt("tokenizer does not support random-access, cannot scan for appending headers"), !r) {
...
function uS() {
  if (!(typeof globalThis.TextDecoder > "u"))
    return Zn ?? (Zn = new globalThis.TextDecoder("utf-8"));
}
function fS() {
  if (!(typeof globalThis.TextEncoder > "u"))
    return ei ?? (ei = new globalThis.TextEncoder());
}
const Zt = 32 * 1024;
function ea(e, t = "utf-8") {
  switch (t.toLowerCase()) {
    case "utf-8":
    case "utf8": {
      const r = uS();
...
const _S = /^[\x21-\x7e©][\x20-\x7e\x00()]{3}/, od = {
  len: 4,
  get: (e, t) => {
    const r = ea(e.subarray(t, t + od.len), "latin1");
    if (!r.match(_S))
      throw new Ys(`FourCC contains invalid characters: ${mb(r)} "${r}"`);
    return r;
  },
  put: (e, t, r) => {
    const n = dS(r, "latin1");
...
function ld(e) {
  return {
    containsHeader: ri(e, 31),
    containsFooter: ri(e, 30),
    isHeader: ri(e, 29),
    readOnly: ri(e, 0),
    dataType: (e & 6) >> 1
  };
...
const Et = Cr("music-metadata:parser:APEv2"), _c = "APEv2", bc = "APETAGEX";
class ui extends db("APEv2") {
}
function SS(e, t, r) {
...
class At extends id {
  ...
  static parseTagFooter(t, r, n) {
    ...
    if (i.ID !== bc)
      throw new ui("Unexpected APEv2 Footer ID preamble value");
    return os(r), new At(t, os(r), n).parseTags(i);
  }
  /**
  ...
  async parse() {
    const t = await this.tokenizer.readToken(Tc);
    if (t.ID !== "MAC ")
      throw new ui("Unexpected descriptor ID");
    this.ape.descriptor = t;
    const r = t.descriptorBytes - Tc.len, n = await (r > 0 ? this.parseDescriptorExpansion(r) : this.parseHeader());
  ...
  async parseTags(t) {
    ...
    for (let i = 0; i < t.fields; i++) {
      ...
      const a = await this.tokenizer.readToken(Ha);
      n -= Ha.len + a.size, await this.tokenizer.peekBuffer(r, { length: Math.min(r.length, n) });
      let s = Ec(r, 0, r.length);
      ...
      switch (await this.tokenizer.ignore(1), n -= o.length + 1, a.flags.dataType) {
        case ti.text_utf8: {
          ...
          await Promise.all(d.map((c) => this.metadata.addTag(_c, o, c)));
          break;
        }
        case ti.binary:
          if (this.options.skipCovers)
            ...
            await this.tokenizer.readBuffer(l), s = Ec(l, 0, l.length);
            const d = ea(l.subarray(0, s), "utf-8"), c = l.subarray(s + 1);
            await this.metadata.addTag(_c, o, {
              description: d,
              data: c
            });
          }
          break;
        case ti.external_info:
  ...
  async parseHeader() {
    ...
    if (this.metadata.setFormat("lossless", !0), this.metadata.setFormat("container", "Monkey's Audio"), this.metadata.setFormat("bitsPerSample", t.bitsPerSample), this.metadata.setFormat("sampleRate", t.sampleRate), this.metadata.setFormat("numberOfChannels", t.channel), this.metadata.setFormat("duration", At.calculateDuration(t)), !this.ape.descriptor)
      throw new ui("Missing APE descriptor");
    return {
...
}, Symbol.toStringTag, { value: "Module" })), ni = Cr("music-metadata:parser:ID3v1"), Sc = [
  "Blues",
  "Classic Rock",
  "Country",
  "Dance",
...
class cd extends id {
  ...
  async parse() {
    if (!this.tokenizer.fileInfo.size) {
      ni("Skip checking for ID3v1 because the file-size is unknown");
      return;
    }
    ...
    const t = this.tokenizer.fileInfo.size - ii.len;
    if (this.tokenizer.position > t) {
      ni("Already consumed the last 128 bytes");
      return;
    }
    const r = await this.tokenizer.readToken(ii, t);
    if (r) {
      ni("ID3v1 header found at: pos=%s", this.tokenizer.fileInfo.size - ii.len);
      ...
      ni("ID3v1 header not found at: pos=%s", this.tokenizer.fileInfo.size - ii.len);
  }
  async addTag(t, r) {
...
async function IS(e) {
  if (e.fileInfo.size >= 128) {
    ...
    return await e.readBuffer(t, { position: e.fileInfo.size - 128 }), e.setPosition(r), ea(t, "latin1") === "TAG";
  }
  return !1;
}
const CS = "LYRICS200";
...
const Ac = Cr("music-metadata:parser");
async function OS(e, t = {}) {
  Ac(`parseFile: ${e}`);
  const r = await o_(e), n = new lS();
  try {
    const i = n.findLoaderForExtension(e);
    i || Ac("Parser could not be determined by file extension");
    try {
...
class PS {
  constructor() {
    Ye(this, "client", null);
    Ye(this, "player", Ap());
    Ye(this, "currentResource", null);
    Ye(this, "currentConnection", null);
    Ye(this, "streamInput", null);
    Ye(this, "isConnected", !1);
    Ye(this, "currentGuildId", null);
    Ye(this, "currentChannelId", null);
  ...
  getChannels(t) {
    ...
    return r.channels.cache.filter((i) => i.type === xo.GuildVoice).map((i) => ({
      id: i.id,
      name: i.name,
  ...
  async joinChannel(t, r) {
    ...
    if (!i || i.type !== xo.GuildVoice) throw new Error("Invalid channel");
    try {
  ...
  async playFile(t, r) {
    ...
    try {
      ...
      const o = this.currentConnection.state.status;
      if (console.log(`[DiscordBot] Connection state: ${o}`), o === "destroyed" || o === "disconnected")
        throw new Error(`Voice connection is ${o}. Cannot play audio.`);
      if (!r) {
      ...
      this.currentResource = p, (s = p.volume) == null || s.setVolume(1), console.log("[DiscordBot] Audio resource created, starting playback"), this.player.play(p);
      const m = () => {
      ...
      this.player.removeAllListeners(ir.Playing), this.player.removeAllListeners(ir.Idle), this.player.removeAllListeners("error"), this.player.once(ir.Playing, m), this.player.once(ir.Idle, x), this.player.once("error", w);
    } catch (o) {
      throw console.error("[DiscordBot] Play File Error:", o), o;
    }
  }
  ...
  async playReceiverStream(t) {
    ...
    if (console.log("[DiscordBot] Starting Receiver Stream..."), this.streamInput = new Cp(), t) {
      console.log(`[DiscordBot] Using manual FFmpeg spawn: ${t}`);
      const { spawn: i } = await import("node:child_process"), s = i(t, [
        "-i",
        "pipe:0",
        // Input from stdin (PassThrough)
        "-analyzeduration",
        "0",
        "-loglevel",
        "0",
      ...
      this.streamInput.pipe(s.stdin), s.on("error", (l) => {
        console.error("[DiscordBot] Stream FFmpeg Error:", l);
      });
      const o = $r(s.stdout, {
        inputType: ca.Raw,
        inlineVolume: !0
      ...
      const i = $r(this.streamInput, {
        inputType: ca.WebmOpus,
        inlineVolume: !0
      });
  ...
  writeAudioChunk(t) {
    this.streamInput && !this.streamInput.destroyed && this.streamInput.write(t);
  }
}
const ud = ai(import.meta.url);
let Ai = ud("ffmpeg-static");
Je.isPackaged && (Ai = Ai.replace("app.asar", "app.asar.unpacked"));
function kS(e) {
...
const NS = Je.requestSingleInstanceLock();
NS ? Je.on("second-instance", () => {
  ee && (ee.isMinimized() && ee.restore(), ee.focus());
}) : Je.quit();
const fd = Oe.dirname(xp(import.meta.url));
process.env.APP_ROOT = Oe.join(fd, "..");
const ps = process.env.VITE_DEV_SERVER_URL, wA = Oe.join(process.env.APP_ROOT, "dist-electron"), dd = Oe.join(process.env.APP_ROOT, "dist");
process.env.VITE_PUBLIC = ps ? Oe.join(process.env.APP_ROOT, "public") : dd;
let ee;
function pd() {
  ee = new Ic({
    width: 1200,
    ...
    webPreferences: {
      preload: Oe.join(fd, "preload.mjs"),
      webSecurity: !1,
  ...
  }), ps ? ee.loadURL(ps) : ee.loadFile(Oe.join(dd, "index.html"));
}
Je.on("window-all-closed", () => {
  process.platform !== "darwin" && (Je.quit(), ee = null);
});
Je.on("activate", () => {
...
Je.whenReady().then(() => {
  process.platform === "win32" && Je.setAppUserModelId("NeonWave"), pd();
  const e = new PS();
  ne.handle("discord:login", async (i, a) => await e.login(a)), ne.handle("discord:getGuilds", () => e.getGuilds()), ne.handle("discord:getChannels", (i, a) => e.getChannels(a)), ne.handle("discord:join", async (i, a, s) => await e.joinChannel(a, s)), ne.handle("discord:leave", async () => await e.leaveChannel()), ne.handle("discord:disconnect", async () => await e.disconnect()), ne.handle("discord:play", async (i, a) => await e.playFile(a, Ai)), ne.handle("discord:stop", () => e.stop()), ne.handle("discord:pause", () => e.pause()), ne.handle("discord:resume", () => e.resume()), ne.handle("discord:setVolume", (i, a) => e.setVolume(a)), ne.handle("discord:status", () => e.getStatus()), ne.handle("discord:startStreamMode", async () => await e.playReceiverStream(Ai)), ne.on("discord:audio-chunk", (i, a) => {
    e.writeAudioChunk(new Uint8Array(a));
  }), ne.handle("dialog:openDirectory", async () => {
    const { canceled: i, filePaths: a } = await yo.showOpenDialog(ee, {
      properties: ["openDirectory"]
    });
    return i ? null : a[0];
  }), ne.handle("files:listMusic", async (i, a) => {
    if (!a) return [];
    try {
      const s = await Fn.readdir(a), o = [".mp3", ".wav", ".wma", ".m4a", ".flac", ".ogg", ".mp4", ".mov", ".wmv", ".avi"];
      return (await Promise.all(s.map(async (d) => {
        const c = Oe.join(a, d), u = Oe.extname(d).toLowerCase();
        if (!o.includes(u)) return null;
        try {
          const p = await Fn.stat(c);
          return {
            fullPath: c,
  ...
  }), ne.handle("files:readBuffer", async (i, a) => {
    try {
      return await Fn.readFile(a);
    } catch (s) {
      return console.error("Error reading file:", s), null;
    }
  }), ne.handle("files:getMetadata", async (i, a) => {
    try {
      const s = await OS(a);
      let o = null;
      if (s.common.picture && s.common.picture.length > 0) {
        const l = s.common.picture[0];
        o = `data:${l.format};base64,${Buffer.from(l.data).toString("base64")}`;
      }
      return {
        title: s.common.title,
        artist: s.common.artist,
        album: s.common.album,
        artwork: o,
        duration: s.format.duration,
        codec: s.format.codec,
        bitrate: s.format.bitrate,
        sampleRate: s.format.sampleRate
      };
    } catch {
      return null;
    }
  }), ne.handle("app:active-window", async () => {
    const i = Oe.join(process.env.APP_ROOT, "scripts/get-active-window.ps1");
    return await kS(i);
  });
  const t = ai(import.meta.url)("yt-dlp-wrap").default;
  let r = !1;
  const n = async () => {
    const i = process.platform === "win32" ? "yt-dlp.exe" : "yt-dlp", a = Oe.join(Je.getPath("userData"), i);
    try {
      await Fn.access(a);
    } catch {
      console.log("Downloading yt-dlp binary..."), await t.downloadFromGithub(a), console.log("Downloaded yt-dlp to", a), r = !0;
    }
    const s = new t(a);
    if (!r) {
      try {
        console.log("Checking for yt-dlp updates..."), await s.execPromise(["-U"]), console.log("yt-dlp updated successfully.");
      } catch (o) {
        console.warn("Failed to update yt-dlp:", o.message);
      }
      r = !0;
    }
    return s;
  };
  ne.handle("search:youtube", async (i, a) => {
    try {
...
`).map((d) => {
  ...
  }), ne.handle("download:youtube", async (i, a, s, o) => {
    try {
      const l = await n(), d = ai(import.meta.url)("ffmpeg-static").replace("app.asar", "app.asar.unpacked");
      let c = s.replace(/[\\/:*?"<>|]/g, "_").trim();
      const { filePath: u } = await yo.showSaveDialog(ee, {
        title: "下載歌曲",
        defaultPath: `${c}.m4a`,
      ...
      return u ? new Promise((p, m) => {
        ...
        o && (x.push("--parse-metadata", `${o}:%(artist)s`), x.push("--parse-metadata", `${o}:%(album_artist)s`)), s && x.push("--parse-metadata", `${s}:%(title)s`);
        const w = l.exec(x);
        w.on("progress", () => {
        }), w.on("error", (T) => {
  ...
  }), ne.handle("search:artistImage", async (i, a) => {
    try {
  ...
  }), ne.handle("search:lyrics", async (i, a, s, o, l) => {
    try {
      const d = ai(import.meta.url)("get-artist-title");
      ...
      const c = (B) => {
        ...
        const G = [
          ...
          const S = (A) => "\\" + A, O = new RegExp(`${S(Y)}([^${S(R)}]*)?${S(R)}`, "gi");
          return U.replace(O, (A, F) => !F || ae(F) ? " " : " " + F + " ");
        };
        return P = y(P, "(", ")"), P = y(P, "（", "）"), P = y(P, "[", "]"), P = y(P, "【", "】"), P = y(P, "{", "}"), P = y(P, "《", "》"), [
          ...
          /^[a-z0-9]+$/i.test(U) ? P = P.replace(new RegExp(`\\b${U}\\b`, "gi"), " ") : P = P.replace(new RegExp(U, "gi"), " ");
        }), P = P.replace(/[:"'_\|\.,!@#$%^&*+=?\/\\♪♫~`\-]/g, " "), P.replace(/\s+/g, " ").trim();
      }, u = (B, P) => P ? Math.abs(B - P) : 0, p = async (B, P) => {
        try {
        ...
        try {
          ...
          let M = y.result.songs.map((S) => {
            ...
            return {
              id: S.id,
              track: S.name,
              artist: ((A = (O = S.artists) == null ? void 0 : O[0]) == null ? void 0 : A.name) || "Unknown",
              duration: S.duration / 1e3,
              // ms to s
              diff: P ? u(S.duration / 1e3, P) : 0
            };
          });
          if (P && (M = M.filter((S) => S.diff <= 5), M.sort((S, O) => S.diff - O.diff)), M.length === 0) return [];
      ...
      if (o) {
        let B = Oe.basename(o, Oe.extname(o));
        const P = B.match(/(.+?)《(.+?)》(.*)/);
        if (P) {
          const y = P[1], M = P[2], j = c(y).replace(/合唱/g, "").trim(), U = c(M);
          if (U) {
            const Y = `${U} ${j}`;
      ...
      w.forEach((B) => {
        const P = `${B.source}-${B.id}`;
        _.has(P) || _.set(P, B);
      });
      let N = Array.from(_.values());
      if (l && l > 0) {
        const B = N.filter((P) => P.diff <= 4);
        if (B.length > 0)
          console.log(`[Lyrics] Calibration: Found ${B.length} strict duration matches.`), N = B;
        else {
          const P = N.filter((G) => G.diff <= 10);
          P.length > 0 ? (console.log(`[Lyrics] Calibration: Found ${P.length} lenient duration matches.`), N = P) : console.log(`[Lyrics] Calibration: No duration matches found. Closest is ${Math.min(...N.map((G) => G.diff))}s off.`);
        }
      }
      N.sort((B, P) => Math.abs(B.diff - P.diff) > 0.5 ? B.diff - P.diff : 0);
      const $ = N[0];
      return console.log(`[Lyrics] Selected: ${$.track} (${$.artist}) [${$.source}] Diff=${$.diff.toFixed(2)}s`), x($.lyrics);
    } catch (d) {
      return console.error("Error fetching lyrics:", d), null;
    }
  }), ne.handle("update:check", () => {
    ot.autoUpdater.checkForUpdates();
  }), ne.handle("update:install", () => {
    ot.autoUpdater.quitAndInstall(!0, !0);
  }), ne.handle("app:version", () => Je.getVersion());
});
export {
  hA as A,
  id as B,
