...
function _p(e) {
  xt.hasOwnProperty("O_SYMLINK") && process.version.match(/^v0\.6\.[0-2]|^v0\.5\./) && t(e), e.lutimes || r(e), e.chown = a(e.chown), e.fchown = a(e.fchown), e.lchown = a(e.lchown), e.chmod = n(e.chmod), e.fchmod = n(e.fchmod), e.lchmod = n(e.lchmod), e.chownSync = s(e.chownSync), e.fchownSync = s(e.fchownSync), e.lchownSync = s(e.lchownSync), e.chmodSync = i(e.chmodSync), e.fchmodSync = i(e.fchmodSync), e.lchmodSync = i(e.lchmodSync), e.stat = o(e.stat), e.fstat = o(e.fstat), e.lstat = o(e.lstat), e.statSync = l(e.statSync), e.fstatSync = l(e.fstatSync), e.lstatSync = l(e.lstatSync), e.chmod && !e.lchmod && (e.lchmod = function(c, f, p) {
    ...
    function f(p, g, w) {
      var x = Date.now(), _ = 0;
      c(p, g, function b(T) {
        if (T && (T.code === "EACCES" || T.code === "EPERM" || T.code === "EBUSY") && Date.now() - x < 6e4) {
          setTimeout(function() {
            e.stat(g, function(O, P) {
              O && O.code === "ENOENT" ? c(p, g, b) : w(T);
            });
          }, _), _ < 100 && (_ += 10);
          return;
        }
    ...
    function f(p, g, w, x, _, b) {
      var T;
      if (b && typeof b == "function") {
        var O = 0;
        T = function(P, Q, ae) {
          if (P && P.code === "EAGAIN" && O < 10)
            return O++, c.call(e, p, g, w, x, _, T);
          b.apply(this, arguments);
        };
      }
      return c.call(e, p, g, w, x, _, T);
    }
    return Object.setPrototypeOf && Object.setPrototypeOf(f, c), f;
  }(e.read), e.readSync = typeof e.readSync != "function" ? e.readSync : /* @__PURE__ */ function(c) {
    return function(f, p, g, w, x) {
      for (var _ = 0; ; )
        try {
          return c.call(e, f, p, g, w, x);
        } catch (b) {
          if (b.code === "EAGAIN" && _ < 10) {
            _++;
            continue;
          }
          throw b;
  ...
  function t(c) {
    c.lchmod = function(f, p, g) {
      ...
      var g = c.openSync(f, xt.O_WRONLY | xt.O_SYMLINK, p), w = !0, x;
      try {
  ...
  function r(c) {
    xt.hasOwnProperty("O_SYMLINK") && c.futimes ? (c.lutimes = function(f, p, g, w) {
      c.open(f, xt.O_SYMLINK, function(x, _) {
        if (x) {
          w && w(x);
          return;
        }
        c.futimes(_, p, g, function(b) {
      ...
      var w = c.openSync(f, xt.O_SYMLINK), x, _ = !0;
      try {
        x = c.futimesSync(w, p, g), _ = !1;
      } finally {
        if (_)
          try {
            c.closeSync(w);
      ...
      return x;
    }) : c.futimes && (c.lutimes = function(f, p, g, w) {
  ...
  function n(c) {
    return c && function(f, p, g) {
      return c.call(e, f, p, function(w) {
  ...
  function a(c) {
    return c && function(f, p, g, w) {
      return c.call(e, f, p, g, function(x) {
  ...
  function o(c) {
    return c && function(f, p, g) {
      ...
      return p ? c.call(e, f, p, w) : c.call(e, f, w);
    };
  }
  function l(c) {
    return c && function(f, p) {
...
var oe = Dt, Rp = Tp, Op = bp, Dp = Ap, kn = us, Te, oi;
typeof Symbol == "function" && typeof Symbol.for == "function" ? (Te = Symbol.for("graceful-fs.queue"), oi = Symbol.for("graceful-fs.previous")) : (Te = "___graceful-fs.queue", oi = "___graceful-fs.previous");
function Pp() {
}
function Ic(e, t) {
...
function fs(e) {
  Rp(e), e.gracefulify = fs, e.createReadStream = Q, e.createWriteStream = ae;
  var t = e.readFile;
  e.readFile = r;
  function r(y, q, j) {
    ...
    function B(Z, R, I, k) {
      return t(Z, R, function(A) {
        A && (A.code === "EMFILE" || A.code === "ENFILE") ? nr([B, [Z, R, I], A, k || Date.now(), Date.now()]) : typeof I == "function" && I.apply(this, arguments);
      });
    }
  }
  var n = e.writeFile;
  ...
  function i(y, q, j, B) {
    ...
    function Z(R, I, k, A, F) {
      return n(R, I, k, function(D) {
        D && (D.code === "EMFILE" || D.code === "ENFILE") ? nr([Z, [R, I, k, A], D, F || Date.now(), Date.now()]) : typeof A == "function" && A.apply(this, arguments);
      });
    }
  }
  var a = e.appendFile;
  ...
  function f(y, q, j) {
    ...
    var B = c.test(process.version) ? function(I, k, A, F) {
      return d(I, Z(
        I,
        k,
        A,
    ...
    function Z(R, I, k, A) {
      return function(F, D) {
        F && (F.code === "EMFILE" || F.code === "ENFILE") ? nr([
          ...
          A || Date.now(),
          Date.now()
        ]) : (D && D.sort && D.sort(), typeof k == "function" && k.call(this, F, D));
      };
    }
  }
  if (process.version.substr(0, 4) === "v0.8") {
    var p = Op(e);
    b = p.ReadStream, O = p.WriteStream;
  }
  var g = e.ReadStream;
  g && (b.prototype = Object.create(g.prototype), b.prototype.open = T);
  var w = e.WriteStream;
  w && (O.prototype = Object.create(w.prototype), O.prototype.open = P), Object.defineProperty(e, "ReadStream", {
    get: function() {
      return b;
    },
    set: function(y) {
  ...
  function T() {
    var y = this;
    be(y.path, y.flags, y.mode, function(q, j) {
...
const Fp = Ne.fromPromise, { makeDir: $p, makeDirSync: sa } = ps, oa = Fp($p);
var ot = {
  mkdirs: oa,
  mkdirsSync: sa,
  // alias
...
const Ue = Fe, Wr = le, Xp = ot.mkdirs, Wp = er.pathExists, Vp = kc.utimesMillis, Vr = br;
function Yp(e, t, r, n) {
...
function li(e, t, r, n, i) {
  (n.dereference ? Ue.stat : Ue.lstat)(t, (s, o) => s ? i(s) : o.isDirectory() ? nh(o, e, t, r, n, i) : o.isFile() || o.isCharacterDevice() || o.isBlockDevice() ? Jp(o, e, t, r, n, i) : o.isSymbolicLink() ? sh(e, t, r, n, i) : o.isSocket() ? i(new Error(`Cannot copy a socket file: ${t}`)) : o.isFIFO() ? i(new Error(`Cannot copy a FIFO pipe: ${t}`)) : i(new Error(`Unknown file: ${t}`)));
}
...
function Lc(e, t, r, n, i) {
  Ue.copyFile(t, r, (a) => a ? i(a) : n.preserveTimestamps ? Zp(e.mode, t, r, i) : Si(r, e.mode, i));
}
function Zp(e, t, r, n) {
...
function rh(e, t, r) {
  Ue.stat(e, (n, i) => n ? r(n) : Vp(t, i.atime, i.mtime, r));
}
...
function ah(e, t, r, n, i, a) {
  ...
  Vr.checkPaths(s, o, "copy", i, (l, d) => {
    if (l) return a(l);
    const { destStat: c } = d;
    Kp(c, s, o, i, (f) => f ? a(f) : Mc(e, r, n, i, a));
  });
}
function sh(e, t, r, n, i) {
  Ue.readlink(t, (a, s) => {
    ...
    if (n.dereference && (s = Wr.resolve(process.cwd(), s)), e)
      Ue.readlink(r, (o, l) => o ? o.code === "EINVAL" || o.code === "UNKNOWN" ? Ue.symlink(s, r, i) : i(o) : (n.dereference && (l = Wr.resolve(process.cwd(), l)), Vr.isSrcSubdir(s, l) ? i(new Error(`Cannot copy '${s}' to a subdirectory of itself, '${l}'.`)) : e.isDirectory() && Vr.isSrcSubdir(l, s) ? i(new Error(`Cannot overwrite '${l}' with '${s}'.`)) : oh(s, r, i)));
    else
...
var lh = Yp;
const Ie = Fe, Yr = le, ch = ot.mkdirsSync, uh = kc.utimesMillisSync, Kr = br;
function fh(e, t, r) {
...
function dh(e, t, r, n) {
  ...
  return Ie.existsSync(i) || ch(i), Bc(e, t, r, n);
}
function ph(e, t, r, n) {
...
function mh(e, t, r, n) {
  if (n.overwrite)
    return Ie.unlinkSync(r), jc(e, t, r, n);
  if (n.errorOnExist)
    throw new Error(`'${r}' already exists`);
}
function jc(e, t, r, n) {
  return Ie.copyFileSync(t, r), n.preserveTimestamps && gh(e.mode, t, r), ms(r, e.mode);
}
function gh(e, t, r) {
...
function vh(e, t, r, n) {
  return Ie.mkdirSync(r), zc(t, r, n), ms(r, e);
}
function zc(e, t, r) {
  Ie.readdirSync(e).forEach((n) => Th(n, e, t, r));
}
function Th(e, t, r, n) {
...
var Sh = fh;
const Ah = Ne.fromCallback;
var gs = {
  copy: Ah(lh),
  copySync: Sh
};
const wo = Fe, Gc = le, te = _c, Jr = process.platform === "win32";
function Hc(e) {
  [
    "unlink",
    "chmod",
...
var Rh = ys;
ys.sync = qc;
const ci = Fe, Oh = Ne.fromCallback, Xc = Rh;
function Dh(e, t) {
...
const kh = Ne.fromPromise, Wc = Zt, Vc = le, Yc = ot, Kc = Ai, _o = kh(async function(t) {
  let r;
  try {
...
const Fh = Ne.fromCallback, Jc = le, Tt = Fe, Qc = ot;
function $h(e, t) {
  function r() {
    Tt.writeFile(e, "", (n) => {
      if (n) return t(n);
...
const Mh = Ne.fromCallback, Zc = le, vt = Fe, eu = ot, Bh = er.pathExists, { areIdentical: tu } = br;
function jh(e, t, r) {
  function n(i, a) {
    vt.link(i, a, (s) => {
      if (s) return r(s);
...
const _t = le, Gr = Fe, Hh = er.pathExists;
function qh(e, t, r) {
  if (_t.isAbsolute(e))
...
const Jh = Ne.fromCallback, nu = le, Ye = Zt, iu = ot, Qh = iu.mkdirs, Zh = iu.mkdirsSync, au = Wh, em = au.symlinkPaths, tm = au.symlinkPathsSync, su = Kh, rm = su.symlinkType, nm = su.symlinkTypeSync, im = er.pathExists, { areIdentical: ou } = br;
function am(e, t, r, n) {
...
const Ii = Ne, { stringify: lu, stripBom: cu } = xs;
...
const wm = Ne.fromCallback, Hr = Fe, uu = le, fu = ot, Em = er.pathExists;
function vm(e, t, r, n) {
...
var Om = Rm;
const Dm = Ne.fromPromise, ke = xm;
ke.outputJson = Dm(Am);
ke.outputJsonSync = Om;
...
var Pm = ke;
const km = Fe, ja = le, Nm = gs.copy, du = Ai.remove, Fm = ot.mkdirp, $m = er.pathExists, Po = br;
function Lm(e, t, r, n) {
...
var Bm = Lm;
const pu = Fe, za = le, jm = gs.copySync, hu = Ai.removeSync, zm = ot.mkdirpSync, No = br;
function Gm(e, t, r) {
  r = r || {};
...
function mu() {
  ...
  $o = 1;
  function e(t) {
    n.debug = n, n.default = n, n.coerce = d, n.disable = o, n.enable = a, n.enabled = l, n.humanize = Zm(), n.destroy = c, Object.keys(t).forEach((f) => {
      n[f] = t[f];
    ...
    function n(f) {
      ...
      function _(...b) {
        if (!_.enabled)
          return;
        const T = _, O = Number(/* @__PURE__ */ new Date()), P = O - (p || O);
        T.diff = P, T.prev = p, T.curr = O, p = O, b[0] = n.coerce(b[0]), typeof b[0] != "string" && b.unshift("%O");
        let Q = 0;
        b[0] = b[0].replace(/%([a-zA-Z%])/g, (V, be) => {
          if (V === "%%")
            return "%";
          Q++;
          const y = n.formatters[be];
          if (typeof y == "function") {
            const q = b[Q];
            V = y.call(T, q), b.splice(Q, 1), Q--;
          }
          return V;
        }), n.formatArgs.call(T, b), (T.log || n.log).apply(T, b);
      }
      return _.namespace = f, _.useColors = n.useColors(), _.color = n.selectColor(f), _.extend = i, _.destroy = n.destroy, Object.defineProperty(_, "enabled", {
        enumerable: !0,
        configurable: !1,
        get: () => g !== null ? g : (w !== n.namespaces && (w = n.namespaces, x = n.enabled(f)), x),
        set: (b) => {
          g = b;
        }
...
function n0() {
  return Bo || (Bo = 1, function(e, t) {
    ...
    t.inspectOpts = Object.keys(process.env).filter((p) => /^debug_/i.test(p)).reduce((p, g) => {
      const w = g.substring(6).toLowerCase().replace(/_([a-z])/g, (_, b) => b.toUpperCase());
      let x = process.env[g];
    ...
    function a(p) {
      ...
      if (w) {
        const x = this.color, _ = "\x1B[3" + (x < 8 ? x : "8;5;" + x), b = `  ${_};1m${g} \x1B[0m`;
        p[0] = b + p[0].split(`
`).join(`
` + b), p.push(_ + "m+" + e.exports.humanize(this.diff) + "\x1B[0m");
      } else
        p[0] = s() + g + " " + p[0];
    }
    function s() {
...
Pe.safeGetHeader = xr;
Pe.configureRequestOptions = fi;
Pe.safeStringifyJson = di;
...
`));
    ...
    if (c && f != null) {
      ...
      this.doApiRequest(ui.prepareRedirectUrlOptions(f, r), n, o, s).then(i).catch(a);
      return;
    }
    t.setEncoding("utf8");
    let p = "";
    t.on("error", a), t.on("data", (g) => p += g), t.on("end", () => {
      try {
        if (t.statusCode != null && t.statusCode >= 400) {
          const g = xr(t, "content-type"), w = g != null && (Array.isArray(g) ? g.find((x) => x.includes("json")) != null : g.includes("json"));
          a(qa(t, `method: ${r.method || "GET"} url: ${r.protocol || "https:"}//${r.hostname}${r.port ? `:${r.port}` : ""}${r.path}
...
function b0(e, t, r, n, i = qr.ASCII) {
  ...
  switch (i) {
    ...
    case qr.OBJECT:
      ...
      break;
    default:
      l = Y[o[0]] + Y[o[1]] + Y[o[2]] + Y[o[3]] + "-" + Y[o[4]] + Y[o[5]] + "-" + Y[o[6] & 15 | r] + Y[o[7]] + "-" + Y[o[8] & 63 | 128] + Y[o[9]] + "-" + Y[o[10]] + Y[o[11]] + Y[o[12]] + Y[o[13]] + Y[o[14]] + Y[o[15]];
      break;
  }
  return l;
}
  ...
  (function(t) {
    ...
    function n(h, u) {
      if (!(this instanceof n))
        return new n(h, u);
      var S = this;
      a(S), S.q = S.c = "", S.bufferCheckPosition = t.MAX_BUFFER_LENGTH, S.opt = u || {}, S.opt.lowercase = S.opt.lowercase || S.opt.lowercasetags, S.looseCase = S.opt.lowercase ? "toLowerCase" : "toUpperCase", S.tags = [], S.closed = S.closedRoot = S.sawRoot = !1, S.tag = S.error = null, S.strict = !!h, S.noscript = !!(h || S.opt.noscript), S.state = y.BEGIN, S.strictEntities = S.opt.strictEntities, S.ENTITIES = S.strictEntities ? Object.create(t.XML_ENTITIES) : Object.create(t.ENTITIES), S.attribList = [], S.opt.xmlns && (S.ns = Object.create(x)), S.opt.unquotedAttributeValues === void 0 && (S.opt.unquotedAttributeValues = !h), S.trackPosition = S.opt.position !== !1, S.trackPosition && (S.position = S.line = S.column = 0), j(S, "onready");
    }
    ...
    function i(h) {
      for (var u = Math.max(t.MAX_BUFFER_LENGTH, 10), S = 0, v = 0, K = r.length; v < K; v++) {
        var ne = h[r[v]].length;
        if (ne > u)
          switch (r[v]) {
            case "textNode":
    ...
    c.prototype = Object.create(o.prototype, {
      ...
      }), o.prototype.on.call(S, h, u);
    };
    var f = "[CDATA[", p = "DOCTYPE", g = "http://www.w3.org/XML/1998/namespace", w = "http://www.w3.org/2000/xmlns/", x = { xml: g, xmlns: w }, _ = /[:_A-Za-z\u00C0-\u00D6\u00D8-\u00F6\u00F8-\u02FF\u0370-\u037D\u037F-\u1FFF\u200C-\u200D\u2070-\u218F\u2C00-\u2FEF\u3001-\uD7FF\uF900-\uFDCF\uFDF0-\uFFFD]/, b = /[:_A-Za-z\u00C0-\u00D6\u00D8-\u00F6\u00F8-\u02FF\u0370-\u037D\u037F-\u1FFF\u200C-\u200D\u2070-\u218F\u2C00-\u2FEF\u3001-\uD7FF\uF900-\uFDCF\uFDF0-\uFFFD\u00B7\u0300-\u036F\u203F-\u2040.\d-]/, T = /[#:_A-Za-z\u00C0-\u00D6\u00D8-\u00F6\u00F8-\u02FF\u0370-\u037D\u037F-\u1FFF\u200C-\u200D\u2070-\u218F\u2C00-\u2FEF\u3001-\uD7FF\uF900-\uFDCF\uFDF0-\uFFFD]/, O = /[#:_A-Za-z\u00C0-\u00D6\u00D8-\u00F6\u00F8-\u02FF\u0370-\u037D\u037F-\u1FFF\u200C-\u200D\u2070-\u218F\u2C00-\u2FEF\u3001-\uD7FF\uF900-\uFDCF\uFDF0-\uFFFD\u00B7\u0300-\u036F\u203F-\u2040.\d-]/;
    function P(h) {
      return h === " " || h === `
` || h === "\r" || h === "	";
    }
...
Char: ` + h.c), u = new Error(u), h.error = u, j(h, "onerror", u), h;
    ...
    function F(h) {
      ...
      h.opt.xmlns && (S.ns = u.ns), h.attribList.length = 0, B(h, "onopentagstart", S);
    }
    function D(h, u) {
      var S = h.indexOf(":"), v = S < 0 ? ["", h] : h.split(":"), K = v[0], ne = v[1];
      return u && h === "xmlns" && (K = "xmlns", ne = ""), { prefix: K, local: ne };
    }
    function M(h) {
      ...
      if (h.opt.xmlns) {
        var u = D(h.attribName, !0), S = u.prefix, v = u.local;
        if (S === "xmlns")
...
Actual: ` + h.attribValue
            ...
            var K = h.tag, ne = h.tags[h.tags.length - 1] || h;
            K.ns === ne.ns && (K.ns = Object.create(ne.ns)), K.ns[v] = h.attribValue;
          }
    ...
    function X(h, u) {
      if (h.opt.xmlns) {
        ...
        for (var ne = 0, ce = h.attribList.length; ne < ce; ne++) {
          var we = h.attribList[ne], Se = we[0], ht = we[1], de = D(Se, !0), We = de.prefix, Ki = de.local, _n = We === "" ? "" : S.ns[We] || "", Rr = {
            name: Se,
            value: ht,
            prefix: We,
            local: Ki,
          ...
          ), Rr.uri = We), h.tag.attributes[Se] = Rr, B(h, "onattribute", Rr);
        }
        h.attribList.length = 0;
      }
      h.tag.isSelfClosing = !!u, h.sawRoot = !0, h.tags.push(h.tag), B(h, "onopentag", h.tag), u || (!h.noscript && h.tagName.toLowerCase() === "script" ? h.state = y.SCRIPT : h.state = y.TEXT, h.tag = null, h.tagName = ""), h.attribName = h.attribValue = "", h.attribList.length = 0;
    }
    function z(h) {
      if (!h.tagName) {
    ...
    function ee(h) {
      var u = h.entity, S = u.toLowerCase(), v, K = "";
      return h.ENTITIES[u] ? h.ENTITIES[u] : h.ENTITIES[S] ? h.ENTITIES[S] : (u = S, u.charAt(0) === "#" && (u.charAt(1) === "x" ? (u = u.slice(2), v = parseInt(u, 16), K = v.toString(16)) : (u = u.slice(1), v = parseInt(u, 10), K = v.toString(10))), u = u.replace(/^0+/, ""), isNaN(v) || K.toLowerCase() !== u || v < 0 || v > 1114111 ? (A(h, "Invalid character entity"), "&" + h.entity + ";") : String.fromCodePoint(v));
    }
    function he(h, u) {
      u === "<" ? (h.state = y.OPEN_WAKA, h.startTagPosition = h.position) : P(u) || (A(h, "Non-whitespace before first tag."), h.textNode = u, h.state = y.TEXT);
    }
    function U(h, u) {
      var S = "";
...
` ? (u.line++, u.column = 0) : u.column++), u.state) {
          ...
          case y.TEXT:
            if (u.sawRoot && !u.closedRoot) {
              for (var ne = S - 1; v && v !== "<" && v !== "&"; )
                v = U(h, S++), v && u.trackPosition && (u.position++, v === `
` ? (u.line++, u.column = 0) : u.column++);
              u.textNode += h.substring(ne, S - 1);
            }
            v === "<" && !(u.sawRoot && u.closedRoot && !u.strict) ? (u.state = y.OPEN_WAKA, u.startTagPosition = u.position) : (!P(v) && (!u.sawRoot || u.closedRoot) && A(u, "Text data outside of root node."), v === "&" ? u.state = y.TEXT_ENTITY : u.textNode += v);
            continue;
          case y.SCRIPT:
          ...
          case y.SGML_DECL:
            ...
            u.doctype && u.doctype !== !0 && u.sgmlDecl ? (u.state = y.DOCTYPE_DTD, u.doctype += "<!" + u.sgmlDecl + v, u.sgmlDecl = "") : (u.sgmlDecl + v).toUpperCase() === f ? (B(u, "onopencdata"), u.state = y.CDATA, u.sgmlDecl = "", u.cdata = "") : (u.sgmlDecl + v).toUpperCase() === p ? (u.state = y.DOCTYPE, (u.doctype || u.sawRoot) && A(
              u,
              "Inappropriately located doctype declaration"
            ), u.doctype = "", u.sgmlDecl = "") : v === ">" ? (B(u, "onsgmldeclaration", u.sgmlDecl), u.sgmlDecl = "", u.state = y.TEXT) : (Q(v) && (u.state = y.SGML_DECL_QUOTED), u.sgmlDecl += v);
            continue;
          case y.SGML_DECL_QUOTED:
            v === u.q && (u.state = y.SGML_DECL, u.q = ""), u.sgmlDecl += v;
            continue;
          case y.DOCTYPE:
            v === ">" ? (u.state = y.TEXT, B(u, "ondoctype", u.doctype), u.doctype = !0) : (u.doctype += v, v === "[" ? u.state = y.DOCTYPE_DTD : Q(v) && (u.state = y.DOCTYPE_QUOTED, u.q = v));
            continue;
          case y.DOCTYPE_QUOTED:
            u.doctype += v, v === u.q && (u.q = "", u.state = y.DOCTYPE);
            continue;
          case y.DOCTYPE_DTD:
            v === "]" ? (u.doctype += v, u.state = y.DOCTYPE) : v === "<" ? (u.state = y.OPEN_WAKA, u.startTagPosition = u.position) : Q(v) ? (u.doctype += v, u.state = y.DOCTYPE_DTD_QUOTED, u.q = v) : u.doctype += v;
            continue;
          ...
          case y.COMMENT_ENDING:
            v === "-" ? (u.state = y.COMMENT_ENDED, u.comment = R(u.opt, u.comment), u.comment && B(u, "oncomment", u.comment), u.comment = "") : (u.comment += "-" + v, u.state = y.COMMENT);
            continue;
          case y.COMMENT_ENDED:
            v !== ">" ? (A(u, "Malformed comment"), u.comment += "--" + v, u.state = y.COMMENT) : u.doctype && u.doctype !== !0 ? u.state = y.DOCTYPE_DTD : u.state = y.TEXT;
            continue;
          case y.CDATA:
            for (var ne = S - 1; v && v !== "]"; )
              v = U(h, S++), v && u.trackPosition && (u.position++, v === `
` ? (u.line++, u.column = 0) : u.column++);
            u.cdata += h.substring(ne, S - 1), v === "]" && (u.state = y.CDATA_ENDING);
            continue;
          case y.CDATA_ENDING:
            v === "]" ? u.state = y.CDATA_ENDING_2 : (u.cdata += "]" + v, u.state = y.CDATA);
            continue;
          case y.CDATA_ENDING_2:
            v === ">" ? (u.cdata && B(u, "oncdata", u.cdata), B(u, "onclosecdata"), u.cdata = "", u.state = y.TEXT) : v === "]" ? u.cdata += "]" : (u.cdata += "]]" + v, u.state = y.CDATA);
            continue;
          case y.PROC_INST:
            v === "?" ? u.state = y.PROC_INST_ENDING : P(v) ? u.state = y.PROC_INST_BODY : u.procInstName += v;
            continue;
          case y.PROC_INST_BODY:
            if (!u.procInstBody && P(v))
              continue;
          ...
          case y.PROC_INST_ENDING:
            ...
            continue;
          case y.OPEN_TAG:
            V(b, v) ? u.tagName += v : (F(u), v === ">" ? X(u) : v === "/" ? u.state = y.OPEN_TAG_SLASH : (P(v) || A(u, "Invalid character in tag name"), u.state = y.ATTRIB));
            continue;
          ...
          case y.ATTRIB:
            if (P(v))
              continue;
            v === ">" ? X(u) : v === "/" ? u.state = y.OPEN_TAG_SLASH : V(_, v) ? (u.attribName = v, u.attribValue = "", u.state = y.ATTRIB_NAME) : A(u, "Invalid attribute name");
            continue;
          case y.ATTRIB_NAME:
            v === "=" ? u.state = y.ATTRIB_VALUE : v === ">" ? (A(u, "Attribute without value"), u.attribValue = u.attribName, M(u), X(u)) : P(v) ? u.state = y.ATTRIB_NAME_SAW_WHITE : V(b, v) ? u.attribName += v : A(u, "Invalid attribute name");
            continue;
          case y.ATTRIB_NAME_SAW_WHITE:
            if (v === "=")
              ...
              A(u, "Attribute without value"), u.tag.attributes[u.attribName] = "", u.attribValue = "", B(u, "onattribute", {
                name: u.attribName,
                value: ""
              }), u.attribName = "", v === ">" ? X(u) : V(_, v) ? (u.attribName = v, u.state = y.ATTRIB_NAME) : (A(u, "Invalid attribute name"), u.state = y.ATTRIB);
            }
            continue;
          case y.ATTRIB_VALUE:
            if (P(v))
              continue;
            Q(v) ? (u.q = v, u.state = y.ATTRIB_VALUE_QUOTED) : (u.opt.unquotedAttributeValues || I(u, "Unquoted attribute value"), u.state = y.ATTRIB_VALUE_UNQUOTED, u.attribValue = v);
            continue;
          ...
          case y.ATTRIB_VALUE_CLOSED:
            P(v) ? u.state = y.ATTRIB : v === ">" ? X(u) : v === "/" ? u.state = y.OPEN_TAG_SLASH : V(_, v) ? (A(u, "No whitespace between attributes"), u.attribName = v, u.attribValue = "", u.state = y.ATTRIB_NAME) : A(u, "Invalid attribute name");
            continue;
          case y.ATTRIB_VALUE_UNQUOTED:
            ...
            M(u), v === ">" ? X(u) : u.state = y.ATTRIB;
            continue;
          case y.CLOSE_TAG:
            if (u.tagName)
              v === ">" ? z(u) : V(b, v) ? u.tagName += v : u.script ? (u.script += "</" + u.tagName, u.tagName = "", u.state = y.SCRIPT) : (P(v) || A(u, "Invalid tagname in closing tag"), u.state = y.CLOSE_TAG_SAW_WHITE);
            else {
              if (P(v))
                continue;
              be(_, v) ? u.script ? (u.script += "</" + v, u.state = y.SCRIPT) : A(u, "Invalid tagname in closing tag.") : u.tagName = v;
            }
            continue;
          case y.CLOSE_TAG_SAW_WHITE:
            if (P(v))
              continue;
            v === ">" ? z(u) : A(u, "Invalid characters in closing tag");
            continue;
          case y.TEXT_ENTITY:
          ...
          case y.ATTRIB_VALUE_ENTITY_U:
            ...
            if (v === ";") {
              var Se = ee(u);
              u.opt.unparsedEntities && !Object.values(t.XML_ENTITIES).includes(Se) ? (u.entity = "", u.state = ce, u.write(Se)) : (u[we] += Se, u.entity = "", u.state = ce);
            } else V(u.entity.length ? O : T, v) ? u.entity += v : (A(u, "Invalid character in entity name"), u[we] += "&" + u.entity + v, u.entity = "", u.state = ce);
            continue;
          default:
    ...
    String.fromCodePoint || function() {
      var h = String.fromCharCode, u = Math.floor, S = function() {
        var v = 16384, K = [], ne, ce, we = -1, Se = arguments.length;
        if (!Se)
          return "";
        for (var ht = ""; ++we < Se; ) {
          ...
          de <= 65535 ? K.push(de) : (de -= 65536, ne = (de >> 10) + 55296, ce = de % 1024 + 56320, K.push(ne, ce)), (we + 1 === Se || K.length > v) && (ht += h.apply(null, K), K.length = 0);
        }
        return ht;
      };
...
` + o;
  for (d = ha(e.buffer, n[s], i[s], e.position, f), o += Br.repeat(" ", t.indent) + ma((e.line + 1).toString(), c) + " | " + d.str + `
...
var Cu = Wa, z0 = $e, Ru = new z0("tag:yaml.org,2002:str", {
  kind: "scalar",
  construct: function(e) {
    return e !== null ? e : "";
  }
}), G0 = $e, Ou = new G0("tag:yaml.org,2002:seq", {
  kind: "sequence",
  construct: function(e) {
    return e !== null ? e : [];
  }
}), H0 = $e, Du = new H0("tag:yaml.org,2002:map", {
  kind: "mapping",
  construct: function(e) {
    return e !== null ? e : {};
  }
...
var Gu = new wg("tag:yaml.org,2002:merge", {
  kind: "scalar",
  resolve: Eg
}), vg = $e, Ss = `ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789+/=
\r`;
function Tg(e) {
  if (e === null) return !1;
...
var Hu = new vg("tag:yaml.org,2002:binary", {
  ...
  predicate: Sg,
  represent: bg
}), Ag = $e, Ig = Object.prototype.hasOwnProperty, Cg = Object.prototype.toString;
function Rg(e) {
  if (e === null) return !0;
  var t = [], r, n, i, a, s, o = e;
...
var qu = new Ag("tag:yaml.org,2002:omap", {
  ...
  resolve: Rg,
  construct: Og
}), Dg = $e, Pg = Object.prototype.toString;
function kg(e) {
  if (e === null) return !0;
  var t, r, n, i, a, s = e;
...
var Xu = new Dg("tag:yaml.org,2002:pairs", {
  ...
  resolve: kg,
  construct: Ng
}), Fg = $e, $g = Object.prototype.hasOwnProperty;
function Lg(e) {
  if (e === null) return !0;
  var t, r = e;
  for (t in r)
...
function Kg(e, t, r) {
  var n, i, a, s, o, l, d, c, f = e.kind, p = e.result, g;
  ...
  for (e.kind = "scalar", e.result = "", a = s = e.position, o = !1; g !== 0; ) {
    if (g === 58) {
      ...
      if (e.position === e.lineStart && Oi(e) || r && fr(g))
        break;
      if (at(g))
...
function Zg(e, t) {
  var r = !0, n, i, a, s = e.tag, o, l = e.anchor, d, c, f, p, g, w = /* @__PURE__ */ Object.create(null), x, _, b, T;
  if (T = e.input.charCodeAt(e.position), T === 91)
    ...
    return !1;
  for (e.anchor !== null && (e.anchorMap[e.anchor] = o), T = e.input.charCodeAt(++e.position); T !== 0; ) {
    if (fe(e, !0, t), T = e.input.charCodeAt(e.position), T === c)
      return e.position++, e.tag = s, e.anchor = l, e.kind = g ? "mapping" : "sequence", e.result = o, !0;
    r ? T === 44 && L(e, "expected the node content, but found ','") : L(e, "missed comma between flow collection entries"), _ = x = b = null, f = p = !1, T === 63 && (d = e.input.charCodeAt(e.position + 1), Me(d) && (f = p = !0, e.position++, fe(e, !0, t))), n = e.line, i = e.lineStart, a = e.position, Tr(e, t, pi, !1, !0), _ = e.tag, x = e.result, fe(e, !0, t), T = e.input.charCodeAt(e.position), (p || e.line === n) && T === 58 && (f = !0, T = e.input.charCodeAt(++e.position), fe(e, !0, t), Tr(e, t, pi, !1, !0), b = e.result), g ? dr(e, o, w, _, x, b, n, i, a) : f ? o.push(dr(e, null, w, _, x, b, n, i, a)) : o.push(x), fe(e, !0, t), T = e.input.charCodeAt(e.position), T === 44 ? (r = !0, T = e.input.charCodeAt(++e.position)) : r = !1;
  }
...
function ey(e, t) {
  ...
  for (e.kind = "scalar", e.result = ""; f !== 0; )
    if (f = e.input.charCodeAt(++e.position), f === 43 || f === 45)
      ya === i ? i = f === 43 ? Wo : jg : L(e, "repeat of a chomping mode identifier");
    else if ((c = Wg(f)) >= 0)
...
function ty(e, t, r) {
  var n, i, a, s, o, l, d = e.tag, c = e.anchor, f = {}, p = /* @__PURE__ */ Object.create(null), g = null, w = null, x = null, _ = !1, b = !1, T;
  if (e.firstTabInLine !== -1) return !1;
  for (e.anchor !== null && (e.anchorMap[e.anchor] = f), T = e.input.charCodeAt(e.position); T !== 0; ) {
    if (!_ && e.firstTabInLine !== -1 && (e.position = e.firstTabInLine, L(e, "tab characters must not be used in indentation")), n = e.input.charCodeAt(e.position + 1), a = e.line, (T === 63 || T === 58) && Me(n))
      T === 63 ? (_ && (dr(e, f, p, g, w, null, s, o, l), g = w = x = null), b = !0, _ = !0, i = !0) : _ ? (_ = !1, i = !0) : L(e, "incomplete explicit mapping pair; a key node is missed; or followed by a non-tabulated empty line"), e.position += 1, T = n;
    else {
      if (s = e.line, o = e.lineStart, l = e.position, !Tr(e, r, Yu, !1, !0))
        break;
      if (e.line === a) {
        for (T = e.input.charCodeAt(e.position); Vt(T); )
          T = e.input.charCodeAt(++e.position);
        if (T === 58)
          T = e.input.charCodeAt(++e.position), Me(T) || L(e, "a whitespace character is expected after the key-value separator within a block mapping"), _ && (dr(e, f, p, g, w, null, s, o, l), g = w = x = null), b = !0, _ = !1, i = !1, g = e.tag, w = e.result;
        else if (b)
    ...
    if ((e.line === a || e.lineIndent > t) && (_ && (s = e.line, o = e.lineStart, l = e.position), Tr(e, t, hi, !0, i) && (_ ? w = e.result : x = e.result), _ || (dr(e, f, p, g, w, x, s, o, l), g = w = x = null), fe(e, !0, -1), T = e.input.charCodeAt(e.position)), (e.line === a || e.lineIndent > t) && T !== 0)
      L(e, "bad indentation of a mapping entry");
    else if (e.lineIndent < t)
      break;
  }
  return _ && dr(e, f, p, g, w, null, s, o, l), b && (e.tag = d, e.anchor = c, e.kind = "mapping", e.result = f), b;
}
function ry(e) {
  var t, r = !1, n = !1, i, a, s;
...
function Tr(e, t, r, n, i) {
  var a, s, o, l = 1, d = !1, c = !1, f, p, g, w, x, _;
  ...
  if (o && (o = d || i), (l === 1 || hi === r) && (pi === r || Yu === r ? x = t : x = t + 1, _ = e.position - e.lineStart, l === 1 ? o && (Qo(e, _) || ty(e, _, x)) || Zg(e, x) ? c = !0 : (s && ey(e, x) || Jg(e, x) || Qg(e, x) ? c = !0 : iy(e) ? (c = !0, (e.tag !== null || e.anchor !== null) && L(e, "alias node should not have any properties")) : Kg(e, x, pi === r) && (c = !0, e.tag === null && (e.tag = "?")), e.anchor !== null && (e.anchorMap[e.anchor] = e.result)) : l === 0 && (c = o && Qo(e, _))), e.tag === null)
    ...
    if (Ct.call(e.typeMap[e.kind || "fallback"], e.tag))
      ...
      for (w = null, g = e.typeMap.multi[e.kind || "fallback"], f = 0, p = g.length; f < p; f += 1)
...
bs.loadAll = sy;
bs.load = oy;
var af = {}, Di = Je, mn = hn, ly = As, sf = Object.prototype.toString, of = Object.prototype.hasOwnProperty, Rs = 65279, cy = 9, Zr = 10, uy = 13, fy = 32, dy = 33, py = 34, Va = 35, hy = 37, my = 38, gy = 39, yy = 42, lf = 44, xy = 45, gi = 58, wy = 61, Ey = 62, vy = 63, Ty = 64, cf = 91, uf = 93, _y = 96, ff = 123, by = 124, df = 125, Re = {};
Re[0] = "\\0";
Re[7] = "\\a";
Re[8] = "\\b";
Re[9] = "\\t";
...
function Ny(e, t, r, n, i, a, s, o) {
  var l, d = 0, c = null, f = !1, p = !1, g = n !== -1, w = -1, x = Py(jr(e, 0)) && ky(jr(e, e.length - 1));
  if (t || s)
  ...
  return !f && !p ? x && !s && !i(e) ? hf : a === en ? ur : Ka : r > 9 && pf(e) ? ur : s ? a === en ? ur : Ka : p ? gf : mf;
}
...
function Ly(e) {
  for (var t = "", r = 0, n, i = 0; i < e.length; r >= 65536 ? i += 2 : i++)
    r = jr(e, i), n = Re[r], !n && tn(r) ? (t += e[i], r >= 65536 && (t += e[i + 1])) : t += n || Cy(r);
  return t;
}
function Uy(e, t, r) {
  var n = "", i = e.tag, a, s, o;
...
function By(e, t, r, n) {
  ...
  for (o = 0, l = s.length; o < l; o += 1)
    p = "", (!n || i !== "") && (p += Ya(e, t)), d = s[o], c = r[d], e.replacer && (c = e.replacer.call(r, d, c)), dt(e, t + 1, d, !0, !0, !0) && (f = e.tag !== null && e.tag !== "?" || e.dump && e.dump.length > 1024, f && (e.dump && Zr === e.dump.charCodeAt(0) ? p += "?" : p += "? "), p += e.dump, f && (p += Ya(e, t)), dt(e, t + 1, c, !0, f) && (e.dump && Zr === e.dump.charCodeAt(0) ? p += ":" : p += ": ", p += e.dump, i += p));
  e.tag = a, e.dump = i || "{}";
}
function sl(e, t, r) {
  var n, i, a, s, o, l;
...
function dt(e, t, r, n, i, a, s) {
  ...
  if (c && (f = e.duplicates.indexOf(r), p = f !== -1), (e.tag !== null && e.tag !== "?" || p || e.indent !== 2 && t > 0) && (i = !1), p && e.usedDuplicates[f])
    ...
    if (c && p && !e.usedDuplicates[f] && (e.usedDuplicates[f] = !0), o === "[object Object]")
      n && Object.keys(e.dump).length !== 0 ? (By(e, t, e.dump, i), p && (e.dump = "&ref_" + f + e.dump)) : (My(e, t, e.dump), p && (e.dump = "&ref_" + f + " " + e.dump));
    else if (o === "[object Array]")
      n && e.dump.length !== 0 ? (e.noArrayIndent && !s && t > 0 ? al(e, t - 1, e.dump, i) : al(e, t, e.dump, i), p && (e.dump = "&ref_" + f + e.dump)) : (Uy(e, t, e.dump), p && (e.dump = "&ref_" + f + " " + e.dump));
...
(function(e, t) {
  ...
  const p = "[a-zA-Z0-9-]", g = [
    ...
    for (const [b, T] of g)
      _ = _.split(`${b}*`).join(`${b}{0,${T}}`).split(`${b}+`).join(`${b}{1,${T}}`);
    return _;
  }, x = (_, b, T) => {
    const O = w(b), P = f++;
    a(_, P, b), c[_] = P, l[P] = b, d[P] = O, s[P] = new RegExp(b, T ? "g" : void 0), o[P] = new RegExp(O, T ? "g" : void 0);
  };
...
var px = dx;
const hx = Le, mx = (e, t) => new hx(e, t).major;
var gx = mx;
const yx = Le, xx = (e, t) => new yx(e, t).minor;
var wx = xx;
const Ex = Le, vx = (e, t) => new Ex(e, t).patch;
var Tx = vx;
const _x = Ir, bx = (e, t) => {
  const r = _x(e, t);
...
var Sx = bx;
const dl = Le, Ax = (e, t, r) => new dl(e, r).compare(new dl(t, r));
var Qe = Ax;
const Ix = Qe, Cx = (e, t, r) => Ix(t, e, r);
var Rx = Cx;
const Ox = Qe, Dx = (e, t) => Ox(e, t, !0);
var Px = Dx;
const pl = Le, kx = (e, t, r) => {
...
var _f = iw;
const aw = Le, sw = Ir, { safeRe: Gn, t: Hn } = gn, ow = (e, t) => {
  if (e instanceof aw)
    return e;
...
function Ze() {
  ...
  class t {
    ...
    parseRange(I) {
      ...
      if (F)
        return F;
      const D = this.options.loose, M = D ? l[d.HYPHENRANGELOOSE] : l[d.HYPHENRANGE];
      I = I.replace(M, B(this.options.includePrerelease)), s("hyphen replace", I), I = I.replace(l[d.COMPARATORTRIM], c), s("comparator trim", I), I = I.replace(l[d.TILDETRIM], f), s("tilde trim", I), I = I.replace(l[d.CARETTRIM], p), s("caret trim", I);
      let X = I.split(" ").map((U) => T(U, this.options)).join(" ").split(/\s+/).map((U) => j(U, this.options));
      D && (X = X.filter((U) => (s("loose invalid filter", U, this.options), !!U.match(l[d.COMPARATORLOOSE])))), s("range list", X);
    ...
    intersects(I, k) {
      ...
      return this.set.some((A) => b(A, k) && I.set.some((F) => b(F, k) && A.every((D) => F.every((M) => D.intersects(M, k)))));
    }
    ...
    test(I) {
      ...
      for (let k = 0; k < this.set.length; k++)
        if (Z(this.set[k], I, this.options))
          return !0;
      return !1;
    }
  }
  wa = t;
  const r = uw, n = new r(), i = Ds, a = $i(), s = Ni, o = Le, {
    safeRe: l,
    t: d,
    comparatorTrimReplace: c,
    tildeTrimReplace: f,
    caretTrimReplace: p
  } = gn, { FLAG_INCLUDE_PRERELEASE: g, FLAG_LOOSE: w } = ki, x = (R) => R.value === "<0.0.0-0", _ = (R) => R.value === "", b = (R, I) => {
    let k = !0;
    const A = R.slice();
    let F = A.pop();
    for (; k && A.length; )
      k = A.every((D) => F.intersects(D, I)), F = A.pop();
    return k;
  }, T = (R, I) => (R = R.replace(l[d.BUILD], ""), s("comp", R, I), R = ae(R, I), s("caret", R), R = P(R, I), s("tildes", R), R = be(R, I), s("xrange", R), R = q(R, I), s("stars", R), R), O = (R) => !R || R.toLowerCase() === "x" || R === "*", P = (R, I) => R.trim().split(/\s+/).map((k) => Q(k, I)).join(" "), Q = (R, I) => {
    const k = I.loose ? l[d.TILDELOOSE] : l[d.TILDE];
    return R.replace(k, (A, F, D, M, X) => {
      s("tilde", R, A, F, D, M, X);
      let z;
      return O(F) ? z = "" : O(D) ? z = `>=${F}.0.0 <${+F + 1}.0.0-0` : O(M) ? z = `>=${F}.${D}.0 <${F}.${+D + 1}.0-0` : X ? (s("replaceTilde pr", X), z = `>=${F}.${D}.${M}-${X} <${F}.${+D + 1}.0-0`) : z = `>=${F}.${D}.${M} <${F}.${+D + 1}.0-0`, s("tilde return", z), z;
    });
  }, ae = (R, I) => R.trim().split(/\s+/).map((k) => V(k, I)).join(" "), V = (R, I) => {
    s("caret", R, I);
    const k = I.loose ? l[d.CARETLOOSE] : l[d.CARET], A = I.includePrerelease ? "-0" : "";
    return R.replace(k, (F, D, M, X, z) => {
      s("caret", R, F, D, M, X, z);
      let ee;
      return O(D) ? ee = "" : O(M) ? ee = `>=${D}.0.0${A} <${+D + 1}.0.0-0` : O(X) ? D === "0" ? ee = `>=${D}.${M}.0${A} <${D}.${+M + 1}.0-0` : ee = `>=${D}.${M}.0${A} <${+D + 1}.0.0-0` : z ? (s("replaceCaret pr", z), D === "0" ? M === "0" ? ee = `>=${D}.${M}.${X}-${z} <${D}.${M}.${+X + 1}-0` : ee = `>=${D}.${M}.${X}-${z} <${D}.${+M + 1}.0-0` : ee = `>=${D}.${M}.${X}-${z} <${+D + 1}.0.0-0`) : (s("no pr"), D === "0" ? M === "0" ? ee = `>=${D}.${M}.${X}${A} <${D}.${M}.${+X + 1}-0` : ee = `>=${D}.${M}.${X}${A} <${D}.${+M + 1}.0-0` : ee = `>=${D}.${M}.${X} <${+D + 1}.0.0-0`), s("caret return", ee), ee;
    });
  }, be = (R, I) => (s("replaceXRanges", R, I), R.split(/\s+/).map((k) => y(k, I)).join(" ")), y = (R, I) => {
    R = R.trim();
    const k = I.loose ? l[d.XRANGELOOSE] : l[d.XRANGE];
    return R.replace(k, (A, F, D, M, X, z) => {
      s("xRange", R, A, F, D, M, X, z);
      const ee = O(D), he = ee || O(M), U = he || O(X), et = U;
      return F === "=" && et && (F = ""), z = I.includePrerelease ? "-0" : "", ee ? F === ">" || F === "<" ? A = "<0.0.0-0" : A = "*" : F && et ? (he && (M = 0), X = 0, F === ">" ? (F = ">=", he ? (D = +D + 1, M = 0, X = 0) : (M = +M + 1, X = 0)) : F === "<=" && (F = "<", he ? D = +D + 1 : M = +M + 1), F === "<" && (z = "-0"), A = `${F + D}.${M}.${X}${z}`) : he ? A = `>=${D}.0.0${z} <${+D + 1}.0.0-0` : U && (A = `>=${D}.${M}.0${z} <${D}.${+M + 1}.0-0`), s("xRange return", A), A;
    });
  }, q = (R, I) => (s("replaceStars", R, I), R.trim().replace(l[d.STAR], "")), j = (R, I) => (s("replaceGTE0", R, I), R.trim().replace(l[I.includePrerelease ? d.GTE0PRE : d.GTE0], "")), B = (R) => (I, k, A, F, D, M, X, z, ee, he, U, et) => (O(A) ? k = "" : O(F) ? k = `>=${A}.0.0${R ? "-0" : ""}` : O(D) ? k = `>=${A}.${F}.0${R ? "-0" : ""}` : M ? k = `>=${k}` : k = `>=${k}${R ? "-0" : ""}`, O(ee) ? z = "" : O(he) ? z = `<${+ee + 1}.0.0-0` : O(U) ? z = `<${ee}.${+he + 1}.0-0` : et ? z = `<=${ee}.${he}.${U}-${et}` : R ? z = `<${ee}.${he}.${+U + 1}-0` : z = `<=${z}`, `${k} ${z}`.trim()), Z = (R, I, k) => {
...
function $i() {
  ...
  Ea = t;
  const r = Ds, { safeRe: n, t: i } = gn, a = _f, s = Ni, o = Le, l = Ze();
  return Ea;
}
...
var _w = Tw;
const va = Le, bw = Ze(), gl = Fi, Sw = (e, t) => {
  e = new bw(e, t);
  let r = new va("0.0.0");
...
var Rw = Cw;
const Ow = Le, bf = $i(), { ANY: Dw } = bf, Pw = Ze(), kw = Li, yl = Fi, xl = ks, Nw = Fs, Fw = Ns, $w = (e, t, r, n) => {
  ...
  for (let d = 0; d < t.set.length; ++d) {
    ...
    let f = null, p = null;
    if (c.forEach((g) => {
      g.semver === Dw && (g = new bf(">=0.0.0")), f = f || g, p = p || g, i(g.semver, f.semver, n) ? f = g : s(g.semver, p.semver, n) && (p = g);
...
var Jw = Vw;
const _a = gn, bl = ki, Qw = Le, Sl = Ef, Zw = Ir, eE = sx, tE = cx, rE = fx, nE = px, iE = gx, aE = wx, sE = Tx, oE = Sx, lE = Qe, cE = Rx, uE = Px, fE = Ps, dE = $x, pE = Mx, hE = Fi, mE = ks, gE = vf, yE = Tf, xE = Ns, wE = Fs, EE = _f, vE = lw, TE = $i(), _E = Ze(), bE = Li, SE = mw, AE = ww, IE = _w, CE = Aw, RE = Rw, OE = $s, DE = Mw, PE = zw, kE = Hw, NE = Ww, FE = Jw;
var Sf = {
  parse: Zw,
  valid: eE,
  clean: tE,
...
xi.exports;
(function(e, t) {
  var r = 200, n = "__lodash_hash_undefined__", i = 1, a = 2, s = 9007199254740991, o = "[object Arguments]", l = "[object Array]", d = "[object AsyncFunction]", c = "[object Boolean]", f = "[object Date]", p = "[object Error]", g = "[object Function]", w = "[object GeneratorFunction]", x = "[object Map]", _ = "[object Number]", b = "[object Null]", T = "[object Object]", O = "[object Promise]", P = "[object Proxy]", Q = "[object RegExp]", ae = "[object Set]", V = "[object String]", be = "[object Symbol]", y = "[object Undefined]", q = "[object WeakMap]", j = "[object ArrayBuffer]", B = "[object DataView]", Z = "[object Float32Array]", R = "[object Float64Array]", I = "[object Int8Array]", k = "[object Int16Array]", A = "[object Int32Array]", F = "[object Uint8Array]", D = "[object Uint8ClampedArray]", M = "[object Uint16Array]", X = "[object Uint32Array]", z = /[\\^$.*+?()[\]{}|]/g, ee = /^\[object .+?Constructor\]$/, he = /^(?:0|[1-9]\d*)$/, U = {};
  U[Z] = U[R] = U[I] = U[k] = U[A] = U[F] = U[D] = U[M] = U[X] = !0, U[o] = U[l] = U[j] = U[c] = U[B] = U[f] = U[p] = U[g] = U[x] = U[_] = U[T] = U[Q] = U[ae] = U[V] = U[q] = !1;
  var et = typeof De == "object" && De && De.Object === Object && De, h = typeof self == "object" && self && self.Object === Object && self, u = et || h || Function("return this")(), S = t && !t.nodeType && t, v = S && !0 && e && !e.nodeType && e, K = v && v.exports === S, ne = K && et.process, ce = function() {
    try {
  ...
  function Se(m, E) {
    for (var C = -1, $ = m == null ? 0 : m.length, ie = 0, H = []; ++C < $; ) {
      var ue = m[C];
      E(ue, C, m) && (H[ie++] = ue);
    }
    return H;
  ...
  function ht(m, E) {
    for (var C = -1, $ = E.length, ie = m.length; ++C < $; )
      m[ie + C] = E[C];
    return m;
  }
  function de(m, E) {
  ...
  var ud = Array.prototype, fd = Function.prototype, Sn = Object.prototype, Ji = u["__core-js_shared__"], Vs = fd.toString, tt = Sn.hasOwnProperty, Ys = function() {
  ...
  ), Js = K ? u.Buffer : void 0, An = u.Symbol, Qs = u.Uint8Array, Zs = Sn.propertyIsEnumerable, pd = ud.splice, Nt = An ? An.toStringTag : void 0, eo = Object.getOwnPropertySymbols, hd = Js ? Js.isBuffer : void 0, md = ld(Object.keys, Object), Qi = rr(u, "DataView"), Or = rr(u, "Map"), Zi = rr(u, "Promise"), ea = rr(u, "Set"), ta = rr(u, "WeakMap"), Dr = rr(Object, "create"), gd = Lt(Qi), yd = Lt(Or), xd = Lt(Zi), wd = Lt(ea), Ed = Lt(ta), to = An ? An.prototype : void 0, ra = to ? to.valueOf : void 0;
  function Ft(m) {
  ...
  function Id(m) {
    ...
    if (C < 0)
      return !1;
    var $ = E.length - 1;
    return C == $ ? E.pop() : pd.call(E, C, 1), --this.size, !0;
  }
  function Cd(m) {
    var E = this.__data__, C = Cn(E, m);
  ...
  function Gd(m, E) {
    var C = On(m), $ = !C && ip(m), ie = !C && !$ && na(m), H = !C && !$ && !ie && uo(m), ue = C || $ || ie || H, me = ue ? We(m.length, String) : [], Ee = me.length;
    for (var se in m)
      ...
      ie && (se == "offset" || se == "parent") || // PhantomJS 2 has enumerable non-index properties on typed arrays.
  ...
  function Pr(m) {
    return m == null ? m === void 0 ? y : b : Nt && Nt in Object(m) ? Jd(m) : np(m);
  }
  function ro(m) {
    return kr(m) && Pr(m) == o;
  }
  function no(m, E, C, $, ie) {
    return m === E ? !0 : m == null || E == null || !kr(m) && !kr(E) ? m !== m && E !== E : qd(m, E, C, $, no, ie);
  }
  function qd(m, E, C, $, ie, H) {
    var ue = On(m), me = On(E), Ee = ue ? l : gt(m), se = me ? l : gt(E);
    Ee = Ee == o ? T : Ee, se = se == o ? T : se;
    var Be = Ee == T, Ve = se == T, Ae = Ee == se;
    if (Ae && na(m)) {
      if (!na(E))
        return !1;
      ue = !0, Be = !1;
    ...
    if (Ae && !Be)
      return H || (H = new mt()), ue || uo(m) ? io(m, E, C, $, ie, H) : Yd(m, E, Ee, C, $, ie, H);
    if (!(C & i)) {
      var Ge = Be && tt.call(m, "__wrapped__"), He = Ve && tt.call(E, "__wrapped__");
      if (Ge || He) {
        var yt = Ge ? m.value() : m, ct = He ? E.value() : E;
        return H || (H = new mt()), ie(yt, ct, C, $, H);
      }
    }
    return Ae ? (H || (H = new mt()), Kd(m, E, C, $, ie, H)) : !1;
  }
  function Xd(m) {
    if (!co(m) || tp(m))
      return !1;
  ...
  function io(m, E, C, $, ie, H) {
    var ue = C & i, me = m.length, Ee = E.length;
    if (me != Ee && !(ue && Ee > me))
      return !1;
    var se = H.get(m);
    if (se && H.get(E))
      return se == E;
    var Be = -1, Ve = !0, Ae = C & a ? new In() : void 0;
    for (H.set(m, E), H.set(E, m); ++Be < me; ) {
      var Ge = m[Be], He = E[Be];
      if ($)
        var yt = ue ? $(He, Ge, Be, E, m, H) : $(Ge, He, Be, m, E, H);
      if (yt !== void 0) {
        if (yt)
          continue;
        Ve = !1;
      ...
      if (Ae) {
        if (!de(E, function(ct, Ut) {
          if (!_n(Ae, Ut) && (Ge === ct || ie(Ge, ct, C, $, H)))
            return Ae.push(Ut);
        })) {
          Ve = !1;
          break;
        }
      } else if (!(Ge === He || ie(Ge, He, C, $, H))) {
        Ve = !1;
        break;
      }
    }
    return H.delete(m), H.delete(E), Ve;
  }
  function Yd(m, E, C, $, ie, H, ue) {
    switch (C) {
      case B:
      ...
      case j:
        return !(m.byteLength != E.byteLength || !H(new Qs(m), new Qs(E)));
      case c:
      case f:
      case _:
        return so(+m, +E);
      ...
      case ae:
        var Ee = $ & i;
        if (me || (me = cd), m.size != E.size && !Ee)
          return !1;
        var se = ue.get(m);
        if (se)
          return se == E;
        $ |= a, ue.set(m, E);
        var Be = io(me(m), me(E), $, ie, H, ue);
  ...
  function Kd(m, E, C, $, ie, H) {
    var ue = C & i, me = ao(m), Ee = me.length, se = ao(E), Be = se.length;
    if (Ee != Be && !ue)
      return !1;
    for (var Ve = Ee; Ve--; ) {
      var Ae = me[Ve];
      if (!(ue ? Ae in E : tt.call(E, Ae)))
        return !1;
    }
    var Ge = H.get(m);
    if (Ge && H.get(E))
    ...
    for (var yt = ue; ++Ve < Ee; ) {
      ...
      var ct = m[Ae], Ut = E[Ae];
      if ($)
        var fo = ue ? $(Ut, ct, Ae, E, m, H) : $(ct, Ut, Ae, m, E, H);
      if (!(fo === void 0 ? ct === Ut || ie(ct, Ut, C, $, H) : fo)) {
        He = !1;
        break;
      }
      yt || (yt = Ae == "constructor");
    }
    if (He && !yt) {
      var Dn = m.constructor, Pn = E.constructor;
      Dn != Pn && "constructor" in m && "constructor" in E && !(typeof Dn == "function" && Dn instanceof Dn && typeof Pn == "function" && Pn instanceof Pn) && (He = !1);
    }
    return H.delete(m), H.delete(E), He;
  }
  function ao(m) {
    return Hd(m, op, Qd);
  }
  ...
  function Jd(m) {
    ...
    var ie = Ks.call(m);
    return $ && (E ? m[Nt] = C : delete m[Nt]), ie;
  }
  var Qd = eo ? function(m) {
    return m == null ? [] : (m = Object(m), Se(eo(m), function(E) {
      return Zs.call(m, E);
    }));
  } : lp, gt = Pr;
  (Qi && gt(new Qi(new ArrayBuffer(1))) != B || Or && gt(new Or()) != x || Zi && gt(Zi.resolve()) != O || ea && gt(new ea()) != ae || ta && gt(new ta()) != q) && (gt = function(m) {
    var E = Pr(m), C = E == T ? m.constructor : void 0, $ = C ? Lt(C) : "";
    if ($)
      switch ($) {
        case gd:
          return B;
...
var xn = {}, Xe = {}, XE = "[object Symbol]", If = /[\\^$.*+?()[\]{}|]/g, WE = RegExp(If.source), VE = typeof De == "object" && De && De.Object === Object && De, YE = typeof self == "object" && self && self.Object === Object && self, KE = VE || YE || Function("return this")(), JE = Object.prototype, QE = JE.toString, Cl = KE.Symbol, Rl = Cl ? Cl.prototype : void 0, Ol = Rl ? Rl.toString : void 0;
function ZE(e) {
  if (typeof e == "string")
    return e;
  if (tv(e))
  ...
  async getLatestVersion() {
    ...
    try {
      if (this.updater.allowPrerelease) {
        const _ = ((t = this.updater) === null || t === void 0 ? void 0 : t.channel) || ((r = pr.prerelease(this.updater.currentVersion)) === null || r === void 0 ? void 0 : r[0]) || null;
        if (_ === null)
          c = Ra.exec(d.element("link").attribute("href"))[1];
        else
          for (const b of l.getElements("entry")) {
            const T = Ra.exec(b.element("link").attribute("href"));
            if (T === null)
              continue;
            const O = T[1], P = ((n = pr.prerelease(O)) === null || n === void 0 ? void 0 : n[0]) || null, Q = !_ || ["alpha", "beta"].includes(_), ae = P !== null && !["alpha", "beta"].includes(String(P));
            if (Q && !ae && !(_ === "beta" && P === "alpha")) {
              c = O;
              break;
            }
            if (P && P === _) {
        ...
        for (const _ of l.getElements("entry"))
          if (Ra.exec(_.element("link").attribute("href"))[1] === c) {
            d = _;
            break;
          }
      }
    } catch (_) {
      throw (0, ut.newError)(`Cannot parse releases feed: ${_.stack || _.message},
XML:
${o}`, "ERR_UPDATER_INVALID_RELEASE_FEED");
    ...
    let f, p = "", g = "";
    const w = async (_) => {
      p = (0, hr.getChannelFilename)(_), g = (0, hr.newUrlFromBase)(this.getBaseDownloadPath(String(c), p), this.baseUrl);
      const b = this.createRequestOptions(g);
      try {
        return await this.executor.request(b, s);
      } catch (T) {
        throw T instanceof ut.HttpError && T.statusCode === 404 ? (0, ut.newError)(`Cannot find ${p} in the latest release artifacts (${g}): ${T.stack || T.message}`, "ERR_UPDATER_CHANNEL_FILE_NOT_FOUND") : T;
      }
    };
    try {
      let _ = this.channel;
      this.updater.allowPrerelease && (!((i = pr.prerelease(c)) === null || i === void 0) && i[0]) && (_ = this.getCustomChannelName(String((a = pr.prerelease(c)) === null || a === void 0 ? void 0 : a[0]))), f = await w(_);
    } catch (_) {
      if (this.updater.allowPrerelease)
    ...
    const x = (0, es.parseUpdateInfo)(f, p, g);
...
const ar = xe, wv = _e, Ev = le, $l = _r, Ll = Xe, vv = Ot, Tv = pe;
...
function Rv(e, t, r) {
  ...
  const c = i.get(l);
  let f = 0;
  const { checksumToOffset: p, checksumToOldSize: g } = Dv(n.get(l), d.offset, r);
  let w = s.offset;
  for (let x = 0; x < c.checksums.length; w += c.sizes[x], x++) {
    const _ = c.sizes[x], b = c.checksums[x];
    let T = p.get(b);
    T != null && g.get(b) !== _ && (r.warn(`Checksum ("${b}") matches, but size differs (old: ${g.get(b)}, new: ${_})`), T = void 0), T === void 0 ? (f++, a != null && a.kind === Xt.DOWNLOAD && a.end === w ? a.end += _ : (a = {
      kind: Xt.DOWNLOAD,
      start: w,
      end: w + _
      // oldBlocks: null,
    }, Ml(a, o, b, x))) : a != null && a.kind === Xt.COPY && a.end === T ? a.end += _ : (a = {
      kind: Xt.COPY,
      start: T,
      end: T + _
      // oldBlocks: [checksum]
...
function Lv(e, t, r, n, i) {
  ...
  if (s <= 1) {
    const f = (p) => {
      ...
      if (g.kind === Gl.OperationKind.COPY)
        (0, zl.copyData)(g, r, t.oldFileFd, i, () => f(p));
      else {
        const w = e.createRequestOptions();
        w.headers.Range = `bytes=${g.start}-${g.end - 1}`;
        const x = e.httpExecutor.createRequest(w, (_) => {
          rs(_, i) && (_.pipe(r, {
            end: !1
          }), _.once("end", () => f(p)));
        });
  ...
  const c = e.httpExecutor.createRequest(d, (f) => {
    if (!rs(f, i))
      return;
    const p = (0, ts.safeGetHeader)(f, "content-type"), g = /^multipart\/.+?(?:; boundary=(?:(?:"(.+)")|(?:([^\s]+))))$/i.exec(p);
    if (g == null) {
  ...
  async doDownloadFile(t, r) {
    ...
    await new Promise((s, o) => {
      ...
      if (!this.options.isUseMultipleRangeRequest && this.options.onProgress) {
        ...
        let T = 0;
        for (const P of t)
          P.kind === Wn.OperationKind.DOWNLOAD && (b.push(P.end - P.start), T += P.end - P.start);
        const O = {
          expectedByteCounts: b,
          grandTotal: T
        };
        d = new Gv.ProgressDifferentialDownloadCallbackTransform(O, this.options.cancellationToken, this.options.onProgress), l.push(d);
      }
      ...
      _.redirect = "manual", g = (b) => {
        ...
        const P = t[b++];
        if (P.kind === Wn.OperationKind.COPY) {
          d && d.beginFileCopy(), (0, jv.copyData)(P, p, n, o, () => g(b));
          return;
        }
        const Q = `bytes=${P.start}-${P.end - 1}`;
        _.headers.range = Q, (O = (T = this.logger) === null || T === void 0 ? void 0 : T.debug) === null || O === void 0 || O.call(T, `download range: ${Q}`), d && d.beginRangeDownload();
        const ae = this.httpExecutor.createRequest(_, (V) => {
          V.on("error", o), V.on("aborted", () => {
            o(new Error("response has been aborted by the server"));
          }), V.statusCode >= 400 && o((0, Lr.createHttpError)(V)), V.pipe(p, {
            end: !1
          }), V.once("end", () => {
            d && d.endRangeDownload(), ++w === 100 ? (w = 0, setTimeout(() => g(b), 1e3)) : g(b);
          });
        });
        ae.on("redirect", (V, be, y) => {
          this.logger.info(`Redirect to ${qv(y)}`), x = y, (0, Lr.configureRequestUrl)(new zv.URL(x), _), ae.followRedirect();
        }), this.httpExecutor.addErrorAndTimeoutHandlers(ae, o), ae.end();
      }, g(0);
    });
  }
...
const Oe = xe, Vv = un, Yv = _i, Kv = bc, sr = Pt, Jv = _e, ka = Pi, Mt = le, Gt = Sf, Xl = yn, Qv = Ui, Wl = Af, Zv = xn, Na = Mi, eT = Ac, tT = Xe, rT = Gi, or = kt;
class Bs extends Kv.EventEmitter {
  ...
  async getOrCreateStagingUserId() {
    ...
    const r = Oe.UUID.v5((0, Vv.randomBytes)(4096), Oe.UUID.OID);
  ...
  async executeDownload(t) {
    ...
    this.listenerCount(or.DOWNLOAD_PROGRESS) > 0 && (n.onProgress = (T) => this.emit(or.DOWNLOAD_PROGRESS, T));
    ...
    function o() {
      ...
      return T.endsWith(`.${t.fileExtension}`) ? Mt.basename(T) : t.fileInfo.info.url;
    }
    const l = await this.getOrCreateDownloadHelper(), d = l.cacheDirForPendingUpdate;
    await (0, sr.mkdir)(d, { recursive: !0 });
    const c = o();
    let f = Mt.join(d, c);
    const p = s == null ? null : Mt.join(d, `package-${a}${Mt.extname(s.path) || ".7z"}`), g = async (T) => (await l.setDownloadedFile(f, p, i, r, c, T), await t.done({
      ...i,
      downloadedFile: f
    }), p == null ? [f] : [f, p]), w = this._logger, x = await l.validateDownloadedPath(f, i, r, w);
    if (x != null)
    ...
    try {
      await t.task(b, n, p, _), await (0, Oe.retry)(() => (0, sr.rename)(b, f), 60, 500, 0, 0, (T) => T instanceof Error && /^EBUSY:/.test(T.message));
    } catch (T) {
      throw await _(), T instanceof Oe.CancellationError && (w.info("cancelled"), this.emit("update-cancelled", i)), T;
    }
    return w.info(`New version ${a} has been downloaded to ${f}`), await g(!0);
  }
  async differentialDownloadInstaller(t, r, n, i, a) {
    try {
      ...
      const o = async (c) => {
        ...
        try {
          return JSON.parse((0, eT.gunzipSync)(f).toString());
        } catch (p) {
      ...
      return await new rT.GenericDifferentialDownloader(t.info, this.httpExecutor, l).download(d[0], d[1]), !1;
    } catch (s) {
...
class RT extends IT.AppUpdater {
  ...
  async doDownloadUpdate(t) {
    ...
    return this.executeDownload({
      ...
      task: async (f, p) => {
        ...
        let x = !0;
        w() && (x = await this.differentialDownloadInstaller(l, t, f, d, c)), x && await this.httpExecutor.download(l.url, f, p);
      },
      done: async (f) => {
  ...
  async updateDownloaded(t, r) {
    ...
    return await new Promise((d, c) => {
      const f = (0, ic.randomBytes)(64).toString("base64").replace(/\//g, "_").replace(/\+/g, "-"), p = Buffer.from(`autoupdater:${f}`, "ascii"), g = `/${(0, ic.randomBytes)(64).toString("hex")}.zip`;
      this.server.on("request", (w, x) => {
        ...
        if (s.info(`${_} requested`), _ === "/") {
          ...
          const O = w.headers.authorization.split(" ")[1], P = Buffer.from(O, "base64").toString("ascii"), [Q, ae] = P.split(":");
          if (Q !== "autoupdater" || ae !== f) {
          ...
          x.writeHead(200, { "Content-Type": "application/json", "Content-Length": V.length }), x.end(V);
          return;
        }
        if (!_.startsWith(g)) {
          s.warn(`${_} requested, but not supported`), x.writeHead(404), x.end();
          return;
        }
        ...
        const T = (0, ST.createReadStream)(i);
        T.on("error", (O) => {
          try {
            x.end();
          } catch (P) {
            s.warn(`cannot end response: ${P}`);
          }
          b = !0, this.nativeUpdater.removeListener("error", c), c(new Error(`Cannot pipe "${i}": ${O}`));
        }), x.writeHead(200, {
...
ln.NsisUpdater = MT;
(function(e) {
  var t = De && De.__createBinding || (Object.create ? function(_, b, T, O) {
    O === void 0 && (O = T);
    var P = Object.getOwnPropertyDescriptor(b, T);
    (!P || ("get" in P ? !b.__esModule : P.writable || P.configurable)) && (P = { enumerable: !0, get: function() {
      return b[T];
    } }), Object.defineProperty(_, O, P);
  } : function(_, b, T, O) {
    O === void 0 && (O = T), _[O] = b[T];
  }), r = De && De.__exportStar || function(_, b) {
    for (var T in _) T !== "default" && !Object.prototype.hasOwnProperty.call(b, T) && t(b, _, T);
  };
  ...
  function x() {
    if (process.platform === "win32")
      ...
      try {
        ...
        const b = (0, n.readFileSync)(_).toString().trim();
...
var Wi = function(e, t, r, n, i) {
  var a, s, o = i * 8 - n - 1, l = (1 << o) - 1, d = l >> 1, c = -7, f = r ? i - 1 : 0, p = r ? -1 : 1, g = e[t + f];
  for (f += p, a = g & (1 << -c) - 1, g >>= -c, c += o; c > 0; a = a * 256 + e[t + f], f += p, c -= 8)
    ;
  ...
  var s, o, l, d = a * 8 - i - 1, c = (1 << d) - 1, f = c >> 1, p = i === 23 ? Math.pow(2, -24) - Math.pow(2, -77) : 0, g = n ? 0 : a - 1, w = n ? 1 : -1, x = t < 0 || t === 0 && 1 / t < 0 ? 1 : 0;
  for (t = Math.abs(t), isNaN(t) || t === 1 / 0 ? (o = isNaN(t) ? 1 : 0, s = c) : (s = Math.floor(Math.log(t) / Math.LN2), t * (l = Math.pow(2, -s)) < 1 && (s--, l *= 2), s + f >= 1 ? t += p / l : t += p * Math.pow(2, 1 - f), t * l >= 2 && (s++, l /= 2), s + f >= c ? (o = 0, s = c) : s + f >= 1 ? (o = (t * l - 1) * Math.pow(2, i), s = s + f) : (o = t * Math.pow(2, f - 1) * Math.pow(2, i), s = 0)); i >= 8; e[r + g] = o & 255, g += w, o /= 256, i -= 8)
    ;
...
const WS = /* @__PURE__ */ Object.freeze(/* @__PURE__ */ Object.defineProperty({
  ...
  get(e) {
    ...
    return {
      signature: W.get(e, 0),
      minVersion: re.get(e, 4),
      dataDescriptor: !!(t & 8),
      compressedMethod: re.get(e, 8),
      compressedSize: W.get(e, 18),
      uncompressedSize: W.get(e, 22),
      filenameLength: re.get(e, 26),
      extraFieldLength: re.get(e, 28),
      filename: null
    };
  },
  len: 30
  ...
  get(e) {
    return {
      signature: W.get(e, 0),
      nrOfThisDisk: re.get(e, 4),
      nrOfThisDiskWithTheStart: re.get(e, 6),
      nrOfEntriesOnThisDisk: re.get(e, 8),
      nrOfEntriesOfSize: re.get(e, 10),
      sizeOfCd: W.get(e, 12),
      offsetOfStartOfCd: W.get(e, 16),
      zipFileCommentLength: re.get(e, 20)
    };
  },
  len: 22
}, b_ = {
  get(e) {
    ...
    return {
      signature: W.get(e, 0),
      minVersion: re.get(e, 6),
      dataDescriptor: !!(t & 8),
      compressedMethod: re.get(e, 10),
      compressedSize: W.get(e, 20),
      uncompressedSize: W.get(e, 24),
      filenameLength: re.get(e, 28),
      extraFieldLength: re.get(e, 30),
      fileCommentLength: re.get(e, 32),
  ...
  async unzip(t) {
    ...
    do {
      ...
      if (await this.tokenizer.ignore(i.extraFieldLength), i.dataDescriptor && i.compressedSize === 0) {
        ...
        let d = -1;
        for (; d < 0 && l === La; ) {
          l = await this.tokenizer.peekBuffer(this.syncBuffer, { mayBeLess: !0 }), d = A_(this.syncBuffer.subarray(0, l), S_);
          const c = d >= 0 ? d : l;
          if (a.handler) {
...
`, { offset: 2, encoding: r }) ? {
  ...
  async readTiffTag(t) {
    const r = await this.tokenizer.readToken(t ? qt : re);
  ...
  async readTiffHeader(t) {
    const r = (t ? qt : re).get(this.buffer, 2), n = (t ? wi : W).get(this.buffer, 4);
    if (r === 42) {
      if (n >= 6) {
        ...
        if (n >= 8) {
          const a = (t ? qt : re).get(this.buffer, 8), s = (t ? qt : re).get(this.buffer, 10);
...
const Ub = {
  ...
  async load() {
    return (await import("./MpegParser-DQbuJiQa.js")).MpegParser;
  }
}, Mb = {
  parserType: "apev2",
  extensions: [".ape"],
  ...
  async load() {
    return (await import("./AsfParser-DxN3zFrg.js")).AsfParser;
  }
}, jb = {
  parserType: "dsdiff",
  extensions: [".dff"],
  ...
  async load() {
    return (await import("./DsdiffParser-BQPcG-y6.js")).DsdiffParser;
  }
}, zb = {
  parserType: "aiff",
  ...
  async load() {
    return (await import("./AiffParser-wJZfS1wC.js")).AIFFParser;
  }
}, Gb = {
  parserType: "dsf",
  extensions: [".dsf"],
  mimeTypes: ["audio/dsf"],
  async load() {
    return (await import("./DsfParser-CeofX1Cy.js")).DsfParser;
  }
}, Hb = {
  parserType: "flac",
  extensions: [".flac"],
  ...
  async load() {
    return (await import("./FlacParser-o75mAhWv.js").then((e) => e.d)).FlacParser;
  }
}, qb = {
  parserType: "matroska",
  ...
  async load() {
    return (await import("./MatroskaParser-5dJfbl4t.js")).MatroskaParser;
  }
}, Xb = {
  parserType: "mp4",
  ...
  async load() {
    return (await import("./MP4Parser-DJ1ynEks.js")).MP4Parser;
  }
}, Wb = {
  parserType: "musepack",
  extensions: [".mpc"],
  ...
  async load() {
    return (await import("./MusepackParser-BPr1RNpZ.js")).MusepackParser;
  }
}, Vb = {
  parserType: "ogg",
  ...
  async load() {
    return (await import("./OggParser-DSpqFD4v.js")).OggParser;
  }
}, Yb = {
  parserType: "wavpack",
  extensions: [".wv", ".wvp"],
  ...
  async load() {
    return (await import("./WavPackParser-CQuIR9aV.js")).WavPackParser;
  }
}, Kb = {
  parserType: "riff",
  ...
  async load() {
    return (await import("./WaveParser-DKulwag3.js")).WaveParser;
  }
...
const pS = /^[\x21-\x7e©][\x20-\x7e\x00()]{3}/, rd = {
  ...
  get: (e, t) => ({
    ...
    compressionLevel: re.get(e, t),
    // any format flags (for future use)
    formatFlags: re.get(e, t + 2),
    ...
    bitsPerSample: re.get(e, t + 16),
    // the number of channels (1 or 2)
    channel: re.get(e, t + 18),
...
const ad = ve.dirname(pp(import.meta.url));
process.env.APP_ROOT = ve.join(ad, "..");
const cs = process.env.VITE_DEV_SERVER_URL, aA = ve.join(process.env.APP_ROOT, "dist-electron"), sd = ve.join(process.env.APP_ROOT, "dist");
process.env.VITE_PUBLIC = cs ? ve.join(process.env.APP_ROOT, "public") : sd;
let J;
function od() {
  J = new Tc({
    width: 1200,
    ...
    minWidth: 800,
    minHeight: 600,
    icon: ve.join(process.env.VITE_PUBLIC, "logo.png"),
    ...
    webPreferences: {
      preload: ve.join(ad, "preload.mjs"),
      webSecurity: !1,
  ...
  }), cs ? J.loadURL(cs) : J.loadFile(ve.join(sd, "index.html"));
}
...
Ke.whenReady().then(() => {
  process.platform === "win32" && Ke.setAppUserModelId("NeonWave"), od(), qe.handle("dialog:openDirectory", async () => {
    ...
    try {
      ...
      return i.filter((s) => a.includes(ve.extname(s).toLowerCase())).map((s) => ve.join(n, s));
    } catch (i) {
    ...
    const r = ve.join(process.env.APP_ROOT, "scripts/get-active-window.ps1");
    return await _S(r);
  });
  const e = Mr(import.meta.url)("yt-dlp-wrap").default, t = async () => {
    const r = process.platform === "win32" ? "yt-dlp.exe" : "yt-dlp", n = ve.join(Ke.getPath("userData"), r);
    try {
      await aa.access(n);
    } catch {
...
`).map((o) => {
    ...
    try {
      ...
      const { filePath: d } = await po.showSaveDialog(J, {
        title: "下載歌曲",
        defaultPath: `${l}.m4a`,
      ...
      return d ? new Promise((c, f) => {
        ...
        g.on("progress", () => {
          ...
          console.error("yt-dlp error:", w), f(new Error(`下載錯誤: ${w.message}`));
        }), g.on("close", () => {
          c(d);
        });
      }) : null;
    ...
    try {
      const o = Mr(import.meta.url)("get-artist-title"), l = Mr(import.meta.url)("genius-lyrics"), d = new l.Client();
      console.log(`[Lyrics] Search: ${n} / ${i} (Duration: ${s}s)`);
      const c = async (T) => {
        try {
          const O = `https://lrclib.net/api/search?q=${encodeURIComponent(T)}`, P = await fetch(O);
          if (P.ok) {
            const Q = await P.json();
            if (Array.isArray(Q)) return Q;
          }
        } catch (O) {
          console.error("LRC Search Error", T, O);
        }
        return [];
      }, f = (T) => T ? T.split(`
`).filter((O) => O.trim()).map((O) => `[00:00.00]${O}`).join(`
`) : null;
      let p = n, g = i, w = typeof s == "number" ? s : 0, x = "";
      a ? x = ve.basename(a, ve.extname(a)).replace(/_/g, " ").replace(/\(.*\)/g, "").replace(/\[.*\]/g, "").trim() : x = `${n} ${i}`, console.log(`[Lyrics] Step 1: iTunes Normalization Query: ${x}`);
      try {
        const T = await fetch(`https://itunes.apple.com/search?term=${encodeURIComponent(x)}&media=music&entity=song&limit=3`);
        if (T.ok) {
          const O = await T.json();
          if (O.resultCount > 0) {
            const P = O.results[0];
            console.log(`[Lyrics] iTunes Match: ${P.artistName} - ${P.trackName} (${P.trackTimeMillis / 1e3}s)`), p = P.trackName, g = P.artistName;
          }
        }
      } catch (T) {
        console.warn("[Lyrics] iTunes search failed/skipped", T);
      }
      const _ = `${p} ${g}`;
      console.log(`[Lyrics] Step 2: Searching LRCLib for: ${_}`);
      const b = await c(_);
      if (b.length > 0 && w > 0) {
        const T = b.find((O) => O.syncedLyrics ? Math.abs(O.duration - w) <= 4 : !1);
        if (T)
          return console.log(`[Lyrics] SUCCESS: Duration Match Found (${T.duration}s vs ${w}s)`), T.syncedLyrics;
        {
          console.warn(`[Lyrics] Warning: ${b.length} results found, but NONE match duration ${w}s`);
          const O = b[0];
          if (O.plainLyrics)
            return console.log("[Lyrics] Falling back to Plain Text due to duration mismatch."), f(O.plainLyrics);
        }
      } else if (b.length > 0 && w === 0) {
        const T = b.find((O) => O.syncedLyrics) || b[0];
        return T.syncedLyrics || f(T.plainLyrics);
      }
      console.log("[Lyrics] Step 3: Fuzzy Fallback (Genius)");
      try {
        let T = null, O = `${p} ${g}`, P = await d.songs.search(O);
        if (P.length === 0 && a) {
          const Q = ve.basename(a, ve.extname(a)).replace(/_/g, " ");
          P = await d.songs.search(Q);
        }
        if (P.length > 0) {
          T = P[0], console.log(`[Lyrics] Genius identified: ${T.artist.name} - ${T.title}`);
          const ae = (await c(`${T.title} ${T.artist.name}`)).find((be) => be.syncedLyrics ? w > 0 ? Math.abs(be.duration - w) <= 10 : !0 : !1);
          if (ae)
            return console.log("[Lyrics] Fallback Sync Found via Genius"), ae.syncedLyrics;
          const V = await T.lyrics();
          if (V)
            return console.log("[Lyrics] Fallback to Genius Plain Text"), f(V);
        }
      } catch (T) {
        console.error("[Lyrics] Fallback failed", T);
      }
      return console.log("[Lyrics] All attempts failed."), null;
    } catch (o) {
