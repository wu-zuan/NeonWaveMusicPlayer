...
const $b = {
  ...
  async load() {
    return (await import("./MpegParser-D4lD25IK.js")).MpegParser;
  }
}, Lb = {
  parserType: "apev2",
  extensions: [".ape"],
  ...
  async load() {
    return (await import("./AsfParser-DhiJ1QI2.js")).AsfParser;
  }
}, Mb = {
  parserType: "dsdiff",
  extensions: [".dff"],
  ...
  async load() {
    return (await import("./DsdiffParser-DTepTLaY.js")).DsdiffParser;
  }
}, Bb = {
  parserType: "aiff",
  ...
  async load() {
    return (await import("./AiffParser-ByHzwrNt.js")).AIFFParser;
  }
}, zb = {
  parserType: "dsf",
  extensions: [".dsf"],
  mimeTypes: ["audio/dsf"],
  async load() {
    return (await import("./DsfParser-D0aF2jiD.js")).DsfParser;
  }
}, jb = {
  parserType: "flac",
  extensions: [".flac"],
  ...
  async load() {
    return (await import("./FlacParser-BL4SHqr8.js").then((e) => e.d)).FlacParser;
  }
}, Gb = {
  parserType: "matroska",
  ...
  async load() {
    return (await import("./MatroskaParser-D88PYlSW.js")).MatroskaParser;
  }
}, Hb = {
  parserType: "mp4",
  ...
  async load() {
    return (await import("./MP4Parser-ecvbnQww.js")).MP4Parser;
  }
}, qb = {
  parserType: "musepack",
  extensions: [".mpc"],
  ...
  async load() {
    return (await import("./MusepackParser-V4inAl0d.js")).MusepackParser;
  }
}, Xb = {
  parserType: "ogg",
  ...
  async load() {
    return (await import("./OggParser-CZF0NXV4.js")).OggParser;
  }
}, Wb = {
  parserType: "wavpack",
  extensions: [".wv", ".wvp"],
  ...
  async load() {
    return (await import("./WavPackParser-BBFvciok.js")).WavPackParser;
  }
}, Vb = {
  parserType: "riff",
  ...
  async load() {
    return (await import("./WaveParser-BomyTJgs.js")).WaveParser;
  }
...
St.whenReady().then(() => {
  sd(), He.handle("dialog:openDirectory", async () => {
    ...
    try {
      const i = fo(import.meta.url)("@distube/ytdl-core");
      if (!i.validateURL(t)) throw new Error("Invalid URL");
      let a;
      try {
        a = await i.getInfo(t);
      } catch (l) {
        throw console.error("Failed to get info:", l), new Error("Video unavailable or blocked. (Info fetch failed)");
      }
      const s = (a.videoDetails.title || r).replace(/[\\/:*?"<>|]/g, "_").trim(), { filePath: o } = await uo.showSaveDialog(J, {
        title: "下載歌曲",
        defaultPath: `${s}.mp3`,
        filters: [{ name: "Audio", extensions: ["mp3"] }]
      });
      return o ? new Promise((l, d) => {
        const c = i.downloadFromInfo(a, {
          quality: "highestaudio",
          filter: "audioonly"
        });
        c.on("error", (f) => {
          console.error("YTDL Stream Error:", f), d(f);
        }), import("node:fs").then((f) => {
          const h = f.createWriteStream(o);
          c.pipe(h), h.on("finish", () => l(o)), h.on("error", (g) => {
            console.error("File Write Error:", g), d(g);
          });
        });
      }) : null;
    } catch (n) {
      throw console.error("Download handler failed:", n), n;
    }
