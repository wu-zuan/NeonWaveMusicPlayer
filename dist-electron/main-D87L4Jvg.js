...
import Jt, { app as Je, BrowserWindow as Ic, Notification as wp, ipcMain as oe, dialog as go } from "electron";
...
import { createAudioPlayer as Ap, AudioPlayerStatus as ir, joinVoiceChannel as Ip, createAudioResource as Fn, StreamType as xo } from "@discordjs/voice";
...
var ce = Pt, Mp = Pp, Bp = Np, jp = $p, $n = ps, _e, fi;
...
function hs(e) {
  Mp(e), e.gracefulify = hs, e.createReadStream = k, e.createWriteStream = H;
  var t = e.readFile;
  e.readFile = r;
  function r(y, j, U) {
...
const qp = Fe.fromPromise, { makeDir: Xp, makeDirSync: la } = gs, ca = qp(Xp);
var lt = {
  mkdirs: ca,
  mkdirsSync: la,
  // alias
...
function Mc(e, t, r, n, i) {
  ...
  vr.stat(s, { bigint: !0 }, (o, l) => o ? o.code === "ENOENT" ? i() : i(o) : dn(t, l) ? i(new Error(Ci(e, r, n))) : Mc(e, t, s, n, i));
}
function Bc(e, t, r, n) {
...
const Me = $e, Vr = ue, rh = lt.mkdirs, nh = tr.pathExists, ih = Uc.utimesMillis, Yr = Ar;
function ah(e, t, r, n) {
  typeof r == "function" && !n ? (n = r, r = {}) : typeof r == "function" && (r = { filter: r }), n = n || function() {
    ...
    Yr.checkParentPaths(e, s, t, "copy", (l) => l ? n(l) : r.filter ? jc(_o, o, e, t, r, n) : _o(o, e, t, r, n));
  });
}
...
var wh = ah;
const Ie = $e, Kr = ue, xh = lt.mkdirsSync, Eh = Uc.utimesMillisSync, Jr = Ar;
function vh(e, t, r) {
...
const So = $e, Vc = ue, ne = Cc, Qr = process.platform === "win32";
function Yc(e) {
  [
    "unlink",
    "chmod",
    ...
    t.unlink(e, (a) => {
      if (a) {
        if (a.code === "ENOENT")
          return r(null);
        if (a.code === "EPERM")
          return Qr ? Io(e, t, a, r) : oi(e, t, a, r);
        if (a.code === "EISDIR")
          return oi(e, t, a, r);
      }
      return r(a);
...
function Uh(e, t) {
  if (ne(e), ne(t), t.readdirSync(e).forEach((r) => Kc(Vc.join(e, r), t)), Qr) {
    const r = Date.now();
    do
      try {
...
const zh = Fe.fromPromise, Qc = er, Zc = ue, eu = lt, tu = Di, Ro = zh(async function(t) {
  let r;
  try {
...
const Rm = Fe.fromCallback, qr = $e, mu = ue, gu = lt, Dm = tr.pathExists;
function Om(e, t, r, n) {
...
var Gm = Ne;
const zm = $e, za = ue, Hm = xs.copy, yu = Di.remove, qm = lt.mkdirp, Xm = tr.pathExists, Uo = Ar;
function Wm(e, t, r, n) {
  ...
  Uo.checkPaths(e, t, "move", r, (a, s) => {
    ...
    Uo.checkParentPaths(e, o, t, "move", (d) => {
      ...
      qm(za.dirname(t), (c) => c ? n(c) : Mo(e, t, i, l, n));
    });
  });
}
function Vm(e) {
...
function Mo(e, t, r, n, i) {
  ...
  if (r)
    return yu(t, (a) => a ? i(a) : ua(e, t, r, i));
  Xm(t, (a, s) => a ? i(a) : s ? i(new Error("dest already exists.")) : ua(e, t, r, i));
}
function ua(e, t, r, n) {
...
var Km = Wm;
const wu = $e, Ha = ue, Jm = xs.copySync, xu = Di.removeSync, Qm = lt.mkdirpSync, Bo = Ar;
function Zm(e, t, r) {
  r = r || {};
  const n = r.overwrite || r.clobber || !1, { srcStat: i, isChangingCase: a = !1 } = Bo.checkPathsSync(e, t, "move", r);
  return Bo.checkParentPathsSync(e, i, t, "move"), e0(t) || Qm(Ha.dirname(t)), t0(e, t, n, a);
}
function e0(e) {
...
var ke = {}, Xa = { exports: {} }, Mn = { exports: {} }, da, jo;
function c0() {
  if (jo) return da;
  jo = 1;
...
var Bn = { exports: {} }, ha, Ho;
function f0() {
  return Ho || (Ho = 1, ha = (e, t = process.argv) => {
...
function d0() {
  if (qo) return ma;
  qo = 1;
  const e = Ii, t = Dc, r = f0(), { env: n } = process;
  let i;
...
typeof process > "u" || process.type === "renderer" || process.browser === !0 || process.__nwjs ? Xa.exports = u0() : Xa.exports = p0();
var vu = Xa.exports;
...
const g0 = fn, y0 = vu, w0 = Pt, x0 = un, Tu = Sr, E0 = Ct, Wo = Ir, v0 = pn, $r = (0, y0.default)("electron-builder");
...
class hi {
  ...
  doApiRequest(t, r, n, i = 0) {
    return $r.enabled && $r(`Request: ${gi(t)}`), r.createPromise((a, s, o) => {
  ...
  handleResponse(t, r, n, i, a, s, o) {
    var l;
    if ($r.enabled && $r(`Response: ${t.statusCode} ${t.statusMessage}, request options: ${gi(r)}`), t.statusCode === 404) {
...
ki.githubUrl = I0;
ki.getS3LikeProviderBaseUrl = C0;
...
const Iu = fn, Cu = Ir, k0 = "options.name must be either a string or a Buffer", Vo = (0, Iu.randomBytes)(16);
Vo[0] = Vo[0] | 1;
const ci = {}, Q = [];
for (let e = 0; e < 256; e++) {
    ...
    function Y(h, f) {
      if (h.opt.xmlns) {
        ...
        for (var ae = 0, fe = h.attribList.length; ae < fe; ae++) {
          var ve = h.attribList[ae], Se = ve[0], mt = ve[1], he = O(Se, !0), We = he.prefix, ea = he.local, bn = We === "" ? "" : A.ns[We] || "", Or = {
            name: Se,
            value: mt,
            prefix: We,
            local: ea,
...
function q0(e, t) {
  ...
  for (l = 1; l <= t.linesBefore && !(s - l < 0); l++)
    d = ga(
      ...
      u
    ), o = jr.repeat(" ", t.indent) + ya((e.line - l + 1).toString(), c) + " | " + d.str + `
` + o;
  for (d = ga(e.buffer, n[s], i[s], e.position, u), o += jr.repeat(" ", t.indent) + ya((e.line + 1).toString(), c) + " | " + d.str + `
...
var ku = Ya, Q0 = Le, Nu = new Q0("tag:yaml.org,2002:str", {
  kind: "scalar",
...
var Vu = new Rg("tag:yaml.org,2002:merge", {
  kind: "scalar",
  resolve: Dg
}), Og = Le, Cs = `ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789+/=
\r`;
function Pg(e) {
  if (e === null) return !1;
...
}), qt = Qe, Zu = mn, Yg = X0, Kg = Rs, Rt = Object.prototype.hasOwnProperty, yi = 1, ef = 2, tf = 3, wi = 4, xa = 1, Jg = 2, Zo = 3, Qg = /[\x00-\x08\x0B\x0C\x0E-\x1F\x7F-\x84\x86-\x9F\uFFFE\uFFFF]|[\uD800-\uDBFF](?![\uDC00-\uDFFF])|(?:[^\uD800-\uDBFF]|^)[\uDC00-\uDFFF]/, Zg = /[\x85\u2028\u2029]/, ey = /[,\[\]\{\}]/, rf = /^(?:!|!!|![a-z\-]+!)$/i, nf = /^(?:!|[^,\[\]\{\}])(?:%[0-9a-f]{2}|[0-9a-z\-#;\/\?:@&=\+\$,_\.!~\*'\(\)\[\]])*$/i;
function el(e) {
...
function sy(e, t, r) {
  ...
  for (e.kind = "scalar", e.result = "", a = s = e.position, o = !1; g !== 0; ) {
    if (g === 58) {
      ...
      if (e.position === e.lineStart && Ni(e) || r && pr(g))
        break;
      if (st(g))
    ...
    o && (St(e, a, s, !1), Os(e, e.line - l), a = s = e.position, o = !1), Yt(g) || (s = e.position + 1), g = e.input.charCodeAt(++e.position);
  }
  ...
  for (e.kind = "scalar", e.result = "", e.position++, n = i = e.position; (r = e.input.charCodeAt(e.position)) !== 0; )
    if (r === 39)
      if (St(e, n, e.position, !0), r = e.input.charCodeAt(++e.position), r === 39)
        ...
        return !0;
    else st(r) ? (St(e, n, i, !0), Os(e, pe(e, !1, t)), n = i = e.position) : e.position === e.lineStart && Ni(e) ? B(e, "unexpected end of the document within a single quoted scalar") : (e.position++, i = e.position);
...
function ly(e, t) {
  ...
  for (e.kind = "scalar", e.result = "", e.position++, r = n = e.position; (o = e.input.charCodeAt(e.position)) !== 0; ) {
    ...
    if (o === 92) {
      ...
      r = n = e.position;
    } else st(o) ? (St(e, r, n, !0), Os(e, pe(e, !1, t)), r = n = e.position) : e.position === e.lineStart && Ni(e) ? B(e, "unexpected end of the document within a double quoted scalar") : (e.position++, n = e.position);
  }
...
function uy(e, t) {
  var r, n, i = xa, a = !1, s = !1, o = t, l = 0, d = !1, c, u;
  ...
  for (e.kind = "scalar", e.result = ""; u !== 0; )
    if (u = e.input.charCodeAt(++e.position), u === 43 || u === 45)
      xa === i ? i = u === 43 ? Zo : Jg : B(e, "repeat of a chomping mode identifier");
    else if ((c = ny(u)) >= 0)
  ...
  for (; u !== 0; ) {
    for (Ds(e), e.lineIndent = 0, u = e.input.charCodeAt(e.position); (!s || e.lineIndent < o) && u === 32; )
...
function my(e) {
  ...
  for (e.version = null, e.checkLineBreaks = e.legacy, e.tagMap = /* @__PURE__ */ Object.create(null), e.anchorMap = /* @__PURE__ */ Object.create(null); (s = e.input.charCodeAt(e.position)) !== 0 && (pe(e, !0, -1), s = e.input.charCodeAt(e.position), !(e.lineIndent > 0 || s !== 37)); ) {
    ...
    s !== 0 && Ds(e), Rt.call(rl, n) ? rl[n](e, n, i) : xi(e, 'unknown document directive "' + n + '"');
  }
  if (pe(e, !0, -1), e.lineIndent === 0 && e.input.charCodeAt(e.position) === 45 && e.input.charCodeAt(e.position + 1) === 45 && e.input.charCodeAt(e.position + 2) === 45 ? (e.position += 3, pe(e, !0, -1)) : a && B(e, "directives end mark is expected"), br(e, e.lineIndent - 1, wi, !1, !0), pe(e, !0, -1), e.checkLineBreaks && Zg.test(e.input.slice(t, e.position)) && xi(e, "non-ASCII line breaks are interpreted as content"), e.documents.push(e.result), e.position === e.lineStart && Ni(e)) {
...
Is.loadAll = gy;
Is.load = yy;
var uf = {}, Fi = Qe, gn = mn, wy = Rs, ff = Object.prototype.toString, df = Object.prototype.hasOwnProperty, Ps = 65279, xy = 9, en = 10, Ey = 13, vy = 32, Ty = 33, _y = 34, Ka = 35, by = 37, Sy = 38, Ay = 39, Iy = 42, pf = 44, Cy = 45, Ei = 58, Ry = 61, Dy = 62, Oy = 63, Py = 64, hf = 91, mf = 93, ky = 96, gf = 123, Ny = 124, yf = 125, Re = {};
Re[0] = "\\0";
Re[7] = "\\a";
Re[8] = "\\b";
Re[9] = "\\t";
...
function rn(e) {
  return 32 <= e && e <= 126 || 161 <= e && e <= 55295 && e !== 8232 && e !== 8233 || 57344 <= e && e <= 65533 && e !== Ps || 65536 <= e && e <= 1114111;
}
function sl(e) {
  return rn(e) && e !== Ps && e !== Ey && e !== en;
}
function ol(e, t, r) {
  var n = sl(e), i = n && !vi(e);
  return (
    ...
    (r ? (
      // c = flow-in
      n
    ) : n && e !== pf && e !== hf && e !== mf && e !== gf && e !== yf) && e !== Ka && !(t === Ei && !i) || sl(t) && !vi(t) && e === Ka || t === Ei && i
  );
}
function Gy(e) {
  return rn(e) && e !== Ps && !vi(e) && e !== Cy && e !== Oy && e !== Ei && e !== pf && e !== hf && e !== mf && e !== gf && e !== yf && e !== Ka && e !== Sy && e !== Iy && e !== Ty && e !== Ny && e !== Ry && e !== Dy && e !== Ay && e !== _y && e !== by && e !== Py && e !== ky;
}
function zy(e) {
  return !vi(e) && e !== Ei;
}
...
var xf = 1, Qa = 2, Ef = 3, vf = 4, dr = 5;
function Hy(e, t, r, n, i, a, s, o) {
  var l, d = 0, c = null, u = !1, p = !1, g = n !== -1, x = -1, w = Gy(Gr(e, 0)) && zy(Gr(e, e.length - 1));
  if (t || s)
  ...
  return !u && !p ? w && !s && !i(e) ? xf : a === tn ? dr : Qa : r > 9 && wf(e) ? dr : s ? a === tn ? dr : Qa : p ? vf : Ef;
}
...
function Wy(e) {
  for (var t = "", r = 0, n, i = 0; i < e.length; r >= 65536 ? i += 2 : i++)
    r = Gr(e, i), n = Re[r], !n && rn(r) ? (t += e[i], r >= 65536 && (t += e[i + 1])) : t += n || Uy(r);
  return t;
}
function Vy(e, t, r) {
  var n = "", i = e.tag, a, s, o;
...
function fl(e, t, r, n) {
  ...
  for (s = 0, o = r.length; s < o; s += 1)
    l = r[s], e.replacer && (l = e.replacer.call(r, String(s), l)), (pt(e, t + 1, l, !0, !0, !1, !0) || typeof l > "u" && pt(e, t + 1, null, !0, !0, !1, !0)) && ((!n || i !== "") && (i += Ja(e, t)), e.dump && en === e.dump.charCodeAt(0) ? i += "-" : i += "- ", i += e.dump);
  e.tag = a, e.dump = i || "[]";
}
function Yy(e, t, r) {
...
function Ky(e, t, r, n) {
  ...
  for (o = 0, l = s.length; o < l; o += 1)
    p = "", (!n || i !== "") && (p += Ja(e, t)), d = s[o], c = r[d], e.replacer && (c = e.replacer.call(r, d, c)), pt(e, t + 1, d, !0, !0, !0) && (u = e.tag !== null && e.tag !== "?" || e.dump && e.dump.length > 1024, u && (e.dump && en === e.dump.charCodeAt(0) ? p += "?" : p += "? "), p += e.dump, u && (p += Ja(e, t)), pt(e, t + 1, c, !0, u) && (e.dump && en === e.dump.charCodeAt(0) ? p += ":" : p += ": ", p += e.dump, i += p));
  e.tag = a, e.dump = i || "{}";
}
function dl(e, t, r) {
  var n, i, a, s, o, l;
...
const Gn = Ui, { MAX_LENGTH: hl, MAX_SAFE_INTEGER: zn } = Li, { safeRe: Hn, t: qn } = yn, fw = Ns, { compareIdentifiers: Ea } = Sf;
let dw = class at {
  constructor(t, r) {
...
var Cf = hx;
const mx = Ue, gx = Rr, { safeRe: Xn, t: Wn } = yn, yx = (e, t) => {
  if (e instanceof mx)
    return e;
...
function et() {
  ...
  const r = Ex, n = new r(), i = Ns, a = Bi(), s = Ui, o = Ue, {
    ...
    tildeTrimReplace: u,
    caretTrimReplace: p
  } = yn, { FLAG_INCLUDE_PRERELEASE: g, FLAG_LOOSE: x } = Li, w = (R) => R.value === "<0.0.0-0", T = (R) => R.value === "", b = (R, I) => {
    let P = !0;
    const S = R.slice();
    let $ = S.pop();
    for (; P && S.length; )
    ...
    return R.replace(P, (S, $, O, z, Y, X) => {
      ...
      const re = F(O), ge = re || F(z), G = ge || F(Y), tt = G;
      return $ === "=" && tt && ($ = ""), X = I.includePrerelease ? "-0" : "", re ? $ === ">" || $ === "<" ? S = "<0.0.0-0" : S = "*" : $ && tt ? (ge && (z = 0), Y = 0, $ === ">" ? ($ = ">=", ge ? (O = +O + 1, z = 0, Y = 0) : (z = +z + 1, Y = 0)) : $ === "<=" && ($ = "<", ge ? O = +O + 1 : z = +z + 1), $ === "<" && (X = "-0"), S = `${$ + O}.${z}.${Y}${X}`) : ge ? S = `>=${O}.0.0${X} <${+O + 1}.0.0-0` : G && (S = `>=${O}.${z}.0${X} <${O}.${+z + 1}.0-0`), s("xRange return", S), S;
    });
  }, j = (R, I) => (s("replaceStars", R, I), R.trim().replace(l[d.STAR], "")), U = (R, I) => (s("replaceGTE0", R, I), R.trim().replace(l[I.includePrerelease ? d.GTE0PRE : d.GTE0], "")), M = (R) => (I, P, S, $, O, z, Y, X, re, ge, G, tt) => (F(S) ? P = "" : F($) ? P = `>=${S}.0.0${R ? "-0" : ""}` : F(O) ? P = `>=${S}.${$}.0${R ? "-0" : ""}` : z ? P = `>=${P}` : P = `>=${P}${R ? "-0" : ""}`, F(re) ? X = "" : F(ge) ? X = `<${+re + 1}.0.0-0` : F(G) ? X = `<${re}.${+ge + 1}.0-0` : tt ? X = `<=${re}.${ge}.${G}-${tt}` : R ? X = `<${re}.${ge}.${+G + 1}-0` : X = `<=${X}`, `${P} ${X}`.trim()), J = (R, I, P) => {
...
function Bi() {
  ...
  Ta = t;
  const r = Ns, { safeRe: n, t: i } = yn, a = Cf, s = Ui, o = Ue, l = et();
  return Ta;
}
...
var kx = Px;
const _a = Ue, Nx = et(), Tl = Mi, Fx = (e, t) => {
  e = new Nx(e, t);
  let r = new _a("0.0.0");
  ...
  for (let n = 0; n < e.set.length; ++n) {
    ...
    let a = null;
    i.forEach((s) => {
      const o = new _a(s.semver.version);
      switch (s.operator) {
        case ">":
...
var Mx = Ux;
const Bx = Ue, Rf = Bi(), { ANY: jx } = Rf, Gx = et(), zx = ji, _l = Mi, bl = $s, Hx = Us, qx = Ls, Xx = (e, t, r, n) => {
...
const Al = et(), Bs = Bi(), { ANY: ba } = Bs, Ur = ji, js = Ze, iE = (e, t, r = {}) => {
  if (e === t)
    return !0;
  ...
  return !0;
}, aE = [new Bs(">=0.0.0-0")], Il = [new Bs(">=0.0.0")], sE = (e, t, r) => {
  if (e === t)
    return !0;
...
var oE = iE;
const Sa = yn, Dl = Li, lE = Ue, Ol = Sf, cE = Rr, uE = gw, fE = xw, dE = vw, pE = _w, hE = Aw, mE = Rw, gE = Pw, yE = Fw, wE = Ze, xE = Mw, EE = Gw, vE = Fs, TE = Xw, _E = Yw, bE = Mi, SE = $s, AE = Af, IE = If, CE = Ls, RE = Us, DE = Cf, OE = wx, PE = Bi(), kE = et(), NE = ji, FE = Sx, $E = Rx, LE = kx, UE = $x, ME = Mx, BE = Ms, jE = Yx, GE = Qx, zE = eE, HE = nE, qE = oE;
var Df = {
  parse: cE,
  valid: uE,
  clean: fE,
...
(function(e, t) {
  ...
  G[J] = G[R] = G[I] = G[P] = G[S] = G[$] = G[O] = G[z] = G[Y] = !0, G[o] = G[l] = G[U] = G[c] = G[M] = G[u] = G[p] = G[g] = G[w] = G[T] = G[_] = G[k] = G[H] = G[q] = G[j] = !1;
  ...
  var gd = Array.prototype, yd = Function.prototype, An = Object.prototype, ta = f["__core-js_shared__"], Js = yd.toString, rt = An.hasOwnProperty, Qs = function() {
    var m = /[^.]+$/.exec(ta && ta.keys && ta.keys.IE_PROTO || "");
    return m ? "Symbol(src)_1." + m : "";
  }(), Zs = An.toString, wd = RegExp(
    "^" + Js.call(rt).replace(X, "\\$&").replace(/hasOwnProperty|(function).*?(?=\\\()| for .+?(?=\\\])/g, "$1.*?") + "$"
  ), eo = Z ? f.Buffer : void 0, In = f.Symbol, to = f.Uint8Array, ro = An.propertyIsEnumerable, xd = gd.splice, Ft = In ? In.toStringTag : void 0, no = Object.getOwnPropertySymbols, Ed = eo ? eo.isBuffer : void 0, vd = hd(Object.keys, Object), ra = nr(f, "DataView"), Pr = nr(f, "Map"), na = nr(f, "Promise"), ia = nr(f, "Set"), aa = nr(f, "WeakMap"), kr = nr(Object, "create"), Td = Ut(ra), _d = Ut(Pr), bd = Ut(na), Sd = Ut(ia), Ad = Ut(aa), io = In ? In.prototype : void 0, sa = io ? io.valueOf : void 0;
  function $t(m) {
  ...
  function Yd(m, E) {
    var C = On(m), L = !C && up(m), se = !C && !L && oa(m), V = !C && !L && !se && ho(m), de = C || L || se || V, ye = de ? We(m.length, String) : [], Te = ye.length;
    for (var le in m)
      ...
      se && (le == "offset" || le == "parent") || // PhantomJS 2 has enumerable non-index properties on typed arrays.
  ...
  function so(m, E, C, L, se) {
    return m === E ? !0 : m == null || E == null || !Fr(m) && !Fr(E) ? m !== m && E !== E : Jd(m, E, C, L, so, se);
  }
  function Jd(m, E, C, L, se, V) {
    var de = On(m), ye = On(E), Te = de ? l : yt(m), le = ye ? l : yt(E);
    ...
    if (Ae && !je)
      return V || (V = new gt()), de || ho(m) ? oo(m, E, C, L, se, V) : tp(m, E, Te, C, L, se, V);
    if (!(C & i)) {
      var He = je && rt.call(m, "__wrapped__"), qe = Ve && rt.call(E, "__wrapped__");
      if (He || qe) {
        var wt = He ? m.value() : m, ut = qe ? E.value() : E;
        return V || (V = new gt()), se(wt, ut, C, L, V);
      }
    }
    return Ae ? (V || (V = new gt()), rp(m, E, C, L, se, V)) : !1;
  }
  function Qd(m) {
    if (!po(m) || op(m))
      return !1;
  ...
  function Zd(m) {
    return Fr(m) && fo(m.length) && !!G[Nr(m)];
  }
  function ep(m) {
    if (!lp(m))
      return vd(m);
    ...
    for (V.set(m, E), V.set(E, m); ++je < ye; ) {
      ...
      if (Ae) {
        if (!he(E, function(ut, Mt) {
          if (!bn(Ae, Mt) && (He === ut || se(He, ut, C, L, V)))
            return Ae.push(Mt);
        })) {
          Ve = !1;
          break;
  ...
  function tp(m, E, C, L, se, V, de) {
    switch (C) {
      ...
      case U:
        return !(m.byteLength != E.byteLength || !V(new to(m), new to(E)));
      case c:
      case u:
      case T:
        return co(+m, +E);
  ...
  function rp(m, E, C, L, se, V) {
    var de = C & i, ye = lo(m), Te = ye.length, le = lo(E), je = le.length;
    if (Te != je && !de)
      return !1;
    for (var Ve = Te; Ve--; ) {
      var Ae = ye[Ve];
    ...
    for (var wt = de; ++Ve < Te; ) {
      ...
      var ut = m[Ae], Mt = E[Ae];
      if (L)
        var mo = de ? L(Mt, ut, Ae, E, m, V) : L(ut, Mt, Ae, m, E, V);
      if (!(mo === void 0 ? ut === Mt || se(ut, Mt, C, L, V) : mo)) {
        qe = !1;
        break;
      }
  ...
  var ip = no ? function(m) {
    return m == null ? [] : (m = Object(m), Se(no(m), function(E) {
      return ro.call(m, E);
    }));
  } : hp, yt = Nr;
  (ra && yt(new ra(new ArrayBuffer(1))) != M || Pr && yt(new Pr()) != w || na && yt(na.resolve()) != F || ia && yt(new ia()) != H || aa && yt(new aa()) != j) && (yt = function(m) {
  ...
  var up = ao(/* @__PURE__ */ function() {
    ...
    return Fr(m) && rt.call(m, "callee") && !ro.call(m, "callee");
  }, On = Array.isArray;
  function fp(m) {
    return m != null && fo(m.length) && !uo(m);
  }
  var oa = Ed || mp;
  function dp(m, E) {
    return so(m, E);
...
const WE = fn, VE = Pt, Pl = XE, zt = kt, Wr = ue;
class YE {
  constructor(t) {
  ...
  async validateDownloadedPath(t, r, n, i) {
    if (this.versionInfo != null && this.file === t && this.fileInfo != null)
      return Pl(this.versionInfo, r) && Pl(this.fileInfo.info, n.info) && await (0, zt.pathExists)(t) ? t : null;
...
var xn = {}, Xe = {}, rv = "[object Symbol]", Pf = /[\\^$.*+?()[\]{}|]/g, nv = RegExp(Pf.source), iv = typeof Pe == "object" && Pe && Pe.Object === Object && Pe, av = typeof self == "object" && self && self.Object === Object && self, sv = iv || av || Function("return this")(), ov = Object.prototype, lv = ov.toString, Nl = sv.Symbol, Fl = Nl ? Nl.prototype : void 0, $l = Fl ? Fl.toString : void 0;
function cv(e) {
  if (typeof e == "string")
    return e;
  if (fv(e))
...
function wv(e, t, r) {
  const n = ts(`${e.pathname}.blockmap`, e);
  return [ts(`${e.pathname.replace(new RegExp(mv(r), "g"), t)}.blockmap`, e), n];
}
var me = {};
...
const Ul = Ee, Ia = Xe, Ca = me;
class bv extends Ca.Provider {
  constructor(t, r, n) {
...
class Sv extends Da.Provider {
  ...
  async getLatestVersion() {
    const t = new Ml.CancellationToken(), r = (0, Ra.getChannelFilename)(this.getCustomChannelName(this.channel)), n = (0, Ra.newUrlFromBase)(r, this.baseUrl, this.updater.isAddNoCacheQuery);
    try {
...
const ft = Ee, mr = Df, Av = Sr, gr = Xe, rs = me, Oa = /\/tag\/([^/]+)$/;
class Ff extends rs.Provider {
  constructor(t, r, n) {
    super({
      ...n,
...
${o}`, "ERR_UPDATER_INVALID_RELEASE_FEED");
    ...
    const w = (0, rs.parseUpdateInfo)(u, p, g);
  ...
  resolveFiles(t) {
    return (0, rs.resolveFiles)(t, this.baseUrl, (r) => this.getBaseDownloadPath(t.tag, r.replace(/ /g, "-")));
  }
...
const jl = Ee, Pa = Xe, ka = me;
class Cv extends ka.Provider {
  constructor(t, r, n) {
    super({
      ...n,
      isUseMultipleRangeRequest: !1
  ...
  async getLatestVersion() {
    const t = new jl.CancellationToken(), r = (0, Pa.getChannelFilename)(this.getCustomChannelName(this.channel)), n = (0, Pa.newUrlFromBase)(r, this.baseUrl, this.updater.isAddNoCacheQuery);
    try {
...
const or = Ee, Rv = be, Dv = ue, Gl = Sr, zl = Xe, Ov = Ot, Pv = me;
class kv extends Ov.BaseGitHubProvider {
  ...
  async getLatestVersion() {
    const t = new or.CancellationToken(), r = (0, zl.getChannelFilename)(this.getDefaultChannelName()), n = await this.getLatestVersionInfo(t), i = n.assets.find((o) => o.name === r);
    if (i == null)
      throw (0, or.newError)(`Cannot find ${r} in the release ${n.html_url || n.name}`, "ERR_UPDATER_CHANNEL_FILE_NOT_FOUND");
    const a = new Gl.URL(i.url);
    let s;
    try {
...
zi.createClient = Uv;
const Vn = Ee, Nv = Hi, Hl = xn, Fv = Ot, $v = qi, Lv = Xi;
function Lf(e) {
...
Dr.copyData = Uf;
const Yn = Ee, Gv = Pt, zv = un, Hv = rr, Wl = Buffer.from(`\r
\r
`);
var vt;
(function(e) {
...
Vi.checkIsRangesSupported = is;
const ns = Ee, Vl = Dr, Yl = rr;
...
function Wv(e, t, r, n, i) {
  ...
  const c = e.httpExecutor.createRequest(d, (u) => {
    if (!is(u, i))
      return;
    const p = (0, ns.safeGetHeader)(u, "content-type"), g = /^multipart\/.+?(?:; boundary=(?:(?:"(.+)")|(?:([^\s]+))))$/i.exec(p);
    if (g == null) {
...
function is(e, t) {
  if (e.statusCode >= 400)
    return t((0, ns.createHttpError)(e)), !1;
  if (e.statusCode !== 206) {
    const r = (0, ns.safeGetHeader)(e, "accept-ranges");
    if (r == null || r === "none")
...
const Mr = Ee, Na = kt, Kv = Pt, Jv = Dr, Qv = Sr, Kn = rr, Kl = Vi, Zv = Yi;
class eT {
    ...
    await new Promise((s, o) => {
      ...
      T.redirect = "manual", g = (b) => {
        ...
        const H = this.httpExecutor.createRequest(T, (q) => {
          ...
          }), q.statusCode >= 400 && o((0, Mr.createHttpError)(q)), q.pipe(p, {
            end: !1
          }), q.once("end", () => {
        ...
        H.on("redirect", (q, te, y) => {
          this.logger.info(`Redirect to ${tT(y)}`), w = y, (0, Mr.configureRequestUrl)(new Qv.URL(w), T), H.followRedirect();
...
const De = Ee, iT = fn, aT = Ii, sT = Rc, lr = kt, oT = be, Fa = $i, Bt = ue, Ht = Df, Ql = wn, lT = Gi, Zl = Of, cT = xn, $a = zi, uT = Oc, fT = Xe, dT = Wi, cr = Nt;
...
const tc = Ee, rc = Ai, ET = kt, vT = Pt, Br = ue, TT = ht, _T = vn, bT = me, nc = Nt;
class ST extends TT.BaseUpdater {
  ...
  doInstall(t) {
    ...
    if (a == null)
      return this.dispatchError(new Error("No valid update available, can't quit and install")), !1;
    Br.basename(a) === i || !/\d+\.\d+\.\d+/.test(i) ? n = r : n = Br.join(Br.dirname(r), Br.basename(a)), (0, rc.execFileSync)("mv", ["-f", a, n]), n !== r && this.emit("appimage-filename-updated", n);
    const s = {
      ...process.env,
...
const oc = Ee, La = kt, FT = Pt, lc = ue, $T = _p, LT = It, UT = me, cc = Ai, uc = fn;
class MT extends LT.AppUpdater {
  ...
  async doDownloadUpdate(t) {
    ...
    return this.executeDownload({
      ...
      downloadUpdateOptions: t,
      task: async (u, p) => {
        const g = lc.join(this.downloadedUpdateHelper.cacheDir, c), x = () => (0, La.pathExistsSync)(g) ? !t.disableDifferentialDownload : (n.info("Unable to locate previous update.zip for differential download (is this first install?), falling back to full download"), !1);
        let w = !0;
  ...
  async updateDownloaded(t, r) {
    var n;
    const i = r.downloadedFile, a = (n = t.info.size) !== null && n !== void 0 ? n : (await (0, La.stat)(i)).size, s = this._logger, o = `fileToProxy=${t.url.href}`;
...
const Jn = Ee, pc = ue, HT = ht, qT = vn, hc = Nt, XT = me, WT = kt, VT = Hs, mc = Sr;
...
for (const [e, t] of Object.entries(ss))
  ;
...
function p_(e) {
  let t = "";
  for (const r of e)
    r >= 128 && r <= 159 && ss[r] ? t += ss[r] : t += String.fromCharCode(r);
  return t;
}
function W(e) {
...
const nt = Cr("tokenizer:inflate"), Ma = 256 * 1024, F_ = Vf(wr.DataDescriptor), Qn = Vf(wr.EndOfCentralDirectory);
class Xs {
  constructor(t) {
              ...
              return {
                async handler(i) {
                  ...
                  if (s === -1) {
                    ...
                    a.includes(`ContentType="${o}"`) && (r = ja(o));
                  } else {
...
`, { offset: 2, encoding: r }) ? {
  ...
  async fromBuffer(t) {
    ...
    if ((r == null ? void 0 : r.length) > 1)
      return this.fromTokenizer(as(r, this.tokenizerOptions));
  }
  async fromBlob(t) {
  ...
  postMap(t, r) {
    switch (t.id) {
      case "UFID":
        {
          const n = t.value;
          n.owner_identifier === "http://musicbrainz.org" && (t.id += `:${n.owner_identifier}`, t.value = cs(n.identifier, "latin1"));
        }
        break;
      case "PRIV":
        {
...
const us = /\[(\d{2}):(\d{2})\.(\d{2,3})]/;
function Gb(e) {
  return us.test(e) ? Hb(e) : zb(e);
}
function zb(e) {
  return {
...
`), r = [];
  for (const n of t) {
    const i = n.match(us);
    if (i) {
      const a = Number.parseInt(i[1], 10), s = Number.parseInt(i[2], 10), o = i[3].length === 3 ? Number.parseInt(i[3], 10) : Number.parseInt(i[3], 10) * 10, l = (a * 60 + s) * 1e3 + o, d = n.replace(us, "").trim();
...
const Vb = {
  ...
  async load() {
    return (await import("./MpegParser-BPruw8eK.js")).MpegParser;
  }
}, Yb = {
  parserType: "apev2",
  extensions: [".ape"],
  ...
  async load() {
    return (await import("./AsfParser-IAx2AWFL.js")).AsfParser;
  }
}, Jb = {
  parserType: "dsdiff",
  extensions: [".dff"],
  ...
  async load() {
    return (await import("./DsdiffParser-CijDAx-K.js")).DsdiffParser;
  }
}, Qb = {
  parserType: "aiff",
  ...
  async load() {
    return (await import("./AiffParser-CtNevB41.js")).AIFFParser;
  }
}, Zb = {
  parserType: "dsf",
  extensions: [".dsf"],
  mimeTypes: ["audio/dsf"],
  async load() {
    return (await import("./DsfParser-D2D_QV77.js")).DsfParser;
  }
}, eS = {
  parserType: "flac",
  extensions: [".flac"],
  ...
  async load() {
    return (await import("./FlacParser-CYDOoSsy.js").then((e) => e.d)).FlacParser;
  }
}, tS = {
  parserType: "matroska",
  ...
  async load() {
    return (await import("./MatroskaParser-DeLTeydw.js")).MatroskaParser;
  }
}, rS = {
  parserType: "mp4",
  ...
  async load() {
    return (await import("./MP4Parser-DAE3Ye89.js")).MP4Parser;
  }
}, nS = {
  parserType: "musepack",
  extensions: [".mpc"],
  ...
  async load() {
    return (await import("./MusepackParser-BADbug2f.js")).MusepackParser;
  }
}, iS = {
  parserType: "ogg",
  ...
  async load() {
    return (await import("./OggParser-D7Yz9WVD.js")).OggParser;
  }
}, aS = {
  parserType: "wavpack",
  extensions: [".wv", ".wvp"],
  ...
  async load() {
    return (await import("./WavPackParser-BW7HCsYB.js")).WavPackParser;
  }
}, sS = {
  parserType: "riff",
  ...
  async load() {
    return (await import("./WaveParser-BZjEwU6s.js")).WaveParser;
  }
...
class lS {
  ...
  async parse(t, r, n) {
    if (t.supportsRandomAccess() ? (Gt("tokenizer supports random-access, scanning for appending headers"), await DS(t, n)) : Gt("tokenizer does not support random-access, cannot scan for appending headers"), !r) {
...
class At extends id {
  ...
  static parseTagFooter(t, r, n) {
    ...
    return as(r), new At(t, as(r), n).parseTags(i);
  }
  /**
...
class PS {
  ...
  async playReceiverStream() {
    ...
    console.log("[DiscordBot] Starting Receiver Stream..."), this.streamInput = new Cp();
    const t = Fn(this.streamInput, {
      inputType: xo.WebmOpus,
      inlineVolume: !0
    });
    return this.currentResource = t, (r = t.volume) == null || r.setVolume(1), this.player.play(t), !0;
  }
  writeAudioChunk(t) {
...
let fs = ud("ffmpeg-static");
Je.isPackaged && (fs = fs.replace("app.asar", "app.asar.unpacked"));
function kS(e) {
...
const ds = process.env.VITE_DEV_SERVER_URL, wA = Oe.join(process.env.APP_ROOT, "dist-electron"), dd = Oe.join(process.env.APP_ROOT, "dist");
process.env.VITE_PUBLIC = ds ? Oe.join(process.env.APP_ROOT, "public") : dd;
let ee;
function pd() {
  ee = new Ic({
    width: 1200,
  ...
  }), ds ? ee.loadURL(ds) : ee.loadFile(Oe.join(dd, "index.html"));
}
...
Je.whenReady().then(() => {
  ...
  const e = new PS();
  oe.handle("discord:login", async (n, i) => await e.login(i)), oe.handle("discord:getGuilds", () => e.getGuilds()), oe.handle("discord:getChannels", (n, i) => e.getChannels(i)), oe.handle("discord:join", async (n, i, a) => await e.joinChannel(i, a)), oe.handle("discord:leave", async () => await e.leaveChannel()), oe.handle("discord:play", async (n, i) => await e.playFile(i, fs)), oe.handle("discord:stop", () => e.stop()), oe.handle("discord:pause", () => e.pause()), oe.handle("discord:resume", () => e.resume()), oe.handle("discord:setVolume", (n, i) => e.setVolume(i)), oe.handle("discord:status", () => e.getStatus()), oe.handle("discord:startStreamMode", async () => await e.playReceiverStream()), oe.on("discord:audio-chunk", (n, i) => {
    e.writeAudioChunk(new Uint8Array(i));
  }), oe.handle("dialog:openDirectory", async () => {
    const { canceled: n, filePaths: i } = await go.showOpenDialog(ee, {
      properties: ["openDirectory"]
    });
    return n ? null : i[0];
  }), oe.handle("files:listMusic", async (n, i) => {
    if (!i) return [];
    try {
      const a = await Nn.readdir(i), s = [".mp3", ".wav", ".wma", ".m4a", ".flac", ".ogg", ".mp4", ".mov", ".wmv", ".avi"];
  ...
  }), oe.handle("files:readBuffer", async (n, i) => {
    try {
      return await Nn.readFile(i);
    } catch (a) {
      return console.error("Error reading file:", a), null;
    }
  }), oe.handle("files:getMetadata", async (n, i) => {
    try {
      const a = await OS(i);
      let s = null;
  ...
  }), oe.handle("app:active-window", async () => {
  ...
  oe.handle("search:youtube", async (n, i) => {
    try {
...
`).map((l) => {
  ...
  }), oe.handle("search:artistImage", async (n, i) => {
    try {
  ...
  }), oe.handle("search:lyrics", async (n, i, a, s, o) => {
    try {
