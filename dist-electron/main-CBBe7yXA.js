...
const Le = ke, Xr = oe, qp = ot.mkdirs, Xp = er.pathExists, Wp = Pc.utimesMillis, Wr = br;
function Vp(e, t, r, n) {
...
var oh = Vp;
const Se = ke, Vr = oe, lh = ot.mkdirsSync, ch = Pc.utimesMillisSync, Yr = br;
function uh(e, t, r) {
...
const Ph = Pe.fromPromise, Xc = Zt, Wc = oe, Vc = ot, Yc = Si, _o = Ph(async function(t) {
  let r;
  try {
...
const Nh = Pe.fromCallback, Kc = oe, Tt = ke, Jc = ot;
function Fh(e, t) {
  function r() {
    Tt.writeFile(e, "", (n) => {
      if (n) return t(n);
...
const Uh = Pe.fromCallback, Qc = oe, vt = ke, Zc = ot, Mh = er.pathExists, { areIdentical: eu } = br;
function Bh(e, t, r) {
  function n(i, a) {
    vt.link(i, a, (s) => {
      if (s) return r(s);
...
const Kh = Pe.fromCallback, ru = oe, Ye = Zt, nu = ot, Jh = nu.mkdirs, Qh = nu.mkdirsSync, iu = Xh, Zh = iu.symlinkPaths, em = iu.symlinkPathsSync, au = Yh, tm = au.symlinkType, rm = au.symlinkTypeSync, nm = er.pathExists, { areIdentical: su } = br;
function im(e, t, r, n) {
...
const xm = Pe.fromCallback, Gr = ke, cu = oe, uu = ot, wm = er.pathExists;
function Em(e, t, r, n) {
...
var Dm = De;
const Pm = ke, Ba = oe, km = ms.copy, fu = Si.remove, Nm = ot.mkdirp, Fm = er.pathExists, Po = br;
function $m(e, t, r, n) {
...
var Mm = $m;
const du = ke, ja = oe, Bm = ms.copySync, pu = Si.removeSync, jm = ot.mkdirpSync, No = br;
function zm(e, t, r) {
  r = r || {};
...
const Lb = {
  ...
  async load() {
    return (await import("./MpegParser-DmNNNCWa.js")).MpegParser;
  }
}, Ub = {
  parserType: "apev2",
  extensions: [".ape"],
  ...
  async load() {
    return (await import("./AsfParser-BHffC02s.js")).AsfParser;
  }
}, Bb = {
  parserType: "dsdiff",
  extensions: [".dff"],
  ...
  async load() {
    return (await import("./DsdiffParser-C5q5tyU4.js")).DsdiffParser;
  }
}, jb = {
  parserType: "aiff",
  ...
  async load() {
    return (await import("./AiffParser-CboMA6lk.js")).AIFFParser;
  }
}, zb = {
  parserType: "dsf",
  extensions: [".dsf"],
  mimeTypes: ["audio/dsf"],
  async load() {
    return (await import("./DsfParser-DChtjMjQ.js")).DsfParser;
  }
}, Gb = {
  parserType: "flac",
  extensions: [".flac"],
  ...
  async load() {
    return (await import("./FlacParser-zJPsfeoN.js").then((e) => e.d)).FlacParser;
  }
}, Hb = {
  parserType: "matroska",
  ...
  async load() {
    return (await import("./MatroskaParser-CAagj_LT.js")).MatroskaParser;
  }
}, qb = {
  parserType: "mp4",
  ...
  async load() {
    return (await import("./MP4Parser-DfAQqBPk.js")).MP4Parser;
  }
}, Xb = {
  parserType: "musepack",
  extensions: [".mpc"],
  ...
  async load() {
    return (await import("./MusepackParser-4h9izJa0.js")).MusepackParser;
  }
}, Wb = {
  parserType: "ogg",
  ...
  async load() {
    return (await import("./OggParser-l_n7ufax.js")).OggParser;
  }
}, Vb = {
  parserType: "wavpack",
  extensions: [".wv", ".wvp"],
  ...
  async load() {
    return (await import("./WavPackParser-Do6GsreU.js")).WavPackParser;
  }
}, Yb = {
  parserType: "riff",
  ...
  async load() {
    return (await import("./WaveParser-BqvcSYSs.js")).WaveParser;
  }
...
it.whenReady().then(() => {
  ...
  const e = po(import.meta.url)("yt-dlp-wrap").default, t = async () => {
    const r = process.platform === "win32" ? "yt-dlp.exe" : "yt-dlp", n = $e.join(it.getPath("userData"), r);
    try {
      await ia.access(n);
    } catch {
