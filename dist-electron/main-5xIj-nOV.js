...
import Jt, { app as Ke, BrowserWindow as Ac, Notification as yp, ipcMain as de, dialog as go } from "electron";
...
import { createAudioPlayer as Sp, AudioPlayerStatus as ir, joinVoiceChannel as Ap, createAudioResource as oa, StreamType as Ip } from "@discordjs/voice";
...
var le = Pt, Up = Op, Mp = kp, Bp = Fp, Fn = ps, _e, ui;
...
Pe[_e] || Oc(Pe, le[_e]);
var $e = hs(Bp(le));
process.env.TEST_GRACEFUL_FS_GLOBAL_PATCH && !le.__patched && ($e = hs(le), le.__patched = !0);
function hs(e) {
  Up(e), e.gracefulify = hs, e.createReadStream = k, e.createWriteStream = H;
  var t = e.readFile;
  e.readFile = r;
  function r(y, j, U) {
...
function ar(e) {
  Vt("ENQUEUE", e[0].name, e[1]), le[_e].push(e), ms();
}
var $n;
function vo() {
...
function ms() {
  if (clearTimeout($n), $n = void 0, le[_e].length !== 0) {
...
const Hp = Fe.fromPromise, { makeDir: qp, makeDirSync: la } = gs, ca = Hp(qp);
var ot = {
  mkdirs: ca,
  mkdirsSync: la,
  // alias
...
function Uc(e, t, r, n, i) {
  ...
  vr.stat(s, { bigint: !0 }, (o, l) => o ? o.code === "ENOENT" ? i() : i(o) : dn(t, l) ? i(new Error(Ii(e, r, n))) : Uc(e, t, s, n, i));
}
function Mc(e, t, r, n) {
...
const Me = $e, Vr = ce, th = ot.mkdirs, rh = tr.pathExists, nh = Lc.utimesMillis, Yr = Ar;
function ih(e, t, r, n) {
  typeof r == "function" && !n ? (n = r, r = {}) : typeof r == "function" && (r = { filter: r }), n = n || function() {
    ...
    Yr.checkParentPaths(e, s, t, "copy", (l) => l ? n(l) : r.filter ? Bc(To, o, e, t, r, n) : To(o, e, t, r, n));
  });
}
...
function mh(e, t, r, n, i) {
  Me.readlink(t, (a, s) => {
    ...
    if (n.dereference && (s = Vr.resolve(process.cwd(), s)), e)
      Me.readlink(r, (o, l) => o ? o.code === "EINVAL" || o.code === "UNKNOWN" ? Me.symlink(s, r, i) : i(o) : (n.dereference && (l = Vr.resolve(process.cwd(), l)), Yr.isSrcSubdir(s, l) ? i(new Error(`Cannot copy '${s}' to a subdirectory of itself, '${l}'.`)) : e.isDirectory() && Yr.isSrcSubdir(l, s) ? i(new Error(`Cannot overwrite '${l}' with '${s}'.`)) : gh(s, r, i)));
    else
...
var yh = ih;
const Ie = $e, Kr = ce, wh = ot.mkdirsSync, xh = Lc.utimesMillisSync, Jr = Ar;
function Eh(e, t, r) {
...
const bo = $e, Wc = ce, ne = Ic, Qr = process.platform === "win32";
function Vc(e) {
  [
    "unlink",
    "chmod",
...
const Gh = Fe.fromPromise, Jc = er, Qc = ce, Zc = ot, eu = Ri, Co = Gh(async function(t) {
  let r;
  try {
...
const Vh = Fe.fromCallback, nu = ce, Tt = $e, iu = ot, Yh = tr.pathExists, { areIdentical: au } = Ar;
function Kh(e, t, r) {
  function n(i, a) {
    Tt.link(i, a, (s) => {
      if (s) return r(s);
...
const bt = ce, Hr = $e, Zh = tr.pathExists;
function em(e, t, r) {
  if (bt.isAbsolute(e))
...
const sm = Fe.fromCallback, ou = ce, Ye = er, lu = ot, om = lu.mkdirs, lm = lu.mkdirsSync, cu = rm, cm = cu.symlinkPaths, um = cu.symlinkPathsSync, uu = am, fm = uu.symlinkType, dm = uu.symlinkTypeSync, pm = tr.pathExists, { areIdentical: fu } = Ar;
function hm(e, t, r, n) {
...
const Cm = Fe.fromCallback, qr = $e, hu = ce, mu = ot, Rm = tr.pathExists;
function Dm(e, t, r, n) {
...
var jm = Ne;
const Gm = $e, za = ce, zm = xs.copy, gu = Ri.remove, Hm = ot.mkdirp, qm = tr.pathExists, Lo = Ar;
function Xm(e, t, r, n) {
  ...
  Lo.checkPaths(e, t, "move", r, (a, s) => {
    ...
    Lo.checkParentPaths(e, o, t, "move", (d) => {
      ...
      Hm(za.dirname(t), (c) => c ? n(c) : Uo(e, t, i, l, n));
    });
  });
}
function Wm(e) {
...
function Uo(e, t, r, n, i) {
  ...
  qm(t, (a, s) => a ? i(a) : s ? i(new Error("dest already exists.")) : ua(e, t, r, i));
}
function ua(e, t, r, n) {
...
var Ym = Xm;
const yu = $e, Ha = ce, Km = xs.copySync, wu = Ri.removeSync, Jm = ot.mkdirpSync, Mo = Ar;
function Qm(e, t, r) {
  r = r || {};
  const n = r.overwrite || r.clobber || !1, { srcStat: i, isChangingCase: a = !1 } = Mo.checkPathsSync(e, t, "move", r);
  return Mo.checkParentPathsSync(e, i, t, "move"), Zm(t) || Jm(Ha.dirname(t)), e0(e, t, n, a);
}
function Zm(e) {
...
var ke = {}, Xa = { exports: {} }, Un = { exports: {} }, da, Bo;
function l0() {
  if (Bo) return da;
  Bo = 1;
...
var Mn = { exports: {} }, ha, zo;
function u0() {
  return zo || (zo = 1, ha = (e, t = process.argv) => {
...
const m0 = fn, g0 = Eu, y0 = Pt, w0 = un, vu = Sr, x0 = Ct, Xo = Ir, E0 = pn, $r = (0, g0.default)("electron-builder");
    ...
    t.on("error", a), t.on("data", (g) => p += g), t.on("end", () => {
      try {
        if (t.statusCode != null && t.statusCode >= 400) {
          const g = Er(t, "content-type"), w = g != null && (Array.isArray(g) ? g.find((x) => x.includes("json")) != null : g.includes("json"));
          a(Wa(t, `method: ${r.method || "GET"} url: ${r.protocol || "https:"}//${r.hostname}${r.port ? `:${r.port}` : ""}${r.path}
...
const Au = fn, Iu = Ir, P0 = "options.name must be either a string or a Buffer", Wo = (0, Au.randomBytes)(16);
Wo[0] = Wo[0] | 1;
const li = {}, Q = [];
for (let e = 0; e < 256; e++) {
...
}), qt = Je, Qu = mn, Vg = q0, Yg = Rs, Rt = Object.prototype.hasOwnProperty, gi = 1, Zu = 2, ef = 3, yi = 4, xa = 1, Kg = 2, Qo = 3, Jg = /[\x00-\x08\x0B\x0C\x0E-\x1F\x7F-\x84\x86-\x9F\uFFFE\uFFFF]|[\uD800-\uDBFF](?![\uDC00-\uDFFF])|(?:[^\uD800-\uDBFF]|^)[\uDC00-\uDFFF]/, Qg = /[\x85\u2028\u2029]/, Zg = /[,\[\]\{\}]/, tf = /^(?:!|!!|![a-z\-]+!)$/i, rf = /^(?:!|[^,\[\]\{\}])(?:%[0-9a-f]{2}|[0-9a-z\-#;\/\?:@&=\+\$,_\.!~\*'\(\)\[\]])*$/i;
function Zo(e) {
...
var tl = {
  YAML: function(t, r, n) {
    var i, a, s;
    t.version !== null && B(t, "duplication of %YAML directive"), n.length !== 1 && B(t, "YAML directive accepts exactly one argument"), i = /^([0-9]+)\.([0-9]+)$/.exec(n[0]), i === null && B(t, "ill-formed argument of the YAML directive"), a = parseInt(i[1], 10), s = parseInt(i[2], 10), a !== 1 && B(t, "unacceptable YAML version of the document"), t.version = n[0], t.checkLineBreaks = s < 2, s !== 1 && s !== 2 && wi(t, "unsupported YAML version of the document");
  },
  TAG: function(t, r, n) {
    var i, a;
  ...
  for (e.kind = "scalar", e.result = "", e.position++, n = i = e.position; (r = e.input.charCodeAt(e.position)) !== 0; )
    if (r === 39)
      if (St(e, n, e.position, !0), r = e.input.charCodeAt(++e.position), r === 39)
        ...
        return !0;
    else at(r) ? (St(e, n, i, !0), Os(e, pe(e, !1, t)), n = i = e.position) : e.position === e.lineStart && ki(e) ? B(e, "unexpected end of the document within a single quoted scalar") : (e.position++, i = e.position);
...
function oy(e, t) {
  ...
  for (e.kind = "scalar", e.result = "", e.position++, r = n = e.position; (o = e.input.charCodeAt(e.position)) !== 0; ) {
    ...
    if (o === 92) {
      ...
      r = n = e.position;
    } else at(o) ? (St(e, r, n, !0), Os(e, pe(e, !1, t)), r = n = e.position) : e.position === e.lineStart && ki(e) ? B(e, "unexpected end of the document within a double quoted scalar") : (e.position++, n = e.position);
  }
...
function uy(e, t, r) {
  ...
  for (e.anchor !== null && (e.anchorMap[e.anchor] = u), _ = e.input.charCodeAt(e.position); _ !== 0; ) {
    if (!T && e.firstTabInLine !== -1 && (e.position = e.firstTabInLine, B(e, "tab characters must not be used in indentation")), n = e.input.charCodeAt(e.position + 1), a = e.line, (_ === 63 || _ === 58) && Be(n))
      _ === 63 ? (T && (hr(e, u, p, g, w, null, s, o, l), g = w = x = null), b = !0, T = !0, i = !0) : T ? (T = !1, i = !0) : B(e, "incomplete explicit mapping pair; a key node is missed; or followed by a non-tabulated empty line"), e.position += 1, _ = n;
    else {
      if (s = e.line, o = e.lineStart, l = e.position, !br(e, r, Zu, !1, !0))
        break;
      if (e.line === a) {
        for (_ = e.input.charCodeAt(e.position); Yt(_); )
          _ = e.input.charCodeAt(++e.position);
        if (_ === 58)
          _ = e.input.charCodeAt(++e.position), Be(_) || B(e, "a whitespace character is expected after the key-value separator within a block mapping"), T && (hr(e, u, p, g, w, null, s, o, l), g = w = x = null), b = !0, T = !1, i = !1, g = e.tag, w = e.result;
        else if (b)
    ...
    if ((e.line === a || e.lineIndent > t) && (T && (s = e.line, o = e.lineStart, l = e.position), br(e, t, yi, !0, i) && (T ? w = e.result : x = e.result), T || (hr(e, u, p, g, w, x, s, o, l), g = w = x = null), pe(e, !0, -1), _ = e.input.charCodeAt(e.position)), (e.line === a || e.lineIndent > t) && _ !== 0)
      B(e, "bad indentation of a mapping entry");
    else if (e.lineIndent < t)
      break;
  }
  return T && hr(e, u, p, g, w, null, s, o, l), b && (e.tag = d, e.anchor = c, e.kind = "mapping", e.result = u), b;
}
function fy(e) {
  var t, r = !1, n = !1, i, a, s;
...
function br(e, t, r, n, i) {
  ...
  if (o && (o = d || i), (l === 1 || yi === r) && (gi === r || Zu === r ? x = t : x = t + 1, T = e.position - e.lineStart, l === 1 ? o && (nl(e, T) || uy(e, T, x)) || ly(e, x) ? c = !0 : (s && cy(e, x) || sy(e, x) || oy(e, x) ? c = !0 : py(e) ? (c = !0, (e.tag !== null || e.anchor !== null) && B(e, "alias node should not have any properties")) : ay(e, x, gi === r) && (c = !0, e.tag === null && (e.tag = "?")), e.anchor !== null && (e.anchorMap[e.anchor] = e.result)) : l === 0 && (c = o && nl(e, T))), e.tag === null)
...
function hy(e) {
  ...
  for (e.version = null, e.checkLineBreaks = e.legacy, e.tagMap = /* @__PURE__ */ Object.create(null), e.anchorMap = /* @__PURE__ */ Object.create(null); (s = e.input.charCodeAt(e.position)) !== 0 && (pe(e, !0, -1), s = e.input.charCodeAt(e.position), !(e.lineIndent > 0 || s !== 37)); ) {
    ...
    s !== 0 && Ds(e), Rt.call(tl, n) ? tl[n](e, n, i) : wi(e, 'unknown document directive "' + n + '"');
  }
...
Is.loadAll = my;
Is.load = gy;
var cf = {}, Ni = Je, gn = mn, yy = Rs, uf = Object.prototype.toString, ff = Object.prototype.hasOwnProperty, Ps = 65279, wy = 9, en = 10, xy = 13, Ey = 32, vy = 33, Ty = 34, Ka = 35, _y = 37, by = 38, Sy = 39, Ay = 42, df = 44, Iy = 45, xi = 58, Cy = 61, Ry = 62, Dy = 63, Oy = 64, pf = 91, hf = 93, Py = 96, mf = 123, ky = 124, gf = 125, Re = {};
Re[0] = "\\0";
Re[7] = "\\a";
Re[8] = "\\b";
Re[9] = "\\t";
...
function il(e, t) {
  for (var r = Ni.repeat(" ", t), n = 0, i = -1, a = "", s, o = e.length; n < o; )
    i = e.indexOf(`
...
function jy(e) {
  return rn(e) && e !== Ps && !Ei(e) && e !== Iy && e !== Dy && e !== xi && e !== df && e !== pf && e !== hf && e !== mf && e !== gf && e !== Ka && e !== by && e !== Ay && e !== vy && e !== ky && e !== Cy && e !== Ry && e !== Sy && e !== Ty && e !== _y && e !== Oy && e !== Py;
}
function Gy(e) {
  return !Ei(e) && e !== xi;
}
...
function zy(e, t, r, n, i, a, s, o) {
  var l, d = 0, c = null, u = !1, p = !1, g = n !== -1, w = -1, x = jy(Gr(e, 0)) && Gy(Gr(e, e.length - 1));
  if (t || s)
  ...
  return !u && !p ? x && !s && !i(e) ? wf : a === tn ? dr : Qa : r > 9 && yf(e) ? dr : s ? a === tn ? dr : Qa : p ? Ef : xf;
}
...
const jn = Li, { MAX_LENGTH: pl, MAX_SAFE_INTEGER: Gn } = $i, { safeRe: zn, t: Hn } = yn, uw = Ns, { compareIdentifiers: Ea } = bf;
let fw = class it {
  constructor(t, r) {
    if (r = uw(r), t instanceof it) {
  ...
  compare(t) {
    if (jn("SemVer.compare", this.version, this.options, t), !(t instanceof it)) {
...
var Fs = Gw;
const zw = Fs, Hw = (e, t) => e.sort((r, n) => zw(r, n, t));
var qw = Hw;
...
var Ls = ix;
const ax = Qe, sx = (e, t, r) => ax(e, t, r) <= 0;
var Us = sx;
const ox = Sf, lx = Af, cx = Ui, ux = Ls, fx = $s, dx = Us, px = (e, t, r, n) => {
  switch (t) {
    case "===":
...
function Ze() {
  ...
  va = t;
  const r = xx, n = new r(), i = Ns, a = Mi(), s = Li, o = Ue, {
    safeRe: l,
    t: d,
    comparatorTrimReplace: c,
    tildeTrimReplace: u,
    caretTrimReplace: p
  } = yn, { FLAG_INCLUDE_PRERELEASE: g, FLAG_LOOSE: w } = $i, x = (R) => R.value === "<0.0.0-0", T = (R) => R.value === "", b = (R, I) => {
    let P = !0;
    const S = R.slice();
    let $ = S.pop();
    for (; P && S.length; )
...
function Mi() {
  ...
  Ta = t;
  const r = Ns, { safeRe: n, t: i } = yn, a = If, s = Li, o = Ue, l = Ze();
  return Ta;
}
...
var Ux = Lx;
const Mx = Ue, Cf = Mi(), { ANY: Bx } = Cf, jx = Ze(), Gx = Bi, Tl = Ui, _l = $s, zx = Us, Hx = Ls, qx = (e, t, r, n) => {
  ...
  for (let d = 0; d < t.set.length; ++d) {
    ...
    let u = null, p = null;
    if (c.forEach((g) => {
      g.semver === Bx && (g = new Cf(">=0.0.0")), u = u || g, p = p || g, i(g.semver, u.semver, n) ? u = g : s(g.semver, p.semver, n) && (p = g);
...
const Sl = Ze(), Bs = Mi(), { ANY: ba } = Bs, Ur = Bi, js = Qe, nE = (e, t, r = {}) => {
  if (e === t)
    return !0;
...
var sE = nE;
const Sa = yn, Rl = $i, oE = Ue, Dl = bf, lE = Rr, cE = mw, uE = ww, fE = Ew, dE = Tw, pE = Sw, hE = Cw, mE = Ow, gE = Nw, yE = Qe, wE = Uw, xE = jw, EE = Fs, vE = qw, TE = Vw, _E = Ui, bE = $s, SE = Sf, AE = Af, IE = Ls, CE = Us, RE = If, DE = yx, OE = Mi(), PE = Ze(), kE = Bi, NE = bx, FE = Cx, $E = Px, LE = Fx, UE = Ux, ME = Ms, BE = Vx, jE = Jx, GE = Zx, zE = rE, HE = sE;
var Rf = {
  parse: lE,
  valid: cE,
  clean: uE,
...
(function(e, t) {
  ...
  var md = Array.prototype, gd = Function.prototype, An = Object.prototype, ea = f["__core-js_shared__"], Js = gd.toString, tt = An.hasOwnProperty, Qs = function() {
    var m = /[^.]+$/.exec(ea && ea.keys && ea.keys.IE_PROTO || "");
    return m ? "Symbol(src)_1." + m : "";
  }(), Zs = An.toString, yd = RegExp(
    "^" + Js.call(tt).replace(X, "\\$&").replace(/hasOwnProperty|(function).*?(?=\\\()| for .+?(?=\\\])/g, "$1.*?") + "$"
  ), eo = Z ? f.Buffer : void 0, In = f.Symbol, to = f.Uint8Array, ro = An.propertyIsEnumerable, wd = md.splice, Ft = In ? In.toStringTag : void 0, no = Object.getOwnPropertySymbols, xd = eo ? eo.isBuffer : void 0, Ed = pd(Object.keys, Object), ta = nr(f, "DataView"), Pr = nr(f, "Map"), ra = nr(f, "Promise"), na = nr(f, "Set"), ia = nr(f, "WeakMap"), kr = nr(Object, "create"), vd = Ut(ta), Td = Ut(Pr), _d = Ut(ra), bd = Ut(na), Sd = Ut(ia), io = In ? In.prototype : void 0, aa = io ? io.valueOf : void 0;
  function $t(m) {
  ...
  function Vd(m, E) {
    var C = On(m), L = !C && cp(m), se = !C && !L && sa(m), V = !C && !L && !se && ho(m), fe = C || L || se || V, ye = fe ? We(m.length, String) : [], Te = ye.length;
    for (var oe in m)
  ...
  function so(m, E, C, L, se) {
    return m === E ? !0 : m == null || E == null || !Fr(m) && !Fr(E) ? m !== m && E !== E : Kd(m, E, C, L, so, se);
  }
  function Kd(m, E, C, L, se, V) {
    var fe = On(m), ye = On(E), Te = fe ? l : yt(m), oe = ye ? l : yt(E);
    ...
    if (Ae && !je)
      return V || (V = new gt()), fe || ho(m) ? oo(m, E, C, L, se, V) : ep(m, E, Te, C, L, se, V);
    if (!(C & i)) {
      var He = je && tt.call(m, "__wrapped__"), qe = Ve && tt.call(E, "__wrapped__");
      if (He || qe) {
        var wt = He ? m.value() : m, ct = qe ? E.value() : E;
        return V || (V = new gt()), se(wt, ct, C, L, V);
      }
    }
  ...
  function oo(m, E, C, L, se, V) {
    ...
    for (V.set(m, E), V.set(E, m); ++je < ye; ) {
      var He = m[je], qe = E[je];
      if (L)
        var wt = fe ? L(qe, He, je, E, m, V) : L(He, qe, je, m, E, V);
      if (wt !== void 0) {
        if (wt)
          continue;
        Ve = !1;
      ...
      if (Ae) {
        if (!he(E, function(ct, Mt) {
          if (!bn(Ae, Mt) && (He === ct || se(He, ct, C, L, V)))
            return Ae.push(Mt);
        })) {
          Ve = !1;
          break;
  ...
  function tp(m, E, C, L, se, V) {
    var fe = C & i, ye = lo(m), Te = ye.length, oe = lo(E), je = oe.length;
    if (Te != je && !fe)
      return !1;
    for (var Ve = Te; Ve--; ) {
      var Ae = ye[Ve];
    ...
    for (var wt = fe; ++Ve < Te; ) {
      ...
      var ct = m[Ae], Mt = E[Ae];
      if (L)
        var mo = fe ? L(Mt, ct, Ae, E, m, V) : L(ct, Mt, Ae, m, E, V);
      if (!(mo === void 0 ? ct === Mt || se(ct, Mt, C, L, V) : mo)) {
        qe = !1;
        break;
      }
  ...
  var np = no ? function(m) {
    return m == null ? [] : (m = Object(m), Se(no(m), function(E) {
      return ro.call(m, E);
    }));
  } : pp, yt = Nr;
  (ta && yt(new ta(new ArrayBuffer(1))) != M || Pr && yt(new Pr()) != x || ra && yt(ra.resolve()) != F || na && yt(new na()) != H || ia && yt(new ia()) != j) && (yt = function(m) {
  ...
  var cp = ao(/* @__PURE__ */ function() {
    ...
    return Fr(m) && tt.call(m, "callee") && !ro.call(m, "callee");
  }, On = Array.isArray;
  function up(m) {
...
const XE = fn, WE = Pt, Ol = qE, zt = kt, Wr = ce;
class VE {
  constructor(t) {
...
function yv(e, t, r) {
  ...
  return [ts(`${e.pathname.replace(new RegExp(hv(r), "g"), t)}.blockmap`, e), n];
}
var me = {};
...
const ft = Ee, mr = Rf, Sv = Sr, gr = Xe, rs = me, Oa = /\/tag\/([^/]+)$/;
class Nf extends rs.Provider {
  constructor(t, r, n) {
    super({
      ...n,
...
${o}`, "ERR_UPDATER_INVALID_RELEASE_FEED");
    ...
    try {
      let T = this.channel;
      this.updater.allowPrerelease && (!((i = mr.prerelease(c)) === null || i === void 0) && i[0]) && (T = this.getCustomChannelName(String((a = mr.prerelease(c)) === null || a === void 0 ? void 0 : a[0]))), u = await w(T);
    } catch (T) {
      if (this.updater.allowPrerelease)
    ...
    const x = (0, rs.parseUpdateInfo)(u, p, g);
...
const or = Ee, Cv = be, Rv = ce, jl = Sr, Gl = Xe, Dv = Ot, Ov = me;
...
Wi.checkIsRangesSupported = is;
const ns = Ee, Wl = Dr, Vl = rr;
    ...
    await new Promise((s, o) => {
      ...
      T.redirect = "manual", g = (b) => {
        ...
        H.on("redirect", (q, te, y) => {
          this.logger.info(`Redirect to ${eT(y)}`), x = y, (0, Mr.configureRequestUrl)(new Jv.URL(x), T), H.followRedirect();
...
const De = Ee, nT = fn, iT = Ai, aT = Cc, lr = kt, sT = be, Fa = Fi, Bt = ce, Ht = Rf, Jl = wn, oT = ji, Ql = Df, lT = xn, $a = Gi, cT = Dc, uT = Xe, fT = Xi, cr = Nt;
class zs extends aT.EventEmitter {
  /**
...
const ec = Ee, tc = Si, xT = kt, ET = Pt, Br = ce, vT = ht, TT = vn, _T = me, rc = Nt;
...
const sc = Ee, La = kt, NT = Pt, oc = ce, FT = Tp, $T = It, LT = me, lc = Si, cc = fn;
class UT extends $T.AppUpdater {
  ...
  async doDownloadUpdate(t) {
    ...
    return this.executeDownload({
      ...
      downloadUpdateOptions: t,
      task: async (u, p) => {
        const g = oc.join(this.downloadedUpdateHelper.cacheDir, c), w = () => (0, La.pathExistsSync)(g) ? !t.disableDifferentialDownload : (n.info("Unable to locate previous update.zip for differential download (is this first install?), falling back to full download"), !1);
        let x = !0;
        ...
        if (c.Status === 0) {
          try {
            ...
            if (r.info(`LiteralPath: ${w}. Update Path: ${x}`), w !== x) {
              Ua(r, new Error(`LiteralPath of ${w} is different than ${x}`), l, i), n(null);
              return;
            }
          } catch (w) {
...
const Kn = Ee, dc = ce, zT = ht, HT = vn, pc = Nt, qT = me, XT = kt, WT = Hs, hc = Sr;
...
(function(e) {
  ...
  function x() {
    if (process.platform === "win32")
      w = new cn.NsisUpdater();
    else if (process.platform === "darwin")
      w = new ln.MacUpdater();
    else {
      w = new nn.AppImageUpdater();
      try {
...
const rt = Cr("tokenizer:inflate"), Ma = 256 * 1024, N_ = Wf(wr.DataDescriptor), Jn = Wf(wr.EndOfCentralDirectory);
class Xs {
  constructor(t) {
  ...
  async readCentralDirectory() {
    ...
    if (r > 0) {
      ...
      for (let a = 0; a < n.nrOfEntriesOfSize; ++a) {
        ...
        s.filename = await this.tokenizer.readToken(new we(s.filenameLength, "utf-8")), await this.tokenizer.ignore(s.extraFieldLength), await this.tokenizer.ignore(s.fileCommentLength), i.push(s), rt(`Add central-directory file-entry: n=${a + 1}/${i.length}: filename=${i[a].filename}`);
      }
...
const Wb = {
  ...
  async load() {
    return (await import("./MpegParser-kCT9bbjR.js")).MpegParser;
  }
}, Vb = {
  parserType: "apev2",
  extensions: [".ape"],
  ...
  async load() {
    return (await import("./AsfParser-BgyZYrkg.js")).AsfParser;
  }
}, Kb = {
  parserType: "dsdiff",
  extensions: [".dff"],
  ...
  async load() {
    return (await import("./DsdiffParser-DZhWU_RB.js")).DsdiffParser;
  }
}, Jb = {
  parserType: "aiff",
  ...
  async load() {
    return (await import("./AiffParser-CroY5mYF.js")).AIFFParser;
  }
}, Qb = {
  parserType: "dsf",
  extensions: [".dsf"],
  mimeTypes: ["audio/dsf"],
  async load() {
    return (await import("./DsfParser-fV2MR7_P.js")).DsfParser;
  }
}, Zb = {
  parserType: "flac",
  extensions: [".flac"],
  ...
  async load() {
    return (await import("./FlacParser-Dv_q_WbC.js").then((e) => e.d)).FlacParser;
  }
}, eS = {
  parserType: "matroska",
  ...
  async load() {
    return (await import("./MatroskaParser-C4gkRkkT.js")).MatroskaParser;
  }
}, tS = {
  parserType: "mp4",
  ...
  async load() {
    return (await import("./MP4Parser-TW_I2-ay.js")).MP4Parser;
  }
}, rS = {
  parserType: "musepack",
  extensions: [".mpc"],
  ...
  async load() {
    return (await import("./MusepackParser-CEqvkKUG.js")).MusepackParser;
  }
}, nS = {
  parserType: "ogg",
  ...
  async load() {
    return (await import("./OggParser-mdzd10V1.js")).OggParser;
  }
}, iS = {
  parserType: "wavpack",
  extensions: [".wv", ".wvp"],
  ...
  async load() {
    return (await import("./WavPackParser-DnVTGHn8.js")).WavPackParser;
  }
}, aS = {
  parserType: "riff",
  ...
  async load() {
    return (await import("./WaveParser-7y3X-dJI.js")).WaveParser;
  }
...
const TS = /^[\x21-\x7e©][\x20-\x7e\x00()]{3}/, sd = {
  len: 4,
  get: (e, t) => {
    const r = Qi(e.subarray(t, t + sd.len), "latin1");
    if (!r.match(TS))
      ...
      switch (await this.tokenizer.ignore(1), n -= o.length + 1, a.flags.dataType) {
        ...
        case ei.binary:
          if (this.options.skipCovers)
            ...
            const d = Qi(l.subarray(0, s), "utf-8"), c = l.subarray(s + 1);
...
class OS {
  ...
  async playFile(t, r) {
    ...
    try {
      ...
      const a = this.currentConnection.state.status;
      if (console.log(`[DiscordBot] Connection state: ${a}`), a === "destroyed" || a === "disconnected")
        throw new Error(`Voice connection is ${a}. Cannot play audio.`);
      if (!r) {
      ...
      const { spawn: s } = await import("node:child_process"), o = [
        "-i",
        t,
        "-analyzeduration",
        "0",
      ...
      console.log(`[DiscordBot] Spawning FFmpeg: ${r} ${o.join(" ")}`);
      const l = s(r, o);
      let d = !1;
      l.on("error", (w) => {
        console.error("[DiscordBot] FFmpeg Spawn Error:", w);
      }), l.on("close", (w) => {
        console.log(`[DiscordBot] FFmpeg process exited with code ${w}`);
      }), (n = l.stderr) == null || n.on("data", (w) => {
        const x = w.toString();
        console.log(`[DiscordBot] FFmpeg: ${x}`);
      }), (i = l.stdout) == null || i.on("data", () => {
        d || (console.log("[DiscordBot] FFmpeg audio stream started"), d = !0);
      });
      const c = oa(l.stdout, {
        inputType: Ip.Raw,
        metadata: {
      ...
      console.log("[DiscordBot] Audio resource created, starting playback"), this.player.play(c);
      const u = () => {
        console.log("[DiscordBot] ✓ Audio player is now playing");
      }, p = () => {
        console.log("[DiscordBot] Audio player became idle");
      }, g = (w) => {
        console.error("[DiscordBot] Audio player error:", w);
      };
      this.player.removeAllListeners(ir.Playing), this.player.removeAllListeners(ir.Idle), this.player.removeAllListeners("error"), this.player.once(ir.Playing, u), this.player.once(ir.Idle, p), this.player.once("error", g);
    } catch (a) {
      throw console.error("[DiscordBot] Play File Error:", a), a;
    }
  }
...
let fs = cd("ffmpeg-static");
Ke.isPackaged && (fs = fs.replace("app.asar", "app.asar.unpacked"));
function PS(e) {
...
const ds = process.env.VITE_DEV_SERVER_URL, gA = Oe.join(process.env.APP_ROOT, "dist-electron"), fd = Oe.join(process.env.APP_ROOT, "dist");
process.env.VITE_PUBLIC = ds ? Oe.join(process.env.APP_ROOT, "public") : fd;
let ee;
function dd() {
  ee = new Ac({
    width: 1200,
  ...
  }), ds ? ee.loadURL(ds) : ee.loadFile(Oe.join(fd, "index.html"));
}
...
`).map((l) => {
    ...
    try {
      const o = await r(), l = ii(import.meta.url)("ffmpeg-static").replace("app.asar", "app.asar.unpacked");
