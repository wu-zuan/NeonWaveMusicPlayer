...
var oe = Dt, Op = _p, Dp = Sp, Pp = Ip, kn = us, ve, li;
typeof Symbol == "function" && typeof Symbol.for == "function" ? (ve = Symbol.for("graceful-fs.queue"), li = Symbol.for("graceful-fs.previous")) : (ve = "___graceful-fs.queue", li = "___graceful-fs.previous");
function kp() {
}
function Ic(e, t) {
...
function Lc(e, t, r, n, i) {
  Le.copyFile(t, r, (a) => a ? i(a) : n.preserveTimestamps ? eh(e.mode, t, r, i) : Ai(r, e.mode, i));
}
function eh(e, t, r, n) {
...
var Oh = ys;
ys.sync = qc;
const ui = Ne, Dh = ke.fromCallback, Xc = Oh;
function Ph(e, t) {
...
const Nh = ke.fromPromise, Wc = Zt, Vc = le, Yc = ot, Kc = Ii, _o = Nh(async function(t) {
  let r;
  try {
...
const Ci = ke, { stringify: lu, stripBom: cu } = xs;
...
var km = Pe;
const Nm = Ne, ja = le, Fm = gs.copy, du = Ii.remove, $m = ot.mkdirp, Lm = er.pathExists, Po = br;
function Um(e, t, r, n) {
...
var jm = Um;
const pu = Ne, za = le, zm = gs.copySync, hu = Ii.removeSync, Gm = ot.mkdirpSync, No = br;
function Hm(e, t, r) {
  r = r || {};
...
De.safeGetHeader = xr;
De.configureRequestOptions = di;
De.safeStringifyJson = pi;
    ...
    function X(h, f) {
      if (h.opt.xmlns) {
        ...
        for (var ie = 0, ce = h.attribList.length; ie < ce; ie++) {
          var we = h.attribList[ie], _e = we[0], ht = we[1], de = O(_e, !0), We = de.prefix, Ji = de.local, Tn = We === "" ? "" : S.ns[We] || "", Rr = {
            name: _e,
            value: ht,
            prefix: We,
            local: Ji,
...
function ey(e, t) {
  ...
  for (e.anchor !== null && (e.anchorMap[e.anchor] = o), b = e.input.charCodeAt(++e.position); b !== 0; ) {
    ...
    r ? b === 44 && L(e, "expected the node content, but found ','") : L(e, "missed comma between flow collection entries"), T = x = _ = null, u = p = !1, b === 63 && (d = e.input.charCodeAt(e.position + 1), Ue(d) && (u = p = !0, e.position++, fe(e, !0, t))), n = e.line, i = e.lineStart, a = e.position, Tr(e, t, hi, !1, !0), T = e.tag, x = e.result, fe(e, !0, t), b = e.input.charCodeAt(e.position), (p || e.line === n) && b === 58 && (u = !0, b = e.input.charCodeAt(++e.position), fe(e, !0, t), Tr(e, t, hi, !1, !0), _ = e.result), g ? dr(e, o, w, T, x, _, n, i, a) : u ? o.push(dr(e, null, w, T, x, _, n, i, a)) : o.push(x), fe(e, !0, t), b = e.input.charCodeAt(e.position), b === 44 ? (r = !0, b = e.input.charCodeAt(++e.position)) : r = !1;
  }
...
function ry(e, t, r) {
  ...
  for (e.anchor !== null && (e.anchorMap[e.anchor] = u), b = e.input.charCodeAt(e.position); b !== 0; ) {
    ...
    if ((e.line === a || e.lineIndent > t) && (T && (s = e.line, o = e.lineStart, l = e.position), Tr(e, t, mi, !0, i) && (T ? w = e.result : x = e.result), T || (dr(e, u, p, g, w, x, s, o, l), g = w = x = null), fe(e, !0, -1), b = e.input.charCodeAt(e.position)), (e.line === a || e.lineIndent > t) && b !== 0)
...
bs.loadAll = oy;
bs.load = ly;
var af = {}, Pi = Je, hn = pn, cy = As, sf = Object.prototype.toString, of = Object.prototype.hasOwnProperty, Rs = 65279, uy = 9, Qr = 10, fy = 13, dy = 32, py = 33, hy = 34, Va = 35, my = 37, gy = 38, yy = 39, xy = 42, lf = 44, wy = 45, yi = 58, Ey = 61, vy = 62, Ty = 63, _y = 64, cf = 91, uf = 93, by = 96, ff = 123, Sy = 124, df = 125, Ie = {};
Ie[0] = "\\0";
Ie[7] = "\\a";
Ie[8] = "\\b";
Ie[9] = "\\t";
...
var _f = aw;
const sw = $e, ow = Ir, { safeRe: Gn, t: Hn } = mn, lw = (e, t) => {
  if (e instanceof sw)
    return e;
...
function Ze() {
  ...
  wa = t;
  const r = fw, n = new r(), i = Ds, a = Li(), s = Fi, o = $e, {
    safeRe: l,
    t: d,
    comparatorTrimReplace: c,
    tildeTrimReplace: u,
    caretTrimReplace: p
  } = mn, { FLAG_INCLUDE_PRERELEASE: g, FLAG_LOOSE: w } = Ni, x = (R) => R.value === "<0.0.0-0", T = (R) => R.value === "", _ = (R, I) => {
    let P = !0;
    const A = R.slice();
    let F = A.pop();
    for (; P && A.length; )
...
function Li() {
  ...
  Ea = t;
  const r = Ds, { safeRe: n, t: i } = mn, a = _f, s = Fi, o = $e, l = Ze();
  return Ea;
}
...
var Ow = Rw;
const Dw = $e, bf = Li(), { ANY: Pw } = bf, kw = Ze(), Nw = Ui, yl = $i, xl = ks, Fw = Fs, $w = Ns, Lw = (e, t, r, n) => {
...
var Qw = Yw;
const _a = mn, bl = Ni, Zw = $e, Sl = Ef, eE = Ir, tE = ox, rE = ux, nE = dx, iE = hx, aE = yx, sE = Ex, oE = _x, lE = Ax, cE = Qe, uE = Ox, fE = kx, dE = Ps, pE = Lx, hE = Bx, mE = $i, gE = ks, yE = vf, xE = Tf, wE = Ns, EE = Fs, vE = _f, TE = cw, _E = Li(), bE = Ze(), SE = Ui, AE = gw, IE = Ew, CE = bw, RE = Iw, OE = Ow, DE = $s, PE = Bw, kE = Gw, NE = qw, FE = Vw, $E = Qw;
var Sf = {
  parse: eE,
  valid: tE,
  clean: rE,
...
(function(e, t) {
  ...
  function Hd(m, E) {
    var C = Rn(m), $ = !C && ap(m), ae = !C && !$ && ia(m), H = !C && !$ && !ae && uo(m), ue = C || $ || ae || H, me = ue ? We(m.length, String) : [], Ee = me.length;
    for (var se in m)
  ...
  (Zi && gt(new Zi(new ArrayBuffer(1))) != B || Or && gt(new Or()) != x || ea && gt(ea.resolve()) != N || ta && gt(new ta()) != ne || ra && gt(new ra()) != q) && (gt = function(m) {
  ...
  async doDownloadFile(t, r) {
    ...
    await new Promise((s, o) => {
      ...
      if (!this.options.isUseMultipleRangeRequest && this.options.onProgress) {
        ...
        let b = 0;
        for (const D of t)
          D.kind === Wn.OperationKind.DOWNLOAD && (_.push(D.end - D.start), b += D.end - D.start);
        const N = {
...
const Ce = xe, Yv = cn, Kv = bi, Jv = bc, sr = Pt, Qv = Te, ka = ki, Mt = le, Gt = Sf, Xl = gn, Zv = Mi, Wl = Af, eT = yn, Na = Bi, tT = Ac, rT = Xe, nT = Hi, or = kt;
...
`, { offset: 2, encoding: r }) ? {
  ...
  async readTiffHeader(t) {
    const r = (t ? qt : re).get(this.buffer, 2), n = (t ? Ei : W).get(this.buffer, 4);
    if (r === 42) {
      if (n >= 6) {
...
const Mb = {
  ...
  async load() {
    return (await import("./MpegParser-BArHT6U4.js")).MpegParser;
  }
}, Bb = {
  parserType: "apev2",
  extensions: [".ape"],
  ...
  async load() {
    return (await import("./AsfParser-BcdxTuhc.js")).AsfParser;
  }
}, zb = {
  parserType: "dsdiff",
  extensions: [".dff"],
  ...
  async load() {
    return (await import("./DsdiffParser-DYGJoQnz.js")).DsdiffParser;
  }
}, Gb = {
  parserType: "aiff",
  ...
  async load() {
    return (await import("./AiffParser-BwtXQ5F7.js")).AIFFParser;
  }
}, Hb = {
  parserType: "dsf",
  extensions: [".dsf"],
  mimeTypes: ["audio/dsf"],
  async load() {
    return (await import("./DsfParser-BmPJDyUx.js")).DsfParser;
  }
}, qb = {
  parserType: "flac",
  extensions: [".flac"],
  ...
  async load() {
    return (await import("./FlacParser-X0rthTrc.js").then((e) => e.d)).FlacParser;
  }
}, Xb = {
  parserType: "matroska",
  ...
  async load() {
    return (await import("./MatroskaParser-4qZTVzCA.js")).MatroskaParser;
  }
}, Wb = {
  parserType: "mp4",
  ...
  async load() {
    return (await import("./MP4Parser-DP3x3CS3.js")).MP4Parser;
  }
}, Vb = {
  parserType: "musepack",
  extensions: [".mpc"],
  ...
  async load() {
    return (await import("./MusepackParser-CMsEgEhe.js")).MusepackParser;
  }
}, Yb = {
  parserType: "ogg",
  ...
  async load() {
    return (await import("./OggParser-Dj9dmF0f.js")).OggParser;
  }
}, Kb = {
  parserType: "wavpack",
  extensions: [".wv", ".wvp"],
  ...
  async load() {
    return (await import("./WavPackParser-BNAirsRL.js")).WavPackParser;
  }
}, Jb = {
  parserType: "riff",
  ...
  async load() {
    return (await import("./WaveParser-Do3DTMbO.js")).WaveParser;
  }
  ...
  process.platform === "win32" && Ke.setAppUserModelId("NeonWave"), ld(), qe.handle("dialog:openDirectory", async () => {
    ...
    try {
      ...
      return (await Promise.all(i.map(async (o) => {
        const l = Re.join(n, o), d = Re.extname(o).toLowerCase();
