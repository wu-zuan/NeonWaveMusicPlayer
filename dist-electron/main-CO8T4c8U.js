...
import kn, { open as Ep } from "node:fs/promises";
import Dt from "fs";
...
import { createAudioPlayer as Ap, joinVoiceChannel as Cp, createAudioResource as Nn, StreamType as la } from "@discordjs/voice";
...
var ce = Dt, Mp = Dp, Bp = Np, jp = $p, Fn = ps, _e, ui;
...
function Mc(e, t, r, n, i) {
  ...
  Er.stat(s, { bigint: !0 }, (o, l) => o ? o.code === "ENOENT" ? i() : i(o) : fn(t, l) ? i(new Error(Ii(e, r, n))) : Mc(e, t, s, n, i));
}
function Bc(e, t, r, n) {
...
var wh = ah;
const Ie = $e, Yr = ue, xh = lt.mkdirsSync, Eh = Uc.utimesMillisSync, Kr = Sr;
function vh(e, t, r) {
...
const bo = $e, Vc = ue, ie = Ic, Jr = process.platform === "win32";
function Yc(e) {
  [
    "unlink",
    "chmod",
...
function Uh(e, t) {
  if (ie(e), ie(t), t.readdirSync(e).forEach((r) => Kc(Vc.join(e, r), t)), Jr) {
    const r = Date.now();
    do
      try {
...
const bt = ue, zr = $e, em = tr.pathExists;
function tm(e, t, r) {
  if (bt.isAbsolute(e))
...
const Rm = Fe.fromCallback, Hr = $e, mu = ue, gu = lt, Pm = tr.pathExists;
function Om(e, t, r, n) {
...
var ke = {}, Wa = { exports: {} }, Un = { exports: {} }, pa, Bo;
function c0() {
  if (Bo) return pa;
  Bo = 1;
...
const g0 = un, y0 = vu, w0 = Dt, x0 = cn, Tu = br, E0 = It, Xo = Ar, v0 = dn, Fr = (0, y0.default)("electron-builder");
...
const Cu = un, Iu = Ar, k0 = "options.name must be either a string or a Buffer", Wo = (0, Cu.randomBytes)(16);
Wo[0] = Wo[0] | 1;
const li = {}, Z = [];
for (let e = 0; e < 256; e++) {
...
Actual: ` + h.attribValue
    ...
    function K(h, f) {
      if (h.opt.xmlns) {
        ...
        C.ns && ee.ns !== C.ns && Object.keys(C.ns).forEach(function(bn) {
          L(h, "onopennamespace", {
            prefix: bn,
            uri: C.ns[bn]
          });
        ...
        for (var se = 0, fe = h.attribList.length; se < fe; se++) {
          var ve = h.attribList[se], Se = ve[0], mt = ve[1], he = P(Se, !0), Ye = he.prefix, ea = he.local, _n = Ye === "" ? "" : C.ns[Ye] || "", Pr = {
            name: Se,
            value: mt,
            prefix: Ye,
            local: ea,
          ...
          ), Pr.uri = Ye), h.tag.attributes[Se] = Pr, L(h, "onattribute", Pr);
        }
...
` ? (f.line++, f.column = 0) : f.column++);
    ...
    String.fromCodePoint || function() {
      var h = String.fromCharCode, f = Math.floor, C = function() {
        var v = 16384, ee = [], se, fe, ve = -1, Se = arguments.length;
        if (!Se)
          return "";
        for (var mt = ""; ++ve < Se; ) {
          ...
          he <= 65535 ? ee.push(he) : (he -= 65536, se = (he >> 10) + 55296, fe = he % 1024 + 56320, ee.push(se, fe)), (ve + 1 === Se || ee.length > v) && (mt += h.apply(null, ee), ee.length = 0);
        }
        return mt;
      };
...
Cs.loadAll = gy;
Cs.load = yy;
var uf = {}, Fi = Qe, mn = hn, wy = Rs, ff = Object.prototype.toString, df = Object.prototype.hasOwnProperty, Ds = 65279, xy = 9, Zr = 10, Ey = 13, vy = 32, Ty = 33, _y = 34, Ja = 35, by = 37, Sy = 38, Ay = 39, Cy = 42, pf = 44, Iy = 45, xi = 58, Ry = 61, Py = 62, Oy = 63, Dy = 64, hf = 91, mf = 93, ky = 96, gf = 123, Ny = 124, yf = 125, Pe = {};
Pe[0] = "\\0";
Pe[7] = "\\a";
Pe[8] = "\\b";
Pe[9] = "\\t";
...
function Gy(e) {
  return tn(e) && e !== Ds && !Ei(e) && e !== Iy && e !== Oy && e !== xi && e !== pf && e !== hf && e !== mf && e !== gf && e !== yf && e !== Ja && e !== Sy && e !== Cy && e !== Ty && e !== Ny && e !== Ry && e !== Py && e !== Ay && e !== _y && e !== by && e !== Dy && e !== ky;
}
function zy(e) {
  return !Ei(e) && e !== xi;
}
...
function Hy(e, t, r, n, i, a, s, o) {
  var l, d = 0, c = null, u = !1, p = !1, m = n !== -1, x = -1, w = Gy(jr(e, 0)) && zy(jr(e, e.length - 1));
  if (t || s)
...
function Wy(e) {
  for (var t = "", r = 0, n, i = 0; i < e.length; r >= 65536 ? i += 2 : i++)
    r = jr(e, i), n = Pe[r], !n && tn(r) ? (t += e[i], r >= 65536 && (t += e[i + 1])) : t += n || Uy(r);
  return t;
}
function Vy(e, t, r) {
  var n = "", i = e.tag, a, s, o;
...
be.safeLoad = ks("safeLoad", "load");
be.safeLoadAll = ks("safeLoadAll", "loadAll");
be.safeDump = ks("safeDump", "dump");
var $i = {};
...
const jn = Ui, { MAX_LENGTH: pl, MAX_SAFE_INTEGER: Gn } = Li, { safeRe: zn, t: Hn } = gn, fw = Ns, { compareIdentifiers: va } = Sf;
let dw = class at {
  constructor(t, r) {
...
var If = hx;
const mx = Ue, gx = Ir, { safeRe: qn, t: Xn } = gn, yx = (e, t) => {
  if (e instanceof mx)
    return e;
...
function et() {
  ...
  const r = Ex, n = new r(), i = Ns, a = Bi(), s = Ui, o = Ue, {
    ...
    tildeTrimReplace: u,
    caretTrimReplace: p
  } = gn, { FLAG_INCLUDE_PRERELEASE: m, FLAG_LOOSE: x } = Li, w = (R) => R.value === "<0.0.0-0", T = (R) => R.value === "", _ = (R, S) => {
    let O = !0;
    const A = R.slice();
    let $ = A.pop();
    for (; O && A.length; )
...
function Bi() {
  ...
  _a = t;
  const r = Ns, { safeRe: n, t: i } = gn, a = If, s = Ui, o = Ue, l = et();
  return _a;
}
...
var oE = iE;
const Aa = gn, Rl = Li, lE = Ue, Pl = Sf, cE = Ir, uE = gw, fE = xw, dE = vw, pE = _w, hE = Aw, mE = Rw, gE = Dw, yE = Fw, wE = Ze, xE = Mw, EE = Gw, vE = Fs, TE = Xw, _E = Yw, bE = Mi, SE = $s, AE = Af, CE = Cf, IE = Ls, RE = Us, PE = If, OE = wx, DE = Bi(), kE = et(), NE = ji, FE = Sx, $E = Rx, LE = kx, UE = $x, ME = Mx, BE = Ms, jE = Yx, GE = Qx, zE = eE, HE = nE, qE = oE;
var Pf = {
  parse: cE,
  valid: uE,
  clean: fE,
...
(function(e, t) {
  ...
  ), eo = ee ? f.Buffer : void 0, An = f.Symbol, to = f.Uint8Array, ro = Sn.propertyIsEnumerable, xd = gd.splice, Ft = An ? An.toStringTag : void 0, no = Object.getOwnPropertySymbols, Ed = eo ? eo.isBuffer : void 0, vd = hd(Object.keys, Object), ra = nr(f, "DataView"), Or = nr(f, "Map"), na = nr(f, "Promise"), ia = nr(f, "Set"), aa = nr(f, "WeakMap"), Dr = nr(Object, "create"), Td = Ut(ra), _d = Ut(Or), bd = Ut(na), Sd = Ut(ia), Ad = Ut(aa), io = An ? An.prototype : void 0, sa = io ? io.valueOf : void 0;
  function $t(g) {
  ...
  function Fd(g) {
    return In(this.__data__, g) > -1;
  }
  function $d(g, E) {
    var I = this.__data__, j = In(I, g);
  ...
  Cn.prototype.add = Cn.prototype.push = Gd, Cn.prototype.has = zd;
  function gt(g) {
  ...
  function Yd(g, E) {
    var I = Pn(g), j = !I && up(g), oe = !I && !j && oa(g), Y = !I && !j && !oe && ho(g), de = I || j || oe || Y, ye = de ? Ye(g.length, String) : [], Te = ye.length;
    for (var le in g)
  ...
  function Jd(g, E, I, j, oe, Y) {
    ...
    return Ae ? (Y || (Y = new gt()), rp(g, E, I, j, oe, Y)) : !1;
  }
  function Qd(g) {
    if (!po(g) || op(g))
      return !1;
  ...
  function oo(g, E, I, j, oe, Y) {
    ...
    if (le && Y.get(E))
      return le == E;
    var je = -1, Ke = !0, Ae = I & a ? new Cn() : void 0;
    for (Y.set(g, E), Y.set(E, g); ++je < ye; ) {
      ...
      if (Ae) {
        if (!he(E, function(ut, Mt) {
          if (!_n(Ae, Mt) && (He === ut || oe(He, ut, I, j, Y)))
            return Ae.push(Mt);
        })) {
          Ke = !1;
          break;
  ...
  function rp(g, E, I, j, oe, Y) {
    ...
    for (var wt = de; ++Ke < Te; ) {
      ...
      var ut = g[Ae], Mt = E[Ae];
      if (j)
        var mo = de ? j(Mt, ut, Ae, E, g, Y) : j(ut, Mt, Ae, g, E, Y);
    ...
    if (qe && !wt) {
      var On = g.constructor, Dn = E.constructor;
      On != Dn && "constructor" in g && "constructor" in E && !(typeof On == "function" && On instanceof On && typeof Dn == "function" && Dn instanceof Dn) && (qe = !1);
    }
  ...
  var ip = no ? function(g) {
    return g == null ? [] : (g = Object(g), Se(no(g), function(E) {
      return ro.call(g, E);
    }));
  } : hp, yt = kr;
  ...
  function lp(g) {
    var E = g && g.constructor, I = typeof E == "function" && E.prototype || Sn;
    return g === I;
  }
  function cp(g) {
    return Zs.call(g);
...
const WE = un, VE = Dt, Ol = XE, zt = kt, Xr = ue;
class YE {
  constructor(t) {
...
var wn = {}, Ve = {}, rv = "[object Symbol]", Df = /[\\^$.*+?()[\]{}|]/g, nv = RegExp(Df.source), iv = typeof De == "object" && De && De.Object === Object && De, av = typeof self == "object" && self && self.Object === Object && self, sv = iv || av || Function("return this")(), ov = Object.prototype, lv = ov.toString, kl = sv.Symbol, Nl = kl ? kl.prototype : void 0, Fl = Nl ? Nl.toString : void 0;
function cv(e) {
  if (typeof e == "string")
    return e;
  if (fv(e))
...
const sr = Ee, Rv = be, Pv = ue, jl = br, Gl = Ve, Ov = Ot, Dv = me;
...
zi.createClient = Uv;
const Wn = Ee, Nv = Hi, zl = wn, Fv = Ot, $v = qi, Lv = Xi;
function Lf(e) {
...
Rr.copyData = Uf;
const Vn = Ee, Gv = Dt, zv = cn, Hv = rr, Xl = Buffer.from(`\r
\r
`);
var vt;
(function(e) {
...
const Ur = Ee, Fa = kt, Kv = Dt, Jv = Rr, Qv = br, Yn = rr, Yl = Vi, Zv = Yi;
class eT {
  ...
  async doDownloadFile(t, r) {
    ...
    await new Promise((s, o) => {
      ...
      if (!this.options.isUseMultipleRangeRequest && this.options.onProgress) {
        ...
        let b = 0;
        for (const F of t)
          F.kind === Yn.OperationKind.DOWNLOAD && (_.push(F.end - F.start), b += F.end - F.start);
        const k = {
      ...
      T.redirect = "manual", m = (_) => {
        ...
        const F = t[_++];
        if (F.kind === Yn.OperationKind.COPY) {
...
const Oe = Ee, iT = un, aT = Ci, sT = Rc, or = kt, oT = be, $a = $i, Bt = ue, Ht = Pf, Jl = yn, lT = Gi, Ql = Of, cT = wn, La = zi, uT = Oc, fT = Ve, dT = Wi, lr = Nt;
...
const ec = Ee, tc = Ai, ET = kt, vT = Dt, Mr = ue, TT = ht, _T = En, bT = me, rc = Nt;
...
const sc = Ee, Ua = kt, FT = Dt, oc = ue, $T = _p, LT = Ct, UT = me, lc = Ai, cc = un;
...
const Kn = Ee, dc = ue, HT = ht, qT = En, pc = Nt, XT = me, WT = kt, VT = Hs, hc = br;
...
(function(e) {
  ...
  function w() {
    if (process.platform === "win32")
      x = new ln.NsisUpdater();
    else if (process.platform === "darwin")
      x = new on.MacUpdater();
    else {
      x = new rn.AppImageUpdater();
      try {
...
const nt = Cr("tokenizer:inflate"), Ba = 256 * 1024, F_ = Vf(yr.DataDescriptor), Jn = Vf(yr.EndOfCentralDirectory);
class Xs {
  constructor(t) {
...
const Vb = {
  ...
  async load() {
    return (await import("./MpegParser-BuPTWyPI.js")).MpegParser;
  }
}, Yb = {
  parserType: "apev2",
  extensions: [".ape"],
  ...
  async load() {
    return (await import("./AsfParser-Db5ddJUp.js")).AsfParser;
  }
}, Jb = {
  parserType: "dsdiff",
  extensions: [".dff"],
  ...
  async load() {
    return (await import("./DsdiffParser-DU_ESvq6.js")).DsdiffParser;
  }
}, Qb = {
  parserType: "aiff",
  ...
  async load() {
    return (await import("./AiffParser-B9z3yQoi.js")).AIFFParser;
  }
}, Zb = {
  parserType: "dsf",
  extensions: [".dsf"],
  mimeTypes: ["audio/dsf"],
  async load() {
    return (await import("./DsfParser-QQ3s5m1b.js")).DsfParser;
  }
}, eS = {
  parserType: "flac",
  extensions: [".flac"],
  ...
  async load() {
    return (await import("./FlacParser-BOMNdcXX.js").then((e) => e.d)).FlacParser;
  }
}, tS = {
  parserType: "matroska",
  ...
  async load() {
    return (await import("./MatroskaParser-B54OOHBm.js")).MatroskaParser;
  }
}, rS = {
  parserType: "mp4",
  ...
  async load() {
    return (await import("./MP4Parser-Diovw2OC.js")).MP4Parser;
  }
}, nS = {
  parserType: "musepack",
  extensions: [".mpc"],
  ...
  async load() {
    return (await import("./MusepackParser-DBvGbo3C.js")).MusepackParser;
  }
}, iS = {
  parserType: "ogg",
  ...
  async load() {
    return (await import("./OggParser-Cpu6vj9p.js")).OggParser;
  }
}, aS = {
  parserType: "wavpack",
  extensions: [".wv", ".wvp"],
  ...
  async load() {
    return (await import("./WavPackParser-CkBzURn4.js")).WavPackParser;
  }
}, sS = {
  parserType: "riff",
  ...
  async load() {
    return (await import("./WaveParser-CQCmyi_U.js")).WaveParser;
  }
...
const fd = Ce.dirname(xp(import.meta.url));
process.env.APP_ROOT = Ce.join(fd, "..");
const ds = process.env.VITE_DEV_SERVER_URL, yA = Ce.join(process.env.APP_ROOT, "dist-electron"), dd = Ce.join(process.env.APP_ROOT, "dist");
process.env.VITE_PUBLIC = ds ? Ce.join(process.env.APP_ROOT, "public") : dd;
let te;
function pd() {
  te = new Cc({
    width: 1200,
    ...
    minWidth: 800,
    minHeight: 600,
    icon: Ce.join(process.env.VITE_PUBLIC, "logo.png"),
    ...
    webPreferences: {
      preload: Ce.join(fd, "preload.mjs"),
      webSecurity: !1,
  ...
  }), ds ? te.loadURL(ds) : te.loadFile(Ce.join(dd, "index.html"));
}
...
We.whenReady().then(() => {
  ...
  re.handle("discord:login", async (i, a) => await e.login(a)), re.handle("discord:getGuilds", () => e.getGuilds()), re.handle("discord:getChannels", (i, a) => e.getChannels(a)), re.handle("discord:join", async (i, a, s) => await e.joinChannel(a, s)), re.handle("discord:leave", async () => await e.leaveChannel()), re.handle("discord:disconnect", async () => await e.disconnect()), re.handle("discord:play", async (i, a) => await e.playFile(a, Si)), re.handle("discord:stop", () => e.stop()), re.handle("discord:pause", () => e.pause()), re.handle("discord:resume", () => e.resume()), re.handle("discord:setVolume", (i, a) => e.setVolume(a)), re.handle("discord:status", () => e.getStatus()), re.handle("discord:startStreamMode", async () => await e.playReceiverStream(Si)), re.on("discord:audio-chunk", (i, a) => {
    ...
    if (!a) return [];
    try {
      const s = await kn.readdir(a), o = [".mp3", ".wav", ".wma", ".m4a", ".flac", ".ogg", ".mp4", ".mov", ".wmv", ".avi"];
      return (await Promise.all(s.map(async (d) => {
        const c = Ce.join(a, d), u = Ce.extname(d).toLowerCase();
        if (!o.includes(u)) return null;
        try {
          const p = await kn.stat(c);
          return {
            fullPath: c,
    ...
    const i = Ce.join(process.env.APP_ROOT, "scripts/get-active-window.ps1");
    return await DS(i);
  });
  const t = ii(import.meta.url)("yt-dlp-wrap").default, r = async () => {
    const i = process.platform === "win32" ? "yt-dlp.exe" : "yt-dlp", a = Ce.join(We.getPath("userData"), i);
    try {
      const s = new t(a);
...
`), U = [], D = /\[(\d{2}):(\d{2}\.\d{2})\]\s*(.*)/;
    ...
    try {
      ...
      if (o) {
        let U = Ce.basename(o, Ce.extname(o));
        const D = U.match(/(.+?)《(.+?)》(.*)/);
        if (D) {
