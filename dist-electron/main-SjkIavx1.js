...
const $b = {
  ...
  async load() {
    return (await import("./MpegParser-Pp0iWNX5.js")).MpegParser;
  }
}, Lb = {
  parserType: "apev2",
  extensions: [".ape"],
  ...
  async load() {
    return (await import("./AsfParser-CJia0GSh.js")).AsfParser;
  }
}, Mb = {
  parserType: "dsdiff",
  extensions: [".dff"],
  ...
  async load() {
    return (await import("./DsdiffParser-D9QE-sS0.js")).DsdiffParser;
  }
}, Bb = {
  parserType: "aiff",
  ...
  async load() {
    return (await import("./AiffParser-DhnBluCv.js")).AIFFParser;
  }
}, zb = {
  parserType: "dsf",
  extensions: [".dsf"],
  mimeTypes: ["audio/dsf"],
  async load() {
    return (await import("./DsfParser-BHsPrcw3.js")).DsfParser;
  }
}, jb = {
  parserType: "flac",
  extensions: [".flac"],
  ...
  async load() {
    return (await import("./FlacParser-BjyjRKcF.js").then((e) => e.d)).FlacParser;
  }
}, Gb = {
  parserType: "matroska",
  ...
  async load() {
    return (await import("./MatroskaParser-vD-C40il.js")).MatroskaParser;
  }
}, Hb = {
  parserType: "mp4",
  ...
  async load() {
    return (await import("./MP4Parser-qfvXgjVp.js")).MP4Parser;
  }
}, qb = {
  parserType: "musepack",
  extensions: [".mpc"],
  ...
  async load() {
    return (await import("./MusepackParser-Da4kz1R8.js")).MusepackParser;
  }
}, Xb = {
  parserType: "ogg",
  ...
  async load() {
    return (await import("./OggParser-mpd0KL6j.js")).OggParser;
  }
}, Wb = {
  parserType: "wavpack",
  extensions: [".wv", ".wvp"],
  ...
  async load() {
    return (await import("./WavPackParser-BCnv3H0K.js")).WavPackParser;
  }
}, Vb = {
  parserType: "riff",
  ...
  async load() {
    return (await import("./WaveParser-B-dR7Gne.js")).WaveParser;
  }
...
St.whenReady().then(() => {
  sd(), He.handle("dialog:openDirectory", async () => {
    ...
    try {
      ...
      const { filePath: a } = await uo.showSaveDialog(J, {
        title: "下載歌曲",
        defaultPath: `${r.replace(/[\\/:*?"<>|]/g, "_")}.mp3`,
        filters: [{ name: "Audio", extensions: ["mp3"] }]
      });
      return a ? new Promise((s, o) => {
        const l = i(t, { quality: "highestaudio", filter: "audioonly" });
        l.on("error", (d) => {
          console.error("YTDL Stream Error:", d), o(d);
        }), import("node:fs").then((d) => {
          const c = d.createWriteStream(a);
          l.pipe(c), c.on("finish", () => s(a)), c.on("error", (f) => {
            console.error("File Write Error:", f), o(f);
          });
        });
      }) : null;
    } catch (n) {
