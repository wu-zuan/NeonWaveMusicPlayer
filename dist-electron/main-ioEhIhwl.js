...
import Jt, { app as Je, BrowserWindow as Ic, Notification as wp, ipcMain as se, dialog as ys } from "electron";
...
import { Client as Sp, GatewayIntentBits as ws, ChannelType as xs } from "discord.js";
...
var xt = vp, Dp = process.cwd, oi = null, Op = process.env.GRACEFUL_FS_PLATFORM || process.platform;
process.cwd = function() {
  return oi || (oi = Dp.call(process)), oi;
};
try {
  process.cwd();
} catch {
...
if (typeof process.chdir == "function") {
  var Es = process.chdir;
  process.chdir = function(e) {
    oi = null, Es.call(process, e);
  }, Object.setPrototypeOf && Object.setPrototypeOf(process.chdir, Es);
}
var Pp = kp;
function kp(e) {
...
var ce = Pt, Mp = Pp, Bp = Np, jp = $p, $n = mo, _e, fi;
  ...
  Pc(ce, Gp), ce.close = function(e) {
    function t(r, n) {
      return e.call(ce, r, function(i) {
        i || Ts(), typeof n == "function" && n.apply(this, arguments);
      });
    }
...
Pe[_e] || Pc(Pe, ce[_e]);
var $e = go(jp(ce));
process.env.TEST_GRACEFUL_FS_GLOBAL_PATCH && !ce.__patched && ($e = go(ce), ce.__patched = !0);
function go(e) {
  Mp(e), e.gracefulify = go, e.createReadStream = k, e.createWriteStream = H;
  var t = e.readFile;
  e.readFile = r;
  function r(y, j, U) {
...
function ar(e) {
  Vt("ENQUEUE", e[0].name, e[1]), ce[_e].push(e), yo();
}
var Ln;
function Ts() {
...
wo.makeDir = async (e, t) => (Fc(e), Nc.mkdir(e, {
  mode: $c(t),
  recursive: !0
}));
wo.makeDirSync = (e, t) => (Fc(e), Nc.mkdirSync(e, {
  mode: $c(t),
  recursive: !0
}));
const qp = Fe.fromPromise, { makeDir: Xp, makeDirSync: ua } = wo, fa = qp(Xp);
var lt = {
  mkdirs: fa,
  mkdirsSync: ua,
  // alias
...
function eh(e, t, r, n, i) {
  Jp.callbackify(Qp)(e, t, n, (a, o) => {
    ...
    return s.isDirectory() && xo(e, t) ? i(new Error(Ri(e, t, r))) : i(null, { srcStat: s, destStat: l });
  });
}
function th(e, t, r, n) {
...
function Mc(e, t, r, n, i) {
  ...
  vr.stat(o, { bigint: !0 }, (s, l) => s ? s.code === "ENOENT" ? i() : i(s) : pn(t, l) ? i(new Error(Ri(e, r, n))) : Mc(e, t, o, n, i));
}
function Bc(e, t, r, n) {
...
function ah(e, t, r, n) {
  typeof r == "function" && !n ? (n = r, r = {}) : typeof r == "function" && (r = { filter: r }), n = n || function() {
    ...
    Kr.checkParentPaths(e, o, t, "copy", (l) => l ? n(l) : r.filter ? jc(_s, s, e, t, r, n) : _s(s, e, t, r, n));
  });
}
...
function di(e, t, r, n, i) {
  (n.dereference ? Me.stat : Me.lstat)(t, (o, s) => o ? i(o) : s.isDirectory() ? ph(s, e, t, r, n, i) : s.isFile() || s.isCharacterDevice() || s.isBlockDevice() ? sh(s, e, t, r, n, i) : s.isSymbolicLink() ? gh(e, t, r, n, i) : s.isSocket() ? i(new Error(`Cannot copy a socket file: ${t}`)) : s.isFIFO() ? i(new Error(`Cannot copy a FIFO pipe: ${t}`)) : i(new Error(`Unknown file: ${t}`)));
}
...
function ch(e, t, r, n) {
  return uh(e) ? fh(r, e, (i) => i ? n(i) : bs(e, t, r, n)) : bs(e, t, r, n);
}
function uh(e) {
  return (e & 128) === 0;
}
...
function mh(e, t, r, n, i, a) {
  const o = Yr.join(r, t), s = Yr.join(n, t);
  Kr.checkPaths(o, s, "copy", i, (l, d) => {
    if (l) return a(l);
    const { destStat: c } = d;
    oh(c, o, s, i, (u) => u ? a(u) : Hc(e, r, n, i, a));
  });
}
function gh(e, t, r, n, i) {
  Me.readlink(t, (a, o) => {
    if (a) return i(a);
    if (n.dereference && (o = Yr.resolve(process.cwd(), o)), e)
      Me.readlink(r, (s, l) => s ? s.code === "EINVAL" || s.code === "UNKNOWN" ? Me.symlink(o, r, i) : i(s) : (n.dereference && (l = Yr.resolve(process.cwd(), l)), Kr.isSrcSubdir(o, l) ? i(new Error(`Cannot copy '${o}' to a subdirectory of itself, '${l}'.`)) : e.isDirectory() && Kr.isSrcSubdir(l, o) ? i(new Error(`Cannot overwrite '${l}' with '${o}'.`)) : yh(o, r, i)));
    else
...
function Xc(e, t, r, n) {
  return Ie.copyFileSync(t, r), n.preserveTimestamps && Ah(e.mode, t, r), Eo(r, e.mode);
}
function Ah(e, t, r) {
...
function Oh(e, t, r, n) {
  return Ie.mkdirSync(r), Wc(t, r, n), Eo(r, e);
}
function Wc(e, t, r) {
  Ie.readdirSync(e).forEach((n) => Ph(n, e, t, r));
}
function Ph(e, t, r, n) {
  const i = Jr.join(t, e), a = Jr.join(r, e), { destStat: o } = Qr.checkPathsSync(i, a, "copy", n);
  return _h(o, i, a, n);
}
function kh(e, t, r, n) {
...
const Ss = $e, Vc = ue, ne = Cc, Zr = process.platform === "win32";
function Yc(e) {
  [
    "unlink",
    "chmod",
    ...
    e[r] = e[r] || Ss[r], r = r + "Sync", e[r] = e[r] || Ss[r];
  }), e.maxBusyTries = e.maxBusyTries || 3;
}
function To(e, t, r) {
  let n = 0;
  typeof t == "function" && (r = t, t = {}), ne(e, "rimraf: missing path"), ne.strictEqual(typeof e, "string", "rimraf: path should be a string"), ne.strictEqual(typeof r, "function", "rimraf: callback function required"), ne(t, "rimraf: invalid options argument provided"), ne.strictEqual(typeof t, "object", "rimraf: options should be object"), Yc(t), As(e, t, function i(a) {
    if (a) {
      if ((a.code === "EBUSY" || a.code === "ENOTEMPTY" || a.code === "EPERM") && n < t.maxBusyTries) {
        n++;
        const o = n * 100;
        return setTimeout(() => As(e, t, i), o);
      }
    ...
    t.unlink(e, (a) => {
      if (a) {
        if (a.code === "ENOENT")
          return r(null);
        if (a.code === "EPERM")
          return Zr ? Is(e, t, a, r) : si(e, t, a, r);
        if (a.code === "EISDIR")
          return si(e, t, a, r);
      }
      return r(a);
...
function Is(e, t, r, n) {
  ne(e), ne(t), ne(typeof n == "function"), t.chmod(e, 438, (i) => {
    i ? n(i.code === "ENOENT" ? null : r) : t.stat(e, (a, o) => {
      a ? n(a.code === "ENOENT" ? null : r) : o.isDirectory() ? si(e, t, r, n) : t.unlink(e, n);
    });
  });
}
function Cs(e, t, r) {
...
function Uh(e, t) {
  if (ne(e), ne(t), t.readdirSync(e).forEach((r) => Kc(Vc.join(e, r), t)), Zr) {
    const r = Date.now();
    do
      try {
...
const Gh = Fe.fromPromise, Qc = er, Zc = ue, eu = lt, tu = Oi, Rs = Gh(async function(t) {
  let r;
  try {
...
function Xh(e, t) {
  ...
  _t.stat(e, (n, i) => {
    ...
    _t.stat(a, (o, s) => {
      if (o)
        return o.code === "ENOENT" ? nu.mkdirs(a, (l) => {
          if (l) return t(l);
          r();
        }) : t(o);
...
const Yh = Fe.fromCallback, iu = ue, Tt = $e, au = lt, Kh = tr.pathExists, { areIdentical: ou } = Ar;
function Jh(e, t, r) {
  function n(i, a) {
    Tt.link(i, a, (o) => {
      if (o) return r(o);
...
function tm(e, t, r) {
    ...
    }));
  {
    ...
    return em(i, (a, o) => a ? r(a) : o ? r(null, {
      toCwd: i,
      toDst: e
    }) : qr.lstat(e, (s) => s ? (s.message = s.message.replace("lstat", "ensureSymlink"), r(s)) : r(null, {
      toCwd: e,
...
const sm = Fe.fromCallback, lu = ue, Ke = er, cu = lt, lm = cu.mkdirs, cm = cu.mkdirsSync, uu = nm, um = uu.symlinkPaths, fm = uu.symlinkPathsSync, fu = om, dm = fu.symlinkType, pm = fu.symlinkTypeSync, hm = tr.pathExists, { areIdentical: du } = Ar;
function mm(e, t, r, n) {
...
function Os(e, t, r, n) {
  um(e, t, (i, a) => {
    if (i) return n(i);
    e = a.toDst, dm(a.toCwd, r, (o, s) => {
      if (o) return n(o);
      const l = lu.dirname(t);
      hm(l, (d, c) => {
        if (d) return n(d);
        if (c) return Ke.symlink(e, t, s, n);
        lm(l, (u) => {
          if (u) return n(u);
          Ke.symlink(e, t, s, n);
        });
...
const { createFile: Ps, createFileSync: ks } = Vh, { createLink: Ns, createLinkSync: Fs } = Zh, { createSymlink: $s, createSymlinkSync: Ls } = ym;
var wm = {
  // file
  createFile: Ps,
  createFileSync: ks,
  ...
  // symlink
  createSymlink: $s,
  createSymlinkSync: Ls,
  ensureSymlink: $s,
  ensureSymlinkSync: Ls
};
function xm(e, { EOL: t = `
...
var _o = { stringify: xm, stripBom: Em };
let Tr;
try {
  Tr = $e;
} catch {
...
const Pi = Fe, { stringify: pu, stripBom: hu } = _o;
...
function Om(e, t, r, n) {
  ...
  Dm(i, (a, o) => {
    if (a) return n(a);
    if (o) return Xr.writeFile(e, t, r, n);
    gu.mkdirs(i, (s) => {
      if (s) return n(s);
...
const { stringify: km } = _o, { outputFile: Nm } = bo;
async function Fm(e, t, r = {}) {
  const n = km(t, r);
  await Nm(e, n, r);
}
var $m = Fm;
const { stringify: Lm } = _o, { outputFileSync: Um } = bo;
function Mm(e, t, r) {
  const n = Lm(t, r);
  Um(e, n, r);
}
...
var zm = Ne;
const Gm = $e, qa = ue, Hm = vo.copy, yu = Oi.remove, qm = lt.mkdirp, Xm = tr.pathExists, Us = Ar;
function Wm(e, t, r, n) {
  typeof r == "function" && (n = r, r = {}), r = r || {};
  const i = r.overwrite || r.clobber || !1;
  Us.checkPaths(e, t, "move", r, (a, o) => {
    if (a) return n(a);
    const { srcStat: s, isChangingCase: l = !1 } = o;
    Us.checkParentPaths(e, s, t, "move", (d) => {
      if (d) return n(d);
      if (Vm(t)) return Ms(e, t, i, l, n);
      qm(qa.dirname(t), (c) => c ? n(c) : Ms(e, t, i, l, n));
    });
  });
}
function Vm(e) {
...
function Ms(e, t, r, n, i) {
  ...
  Xm(t, (a, o) => a ? i(a) : o ? i(new Error("dest already exists.")) : da(e, t, r, i));
}
function da(e, t, r, n) {
...
var Km = Wm;
const wu = $e, Xa = ue, Jm = vo.copySync, xu = Oi.removeSync, Qm = lt.mkdirpSync, Bs = Ar;
function Zm(e, t, r) {
  r = r || {};
  const n = r.overwrite || r.clobber || !1, { srcStat: i, isChangingCase: a = !1 } = Bs.checkPathsSync(e, t, "move", r);
  return Bs.checkParentPathsSync(e, i, t, "move"), e0(t) || Qm(Xa.dirname(t)), t0(e, t, n, a);
}
function e0(e) {
...
const o0 = Rc;
class s0 extends o0.EventEmitter {
  get cancelled() {
...
var ke = {}, Va = { exports: {} }, Mn = { exports: {} }, ha, js;
function c0() {
  if (js) return ha;
  js = 1;
...
function Eu() {
  ...
  zs = 1;
  function e(t) {
    n.debug = n, n.default = n, n.coerce = d, n.disable = s, n.enable = a, n.enabled = l, n.humanize = c0(), n.destroy = c, Object.keys(t).forEach((u) => {
      n[u] = t[u];
...
var Bn = { exports: {} }, ga, Hs;
function f0() {
  return Hs || (Hs = 1, ga = (e, t = process.argv) => {
...
ke.configureRequestUrl = Ao;
ke.safeGetHeader = Er;
ke.configureRequestOptions = mi;
ke.safeStringifyJson = gi;
const g0 = dn, y0 = vu, w0 = Pt, x0 = fn, Tu = Sr, E0 = Ct, Ws = Ir, v0 = hn, Lr = (0, y0.default)("electron-builder");
...
class hi {
  ...
  doApiRequest(t, r, n, i = 0) {
    return Lr.enabled && Lr(`Request: ${gi(t)}`), r.createPromise((a, o, s) => {
...
`));
    ...
    if (c && u != null) {
      ...
      this.doApiRequest(hi.prepareRedirectUrlOptions(u, r), n, s, o).then(i).catch(a);
      return;
    }
    t.setEncoding("utf8");
    let p = "";
  ...
  doDownload(t, r, n) {
    const i = this.createRequest(t, (a) => {
      ...
      if (o != null) {
        n < this.maxRedirects ? this.doDownload(hi.prepareRedirectUrlOptions(o, t), r, n++) : r.callback(this.createMaxRedirectError());
        return;
      }
...
class Ka extends x0.Transform {
  ...
  validate() {
    if (this._actual == null)
      throw (0, Ws.newError)("Not finished yet", "ERR_STREAM_NOT_FINISHED");
    if (this._actual !== this.expected)
      throw (0, Ws.newError)(`${this.algorithm} checksum mismatch, expected ${this.expected}, got ${this._actual}`, "ERR_CHECKSUM_MISMATCH");
    return null;
  }
}
...
function S0(e, t) {
  ...
  if (e.options.onProgress != null) {
    ...
    o != null && r.push(new v0.ProgressCallbackTransform(parseInt(o, 10), e.options.cancellationToken, e.options.onProgress));
  }
...
function bu(e, t) {
  if (typeof e == "object" && e !== null && (typeof t == "object" && t !== null)) {
    ...
    return i.length === a.length && i.every((o) => bu(e[o], t[o]));
  }
  return e === t;
}
var Ni = {};
...
async function Au(e, t, r, n = 0, i = 0, a) {
  var o;
  const s = new O0.CancellationToken();
  try {
    return await e();
  } catch (l) {
...
const Iu = dn, Cu = Ir, k0 = "options.name must be either a string or a Buffer", Vs = (0, Iu.randomBytes)(16);
Vs[0] = Vs[0] | 1;
const ci = {}, Q = [];
for (let e = 0; e < 256; e++) {
...
Actual: ` + h.attribValue
    ...
    function Y(h, f) {
      if (h.opt.xmlns) {
        ...
        A.ns && Z.ns !== A.ns && Object.keys(A.ns).forEach(function(An) {
          M(h, "onopennamespace", {
            prefix: An,
            uri: A.ns[An]
          });
        ...
        for (var ae = 0, fe = h.attribList.length; ae < fe; ae++) {
          var ve = h.attribList[ae], Se = ve[0], mt = ve[1], he = O(Se, !0), We = he.prefix, ta = he.local, Sn = We === "" ? "" : A.ns[We] || "", Or = {
            name: Se,
            value: mt,
            prefix: We,
            local: ta,
          ...
          case y.TEXT:
            if (f.sawRoot && !f.closedRoot) {
              for (var ae = A - 1; v && v !== "<" && v !== "&"; )
                v = z(h, A++), v && f.trackPosition && (f.position++, v === `
...
` ? (f.line++, f.column = 0) : f.column++);
          ...
          case y.ATTRIB:
            ...
            continue;
          case y.ATTRIB_NAME:
            v === "=" ? f.state = y.ATTRIB_VALUE : v === ">" ? (S(f, "Attribute without value"), f.attribValue = f.attribName, G(f), Y(f)) : D(v) ? f.state = y.ATTRIB_NAME_SAW_WHITE : q(b, v) ? f.attribName += v : S(f, "Invalid attribute name");
            continue;
          ...
          case y.ATTRIB_VALUE_QUOTED:
            ...
            G(f), f.q = "", f.state = y.ATTRIB_VALUE_CLOSED;
            continue;
...
class Du {
  ...
  getElements(t, r = !1) {
    return this.elements === null ? [] : this.elements.filter((n) => Ks(n, t, r));
  }
...
function q0(e, t) {
  ...
  for (l = 1; l <= t.linesBefore && !(o - l < 0); l++)
    d = wa(
      ...
      u
    ), s = zr.repeat(" ", t.indent) + xa((e.line - l + 1).toString(), c) + " | " + d.str + `
` + s;
  for (d = wa(e.buffer, n[o], i[o], e.position, u), s += zr.repeat(" ", t.indent) + xa((e.line + 1).toString(), c) + " | " + d.str + `
`, s += zr.repeat("-", t.indent + c + 3 + d.pos) + `^
...
function K0(e, t) {
  if (t = t || {}, Object.keys(t).forEach(function(r) {
    if (W0.indexOf(r) === -1)
      throw new Js('Unknown option "' + r + '" is met in definition of "' + e + '" YAML type.');
...
Ja.prototype.extend = function(t) {
  ...
  return i.implicit = (this.implicit || []).concat(r), i.explicit = (this.explicit || []).concat(n), i.compiledImplicit = Qs(i, "implicit"), i.compiledExplicit = Qs(i, "explicit"), i.compiledTypeMap = J0(i.compiledImplicit, i.compiledExplicit), i;
};
...
var Mu = new og("tag:yaml.org,2002:bool", {
  kind: "scalar",
  resolve: sg,
  construct: lg,
  predicate: cg,
...
var Vu = new Rg("tag:yaml.org,2002:merge", {
  kind: "scalar",
  resolve: Dg
}), Og = Le, Do = `ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789+/=
\r`;
function Pg(e) {
  if (e === null) return !1;
  var t, r, n = 0, i = e.length, a = Do;
  for (r = 0; r < i; r++)
...
function Mg(e) {
  ...
  for (r = 0, n = s.length; r < n; r += 1) {
    if (i = s[r], o = !1, Ug.call(i) !== "[object Object]") return !1;
    for (a in i)
      if (Lg.call(i, a))
        if (!o) o = !0;
        else return !1;
...
function Gg(e) {
  ...
  for (a = new Array(o.length), t = 0, r = o.length; t < r; t += 1) {
    if (n = o[t], zg.call(n) !== "[object Object]" || (i = Object.keys(n), i.length !== 1)) return !1;
    a[t] = [i[0], n[i[0]]];
  }
  return !0;
}
...
}), qt = Qe, Zu = gn, Yg = X0, Kg = Oo, Rt = Object.prototype.hasOwnProperty, yi = 1, ef = 2, tf = 3, wi = 4, va = 1, Jg = 2, Zs = 3, Qg = /[\x00-\x08\x0B\x0C\x0E-\x1F\x7F-\x84\x86-\x9F\uFFFE\uFFFF]|[\uD800-\uDBFF](?![\uDC00-\uDFFF])|(?:[^\uD800-\uDBFF]|^)[\uDC00-\uDFFF]/, Zg = /[\x85\u2028\u2029]/, ey = /[,\[\]\{\}]/, rf = /^(?:!|!!|![a-z\-]+!)$/i, nf = /^(?:!|[^,\[\]\{\}])(?:%[0-9a-f]{2}|[0-9a-z\-#;\/\?:@&=\+\$,_\.!~\*'\(\)\[\]])*$/i;
function el(e) {
...
var of = new Array(256), sf = new Array(256);
for (var or = 0; or < 256; or++)
  of[or] = tl(or) ? 1 : 0, sf[or] = tl(or);
function ay(e, t) {
...
var rl = {
  YAML: function(t, r, n) {
    var i, a, o;
    t.version !== null && B(t, "duplication of %YAML directive"), n.length !== 1 && B(t, "YAML directive accepts exactly one argument"), i = /^([0-9]+)\.([0-9]+)$/.exec(n[0]), i === null && B(t, "ill-formed argument of the YAML directive"), a = parseInt(i[1], 10), o = parseInt(i[2], 10), a !== 1 && B(t, "unacceptable YAML version of the document"), t.version = n[0], t.checkLineBreaks = o < 2, o !== 1 && o !== 2 && xi(t, "unsupported YAML version of the document");
  },
  TAG: function(t, r, n) {
    var i, a;
    n.length !== 2 && B(t, "TAG directive accepts exactly two arguments"), i = n[0], a = n[1], rf.test(i) || B(t, "ill-formed tag handle (first argument) of the TAG directive"), Rt.call(t.tagMap, i) && B(t, 'there is a previously declared suffix for "' + i + '" tag handle'), nf.test(a) || B(t, "ill-formed tag prefix (second argument) of the TAG directive");
    try {
...
function St(e, t, r, n) {
  ...
  if (t < r) {
    ...
    else Qg.test(s) && B(e, "the stream contains non-printable characters");
    e.result += s;
  }
}
function nl(e, t, r, n) {
  ...
  for (qt.isObject(r) || B(e, "cannot merge mappings; the provided source object is unacceptable"), i = Object.keys(r), o = 0, s = i.length; o < s; o += 1)
    a = i[o], Rt.call(t, a) || (af(t, a, r[a]), n[a] = !0);
}
function hr(e, t, r, n, i, a, o, s, l) {
  var d, c;
  if (Array.isArray(i))
    for (i = Array.prototype.slice.call(i), d = 0, c = i.length; d < c; d += 1)
      Array.isArray(i[d]) && B(e, "nested arrays are not supported inside keys"), typeof i == "object" && el(i[d]) === "[object Object]" && (i[d] = "[object Object]");
  if (typeof i == "object" && el(i) === "[object Object]" && (i = "[object Object]"), i = String(i), t === null && (t = {}), n === "tag:yaml.org,2002:merge")
    ...
    !e.json && !Rt.call(r, i) && Rt.call(t, i) && (e.line = o || e.line, e.lineStart = s || e.lineStart, e.position = l || e.position, B(e, "duplicated mapping key")), af(t, i, a), delete r[i];
  return t;
}
function Po(e) {
  var t;
...
function oy(e, t, r) {
  ...
  for (e.kind = "scalar", e.result = "", a = o = e.position, s = !1; g !== 0; ) {
    if (g === 58) {
      ...
      if (e.position === e.lineStart && Fi(e) || r && pr(g))
        break;
      if (ot(g))
    ...
    s && (St(e, a, o, !1), ko(e, e.line - l), a = o = e.position, s = !1), Yt(g) || (o = e.position + 1), g = e.input.charCodeAt(++e.position);
  }
  ...
  for (e.kind = "scalar", e.result = "", e.position++, n = i = e.position; (r = e.input.charCodeAt(e.position)) !== 0; )
    if (r === 39)
      if (St(e, n, e.position, !0), r = e.input.charCodeAt(++e.position), r === 39)
        ...
        return !0;
    else ot(r) ? (St(e, n, i, !0), ko(e, pe(e, !1, t)), n = i = e.position) : e.position === e.lineStart && Fi(e) ? B(e, "unexpected end of the document within a single quoted scalar") : (e.position++, i = e.position);
  ...
  for (e.kind = "scalar", e.result = "", e.position++, r = n = e.position; (s = e.input.charCodeAt(e.position)) !== 0; ) {
    ...
    if (s === 92) {
      if (St(e, r, e.position, !0), s = e.input.charCodeAt(++e.position), ot(s))
        ...
        e.result += sf[s], e.position++;
      else if ((o = ry(s)) > 0) {
        for (i = o, a = 0; i > 0; i--)
          s = e.input.charCodeAt(++e.position), (o = ty(s)) >= 0 ? a = (a << 4) + o : B(e, "expected hexadecimal character");
        e.result += iy(a), e.position++;
      } else
        B(e, "unknown escape sequence");
      r = n = e.position;
    } else ot(s) ? (St(e, r, n, !0), ko(e, pe(e, !1, t)), r = n = e.position) : e.position === e.lineStart && Fi(e) ? B(e, "unexpected end of the document within a double quoted scalar") : (e.position++, n = e.position);
  }
...
function uy(e, t) {
  ...
  for (e.kind = "scalar", e.result = ""; u !== 0; )
    if (u = e.input.charCodeAt(++e.position), u === 43 || u === 45)
      va === i ? i = u === 43 ? Zs : Jg : B(e, "repeat of a chomping mode identifier");
    else if ((c = ny(u)) >= 0)
  ...
  for (; u !== 0; ) {
    for (Po(e), e.lineIndent = 0, u = e.input.charCodeAt(e.position); (!o || e.lineIndent < s) && u === 32; )
...
function fy(e, t, r) {
  ...
  for (e.anchor !== null && (e.anchorMap[e.anchor] = u), _ = e.input.charCodeAt(e.position); _ !== 0; ) {
    if (!T && e.firstTabInLine !== -1 && (e.position = e.firstTabInLine, B(e, "tab characters must not be used in indentation")), n = e.input.charCodeAt(e.position + 1), a = e.line, (_ === 63 || _ === 58) && Be(n))
      ...
      if (o = e.line, s = e.lineStart, l = e.position, !br(e, r, ef, !1, !0))
        break;
      if (e.line === a) {
    ...
    if ((e.line === a || e.lineIndent > t) && (T && (o = e.line, s = e.lineStart, l = e.position), br(e, t, wi, !0, i) && (T ? x = e.result : w = e.result), T || (hr(e, u, p, g, x, w, o, s, l), g = x = w = null), pe(e, !0, -1), _ = e.input.charCodeAt(e.position)), (e.line === a || e.lineIndent > t) && _ !== 0)
...
function dy(e) {
  ...
  if (e.tag !== null && B(e, "duplication of a tag property"), o = e.input.charCodeAt(++e.position), o === 60 ? (r = !0, o = e.input.charCodeAt(++e.position)) : o === 33 ? (n = !0, i = "!!", o = e.input.charCodeAt(++e.position)) : i = "!", t = e.position, r) {
    ...
    for (; o !== 0 && !Be(o); )
      o === 33 && (n ? B(e, "tag suffix cannot contain exclamation marks") : (i = e.input.slice(t - 1, e.position + 1), rf.test(i) || B(e, "named tag handle cannot contain such characters"), n = !0, t = e.position + 1)), o = e.input.charCodeAt(++e.position);
    a = e.input.slice(t, e.position), ey.test(a) && B(e, "tag suffix cannot contain flow indicator characters");
  }
  a && !nf.test(a) && B(e, "tag name cannot contain such characters: " + a);
  try {
    a = decodeURIComponent(a);
  } catch {
...
function br(e, t, r, n, i) {
  ...
  if (e.listener !== null && e.listener("open", e), e.tag = null, e.anchor = null, e.kind = null, e.result = null, a = o = s = wi === r || tf === r, n && pe(e, !0, -1) && (d = !0, e.lineIndent > t ? l = 1 : e.lineIndent === t ? l = 0 : e.lineIndent < t && (l = -1)), l === 1)
    for (; dy(e) || py(e); )
      pe(e, !0, -1) ? (d = !0, s = a, e.lineIndent > t ? l = 1 : e.lineIndent === t ? l = 0 : e.lineIndent < t && (l = -1)) : s = !1;
  if (s && (s = d || i), (l === 1 || wi === r) && (yi === r || ef === r ? w = t : w = t + 1, T = e.position - e.lineStart, l === 1 ? s && (il(e, T) || fy(e, T, w)) || cy(e, w) ? c = !0 : (o && uy(e, w) || sy(e, w) || ly(e, w) ? c = !0 : hy(e) ? (c = !0, (e.tag !== null || e.anchor !== null) && B(e, "alias node should not have any properties")) : oy(e, w, yi === r) && (c = !0, e.tag === null && (e.tag = "?")), e.anchor !== null && (e.anchorMap[e.anchor] = e.result)) : l === 0 && (c = s && il(e, T))), e.tag === null)
...
function my(e) {
  ...
  for (e.version = null, e.checkLineBreaks = e.legacy, e.tagMap = /* @__PURE__ */ Object.create(null), e.anchorMap = /* @__PURE__ */ Object.create(null); (o = e.input.charCodeAt(e.position)) !== 0 && (pe(e, !0, -1), o = e.input.charCodeAt(e.position), !(e.lineIndent > 0 || o !== 37)); ) {
    ...
    o !== 0 && Po(e), Rt.call(rl, n) ? rl[n](e, n, i) : xi(e, 'unknown document directive "' + n + '"');
  }
  if (pe(e, !0, -1), e.lineIndent === 0 && e.input.charCodeAt(e.position) === 45 && e.input.charCodeAt(e.position + 1) === 45 && e.input.charCodeAt(e.position + 2) === 45 ? (e.position += 3, pe(e, !0, -1)) : a && B(e, "directives end mark is expected"), br(e, e.lineIndent - 1, wi, !1, !0), pe(e, !0, -1), e.checkLineBreaks && Zg.test(e.input.slice(t, e.position)) && xi(e, "non-ASCII line breaks are interpreted as content"), e.documents.push(e.result), e.position === e.lineStart && Fi(e)) {
...
Ro.loadAll = gy;
Ro.load = yy;
var uf = {}, $i = Qe, yn = gn, wy = Oo, ff = Object.prototype.toString, df = Object.prototype.hasOwnProperty, No = 65279, xy = 9, tn = 10, Ey = 13, vy = 32, Ty = 33, _y = 34, Qa = 35, by = 37, Sy = 38, Ay = 39, Iy = 42, pf = 44, Cy = 45, Ei = 58, Ry = 61, Dy = 62, Oy = 63, Py = 64, hf = 91, mf = 93, ky = 96, gf = 123, Ny = 124, yf = 125, Re = {};
Re[0] = "\\0";
Re[7] = "\\a";
Re[8] = "\\b";
Re[9] = "\\t";
...
function Ly(e, t) {
  ...
  for (r = {}, n = Object.keys(t), i = 0, a = n.length; i < a; i += 1)
    o = n[i], s = String(t[o]), o.slice(0, 2) === "!!" && (o = "tag:yaml.org,2002:" + o.slice(2)), l = e.compiledTypeMap.fallback[o], l && df.call(l.styleAliases, s) && (s = l.styleAliases[s]), r[o] = s;
  return r;
}
function Uy(e) {
  var t, r, n;
...
function al(e, t) {
  for (var r = $i.repeat(" ", t), n = 0, i = -1, a = "", o, s = e.length; n < s; )
    i = e.indexOf(`
...
function sl(e, t, r) {
  ...
  return (
    ...
    (r ? (
      // c = flow-in
      n
    ) : n && e !== pf && e !== hf && e !== mf && e !== gf && e !== yf) && e !== Qa && !(t === Ei && !i) || ol(t) && !vi(t) && e === Qa || t === Ei && i
  );
}
function zy(e) {
  return nn(e) && e !== No && !vi(e) && e !== Cy && e !== Oy && e !== Ei && e !== pf && e !== hf && e !== mf && e !== gf && e !== yf && e !== Qa && e !== Sy && e !== Iy && e !== Ty && e !== Ny && e !== Ry && e !== Dy && e !== Ay && e !== _y && e !== by && e !== Py && e !== ky;
}
function Gy(e) {
  return !vi(e) && e !== Ei;
}
...
var xf = 1, eo = 2, Ef = 3, vf = 4, dr = 5;
function Hy(e, t, r, n, i, a, o, s) {
  var l, d = 0, c = null, u = !1, p = !1, g = n !== -1, x = -1, w = zy(Gr(e, 0)) && Gy(Gr(e, e.length - 1));
  if (t || o)
  ...
  return !u && !p ? w && !o && !i(e) ? xf : a === rn ? dr : eo : r > 9 && wf(e) ? dr : o ? a === rn ? dr : eo : p ? vf : Ef;
}
function qy(e, t, r, n, i) {
  e.dump = function() {
    ...
    switch (Hy(
      ...
      case vf:
        return ">" + ll(t, e.indent) + cl(al(Xy(t, o), a));
      case dr:
        return '"' + Wy(t) + '"';
      default:
...
function fl(e, t, r, n) {
  ...
  for (o = 0, s = r.length; o < s; o += 1)
    l = r[o], e.replacer && (l = e.replacer.call(r, String(o), l)), (pt(e, t + 1, l, !0, !0, !1, !0) || typeof l > "u" && pt(e, t + 1, null, !0, !0, !1, !0)) && ((!n || i !== "") && (i += Za(e, t)), e.dump && tn === e.dump.charCodeAt(0) ? i += "-" : i += "- ", i += e.dump);
  e.tag = a, e.dump = i || "[]";
}
function Yy(e, t, r) {
...
function Ky(e, t, r, n) {
  ...
  for (s = 0, l = o.length; s < l; s += 1)
    p = "", (!n || i !== "") && (p += Za(e, t)), d = o[s], c = r[d], e.replacer && (c = e.replacer.call(r, d, c)), pt(e, t + 1, d, !0, !0, !0) && (u = e.tag !== null && e.tag !== "?" || e.dump && e.dump.length > 1024, u && (e.dump && tn === e.dump.charCodeAt(0) ? p += "?" : p += "? "), p += e.dump, u && (p += Za(e, t)), pt(e, t + 1, c, !0, u) && (e.dump && tn === e.dump.charCodeAt(0) ? p += ":" : p += ": ", p += e.dump, i += p));
  e.tag = a, e.dump = i || "{}";
}
function dl(e, t, r) {
  var n, i, a, o, s, l;
  for (i = r ? e.explicitTypes : e.implicitTypes, a = 0, o = i.length; a < o; a += 1)
    if (s = i[a], (s.instanceOf || s.predicate) && (!s.instanceOf || typeof t == "object" && t instanceof s.instanceOf) && (!s.predicate || s.predicate(t))) {
      if (r ? s.multi && s.representName ? e.tag = s.representName(t) : e.tag = s.tag : e.tag = "?", s.represent) {
        if (l = e.styleMap[s.tag] || s.defaultStyle, ff.call(s.represent) === "[object Function]")
          n = s.represent(t, l);
        else if (df.call(s.represent, l))
          n = s.represent[l](t, l);
        else
          throw new yn("!<" + s.tag + '> tag resolver accepts not "' + l + '" style');
        e.dump = n;
      }
      return !0;
    }
...
function pt(e, t, r, n, i, a, o) {
  ...
  if (c && (u = e.duplicates.indexOf(r), p = u !== -1), (e.tag !== null && e.tag !== "?" || p || e.indent !== 2 && t > 0) && (i = !1), p && e.usedDuplicates[u])
    ...
    if (c && p && !e.usedDuplicates[u] && (e.usedDuplicates[u] = !0), s === "[object Object]")
      ...
      n && e.dump.length !== 0 ? (e.noArrayIndent && !o && t > 0 ? fl(e, t - 1, e.dump, i) : fl(e, t, e.dump, i), p && (e.dump = "&ref_" + u + e.dump)) : (Vy(e, t, e.dump), p && (e.dump = "&ref_" + u + " " + e.dump));
      ...
      throw new yn("unacceptable kind of an object to dump " + s);
    }
...
function Jy(e, t) {
  var r = [], n = [], i, a;
  for (to(e, r, n), i = 0, a = n.length; i < a; i += 1)
...
be.safeLoad = Fo("safeLoad", "load");
be.safeLoadAll = Fo("safeLoadAll", "loadAll");
be.safeDump = Fo("safeDump", "dump");
var Li = {};
...
const ow = typeof process == "object" && process.env && process.env.NODE_DEBUG && /\bsemver\b/i.test(process.env.NODE_DEBUG) ? (...e) => console.error("SEMVER", ...e) : () => {
};
var Mi = ow;
(function(e, t) {
  const {
...
var wn = ro.exports;
const sw = Object.freeze({ loose: !0 }), lw = Object.freeze({}), cw = (e) => e ? typeof e != "object" ? sw : e : lw;
var $o = cw;
const pl = /^[0-9]+$/, bf = (e, t) => {
...
const zn = Mi, { MAX_LENGTH: hl, MAX_SAFE_INTEGER: Gn } = Ui, { safeRe: Hn, t: qn } = wn, fw = $o, { compareIdentifiers: Ta } = Sf;
let dw = class at {
  constructor(t, r) {
...
var Lo = Gw;
const Hw = Lo, qw = (e, t) => e.sort((r, n) => Hw(r, n, t));
var Xw = qw;
const Ww = Lo, Vw = (e, t) => e.sort((r, n) => Ww(n, r, t));
var Yw = Vw;
...
var Mo = ax;
const ox = Ze, sx = (e, t, r) => ox(e, t, r) <= 0;
var Bo = sx;
const lx = Af, cx = If, ux = Bi, fx = Mo, dx = Uo, px = Bo, hx = (e, t, r, n) => {
  switch (t) {
    case "===":
...
function et() {
  ...
  class t {
    ...
    parseRange(I) {
      ...
      if ($)
        return $;
      const O = this.options.loose, G = O ? l[d.HYPHENRANGELOOSE] : l[d.HYPHENRANGE];
      I = I.replace(G, M(this.options.includePrerelease)), o("hyphen replace", I), I = I.replace(l[d.COMPARATORTRIM], c), o("comparator trim", I), I = I.replace(l[d.TILDETRIM], u), o("tilde trim", I), I = I.replace(l[d.CARETTRIM], p), o("caret trim", I);
      let Y = I.split(" ").map((z) => _(z, this.options)).join(" ").split(/\s+/).map((z) => U(z, this.options));
      O && (Y = Y.filter((z) => (o("loose invalid filter", z, this.options), !!z.match(l[d.COMPARATORLOOSE])))), o("range list", Y);
      const X = /* @__PURE__ */ new Map(), re = Y.map((z) => new a(z, this.options));
      for (const z of re) {
        if (w(z))
          return [z];
        X.set(z.value, z);
    ...
    intersects(I, P) {
      ...
      return this.set.some((S) => b(S, P) && I.set.some(($) => b($, P) && S.every((O) => $.every((G) => O.intersects(G, P)))));
    }
  ...
  _a = t;
  const r = Ex, n = new r(), i = $o, a = ji(), o = Mi, s = Ue, {
    safeRe: l,
    t: d,
    comparatorTrimReplace: c,
    tildeTrimReplace: u,
    caretTrimReplace: p
  } = wn, { FLAG_INCLUDE_PRERELEASE: g, FLAG_LOOSE: x } = Ui, w = (R) => R.value === "<0.0.0-0", T = (R) => R.value === "", b = (R, I) => {
    let P = !0;
    const S = R.slice();
    let $ = S.pop();
    for (; P && S.length; )
    ...
    return R.replace(P, (S, $, O, G, Y) => {
      o("tilde", R, S, $, O, G, Y);
      let X;
      return F($) ? X = "" : F(O) ? X = `>=${$}.0.0 <${+$ + 1}.0.0-0` : F(G) ? X = `>=${$}.${O}.0 <${$}.${+O + 1}.0-0` : Y ? (o("replaceTilde pr", Y), X = `>=${$}.${O}.${G}-${Y} <${$}.${+O + 1}.0-0`) : X = `>=${$}.${O}.${G} <${$}.${+O + 1}.0-0`, o("tilde return", X), X;
    });
  }, H = (R, I) => R.trim().split(/\s+/).map((P) => q(P, I)).join(" "), q = (R, I) => {
    o("caret", R, I);
    const P = I.loose ? l[d.CARETLOOSE] : l[d.CARET], S = I.includePrerelease ? "-0" : "";
    return R.replace(P, ($, O, G, Y, X) => {
      o("caret", R, $, O, G, Y, X);
      let re;
      return F(O) ? re = "" : F(G) ? re = `>=${O}.0.0${S} <${+O + 1}.0.0-0` : F(Y) ? O === "0" ? re = `>=${O}.${G}.0${S} <${O}.${+G + 1}.0-0` : re = `>=${O}.${G}.0${S} <${+O + 1}.0.0-0` : X ? (o("replaceCaret pr", X), O === "0" ? G === "0" ? re = `>=${O}.${G}.${Y}-${X} <${O}.${G}.${+Y + 1}-0` : re = `>=${O}.${G}.${Y}-${X} <${O}.${+G + 1}.0-0` : re = `>=${O}.${G}.${Y}-${X} <${+O + 1}.0.0-0`) : (o("no pr"), O === "0" ? G === "0" ? re = `>=${O}.${G}.${Y}${S} <${O}.${G}.${+Y + 1}-0` : re = `>=${O}.${G}.${Y}${S} <${O}.${+G + 1}.0-0` : re = `>=${O}.${G}.${Y} <${+O + 1}.0.0-0`), o("caret return", re), re;
    });
  }, te = (R, I) => (o("replaceXRanges", R, I), R.split(/\s+/).map((P) => y(P, I)).join(" ")), y = (R, I) => {
    R = R.trim();
    const P = I.loose ? l[d.XRANGELOOSE] : l[d.XRANGE];
    return R.replace(P, (S, $, O, G, Y, X) => {
      o("xRange", R, S, $, O, G, Y, X);
      const re = F(O), ge = re || F(G), z = ge || F(Y), tt = z;
      return $ === "=" && tt && ($ = ""), X = I.includePrerelease ? "-0" : "", re ? $ === ">" || $ === "<" ? S = "<0.0.0-0" : S = "*" : $ && tt ? (ge && (G = 0), Y = 0, $ === ">" ? ($ = ">=", ge ? (O = +O + 1, G = 0, Y = 0) : (G = +G + 1, Y = 0)) : $ === "<=" && ($ = "<", ge ? O = +O + 1 : G = +G + 1), $ === "<" && (X = "-0"), S = `${$ + O}.${G}.${Y}${X}`) : ge ? S = `>=${O}.0.0${X} <${+O + 1}.0.0-0` : z && (S = `>=${O}.${G}.0${X} <${O}.${+G + 1}.0-0`), o("xRange return", S), S;
    });
  }, j = (R, I) => (o("replaceStars", R, I), R.trim().replace(l[d.STAR], "")), U = (R, I) => (o("replaceGTE0", R, I), R.trim().replace(l[I.includePrerelease ? d.GTE0PRE : d.GTE0], "")), M = (R) => (I, P, S, $, O, G, Y, X, re, ge, z, tt) => (F(S) ? P = "" : F($) ? P = `>=${S}.0.0${R ? "-0" : ""}` : F(O) ? P = `>=${S}.${$}.0${R ? "-0" : ""}` : G ? P = `>=${P}` : P = `>=${P}${R ? "-0" : ""}`, F(re) ? X = "" : F(ge) ? X = `<${+re + 1}.0.0-0` : F(z) ? X = `<${re}.${+ge + 1}.0-0` : tt ? X = `<=${re}.${ge}.${z}-${tt}` : R ? X = `<${re}.${ge}.${+z + 1}-0` : X = `<=${X}`, `${P} ${X}`.trim()), J = (R, I, P) => {
...
function ji() {
  ...
  ba = t;
  const r = $o, { safeRe: n, t: i } = wn, a = Cf, o = Mi, s = Ue, l = et();
  return ba;
}
...
const Dx = Ue, Ox = et(), Px = (e, t, r) => {
  ...
  return e.forEach((o) => {
    a.test(o) && (!n || i.compare(o) === 1) && (n = o, i = new Dx(n, r));
  }), n;
};
var kx = Px;
const Sa = Ue, Nx = et(), Tl = Bi, Fx = (e, t) => {
  ...
  for (let n = 0; n < e.set.length; ++n) {
    ...
    let a = null;
    i.forEach((o) => {
      const s = new Sa(o.semver.version);
      switch (o.operator) {
        case ">":
...
var Mx = Ux;
const Bx = Ue, Rf = ji(), { ANY: jx } = Rf, zx = et(), Gx = zi, _l = Bi, bl = Uo, Hx = Bo, qx = Mo, Xx = (e, t, r, n) => {
  ...
  for (let d = 0; d < t.set.length; ++d) {
    ...
    let u = null, p = null;
    if (c.forEach((g) => {
      g.semver === jx && (g = new Rf(">=0.0.0")), u = u || g, p = p || g, i(g.semver, u.semver, n) ? u = g : o(g.semver, p.semver, n) && (p = g);
...
var jo = Xx;
const Wx = jo, Vx = (e, t, r) => Wx(e, t, ">", r);
var Yx = Vx;
const Kx = jo, Jx = (e, t, r) => Kx(e, t, "<", r);
var Qx = Jx;
...
const Al = et(), zo = ji(), { ANY: Aa } = zo, Mr = zi, Go = Ze, iE = (e, t, r = {}) => {
  if (e === t)
    return !0;
  ...
  return !0;
}, aE = [new zo(">=0.0.0-0")], Il = [new zo(">=0.0.0")], oE = (e, t, r) => {
  if (e === t)
    return !0;
  ...
  let i, a;
  for (const g of e)
    g.operator === ">" || g.operator === ">=" ? i = Cl(i, g, r) : g.operator === "<" || g.operator === "<=" ? a = Rl(a, g, r) : n.add(g.semver);
  if (n.size > 1)
    return null;
  let o;
  if (i && a) {
  ...
  for (const g of n) {
    if (i && !Mr(g, String(i), r) || a && !Mr(g, String(a), r))
      return null;
    for (const x of t)
      if (!Mr(g, String(x), r))
        return !1;
...
var sE = iE;
const Ia = wn, Dl = Ui, lE = Ue, Ol = Sf, cE = Rr, uE = gw, fE = xw, dE = vw, pE = _w, hE = Aw, mE = Rw, gE = Pw, yE = Fw, wE = Ze, xE = Mw, EE = zw, vE = Lo, TE = Xw, _E = Yw, bE = Bi, SE = Uo, AE = Af, IE = If, CE = Mo, RE = Bo, DE = Cf, OE = wx, PE = ji(), kE = et(), NE = zi, FE = Sx, $E = Rx, LE = kx, UE = $x, ME = Mx, BE = jo, jE = Yx, zE = Qx, GE = eE, HE = nE, qE = sE;
var Df = {
  parse: cE,
  valid: uE,
  clean: fE,
...
(function(e, t) {
  ...
  var gd = Array.prototype, yd = Function.prototype, In = Object.prototype, ra = f["__core-js_shared__"], Zo = yd.toString, rt = In.hasOwnProperty, es = function() {
    var m = /[^.]+$/.exec(ra && ra.keys && ra.keys.IE_PROTO || "");
    return m ? "Symbol(src)_1." + m : "";
  }(), ts = In.toString, wd = RegExp(
    "^" + Zo.call(rt).replace(X, "\\$&").replace(/hasOwnProperty|(function).*?(?=\\\()| for .+?(?=\\\])/g, "$1.*?") + "$"
  ), rs = Z ? f.Buffer : void 0, Cn = f.Symbol, ns = f.Uint8Array, is = In.propertyIsEnumerable, xd = gd.splice, Ft = Cn ? Cn.toStringTag : void 0, as = Object.getOwnPropertySymbols, Ed = rs ? rs.isBuffer : void 0, vd = hd(Object.keys, Object), na = nr(f, "DataView"), Pr = nr(f, "Map"), ia = nr(f, "Promise"), aa = nr(f, "Set"), oa = nr(f, "WeakMap"), kr = nr(Object, "create"), Td = Ut(na), _d = Ut(Pr), bd = Ut(ia), Sd = Ut(aa), Ad = Ut(oa), os = Cn ? Cn.prototype : void 0, sa = os ? os.valueOf : void 0;
  function $t(m) {
  ...
  function Rd(m) {
    ...
    return rt.call(E, m) ? E[m] : void 0;
  }
  function Dd(m) {
    var E = this.__data__;
    return kr ? E[m] !== void 0 : rt.call(E, m);
  }
  function Od(m, E) {
    var C = this.__data__;
  ...
  function Ud(m) {
    var E = On(this, m).delete(m);
    return this.size -= E ? 1 : 0, E;
  }
  function Md(m) {
    return On(this, m).get(m);
  }
  function Bd(m) {
    return On(this, m).has(m);
  }
  function jd(m, E) {
    var C = On(this, m), L = C.size;
  ...
  function Yd(m, E) {
    var C = Pn(m), L = !C && up(m), oe = !C && !L && la(m), V = !C && !L && !oe && ms(m), de = C || L || oe || V, ye = de ? We(m.length, String) : [], Te = ye.length;
    for (var le in m)
      rt.call(m, le) && !(de && // Safari 9 has enumerable `arguments.length` in strict mode.
  ...
  function Kd(m, E, C) {
    var L = E(m);
    return Pn(m) ? L : mt(L, C(m));
  }
  function Nr(m) {
    return m == null ? m === void 0 ? y : b : Ft && Ft in Object(m) ? np(m) : cp(m);
  }
  function ss(m) {
    return Fr(m) && Nr(m) == s;
  }
  function ls(m, E, C, L, oe) {
    return m === E ? !0 : m == null || E == null || !Fr(m) && !Fr(E) ? m !== m && E !== E : Jd(m, E, C, L, ls, oe);
  }
  function Jd(m, E, C, L, oe, V) {
    var de = Pn(m), ye = Pn(E), Te = de ? l : yt(m), le = ye ? l : yt(E);
    Te = Te == s ? _ : Te, le = le == s ? _ : le;
    ...
    if (Ae && !je)
      return V || (V = new gt()), de || ms(m) ? cs(m, E, C, L, oe, V) : tp(m, E, Te, C, L, oe, V);
    if (!(C & i)) {
      var He = je && rt.call(m, "__wrapped__"), qe = Ve && rt.call(E, "__wrapped__");
      if (He || qe) {
        var wt = He ? m.value() : m, ut = qe ? E.value() : E;
        return V || (V = new gt()), oe(wt, ut, C, L, V);
      }
    }
    return Ae ? (V || (V = new gt()), rp(m, E, C, L, oe, V)) : !1;
  }
  function Qd(m) {
    if (!hs(m) || sp(m))
      return !1;
  ...
  function Zd(m) {
    return Fr(m) && ps(m.length) && !!z[Nr(m)];
  }
  function ep(m) {
    if (!lp(m))
      return vd(m);
    ...
    for (var C in Object(m))
      rt.call(m, C) && C != "constructor" && E.push(C);
    return E;
  }
  function cs(m, E, C, L, oe, V) {
  ...
  function tp(m, E, C, L, oe, V, de) {
    switch (C) {
      ...
      case U:
        return !(m.byteLength != E.byteLength || !V(new ns(m), new ns(E)));
      case c:
      case u:
      case T:
        return fs(+m, +E);
      ...
      case H:
        var Te = L & i;
        if (ye || (ye = md), m.size != E.size && !Te)
          return !1;
        var le = de.get(m);
        if (le)
          return le == E;
        L |= a, de.set(m, E);
        var je = cs(ye(m), ye(E), L, oe, V, de);
        return de.delete(m), je;
      case te:
        if (sa)
          return sa.call(m) == sa.call(E);
    }
    return !1;
  }
  function rp(m, E, C, L, oe, V) {
    var de = C & i, ye = us(m), Te = ye.length, le = us(E), je = le.length;
    if (Te != je && !de)
      return !1;
    for (var Ve = Te; Ve--; ) {
      var Ae = ye[Ve];
    ...
    for (var wt = de; ++Ve < Te; ) {
      ...
      var ut = m[Ae], Mt = E[Ae];
      if (L)
        var gs = de ? L(Mt, ut, Ae, E, m, V) : L(ut, Mt, Ae, m, E, V);
      if (!(gs === void 0 ? ut === Mt || oe(ut, Mt, C, L, V) : gs)) {
        qe = !1;
        break;
      }
    ...
    if (qe && !wt) {
      var kn = m.constructor, Nn = E.constructor;
      kn != Nn && "constructor" in m && "constructor" in E && !(typeof kn == "function" && kn instanceof kn && typeof Nn == "function" && Nn instanceof Nn) && (qe = !1);
    }
  ...
  function On(m, E) {
    var C = m.__data__;
    return op(E) ? C[typeof E == "string" ? "string" : "hash"] : C.map;
  }
  function nr(m, E) {
    var C = Or(m, E);
  ...
  var ip = as ? function(m) {
    return m == null ? [] : (m = Object(m), Se(as(m), function(E) {
      return is.call(m, E);
    }));
  } : hp, yt = Nr;
  (na && yt(new na(new ArrayBuffer(1))) != M || Pr && yt(new Pr()) != w || ia && yt(ia.resolve()) != F || aa && yt(new aa()) != H || oa && yt(new oa()) != j) && (yt = function(m) {
  ...
  function lp(m) {
    var E = m && m.constructor, C = typeof E == "function" && E.prototype || In;
    return m === C;
  }
  function cp(m) {
    return ts.call(m);
  ...
  var up = ss(/* @__PURE__ */ function() {
    return arguments;
  }()) ? ss : function(m) {
    return Fr(m) && rt.call(m, "callee") && !is.call(m, "callee");
  }, Pn = Array.isArray;
  function fp(m) {
    return m != null && ps(m.length) && !ds(m);
  }
  var la = Ed || mp;
  function dp(m, E) {
    return ls(m, E);
...
class YE {
  ...
  async setDownloadedFile(t, r, n, i, a, o) {
    ...
    }, o && await (0, Gt.outputJson)(this.getUpdateInfoFile(), this._downloadedFileInfo);
  }
  async clear() {
  ...
  async getValidCachedUpdateFile(t, r) {
    ...
    const s = Vr.join(this.cacheDirForPendingUpdate, a.fileName);
...
function KE(e, t = "sha512", r = "base64", n) {
  return new Promise((i, a) => {
    const o = (0, WE.createHash)(t);
    o.on("error", a).setEncoding(r), (0, VE.createReadStream)(e, {
      ...n,
...
async function JE(e, t, r) {
  ...
  for (let a = 0; a < 3; a++)
    try {
      ...
      if (o.code === "ENOENT")
        return i;
      r.warn(`Error on remove temp update file: ${o}`), i = Vr.join(t, `${n++}-${e}`);
    }
  return i;
}
var Gi = {}, Ho = {};
Object.defineProperty(Ho, "__esModule", { value: !0 });
Ho.getAppCacheDir = ZE;
const Ca = ue, QE = Ci;
function ZE() {
...
var En = {}, Xe = {}, rv = "[object Symbol]", Pf = /[\\^$.*+?()[\]{}|]/g, nv = RegExp(Pf.source), iv = typeof Pe == "object" && Pe && Pe.Object === Object && Pe, av = typeof self == "object" && self && self.Object === Object && self, ov = iv || av || Function("return this")(), sv = Object.prototype, lv = sv.toString, Nl = ov.Symbol, Fl = Nl ? Nl.prototype : void 0, $l = Fl ? Fl.toString : void 0;
function cv(e) {
  if (typeof e == "string")
    return e;
  if (fv(e))
...
function wv(e, t, r) {
  const n = no(`${e.pathname}.blockmap`, e);
  return [no(`${e.pathname.replace(new RegExp(mv(r), "g"), t)}.blockmap`, e), n];
}
var me = {};
...
const ft = Ee, mr = Df, Av = Sr, gr = Xe, io = me, ka = /\/tag\/([^/]+)$/;
class Ff extends io.Provider {
  constructor(t, r, n) {
    super({
      ...n,
...
${s}`, "ERR_UPDATER_INVALID_RELEASE_FEED");
    ...
    const w = (0, io.parseUpdateInfo)(u, p, g);
  ...
  resolveFiles(t) {
    return (0, io.resolveFiles)(t, this.baseUrl, (r) => this.getBaseDownloadPath(t.tag, r.replace(/ /g, "-")));
  }
...
const sr = Ee, Rv = be, Dv = ue, zl = Sr, Gl = Xe, Ov = Ot, Pv = me;
class kv extends Ov.BaseGitHubProvider {
  ...
  async getLatestVersion() {
    ...
    let o;
    try {
      o = (0, Rv.load)(await this.httpRequest(a, this.configureHeaders("application/octet-stream"), t));
    } catch (s) {
...
function Mv(e, t, r) {
  ...
  for (let w = 0; w < c.checksums.length; x += c.sizes[w], w++) {
    ...
    _ != null && g.get(b) !== T && (r.warn(`Checksum ("${b}") matches, but size differs (old: ${g.get(b)}, new: ${T})`), _ = void 0), _ === void 0 ? (u++, a != null && a.kind === Wt.DOWNLOAD && a.end === x ? a.end += T : (a = {
      ...
      // oldBlocks: null,
    }, ql(a, s, b, w))) : a != null && a.kind === Wt.COPY && a.end === _ ? a.end += T : (a = {
      kind: Wt.COPY,
      start: _,
      end: _ + T
      // oldBlocks: [checksum]
  ...
  copyExistingData(t, r) {
    return new Promise((n, i) => {
      const a = () => {
        ...
        if (o.kind !== Hv.OperationKind.COPY) {
          i(new Error("Task kind must be COPY"));
          return;
        }
        Uf(o, this.out, this.options.oldFileFd, i, () => {
          t++, a();
        });
      };
      a();
...
Yi.checkIsRangesSupported = oo;
const ao = Ee, Vl = Dr, Yl = rr;
...
function Wv(e, t, r, n, i) {
  ...
  for (let u = t.start; u < t.end; u++) {
    const p = t.tasks[u];
    p.kind === Yl.OperationKind.DOWNLOAD && (a += `${p.start}-${p.end - 1}, `, s.set(o, u), o++, l.push(p.end - p.start));
  }
  if (o <= 1) {
    const u = (p) => {
      if (p >= t.end) {
      ...
      const g = t.tasks[p++];
      if (g.kind === Yl.OperationKind.COPY)
        (0, Vl.copyData)(g, r, t.oldFileFd, i, () => u(p));
      else {
  ...
  const c = e.httpExecutor.createRequest(d, (u) => {
    if (!oo(u, i))
      return;
    const p = (0, ao.safeGetHeader)(u, "content-type"), g = /^multipart\/.+?(?:; boundary=(?:(?:"(.+)")|(?:([^\s]+))))$/i.exec(p);
    if (g == null) {
      i(new Error(`Content-Type "multipart/byteranges" is expected, but got "${p}"`));
      return;
    }
    const x = new Vl.DataSplitter(r, t, s, g[1] || g[2], l, n);
...
class eT {
  ...
  doDownload(t, r) {
    ...
    for (const l of i) {
      ...
      l.kind === Kn.OperationKind.DOWNLOAD ? a += d : o += d;
    }
    ...
    return n.info(`Full: ${Jl(s)}, To download: ${Jl(a)} (${Math.round(a / (s / 100))}%)`), this.downloadFile(i);
  }
  downloadFile(t) {
  ...
  async doDownloadFile(t, r) {
    ...
    await new Promise((o, s) => {
      ...
      if (!this.options.isUseMultipleRangeRequest && this.options.onProgress) {
        ...
        let _ = 0;
        for (const D of t)
          D.kind === Kn.OperationKind.DOWNLOAD && (b.push(D.end - D.start), _ += D.end - D.start);
        const F = {
          expectedByteCounts: b,
          grandTotal: _
        };
        d = new Zv.ProgressDifferentialDownloadCallbackTransform(F, this.options.cancellationToken, this.options.onProgress), l.push(d);
      }
      ...
      if (this.options.isUseMultipleRangeRequest) {
        g = (0, Kl.executeTasksUsingMultipleRangeRequests)(this, t, p, n, s), g(0);
        return;
      }
      let x = 0, w = null;
      ...
      T.redirect = "manual", g = (b) => {
        ...
        const D = t[b++];
        if (D.kind === Kn.OperationKind.COPY) {
          d && d.beginFileCopy(), (0, Jv.copyData)(D, p, n, s, () => g(b));
          return;
        }
        ...
        const H = this.httpExecutor.createRequest(T, (q) => {
          ...
          }), q.statusCode >= 400 && s((0, Br.createHttpError)(q)), q.pipe(p, {
            end: !1
          }), q.once("end", () => {
        ...
        H.on("redirect", (q, te, y) => {
          this.logger.info(`Redirect to ${tT(y)}`), w = y, (0, Br.configureRequestUrl)(new Qv.URL(w), T), H.followRedirect();
  ...
  request(t, r) {
    return new Promise((n, i) => {
      const a = this.httpExecutor.createRequest(t, (o) => {
        (0, Kl.checkIsRangesSupported)(o, i) && (o.on("error", i), o.on("aborted", () => {
...
const De = Ee, iT = dn, aT = Ci, oT = Rc, lr = kt, sT = be, La = Li, Bt = ue, Ht = Df, Ql = xn, lT = Gi, Zl = Of, cT = En, Ua = Hi, uT = Oc, fT = Xe, dT = Vi, cr = Nt;
class qo extends oT.EventEmitter {
  /**
  ...
  constructor(t, r) {
    ...
    }), r == null ? (this.app = new lT.ElectronAppAdapter(), this.httpExecutor = new Zl.ElectronHttpExecutor((a, o) => this.emit("login", a, o))) : (this.app = r, this.httpExecutor = null);
  ...
  async loadUpdateConfig() {
    return this._appUpdateConfigPath == null && (this._appUpdateConfigPath = this.app.appUpdateConfigPath), (0, sT.load)(await (0, lr.readFile)(this._appUpdateConfigPath, "utf-8"));
  }
  ...
  async differentialDownloadInstaller(t, r, n, i, a) {
    try {
      if (this._testOnlyOptions != null && !this._testOnlyOptions.isUseDifferentialDownload)
        return !0;
      const o = (0, fT.blockmapFiles)(t.url, this.app.version, r.updateInfoAndProvider.info.version);
...
class mT extends hT.AppUpdater {
  ...
  async spawnLog(t, r = [], n = void 0, i = "ignore") {
    return this._logger.info(`Executing: ${t} with args: ${r}`), new Promise((a, o) => {
      try {
        const s = { stdio: i, env: n, detached: !0 }, l = (0, ec.spawn)(t, r, s);
        l.on("error", (d) => {
          o(d);
...
class ST extends TT.BaseUpdater {
  ...
  doDownloadUpdate(t) {
    ...
    return this.executeDownload({
      ...
      task: async (i, a) => {
        ...
        (t.disableDifferentialDownload || await this.downloadDifferential(n, o, i, r, t)) && await this.httpExecutor.download(n.url, i, a), await (0, ET.chmod)(i, 493);
      }
    });
  }
  async downloadDifferential(t, r, n, i, a) {
    try {
      ...
      return this.listenerCount(nc.DOWNLOAD_PROGRESS) > 0 && (o.onProgress = (s) => this.emit(nc.DOWNLOAD_PROGRESS, s)), await new _T.FileWithEmbeddedBlockMapDifferentialDownloader(t.info, this.httpExecutor, o).download(), !1;
    } catch (o) {
  ...
  doInstall(t) {
    ...
    return t.isForceRunAfter ? this.spawnLog(n, [], o) : (o.APPIMAGE_EXIT_AFTER_INSTALL = "true", (0, rc.execFileSync)(n, [], { env: o })), !0;
  }
}
an.AppImageUpdater = ST;
var on = {};
Object.defineProperty(on, "__esModule", { value: !0 });
on.DebUpdater = void 0;
...
class NT extends PT.BaseUpdater {
  ...
  doDownloadUpdate(t) {
    ...
    return this.executeDownload({
      ...
      downloadUpdateOptions: t,
      task: async (i, a) => {
        this.listenerCount(oc.DOWNLOAD_PROGRESS) > 0 && (a.onProgress = (o) => this.emit(oc.DOWNLOAD_PROGRESS, o)), await this.httpExecutor.download(n.url, i, a);
      }
    });
  }
  get installerPath() {
...
const sc = Ee, Ma = kt, FT = Pt, lc = ue, $T = _p, LT = It, UT = me, cc = Ii, uc = dn;
class MT extends LT.AppUpdater {
  ...
  async doDownloadUpdate(t) {
    ...
    return this.executeDownload({
      ...
      downloadUpdateOptions: t,
      task: async (u, p) => {
        const g = lc.join(this.downloadedUpdateHelper.cacheDir, c), x = () => (0, Ma.pathExistsSync)(g) ? !t.disableDifferentialDownload : (n.info("Unable to locate previous update.zip for differential download (is this first install?), falling back to full download"), !1);
        let w = !0;
  ...
  async updateDownloaded(t, r) {
    var n;
    const i = r.downloadedFile, a = (n = t.info.size) !== null && n !== void 0 ? n : (await (0, Ma.stat)(i)).size, o = this._logger, s = `fileToProxy=${t.url.href}`;
    this.closeServerIfExists(), this.debug(`Creating proxy server for native Squirrel.Mac (${s})`), this.server = (0, $T.createServer)(), this.debug(`Proxy server for native Squirrel.Mac is created (${s})`), this.server.on("close", () => {
    ...
    return await new Promise((d, c) => {
      const u = (0, uc.randomBytes)(64).toString("base64").replace(/\//g, "_").replace(/\+/g, "-"), p = Buffer.from(`autoupdater:${u}`, "ascii"), g = `/${(0, uc.randomBytes)(64).toString("hex")}.zip`;
...
const Jn = Ee, pc = ue, HT = ht, qT = Tn, hc = Nt, XT = me, WT = kt, VT = Xo, mc = Sr;
class YT extends HT.BaseUpdater {
  ...
  doDownloadUpdate(t) {
    ...
    return this.executeDownload({
      ...
      task: async (i, a, o, s) => {
        ...
        if (c != null)
          throw await s(), (0, Jn.newError)(`New version ${t.updateInfoAndProvider.info.version} is not signed by the application owner: ${c}`, "ERR_UPDATER_INVALID_SIGNATURE");
        if (d && await this.differentialDownloadWebPackage(t, l, o, r))
          try {
            await this.httpExecutor.download(new mc.URL(l.path), o, {
  ...
  doInstall(t) {
    ...
    const a = () => {
      this.spawnLog(pc.join(process.resourcesPath, "elevate.exe"), [r].concat(n)).catch((o) => this.dispatchError(o));
    };
  ...
  async differentialDownloadWebPackage(t, r, n, i) {
    ...
    try {
      ...
      this.listenerCount(hc.DOWNLOAD_PROGRESS) > 0 && (a.onProgress = (o) => this.emit(hc.DOWNLOAD_PROGRESS, o)), await new qT.FileWithEmbeddedBlockMapDifferentialDownloader(r, this.httpExecutor, a).download();
    } catch (a) {
...
class Wo extends Ji {
  ...
  static async fromFile(t) {
    ...
    return new Wo(r, { fileInfo: { path: t, size: n.size } });
  }
  constructor(t, r) {
...
for (const [e, t] of Object.entries(lo))
  ;
...
function p_(e) {
  let t = "";
  for (const r of e)
    r >= 128 && r <= 159 && lo[r] ? t += lo[r] : t += String.fromCharCode(r);
  return t;
}
function W(e) {
...
class Vo {
  ...
  async readCentralDirectory() {
    ...
    if (r > 0) {
      ...
      for (let a = 0; a < n.nrOfEntriesOfSize; ++a) {
        const o = await this.tokenizer.readToken(N_);
  ...
  async unzip(t) {
    ...
    do {
      ...
      if (await this.tokenizer.ignore(i.extraFieldLength), i.dataDescriptor && i.compressedSize === 0) {
        ...
        nt(`Found data-descriptor-signature at pos=${this.tokenizer.position}`), a.handler && await this.inflate(i, L_(s), a.handler);
      } else
  ...
  async inflate(t, r, n) {
    ...
    const i = await Vo.decompressDeflateRaw(r);
    return n(i);
  }
              ...
              return {
                async handler(i) {
                  ...
                  if (o === -1) {
                    ...
                    a.includes(`ContentType="${s}"`) && (r = Ga(s));
                  } else {
...
`, { offset: 2, encoding: r }) ? {
  ...
  async fromBuffer(t) {
    ...
    if ((r == null ? void 0 : r.length) > 1)
      return this.fromTokenizer(so(r, this.tokenizerOptions));
  }
  async fromBlob(t) {
    const r = o_(t, this.tokenizerOptions);
    try {
  ...
  async readTiffHeader(t) {
    const r = (t ? Xt : ie).get(this.buffer, 2), n = (t ? _i : K).get(this.buffer, 4);
    if (r === 42) {
      if (n >= 6) {
...
function rb(e) {
  ...
  if (r !== -1) {
    var a, o, s;
    for (xc.lastIndex = r; o = xc.exec(t); ) {
      if (o.index !== r)
        throw new TypeError("invalid parameter format");
      r += o[0].length, a = o[1].toLowerCase(), s = o[2], s.charCodeAt(0) === 34 && (s = s.slice(1, -1), s.indexOf("\\") !== -1 && (s = s.replace(Z_, "$1"))), i.parameters[a] = s;
    }
    if (r !== t.length)
      throw new TypeError("invalid parameter format");
  }
 ...
 * MIT Licensed
 */
var ob = /^ *([A-Za-z0-9][A-Za-z0-9!#$&^_-]{0,126})\/([A-Za-z0-9][A-Za-z0-9!#$&^_.+-]{0,126}) *$/, sb = lb;
function lb(e) {
  if (!e)
    throw new TypeError("argument string is required");
  if (typeof e != "string")
    throw new TypeError("argument string is required to be a string");
  var t = ob.exec(e.toLowerCase());
  if (!t)
    throw new TypeError("invalid media type");
...
class Ko extends _n("FieldDecodingError") {
}
...
function hb(e) {
  const t = e.length;
  if (t & 1)
    throw new Ko("Buffer length must be even");
  for (let r = 0; r < t; r += 2) {
    const n = e[r];
    e[r] = e[r + 1], e[r + 1] = n;
  }
...
function fo(e, t) {
  if (e[0] === 255 && e[1] === 254)
    return fo(e.subarray(2), t);
  if (t === "utf-16le" && e[0] === 254 && e[1] === 255) {
    if (e.length & 1)
      throw new Ko("Expected even number of octets for 16-bit unicode string");
    return fo(hb(e), t);
  }
...
function td(e, t, r, n) {
  ...
  o &= 255 >> a;
  const s = 8 - a, l = n - s;
  return l < 0 ? o >>= 8 - a - n : l > 0 && (o <<= l, o |= td(e, t, r + s, l)), o;
}
function dA(e, t, r) {
  return td(e, t, r, 1) === 1;
}
  ...
  postMap(t, r) {
    switch (t.id) {
      case "UFID":
        {
          const n = t.value;
          n.owner_identifier === "http://musicbrainz.org" && (t.id += `:${n.owner_identifier}`, t.value = fo(n.identifier, "latin1"));
        }
        break;
      case "PRIV":
        {
  ...
  postMap(t) {
    switch (t.id) {
      case "WM/SharedUserRating": {
        const r = t.id.split(":");
        t.value = Qo.toRating(t.value), t.id = r[0];
        break;
      }
    }
  }
...
const po = /\[(\d{2}):(\d{2})\.(\d{2,3})]/;
function zb(e) {
  return po.test(e) ? Hb(e) : Gb(e);
}
function Gb(e) {
  return {
...
`), r = [];
  for (const n of t) {
    const i = n.match(po);
    if (i) {
      const a = Number.parseInt(i[1], 10), o = Number.parseInt(i[2], 10), s = i[3].length === 3 ? Number.parseInt(i[3], 10) : Number.parseInt(i[3], 10) * 10, l = (a * 60 + o) * 1e3 + s, d = n.replace(po, "").trim();
...
const Vb = {
  ...
  async load() {
    return (await import("./MpegParser-VjI7nkRg.js")).MpegParser;
  }
}, Yb = {
  parserType: "apev2",
  extensions: [".ape"],
  ...
  async load() {
    return (await import("./AsfParser-OFGK2zmm.js")).AsfParser;
  }
}, Jb = {
  parserType: "dsdiff",
  extensions: [".dff"],
  ...
  async load() {
    return (await import("./DsdiffParser-DGEjZEG0.js")).DsdiffParser;
  }
}, Qb = {
  parserType: "aiff",
  ...
  async load() {
    return (await import("./AiffParser-CYd1tS4x.js")).AIFFParser;
  }
}, Zb = {
  parserType: "dsf",
  extensions: [".dsf"],
  mimeTypes: ["audio/dsf"],
  async load() {
    return (await import("./DsfParser-D_jA0I85.js")).DsfParser;
  }
}, eS = {
  parserType: "flac",
  extensions: [".flac"],
  ...
  async load() {
    return (await import("./FlacParser-DpRV9imh.js").then((e) => e.d)).FlacParser;
  }
}, tS = {
  parserType: "matroska",
  ...
  async load() {
    return (await import("./MatroskaParser-xmBcM1gr.js")).MatroskaParser;
  }
}, rS = {
  parserType: "mp4",
  ...
  async load() {
    return (await import("./MP4Parser-DZXZbx_W.js")).MP4Parser;
  }
}, nS = {
  parserType: "musepack",
  extensions: [".mpc"],
  ...
  async load() {
    return (await import("./MusepackParser-DL4peKQX.js")).MusepackParser;
  }
}, iS = {
  parserType: "ogg",
  ...
  async load() {
    return (await import("./OggParser-CC68Yaql.js")).OggParser;
  }
}, aS = {
  parserType: "wavpack",
  extensions: [".wv", ".wvp"],
  ...
  async load() {
    return (await import("./WavPackParser-KYxJsutk.js")).WavPackParser;
  }
}, oS = {
  parserType: "riff",
  ...
  async load() {
    return (await import("./WaveParser-BGBWaiVe.js")).WaveParser;
  }
}, zt = Cr("music-metadata:parser:factory");
function sS(e) {
  const t = Yo.parse(e), r = sb(t.type);
  return {
    type: r.type,
    subtype: r.subtype,
    suffix: r.suffix,
  ...
  async parse(t, r, n) {
    if (t.supportsRandomAccess() ? (zt("tokenizer supports random-access, scanning for appending headers"), await DS(t, n)) : zt("tokenizer does not support random-access, cannot scan for appending headers"), !r) {
      ...
      if (t.fileInfo.mimeType && (r = this.findLoaderForContentType(t.fileInfo.mimeType)), !r && t.fileInfo.path && (r = this.findLoaderForExtension(t.fileInfo.path)), !r) {
        zt("Guess parser on content..."), await t.peekBuffer(s, { mayBeLess: !0 });
        const l = await Yf(s, { mpegOffsetTolerance: 10 });
        if (!l || !l.mime)
    ...
    const i = new Xb(n), a = await r.load(), o = new a(i, t, n ?? {});
    return zt(`Parser ${r.parserType} loaded`), await o.parse(), i.format.trackInfo && (i.format.hasAudio === void 0 && i.setFormat("hasAudio", !!i.format.trackInfo.find((s) => s.type === dt.audio)), i.format.hasVideo === void 0 && i.setFormat("hasVideo", !!i.format.trackInfo.find((s) => s.type === dt.video))), i.toCommonMetadata();
  }
  /**
...
const _S = /^[\x21-\x7e©][\x20-\x7e\x00()]{3}/, sd = {
  len: 4,
  get: (e, t) => {
    const r = ea(e.subarray(t, t + sd.len), "latin1");
    if (!r.match(_S))
      throw new Ko(`FourCC contains invalid characters: ${mb(r)} "${r}"`);
    return r;
  },
  put: (e, t, r) => {
    const n = dS(r, "latin1");
...
class At extends id {
  ...
  static parseTagFooter(t, r, n) {
    ...
    return so(r), new At(t, so(r), n).parseTags(i);
  }
  /**
    ...
    for (let i = 0; i < t.fields; i++) {
      ...
      switch (await this.tokenizer.ignore(1), n -= s.length + 1, a.flags.dataType) {
        case ti.text_utf8: {
          ...
          await Promise.all(d.map((c) => this.metadata.addTag(_c, s, c)));
          break;
        }
        case ti.binary:
          if (this.options.skipCovers)
            ...
            await this.tokenizer.readBuffer(l), o = Ec(l, 0, l.length);
            const d = ea(l.subarray(0, o), "utf-8"), c = l.subarray(o + 1);
            await this.metadata.addTag(_c, s, {
              description: d,
              data: c
            });
          }
...
class PS {
  ...
  getChannels(t) {
    ...
    return r.channels.cache.filter((i) => i.type === xs.GuildVoice).map((i) => ({
      id: i.id,
      name: i.name,
  ...
  async joinChannel(t, r) {
    ...
    if (!i || i.type !== xs.GuildVoice) throw new Error("Invalid channel");
    try {
  ...
  async playReceiverStream(t) {
    ...
    if (console.log("[DiscordBot] Starting Receiver Stream..."), this.streamInput = new Cp(), t) {
      ...
      const { spawn: i } = await import("node:child_process"), o = i(t, [
        "-i",
        "pipe:0",
      ...
      this.streamInput.pipe(o.stdin), o.on("error", (l) => {
      ...
      this.currentResource = s, (r = s.volume) == null || r.setVolume(1), this.player.play(s);
    } else {
...
const ho = process.env.VITE_DEV_SERVER_URL, wA = Oe.join(process.env.APP_ROOT, "dist-electron"), dd = Oe.join(process.env.APP_ROOT, "dist");
process.env.VITE_PUBLIC = ho ? Oe.join(process.env.APP_ROOT, "public") : dd;
let ee;
function pd() {
  ee = new Ic({
    width: 1200,
  ...
  }), ho ? ee.loadURL(ho) : ee.loadFile(Oe.join(dd, "index.html"));
}
...
Je.whenReady().then(() => {
  ...
  const e = new PS();
  se.handle("discord:login", async (n, i) => await e.login(i)), se.handle("discord:getGuilds", () => e.getGuilds()), se.handle("discord:getChannels", (n, i) => e.getChannels(i)), se.handle("discord:join", async (n, i, a) => await e.joinChannel(i, a)), se.handle("discord:leave", async () => await e.leaveChannel()), se.handle("discord:play", async (n, i) => await e.playFile(i, Ai)), se.handle("discord:stop", () => e.stop()), se.handle("discord:pause", () => e.pause()), se.handle("discord:resume", () => e.resume()), se.handle("discord:setVolume", (n, i) => e.setVolume(i)), se.handle("discord:status", () => e.getStatus()), se.handle("discord:startStreamMode", async () => await e.playReceiverStream(Ai)), se.on("discord:audio-chunk", (n, i) => {
    e.writeAudioChunk(new Uint8Array(i));
  }), se.handle("dialog:openDirectory", async () => {
    const { canceled: n, filePaths: i } = await ys.showOpenDialog(ee, {
      properties: ["openDirectory"]
    });
    return n ? null : i[0];
  }), se.handle("files:listMusic", async (n, i) => {
    if (!i) return [];
    try {
      const a = await Fn.readdir(i), o = [".mp3", ".wav", ".wma", ".m4a", ".flac", ".ogg", ".mp4", ".mov", ".wmv", ".avi"];
      return (await Promise.all(a.map(async (l) => {
        const d = Oe.join(i, l), c = Oe.extname(l).toLowerCase();
        if (!o.includes(c)) return null;
        try {
          const u = await Fn.stat(d);
          return {
            fullPath: d,
  ...
  }), se.handle("files:readBuffer", async (n, i) => {
    try {
      return await Fn.readFile(i);
    } catch (a) {
      return console.error("Error reading file:", a), null;
    }
  }), se.handle("files:getMetadata", async (n, i) => {
    try {
      const a = await OS(i);
      let o = null;
  ...
  }), se.handle("app:active-window", async () => {
    const n = Oe.join(process.env.APP_ROOT, "scripts/get-active-window.ps1");
    return await kS(n);
  });
  const t = ai(import.meta.url)("yt-dlp-wrap").default, r = async () => {
    const n = process.platform === "win32" ? "yt-dlp.exe" : "yt-dlp", i = Oe.join(Je.getPath("userData"), n);
    try {
      await Fn.access(i);
    } catch {
  ...
  se.handle("search:youtube", async (n, i) => {
    try {
...
`).map((l) => {
  ...
  }), se.handle("download:youtube", async (n, i, a, o) => {
    try {
      const s = await r(), l = ai(import.meta.url)("ffmpeg-static").replace("app.asar", "app.asar.unpacked");
      let d = a.replace(/[\\/:*?"<>|]/g, "_").trim();
      const { filePath: c } = await ys.showSaveDialog(ee, {
        title: "下載歌曲",
        defaultPath: `${d}.m4a`,
  ...
  }), se.handle("search:artistImage", async (n, i) => {
    try {
  ...
  }), se.handle("search:lyrics", async (n, i, a, o, s) => {
    try {
      const l = ai(import.meta.url)("get-artist-title");
      ...
      const d = (D) => {
        ...
        if (!D) return null;
        try {
          return ud("opencc-js").Converter({ from: "cn", to: "tw" })(D);
        } catch {
          return D;
        }
      };
  ...
  }), se.handle("update:check", () => {
    st.autoUpdater.checkForUpdates();
  }), se.handle("update:install", () => {
    st.autoUpdater.quitAndInstall(!0, !0);
  }), se.handle("app:version", () => Je.getVersion());
});
export {
  hA as A,
  id as B,
