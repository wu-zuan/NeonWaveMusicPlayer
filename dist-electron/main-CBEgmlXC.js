...
import Kt, { app as ft, BrowserWindow as vc, ipcMain as qe, dialog as fo } from "electron";
...
function vp(e) {
  xt.hasOwnProperty("O_SYMLINK") && process.version.match(/^v0\.6\.[0-2]|^v0\.5\./) && t(e), e.lutimes || r(e), e.chown = a(e.chown), e.fchown = a(e.fchown), e.lchown = a(e.lchown), e.chmod = n(e.chmod), e.fchmod = n(e.fchmod), e.lchmod = n(e.lchmod), e.chownSync = s(e.chownSync), e.fchownSync = s(e.fchownSync), e.lchownSync = s(e.lchownSync), e.chmodSync = i(e.chmodSync), e.fchmodSync = i(e.fchmodSync), e.lchmodSync = i(e.lchmodSync), e.stat = o(e.stat), e.fstat = o(e.fstat), e.lstat = o(e.lstat), e.statSync = l(e.statSync), e.fstatSync = l(e.fstatSync), e.lstatSync = l(e.lstatSync), e.chmod && !e.lchmod && (e.lchmod = function(c, f, p) {
    ...
    return function(f, p, g, v, x) {
      for (var T = 0; ; )
        try {
          return c.call(e, f, p, g, v, x);
        } catch (b) {
  ...
  function t(c) {
    c.lchmod = function(f, p, g) {
      ...
      var g = c.openSync(f, xt.O_WRONLY | xt.O_SYMLINK, p), v = !0, x;
      try {
  ...
  function r(c) {
    xt.hasOwnProperty("O_SYMLINK") && c.futimes ? (c.lutimes = function(f, p, g, v) {
      ...
      return x;
    }) : c.futimes && (c.lutimes = function(f, p, g, v) {
  ...
  function n(c) {
    return c && function(f, p, g) {
      return c.call(e, f, p, function(v) {
  ...
  function o(c) {
    return c && function(f, p, g) {
      ...
      return p ? c.call(e, f, p, v) : c.call(e, f, v);
    };
  }
  function l(c) {
    return c && function(f, p) {
...
const $e = ke, Xr = oe, Hp = st.mkdirs, qp = er.pathExists, Xp = Pc.utimesMillis, Wr = br;
function Wp(e, t, r, n) {
...
function Yp(e, t, r, n, i, a) {
  return t ? Kp(e, r, n, i, a) : $c(e, r, n, i, a);
}
function Kp(e, t, r, n, i) {
  if (n.overwrite)
    $e.unlink(r, (a) => a ? i(a) : $c(e, t, r, n, i));
...
function Jp(e, t, r, n) {
  return Qp(e) ? Zp(r, e, (i) => i ? n(i) : xo(e, t, r, n)) : xo(e, t, r, n);
}
function Qp(e) {
  return (e & 128) === 0;
}
...
function th(e, t, r, n, i, a) {
  return t ? Lc(r, n, i, a) : rh(e.mode, r, n, i, a);
}
...
function Lc(e, t, r, n) {
  $e.readdir(e, (i, a) => i ? n(i) : Uc(a, e, t, r, n));
}
...
function nh(e, t, r, n, i, a) {
  ...
  Wr.checkPaths(s, o, "copy", i, (l, d) => {
    if (l) return a(l);
    const { destStat: c } = d;
    Vp(c, s, o, i, (f) => f ? a(f) : Uc(e, r, n, i, a));
  });
}
...
var sh = Wp;
const Se = ke, Vr = oe, oh = st.mkdirsSync, lh = Pc.utimesMillisSync, Yr = br;
function ch(e, t, r) {
...
function uh(e, t, r, n) {
  ...
  return Se.existsSync(i) || oh(i), Mc(e, t, r, n);
}
function fh(e, t, r, n) {
...
function dh(e, t, r, n, i) {
  return t ? ph(e, r, n, i) : Bc(e, r, n, i);
}
function ph(e, t, r, n) {
  if (n.overwrite)
...
function xh(e, t, r, n, i) {
  return t ? jc(r, n, i) : wh(e.mode, r, n, i);
}
function wh(e, t, r, n) {
...
const wo = ke, zc = oe, ee = Tc, Kr = process.platform === "win32";
function Gc(e) {
  [
    "unlink",
    "chmod",
...
var Ih = gs;
gs.sync = Hc;
const li = ke, Ch = Pe.fromCallback, qc = Ih;
function Rh(e, t) {
...
const Dh = Pe.fromPromise, Xc = Zt, Wc = oe, Vc = st, Yc = Si, _o = Dh(async function(t) {
  let r;
  try {
...
const kh = Pe.fromCallback, Kc = oe, Tt = ke, Jc = st;
function Nh(e, t) {
  function r() {
    Tt.writeFile(e, "", (n) => {
      if (n) return t(n);
...
const Lh = Pe.fromCallback, Qc = oe, vt = ke, Zc = st, Uh = er.pathExists, { areIdentical: eu } = br;
function Mh(e, t, r) {
  function n(i, a) {
    vt.link(i, a, (s) => {
      if (s) return r(s);
...
const Yh = Pe.fromCallback, ru = oe, Ye = Zt, nu = st, Kh = nu.mkdirs, Jh = nu.mkdirsSync, iu = qh, Qh = iu.symlinkPaths, Zh = iu.symlinkPathsSync, au = Vh, em = au.symlinkType, tm = au.symlinkTypeSync, rm = er.pathExists, { areIdentical: su } = br;
function nm(e, t, r, n) {
...
const { createFile: Ao, createFileSync: Io } = $h, { createLink: Co, createLinkSync: Ro } = jh, { createSymlink: Oo, createSymlinkSync: Do } = am;
var sm = {
  // file
  createFile: Ao,
  createFileSync: Io,
...
const Ai = Pe, { stringify: ou, stripBom: lu } = ys;
...
const ym = Pe.fromCallback, Gr = ke, cu = oe, uu = st, xm = er.pathExists;
function wm(e, t, r, n) {
...
var Om = De;
const Dm = ke, Ba = oe, Pm = ms.copy, fu = Si.remove, km = st.mkdirp, Nm = er.pathExists, Po = br;
function Fm(e, t, r, n) {
  ...
  Po.checkPaths(e, t, "move", r, (a, s) => {
    ...
    Po.checkParentPaths(e, o, t, "move", (d) => {
      if (d) return n(d);
      if ($m(t)) return ko(e, t, i, l, n);
      km(Ba.dirname(t), (c) => c ? n(c) : ko(e, t, i, l, n));
    });
  });
}
function $m(e) {
...
var Um = Fm;
const du = ke, ja = oe, Mm = ms.copySync, pu = Si.removeSync, Bm = st.mkdirpSync, No = br;
function jm(e, t, r) {
  r = r || {};
  const n = r.overwrite || r.clobber || !1, { srcStat: i, isChangingCase: a = !1 } = No.checkPathsSync(e, t, "move", r);
  return No.checkParentPathsSync(e, i, t, "move"), zm(t) || Bm(ja.dirname(t)), Gm(e, t, n, a);
}
function zm(e) {
...
var Oe = {}, Ga = { exports: {} }, Fn = { exports: {} }, ca, Fo;
function Jm() {
  if (Fo) return ca;
  Fo = 1;
...
function e0() {
  if (Mo) return da;
  Mo = 1;
  const e = Ti, t = bc, r = Zm(), { env: n } = process;
  let i;
...
Oe.parseJson = f0;
Oe.configureRequestOptionsFromUrl = yu;
Oe.configureRequestUrl = Es;
Oe.safeGetHeader = xr;
Oe.configureRequestOptions = ui;
Oe.safeStringifyJson = fi;
const i0 = cn, a0 = mu, s0 = Dt, o0 = ln, gu = _r, l0 = It, jo = Sr, c0 = fn, Nr = (0, a0.default)("electron-builder");
...
const vu = cn, Tu = Sr, v0 = "options.name must be either a string or a Buffer", zo = (0, vu.randomBytes)(16);
zo[0] = zo[0] | 1;
const ii = {}, V = [];
for (let e = 0; e < 256; e++) {
...
function T0(e, t, r, n, i = Hr.ASCII) {
  ...
  if (typeof e != "string" && !Buffer.isBuffer(e))
    throw (0, Tu.newError)(v0, "ERR_INVALID_UUID_NAME");
...
(function(e) {
  (function(t) {
    ...
    var f = "[CDATA[", p = "DOCTYPE", g = "http://www.w3.org/XML/1998/namespace", v = "http://www.w3.org/2000/xmlns/", x = { xml: g, xmlns: v }, T = /[:_A-Za-z\u00C0-\u00D6\u00D8-\u00F6\u00F8-\u02FF\u0370-\u037D\u037F-\u1FFF\u200C-\u200D\u2070-\u218F\u2C00-\u2FEF\u3001-\uD7FF\uF900-\uFDCF\uFDF0-\uFFFD]/, b = /[:_A-Za-z\u00C0-\u00D6\u00D8-\u00F6\u00F8-\u02FF\u0370-\u037D\u037F-\u1FFF\u200C-\u200D\u2070-\u218F\u2C00-\u2FEF\u3001-\uD7FF\uF900-\uFDCF\uFDF0-\uFFFD\u00B7\u0300-\u036F\u203F-\u2040.\d-]/, _ = /[#:_A-Za-z\u00C0-\u00D6\u00D8-\u00F6\u00F8-\u02FF\u0370-\u037D\u037F-\u1FFF\u200C-\u200D\u2070-\u218F\u2C00-\u2FEF\u3001-\uD7FF\uF900-\uFDCF\uFDF0-\uFFFD]/, N = /[#:_A-Za-z\u00C0-\u00D6\u00D8-\u00F6\u00F8-\u02FF\u0370-\u037D\u037F-\u1FFF\u200C-\u200D\u2070-\u218F\u2C00-\u2FEF\u3001-\uD7FF\uF900-\uFDCF\uFDF0-\uFFFD\u00B7\u0300-\u036F\u203F-\u2040.\d-]/;
    function $(h) {
      return h === " " || h === `
` || h === "\r" || h === "	";
    }
...
Char: ` + h.c), u = new Error(u), h.error = u, j(h, "onerror", u), h;
    ...
    function O(h, u) {
      ...
      return u && h === "xmlns" && (K = "xmlns", re = ""), { prefix: K, local: re };
    }
    function M(h) {
      ...
      if (h.opt.xmlns) {
        var u = O(h.attribName, !0), S = u.prefix, E = u.local;
        if (S === "xmlns")
...
Actual: ` + h.attribValue
    ...
    function Z(h) {
      var u = h.entity, S = u.toLowerCase(), E, K = "";
      return h.ENTITIES[u] ? h.ENTITIES[u] : h.ENTITIES[S] ? h.ENTITIES[S] : (u = S, u.charAt(0) === "#" && (u.charAt(1) === "x" ? (u = u.slice(2), E = parseInt(u, 16), K = E.toString(16)) : (u = u.slice(1), E = parseInt(u, 10), K = E.toString(10))), u = u.replace(/^0+/, ""), isNaN(E) || K.toLowerCase() !== u || E < 0 || E > 1114111 ? (A(h, "Invalid character entity"), "&" + h.entity + ";") : String.fromCodePoint(E));
    }
    function he(h, u) {
      u === "<" ? (h.state = y.OPEN_WAKA, h.startTagPosition = h.position) : $(u) || (A(h, "Non-whitespace before first tag."), h.textNode = u, h.state = y.TEXT);
    }
    function U(h, u) {
      var S = "";
          ...
          case y.TEXT:
            if (u.sawRoot && !u.closedRoot) {
              for (var re = S - 1; E && E !== "<" && E !== "&"; )
                E = U(h, S++), E && u.trackPosition && (u.position++, E === `
` ? (u.line++, u.column = 0) : u.column++);
              u.textNode += h.substring(re, S - 1);
            }
          ...
          case y.SGML_DECL:
            ...
            u.doctype && u.doctype !== !0 && u.sgmlDecl ? (u.state = y.DOCTYPE_DTD, u.doctype += "<!" + u.sgmlDecl + E, u.sgmlDecl = "") : (u.sgmlDecl + E).toUpperCase() === f ? (B(u, "onopencdata"), u.state = y.CDATA, u.sgmlDecl = "", u.cdata = "") : (u.sgmlDecl + E).toUpperCase() === p ? (u.state = y.DOCTYPE, (u.doctype || u.sawRoot) && A(
              u,
          ...
          case y.CDATA:
            for (var re = S - 1; E && E !== "]"; )
              E = U(h, S++), E && u.trackPosition && (u.position++, E === `
` ? (u.line++, u.column = 0) : u.column++);
            u.cdata += h.substring(re, S - 1), E === "]" && (u.state = y.CDATA_ENDING);
            continue;
          case y.CDATA_ENDING:
...
Xa.prototype.extend = function(t) {
  ...
  return i.implicit = (this.implicit || []).concat(r), i.explicit = (this.explicit || []).concat(n), i.compiledImplicit = Xo(i, "implicit"), i.compiledExplicit = Xo(i, "explicit"), i.compiledTypeMap = M0(i.compiledImplicit, i.compiledExplicit), i;
};
var Iu = Xa, B0 = Ne, Cu = new B0("tag:yaml.org,2002:str", {
  kind: "scalar",
  construct: function(e) {
    return e !== null ? e : "";
  }
}), j0 = Ne, Ru = new j0("tag:yaml.org,2002:seq", {
  kind: "sequence",
  construct: function(e) {
    return e !== null ? e : [];
  }
}), z0 = Ne, Ou = new z0("tag:yaml.org,2002:map", {
  kind: "mapping",
  construct: function(e) {
    return e !== null ? e : {};
  }
...
var Pu = new H0("tag:yaml.org,2002:null", {
  kind: "scalar",
  resolve: q0,
  construct: X0,
  predicate: W0,
...
var ku = new V0("tag:yaml.org,2002:bool", {
  kind: "scalar",
  resolve: Y0,
  construct: K0,
  predicate: J0,
...
var Nu = new Z0("tag:yaml.org,2002:int", {
  kind: "scalar",
  resolve: ng,
  construct: ig,
  predicate: ag,
...
var $u = new sg("tag:yaml.org,2002:float", {
  kind: "scalar",
  resolve: lg,
  construct: cg,
  predicate: dg,
...
var ju = new pg("tag:yaml.org,2002:timestamp", {
  kind: "scalar",
  resolve: hg,
  construct: mg,
  instanceOf: Date,
...
var zu = new yg("tag:yaml.org,2002:merge", {
  kind: "scalar",
  resolve: xg
...
var Gu = new wg("tag:yaml.org,2002:binary", {
  kind: "scalar",
  resolve: Eg,
  construct: vg,
  predicate: _g,
...
var Hu = new bg("tag:yaml.org,2002:omap", {
  kind: "sequence",
  resolve: Ig,
  construct: Cg
...
var qu = new Rg("tag:yaml.org,2002:pairs", {
  kind: "sequence",
  resolve: Dg,
  construct: Pg
...
var Xu = new kg("tag:yaml.org,2002:set", {
  kind: "mapping",
  resolve: Fg,
  construct: $g
}), Ss = Uu.extend({
...
}), Ht = Ke, Wu = pn, Lg = N0, Ug = Ss, Ct = Object.prototype.hasOwnProperty, di = 1, Vu = 2, Yu = 3, pi = 4, ga = 1, Mg = 2, Wo = 3, Bg = /[\x00-\x08\x0B\x0C\x0E-\x1F\x7F-\x84\x86-\x9F\uFFFE\uFFFF]|[\uD800-\uDBFF](?![\uDC00-\uDFFF])|(?:[^\uD800-\uDBFF]|^)[\uDC00-\uDFFF]/, jg = /[\x85\u2028\u2029]/, zg = /[,\[\]\{\}]/, Ku = /^(?:!|!!|![a-z\-]+!)$/i, Ju = /^(?:!|[^,\[\]\{\}])(?:%[0-9a-f]{2}|[0-9a-z\-#;\/\?:@&=\+\$,_\.!~\*'\(\)\[\]])*$/i;
function Vo(e) {
...
function tf(e, t) {
  ...
  return r.snippet = Lg(r), new Wu(t, r);
}
function L(e, t) {
  throw tf(e, t);
}
...
function Jg(e, t) {
  var r = !0, n, i, a, s = e.tag, o, l = e.anchor, d, c, f, p, g, v = /* @__PURE__ */ Object.create(null), x, T, b, _;
...
function Qg(e, t) {
  ...
  for (e.kind = "scalar", e.result = ""; f !== 0; )
    if (f = e.input.charCodeAt(++e.position), f === 43 || f === 45)
      ga === i ? i = f === 43 ? Wo : Mg : L(e, "repeat of a chomping mode identifier");
    else if ((c = qg(f)) >= 0)
...
function Zg(e, t, r) {
  var n, i, a, s, o, l, d = e.tag, c = e.anchor, f = {}, p = /* @__PURE__ */ Object.create(null), g = null, v = null, x = null, T = !1, b = !1, _;
  if (e.firstTabInLine !== -1) return !1;
  for (e.anchor !== null && (e.anchorMap[e.anchor] = f), _ = e.input.charCodeAt(e.position); _ !== 0; ) {
    if (!T && e.firstTabInLine !== -1 && (e.position = e.firstTabInLine, L(e, "tab characters must not be used in indentation")), n = e.input.charCodeAt(e.position + 1), a = e.line, (_ === 63 || _ === 58) && Le(n))
      _ === 63 ? (T && (dr(e, f, p, g, v, null, s, o, l), g = v = x = null), b = !0, T = !0, i = !0) : T ? (T = !1, i = !0) : L(e, "incomplete explicit mapping pair; a key node is missed; or followed by a non-tabulated empty line"), e.position += 1, _ = n;
    else {
      ...
      if (e.line === a) {
        ...
        if (_ === 58)
          _ = e.input.charCodeAt(++e.position), Le(_) || L(e, "a whitespace character is expected after the key-value separator within a block mapping"), T && (dr(e, f, p, g, v, null, s, o, l), g = v = x = null), b = !0, T = !1, i = !1, g = e.tag, v = e.result;
        else if (b)
    ...
    if ((e.line === a || e.lineIndent > t) && (T && (s = e.line, o = e.lineStart, l = e.position), Tr(e, t, pi, !0, i) && (T ? v = e.result : x = e.result), T || (dr(e, f, p, g, v, x, s, o, l), g = v = x = null), fe(e, !0, -1), _ = e.input.charCodeAt(e.position)), (e.line === a || e.lineIndent > t) && _ !== 0)
      L(e, "bad indentation of a mapping entry");
    else if (e.lineIndent < t)
      break;
  }
  return T && dr(e, f, p, g, v, null, s, o, l), b && (e.tag = d, e.anchor = c, e.kind = "mapping", e.result = f), b;
}
function ey(e) {
  var t, r = !1, n = !1, i, a, s;
...
function Tr(e, t, r, n, i) {
  var a, s, o, l = 1, d = !1, c = !1, f, p, g, v, x, T;
  ...
  if (o && (o = d || i), (l === 1 || pi === r) && (di === r || Vu === r ? x = t : x = t + 1, T = e.position - e.lineStart, l === 1 ? o && (Qo(e, T) || Zg(e, T, x)) || Jg(e, x) ? c = !0 : (s && Qg(e, x) || Yg(e, x) || Kg(e, x) ? c = !0 : ry(e) ? (c = !0, (e.tag !== null || e.anchor !== null) && L(e, "alias node should not have any properties")) : Vg(e, x, di === r) && (c = !0, e.tag === null && (e.tag = "?")), e.anchor !== null && (e.anchorMap[e.anchor] = e.result)) : l === 0 && (c = o && Qo(e, T))), e.tag === null)
    ...
    if (Ct.call(e.typeMap[e.kind || "fallback"], e.tag))
      ...
      for (v = null, g = e.typeMap.multi[e.kind || "fallback"], f = 0, p = g.length; f < p; f += 1)
...
_s.loadAll = iy;
_s.load = ay;
var nf = {}, Oi = Ke, hn = pn, sy = Ss, af = Object.prototype.toString, sf = Object.prototype.hasOwnProperty, Cs = 65279, oy = 9, Qr = 10, ly = 13, cy = 32, uy = 33, fy = 34, Wa = 35, dy = 37, py = 38, hy = 39, my = 42, of = 44, gy = 45, mi = 58, yy = 61, xy = 62, wy = 63, Ey = 64, lf = 91, cf = 93, vy = 96, uf = 123, Ty = 124, ff = 125, Ie = {};
Ie[0] = "\\0";
Ie[7] = "\\a";
Ie[8] = "\\b";
Ie[9] = "\\t";
...
function Oy(e) {
  return en(e) && e !== Cs && !gi(e) && e !== gy && e !== wy && e !== mi && e !== of && e !== lf && e !== cf && e !== uf && e !== ff && e !== Wa && e !== py && e !== my && e !== uy && e !== Ty && e !== yy && e !== xy && e !== hy && e !== fy && e !== dy && e !== Ey && e !== vy;
}
function Dy(e) {
  return !gi(e) && e !== mi;
}
...
function Py(e, t, r, n, i, a, s, o) {
  var l, d = 0, c = null, f = !1, p = !1, g = n !== -1, v = -1, x = Oy(Br(e, 0)) && Dy(Br(e, e.length - 1));
  if (t || s)
  ...
  return !f && !p ? x && !s && !i(e) ? pf : a === Zr ? ur : Ya : r > 9 && df(e) ? ur : s ? a === Zr ? ur : Ya : p ? mf : hf;
}
function ky(e, t, r, n, i) {
  e.dump = function() {
    ...
    switch (Py(
      ...
      case mf:
        return ">" + rl(t, e.indent) + nl(Zo(Ny(t, s), a));
      case ur:
        return '"' + Fy(t) + '"';
      default:
...
function Uy(e, t, r, n) {
  ...
  for (o = 0, l = s.length; o < l; o += 1)
    p = "", (!n || i !== "") && (p += Va(e, t)), d = s[o], c = r[d], e.replacer && (c = e.replacer.call(r, d, c)), dt(e, t + 1, d, !0, !0, !0) && (f = e.tag !== null && e.tag !== "?" || e.dump && e.dump.length > 1024, f && (e.dump && Qr === e.dump.charCodeAt(0) ? p += "?" : p += "? "), p += e.dump, f && (p += Va(e, t)), dt(e, t + 1, c, !0, f) && (e.dump && Qr === e.dump.charCodeAt(0) ? p += ":" : p += ": ", p += e.dump, i += p));
  e.tag = a, e.dump = i || "{}";
}
function sl(e, t, r) {
  var n, i, a, s, o, l;
...
function dt(e, t, r, n, i, a, s) {
  ...
  if (c && (f = e.duplicates.indexOf(r), p = f !== -1), (e.tag !== null && e.tag !== "?" || p || e.indent !== 2 && t > 0) && (i = !1), p && e.usedDuplicates[f])
    ...
    if (c && p && !e.usedDuplicates[f] && (e.usedDuplicates[f] = !0), o === "[object Object]")
      n && Object.keys(e.dump).length !== 0 ? (Uy(e, t, e.dump, i), p && (e.dump = "&ref_" + f + e.dump)) : (Ly(e, t, e.dump), p && (e.dump = "&ref_" + f + " " + e.dump));
    else if (o === "[object Array]")
      n && e.dump.length !== 0 ? (e.noArrayIndent && !s && t > 0 ? al(e, t - 1, e.dump, i) : al(e, t, e.dump, i), p && (e.dump = "&ref_" + f + e.dump)) : ($y(e, t, e.dump), p && (e.dump = "&ref_" + f + " " + e.dump));
...
Di.Lazy = zy;
var Ja = { exports: {} };
const Gy = "2.0.0", yf = 256, Hy = Number.MAX_SAFE_INTEGER || /* istanbul ignore next */
9007199254740991, qy = 16, Xy = yf - 6, Wy = [
  "major",
  "premajor",
  "minor",
  "preminor",
...
const Un = ki, { MAX_LENGTH: ll, MAX_SAFE_INTEGER: Mn } = Pi, { safeRe: Bn, t: jn } = mn, Zy = Os, { compareIdentifiers: ya } = wf;
let ex = class nt {
  constructor(t, r) {
...
var _x = Tx;
const dl = Fe, bx = (e, t, r) => new dl(e, r).compare(new dl(t, r));
var Je = bx;
const Sx = Je, Ax = (e, t, r) => Sx(t, e, r);
var Ix = Ax;
const Cx = Je, Rx = (e, t) => Cx(e, t, !0);
var Ox = Rx;
const pl = Fe, Dx = (e, t, r) => {
...
var Ns = Yx;
const Kx = Ef, Jx = vf, Qx = Ni, Zx = ks, ew = Ps, tw = Ns, rw = (e, t, r, n) => {
  switch (t) {
    case "===":
...
function Fi() {
  ...
  wa = t;
  const r = Os, { safeRe: n, t: i } = mn, a = Tf, s = ki, o = Fe, l = Qe();
  return wa;
}
...
var vw = Ew;
const Ea = Fe, Tw = Qe(), gl = Ni, _w = (e, t) => {
  e = new Tw(e, t);
  let r = new Ea("0.0.0");
...
var Iw = Aw;
const Cw = Fe, _f = Fi(), { ANY: Rw } = _f, Ow = Qe(), Dw = $i, yl = Ni, xl = Ps, Pw = Ns, kw = ks, Nw = (e, t, r, n) => {
  ...
  for (let d = 0; d < t.set.length; ++d) {
    ...
    let f = null, p = null;
    if (c.forEach((g) => {
      g.semver === Rw && (g = new _f(">=0.0.0")), f = f || g, p = p || g, i(g.semver, f.semver, n) ? f = g : s(g.semver, p.semver, n) && (p = g);
...
var Bw = Mw;
const wl = Qe(), jw = (e, t, r) => (e = new wl(e, r), t = new wl(t, r), e.intersects(t, r));
var zw = jw;
const Gw = $i, Hw = Je;
var qw = (e, t, r) => {
  const n = [];
...
const El = Qe(), $s = Fi(), { ANY: va } = $s, $r = $i, Ls = Je, Xw = (e, t, r = {}) => {
  if (e === t)
    return !0;
  ...
  return !0;
}, Ww = [new $s(">=0.0.0-0")], vl = [new $s(">=0.0.0")], Vw = (e, t, r) => {
  if (e === t)
    return !0;
  if (e.length === 1 && e[0].semver === va) {
    if (t.length === 1 && t[0].semver === va)
      return !0;
    r.includePrerelease ? e = Ww : e = vl;
  }
  if (t.length === 1 && t[0].semver === va) {
...
var Yw = Xw;
const Ta = mn, bl = Pi, Kw = Fe, Sl = wf, Jw = Ir, Qw = ix, Zw = ox, eE = cx, tE = fx, rE = hx, nE = yx, iE = Ex, aE = _x, sE = Je, oE = Ix, lE = Ox, cE = Ds, uE = Nx, fE = Lx, dE = Ni, pE = Ps, hE = Ef, mE = vf, gE = ks, yE = Ns, xE = Tf, wE = sw, EE = Fi(), vE = Qe(), TE = $i, _E = pw, bE = yw, SE = vw, AE = bw, IE = Iw, CE = Fs, RE = Lw, OE = Bw, DE = zw, PE = qw, kE = Yw;
var bf = {
  parse: Jw,
  valid: Qw,
  clean: Zw,
...
(function(e, t) {
  ...
  U[Q] = U[R] = U[I] = U[D] = U[A] = U[k] = U[O] = U[M] = U[X] = !0, U[o] = U[l] = U[j] = U[c] = U[B] = U[f] = U[p] = U[g] = U[x] = U[T] = U[_] = U[ie] = U[ue] = U[Y] = U[q] = !1;
  var Ze = typeof Re == "object" && Re && Re.Object === Object && Re, h = typeof self == "object" && self && self.Object === Object && self, u = Ze || h || Function("return this")(), S = t && !t.nodeType && t, E = S && !0 && e && !e.nodeType && e, K = E && E.exports === S, re = K && Ze.process, le = function() {
    try {
  ...
  var cd = Array.prototype, ud = Function.prototype, bn = Object.prototype, Ki = u["__core-js_shared__"], Ws = ud.toString, et = bn.hasOwnProperty, Vs = function() {
  ...
  ), Ks = K ? u.Buffer : void 0, Sn = u.Symbol, Js = u.Uint8Array, Qs = bn.propertyIsEnumerable, dd = cd.splice, Nt = Sn ? Sn.toStringTag : void 0, Zs = Object.getOwnPropertySymbols, pd = Ks ? Ks.isBuffer : void 0, hd = od(Object.keys, Object), Ji = rr(u, "DataView"), Or = rr(u, "Map"), Qi = rr(u, "Promise"), Zi = rr(u, "Set"), ea = rr(u, "WeakMap"), Dr = rr(Object, "create"), md = Lt(Ji), gd = Lt(Or), yd = Lt(Qi), xd = Lt(Zi), wd = Lt(ea), eo = Sn ? Sn.prototype : void 0, ta = eo ? eo.valueOf : void 0;
  function Ft(m) {
  ...
  ot.prototype.clear = Sd, ot.prototype.delete = Ad, ot.prototype.get = Id, ot.prototype.has = Cd, ot.prototype.set = Rd;
  function $t(m) {
    var w = -1, C = m == null ? 0 : m.length;
    for (this.clear(); ++w < C; ) {
      var F = m[w];
...
const FE = cn, $E = Dt, Al = NE, zt = Pt, qr = oe;
class LE {
  constructor(t) {
...
var yn = {}, Xe = {}, HE = "[object Symbol]", Af = /[\\^$.*+?()[\]{}|]/g, qE = RegExp(Af.source), XE = typeof Re == "object" && Re && Re.Object === Object && Re, WE = typeof self == "object" && self && self.Object === Object && self, VE = XE || WE || Function("return this")(), YE = Object.prototype, KE = YE.toString, Cl = VE.Symbol, Rl = Cl ? Cl.prototype : void 0, Ol = Rl ? Rl.toString : void 0;
function JE(e) {
  if (typeof e == "string")
    return e;
  if (ZE(e))
...
function tv(e) {
  return e = ev(e), e && qE.test(e) ? e.replace(Af, "\\$&") : e;
}
var rv = tv;
...
const ct = xe, pr = bf, hv = _r, hr = Xe, Za = pe, Ca = /\/tag\/([^/]+)$/;
...
${o}`, "ERR_UPDATER_INVALID_RELEASE_FEED");
    ...
    const v = async (T) => {
      ...
      try {
        ...
        throw _ instanceof ct.HttpError && _.statusCode === 404 ? (0, ct.newError)(`Cannot find ${p} in the latest release artifacts (${g}): ${_.stack || _.message}`, "ERR_UPDATER_CHANNEL_FILE_NOT_FOUND") : _;
      }
    };
    try {
      let T = this.channel;
    ...
    const x = (0, Za.parseUpdateInfo)(f, p, g);
...
const ar = xe, yv = Te, xv = oe, $l = _r, Ll = Xe, wv = Ot, Ev = pe;
...
Ui.createClient = Av;
const Hn = xe, Tv = Mi, Ul = yn, _v = Ot, bv = Bi, Sv = ji;
function Df(e) {
...
function Iv(e, t, r) {
  ...
  const c = i.get(l);
  let f = 0;
  const { checksumToOffset: p, checksumToOldSize: g } = Rv(n.get(l), d.offset, r);
  let v = s.offset;
...
Cr.copyData = Pf;
const qn = xe, Ov = Dt, Dv = ln, Pv = tr, jl = Buffer.from(`\r
\r
`);
var Et;
(function(e) {
...
function Fv(e, t, r, n, i) {
  ...
  const c = e.httpExecutor.createRequest(d, (f) => {
    if (!ts(f, i))
      return;
    const p = (0, es.safeGetHeader)(f, "content-type"), g = /^multipart\/.+?(?:; boundary=(?:(?:"(.+)")|(?:([^\s]+))))$/i.exec(p);
    if (g == null) {
...
const Lr = xe, Da = Pt, Uv = Dt, Mv = Cr, Bv = _r, Xn = tr, Hl = Gi, jv = Hi;
class zv {
    ...
    await new Promise((s, o) => {
      ...
      T.redirect = "manual", g = (b) => {
        ...
        if ($.kind === Xn.OperationKind.COPY) {
          d && d.beginFileCopy(), (0, Mv.copyData)($, p, n, o, () => g(b));
          return;
        }
...
const Ce = xe, Xv = cn, Wv = Ti, Vv = _c, sr = Pt, Yv = Te, Pa = Di, Mt = oe, Gt = bf, Xl = gn, Kv = Li, Wl = Sf, Jv = yn, ka = Ui, Qv = Sc, Zv = Xe, eT = zi, or = kt;
class Ms extends Vv.EventEmitter {
  ...
  constructor(t, r) {
    ...
    }), r == null ? (this.app = new Kv.ElectronAppAdapter(), this.httpExecutor = new Wl.ElectronHttpExecutor((a, s) => this.emit("login", a, s))) : (this.app = r, this.httpExecutor = null);
  ...
  async executeDownload(t) {
    ...
    const c = o();
    let f = Mt.join(d, c);
    const p = s == null ? null : Mt.join(d, `package-${a}${Mt.extname(s.path) || ".7z"}`), g = async (_) => (await l.setDownloadedFile(f, p, i, r, c, _), await t.done({
      ...i,
      downloadedFile: f
    }), p == null ? [f] : [f, p]), v = this._logger, x = await l.validateDownloadedPath(f, i, r, v);
    if (x != null)
    ...
    try {
      await t.task(b, n, p, T), await (0, Ce.retry)(() => (0, sr.rename)(b, f), 60, 500, 0, 0, (_) => _ instanceof Error && /^EBUSY:/.test(_.message));
    } catch (_) {
...
const Yl = xe, Kl = vi, lT = Pt, cT = Dt, Ur = oe, uT = pt, fT = wn, dT = pe, Jl = kt;
class pT extends uT.BaseUpdater {
  ...
  async downloadDifferential(t, r, n, i, a) {
    try {
      ...
      return this.listenerCount(Jl.DOWNLOAD_PROGRESS) > 0 && (s.onProgress = (o) => this.emit(Jl.DOWNLOAD_PROGRESS, o)), await new fT.FileWithEmbeddedBlockMapDifferentialDownloader(t.info, this.httpExecutor, s).download(), !1;
    } catch (s) {
...
const tc = xe, Na = Pt, _T = Dt, rc = oe, bT = mp, ST = At, AT = pe, nc = vi, ic = cn;
  ...
  async doDownloadUpdate(t) {
    ...
    return this.executeDownload({
      ...
      task: async (f, p) => {
        ...
        let x = !0;
        v() && (x = await this.differentialDownloadInstaller(l, t, f, d, c)), x && await this.httpExecutor.download(l.url, f, p);
      },
      done: async (f) => {
...
const Wn = xe, oc = oe, PT = pt, kT = wn, lc = kt, NT = pe, FT = Pt, $T = Bs, cc = _r;
class LT extends PT.BaseUpdater {
  ...
  async differentialDownloadWebPackage(t, r, n, i) {
    ...
    try {
      ...
      this.listenerCount(lc.DOWNLOAD_PROGRESS) > 0 && (a.onProgress = (s) => this.emit(lc.DOWNLOAD_PROGRESS, s)), await new kT.FileWithEmbeddedBlockMapDifferentialDownloader(r, this.httpExecutor, a).download();
    } catch (a) {
...
function zT(e) {
  try {
    ...
    return t instanceof ReadableStreamDefaultReader ? new uc(t) : new jT(t);
  } catch (t) {
...
var Xi = function(e, t, r, n, i) {
  ...
  var s, o, l, d = a * 8 - i - 1, c = (1 << d) - 1, f = c >> 1, p = i === 23 ? Math.pow(2, -24) - Math.pow(2, -77) : 0, g = n ? 0 : a - 1, v = n ? 1 : -1, x = t < 0 || t === 0 && 1 / t < 0 ? 1 : 0;
  for (t = Math.abs(t), isNaN(t) || t === 1 / 0 ? (o = isNaN(t) ? 1 : 0, s = c) : (s = Math.floor(Math.log(t) / Math.LN2), t * (l = Math.pow(2, -s)) < 1 && (s--, l *= 2), s + f >= 1 ? t += p / l : t += p * Math.pow(2, 1 - f), t * l >= 2 && (s++, l /= 2), s + f >= c ? (o = 0, s = c) : s + f >= 1 ? (o = (t * l - 1) * Math.pow(2, i), s = s + f) : (o = t * Math.pow(2, f - 1) * Math.pow(2, i), s = 0)); i >= 8; e[r + g] = o & 255, g += v, o /= 256, i -= 8)
    ;
...
const tt = Ar("tokenizer:inflate"), $a = 256 * 1024, __ = zf(gr.DataDescriptor), Vn = zf(gr.EndOfCentralDirectory);
class zs {
  constructor(t) {
 ...
 * MIT Licensed
 */
var pc = /; *([!#$%&'*+.^_`|~0-9A-Za-z-]+) *= *("(?:[\u000b\u0020\u0021\u0023-\u005b\u005d-\u007e\u0080-\u00ff]|\\[\u000b\u0020-\u00ff])*"|[!#$%&'*+.^_`|~0-9A-Za-z-]+) */g, B_ = /^[\u000b\u0020-\u007e\u0080-\u00ff]+$/, Hf = /^[!#$%&'*+.^_`|~0-9A-Za-z-]+$/, j_ = /\\([\u000b\u0020-\u00ff])/g, z_ = /([\\"])/g, qf = /^[!#$%&'*+.^_`|~0-9A-Za-z-]+\/[!#$%&'*+.^_`|~0-9A-Za-z-]+$/;
Gs.format = G_;
Gs.parse = H_;
function G_(e) {
...
const $b = {
  ...
  async load() {
    return (await import("./MpegParser-1H8dWfGN.js")).MpegParser;
  }
}, Lb = {
  parserType: "apev2",
  extensions: [".ape"],
  ...
  async load() {
    return (await import("./AsfParser-BKSru9et.js")).AsfParser;
  }
}, Mb = {
  parserType: "dsdiff",
  extensions: [".dff"],
  ...
  async load() {
    return (await import("./DsdiffParser-By-aWARP.js")).DsdiffParser;
  }
}, Bb = {
  parserType: "aiff",
  ...
  async load() {
    return (await import("./AiffParser-OC2NcG_c.js")).AIFFParser;
  }
}, jb = {
  parserType: "dsf",
  extensions: [".dsf"],
  mimeTypes: ["audio/dsf"],
  async load() {
    return (await import("./DsfParser-CfGK7soc.js")).DsfParser;
  }
}, zb = {
  parserType: "flac",
  extensions: [".flac"],
  ...
  async load() {
    return (await import("./FlacParser-BTCbzmy0.js").then((e) => e.d)).FlacParser;
  }
}, Gb = {
  parserType: "matroska",
  ...
  async load() {
    return (await import("./MatroskaParser-BKWBFJ0U.js")).MatroskaParser;
  }
}, Hb = {
  parserType: "mp4",
  ...
  async load() {
    return (await import("./MP4Parser-CtNAdIT3.js")).MP4Parser;
  }
}, qb = {
  parserType: "musepack",
  extensions: [".mpc"],
  ...
  async load() {
    return (await import("./MusepackParser-ByJ1KDNx.js")).MusepackParser;
  }
}, Xb = {
  parserType: "ogg",
  ...
  async load() {
    return (await import("./OggParser-Ygns3kNE.js")).OggParser;
  }
}, Wb = {
  parserType: "wavpack",
  extensions: [".wv", ".wvp"],
  ...
  async load() {
    return (await import("./WavPackParser-BGA1zN5W.js")).WavPackParser;
  }
}, Vb = {
  parserType: "riff",
  ...
  async load() {
    return (await import("./WaveParser-D4m6_MWu.js")).WaveParser;
  }
...
const fS = /^[\x21-\x7e©][\x20-\x7e\x00()]{3}/, td = {
  len: 4,
  get: (e, t) => {
...
const id = je.dirname(fp(import.meta.url));
process.env.APP_ROOT = je.join(id, "..");
const ls = process.env.VITE_DEV_SERVER_URL, rA = je.join(process.env.APP_ROOT, "dist-electron"), ad = je.join(process.env.APP_ROOT, "dist");
process.env.VITE_PUBLIC = ls ? je.join(process.env.APP_ROOT, "public") : ad;
let J;
function sd() {
  J = new vc({
    width: 1200,
    ...
    webPreferences: {
      preload: je.join(id, "preload.mjs"),
      webSecurity: !1,
  ...
  }), ls ? J.loadURL(ls) : J.loadFile(je.join(ad, "index.html"));
}
...
ft.whenReady().then(() => {
  sd(), qe.handle("dialog:openDirectory", async () => {
    ...
    try {
      ...
      if (i.common.picture && i.common.picture.length > 0) {
        ...
        a = `data:${s.format};base64,${s.data.toString("base64")}`;
      }
      return {
    ...
    try {
      ...
      return d ? new Promise((c, f) => {
        ...
        g.on("progress", (v) => {
          ...
          console.error("yt-dlp error:", v), f(new Error(`下載錯誤: ${v.message}`));
        }), g.on("close", () => {
          c(d);
        });
      }) : null;
    ...
    try {
      ...
      if (a) {
        ...
        if (d.ok) {
          ...
          if (c && c.length > 0) {
            const f = c.find((p) => p.syncedLyrics) || c[0];
