...
var cp = (e, t, r) => t in e ? lp(e, t, { enumerable: !0, configurable: !0, writable: !0, value: r }) : e[t] = r;
var na = (e, t, r) => cp(e, typeof t != "symbol" ? t + "" : t, r);
import Kt, { app as ft, BrowserWindow as Ec, ipcMain as qe, dialog as fo } from "electron";
import { createRequire as up } from "node:module";
import { fileURLToPath as fp } from "node:url";
import je from "node:path";
import ia, { open as dp } from "node:fs/promises";
import Dt from "fs";
...
var xt = pp, xp = process.cwd, ti = null, wp = process.env.GRACEFUL_FS_PLATFORM || process.platform;
process.cwd = function() {
  return ti || (ti = xp.call(process)), ti;
};
try {
  process.cwd();
} catch {
...
if (typeof process.chdir == "function") {
  var po = process.chdir;
  process.chdir = function(e) {
    ti = null, po.call(process, e);
...
function vp(e) {
  xt.hasOwnProperty("O_SYMLINK") && process.version.match(/^v0\.6\.[0-2]|^v0\.5\./) && t(e), e.lutimes || r(e), e.chown = a(e.chown), e.fchown = a(e.fchown), e.lchown = a(e.lchown), e.chmod = n(e.chmod), e.fchmod = n(e.fchmod), e.lchmod = n(e.lchmod), e.chownSync = s(e.chownSync), e.fchownSync = s(e.fchownSync), e.lchownSync = s(e.lchownSync), e.chmodSync = i(e.chmodSync), e.fchmodSync = i(e.fchmodSync), e.lchmodSync = i(e.lchmodSync), e.stat = o(e.stat), e.fstat = o(e.fstat), e.lstat = o(e.lstat), e.statSync = l(e.statSync), e.fstatSync = l(e.fstatSync), e.lstatSync = l(e.lstatSync), e.chmod && !e.lchmod && (e.lchmod = function(c, f, h) {
    ...
    function f(h, g, v, x, T, b) {
      var _;
      if (b && typeof b == "function") {
        var N = 0;
        _ = function($, ie, ue) {
          if ($ && $.code === "EAGAIN" && N < 10)
            return N++, c.call(e, h, g, v, x, T, _);
          b.apply(this, arguments);
        };
      }
      return c.call(e, h, g, v, x, T, _);
    }
    return Object.setPrototypeOf && Object.setPrototypeOf(f, c), f;
  }(e.read), e.readSync = typeof e.readSync != "function" ? e.readSync : /* @__PURE__ */ function(c) {
    return function(f, h, g, v, x) {
      for (var T = 0; ; )
        try {
          return c.call(e, f, h, g, v, x);
        } catch (b) {
  ...
  function t(c) {
    c.lchmod = function(f, h, g) {
      ...
      var g = c.openSync(f, xt.O_WRONLY | xt.O_SYMLINK, h), v = !0, x;
      try {
        x = c.fchmodSync(g, h), v = !1;
      } finally {
        if (v)
          try {
            c.closeSync(g);
  ...
  function r(c) {
    xt.hasOwnProperty("O_SYMLINK") && c.futimes ? (c.lutimes = function(f, h, g, v) {
      c.open(f, xt.O_SYMLINK, function(x, T) {
        if (x) {
          v && v(x);
          return;
        }
      ...
      var v = c.openSync(f, xt.O_SYMLINK), x, T = !0;
      try {
        x = c.futimesSync(v, h, g), T = !1;
      } finally {
        if (T)
          try {
            c.closeSync(v);
  ...
  function a(c) {
    return c && function(f, h, g, v) {
      return c.call(e, f, h, g, function(x) {
...
function _p(e) {
  ...
  function r(n, i) {
    ...
    ho.call(this), this.path = n, this.fd = null, this.writable = !0, this.flags = "w", this.encoding = "binary", this.mode = 438, this.bytesWritten = 0, i = i || {};
...
var se = Dt, Ip = Ep, Cp = Tp, Rp = bp, Pn = cs, ve, si;
...
if (!se[ve]) {
  var Dp = Re[ve] || [];
  Sc(se, Dp), se.close = function(e) {
    function t(r, n) {
      return e.call(se, r, function(i) {
        i || mo(), typeof n == "function" && n.apply(this, arguments);
      });
    }
    ...
    function t(r) {
      e.apply(se, arguments), mo();
    }
    return Object.defineProperty(t, si, {
      value: e
    }), t;
  }(se.closeSync), /\bgfs4\b/i.test(process.env.NODE_DEBUG || "") && process.on("exit", function() {
    Wt(se[ve]), vc.equal(se[ve].length, 0);
  });
}
Re[ve] || Sc(Re, se[ve]);
var ke = us(Rp(se));
process.env.TEST_GRACEFUL_FS_GLOBAL_PATCH && !se.__patched && (ke = us(se), se.__patched = !0);
function us(e) {
  Ip(e), e.gracefulify = us, e.createReadStream = ie, e.createWriteStream = ue;
  var t = e.readFile;
  e.readFile = r;
  function r(y, q, j) {
  ...
  function _() {
    var y = this;
    Ue(y.path, y.flags, y.mode, function(q, j) {
...
const Ic = Zt, { checkPath: Cc } = Ac, Rc = (e) => {
  const t = { mode: 511 };
  return typeof e == "number" ? e : { ...t, ...e }.mode;
};
ds.makeDir = async (e, t) => (Cc(e), Ic.mkdir(e, {
  mode: Rc(t),
  recursive: !0
}));
ds.makeDirSync = (e, t) => (Cc(e), Ic.mkdirSync(e, {
  mode: Rc(t),
  recursive: !0
}));
const kp = Pe.fromPromise, { makeDir: Np, makeDirSync: aa } = ds, sa = kp(Np);
var st = {
  mkdirs: sa,
  mkdirsSync: aa,
  // alias
...
const Fp = Pe.fromPromise, Oc = Zt;
function $p(e) {
  return Oc.access(e).then(() => !0).catch(() => !1);
}
var er = {
  pathExists: Fp($p),
  pathExistsSync: Oc.existsSync
};
const yr = ke;
function Lp(e, t, r, n) {
  yr.open(e, "r+", (i, a) => {
...
function Pc(e, t, r, n, i) {
  ...
  wr.stat(s, { bigint: !0 }, (o, l) => o ? o.code === "ENOENT" ? i() : i(o) : un(t, l) ? i(new Error(_i(e, r, n))) : Pc(e, t, s, n, i));
}
function kc(e, t, r, n) {
...
var br = {
  ...
  checkPathsSync: Gp,
  checkParentPaths: Pc,
  checkParentPathsSync: kc,
  isSrcSubdir: ps,
  areIdentical: un
};
const $e = ke, Xr = oe, Hp = st.mkdirs, qp = er.pathExists, Xp = Dc.utimesMillis, Wr = br;
function Wp(e, t, r, n) {
  typeof r == "function" && !n ? (n = r, r = {}) : typeof r == "function" && (r = { filter: r }), n = n || function() {
    ...
    Wr.checkParentPaths(e, s, t, "copy", (l) => l ? n(l) : r.filter ? Nc(go, o, e, t, r, n) : go(o, e, t, r, n));
  });
}
...
function Vp(e, t, r, n, i) {
  return n.filter ? Nc(oi, e, t, r, n, i) : oi(e, t, r, n, i);
}
...
function Yp(e, t, r, n, i, a) {
  return t ? Kp(e, r, n, i, a) : Fc(e, r, n, i, a);
}
function Kp(e, t, r, n, i) {
  if (n.overwrite)
    $e.unlink(r, (a) => a ? i(a) : Fc(e, t, r, n, i));
...
function Jp(e, t, r, n) {
  return Qp(e) ? Zp(r, e, (i) => i ? n(i) : yo(e, t, r, n)) : yo(e, t, r, n);
}
function Qp(e) {
  return (e & 128) === 0;
}
...
function th(e, t, r, n, i, a) {
  return t ? $c(r, n, i, a) : rh(e.mode, r, n, i, a);
}
function rh(e, t, r, n, i) {
  $e.mkdir(r, (a) => {
    if (a) return i(a);
    $c(t, r, n, (s) => s ? i(s) : bi(r, e, i));
  });
}
function $c(e, t, r, n) {
  $e.readdir(e, (i, a) => i ? n(i) : Lc(a, e, t, r, n));
}
...
function nh(e, t, r, n, i, a) {
  ...
  Wr.checkPaths(s, o, "copy", i, (l, d) => {
    if (l) return a(l);
    const { destStat: c } = d;
    Vp(c, s, o, i, (f) => f ? a(f) : Lc(e, r, n, i, a));
  });
}
...
var sh = Wp;
const Se = ke, Vr = oe, oh = st.mkdirsSync, lh = Dc.utimesMillisSync, Yr = br;
function ch(e, t, r) {
...
function uh(e, t, r, n) {
  ...
  return Se.existsSync(i) || oh(i), Uc(e, t, r, n);
}
function fh(e, t, r, n) {
...
function Uc(e, t, r, n) {
  ...
  if (a.isDirectory()) return xh(a, e, t, r, n);
...
function dh(e, t, r, n, i) {
  return t ? ph(e, r, n, i) : Mc(e, r, n, i);
}
function ph(e, t, r, n) {
  if (n.overwrite)
    return Se.unlinkSync(r), Mc(e, t, r, n);
  if (n.errorOnExist)
    throw new Error(`'${r}' already exists`);
}
function Mc(e, t, r, n) {
  return Se.copyFileSync(t, r), n.preserveTimestamps && hh(e.mode, t, r), hs(r, e.mode);
}
function hh(e, t, r) {
  return mh(e) && gh(r, e), yh(t, r);
}
function mh(e) {
  return (e & 128) === 0;
}
...
function xh(e, t, r, n, i) {
  return t ? Bc(r, n, i) : wh(e.mode, r, n, i);
}
function wh(e, t, r, n) {
  return Se.mkdirSync(r), Bc(t, r, n), hs(r, e);
}
function Bc(e, t, r) {
...
const xo = ke, jc = oe, ee = vc, Kr = process.platform === "win32";
function zc(e) {
  [
    "unlink",
    "chmod",
...
function gs(e, t, r) {
  let n = 0;
  typeof t == "function" && (r = t, t = {}), ee(e, "rimraf: missing path"), ee.strictEqual(typeof e, "string", "rimraf: path should be a string"), ee.strictEqual(typeof r, "function", "rimraf: callback function required"), ee(t, "rimraf: invalid options argument provided"), ee.strictEqual(typeof t, "object", "rimraf: options should be object"), zc(t), wo(e, t, function i(a) {
    if (a) {
      if ((a.code === "EBUSY" || a.code === "ENOTEMPTY" || a.code === "EPERM") && n < t.maxBusyTries) {
        n++;
        const s = n * 100;
        return setTimeout(() => wo(e, t, i), s);
      }
    ...
    t.unlink(e, (a) => {
      if (a) {
        if (a.code === "ENOENT")
          return r(null);
        if (a.code === "EPERM")
          return Kr ? Eo(e, t, a, r) : ri(e, t, a, r);
        if (a.code === "EISDIR")
          return ri(e, t, a, r);
      }
      return r(a);
...
function Ah(e, t) {
  if (ee(e), ee(t), t.readdirSync(e).forEach((r) => Gc(jc.join(e, r), t)), Kr) {
    const r = Date.now();
    do
      try {
...
var Ih = gs;
gs.sync = Gc;
const li = ke, Ch = Pe.fromCallback, Hc = Ih;
function Rh(e, t) {
...
const Dh = Pe.fromPromise, qc = Zt, Xc = oe, Wc = st, Vc = Si, To = Dh(async function(t) {
  let r;
  try {
  ...
  return Promise.all(r.map((n) => Vc.remove(Xc.join(t, n))));
});
function _o(e) {
  let t;
  try {
...
const kh = Pe.fromCallback, Yc = oe, Tt = ke, Kc = st;
function Nh(e, t) {
  function r() {
    Tt.writeFile(e, "", (n) => {
      if (n) return t(n);
  ...
  Tt.stat(e, (n, i) => {
    ...
    const a = Yc.dirname(e);
    Tt.stat(a, (s, o) => {
      if (s)
        return s.code === "ENOENT" ? Kc.mkdirs(a, (l) => {
          if (l) return t(l);
          r();
        }) : t(s);
...
function Fh(e) {
  ...
  try {
    ...
    if (n && n.code === "ENOENT") Kc.mkdirsSync(r);
    else throw n;
  }
  Tt.writeFileSync(e, "");
}
...
const Lh = Pe.fromCallback, Jc = oe, vt = ke, Qc = st, Uh = er.pathExists, { areIdentical: Zc } = br;
function Mh(e, t, r) {
  function n(i, a) {
    vt.link(i, a, (s) => {
      if (s) return r(s);
...
function Bh(e, t) {
  ...
  return vt.existsSync(n) || Qc.mkdirsSync(n), vt.linkSync(e, t);
}
var jh = {
  createLink: Lh(Mh),
  createLinkSync: Bh
};
const _t = oe, zr = ke, zh = er.pathExists;
function Gh(e, t, r) {
  if (_t.isAbsolute(e))
    ...
    }));
  {
    ...
    return zh(i, (a, s) => a ? r(a) : s ? r(null, {
      toCwd: i,
      toDst: e
...
const Yh = Pe.fromCallback, tu = oe, Ye = Zt, ru = st, Kh = ru.mkdirs, Jh = ru.mkdirsSync, nu = qh, Qh = nu.symlinkPaths, Zh = nu.symlinkPathsSync, iu = Vh, em = iu.symlinkType, tm = iu.symlinkTypeSync, rm = er.pathExists, { areIdentical: au } = br;
function nm(e, t, r, n) {
...
function im(e, t, r) {
  ...
  const a = tu.dirname(t);
  return Ye.existsSync(a) || Jh(a), Ye.symlinkSync(e, t, r);
}
var am = {
  createSymlink: Yh(nm),
  createSymlinkSync: im
};
const { createFile: So, createFileSync: Ao } = $h, { createLink: Io, createLinkSync: Co } = jh, { createSymlink: Ro, createSymlinkSync: Oo } = am;
var sm = {
  // file
  createFile: So,
  createFileSync: Ao,
...
var ys = { stringify: om, stripBom: lm };
let Er;
try {
  Er = ke;
} catch {
...
const Ai = Pe, { stringify: su, stripBom: ou } = ys;
...
const ym = Pe.fromCallback, Gr = ke, lu = oe, cu = st, xm = er.pathExists;
function wm(e, t, r, n) {
  typeof r == "function" && (n = r, r = "utf8");
  const i = lu.dirname(e);
  xm(i, (a, s) => {
    if (a) return n(a);
...
function Em(e, ...t) {
  const r = lu.dirname(e);
  if (Gr.existsSync(r))
    return Gr.writeFileSync(e, ...t);
  cu.mkdirsSync(r), Gr.writeFileSync(e, ...t);
}
var xs = {
  outputFile: ym(wm),
  outputFileSync: Em
};
const { stringify: vm } = ys, { outputFile: Tm } = xs;
async function _m(e, t, r = {}) {
  const n = vm(t, r);
  await Tm(e, n, r);
}
var bm = _m;
const { stringify: Sm } = ys, { outputFileSync: Am } = xs;
function Im(e, t, r) {
  const n = Sm(t, r);
  Am(e, n, r);
}
...
var Om = De;
const Dm = ke, Ba = oe, Pm = ms.copy, uu = Si.remove, km = st.mkdirp, Nm = er.pathExists, Do = br;
function Fm(e, t, r, n) {
  typeof r == "function" && (n = r, r = {}), r = r || {};
  const i = r.overwrite || r.clobber || !1;
  Do.checkPaths(e, t, "move", r, (a, s) => {
    if (a) return n(a);
    const { srcStat: o, isChangingCase: l = !1 } = s;
    Do.checkParentPaths(e, o, t, "move", (d) => {
      if (d) return n(d);
      if ($m(t)) return Po(e, t, i, l, n);
      km(Ba.dirname(t), (c) => c ? n(c) : Po(e, t, i, l, n));
    });
  });
}
function $m(e) {
...
function Po(e, t, r, n, i) {
  ...
  if (r)
    return uu(t, (a) => a ? i(a) : oa(e, t, r, i));
  Nm(t, (a, s) => a ? i(a) : s ? i(new Error("dest already exists.")) : oa(e, t, r, i));
}
function oa(e, t, r, n) {
...
var Um = Fm;
const fu = ke, ja = oe, Mm = ms.copySync, du = Si.removeSync, Bm = st.mkdirpSync, ko = br;
function jm(e, t, r) {
  r = r || {};
  const n = r.overwrite || r.clobber || !1, { srcStat: i, isChangingCase: a = !1 } = ko.checkPathsSync(e, t, "move", r);
  return ko.checkParentPathsSync(e, i, t, "move"), zm(t) || Bm(ja.dirname(t)), Gm(e, t, n, a);
}
function zm(e) {
...
function Gm(e, t, r, n) {
  ...
  if (r)
    return du(t), la(e, t, r);
  if (fu.existsSync(t)) throw new Error("dest already exists.");
  return la(e, t, r);
}
function la(e, t, r) {
  try {
...
var Oe = {}, Ga = { exports: {} }, Fn = { exports: {} }, ca, No;
function Jm() {
  if (No) return ca;
  No = 1;
  ...
  function e(t) {
    ...
    function n(f) {
      ...
      return T.namespace = f, T.useColors = n.useColors(), T.color = n.selectColor(f), T.extend = i, T.destroy = n.destroy, Object.defineProperty(T, "enabled", {
        enumerable: !0,
        configurable: !1,
        get: () => g !== null ? g : (v !== n.namespaces && (v = n.namespaces, x = n.enabled(f)), x),
        set: (b) => {
          g = b;
        }
...
var $n = { exports: {} }, fa, Lo;
function Zm() {
  return Lo || (Lo = 1, fa = (e, t = process.argv) => {
...
function e0() {
  if (Uo) return da;
  Uo = 1;
  const e = Ti, t = _c, r = Zm(), { env: n } = process;
  let i;
...
typeof process > "u" || process.type === "renderer" || process.browser === !0 || process.__nwjs ? Ga.exports = Qm() : Ga.exports = t0();
var hu = Ga.exports;
const Ar = /* @__PURE__ */ yp(hu);
var fn = {};
...
Oe.parseJson = f0;
Oe.configureRequestOptionsFromUrl = gu;
Oe.configureRequestUrl = Es;
Oe.safeGetHeader = xr;
Oe.configureRequestOptions = ui;
Oe.safeStringifyJson = fi;
const i0 = cn, a0 = hu, s0 = Dt, o0 = ln, mu = _r, l0 = It, Bo = Sr, c0 = fn, Nr = (0, a0.default)("electron-builder");
...
`));
    ...
    const d = (l = t.statusCode) !== null && l !== void 0 ? l : 0, c = d >= 300 && d < 400, f = xr(t, "location");
    if (c && f != null) {
  ...
  static prepareRedirectUrlOptions(t, r) {
    const n = gu(t, { ...r }), i = n.headers;
    if (i != null && i.authorization) {
      const a = new mu.URL(t);
...
function gu(e, t) {
  const r = ui(t);
  return Es(new mu.URL(e), r), r;
}
function Es(e, t) {
  t.protocol = e.protocol, t.hostname = e.hostname, e.port ? t.port = e.port : t.port && delete t.port, t.path = e.pathname + e.search;
}
class qa extends o0.Transform {
  ...
  validate() {
    if (this._actual == null)
      throw (0, Bo.newError)("Not finished yet", "ERR_STREAM_NOT_FINISHED");
    if (this._actual !== this.expected)
      throw (0, Bo.newError)(`${this.algorithm} checksum mismatch, expected ${this.expected}, got ${this._actual}`, "ERR_CHECKSUM_MISMATCH");
    return null;
  }
}
Oe.DigestTransform = qa;
function d0(e, t, r) {
...
function p0(e, t) {
  if (!d0(xr(t, "X-Checksum-Sha2"), e.options.sha2, e.callback))
    return;
  const r = [];
...
class h0 {
  ...
  get value() {
    ...
    if (this._value !== void 0 && yu(this.selected, t))
      return this._value;
    this.selected = t;
...
function yu(e, t) {
  if (typeof e == "object" && e !== null && (typeof t == "object" && t !== null)) {
    ...
    return i.length === a.length && i.every((s) => yu(e[s], t[s]));
  }
  return e === t;
}
var Ci = {};
...
vs.retry = wu;
const w0 = It;
async function wu(e, t, r, n = 0, i = 0, a) {
  var s;
  ...
  try {
    ...
    if ((!((s = a == null ? void 0 : a(l)) !== null && s !== void 0) || s) && t > 0 && !o.cancelled)
      return await new Promise((d) => setTimeout(d, r + n * i)), await wu(e, t - 1, r, n, i + 1, a);
    throw l;
  }
}
var Ts = {};
...
const Eu = cn, vu = Sr, v0 = "options.name must be either a string or a Buffer", jo = (0, Eu.randomBytes)(16);
jo[0] = jo[0] | 1;
const ii = {}, V = [];
for (let e = 0; e < 256; e++) {
...
function T0(e, t, r, n, i = Hr.ASCII) {
  ...
  if (typeof e != "string" && !Buffer.isBuffer(e))
    throw (0, vu.newError)(v0, "ERR_INVALID_UUID_NAME");
  ...
  (function(t) {
    ...
    function n(p, u) {
      if (!(this instanceof n))
        return new n(p, u);
      var S = this;
      a(S), S.q = S.c = "", S.bufferCheckPosition = t.MAX_BUFFER_LENGTH, S.opt = u || {}, S.opt.lowercase = S.opt.lowercase || S.opt.lowercasetags, S.looseCase = S.opt.lowercase ? "toLowerCase" : "toUpperCase", S.tags = [], S.closed = S.closedRoot = S.sawRoot = !1, S.tag = S.error = null, S.strict = !!p, S.noscript = !!(p || S.opt.noscript), S.state = y.BEGIN, S.strictEntities = S.opt.strictEntities, S.ENTITIES = S.strictEntities ? Object.create(t.XML_ENTITIES) : Object.create(t.ENTITIES), S.attribList = [], S.opt.xmlns && (S.ns = Object.create(x)), S.opt.unquotedAttributeValues === void 0 && (S.opt.unquotedAttributeValues = !p), S.trackPosition = S.opt.position !== !1, S.trackPosition && (S.position = S.line = S.column = 0), j(S, "onready");
    }
    ...
    var f = "[CDATA[", h = "DOCTYPE", g = "http://www.w3.org/XML/1998/namespace", v = "http://www.w3.org/2000/xmlns/", x = { xml: g, xmlns: v }, T = /[:_A-Za-z\u00C0-\u00D6\u00D8-\u00F6\u00F8-\u02FF\u0370-\u037D\u037F-\u1FFF\u200C-\u200D\u2070-\u218F\u2C00-\u2FEF\u3001-\uD7FF\uF900-\uFDCF\uFDF0-\uFFFD]/, b = /[:_A-Za-z\u00C0-\u00D6\u00D8-\u00F6\u00F8-\u02FF\u0370-\u037D\u037F-\u1FFF\u200C-\u200D\u2070-\u218F\u2C00-\u2FEF\u3001-\uD7FF\uF900-\uFDCF\uFDF0-\uFFFD\u00B7\u0300-\u036F\u203F-\u2040.\d-]/, _ = /[#:_A-Za-z\u00C0-\u00D6\u00D8-\u00F6\u00F8-\u02FF\u0370-\u037D\u037F-\u1FFF\u200C-\u200D\u2070-\u218F\u2C00-\u2FEF\u3001-\uD7FF\uF900-\uFDCF\uFDF0-\uFFFD]/, N = /[#:_A-Za-z\u00C0-\u00D6\u00D8-\u00F6\u00F8-\u02FF\u0370-\u037D\u037F-\u1FFF\u200C-\u200D\u2070-\u218F\u2C00-\u2FEF\u3001-\uD7FF\uF900-\uFDCF\uFDF0-\uFFFD\u00B7\u0300-\u036F\u203F-\u2040.\d-]/;
    function $(p) {
      return p === " " || p === `
` || p === "\r" || p === "	";
    }
    ...
    function B(p, u, S) {
      p.textNode && Q(p), j(p, u, S);
    }
    function Q(p) {
      p.textNode = R(p.opt, p.textNode), p.textNode && j(p, "ontext", p.textNode), p.textNode = "";
    }
    function R(p, u) {
...
Line: ` + p.line + `
Column: ` + p.column + `
Char: ` + p.c), u = new Error(u), p.error = u, j(p, "onerror", u), p;
    }
    function D(p) {
      return p.sawRoot && !p.closedRoot && A(p, "Unclosed root tag"), p.state !== y.BEGIN && p.state !== y.BEGIN_WHITESPACE && p.state !== y.TEXT && I(p, "Unexpected end"), Q(p), p.c = "", p.closed = !0, j(p, "onend"), n.call(p, p.strict, p.opt), p;
    }
    function A(p, u) {
...
Actual: ` + p.attribValue
    ...
    function X(p, u) {
      if (p.opt.xmlns) {
        ...
        for (var re = 0, le = p.attribList.length; re < le; re++) {
          var we = p.attribList[re], _e = we[0], ht = we[1], de = O(_e, !0), We = de.prefix, Yi = de.local, Tn = We === "" ? "" : S.ns[We] || "", Rr = {
            name: _e,
            value: ht,
            prefix: We,
            local: Yi,
          ...
          ), Rr.uri = We), p.tag.attributes[_e] = Rr, B(p, "onattribute", Rr);
        }
        p.attribList.length = 0;
      }
      p.tag.isSelfClosing = !!u, p.sawRoot = !0, p.tags.push(p.tag), B(p, "onopentag", p.tag), u || (!p.noscript && p.tagName.toLowerCase() === "script" ? p.state = y.SCRIPT : p.state = y.TEXT, p.tag = null, p.tagName = ""), p.attribName = p.attribValue = "", p.attribList.length = 0;
    }
    function z(p) {
      if (!p.tagName) {
        A(p, "Weird empty close tag."), p.textNode += "</>", p.state = y.TEXT;
        return;
      }
      if (p.script) {
        if (p.tagName !== "script") {
      ...
      if (u < 0) {
        A(p, "Unmatched closing tag: " + p.tagName), p.textNode += "</" + p.tagName + ">", p.state = y.TEXT;
        return;
      }
      p.tagName = S;
      for (var re = p.tags.length; re-- > u; ) {
        ...
        for (var _e in le.ns)
          we[_e] = le.ns[_e];
        var ht = p.tags[p.tags.length - 1] || p;
        p.opt.xmlns && le.ns !== ht.ns && Object.keys(le.ns).forEach(function(de) {
          var We = le.ns[de];
          B(p, "onclosenamespace", { prefix: de, uri: We });
        });
      }
    ...
    function he(p, u) {
      u === "<" ? (p.state = y.OPEN_WAKA, p.startTagPosition = p.position) : $(u) || (A(p, "Non-whitespace before first tag."), p.textNode = u, p.state = y.TEXT);
    }
    function U(p, u) {
      var S = "";
...
` ? (u.line++, u.column = 0) : u.column++), u.state) {
          case y.BEGIN:
            if (u.state = y.BEGIN_WHITESPACE, E === "\uFEFF")
              continue;
            he(u, E);
            continue;
...
` ? (u.line++, u.column = 0) : u.column++);
            ...
            E === "<" && !(u.sawRoot && u.closedRoot && !u.strict) ? (u.state = y.OPEN_WAKA, u.startTagPosition = u.position) : (!$(E) && (!u.sawRoot || u.closedRoot) && A(u, "Text data outside of root node."), E === "&" ? u.state = y.TEXT_ENTITY : u.textNode += E);
            continue;
          case y.SCRIPT:
            E === "<" ? u.state = y.SCRIPT_ENDING : u.script += E;
            continue;
          case y.SCRIPT_ENDING:
            E === "/" ? u.state = y.CLOSE_TAG : (u.script += "<" + E, u.state = y.SCRIPT);
            continue;
          case y.OPEN_WAKA:
            if (E === "!")
              u.state = y.SGML_DECL, u.sgmlDecl = "";
            else if (!$(E)) if (Y(T, E))
              u.state = y.OPEN_TAG, u.tagName = E;
            else if (E === "/")
          ...
          case y.SGML_DECL:
            ...
            u.doctype && u.doctype !== !0 && u.sgmlDecl ? (u.state = y.DOCTYPE_DTD, u.doctype += "<!" + u.sgmlDecl + E, u.sgmlDecl = "") : (u.sgmlDecl + E).toUpperCase() === f ? (B(u, "onopencdata"), u.state = y.CDATA, u.sgmlDecl = "", u.cdata = "") : (u.sgmlDecl + E).toUpperCase() === h ? (u.state = y.DOCTYPE, (u.doctype || u.sawRoot) && A(
              u,
              "Inappropriately located doctype declaration"
            ), u.doctype = "", u.sgmlDecl = "") : E === ">" ? (B(u, "onsgmldeclaration", u.sgmlDecl), u.sgmlDecl = "", u.state = y.TEXT) : (ie(E) && (u.state = y.SGML_DECL_QUOTED), u.sgmlDecl += E);
            continue;
          case y.SGML_DECL_QUOTED:
            E === u.q && (u.state = y.SGML_DECL, u.q = ""), u.sgmlDecl += E;
            continue;
          case y.DOCTYPE:
            E === ">" ? (u.state = y.TEXT, B(u, "ondoctype", u.doctype), u.doctype = !0) : (u.doctype += E, E === "[" ? u.state = y.DOCTYPE_DTD : ie(E) && (u.state = y.DOCTYPE_QUOTED, u.q = E));
            continue;
          case y.DOCTYPE_QUOTED:
            u.doctype += E, E === u.q && (u.q = "", u.state = y.DOCTYPE);
            continue;
          case y.DOCTYPE_DTD:
            E === "]" ? (u.doctype += E, u.state = y.DOCTYPE) : E === "<" ? (u.state = y.OPEN_WAKA, u.startTagPosition = u.position) : ie(E) ? (u.doctype += E, u.state = y.DOCTYPE_DTD_QUOTED, u.q = E) : u.doctype += E;
            continue;
          case y.DOCTYPE_DTD_QUOTED:
            u.doctype += E, E === u.q && (u.state = y.DOCTYPE_DTD, u.q = "");
            continue;
          case y.COMMENT:
            E === "-" ? u.state = y.COMMENT_ENDING : u.comment += E;
            continue;
          case y.COMMENT_ENDING:
            E === "-" ? (u.state = y.COMMENT_ENDED, u.comment = R(u.opt, u.comment), u.comment && B(u, "oncomment", u.comment), u.comment = "") : (u.comment += "-" + E, u.state = y.COMMENT);
            continue;
          case y.COMMENT_ENDED:
            E !== ">" ? (A(u, "Malformed comment"), u.comment += "--" + E, u.state = y.COMMENT) : u.doctype && u.doctype !== !0 ? u.state = y.DOCTYPE_DTD : u.state = y.TEXT;
            continue;
          case y.CDATA:
            for (var re = S - 1; E && E !== "]"; )
              E = U(p, S++), E && u.trackPosition && (u.position++, E === `
` ? (u.line++, u.column = 0) : u.column++);
            u.cdata += p.substring(re, S - 1), E === "]" && (u.state = y.CDATA_ENDING);
            continue;
          case y.CDATA_ENDING:
            E === "]" ? u.state = y.CDATA_ENDING_2 : (u.cdata += "]" + E, u.state = y.CDATA);
            continue;
          case y.CDATA_ENDING_2:
            E === ">" ? (u.cdata && B(u, "oncdata", u.cdata), B(u, "onclosecdata"), u.cdata = "", u.state = y.TEXT) : E === "]" ? u.cdata += "]" : (u.cdata += "]]" + E, u.state = y.CDATA);
            continue;
          case y.PROC_INST:
            E === "?" ? u.state = y.PROC_INST_ENDING : $(E) ? u.state = y.PROC_INST_BODY : u.procInstName += E;
            continue;
          case y.PROC_INST_BODY:
            if (!u.procInstBody && $(E))
              continue;
            E === "?" ? u.state = y.PROC_INST_ENDING : u.procInstBody += E;
            continue;
          case y.PROC_INST_ENDING:
            E === ">" ? (B(u, "onprocessinginstruction", {
              name: u.procInstName,
              body: u.procInstBody
            }), u.procInstName = u.procInstBody = "", u.state = y.TEXT) : (u.procInstBody += "?" + E, u.state = y.PROC_INST_BODY);
            continue;
          case y.OPEN_TAG:
            Y(b, E) ? u.tagName += E : (k(u), E === ">" ? X(u) : E === "/" ? u.state = y.OPEN_TAG_SLASH : ($(E) || A(u, "Invalid character in tag name"), u.state = y.ATTRIB));
            continue;
          ...
          case y.ATTRIB:
            if ($(E))
              continue;
            E === ">" ? X(u) : E === "/" ? u.state = y.OPEN_TAG_SLASH : Y(T, E) ? (u.attribName = E, u.attribValue = "", u.state = y.ATTRIB_NAME) : A(u, "Invalid attribute name");
            continue;
          case y.ATTRIB_NAME:
            E === "=" ? u.state = y.ATTRIB_VALUE : E === ">" ? (A(u, "Attribute without value"), u.attribValue = u.attribName, M(u), X(u)) : $(E) ? u.state = y.ATTRIB_NAME_SAW_WHITE : Y(b, E) ? u.attribName += E : A(u, "Invalid attribute name");
            continue;
          case y.ATTRIB_NAME_SAW_WHITE:
            if (E === "=")
              ...
              A(u, "Attribute without value"), u.tag.attributes[u.attribName] = "", u.attribValue = "", B(u, "onattribute", {
                name: u.attribName,
                value: ""
              }), u.attribName = "", E === ">" ? X(u) : Y(T, E) ? (u.attribName = E, u.state = y.ATTRIB_NAME) : (A(u, "Invalid attribute name"), u.state = y.ATTRIB);
            }
            continue;
          case y.ATTRIB_VALUE:
            if ($(E))
              continue;
            ie(E) ? (u.q = E, u.state = y.ATTRIB_VALUE_QUOTED) : (u.opt.unquotedAttributeValues || I(u, "Unquoted attribute value"), u.state = y.ATTRIB_VALUE_UNQUOTED, u.attribValue = E);
            continue;
          case y.ATTRIB_VALUE_QUOTED:
            if (E !== u.q) {
              E === "&" ? u.state = y.ATTRIB_VALUE_ENTITY_Q : u.attribValue += E;
              continue;
            }
            M(u), u.q = "", u.state = y.ATTRIB_VALUE_CLOSED;
            continue;
          case y.ATTRIB_VALUE_CLOSED:
            $(E) ? u.state = y.ATTRIB : E === ">" ? X(u) : E === "/" ? u.state = y.OPEN_TAG_SLASH : Y(T, E) ? (A(u, "No whitespace between attributes"), u.attribName = E, u.attribValue = "", u.state = y.ATTRIB_NAME) : A(u, "Invalid attribute name");
            continue;
          case y.ATTRIB_VALUE_UNQUOTED:
            if (!ue(E)) {
              E === "&" ? u.state = y.ATTRIB_VALUE_ENTITY_U : u.attribValue += E;
              continue;
            }
            M(u), E === ">" ? X(u) : u.state = y.ATTRIB;
            continue;
          case y.CLOSE_TAG:
            if (u.tagName)
              E === ">" ? z(u) : Y(b, E) ? u.tagName += E : u.script ? (u.script += "</" + u.tagName, u.tagName = "", u.state = y.SCRIPT) : ($(E) || A(u, "Invalid tagname in closing tag"), u.state = y.CLOSE_TAG_SAW_WHITE);
            else {
              if ($(E))
                continue;
              Ue(T, E) ? u.script ? (u.script += "</" + E, u.state = y.SCRIPT) : A(u, "Invalid tagname in closing tag.") : u.tagName = E;
            }
            continue;
          case y.CLOSE_TAG_SAW_WHITE:
            if ($(E))
              continue;
            E === ">" ? z(u) : A(u, "Invalid characters in closing tag");
            continue;
          case y.TEXT_ENTITY:
    ...
    String.fromCodePoint || function() {
      var p = String.fromCharCode, u = Math.floor, S = function() {
        ...
        for (var ht = ""; ++we < _e; ) {
          ...
          de <= 65535 ? K.push(de) : (de -= 65536, re = (de >> 10) + 55296, le = de % 1024 + 56320, K.push(re, le)), (we + 1 === _e || K.length > E) && (ht += p.apply(null, K), K.length = 0);
        }
        return ht;
      };
...
class _u {
  ...
  getElements(t, r = !1) {
    return this.elements === null ? [] : this.elements.filter((n) => Go(n, t, r));
  }
...
function R0(e) {
  return Array.isArray(e) ? e : bu(e) ? [] : [e];
}
function O0(e, t) {
  var r, n, i, a;
  if (t)
...
` + o;
  for (d = pa(e.buffer, n[s], i[s], e.position, f), o += Mr.repeat(" ", t.indent) + ha((e.line + 1).toString(), c) + " | " + d.str + `
...
function U0(e, t) {
  if (t = t || {}, Object.keys(t).forEach(function(r) {
    if (F0.indexOf(r) === -1)
      throw new Ho('Unknown option "' + r + '" is met in definition of "' + e + '" YAML type.');
...
Xa.prototype.extend = function(t) {
  ...
  return i.implicit = (this.implicit || []).concat(r), i.explicit = (this.explicit || []).concat(n), i.compiledImplicit = qo(i, "implicit"), i.compiledExplicit = qo(i, "explicit"), i.compiledTypeMap = M0(i.compiledImplicit, i.compiledExplicit), i;
};
var Au = Xa, B0 = Ne, Iu = new B0("tag:yaml.org,2002:str", {
  kind: "scalar",
  construct: function(e) {
    return e !== null ? e : "";
  }
}), j0 = Ne, Cu = new j0("tag:yaml.org,2002:seq", {
  kind: "sequence",
  construct: function(e) {
    return e !== null ? e : [];
  }
}), z0 = Ne, Ru = new z0("tag:yaml.org,2002:map", {
  kind: "mapping",
  construct: function(e) {
    return e !== null ? e : {};
  }
...
var Du = new H0("tag:yaml.org,2002:null", {
  kind: "scalar",
  resolve: q0,
  construct: X0,
  predicate: W0,
...
var Pu = new V0("tag:yaml.org,2002:bool", {
  kind: "scalar",
  resolve: Y0,
  construct: K0,
  predicate: J0,
...
var ku = new Z0("tag:yaml.org,2002:int", {
  kind: "scalar",
  resolve: ng,
  construct: ig,
  predicate: ag,
...
function fg(e, t) {
  ...
  else if (Nu.isNegativeZero(e))
    return "-0.0";
  return r = e.toString(10), ug.test(r) ? r.replace("e", ".e") : r;
}
function dg(e) {
  return Object.prototype.toString.call(e) === "[object Number]" && (e % 1 !== 0 || Nu.isNegativeZero(e));
}
var Fu = new sg("tag:yaml.org,2002:float", {
  kind: "scalar",
  resolve: lg,
  construct: cg,
  predicate: dg,
...
}), Lu = $u, pg = Ne, Uu = new RegExp(
  "^([0-9][0-9][0-9][0-9])-([0-9][0-9])-([0-9][0-9])$"
), Mu = new RegExp(
  "^([0-9][0-9][0-9][0-9])-([0-9][0-9]?)-([0-9][0-9]?)(?:[Tt]|[ \\t]+)([0-9][0-9]?):([0-9][0-9]):([0-9][0-9])(?:\\.([0-9]*))?(?:[ \\t]*(Z|([-+])([0-9][0-9]?)(?::([0-9][0-9]))?))?$"
);
function hg(e) {
  return e === null ? !1 : Uu.exec(e) !== null || Mu.exec(e) !== null;
}
function mg(e) {
  var t, r, n, i, a, s, o, l = 0, d = null, c, f, h;
  if (t = Uu.exec(e), t === null && (t = Mu.exec(e)), t === null) throw new Error("Date resolve error");
...
var Bu = new pg("tag:yaml.org,2002:timestamp", {
  kind: "scalar",
  resolve: hg,
  construct: mg,
  instanceOf: Date,
...
var ju = new yg("tag:yaml.org,2002:merge", {
  kind: "scalar",
  resolve: xg
}), wg = Ne, bs = `ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789+/=
\r`;
function Eg(e) {
  if (e === null) return !1;
...
var Gu = new bg("tag:yaml.org,2002:omap", {
  kind: "sequence",
  resolve: Ig,
  construct: Cg
...
var Hu = new Rg("tag:yaml.org,2002:pairs", {
  kind: "sequence",
  resolve: Dg,
  construct: Pg
...
var qu = new kg("tag:yaml.org,2002:set", {
  kind: "mapping",
  resolve: Fg,
  construct: $g
}), Ss = Lu.extend({
...
}), Ht = Ke, Xu = pn, Lg = N0, Ug = Ss, Ct = Object.prototype.hasOwnProperty, di = 1, Wu = 2, Vu = 3, pi = 4, ga = 1, Mg = 2, Xo = 3, Bg = /[\x00-\x08\x0B\x0C\x0E-\x1F\x7F-\x84\x86-\x9F\uFFFE\uFFFF]|[\uD800-\uDBFF](?![\uDC00-\uDFFF])|(?:[^\uD800-\uDBFF]|^)[\uDC00-\uDFFF]/, jg = /[\x85\u2028\u2029]/, zg = /[,\[\]\{\}]/, Yu = /^(?:!|!!|![a-z\-]+!)$/i, Ku = /^(?:!|[^,\[\]\{\}])(?:%[0-9a-f]{2}|[0-9a-z\-#;\/\?:@&=\+\$,_\.!~\*'\(\)\[\]])*$/i;
function Wo(e) {
...
var Qu = new Array(256), Zu = new Array(256);
for (var ir = 0; ir < 256; ir++)
  Qu[ir] = Vo(ir) ? 1 : 0, Zu[ir] = Vo(ir);
function Wg(e, t) {
...
function ef(e, t) {
  ...
  return r.snippet = Lg(r), new Xu(t, r);
}
function L(e, t) {
  throw ef(e, t);
}
function hi(e, t) {
  e.onWarning && e.onWarning.call(null, ef(e, t));
}
var Yo = {
  YAML: function(t, r, n) {
    var i, a, s;
  ...
  TAG: function(t, r, n) {
    var i, a;
    n.length !== 2 && L(t, "TAG directive accepts exactly two arguments"), i = n[0], a = n[1], Yu.test(i) || L(t, "ill-formed tag handle (first argument) of the TAG directive"), Ct.call(t.tagMap, i) && L(t, 'there is a previously declared suffix for "' + i + '" tag handle'), Ku.test(a) || L(t, "ill-formed tag prefix (second argument) of the TAG directive");
    try {
...
function Ko(e, t, r, n) {
  ...
  for (Ht.isObject(r) || L(e, "cannot merge mappings; the provided source object is unacceptable"), i = Object.keys(r), s = 0, o = i.length; s < o; s += 1)
    a = i[s], Ct.call(t, a) || (Ju(t, a, r[a]), n[a] = !0);
}
function dr(e, t, r, n, i, a, s, o, l) {
  var d, c;
  if (Array.isArray(i))
    for (i = Array.prototype.slice.call(i), d = 0, c = i.length; d < c; d += 1)
      Array.isArray(i[d]) && L(e, "nested arrays are not supported inside keys"), typeof i == "object" && Wo(i[d]) === "[object Object]" && (i[d] = "[object Object]");
  if (typeof i == "object" && Wo(i) === "[object Object]" && (i = "[object Object]"), i = String(i), t === null && (t = {}), n === "tag:yaml.org,2002:merge")
    if (Array.isArray(a))
    ...
    !e.json && !Ct.call(r, i) && Ct.call(t, i) && (e.line = s || e.line, e.lineStart = o || e.lineStart, e.position = l || e.position, L(e, "duplicated mapping key")), Ju(t, i, a), delete r[i];
  return t;
}
function As(e) {
  var t;
...
function Vg(e, t, r) {
  ...
  return bt(e, a, s, !1), e.result ? !0 : (e.kind = f, e.result = h, !1);
}
function Yg(e, t) {
  var r, n, i;
  ...
  for (e.kind = "scalar", e.result = "", e.position++, n = i = e.position; (r = e.input.charCodeAt(e.position)) !== 0; )
    if (r === 39)
      if (bt(e, n, e.position, !0), r = e.input.charCodeAt(++e.position), r === 39)
        ...
        return !0;
    else it(r) ? (bt(e, n, i, !0), Is(e, fe(e, !1, t)), n = i = e.position) : e.position === e.lineStart && Ri(e) ? L(e, "unexpected end of the document within a single quoted scalar") : (e.position++, i = e.position);
...
function Kg(e, t) {
  ...
  for (e.kind = "scalar", e.result = "", e.position++, r = n = e.position; (o = e.input.charCodeAt(e.position)) !== 0; ) {
    ...
    if (o === 92) {
      if (bt(e, r, e.position, !0), o = e.input.charCodeAt(++e.position), it(o))
        fe(e, !1, t);
      else if (o < 256 && Qu[o])
        e.result += Zu[o], e.position++;
      else if ((s = Hg(o)) > 0) {
        for (i = s, a = 0; i > 0; i--)
      ...
      r = n = e.position;
    } else it(o) ? (bt(e, r, n, !0), Is(e, fe(e, !1, t)), r = n = e.position) : e.position === e.lineStart && Ri(e) ? L(e, "unexpected end of the document within a double quoted scalar") : (e.position++, n = e.position);
  }
  L(e, "unexpected end of the stream within a double quoted scalar");
}
function Jg(e, t) {
  var r = !0, n, i, a, s = e.tag, o, l = e.anchor, d, c, f, h, g, v = /* @__PURE__ */ Object.create(null), x, T, b, _;
  ...
  for (e.anchor !== null && (e.anchorMap[e.anchor] = o), _ = e.input.charCodeAt(++e.position); _ !== 0; ) {
    ...
    r ? _ === 44 && L(e, "expected the node content, but found ','") : L(e, "missed comma between flow collection entries"), T = x = b = null, f = h = !1, _ === 63 && (d = e.input.charCodeAt(e.position + 1), Le(d) && (f = h = !0, e.position++, fe(e, !0, t))), n = e.line, i = e.lineStart, a = e.position, Tr(e, t, di, !1, !0), T = e.tag, x = e.result, fe(e, !0, t), _ = e.input.charCodeAt(e.position), (h || e.line === n) && _ === 58 && (f = !0, _ = e.input.charCodeAt(++e.position), fe(e, !0, t), Tr(e, t, di, !1, !0), b = e.result), g ? dr(e, o, v, T, x, b, n, i, a) : f ? o.push(dr(e, null, v, T, x, b, n, i, a)) : o.push(x), fe(e, !0, t), _ = e.input.charCodeAt(e.position), _ === 44 ? (r = !0, _ = e.input.charCodeAt(++e.position)) : r = !1;
  }
  L(e, "unexpected end of the stream within a flow collection");
}
function Qg(e, t) {
  var r, n, i = ga, a = !1, s = !1, o = t, l = 0, d = !1, c, f;
  ...
  for (e.kind = "scalar", e.result = ""; f !== 0; )
    if (f = e.input.charCodeAt(++e.position), f === 43 || f === 45)
      ga === i ? i = f === 43 ? Xo : Mg : L(e, "repeat of a chomping mode identifier");
    else if ((c = qg(f)) >= 0)
  ...
  for (; f !== 0; ) {
    for (As(e), e.lineIndent = 0, f = e.input.charCodeAt(e.position); (!s || e.lineIndent < o) && f === 32; )
      e.lineIndent++, f = e.input.charCodeAt(++e.position);
    if (!s && e.lineIndent > o && (o = e.lineIndent), it(f)) {
      l++;
      continue;
    }
    if (e.lineIndent < o) {
      i === Xo ? e.result += Ht.repeat(`
...
`, a ? 1 + l : l), a = !0, s = !0, l = 0, r = e.position; !it(f) && f !== 0; )
      f = e.input.charCodeAt(++e.position);
    bt(e, r, e.position, !1);
  }
  return !0;
...
function Jo(e, t) {
  ...
  for (e.anchor !== null && (e.anchorMap[e.anchor] = a), l = e.input.charCodeAt(e.position); l !== 0 && (e.firstTabInLine !== -1 && (e.position = e.firstTabInLine, L(e, "tab characters must not be used in indentation")), !(l !== 45 || (s = e.input.charCodeAt(e.position + 1), !Le(s)))); ) {
    ...
    if (r = e.line, Tr(e, t, Vu, !1, !0), a.push(e.result), fe(e, !0, -1), l = e.input.charCodeAt(e.position), (e.line === r || e.lineIndent > t) && l !== 0)
...
function Zg(e, t, r) {
  var n, i, a, s, o, l, d = e.tag, c = e.anchor, f = {}, h = /* @__PURE__ */ Object.create(null), g = null, v = null, x = null, T = !1, b = !1, _;
  if (e.firstTabInLine !== -1) return !1;
  for (e.anchor !== null && (e.anchorMap[e.anchor] = f), _ = e.input.charCodeAt(e.position); _ !== 0; ) {
    if (!T && e.firstTabInLine !== -1 && (e.position = e.firstTabInLine, L(e, "tab characters must not be used in indentation")), n = e.input.charCodeAt(e.position + 1), a = e.line, (_ === 63 || _ === 58) && Le(n))
      _ === 63 ? (T && (dr(e, f, h, g, v, null, s, o, l), g = v = x = null), b = !0, T = !0, i = !0) : T ? (T = !1, i = !0) : L(e, "incomplete explicit mapping pair; a key node is missed; or followed by a non-tabulated empty line"), e.position += 1, _ = n;
    else {
      if (s = e.line, o = e.lineStart, l = e.position, !Tr(e, r, Wu, !1, !0))
        break;
      if (e.line === a) {
        for (_ = e.input.charCodeAt(e.position); Vt(_); )
          _ = e.input.charCodeAt(++e.position);
        if (_ === 58)
          _ = e.input.charCodeAt(++e.position), Le(_) || L(e, "a whitespace character is expected after the key-value separator within a block mapping"), T && (dr(e, f, h, g, v, null, s, o, l), g = v = x = null), b = !0, T = !1, i = !1, g = e.tag, v = e.result;
        else if (b)
    ...
    if ((e.line === a || e.lineIndent > t) && (T && (s = e.line, o = e.lineStart, l = e.position), Tr(e, t, pi, !0, i) && (T ? v = e.result : x = e.result), T || (dr(e, f, h, g, v, x, s, o, l), g = v = x = null), fe(e, !0, -1), _ = e.input.charCodeAt(e.position)), (e.line === a || e.lineIndent > t) && _ !== 0)
...
function ey(e) {
  ...
  if (e.tag !== null && L(e, "duplication of a tag property"), s = e.input.charCodeAt(++e.position), s === 60 ? (r = !0, s = e.input.charCodeAt(++e.position)) : s === 33 ? (n = !0, i = "!!", s = e.input.charCodeAt(++e.position)) : i = "!", t = e.position, r) {
    ...
    for (; s !== 0 && !Le(s); )
      s === 33 && (n ? L(e, "tag suffix cannot contain exclamation marks") : (i = e.input.slice(t - 1, e.position + 1), Yu.test(i) || L(e, "named tag handle cannot contain such characters"), n = !0, t = e.position + 1)), s = e.input.charCodeAt(++e.position);
    a = e.input.slice(t, e.position), zg.test(a) && L(e, "tag suffix cannot contain flow indicator characters");
  }
  a && !Ku.test(a) && L(e, "tag name cannot contain such characters: " + a);
  try {
    a = decodeURIComponent(a);
  } catch {
...
function Tr(e, t, r, n, i) {
  var a, s, o, l = 1, d = !1, c = !1, f, h, g, v, x, T;
  if (e.listener !== null && e.listener("open", e), e.tag = null, e.anchor = null, e.kind = null, e.result = null, a = s = o = pi === r || Vu === r, n && fe(e, !0, -1) && (d = !0, e.lineIndent > t ? l = 1 : e.lineIndent === t ? l = 0 : e.lineIndent < t && (l = -1)), l === 1)
    for (; ey(e) || ty(e); )
      fe(e, !0, -1) ? (d = !0, o = a, e.lineIndent > t ? l = 1 : e.lineIndent === t ? l = 0 : e.lineIndent < t && (l = -1)) : o = !1;
  if (o && (o = d || i), (l === 1 || pi === r) && (di === r || Wu === r ? x = t : x = t + 1, T = e.position - e.lineStart, l === 1 ? o && (Jo(e, T) || Zg(e, T, x)) || Jg(e, x) ? c = !0 : (s && Qg(e, x) || Yg(e, x) || Kg(e, x) ? c = !0 : ry(e) ? (c = !0, (e.tag !== null || e.anchor !== null) && L(e, "alias node should not have any properties")) : Vg(e, x, di === r) && (c = !0, e.tag === null && (e.tag = "?")), e.anchor !== null && (e.anchorMap[e.anchor] = e.result)) : l === 0 && (c = o && Jo(e, T))), e.tag === null)
...
function ny(e) {
  ...
  for (e.version = null, e.checkLineBreaks = e.legacy, e.tagMap = /* @__PURE__ */ Object.create(null), e.anchorMap = /* @__PURE__ */ Object.create(null); (s = e.input.charCodeAt(e.position)) !== 0 && (fe(e, !0, -1), s = e.input.charCodeAt(e.position), !(e.lineIndent > 0 || s !== 37)); ) {
    ...
    s !== 0 && As(e), Ct.call(Yo, n) ? Yo[n](e, n, i) : hi(e, 'unknown document directive "' + n + '"');
  }
  if (fe(e, !0, -1), e.lineIndent === 0 && e.input.charCodeAt(e.position) === 45 && e.input.charCodeAt(e.position + 1) === 45 && e.input.charCodeAt(e.position + 2) === 45 ? (e.position += 3, fe(e, !0, -1)) : a && L(e, "directives end mark is expected"), Tr(e, e.lineIndent - 1, pi, !1, !0), fe(e, !0, -1), e.checkLineBreaks && jg.test(e.input.slice(t, e.position)) && hi(e, "non-ASCII line breaks are interpreted as content"), e.documents.push(e.result), e.position === e.lineStart && Ri(e)) {
...
_s.loadAll = iy;
_s.load = ay;
var rf = {}, Oi = Ke, hn = pn, sy = Ss, nf = Object.prototype.toString, af = Object.prototype.hasOwnProperty, Cs = 65279, oy = 9, Qr = 10, ly = 13, cy = 32, uy = 33, fy = 34, Wa = 35, dy = 37, py = 38, hy = 39, my = 42, sf = 44, gy = 45, mi = 58, yy = 61, xy = 62, wy = 63, Ey = 64, of = 91, lf = 93, vy = 96, cf = 123, Ty = 124, uf = 125, Ie = {};
Ie[0] = "\\0";
Ie[7] = "\\a";
Ie[8] = "\\b";
Ie[9] = "\\t";
...
function Sy(e, t) {
  ...
  for (r = {}, n = Object.keys(t), i = 0, a = n.length; i < a; i += 1)
    s = n[i], o = String(t[s]), s.slice(0, 2) === "!!" && (s = "tag:yaml.org,2002:" + s.slice(2)), l = e.compiledTypeMap.fallback[s], l && af.call(l.styleAliases, o) && (o = l.styleAliases[o]), r[s] = o;
  return r;
}
function Ay(e) {
  var t, r, n;
...
var Iy = 1, Zr = 2;
function Cy(e) {
  this.schema = e.schema || sy, this.indent = Math.max(1, e.indent || 2), this.noArrayIndent = e.noArrayIndent || !1, this.skipInvalid = e.skipInvalid || !1, this.flowLevel = Oi.isNothing(e.flowLevel) ? -1 : e.flowLevel, this.styleMap = Sy(this.schema, e.styles || null), this.sortKeys = e.sortKeys || !1, this.lineWidth = e.lineWidth || 80, this.noRefs = e.noRefs || !1, this.noCompatMode = e.noCompatMode || !1, this.condenseFlow = e.condenseFlow || !1, this.quotingType = e.quotingType === '"' ? Zr : Iy, this.forceQuotes = e.forceQuotes || !1, this.replacer = typeof e.replacer == "function" ? e.replacer : null, this.implicitTypes = this.schema.compiledImplicit, this.explicitTypes = this.schema.compiledExplicit, this.tag = null, this.result = "", this.duplicates = [], this.usedDuplicates = null;
}
function Qo(e, t) {
...
function el(e, t, r) {
  ...
  return (
    ...
    (r ? (
      // c = flow-in
      n
    ) : n && e !== sf && e !== of && e !== lf && e !== cf && e !== uf) && e !== Wa && !(t === mi && !i) || Zo(t) && !gi(t) && e === Wa || t === mi && i
  );
}
function Oy(e) {
  return en(e) && e !== Cs && !gi(e) && e !== gy && e !== wy && e !== mi && e !== sf && e !== of && e !== lf && e !== cf && e !== uf && e !== Wa && e !== py && e !== my && e !== uy && e !== Ty && e !== yy && e !== xy && e !== hy && e !== fy && e !== dy && e !== Ey && e !== vy;
}
function Dy(e) {
  return !gi(e) && e !== mi;
}
...
var df = 1, Ya = 2, pf = 3, hf = 4, ur = 5;
function Py(e, t, r, n, i, a, s, o) {
  var l, d = 0, c = null, f = !1, h = !1, g = n !== -1, v = -1, x = Oy(Br(e, 0)) && Dy(Br(e, e.length - 1));
  if (t || s)
  ...
  return !f && !h ? x && !s && !i(e) ? df : a === Zr ? ur : Ya : r > 9 && ff(e) ? ur : s ? a === Zr ? ur : Ya : h ? hf : pf;
}
function ky(e, t, r, n, i) {
  e.dump = function() {
    if (t.length === 0)
      return e.quotingType === Zr ? '""' : "''";
    if (!e.noCompatMode && (_y.indexOf(t) !== -1 || by.test(t)))
    ...
    switch (Py(
      ...
      case Ya:
        return "'" + t.replace(/'/g, "''") + "'";
      case pf:
        return "|" + tl(t, e.indent) + rl(Qo(t, a));
      case hf:
        return ">" + tl(t, e.indent) + rl(Qo(Ny(t, s), a));
      case ur:
        return '"' + Fy(t) + '"';
      default:
...
function tl(e, t) {
  var r = ff(e) ? String(t) : "", n = e[e.length - 1] === `
`, i = n && (e[e.length - 2] === `
` || e === `
`), a = i ? "+" : n ? "" : "-";
  return r + a + `
...
function Ny(e, t) {
  for (var r = /(\n+)([^\n]*)/g, n = function() {
    var d = e.indexOf(`
`);
    return d = d !== -1 ? d : e.length, r.lastIndex = d, nl(e.slice(0, d), t);
  }(), i = e[0] === `
` || e[0] === " ", a, s; s = r.exec(e); ) {
    var o = s[1], l = s[2];
    a = l[0] === " ", n += o + (!i && !a && l !== "" ? `
...
function Fy(e) {
  for (var t = "", r = 0, n, i = 0; i < e.length; r >= 65536 ? i += 2 : i++)
    r = Br(e, i), n = Ie[r], !n && en(r) ? (t += e[i], r >= 65536 && (t += e[i + 1])) : t += n || Ay(r);
  return t;
}
function $y(e, t, r) {
  var n = "", i = e.tag, a, s, o;
...
function Uy(e, t, r, n) {
  ...
  for (o = 0, l = s.length; o < l; o += 1)
    h = "", (!n || i !== "") && (h += Va(e, t)), d = s[o], c = r[d], e.replacer && (c = e.replacer.call(r, d, c)), dt(e, t + 1, d, !0, !0, !0) && (f = e.tag !== null && e.tag !== "?" || e.dump && e.dump.length > 1024, f && (e.dump && Qr === e.dump.charCodeAt(0) ? h += "?" : h += "? "), h += e.dump, f && (h += Va(e, t)), dt(e, t + 1, c, !0, f) && (e.dump && Qr === e.dump.charCodeAt(0) ? h += ":" : h += ": ", h += e.dump, i += h));
  e.tag = a, e.dump = i || "{}";
}
function al(e, t, r) {
  var n, i, a, s, o, l;
  for (i = r ? e.explicitTypes : e.implicitTypes, a = 0, s = i.length; a < s; a += 1)
    if (o = i[a], (o.instanceOf || o.predicate) && (!o.instanceOf || typeof t == "object" && t instanceof o.instanceOf) && (!o.predicate || o.predicate(t))) {
      if (r ? o.multi && o.representName ? e.tag = o.representName(t) : e.tag = o.tag : e.tag = "?", o.represent) {
        if (l = e.styleMap[o.tag] || o.defaultStyle, nf.call(o.represent) === "[object Function]")
          n = o.represent(t, l);
        else if (af.call(o.represent, l))
          n = o.represent[l](t, l);
        else
...
function dt(e, t, r, n, i, a, s) {
  ...
  if (c && (f = e.duplicates.indexOf(r), h = f !== -1), (e.tag !== null && e.tag !== "?" || h || e.indent !== 2 && t > 0) && (i = !1), h && e.usedDuplicates[f])
    ...
    if (c && h && !e.usedDuplicates[f] && (e.usedDuplicates[f] = !0), o === "[object Object]")
      n && Object.keys(e.dump).length !== 0 ? (Uy(e, t, e.dump, i), h && (e.dump = "&ref_" + f + e.dump)) : (Ly(e, t, e.dump), h && (e.dump = "&ref_" + f + " " + e.dump));
    else if (o === "[object Array]")
      n && e.dump.length !== 0 ? (e.noArrayIndent && !s && t > 0 ? il(e, t - 1, e.dump, i) : il(e, t, e.dump, i), h && (e.dump = "&ref_" + f + e.dump)) : ($y(e, t, e.dump), h && (e.dump = "&ref_" + f + " " + e.dump));
    else if (o === "[object String]")
      e.tag !== "?" && ky(e, e.dump, t, a, l);
    else {
...
Te.Type = Ne;
Te.Schema = Au;
Te.FAILSAFE_SCHEMA = Ou;
Te.JSON_SCHEMA = $u;
Te.CORE_SCHEMA = Lu;
Te.DEFAULT_SCHEMA = Ss;
Te.load = mf.load;
Te.loadAll = mf.loadAll;
Te.dump = jy.dump;
Te.YAMLException = pn;
Te.types = {
  binary: zu,
...
Di.Lazy = zy;
var Ja = { exports: {} };
const Gy = "2.0.0", gf = 256, Hy = Number.MAX_SAFE_INTEGER || /* istanbul ignore next */
9007199254740991, qy = 16, Xy = gf - 6, Wy = [
  "major",
  "premajor",
  "minor",
  "preminor",
...
var Pi = {
  MAX_LENGTH: gf,
  MAX_SAFE_COMPONENT_LENGTH: qy,
  MAX_SAFE_BUILD_LENGTH: Xy,
  MAX_SAFE_INTEGER: Hy,
  RELEASE_TYPES: Wy,
  SEMVER_SPEC_VERSION: Gy,
  FLAG_INCLUDE_PRERELEASE: 1,
  FLAG_LOOSE: 2
};
const Vy = typeof process == "object" && process.env && process.env.NODE_DEBUG && /\bsemver\b/i.test(process.env.NODE_DEBUG) ? (...e) => console.error("SEMVER", ...e) : () => {
};
var ki = Vy;
(function(e, t) {
  const {
...
var xf = {
  ...
  rcompareIdentifiers: Qy
};
const Un = ki, { MAX_LENGTH: ol, MAX_SAFE_INTEGER: Mn } = Pi, { safeRe: Bn, t: jn } = mn, Zy = Os, { compareIdentifiers: ya } = xf;
let ex = class nt {
  constructor(t, r) {
    if (r = Zy(r), t instanceof nt) {
...
var ix = nx;
const ax = Ir, sx = (e, t) => {
  const r = ax(e.trim().replace(/^[=v]+/, ""), t);
  return r ? r.version : null;
};
var ox = sx;
const cl = Fe, lx = (e, t, r, n, i) => {
  typeof r == "string" && (i = n, n = r, r = void 0);
  try {
    return new cl(
      e instanceof cl ? e.version : e,
      r
    ).inc(t, n, i).version;
  } catch {
    return null;
...
var cx = lx;
const ul = Ir, ux = (e, t) => {
  const r = ul(e, null, !0), n = ul(t, null, !0), i = r.compare(n);
  if (i === 0)
    return null;
...
var fx = ux;
const dx = Fe, px = (e, t) => new dx(e, t).major;
var hx = px;
const mx = Fe, gx = (e, t) => new mx(e, t).minor;
var yx = gx;
const xx = Fe, wx = (e, t) => new xx(e, t).patch;
var Ex = wx;
const vx = Ir, Tx = (e, t) => {
  const r = vx(e, t);
...
var _x = Tx;
const fl = Fe, bx = (e, t, r) => new fl(e, r).compare(new fl(t, r));
var Je = bx;
const Sx = Je, Ax = (e, t, r) => Sx(t, e, r);
var Ix = Ax;
const Cx = Je, Rx = (e, t) => Cx(e, t, !0);
var Ox = Rx;
const dl = Fe, Dx = (e, t, r) => {
  const n = new dl(e, r), i = new dl(t, r);
  return n.compare(i) || n.compareBuild(i);
};
var Ds = Dx;
const Px = Ds, kx = (e, t) => e.sort((r, n) => Px(r, n, t));
var Nx = kx;
const Fx = Ds, $x = (e, t) => e.sort((r, n) => Fx(n, r, t));
var Lx = $x;
const Ux = Je, Mx = (e, t, r) => Ux(e, t, r) > 0;
var Ni = Mx;
const Bx = Je, jx = (e, t, r) => Bx(e, t, r) < 0;
var Ps = jx;
const zx = Je, Gx = (e, t, r) => zx(e, t, r) === 0;
var wf = Gx;
const Hx = Je, qx = (e, t, r) => Hx(e, t, r) !== 0;
var Ef = qx;
const Xx = Je, Wx = (e, t, r) => Xx(e, t, r) >= 0;
var ks = Wx;
const Vx = Je, Yx = (e, t, r) => Vx(e, t, r) <= 0;
var Ns = Yx;
const Kx = wf, Jx = Ef, Qx = Ni, Zx = ks, ew = Ps, tw = Ns, rw = (e, t, r, n) => {
  switch (t) {
    case "===":
...
var vf = rw;
const nw = Fe, iw = Ir, { safeRe: zn, t: Gn } = mn, aw = (e, t) => {
  if (e instanceof nw)
    return e;
...
function Qe() {
  ...
  xa = t;
  const r = lw, n = new r(), i = Os, a = Fi(), s = ki, o = Fe, {
    safeRe: l,
    t: d,
  ...
  }, Ue = (R, I) => (s("replaceXRanges", R, I), R.split(/\s+/).map((D) => y(D, I)).join(" ")), y = (R, I) => {
    R = R.trim();
...
function Fi() {
  ...
  wa = t;
  const r = Os, { safeRe: n, t: i } = mn, a = vf, s = ki, o = Fe, l = Qe();
  return wa;
}
const cw = Qe(), uw = (e, t, r) => {
  try {
    t = new cw(t, r);
  } catch {
    return !1;
...
var $i = uw;
const fw = Qe(), dw = (e, t) => new fw(e, t).set.map((r) => r.map((n) => n.value).join(" ").trim().split(" "));
var pw = dw;
const hw = Fe, mw = Qe(), gw = (e, t, r) => {
...
var vw = Ew;
const Ea = Fe, Tw = Qe(), ml = Ni, _w = (e, t) => {
  e = new Tw(e, t);
  let r = new Ea("0.0.0");
...
var Iw = Aw;
const Cw = Fe, Tf = Fi(), { ANY: Rw } = Tf, Ow = Qe(), Dw = $i, gl = Ni, yl = Ps, Pw = Ns, kw = ks, Nw = (e, t, r, n) => {
  ...
  for (let d = 0; d < t.set.length; ++d) {
    ...
    let f = null, h = null;
    if (c.forEach((g) => {
      g.semver === Rw && (g = new Tf(">=0.0.0")), f = f || g, h = h || g, i(g.semver, f.semver, n) ? f = g : s(g.semver, h.semver, n) && (h = g);
...
var Fs = Nw;
const Fw = Fs, $w = (e, t, r) => Fw(e, t, ">", r);
var Lw = $w;
const Uw = Fs, Mw = (e, t, r) => Uw(e, t, "<", r);
var Bw = Mw;
const xl = Qe(), jw = (e, t, r) => (e = new xl(e, r), t = new xl(t, r), e.intersects(t, r));
var zw = jw;
const Gw = $i, Hw = Je;
var qw = (e, t, r) => {
  const n = [];
...
const wl = Qe(), $s = Fi(), { ANY: va } = $s, $r = $i, Ls = Je, Xw = (e, t, r = {}) => {
  if (e === t)
    return !0;
  e = new wl(e, r), t = new wl(t, r);
  let n = !1;
  ...
  return !0;
}, Ww = [new $s(">=0.0.0-0")], El = [new $s(">=0.0.0")], Vw = (e, t, r) => {
  if (e === t)
    return !0;
  if (e.length === 1 && e[0].semver === va) {
    if (t.length === 1 && t[0].semver === va)
      return !0;
    r.includePrerelease ? e = Ww : e = El;
  }
  if (t.length === 1 && t[0].semver === va) {
  ...
  let i, a;
  for (const g of e)
    g.operator === ">" || g.operator === ">=" ? i = vl(i, g, r) : g.operator === "<" || g.operator === "<=" ? a = Tl(a, g, r) : n.add(g.semver);
  if (n.size > 1)
    return null;
  let s;
  if (i && a) {
...
var Yw = Xw;
const Ta = mn, _l = Pi, Kw = Fe, bl = xf, Jw = Ir, Qw = ix, Zw = ox, eE = cx, tE = fx, rE = hx, nE = yx, iE = Ex, aE = _x, sE = Je, oE = Ix, lE = Ox, cE = Ds, uE = Nx, fE = Lx, dE = Ni, pE = Ps, hE = wf, mE = Ef, gE = ks, yE = Ns, xE = vf, wE = sw, EE = Fi(), vE = Qe(), TE = $i, _E = pw, bE = yw, SE = vw, AE = bw, IE = Iw, CE = Fs, RE = Lw, OE = Bw, DE = zw, PE = qw, kE = Yw;
var _f = {
  parse: Jw,
  valid: Qw,
  clean: Zw,
  ...
  compareIdentifiers: bl.compareIdentifiers,
  rcompareIdentifiers: bl.rcompareIdentifiers
}, gn = {}, yi = { exports: {} };
yi.exports;
(function(e, t) {
  var r = 200, n = "__lodash_hash_undefined__", i = 1, a = 2, s = 9007199254740991, o = "[object Arguments]", l = "[object Array]", d = "[object AsyncFunction]", c = "[object Boolean]", f = "[object Date]", h = "[object Error]", g = "[object Function]", v = "[object GeneratorFunction]", x = "[object Map]", T = "[object Number]", b = "[object Null]", _ = "[object Object]", N = "[object Promise]", $ = "[object Proxy]", ie = "[object RegExp]", ue = "[object Set]", Y = "[object String]", Ue = "[object Symbol]", y = "[object Undefined]", q = "[object WeakMap]", j = "[object ArrayBuffer]", B = "[object DataView]", Q = "[object Float32Array]", R = "[object Float64Array]", I = "[object Int8Array]", D = "[object Int16Array]", A = "[object Int32Array]", k = "[object Uint8Array]", O = "[object Uint8ClampedArray]", M = "[object Uint16Array]", X = "[object Uint32Array]", z = /[\\^$.*+?()[\]{}|]/g, Z = /^\[object .+?Constructor\]$/, he = /^(?:0|[1-9]\d*)$/, U = {};
  U[Q] = U[R] = U[I] = U[D] = U[A] = U[k] = U[O] = U[M] = U[X] = !0, U[o] = U[l] = U[j] = U[c] = U[B] = U[f] = U[h] = U[g] = U[x] = U[T] = U[_] = U[ie] = U[ue] = U[Y] = U[q] = !1;
  var Ze = typeof Re == "object" && Re && Re.Object === Object && Re, p = typeof self == "object" && self && self.Object === Object && self, u = Ze || p || Function("return this")(), S = t && !t.nodeType && t, E = S && !0 && e && !e.nodeType && e, K = E && E.exports === S, re = K && Ze.process, le = function() {
    try {
  ...
  var ld = Array.prototype, cd = Function.prototype, bn = Object.prototype, Ki = u["__core-js_shared__"], Ws = cd.toString, et = bn.hasOwnProperty, Vs = function() {
    var m = /[^.]+$/.exec(Ki && Ki.keys && Ki.keys.IE_PROTO || "");
    return m ? "Symbol(src)_1." + m : "";
  }(), Ys = bn.toString, ud = RegExp(
    "^" + Ws.call(et).replace(z, "\\$&").replace(/hasOwnProperty|(function).*?(?=\\\()| for .+?(?=\\\])/g, "$1.*?") + "$"
  ), Ks = K ? u.Buffer : void 0, Sn = u.Symbol, Js = u.Uint8Array, Qs = bn.propertyIsEnumerable, fd = ld.splice, Nt = Sn ? Sn.toStringTag : void 0, Zs = Object.getOwnPropertySymbols, dd = Ks ? Ks.isBuffer : void 0, pd = sd(Object.keys, Object), Ji = rr(u, "DataView"), Or = rr(u, "Map"), Qi = rr(u, "Promise"), Zi = rr(u, "Set"), ea = rr(u, "WeakMap"), Dr = rr(Object, "create"), hd = Lt(Ji), md = Lt(Or), gd = Lt(Qi), yd = Lt(Zi), xd = Lt(ea), eo = Sn ? Sn.prototype : void 0, ta = eo ? eo.valueOf : void 0;
  function Ft(m) {
  ...
  Ft.prototype.clear = wd, Ft.prototype.delete = Ed, Ft.prototype.get = vd, Ft.prototype.has = Td, Ft.prototype.set = _d;
  function ot(m) {
    var w = -1, C = m == null ? 0 : m.length;
    for (this.clear(); ++w < C; ) {
      var F = m[w];
  ...
  function Sd(m) {
    ...
    if (C < 0)
      return !1;
    var F = w.length - 1;
    return C == F ? w.pop() : fd.call(w, C, 1), --this.size, !0;
  }
  function Ad(m) {
    var w = this.__data__, C = In(w, m);
  ...
  ot.prototype.clear = bd, ot.prototype.delete = Sd, ot.prototype.get = Ad, ot.prototype.has = Id, ot.prototype.set = Cd;
  function $t(m) {
    var w = -1, C = m == null ? 0 : m.length;
    for (this.clear(); ++w < C; ) {
      var F = m[w];
  ...
  $t.prototype.clear = Rd, $t.prototype.delete = Od, $t.prototype.get = Dd, $t.prototype.has = Pd, $t.prototype.set = kd;
  function An(m) {
    var w = -1, C = m == null ? 0 : m.length;
  ...
  An.prototype.add = An.prototype.push = Nd, An.prototype.has = Fd;
  function mt(m) {
  ...
  mt.prototype.clear = $d, mt.prototype.delete = Ld, mt.prototype.get = Ud, mt.prototype.has = Md, mt.prototype.set = Bd;
  function jd(m, w) {
    var C = Rn(m), F = !C && rp(m), ne = !C && !F && ra(m), H = !C && !F && !ne && co(m), ce = C || F || ne || H, me = ce ? We(m.length, String) : [], Ee = me.length;
    for (var ae in m)
  ...
  function Pr(m) {
    return m == null ? m === void 0 ? y : b : Nt && Nt in Object(m) ? Yd(m) : tp(m);
  }
  function to(m) {
    return kr(m) && Pr(m) == o;
  }
  function ro(m, w, C, F, ne) {
    return m === w ? !0 : m == null || w == null || !kr(m) && !kr(w) ? m !== m && w !== w : Gd(m, w, C, F, ro, ne);
  }
  function Gd(m, w, C, F, ne, H) {
    var ce = Rn(m), me = Rn(w), Ee = ce ? l : gt(m), ae = me ? l : gt(w);
    Ee = Ee == o ? _ : Ee, ae = ae == o ? _ : ae;
    var Me = Ee == _, Ve = ae == _, be = Ee == ae;
    if (be && ra(m)) {
      if (!ra(w))
        return !1;
      ce = !0, Me = !1;
    ...
    if (be && !Me)
      return H || (H = new mt()), ce || co(m) ? no(m, w, C, F, ne, H) : Wd(m, w, Ee, C, F, ne, H);
    if (!(C & i)) {
      var Ge = Me && et.call(m, "__wrapped__"), He = Ve && et.call(w, "__wrapped__");
      if (Ge || He) {
        var yt = Ge ? m.value() : m, lt = He ? w.value() : w;
        return H || (H = new mt()), ne(yt, lt, C, F, H);
      }
    }
    return be ? (H || (H = new mt()), Vd(m, w, C, F, ne, H)) : !1;
  }
  function Hd(m) {
    if (!lo(m) || Zd(m))
      return !1;
  ...
  function no(m, w, C, F, ne, H) {
    ...
    if (ae && H.get(w))
      return ae == w;
    var Me = -1, Ve = !0, be = C & a ? new An() : void 0;
    for (H.set(m, w), H.set(w, m); ++Me < me; ) {
      var Ge = m[Me], He = w[Me];
      if (F)
        var yt = ce ? F(He, Ge, Me, w, m, H) : F(Ge, He, Me, m, w, H);
      if (yt !== void 0) {
        if (yt)
          continue;
        Ve = !1;
      ...
      if (be) {
        if (!de(w, function(lt, Ut) {
          if (!Tn(be, Ut) && (Ge === lt || ne(Ge, lt, C, F, H)))
            return be.push(Ut);
        })) {
          Ve = !1;
          break;
  ...
  function Wd(m, w, C, F, ne, H, ce) {
    switch (C) {
      ...
      case ue:
        var Ee = F & i;
        if (me || (me = od), m.size != w.size && !Ee)
          return !1;
        var ae = ce.get(m);
        if (ae)
          return ae == w;
        F |= a, ce.set(m, w);
        var Me = no(me(m), me(w), F, ne, H, ce);
  ...
  function Vd(m, w, C, F, ne, H) {
    var ce = C & i, me = io(m), Ee = me.length, ae = io(w), Me = ae.length;
    if (Ee != Me && !ce)
      return !1;
    for (var Ve = Ee; Ve--; ) {
      var be = me[Ve];
    ...
    for (var yt = ce; ++Ve < Ee; ) {
      ...
      var lt = m[be], Ut = w[be];
      if (F)
        var uo = ce ? F(Ut, lt, be, w, m, H) : F(lt, Ut, be, m, w, H);
      if (!(uo === void 0 ? lt === Ut || ne(lt, Ut, C, F, H) : uo)) {
        He = !1;
        break;
      }
  ...
  function Cn(m, w) {
    var C = m.__data__;
    return Qd(w) ? C[typeof w == "string" ? "string" : "hash"] : C.map;
  }
  function rr(m, w) {
    var C = Rr(m, w);
    return Hd(C) ? C : void 0;
  }
  function Yd(m) {
...
const FE = cn, $E = Dt, Sl = NE, zt = Pt, qr = oe;
class LE {
  constructor(t) {
  ...
  async validateDownloadedPath(t, r, n, i) {
    if (this.versionInfo != null && this.file === t && this.fileInfo != null)
      return Sl(this.versionInfo, r) && Sl(this.fileInfo.info, n.info) && await (0, zt.pathExists)(t) ? t : null;
...
var yn = {}, Xe = {}, HE = "[object Symbol]", Sf = /[\\^$.*+?()[\]{}|]/g, qE = RegExp(Sf.source), XE = typeof Re == "object" && Re && Re.Object === Object && Re, WE = typeof self == "object" && self && self.Object === Object && self, VE = XE || WE || Function("return this")(), YE = Object.prototype, KE = YE.toString, Il = VE.Symbol, Cl = Il ? Il.prototype : void 0, Rl = Cl ? Cl.toString : void 0;
function JE(e) {
  if (typeof e == "string")
    return e;
  if (ZE(e))
...
function tv(e) {
  return e = ev(e), e && qE.test(e) ? e.replace(Sf, "\\$&") : e;
}
var rv = tv;
...
function sv(e, t, r) {
  ...
  return [Qa(`${e.pathname.replace(new RegExp(nv(r), "g"), t)}.blockmap`, e), n];
}
var pe = {};
...
function fv(e, t, r = (n) => n) {
  const i = If(e).map((o) => {
    ...
    return {
      url: (0, Ol.newUrlFromBase)(r(o.url), t),
      info: o
    };
  }), a = e.packages, s = a == null ? null : a[process.arch] || a.ia32;
  return s != null && (i[0].packageInfo = {
    ...s,
    path: (0, Ol.newUrlFromBase)(r(s.path), t).href
  }), i;
}
Object.defineProperty(yn, "__esModule", { value: !0 });
yn.GenericProvider = void 0;
const Dl = xe, ba = Xe, Sa = pe;
class dv extends Sa.Provider {
  constructor(t, r, n) {
...
yn.GenericProvider = dv;
var Ui = {}, Mi = {};
Object.defineProperty(Mi, "__esModule", { value: !0 });
Mi.BitbucketProvider = void 0;
const Pl = xe, Aa = Xe, Ia = pe;
class pv extends Ia.Provider {
  constructor(t, r, n) {
    super({
      ...n,
  ...
  async getLatestVersion() {
    const t = new Pl.CancellationToken(), r = (0, Aa.getChannelFilename)(this.getCustomChannelName(this.channel)), n = (0, Aa.newUrlFromBase)(r, this.baseUrl, this.updater.isAddNoCacheQuery);
    try {
      const i = await this.httpRequest(n, void 0, t);
      return (0, Ia.parseUpdateInfo)(i, r, n);
    } catch (i) {
      throw (0, Pl.newError)(`Unable to find latest version on ${this.toString()}, please ensure release exists: ${i.stack || i.message}`, "ERR_UPDATER_LATEST_VERSION_NOT_FOUND");
    }
  }
  resolveFiles(t) {
...
Ot.computeReleaseNotes = Rf;
const ct = xe, pr = _f, hv = _r, hr = Xe, Za = pe, Ca = /\/tag\/([^/]+)$/;
class Cf extends Za.Provider {
  constructor(t, r, n) {
    super({
      ...n,
...
${o}`, "ERR_UPDATER_INVALID_RELEASE_FEED");
    ...
    const x = (0, Za.parseUpdateInfo)(f, h, g);
    return x.releaseName == null && (x.releaseName = d.elementValueOrEmpty("title")), x.releaseNotes == null && (x.releaseNotes = Rf(this.updater.currentVersion, this.updater.fullChangelog, l, d)), {
      tag: c,
      ...x
    };
  }
...
const Nl = xe, Ra = Xe, Oa = pe;
class gv extends Oa.Provider {
  constructor(t, r, n) {
    super({
      ...n,
      isUseMultipleRangeRequest: !1
  ...
  async getLatestVersion() {
    const t = new Nl.CancellationToken(), r = (0, Ra.getChannelFilename)(this.getCustomChannelName(this.channel)), n = (0, Ra.newUrlFromBase)(r, this.baseUrl, this.updater.isAddNoCacheQuery);
    try {
...
const ar = xe, yv = Te, xv = oe, Fl = _r, $l = Xe, wv = Ot, Ev = pe;
class vv extends wv.BaseGitHubProvider {
  ...
  async getLatestVersion() {
    const t = new ar.CancellationToken(), r = (0, $l.getChannelFilename)(this.getDefaultChannelName()), n = await this.getLatestVersionInfo(t), i = n.assets.find((o) => o.name === r);
    if (i == null)
      throw (0, ar.newError)(`Cannot find ${r} in the release ${n.html_url || n.name}`, "ERR_UPDATER_CHANNEL_FILE_NOT_FOUND");
    const a = new Fl.URL(i.url);
    let s;
    try {
      s = (0, yv.load)(await this.httpRequest(a, this.configureHeaders("application/octet-stream"), t));
    } catch (o) {
  ...
  async getLatestVersionInfo(t) {
    ...
    let n = this.basePath;
    r || (n = `${n}/latest`);
    const i = (0, $l.newUrlFromBase)(n, this.baseUrl);
    try {
  ...
  resolveFiles(t) {
    return (0, Ev.getFileList)(t).map((r) => {
      const n = xv.posix.basename(r.url).replace(/ /g, "-"), i = t.assets.find((a) => a != null && a.name === n);
      if (i == null)
...
ji.PrivateGitHubProvider = vv;
Object.defineProperty(Ui, "__esModule", { value: !0 });
Ui.isUrlProbablySupportMultiRangeRequests = Of;
Ui.createClient = Av;
const Hn = xe, Tv = Mi, Ll = yn, _v = Ot, bv = Bi, Sv = ji;
function Of(e) {
...
function Iv(e, t, r) {
  const n = Ml(e.files), i = Ml(t.files);
  let a = null;
  ...
  for (let x = 0; x < c.checksums.length; v += c.sizes[x], x++) {
    ...
    _ != null && g.get(b) !== T && (r.warn(`Checksum ("${b}") matches, but size differs (old: ${g.get(b)}, new: ${T})`), _ = void 0), _ === void 0 ? (f++, a != null && a.kind === Xt.DOWNLOAD && a.end === v ? a.end += T : (a = {
      ...
      // oldBlocks: null,
    }, Ul(a, o, b, x))) : a != null && a.kind === Xt.COPY && a.end === _ ? a.end += T : (a = {
      kind: Xt.COPY,
      start: _,
      end: _ + T
      // oldBlocks: [checksum]
...
Cr.copyData = Df;
const qn = xe, Ov = Dt, Dv = ln, Pv = tr, Bl = Buffer.from(`\r
\r
`);
var Et;
(function(e) {
...
function Fv(e, t, r, n, i) {
  ...
  if (s <= 1) {
    const f = (h) => {
      ...
      if (g.kind === zl.OperationKind.COPY)
        (0, jl.copyData)(g, r, t.oldFileFd, i, () => f(h));
      else {
  ...
  const c = e.httpExecutor.createRequest(d, (f) => {
    if (!ts(f, i))
      return;
    const h = (0, es.safeGetHeader)(f, "content-type"), g = /^multipart\/.+?(?:; boundary=(?:(?:"(.+)")|(?:([^\s]+))))$/i.exec(h);
    if (g == null) {
      i(new Error(`Content-Type "multipart/byteranges" is expected, but got "${h}"`));
      return;
    }
    const v = new jl.DataSplitter(r, t, o, g[1] || g[2], l, n);
...
const Lr = xe, Da = Pt, Uv = Dt, Mv = Cr, Bv = _r, Xn = tr, Gl = Gi, jv = Hi;
class zv {
  ...
  doDownload(t, r) {
    ...
    return n.info(`Full: ${Hl(o)}, To download: ${Hl(a)} (${Math.round(a / (o / 100))}%)`), this.downloadFile(i);
  }
  downloadFile(t) {
  ...
  async doDownloadFile(t, r) {
    ...
    await new Promise((s, o) => {
      ...
      if (!this.options.isUseMultipleRangeRequest && this.options.onProgress) {
        ...
        d = new jv.ProgressDifferentialDownloadCallbackTransform(N, this.options.cancellationToken, this.options.onProgress), l.push(d);
      }
      ...
      if (this.options.isUseMultipleRangeRequest) {
        g = (0, Gl.executeTasksUsingMultipleRangeRequests)(this, t, h, n, o), g(0);
        return;
      }
      let v = 0, x = null;
      ...
      T.redirect = "manual", g = (b) => {
        ...
        ue.on("redirect", (Y, Ue, y) => {
          this.logger.info(`Redirect to ${Gv(y)}`), x = y, (0, Lr.configureRequestUrl)(new Bv.URL(x), T), ue.followRedirect();
  ...
  request(t, r) {
    return new Promise((n, i) => {
      const a = this.httpExecutor.createRequest(t, (s) => {
        (0, Gl.checkIsRangesSupported)(s, i) && (s.on("error", i), s.on("aborted", () => {
...
zi.GenericDifferentialDownloader = qv;
var kt = {};
(function(e) {
...
const Ce = xe, Xv = cn, Wv = Ti, Vv = Tc, sr = Pt, Yv = Te, Pa = Di, Mt = oe, Gt = _f, ql = gn, Kv = Li, Xl = bf, Jv = yn, ka = Ui, Qv = bc, Zv = Xe, eT = zi, or = kt;
class Ms extends Vv.EventEmitter {
  /**
  ...
  constructor(t, r) {
    ...
    }), r == null ? (this.app = new Kv.ElectronAppAdapter(), this.httpExecutor = new Xl.ElectronHttpExecutor((a, s) => this.emit("login", a, s))) : (this.app = r, this.httpExecutor = null);
  ...
  async executeDownload(t) {
    ...
    const h = s == null ? null : Mt.join(d, `package-${a}${Mt.extname(s.path) || ".7z"}`), g = async (_) => (await l.setDownloadedFile(f, h, i, r, c, _), await t.done({
      ...i,
      downloadedFile: f
    }), h == null ? [f] : [f, h]), v = this._logger, x = await l.validateDownloadedPath(f, i, r, v);
    if (x != null)
      return f = x, await g(!1);
    const T = async () => (await l.clear().catch(() => {
    }), await (0, sr.unlink)(f).catch(() => {
    })), b = await (0, ql.createTempUpdateFile)(`temp-${c}`, d, v);
    try {
...
class nT extends rT.AppUpdater {
  ...
  async spawnLog(t, r = [], n = void 0, i = "ignore") {
    return this._logger.info(`Executing: ${t} with args: ${r}`), new Promise((a, s) => {
      try {
        const o = { stdio: i, env: n, detached: !0 }, l = (0, Wl.spawn)(t, r, o);
        l.on("error", (d) => {
          s(d);
...
async function oT(e) {
  ...
  try {
    ...
    return await (0, lr.read)(t, i, 0, i.length, r - n.length - i.length), await (0, lr.close)(t), kf(i);
  } catch (r) {
...
const Vl = xe, Yl = vi, lT = Pt, cT = Dt, Ur = oe, uT = pt, fT = wn, dT = pe, Kl = kt;
class pT extends uT.BaseUpdater {
  ...
  doDownloadUpdate(t) {
    ...
    return this.executeDownload({
      ...
      task: async (i, a) => {
        ...
        if (s == null)
          throw (0, Vl.newError)("APPIMAGE env is not defined", "ERR_UPDATER_OLD_FILE_NOT_FOUND");
  ...
  async downloadDifferential(t, r, n, i, a) {
    try {
      ...
      return this.listenerCount(Kl.DOWNLOAD_PROGRESS) > 0 && (s.onProgress = (o) => this.emit(Kl.DOWNLOAD_PROGRESS, o)), await new fT.FileWithEmbeddedBlockMapDifferentialDownloader(t.info, this.httpExecutor, s).download(), !1;
    } catch (s) {
  ...
  doInstall(t) {
    ...
    if (a == null)
      return this.dispatchError(new Error("No valid update available, can't quit and install")), !1;
    Ur.basename(a) === i || !/\d+\.\d+\.\d+/.test(i) ? n = r : n = Ur.join(Ur.dirname(r), Ur.basename(a)), (0, Yl.execFileSync)("mv", ["-f", a, n]), n !== r && this.emit("appimage-filename-updated", n);
    const s = {
      ...process.env,
      APPIMAGE_SILENT_INSTALL: "true"
    };
    return t.isForceRunAfter ? this.spawnLog(n, [], s) : (s.APPIMAGE_EXIT_AFTER_INSTALL = "true", (0, Yl.execFileSync)(n, [], { env: s })), !0;
  }
}
...
class wT extends yT.BaseUpdater {
  ...
  /*** @private */
  doDownloadUpdate(t) {
    const r = t.updateInfoAndProvider.provider, n = (0, xT.findFile)(r.resolveFiles(t.updateInfoAndProvider.info), "pacman", ["AppImage", "deb", "rpm"]);
    return this.executeDownload({
...
const ec = xe, Na = Pt, _T = Dt, tc = oe, bT = mp, ST = At, AT = pe, rc = vi, nc = cn;
class IT extends ST.AppUpdater {
  ...
  async doDownloadUpdate(t) {
    ...
    let a = !1;
    try {
      this.debug("Checking for macOS Rosetta environment"), a = (0, rc.execFileSync)("sysctl", [i], { encoding: "utf8" }).includes(`${i}: 1`), n.info(`Checked for macOS Rosetta environment (isRosetta=${a})`);
    } catch (f) {
    ...
    try {
      ...
      const h = (0, rc.execFileSync)("uname", ["-a"], { encoding: "utf8" }).includes("ARM");
    ...
    if (l == null)
      throw (0, ec.newError)(`ZIP file not provided: ${(0, ec.safeStringifyJson)(r)}`, "ERR_UPDATER_ZIP_FILE_NOT_FOUND");
    ...
    return this.executeDownload({
      ...
      downloadUpdateOptions: t,
      task: async (f, h) => {
        const g = tc.join(this.downloadedUpdateHelper.cacheDir, c), v = () => (0, Na.pathExistsSync)(g) ? !t.disableDifferentialDownload : (n.info("Unable to locate previous update.zip for differential download (is this first install?), falling back to full download"), !1);
        let x = !0;
        v() && (x = await this.differentialDownloadInstaller(l, t, f, d, c)), x && await this.httpExecutor.download(l.url, f, h);
      },
      done: async (f) => {
        if (!t.disableDifferentialDownload)
          try {
            const h = tc.join(this.downloadedUpdateHelper.cacheDir, c);
            await (0, Na.copyFile)(f.downloadedFile, h);
          } catch (h) {
  ...
  async updateDownloaded(t, r) {
    ...
    return await new Promise((d, c) => {
      const f = (0, nc.randomBytes)(64).toString("base64").replace(/\//g, "_").replace(/\+/g, "-"), h = Buffer.from(`autoupdater:${f}`, "ascii"), g = `/${(0, nc.randomBytes)(64).toString("hex")}.zip`;
...
Bs.verifySignature = RT;
const ic = xe, Nf = vi, CT = Ti, ac = oe;
function RT(e, t, r) {
  return new Promise((n, i) => {
    const a = t.replace(/'/g, "''");
    r.info(`Verifying signature ${a}`), (0, Nf.execFile)('set "PSModulePath=" & chcp 65001 >NUL & powershell.exe', ["-NoProfile", "-NonInteractive", "-InputFormat", "None", "-Command", `"Get-AuthenticodeSignature -LiteralPath '${a}' | ConvertTo-Json -Compress"`], {
      shell: !0,
      timeout: 20 * 1e3
    }, (s, o, l) => {
      var d;
      try {
        ...
        if (c.Status === 0) {
          try {
            const v = ac.normalize(c.Path), x = ac.normalize(t);
          ...
          const h = (0, ic.parseDn)(c.SignerCertificate.Subject);
          let g = !1;
          for (const v of e) {
            const x = (0, ic.parseDn)(v);
            if (x.size ? g = Array.from(x.keys()).every((b) => x.get(b) === h.get(b)) : v === h.get("CN") && (r.warn(`Signature validated using only CN ${v}. Please add your full Distinguished Name (DN) to publisherNames configuration`), g = !0), g) {
              n(null);
              return;
            }
          }
...
const Wn = xe, sc = oe, PT = pt, kT = wn, oc = kt, NT = pe, FT = Pt, $T = Bs, lc = _r;
class LT extends PT.BaseUpdater {
    ...
    return this.executeDownload({
      ...
      task: async (i, a, s, o) => {
        ...
        if (d && await this.differentialDownloadWebPackage(t, l, s, r))
          try {
            await this.httpExecutor.download(new lc.URL(l.path), s, {
  ...
  doInstall(t) {
    ...
    const a = () => {
      this.spawnLog(sc.join(process.resourcesPath, "elevate.exe"), [r].concat(n)).catch((s) => this.dispatchError(s));
    };
  ...
  async differentialDownloadWebPackage(t, r, n, i) {
    ...
    try {
      const a = {
        newUrl: new lc.URL(r.path),
        oldFile: sc.join(this.downloadedUpdateHelper.cacheDir, Wn.CURRENT_APP_PACKAGE_FILE_NAME),
        logger: this._logger,
        newFile: n,
      ...
      this.listenerCount(oc.DOWNLOAD_PROGRESS) > 0 && (a.onProgress = (s) => this.emit(oc.DOWNLOAD_PROGRESS, s)), await new kT.FileWithEmbeddedBlockMapDifferentialDownloader(r, this.httpExecutor, a).download();
    } catch (a) {
...
function zT(e) {
  try {
    ...
    return t instanceof ReadableStreamDefaultReader ? new cc(t) : new jT(t);
  } catch (t) {
    if (t instanceof TypeError)
      return new cc(e.getReader());
    throw t;
  }
}
class qi {
...
var Xi = function(e, t, r, n, i) {
  ...
  var s, o, l, d = a * 8 - i - 1, c = (1 << d) - 1, f = c >> 1, h = i === 23 ? Math.pow(2, -24) - Math.pow(2, -77) : 0, g = n ? 0 : a - 1, v = n ? 1 : -1, x = t < 0 || t === 0 && 1 / t < 0 ? 1 : 0;
...
const tt = Ar("tokenizer:inflate"), $a = 256 * 1024, __ = jf(gr.DataDescriptor), Vn = jf(gr.EndOfCentralDirectory);
class zs {
  constructor(t) {
  ...
  async unzip(t) {
    ...
    do {
      ...
      if (await this.tokenizer.ignore(i.extraFieldLength), i.dataDescriptor && i.compressedSize === 0) {
        ...
        tt(`Found data-descriptor-signature at pos=${this.tokenizer.position}`), a.handler && await this.inflate(i, S_(o), a.handler);
      } else
      ...
      if (tt(`Reading data-descriptor at pos=${this.tokenizer.position}`), i.dataDescriptor && (await this.tokenizer.readToken(uc)).signature !== 134695760)
        throw new Error(`Expected data-descriptor-signature at position ${this.tokenizer.position - uc.len}`);
    } while (!n);
  }
      ...
      if (this.check([48, 38, 178, 117, 142, 102, 207, 17, 166, 217])) {
        async function r() {
          ...
          return await t.readBuffer(n), {
            id: n,
            size: Number(await t.readToken(Mf))
          };
        }
 ...
 * MIT Licensed
 */
var dc = /; *([!#$%&'*+.^_`|~0-9A-Za-z-]+) *= *("(?:[\u000b\u0020\u0021\u0023-\u005b\u005d-\u007e\u0080-\u00ff]|\\[\u000b\u0020-\u00ff])*"|[!#$%&'*+.^_`|~0-9A-Za-z-]+) */g, B_ = /^[\u000b\u0020-\u007e\u0080-\u00ff]+$/, Gf = /^[!#$%&'*+.^_`|~0-9A-Za-z-]+$/, j_ = /\\([\u000b\u0020-\u00ff])/g, z_ = /([\\"])/g, Hf = /^[!#$%&'*+.^_`|~0-9A-Za-z-]+\/[!#$%&'*+.^_`|~0-9A-Za-z-]+$/;
Gs.format = G_;
Gs.parse = H_;
function G_(e) {
...
function H_(e) {
  ...
  if (r !== -1) {
    var a, s, o;
    for (dc.lastIndex = r; s = dc.exec(t); ) {
      if (s.index !== r)
...
class qf extends En("CouldNotDetermineFileTypeError") {
}
class Xf extends En("UnsupportedFileTypeError") {
}
...
class Wf extends En("InternalParserError") {
}
...
function Vf(e, t, r, n) {
  ...
  s &= 255 >> a;
  const o = 8 - a, l = n - o;
  return l < 0 ? s >>= 8 - a - n : l > 0 && (s <<= l, s |= Vf(e, t, r + o, l)), s;
}
function KS(e, t, r) {
  return Vf(e, t, r, 1) === 1;
}
...
class Rb {
  ...
  mapTag(t, r, n) {
    ...
    throw new Wf(`No generic tag mapper defined for tag-format: ${t}`);
  }
  registerTagMapper(t) {
...
function Ob(e) {
  return os.test(e) ? Pb(e) : Db(e);
}
function Db(e) {
  return {
    contentType: Yf.lyrics,
    timeStampFormat: Kf.notSynchronized,
    text: e.trim(),
    syncText: []
  };
}
...
`), r = [];
  ...
  return {
    contentType: Yf.lyrics,
    timeStampFormat: Kf.milliseconds,
...
const $b = {
  ...
  async load() {
    return (await import("./MpegParser-Bya_biYm.js")).MpegParser;
  }
}, Lb = {
  parserType: "apev2",
  extensions: [".ape"],
  ...
  async load() {
    return (await import("./AsfParser-Bk7HpyG8.js")).AsfParser;
  }
}, Mb = {
  parserType: "dsdiff",
  extensions: [".dff"],
  ...
  async load() {
    return (await import("./DsdiffParser-0GyPLivS.js")).DsdiffParser;
  }
}, Bb = {
  parserType: "aiff",
  ...
  async load() {
    return (await import("./AiffParser-CPx2kDCj.js")).AIFFParser;
  }
}, jb = {
  parserType: "dsf",
  extensions: [".dsf"],
  mimeTypes: ["audio/dsf"],
  async load() {
    return (await import("./DsfParser-J5rUgSLF.js")).DsfParser;
  }
}, zb = {
  parserType: "flac",
  extensions: [".flac"],
  ...
  async load() {
    return (await import("./FlacParser-Q1Te2tUO.js").then((e) => e.d)).FlacParser;
  }
}, Gb = {
  parserType: "matroska",
  ...
  async load() {
    return (await import("./MatroskaParser-B1SEKDgC.js")).MatroskaParser;
  }
}, Hb = {
  parserType: "mp4",
  ...
  async load() {
    return (await import("./MP4Parser-CIgDThdw.js")).MP4Parser;
  }
}, qb = {
  parserType: "musepack",
  extensions: [".mpc"],
  ...
  async load() {
    return (await import("./MusepackParser-C69fmO2T.js")).MusepackParser;
  }
}, Xb = {
  parserType: "ogg",
  ...
  async load() {
    return (await import("./OggParser-RvgCWSP1.js")).OggParser;
  }
}, Wb = {
  parserType: "wavpack",
  extensions: [".wv", ".wvp"],
  ...
  async load() {
    return (await import("./WavPackParser-BeS3CLmy.js")).WavPackParser;
  }
}, Vb = {
  parserType: "riff",
  ...
  async load() {
    return (await import("./WaveParser-BhHdoMPx.js")).WaveParser;
  }
}, jt = Ar("music-metadata:parser:factory");
function Yb(e) {
  const t = Gs.parse(e), r = Y_(t.type);
  return {
    type: r.type,
    subtype: r.subtype,
    suffix: r.suffix,
...
class Kb {
  ...
  async parse(t, r, n) {
    if (t.supportsRandomAccess() ? (jt("tokenizer supports random-access, scanning for appending headers"), await xS(t, n)) : jt("tokenizer does not support random-access, cannot scan for appending headers"), !r) {
      ...
      if (t.fileInfo.mimeType && (r = this.findLoaderForContentType(t.fileInfo.mimeType)), !r && t.fileInfo.path && (r = this.findLoaderForExtension(t.fileInfo.path)), !r) {
        ...
        if (jt(`Guessed file type is mime=${l.mime}, extension=${l.ext}`), r = this.findLoaderForContentType(l.mime), !r)
          throw new Xf(`Guessed MIME-type not supported: ${l.mime}`);
      }
    }
    jt(`Loading ${r.parserType} parser...`);
    const i = new Nb(n), a = await r.load(), s = new a(i, t, n ?? {});
    return jt(`Parser ${r.parserType} loaded`), await s.parse(), i.format.trackInfo && (i.format.hasAudio === void 0 && i.setFormat("hasAudio", !!i.format.trackInfo.find((o) => o.type === ut.audio)), i.format.hasVideo === void 0 && i.setFormat("hasVideo", !!i.format.trackInfo.find((o) => o.type === ut.video))), i.toCommonMetadata();
  }
  /**
...
for (const [e, t] of Object.entries(Qf))
  Zf[t] = Number.parseInt(e, 10);
let Yn, Kn;
function Qb() {
...
function aS(e) {
  ...
  let r = "";
  for (let n = 0; n < e.length; n++) {
    const i = e[n], a = i >= 128 && i <= 159 ? Qf[i] : void 0;
...
const fS = /^[\x21-\x7e©][\x20-\x7e\x00()]{3}/, ed = {
  len: 4,
  get: (e, t) => {
    const r = Vi(e.subarray(t, t + ed.len), "latin1");
    if (!r.match(fS))
      throw new Hs(`FourCC contains invalid characters: ${nb(r)} "${r}"`);
    return r;
  },
  put: (e, t, r) => {
    const n = eS(r, "latin1");
    if (n.length !== 4)
      throw new Wf("Invalid length");
...
const wt = Ar("music-metadata:parser:APEv2"), gc = "APEv2", yc = "APETAGEX";
...
class St extends Jf {
  ...
  static async findApeFooterOffset(t, r) {
    ...
    if (r > Be.len) {
      ...
      const a = Be.get(n, 0);
      if (a.ID === "APETAGEX")
        return a.flags.isHeader ? wt(`APE Header found at offset=${r - Be.len}`) : (wt(`APE Footer found at offset=${r - Be.len}`), r -= a.size), { footer: a, offset: r };
    }
  }
  ...
  async parse() {
    const t = await this.tokenizer.readToken(mc);
    if (t.ID !== "MAC ")
      throw new ai("Unexpected descriptor ID");
    this.ape.descriptor = t;
    const r = t.descriptorBytes - mc.len, n = await (r > 0 ? this.parseDescriptorExpansion(r) : this.parseHeader());
    ...
    for (let i = 0; i < t.fields; i++) {
      ...
      switch (await this.tokenizer.ignore(1), n -= o.length + 1, a.flags.dataType) {
        case Jn.text_utf8: {
          ...
          await Promise.all(d.map((c) => this.metadata.addTag(gc, o, c)));
          break;
        }
        case Jn.binary:
          if (this.options.skipCovers)
            ...
            await this.tokenizer.readBuffer(l), s = pc(l, 0, l.length);
            const d = Vi(l.subarray(0, s), "utf-8"), c = l.subarray(s + 1);
            await this.metadata.addTag(gc, o, {
              description: d,
              data: c
            });
          }
...
const wc = Ar("music-metadata:parser");
async function wS(e, t = {}) {
  wc(`parseFile: ${e}`);
  const r = await YT(e), n = new Kb();
  try {
    const i = n.findLoaderForExtension(e);
    i || wc("Parser could not be determined by file extension");
    try {
      return await n.parse(r, i, t);
    } catch (a) {
      throw (a instanceof qf || a instanceof Xf) && (a.message += `: ${e}`), a;
    }
  } finally {
    await r.close();
  }
...
at.autoUpdater.allowPrerelease = !0;
const vS = ft.requestSingleInstanceLock();
vS ? ft.on("second-instance", () => {
  J && (J.isMinimized() && J.restore(), J.focus());
}) : ft.quit();
const nd = je.dirname(fp(import.meta.url));
process.env.APP_ROOT = je.join(nd, "..");
const ls = process.env.VITE_DEV_SERVER_URL, rA = je.join(process.env.APP_ROOT, "dist-electron"), id = je.join(process.env.APP_ROOT, "dist");
process.env.VITE_PUBLIC = ls ? je.join(process.env.APP_ROOT, "public") : id;
let J;
function ad() {
  J = new Ec({
    width: 1200,
    ...
    webPreferences: {
      preload: je.join(nd, "preload.mjs"),
      webSecurity: !1,
  ...
  }), ls ? J.loadURL(ls) : J.loadFile(je.join(id, "index.html"));
}
ft.on("window-all-closed", () => {
  process.platform !== "darwin" && (ft.quit(), J = null);
});
ft.on("activate", () => {
  Ec.getAllWindows().length === 0 && ad();
});
...
ft.whenReady().then(() => {
  ad(), qe.handle("dialog:openDirectory", async () => {
    ...
    try {
      ...
      return i.filter((s) => a.includes(je.extname(s).toLowerCase())).map((s) => je.join(n, s));
    } catch (i) {
    ...
    const r = je.join(process.env.APP_ROOT, "scripts/get-active-window.ps1");
    return await ES(r);
  });
  const e = up(import.meta.url)("yt-dlp-wrap").default, t = async () => {
    const r = process.platform === "win32" ? "yt-dlp.exe" : "yt-dlp", n = je.join(ft.getPath("userData"), r);
    try {
      await ia.access(n);
    } catch {
...
`).map((o) => {
  ...
  }), qe.handle("download:youtube", async (r, n, i) => {
    try {
      const a = await t();
      let s = i.replace(/[\\/:*?"<>|]/g, "_").trim();
      const { filePath: o } = await fo.showSaveDialog(J, {
        title: "下載歌曲",
        defaultPath: `${s}.m4a`,
        // Force m4a for best playback without ffmpeg
        filters: [{ name: "Audio (m4a)", extensions: ["m4a"] }]
      });
      return o ? new Promise((l, d) => {
        const c = a.exec([
          n,
          "-f",
          "bestaudio[ext=m4a]",
        ...
        c.on("progress", (f) => {
          ...
          console.error("yt-dlp error:", f), d(new Error(`下載錯誤: ${f.message}`));
        }), c.on("close", () => {
          l(o);
        });
      }) : null;
    } catch (a) {
      throw console.error("Download fatal error:", a), new Error(a.message);
    }
      ...
      try {
        ...
        if (l.ok) {
          ...
          if (d && d.artists && d.artists.length > 0) {
            const c = d.artists[0], f = c.strArtistThumb || c.strArtistFanart;
            if (f) return f;
          }
        }
      } catch {
    ...
    try {
      if (!(!n || !i || n.includes("Unknown") || i.includes("Unknown"))) {
        const o = `https://lrclib.net/api/get?artist_name=${encodeURIComponent(i)}&track_name=${encodeURIComponent(n)}`, l = await fetch(o);
        if (l.ok) {
          const d = await l.json();
      ...
      if (a) {
        const o = je.basename(a, je.extname(a)), l = `https://lrclib.net/api/search?q=${encodeURIComponent(o)}`, d = await fetch(l);
        if (d.ok) {
          const c = await d.json();
          if (c && c.length > 0) {
            const f = c.find((h) => h.syncedLyrics) || c[0];
            return f.syncedLyrics || f.plainLyrics || null;
          }
        }
      }
      return null;
    ...
    at.autoUpdater.quitAndInstall(!0, !0);
  }), qe.handle("app:version", () => ft.getVersion());
});
export {
  QS as A,
  Jf as B,
