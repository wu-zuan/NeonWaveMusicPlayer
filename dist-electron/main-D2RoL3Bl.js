...
function _p(e) {
  xt.hasOwnProperty("O_SYMLINK") && process.version.match(/^v0\.6\.[0-2]|^v0\.5\./) && t(e), e.lutimes || r(e), e.chown = a(e.chown), e.fchown = a(e.fchown), e.lchown = a(e.lchown), e.chmod = n(e.chmod), e.fchmod = n(e.fchmod), e.lchmod = n(e.lchmod), e.chownSync = s(e.chownSync), e.fchownSync = s(e.fchownSync), e.lchownSync = s(e.lchownSync), e.chmodSync = i(e.chmodSync), e.fchmodSync = i(e.fchmodSync), e.lchmodSync = i(e.lchmodSync), e.stat = o(e.stat), e.fstat = o(e.fstat), e.lstat = o(e.lstat), e.statSync = l(e.statSync), e.fstatSync = l(e.fstatSync), e.lstatSync = l(e.lstatSync), e.chmod && !e.lchmod && (e.lchmod = function(c, u, p) {
    ...
    function u(p, g, E, x, T, b) {
      var _;
      if (b && typeof b == "function") {
        var N = 0;
        _ = function($, ie, ue) {
          if ($ && $.code === "EAGAIN" && N < 10)
            return N++, c.call(e, p, g, E, x, T, _);
          b.apply(this, arguments);
        };
      }
      return c.call(e, p, g, E, x, T, _);
    }
    return Object.setPrototypeOf && Object.setPrototypeOf(u, c), u;
  }(e.read), e.readSync = typeof e.readSync != "function" ? e.readSync : /* @__PURE__ */ function(c) {
    return function(u, p, g, E, x) {
      for (var T = 0; ; )
        try {
          return c.call(e, u, p, g, E, x);
        } catch (b) {
  ...
  function t(c) {
    c.lchmod = function(u, p, g) {
      ...
      var g = c.openSync(u, xt.O_WRONLY | xt.O_SYMLINK, p), E = !0, x;
      try {
        x = c.fchmodSync(g, p), E = !1;
      } finally {
        if (E)
          try {
            c.closeSync(g);
  ...
  function r(c) {
    xt.hasOwnProperty("O_SYMLINK") && c.futimes ? (c.lutimes = function(u, p, g, E) {
      ...
      var E = c.openSync(u, xt.O_SYMLINK), x, T = !0;
      try {
        x = c.futimesSync(E, p, g), T = !1;
      } finally {
        if (T)
          try {
            c.closeSync(E);
      ...
      return x;
    }) : c.futimes && (c.lutimes = function(u, p, g, E) {
...
const wo = Ne, Gc = oe, ee = _c, Kr = process.platform === "win32";
function Hc(e) {
  [
    "unlink",
    "chmod",
...
function Ch(e, t) {
  if (ee(e), ee(t), t.readdirSync(e).forEach((r) => qc(Gc.join(e, r), t)), Kr) {
    const r = Date.now();
    do
      try {
  ...
  function e(t) {
    ...
    function n(u) {
      ...
      return T.namespace = u, T.useColors = n.useColors(), T.color = n.selectColor(u), T.extend = i, T.destroy = n.destroy, Object.defineProperty(T, "enabled", {
        enumerable: !0,
        configurable: !1,
        get: () => g !== null ? g : (E !== n.namespaces && (E = n.namespaces, x = n.enabled(u)), x),
        set: (b) => {
          g = b;
        }
...
function n0() {
  return Bo || (Bo = 1, function(e, t) {
    ...
    t.inspectOpts = Object.keys(process.env).filter((p) => /^debug_/i.test(p)).reduce((p, g) => {
      const E = g.substring(6).toLowerCase().replace(/_([a-z])/g, (T, b) => b.toUpperCase());
      let x = process.env[g];
    ...
    t.on("error", a), t.on("data", (g) => p += g), t.on("end", () => {
      try {
        if (t.statusCode != null && t.statusCode >= 400) {
          const g = xr(t, "content-type"), E = g != null && (Array.isArray(g) ? g.find((x) => x.includes("json")) != null : g.includes("json"));
          a(qa(t, `method: ${r.method || "GET"} url: ${r.protocol || "https:"}//${r.hostname}${r.port ? `:${r.port}` : ""}${r.path}
...
(function(e) {
  (function(t) {
    ...
    var u = "[CDATA[", p = "DOCTYPE", g = "http://www.w3.org/XML/1998/namespace", E = "http://www.w3.org/2000/xmlns/", x = { xml: g, xmlns: E }, T = /[:_A-Za-z\u00C0-\u00D6\u00D8-\u00F6\u00F8-\u02FF\u0370-\u037D\u037F-\u1FFF\u200C-\u200D\u2070-\u218F\u2C00-\u2FEF\u3001-\uD7FF\uF900-\uFDCF\uFDF0-\uFFFD]/, b = /[:_A-Za-z\u00C0-\u00D6\u00D8-\u00F6\u00F8-\u02FF\u0370-\u037D\u037F-\u1FFF\u200C-\u200D\u2070-\u218F\u2C00-\u2FEF\u3001-\uD7FF\uF900-\uFDCF\uFDF0-\uFFFD\u00B7\u0300-\u036F\u203F-\u2040.\d-]/, _ = /[#:_A-Za-z\u00C0-\u00D6\u00D8-\u00F6\u00F8-\u02FF\u0370-\u037D\u037F-\u1FFF\u200C-\u200D\u2070-\u218F\u2C00-\u2FEF\u3001-\uD7FF\uF900-\uFDCF\uFDF0-\uFFFD]/, N = /[#:_A-Za-z\u00C0-\u00D6\u00D8-\u00F6\u00F8-\u02FF\u0370-\u037D\u037F-\u1FFF\u200C-\u200D\u2070-\u218F\u2C00-\u2FEF\u3001-\uD7FF\uF900-\uFDCF\uFDF0-\uFFFD\u00B7\u0300-\u036F\u203F-\u2040.\d-]/;
    function $(h) {
      return h === " " || h === `
` || h === "\r" || h === "	";
    }
    ...
    function X(h, f) {
      if (h.opt.xmlns) {
        ...
        for (var re = 0, le = h.attribList.length; re < le; re++) {
          var we = h.attribList[re], _e = we[0], ht = we[1], de = O(_e, !0), We = de.prefix, Ki = de.local, Tn = We === "" ? "" : S.ns[We] || "", Rr = {
            name: _e,
            value: ht,
            prefix: We,
            local: Ki,
...
function Zg(e, t) {
  var r = !0, n, i, a, s = e.tag, o, l = e.anchor, d, c, u, p, g, E = /* @__PURE__ */ Object.create(null), x, T, b, _;
...
function ty(e, t, r) {
  var n, i, a, s, o, l, d = e.tag, c = e.anchor, u = {}, p = /* @__PURE__ */ Object.create(null), g = null, E = null, x = null, T = !1, b = !1, _;
  if (e.firstTabInLine !== -1) return !1;
  for (e.anchor !== null && (e.anchorMap[e.anchor] = u), _ = e.input.charCodeAt(e.position); _ !== 0; ) {
    if (!T && e.firstTabInLine !== -1 && (e.position = e.firstTabInLine, L(e, "tab characters must not be used in indentation")), n = e.input.charCodeAt(e.position + 1), a = e.line, (_ === 63 || _ === 58) && Ue(n))
      _ === 63 ? (T && (dr(e, u, p, g, E, null, s, o, l), g = E = x = null), b = !0, T = !0, i = !0) : T ? (T = !1, i = !0) : L(e, "incomplete explicit mapping pair; a key node is missed; or followed by a non-tabulated empty line"), e.position += 1, _ = n;
    else {
      ...
      if (e.line === a) {
        ...
        if (_ === 58)
          _ = e.input.charCodeAt(++e.position), Ue(_) || L(e, "a whitespace character is expected after the key-value separator within a block mapping"), T && (dr(e, u, p, g, E, null, s, o, l), g = E = x = null), b = !0, T = !1, i = !1, g = e.tag, E = e.result;
        else if (b)
    ...
    if ((e.line === a || e.lineIndent > t) && (T && (s = e.line, o = e.lineStart, l = e.position), Tr(e, t, hi, !0, i) && (T ? E = e.result : x = e.result), T || (dr(e, u, p, g, E, x, s, o, l), g = E = x = null), fe(e, !0, -1), _ = e.input.charCodeAt(e.position)), (e.line === a || e.lineIndent > t) && _ !== 0)
      L(e, "bad indentation of a mapping entry");
    else if (e.lineIndent < t)
      break;
  }
  return T && dr(e, u, p, g, E, null, s, o, l), b && (e.tag = d, e.anchor = c, e.kind = "mapping", e.result = u), b;
}
function ry(e) {
  var t, r = !1, n = !1, i, a, s;
...
function Tr(e, t, r, n, i) {
  var a, s, o, l = 1, d = !1, c = !1, u, p, g, E, x, T;
...
function Ny(e, t, r, n, i, a, s, o) {
  var l, d = 0, c = null, u = !1, p = !1, g = n !== -1, E = -1, x = Py(Br(e, 0)) && ky(Br(e, e.length - 1));
  if (t || s)
...
function Ze() {
  ...
  class t {
    ...
    parseRange(I) {
      const A = ((this.options.includePrerelease && g) | (this.options.loose && E)) + ":" + I, k = n.get(A);
      if (k)
        return k;
  ...
  const r = uw, n = new r(), i = Ds, a = $i(), s = Ni, o = $e, {
    ...
    tildeTrimReplace: u,
    caretTrimReplace: p
  } = mn, { FLAG_INCLUDE_PRERELEASE: g, FLAG_LOOSE: E } = ki, x = (R) => R.value === "<0.0.0-0", T = (R) => R.value === "", b = (R, I) => {
    let D = !0;
    const A = R.slice();
    let k = A.pop();
    for (; D && A.length; )
...
(function(e, t) {
  ...
  function Gd(m, w) {
    var C = Rn(m), F = !C && ip(m), ne = !C && !F && na(m), H = !C && !F && !ne && uo(m), ce = C || F || ne || H, me = ce ? We(m.length, String) : [], Ee = me.length;
    for (var ae in m)
  ...
  function no(m, w, C, F, ne) {
    return m === w ? !0 : m == null || w == null || !kr(m) && !kr(w) ? m !== m && w !== w : qd(m, w, C, F, no, ne);
  }
  function qd(m, w, C, F, ne, H) {
    ...
    if (be && !Be)
      return H || (H = new mt()), ce || uo(m) ? io(m, w, C, F, ne, H) : Yd(m, w, Ee, C, F, ne, H);
    if (!(C & i)) {
    ...
    return be ? (H || (H = new mt()), Kd(m, w, C, F, ne, H)) : !1;
  }
  function Xd(m) {
    if (!co(m) || tp(m))
      return !1;
  ...
  (Qi && gt(new Qi(new ArrayBuffer(1))) != B || Or && gt(new Or()) != x || Zi && gt(Zi.resolve()) != N || ea && gt(new ea()) != ue || ta && gt(new ta()) != q) && (gt = function(m) {
...
${o}`, "ERR_UPDATER_INVALID_RELEASE_FEED");
    ...
    try {
      let T = this.channel;
      this.updater.allowPrerelease && (!((i = pr.prerelease(c)) === null || i === void 0) && i[0]) && (T = this.getCustomChannelName(String((a = pr.prerelease(c)) === null || a === void 0 ? void 0 : a[0]))), u = await E(T);
    } catch (T) {
      if (this.updater.allowPrerelease)
...
function Rv(e, t, r) {
  ...
  for (let x = 0; x < c.checksums.length; E += c.sizes[x], x++) {
    ...
    let _ = p.get(b);
    _ != null && g.get(b) !== T && (r.warn(`Checksum ("${b}") matches, but size differs (old: ${g.get(b)}, new: ${T})`), _ = void 0), _ === void 0 ? (u++, a != null && a.kind === Xt.DOWNLOAD && a.end === E ? a.end += T : (a = {
      kind: Xt.DOWNLOAD,
      start: E,
      end: E + T
      // oldBlocks: null,
...
function Lv(e, t, r, n, i) {
  ...
  const c = e.httpExecutor.createRequest(d, (u) => {
    ...
    const E = new zl.DataSplitter(r, t, o, g[1] || g[2], l, n);
      ...
      T.redirect = "manual", g = (b) => {
        ...
        const ue = this.httpExecutor.createRequest(T, (Y) => {
          Y.on("error", o), Y.on("aborted", () => {
            ...
            d && d.endRangeDownload(), ++E === 100 ? (E = 0, setTimeout(() => g(b), 1e3)) : g(b);
          });
        });
...
class Bs extends Kv.EventEmitter {
  ...
  async executeDownload(t) {
    ...
    const p = s == null ? null : Mt.join(d, `package-${a}${Mt.extname(s.path) || ".7z"}`), g = async (_) => (await l.setDownloadedFile(u, p, i, r, c, _), await t.done({
      ...i,
      downloadedFile: u
    }), p == null ? [u] : [u, p]), E = this._logger, x = await l.validateDownloadedPath(u, i, r, E);
    if (x != null)
      return u = x, await g(!1);
    const T = async () => (await l.clear().catch(() => {
    }), await (0, sr.unlink)(u).catch(() => {
    })), b = await (0, Xl.createTempUpdateFile)(`temp-${c}`, d, E);
    try {
      await t.task(b, n, p, T), await (0, Ce.retry)(() => (0, sr.rename)(b, u), 60, 500, 0, 0, (_) => _ instanceof Error && /^EBUSY:/.test(_.message));
    } catch (_) {
      throw await T(), _ instanceof Ce.CancellationError && (E.info("cancelled"), this.emit("update-cancelled", i)), _;
    }
    return E.info(`New version ${a} has been downloaded to ${u}`), await g(!0);
  }
...
class RT extends IT.AppUpdater {
  ...
  async doDownloadUpdate(t) {
    ...
    return this.executeDownload({
      ...
      downloadUpdateOptions: t,
      task: async (u, p) => {
        const g = rc.join(this.downloadedUpdateHelper.cacheDir, c), E = () => (0, Fa.pathExistsSync)(g) ? !t.disableDifferentialDownload : (n.info("Unable to locate previous update.zip for differential download (is this first install?), falling back to full download"), !1);
        let x = !0;
        E() && (x = await this.differentialDownloadInstaller(l, t, u, d, c)), x && await this.httpExecutor.download(l.url, u, p);
      },
      done: async (u) => {
    ...
    return await new Promise((d, c) => {
      ...
      this.server.on("request", (E, x) => {
        ...
        if (s.info(`${T} requested`), T === "/") {
          ...
          const N = E.headers.authorization.split(" ")[1], $ = Buffer.from(N, "base64").toString("ascii"), [ie, ue] = $.split(":");
      ...
      try {
        ...
        if (c.Status === 0) {
          ...
          for (const E of e) {
            ...
            if (x.size ? g = Array.from(x.keys()).every((b) => x.get(b) === p.get(b)) : E === p.get("CN") && (r.warn(`Signature validated using only CN ${E}. Please add your full Distinguished Name (DN) to publisherNames configuration`), g = !0), g) {
              n(null);
              return;
            }
          }
...
var Wi = function(e, t, r, n, i) {
  ...
  var s, o, l, d = a * 8 - i - 1, c = (1 << d) - 1, u = c >> 1, p = i === 23 ? Math.pow(2, -24) - Math.pow(2, -77) : 0, g = n ? 0 : a - 1, E = n ? 1 : -1, x = t < 0 || t === 0 && 1 / t < 0 ? 1 : 0;
  for (t = Math.abs(t), isNaN(t) || t === 1 / 0 ? (o = isNaN(t) ? 1 : 0, s = c) : (s = Math.floor(Math.log(t) / Math.LN2), t * (l = Math.pow(2, -s)) < 1 && (s--, l *= 2), s + u >= 1 ? t += p / l : t += p * Math.pow(2, 1 - u), t * l >= 2 && (s++, l /= 2), s + u >= c ? (o = 0, s = c) : s + u >= 1 ? (o = (t * l - 1) * Math.pow(2, i), s = s + u) : (o = t * Math.pow(2, u - 1) * Math.pow(2, i), s = 0)); i >= 8; e[r + g] = o & 255, g += E, o /= 256, i -= 8)
    ;
  for (s = s << i | o, d += i; d > 0; e[r + g] = s & 255, g += E, s /= 256, d -= 8)
    ;
  e[r + g - E] |= x * 128;
};
const is = {
...
const Ub = {
  ...
  async load() {
    return (await import("./MpegParser-D0T_Y4Iw.js")).MpegParser;
  }
}, Mb = {
  parserType: "apev2",
  extensions: [".ape"],
  ...
  async load() {
    return (await import("./AsfParser-Ctt3ZYIK.js")).AsfParser;
  }
}, jb = {
  parserType: "dsdiff",
  extensions: [".dff"],
  ...
  async load() {
    return (await import("./DsdiffParser-YW2M8PZF.js")).DsdiffParser;
  }
}, zb = {
  parserType: "aiff",
  ...
  async load() {
    return (await import("./AiffParser-AnXgO9H8.js")).AIFFParser;
  }
}, Gb = {
  parserType: "dsf",
  extensions: [".dsf"],
  mimeTypes: ["audio/dsf"],
  async load() {
    return (await import("./DsfParser-DblAsKhD.js")).DsfParser;
  }
}, Hb = {
  parserType: "flac",
  extensions: [".flac"],
  ...
  async load() {
    return (await import("./FlacParser-BvQ3_k-j.js").then((e) => e.d)).FlacParser;
  }
}, qb = {
  parserType: "matroska",
  ...
  async load() {
    return (await import("./MatroskaParser-xJkdjRmg.js")).MatroskaParser;
  }
}, Xb = {
  parserType: "mp4",
  ...
  async load() {
    return (await import("./MP4Parser-DL6mUPLp.js")).MP4Parser;
  }
}, Wb = {
  parserType: "musepack",
  extensions: [".mpc"],
  ...
  async load() {
    return (await import("./MusepackParser-C5U6hkLD.js")).MusepackParser;
  }
}, Vb = {
  parserType: "ogg",
  ...
  async load() {
    return (await import("./OggParser-8uHQyk4q.js")).OggParser;
  }
}, Yb = {
  parserType: "wavpack",
  extensions: [".wv", ".wvp"],
  ...
  async load() {
    return (await import("./WavPackParser-B4GnZVme.js")).WavPackParser;
  }
}, Kb = {
  parserType: "riff",
  ...
  async load() {
    return (await import("./WaveParser-BYis2G4B.js")).WaveParser;
  }
...
`).map((o) => {
    ...
    try {
      ...
      return d ? new Promise((c, u) => {
        ...
        g.on("progress", () => {
          ...
          console.error("yt-dlp error:", E), u(new Error(`下載錯誤: ${E.message}`));
        }), g.on("close", () => {
          c(d);
        });
      }) : null;
    ...
    try {
      ...
      console.log(`[Lyrics] Strict Search: ${n} / ${i}`);
      const l = async (d) => {
        try {
          const c = `https://lrclib.net/api/search?q=${encodeURIComponent(d)}`, u = await fetch(c);
          if (u.ok) {
            const p = await u.json();
            if (Array.isArray(p) && p.length > 0) {
              const g = p.find((E) => E.syncedLyrics && E.syncedLyrics.length > 0);
              if (g)
                return console.log(`[Lyrics] Match found: ${g.trackName} by ${g.artistName}`), g.syncedLyrics;
            }
          }
        } catch (c) {
          console.error("LRC Search Error", d, c);
        }
        return null;
      };
      if (n && i) {
      ...
      if (a) {
        let d = Re.basename(a, Re.extname(a));
        d = d.replace(/\(.*\)/g, "").replace(/\[.*\]/g, "").replace(/_/g, " ");
        const c = o(d);
        if (c && c.length === 2) {
          const p = await l(`${c[1]} ${c[0]}`);
          if (p) return p;
        }
        const u = await l(d);
        if (u) return u;
      }
      return console.log("[Lyrics] No synced lyrics found."), null;
    } catch (o) {
