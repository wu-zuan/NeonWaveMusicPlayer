...
function ey(e, t, r) {
  ...
  for (e.anchor !== null && (e.anchorMap[e.anchor] = u), _ = e.input.charCodeAt(e.position); _ !== 0; ) {
    ...
    if ((e.line === a || e.lineIndent > t) && (T && (s = e.line, o = e.lineStart, l = e.position), Tr(e, t, pi, !0, i) && (T ? E = e.result : x = e.result), T || (dr(e, u, p, g, E, x, s, o, l), g = E = x = null), fe(e, !0, -1), _ = e.input.charCodeAt(e.position)), (e.line === a || e.lineIndent > t) && _ !== 0)
...
function ky(e, t, r, n, i, a, s, o) {
  var l, d = 0, c = null, u = !1, p = !1, g = n !== -1, E = -1, x = Dy(Br(e, 0)) && Py(Br(e, e.length - 1));
  if (t || s)
...
function Qe() {
  ...
  const r = cw, n = new r(), i = Os, a = Fi(), s = ki, o = $e, {
    ...
    tildeTrimReplace: u,
    caretTrimReplace: p
  } = mn, { FLAG_INCLUDE_PRERELEASE: g, FLAG_LOOSE: E } = Pi, x = (R) => R.value === "<0.0.0-0", T = (R) => R.value === "", b = (R, I) => {
    let D = !0;
    const A = R.slice();
    let k = A.pop();
    for (; D && A.length; )
...
(function(e, t) {
  ...
  var Ze = typeof Oe == "object" && Oe && Oe.Object === Object && Oe, h = typeof self == "object" && self && self.Object === Object && self, f = Ze || h || Function("return this")(), S = t && !t.nodeType && t, v = S && !0 && e && !e.nodeType && e, K = v && v.exports === S, re = K && Ze.process, le = function() {
    try {
...
class CT extends AT.AppUpdater {
  ...
  async doDownloadUpdate(t) {
    ...
    return this.executeDownload({
      ...
      downloadUpdateOptions: t,
      task: async (u, p) => {
        const g = rc.join(this.downloadedUpdateHelper.cacheDir, c), E = () => (0, Na.pathExistsSync)(g) ? !t.disableDifferentialDownload : (n.info("Unable to locate previous update.zip for differential download (is this first install?), falling back to full download"), !1);
        let x = !0;
        ...
        if (c.Status === 0) {
          try {
            ...
            if (r.info(`LiteralPath: ${E}. Update Path: ${x}`), E !== x) {
              Fa(r, new Error(`LiteralPath of ${E} is different than ${x}`), l, i), n(null);
              return;
            }
          } catch (E) {
...
const Lb = {
  ...
  async load() {
    return (await import("./MpegParser-DYtVmd0y.js")).MpegParser;
  }
}, Ub = {
  parserType: "apev2",
  extensions: [".ape"],
  ...
  async load() {
    return (await import("./AsfParser-jTj0Yo9n.js")).AsfParser;
  }
}, Bb = {
  parserType: "dsdiff",
  extensions: [".dff"],
  ...
  async load() {
    return (await import("./DsdiffParser-C5AKpI3S.js")).DsdiffParser;
  }
}, jb = {
  parserType: "aiff",
  ...
  async load() {
    return (await import("./AiffParser-Ct7iDNSw.js")).AIFFParser;
  }
}, zb = {
  parserType: "dsf",
  extensions: [".dsf"],
  mimeTypes: ["audio/dsf"],
  async load() {
    return (await import("./DsfParser-CyQtKUg-.js")).DsfParser;
  }
}, Gb = {
  parserType: "flac",
  extensions: [".flac"],
  ...
  async load() {
    return (await import("./FlacParser-CbBxnBMP.js").then((e) => e.d)).FlacParser;
  }
}, Hb = {
  parserType: "matroska",
  ...
  async load() {
    return (await import("./MatroskaParser-BtLENKEh.js")).MatroskaParser;
  }
}, qb = {
  parserType: "mp4",
  ...
  async load() {
    return (await import("./MP4Parser-CNrq9w7D.js")).MP4Parser;
  }
}, Xb = {
  parserType: "musepack",
  extensions: [".mpc"],
  ...
  async load() {
    return (await import("./MusepackParser-DCfPhZPY.js")).MusepackParser;
  }
}, Wb = {
  parserType: "ogg",
  ...
  async load() {
    return (await import("./OggParser-iHCCylju.js")).OggParser;
  }
}, Vb = {
  parserType: "wavpack",
  extensions: [".wv", ".wvp"],
  ...
  async load() {
    return (await import("./WavPackParser-D9zc2lfV.js")).WavPackParser;
  }
}, Yb = {
  parserType: "riff",
  ...
  async load() {
    return (await import("./WaveParser-Br9x8V1p.js")).WaveParser;
  }
...
`).map((o) => {
    ...
    try {
        ...
        try {
          ...
          if (p.ok) {
            ...
            if (Array.isArray(g) && g.length > 0) {
              const E = (i || "").split(" ")[0].toLowerCase(), x = g.find((T) => T.syncedLyrics && (!E || T.artistName.toLowerCase().includes(E))) || g.find((T) => T.syncedLyrics) || g[0];
      ...
      if (a) {
        const c = Re.basename(a, Re.extname(a)).replace(/-?\s*official\s*video/gi, "").replace(/\(.*\)/g, ""), u = await s(c);
        if (u) return u;
      }
      return null;
    } catch (s) {
