...
import Kt, { app as St, BrowserWindow as wc, ipcMain as We, dialog as cp } from "electron";
...
const $e = ke, Xr = oe, Hp = st.mkdirs, qp = er.pathExists, Xp = Oc.utimesMillis, Wr = br;
function Wp(e, t, r, n) {
...
var sh = Wp;
const Se = ke, Vr = oe, oh = st.mkdirsSync, lh = Oc.utimesMillisSync, Yr = br;
function ch(e, t, r) {
...
const Dh = Pe.fromPromise, Hc = Zt, qc = oe, Xc = st, Wc = Si, vo = Dh(async function(t) {
  let r;
  try {
...
const kh = Pe.fromCallback, Vc = oe, vt = ke, Yc = st;
function Nh(e, t) {
  function r() {
    vt.writeFile(e, "", (n) => {
      if (n) return t(n);
...
const Lh = Pe.fromCallback, Kc = oe, Et = ke, Jc = st, Uh = er.pathExists, { areIdentical: Qc } = br;
function Mh(e, t, r) {
  function n(i, a) {
    Et.link(i, a, (s) => {
      if (s) return r(s);
...
const Yh = Pe.fromCallback, eu = oe, Ve = Zt, tu = st, Kh = tu.mkdirs, Jh = tu.mkdirsSync, ru = qh, Qh = ru.symlinkPaths, Zh = ru.symlinkPathsSync, nu = Vh, em = nu.symlinkType, tm = nu.symlinkTypeSync, rm = er.pathExists, { areIdentical: iu } = br;
function nm(e, t, r, n) {
...
function _o(e, t, r, n) {
  Qh(e, t, (i, a) => {
    ...
    e = a.toDst, em(a.toCwd, r, (s, o) => {
      ...
      rm(l, (d, c) => {
        if (d) return n(d);
        if (c) return Ve.symlink(e, t, o, n);
        Kh(l, (f) => {
          if (f) return n(f);
          Ve.symlink(e, t, o, n);
        });
...
function im(e, t, r) {
  ...
  if (n && n.isSymbolicLink()) {
    const o = Ve.statSync(e), l = Ve.statSync(t);
    if (iu(o, l)) return;
  }
  const i = Zh(e, t);
  e = i.toDst, r = tm(i.toCwd, r);
  const a = eu.dirname(t);
  return Ve.existsSync(a) || Jh(a), Ve.symlinkSync(e, t, r);
}
var am = {
  createSymlink: Yh(nm),
...
const xm = Pe.fromCallback, Gr = ke, ou = oe, lu = st, ym = er.pathExists;
function wm(e, t, r, n) {
...
var Om = De;
const Dm = ke, Ma = oe, Pm = hs.copy, cu = Si.remove, km = st.mkdirp, Nm = er.pathExists, Oo = br;
function Fm(e, t, r, n) {
...
var Um = Fm;
const uu = ke, Ba = oe, Mm = hs.copySync, fu = Si.removeSync, Bm = st.mkdirpSync, Po = br;
function zm(e, t, r) {
  r = r || {};
...
}), Ht = Ye, qu = pn, Lg = N0, Ug = bs, Ct = Object.prototype.hasOwnProperty, di = 1, Xu = 2, Wu = 3, pi = 4, ma = 1, Mg = 2, qo = 3, Bg = /[\x00-\x08\x0B\x0C\x0E-\x1F\x7F-\x84\x86-\x9F\uFFFE\uFFFF]|[\uD800-\uDBFF](?![\uDC00-\uDFFF])|(?:[^\uD800-\uDBFF]|^)[\uDC00-\uDFFF]/, zg = /[\x85\u2028\u2029]/, jg = /[,\[\]\{\}]/, Vu = /^(?:!|!!|![a-z\-]+!)$/i, Yu = /^(?:!|[^,\[\]\{\}])(?:%[0-9a-f]{2}|[0-9a-z\-#;\/\?:@&=\+\$,_\.!~\*'\(\)\[\]])*$/i;
function Xo(e) {
...
Ts.loadAll = ix;
Ts.load = ax;
var tf = {}, Oi = Ye, hn = pn, sx = bs, rf = Object.prototype.toString, nf = Object.prototype.hasOwnProperty, Is = 65279, ox = 9, Qr = 10, lx = 13, cx = 32, ux = 33, fx = 34, Xa = 35, dx = 37, px = 38, hx = 39, mx = 42, af = 44, gx = 45, mi = 58, xx = 61, yx = 62, wx = 63, Ex = 64, sf = 91, of = 93, vx = 96, lf = 123, Tx = 124, cf = 125, Ie = {};
Ie[0] = "\\0";
Ie[7] = "\\a";
Ie[8] = "\\b";
Ie[9] = "\\t";
...
let ey = class rt {
  ...
  compare(t) {
    if (Un("SemVer.compare", this.version, this.options, t), !(t instanceof rt)) {
...
var Ke = by;
const Sy = Ke, Ay = (e, t, r) => Sy(t, e, r);
var Iy = Ay;
const Cy = Ke, Ry = (e, t) => Cy(e, t, !0);
var Oy = Ry;
...
var Ly = $y;
const Uy = Ke, My = (e, t, r) => Uy(e, t, r) > 0;
var Ni = My;
const By = Ke, zy = (e, t, r) => By(e, t, r) < 0;
var Ds = zy;
const jy = Ke, Gy = (e, t, r) => jy(e, t, r) === 0;
var yf = Gy;
const Hy = Ke, qy = (e, t, r) => Hy(e, t, r) !== 0;
var wf = qy;
const Xy = Ke, Wy = (e, t, r) => Xy(e, t, r) >= 0;
var Ps = Wy;
const Vy = Ke, Yy = (e, t, r) => Vy(e, t, r) <= 0;
var ks = Yy;
...
function Je() {
  ...
  const r = lw, n = new r(), i = Rs, a = Fi(), s = ki, o = Fe, {
    ...
    return R.replace(D, (A, k, O, M, X, j) => {
      ...
      const Z = N(O), he = Z || N(M), U = he || N(X), Qe = U;
      return k === "=" && Qe && (k = ""), j = I.includePrerelease ? "-0" : "", Z ? k === ">" || k === "<" ? A = "<0.0.0-0" : A = "*" : k && Qe ? (he && (M = 0), X = 0, k === ">" ? (k = ">=", he ? (O = +O + 1, M = 0, X = 0) : (M = +M + 1, X = 0)) : k === "<=" && (k = "<", he ? O = +O + 1 : M = +M + 1), k === "<" && (j = "-0"), A = `${k + O}.${M}.${X}${j}`) : he ? A = `>=${O}.0.0${j} <${+O + 1}.0.0-0` : U && (A = `>=${O}.${M}.0${j} <${O}.${+M + 1}.0-0`), s("xRange return", A), A;
    });
  }, q = (R, I) => (s("replaceStars", R, I), R.trim().replace(l[d.STAR], "")), z = (R, I) => (s("replaceGTE0", R, I), R.trim().replace(l[I.includePrerelease ? d.GTE0PRE : d.GTE0], "")), B = (R) => (I, D, A, k, O, M, X, j, Z, he, U, Qe) => (N(A) ? D = "" : N(k) ? D = `>=${A}.0.0${R ? "-0" : ""}` : N(O) ? D = `>=${A}.${k}.0${R ? "-0" : ""}` : M ? D = `>=${D}` : D = `>=${D}${R ? "-0" : ""}`, N(Z) ? j = "" : N(he) ? j = `<${+Z + 1}.0.0-0` : N(U) ? j = `<${Z}.${+he + 1}.0-0` : Qe ? j = `<=${Z}.${he}.${U}-${Qe}` : R ? j = `<${Z}.${he}.${+U + 1}-0` : j = `<=${j}`, `${D} ${j}`.trim()), Q = (R, I, D) => {
...
function Fi() {
  ...
  ya = t;
  const r = Rs, { safeRe: n, t: i } = mn, a = Ef, s = ki, o = Fe, l = Je();
  return ya;
}
const cw = Je(), uw = (e, t, r) => {
  try {
    t = new cw(t, r);
  } catch {
    return !1;
...
var $i = uw;
const fw = Je(), dw = (e, t) => new fw(e, t).set.map((r) => r.map((n) => n.value).join(" ").trim().split(" "));
var pw = dw;
const hw = Fe, mw = Je(), gw = (e, t, r) => {
...
var vw = Ew;
const wa = Fe, Tw = Je(), hl = Ni, _w = (e, t) => {
  e = new Tw(e, t);
  let r = new wa("0.0.0");
...
var Iw = Aw;
const Cw = Fe, vf = Fi(), { ANY: Rw } = vf, Ow = Je(), Dw = $i, ml = Ni, gl = Ds, Pw = ks, kw = Ps, Nw = (e, t, r, n) => {
...
var Bw = Mw;
const xl = Je(), zw = (e, t, r) => (e = new xl(e, r), t = new xl(t, r), e.intersects(t, r));
var jw = zw;
const Gw = $i, Hw = Ke;
var qw = (e, t, r) => {
  const n = [];
...
const yl = Je(), Fs = Fi(), { ANY: Ea } = Fs, $r = $i, $s = Ke, Xw = (e, t, r = {}) => {
  if (e === t)
    return !0;
...
var Yw = Xw;
const va = mn, Tl = Pi, Kw = Fe, _l = xf, Jw = Ir, Qw = iy, Zw = oy, eE = cy, tE = fy, rE = hy, nE = xy, iE = Ey, aE = _y, sE = Ke, oE = Iy, lE = Oy, cE = Os, uE = Ny, fE = Ly, dE = Ni, pE = Ds, hE = yf, mE = wf, gE = Ps, xE = ks, yE = Ef, wE = sw, EE = Fi(), vE = Je(), TE = $i, _E = pw, bE = xw, SE = vw, AE = bw, IE = Iw, CE = Ns, RE = Lw, OE = Bw, DE = jw, PE = qw, kE = Yw;
var Tf = {
  parse: Jw,
  valid: Qw,
  clean: Zw,
...
(function(e, t) {
  ...
  var Qe = typeof Re == "object" && Re && Re.Object === Object && Re, p = typeof self == "object" && self && self.Object === Object && self, u = Qe || p || Function("return this")(), S = t && !t.nodeType && t, E = S && !0 && e && !e.nodeType && e, K = E && E.exports === S, re = K && Qe.process, le = function() {
    try {
  ...
  var od = Array.prototype, ld = Function.prototype, bn = Object.prototype, Ki = u["__core-js_shared__"], Xs = ld.toString, Ze = bn.hasOwnProperty, Ws = function() {
    var m = /[^.]+$/.exec(Ki && Ki.keys && Ki.keys.IE_PROTO || "");
    return m ? "Symbol(src)_1." + m : "";
  }(), Vs = bn.toString, cd = RegExp(
    "^" + Xs.call(Ze).replace(j, "\\$&").replace(/hasOwnProperty|(function).*?(?=\\\()| for .+?(?=\\\])/g, "$1.*?") + "$"
  ...
  function vd(m) {
    var w = this.__data__;
    return Dr ? w[m] !== void 0 : Ze.call(w, m);
  }
  function Td(m, w) {
    var C = this.__data__;
  ...
  ot.prototype.clear = _d, ot.prototype.delete = bd, ot.prototype.get = Sd, ot.prototype.has = Ad, ot.prototype.set = Id;
  function $t(m) {
    var w = -1, C = m == null ? 0 : m.length;
    for (this.clear(); ++w < C; ) {
      var F = m[w];
  ...
  function Bd(m, w) {
    ...
    for (var ae in m)
      Ze.call(m, ae) && !(ce && // Safari 9 has enumerable `arguments.length` in strict mode.
  ...
  function jd(m, w, C, F, ne, H) {
    ...
    if (!(C & i)) {
      var je = Me && Ze.call(m, "__wrapped__"), Ge = Xe && Ze.call(w, "__wrapped__");
      if (je || Ge) {
  ...
  function qd(m) {
    ...
    for (var C in Object(m))
      Ze.call(m, C) && C != "constructor" && w.push(C);
    return w;
  }
  ...
  var tp = eo(/* @__PURE__ */ function() {
    ...
    return kr(m) && Ze.call(m, "callee") && !Js.call(m, "callee");
  }, Rn = Array.isArray;
  function rp(m) {
...
const et = Ar("tokenizer:inflate"), Fa = 256 * 1024, __ = Bf(gr.DataDescriptor), Vn = Bf(gr.EndOfCentralDirectory);
class zs {
  constructor(t) {
  ...
  async readCentralDirectory() {
    if (!this.tokenizer.supportsRandomAccess()) {
      et("Cannot reading central-directory without random-read support");
      return;
    }
    et("Reading central-directory...");
    const t = this.tokenizer.position, r = await this.findEndOfCentralDirectoryLocator();
    if (r > 0) {
      et("Central-directory 32-bit signature found");
      ...
      for (let a = 0; a < n.nrOfEntriesOfSize; ++a) {
        ...
        s.filename = await this.tokenizer.readToken(new ge(s.filenameLength, "utf-8")), await this.tokenizer.ignore(s.extraFieldLength), await this.tokenizer.ignore(s.fileCommentLength), i.push(s), et(`Add central-directory file-entry: n=${a + 1}/${i.length}: filename=${i[a].filename}`);
      }
  ...
  async unzip(t) {
    ...
    do {
      ...
      if (await this.tokenizer.ignore(i.extraFieldLength), i.dataDescriptor && i.compressedSize === 0) {
        const o = [];
        let l = Fa;
        et("Compressed-file-size unknown, scanning for next data-descriptor-signature....");
        let d = -1;
        for (; d < 0 && l === Fa; ) {
        ...
        et(`Found data-descriptor-signature at pos=${this.tokenizer.position}`), a.handler && await this.inflate(i, S_(o), a.handler);
      } else
        a.handler ? (et(`Reading compressed-file-data: ${i.compressedSize} bytes`), s = new Uint8Array(i.compressedSize), await this.tokenizer.readBuffer(s), await this.inflate(i, s, a.handler)) : (et(`Ignoring compressed-file-data: ${i.compressedSize} bytes`), await this.tokenizer.ignore(i.compressedSize));
      if (et(`Reading data-descriptor at pos=${this.tokenizer.position}`), i.dataDescriptor && (await this.tokenizer.readToken(cc)).signature !== 134695760)
  ...
  async inflate(t, r, n) {
    ...
    et(`Decompress filename=${t.filename}, compressed-size=${r.length}`);
  ...
  constructor(t) {
    ...
    na(this, "detectConfident", async (t) => {
      ...
      if (this.checkString("OggS")) {
        ...
        return await t.readBuffer(r), tt(r, [79, 112, 117, 115, 72, 101, 97, 100]) ? {
          ext: "opus",
          mime: "audio/ogg; codecs=opus"
        } : tt(r, [128, 116, 104, 101, 111, 114, 97]) ? {
          ext: "ogv",
          mime: "video/ogg"
        } : tt(r, [1, 118, 105, 100, 101, 111, 0]) ? {
          ext: "ogm",
          mime: "video/ogg"
        } : tt(r, [127, 70, 76, 65, 67]) ? {
          ext: "oga",
          mime: "audio/ogg"
        } : tt(r, [83, 112, 101, 101, 120, 32, 32]) ? {
          ext: "spx",
          mime: "audio/ogg"
        } : tt(r, [1, 118, 111, 114, 98, 105, 115]) ? {
          ext: "ogg",
          mime: "audio/ogg"
        } : {
          ext: "ogx",
...
`))
      ...
      if (this.check([48, 38, 178, 117, 142, 102, 207, 17, 166, 217])) {
        ...
        for (await t.ignore(30); t.position + 24 < t.fileInfo.size; ) {
          const n = await r();
          let i = n.size - 24;
          if (tt(n.id, [145, 7, 220, 183, 183, 169, 207, 17, 142, 230, 0, 192, 12, 32, 83, 101])) {
            const a = new Uint8Array(16);
            if (i -= await t.readBuffer(a), tt(a, [64, 158, 105, 248, 77, 91, 207, 17, 168, 253, 0, 128, 95, 92, 68, 43]))
              return {
                ext: "asf",
                mime: "audio/x-ms-asf"
              };
            if (tt(a, [192, 239, 25, 188, 77, 91, 207, 17, 168, 253, 0, 128, 95, 92, 68, 43]))
              return {
                ext: "asf",
                mime: "video/x-ms-asf"
              };
...
const $b = {
  ...
  async load() {
    return (await import("./MpegParser-Bf4MiUha.js")).MpegParser;
  }
}, Lb = {
  parserType: "apev2",
  extensions: [".ape"],
  ...
  async load() {
    return (await import("./AsfParser-DflsRFu0.js")).AsfParser;
  }
}, Mb = {
  parserType: "dsdiff",
  extensions: [".dff"],
  ...
  async load() {
    return (await import("./DsdiffParser-DaE7a7ll.js")).DsdiffParser;
  }
}, Bb = {
  parserType: "aiff",
  ...
  async load() {
    return (await import("./AiffParser-C_qZScus.js")).AIFFParser;
  }
}, zb = {
  parserType: "dsf",
  extensions: [".dsf"],
  mimeTypes: ["audio/dsf"],
  async load() {
    return (await import("./DsfParser-Cjp5jTsE.js")).DsfParser;
  }
}, jb = {
  parserType: "flac",
  extensions: [".flac"],
  ...
  async load() {
    return (await import("./FlacParser-DB_L9OU4.js").then((e) => e.d)).FlacParser;
  }
}, Gb = {
  parserType: "matroska",
  ...
  async load() {
    return (await import("./MatroskaParser-B4F9Q1Ik.js")).MatroskaParser;
  }
}, Hb = {
  parserType: "mp4",
  ...
  async load() {
    return (await import("./MP4Parser-CSHskwmp.js")).MP4Parser;
  }
}, qb = {
  parserType: "musepack",
  extensions: [".mpc"],
  ...
  async load() {
    return (await import("./MusepackParser-Bmgbvy0S.js")).MusepackParser;
  }
}, Xb = {
  parserType: "ogg",
  ...
  async load() {
    return (await import("./OggParser-DnuOasUC.js")).OggParser;
  }
}, Wb = {
  parserType: "wavpack",
  extensions: [".wv", ".wvp"],
  ...
  async load() {
    return (await import("./WavPackParser-BCadFMmh.js")).WavPackParser;
  }
}, Vb = {
  parserType: "riff",
  ...
  async load() {
    return (await import("./WaveParser-DHJ3rsJ4.js")).WaveParser;
  }
...
const rd = nt.dirname(fp(import.meta.url));
process.env.APP_ROOT = nt.join(rd, "..");
const os = process.env.VITE_DEV_SERVER_URL, rA = nt.join(process.env.APP_ROOT, "dist-electron"), nd = nt.join(process.env.APP_ROOT, "dist");
process.env.VITE_PUBLIC = os ? nt.join(process.env.APP_ROOT, "public") : nd;
let J;
function id() {
  J = new wc({
    width: 1200,
    ...
    webPreferences: {
      preload: nt.join(rd, "preload.mjs"),
      webSecurity: !1,
  ...
  }), os ? J.loadURL(os) : J.loadFile(nt.join(nd, "index.html"));
}
...
St.whenReady().then(() => {
  ...
  }), We.handle("app:active-window", async () => {
    const e = nt.join(process.env.APP_ROOT, "scripts/get-active-window.ps1");
    return await ES(e);
  }), We.handle("search:youtube", async (e, t) => {
    try {
  ...
  }), We.handle("search:artistImage", async (e, t) => {
    try {
  ...
  }), We.handle("search:lyrics", async (e, t, r) => {
    try {
      const n = `https://lrclib.net/api/get?artist_name=${encodeURIComponent(r)}&track_name=${encodeURIComponent(t)}`, i = await fetch(n);
      if (!i.ok) return null;
      const a = await i.json();
      return a.syncedLyrics || a.plainLyrics || null;
    } catch (n) {
      return console.error("Error fetching lyrics:", n), null;
    }
  }), We.handle("update:check", () => {
    at.autoUpdater.checkForUpdatesAndNotify();
  }), We.handle("update:install", () => {
    at.autoUpdater.quitAndInstall(!0, !0);
  }), We.handle("app:version", () => St.getVersion());
});
export {
  QS as A,
  Kf as B,
