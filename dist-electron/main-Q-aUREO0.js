...
import Kt, { app as St, BrowserWindow as wc, ipcMain as Ze, dialog as cp } from "electron";
...
const Yh = Pe.fromCallback, eu = oe, We = Zt, tu = st, Kh = tu.mkdirs, Jh = tu.mkdirsSync, ru = qh, Qh = ru.symlinkPaths, Zh = ru.symlinkPathsSync, nu = Vh, em = nu.symlinkType, tm = nu.symlinkTypeSync, rm = er.pathExists, { areIdentical: iu } = br;
function nm(e, t, r, n) {
...
const $b = {
  ...
  async load() {
    return (await import("./MpegParser-BLm8SYRX.js")).MpegParser;
  }
}, Lb = {
  parserType: "apev2",
  extensions: [".ape"],
  ...
  async load() {
    return (await import("./AsfParser-BKIV57fc.js")).AsfParser;
  }
}, Mb = {
  parserType: "dsdiff",
  extensions: [".dff"],
  ...
  async load() {
    return (await import("./DsdiffParser-DoOCHJw7.js")).DsdiffParser;
  }
}, Bb = {
  parserType: "aiff",
  ...
  async load() {
    return (await import("./AiffParser-Dx31RigP.js")).AIFFParser;
  }
}, zb = {
  parserType: "dsf",
  extensions: [".dsf"],
  mimeTypes: ["audio/dsf"],
  async load() {
    return (await import("./DsfParser-Daqt30I-.js")).DsfParser;
  }
}, jb = {
  parserType: "flac",
  extensions: [".flac"],
  ...
  async load() {
    return (await import("./FlacParser-BTL1Adu3.js").then((e) => e.d)).FlacParser;
  }
}, Gb = {
  parserType: "matroska",
  ...
  async load() {
    return (await import("./MatroskaParser-qbayQOXX.js")).MatroskaParser;
  }
}, Hb = {
  parserType: "mp4",
  ...
  async load() {
    return (await import("./MP4Parser-BpJzLiaI.js")).MP4Parser;
  }
}, qb = {
  parserType: "musepack",
  extensions: [".mpc"],
  ...
  async load() {
    return (await import("./MusepackParser-RmfAKUmQ.js")).MusepackParser;
  }
}, Xb = {
  parserType: "ogg",
  ...
  async load() {
    return (await import("./OggParser-DFNbBgvp.js")).OggParser;
  }
}, Wb = {
  parserType: "wavpack",
  extensions: [".wv", ".wvp"],
  ...
  async load() {
    return (await import("./WavPackParser-CqW8nzZ2.js")).WavPackParser;
  }
}, Vb = {
  parserType: "riff",
  ...
  async load() {
    return (await import("./WaveParser-Oa0zYzdx.js")).WaveParser;
  }
...
St.whenReady().then(() => {
  id(), Ze.handle("dialog:openDirectory", async () => {
    const { canceled: e, filePaths: t } = await cp.showOpenDialog(J, {
      properties: ["openDirectory"]
    });
    return e ? null : t[0];
  }), Ze.handle("files:listMusic", async (e, t) => {
    if (!t) return [];
    try {
  ...
  }), Ze.handle("files:readBuffer", async (e, t) => {
    try {
      return await uo.readFile(t);
    } catch (r) {
      return console.error("Error reading file:", r), null;
    }
  }), Ze.handle("files:getMetadata", async (e, t) => {
    try {
      const r = await wS(t);
      return {
    ...
    return await ES(e);
  }), Ze.handle("search:youtube", async (e, t) => {
    try {
  ...
  }), Ze.handle("search:artistImage", async (e, t) => {
    try {
  ...
  }), Ze.handle("app:version", () => St.getVersion());
});
export {
  QS as A,
  Kf as B,
