...
function _p(e) {
  xt.hasOwnProperty("O_SYMLINK") && process.version.match(/^v0\.6\.[0-2]|^v0\.5\./) && t(e), e.lutimes || r(e), e.chown = a(e.chown), e.fchown = a(e.fchown), e.lchown = a(e.lchown), e.chmod = n(e.chmod), e.fchmod = n(e.fchmod), e.lchmod = n(e.lchmod), e.chownSync = s(e.chownSync), e.fchownSync = s(e.fchownSync), e.lchownSync = s(e.lchownSync), e.chmodSync = i(e.chmodSync), e.fchmodSync = i(e.fchmodSync), e.lchmodSync = i(e.lchmodSync), e.stat = o(e.stat), e.fstat = o(e.fstat), e.lstat = o(e.lstat), e.statSync = l(e.statSync), e.fstatSync = l(e.fstatSync), e.lstatSync = l(e.lstatSync), e.chmod && !e.lchmod && (e.lchmod = function(c, u, p) {
    ...
    function u(p, m, w) {
      ...
      c(p, m, function _(b) {
        if (b && (b.code === "EACCES" || b.code === "EPERM" || b.code === "EBUSY") && Date.now() - x < 6e4) {
          setTimeout(function() {
            e.stat(m, function(k, N) {
              k && k.code === "ENOENT" ? c(p, m, _) : w(b);
            });
          }, T), T < 100 && (T += 10);
          return;
        }
    ...
    function u(p, m, w, x, T, _) {
      var b;
      if (_ && typeof _ == "function") {
        var k = 0;
        b = function(N, q, Y) {
          if (N && N.code === "EAGAIN" && k < 10)
            return k++, c.call(e, p, m, w, x, T, b);
          _.apply(this, arguments);
        };
      }
      return c.call(e, p, m, w, x, T, b);
    }
    return Object.setPrototypeOf && Object.setPrototypeOf(u, c), u;
  }(e.read), e.readSync = typeof e.readSync != "function" ? e.readSync : /* @__PURE__ */ function(c) {
    return function(u, p, m, w, x) {
      for (var T = 0; ; )
        try {
          return c.call(e, u, p, m, w, x);
        } catch (_) {
  ...
  function t(c) {
    c.lchmod = function(u, p, m) {
      ...
      var m = c.openSync(u, xt.O_WRONLY | xt.O_SYMLINK, p), w = !0, x;
      try {
        x = c.fchmodSync(m, p), w = !1;
      } finally {
        if (w)
          try {
            c.closeSync(m);
  ...
  function r(c) {
    xt.hasOwnProperty("O_SYMLINK") && c.futimes ? (c.lutimes = function(u, p, m, w) {
      ...
      return x;
    }) : c.futimes && (c.lutimes = function(u, p, m, w) {
  ...
  function n(c) {
    return c && function(u, p, m) {
      return c.call(e, u, p, function(w) {
        d(w) && (w = null), m && m.apply(this, arguments);
      });
    };
  }
  function i(c) {
  ...
  function a(c) {
    return c && function(u, p, m, w) {
      return c.call(e, u, p, m, function(x) {
...
function fs(e) {
  Rp(e), e.gracefulify = fs, e.createReadStream = q, e.createWriteStream = Y;
  var t = e.readFile;
  e.readFile = r;
  function r(y, X, j) {
    return typeof X == "function" && (j = X, X = null), B(y, X, j);
    function B(ee, R, I, D) {
      return t(ee, R, function(A) {
        A && (A.code === "EMFILE" || A.code === "ENFILE") ? nr([B, [ee, R, I], A, D || Date.now(), Date.now()]) : typeof I == "function" && I.apply(this, arguments);
      });
    }
  }
  var n = e.writeFile;
  e.writeFile = i;
  function i(y, X, j, B) {
    return typeof j == "function" && (B = j, j = null), ee(y, X, j, B);
    function ee(R, I, D, A, F) {
      return n(R, I, D, function(O) {
        O && (O.code === "EMFILE" || O.code === "ENFILE") ? nr([ee, [R, I, D, A], O, F || Date.now(), Date.now()]) : typeof A == "function" && A.apply(this, arguments);
      });
    }
  }
  var a = e.appendFile;
  ...
  o && (e.copyFile = l);
  function l(y, X, j, B) {
    return typeof j == "function" && (B = j, j = 0), ee(y, X, j, B);
    function ee(R, I, D, A, F) {
  ...
  var c = /^v[0-5]\./;
  function u(y, X, j) {
    typeof X == "function" && (j = X, X = null);
    var B = c.test(process.version) ? function(I, D, A, F) {
      return d(I, ee(
        I,
        D,
        A,
  ...
  var w = e.WriteStream;
  w && (k.prototype = Object.create(w.prototype), k.prototype.open = N), Object.defineProperty(e, "ReadStream", {
    get: function() {
      return _;
    },
    set: function(y) {
  ...
  function b() {
    var y = this;
    be(y.path, y.flags, y.mode, function(X, j) {
      X ? (y.autoClose && y.destroy(), y.emit("error", X)) : (y.fd = j, y.emit("open", j), y.read());
    });
  }
  function k(y, X) {
  ...
  function N() {
    var y = this;
    be(y.path, y.flags, y.mode, function(X, j) {
      X ? (y.destroy(), y.emit("error", X)) : (y.fd = j, y.emit("open", j));
    });
  }
  function q(y, X) {
    return new e.ReadStream(y, X);
  }
  function Y(y, X) {
    return new e.WriteStream(y, X);
  }
  var K = e.open;
  e.open = be;
  function be(y, X, j, B) {
...
const wo = Fe, Gc = le, re = _c, Jr = process.platform === "win32";
function Hc(e) {
  [
    "unlink",
    "chmod",
...
function Ch(e, t) {
  if (re(e), re(t), t.readdirSync(e).forEach((r) => qc(Gc.join(e, r), t)), Jr) {
    const r = Date.now();
    do
      try {
  ...
  function e(t) {
    ...
    function n(u) {
      ...
      function T(..._) {
        if (!T.enabled)
          return;
        const b = T, k = Number(/* @__PURE__ */ new Date()), N = k - (p || k);
        b.diff = N, b.prev = p, b.curr = k, p = k, _[0] = n.coerce(_[0]), typeof _[0] != "string" && _.unshift("%O");
        let q = 0;
        _[0] = _[0].replace(/%([a-zA-Z%])/g, (K, be) => {
          if (K === "%%")
            return "%";
          q++;
...
function n0() {
  return Bo || (Bo = 1, function(e, t) {
    ...
    t.inspectOpts = Object.keys(process.env).filter((p) => /^debug_/i.test(p)).reduce((p, m) => {
      const w = m.substring(6).toLowerCase().replace(/_([a-z])/g, (T, _) => _.toUpperCase());
      let x = process.env[m];
...
`);
    ...
    function c(p) {
      ...
      for (let w = 0; w < m.length; w++)
        p.inspectOpts[m[w]] = t.inspectOpts[m[w]];
    }
    e.exports = mu()(t);
...
function b0(e, t, r, n, i = qr.ASCII) {
  ...
  switch (i) {
    ...
    case qr.OBJECT:
      ...
      break;
    default:
      l = J[o[0]] + J[o[1]] + J[o[2]] + J[o[3]] + "-" + J[o[4]] + J[o[5]] + "-" + J[o[6] & 15 | r] + J[o[7]] + "-" + J[o[8] & 63 | 128] + J[o[9]] + "-" + J[o[10]] + J[o[11]] + J[o[12]] + J[o[13]] + J[o[14]] + J[o[15]];
      break;
  }
  return l;
}
...
(function(e) {
  (function(t) {
    ...
    function i(h) {
      for (var f = Math.max(t.MAX_BUFFER_LENGTH, 10), S = 0, v = 0, Q = r.length; v < Q; v++) {
        var ie = h[r[v]].length;
        if (ie > f)
          switch (r[v]) {
            case "textNode":
    ...
    function s(h) {
      ee(h), h.cdata !== "" && (B(h, "oncdata", h.cdata), h.cdata = ""), h.script !== "" && (B(h, "onscript", h.script), h.script = "");
    }
    n.prototype = {
      end: function() {
        D(this);
    ...
    function c(h, f) {
      ...
      this._parser.onend = function() {
        ...
        Object.defineProperty(S, "on" + v, {
          ...
          set: function(Q) {
            if (!Q)
              return S.removeAllListeners(v), S._parser["on" + v] = Q, Q;
            S.on(v, Q);
          },
          enumerable: !0,
          configurable: !1
    ...
    var u = "[CDATA[", p = "DOCTYPE", m = "http://www.w3.org/XML/1998/namespace", w = "http://www.w3.org/2000/xmlns/", x = { xml: m, xmlns: w }, T = /[:_A-Za-z\u00C0-\u00D6\u00D8-\u00F6\u00F8-\u02FF\u0370-\u037D\u037F-\u1FFF\u200C-\u200D\u2070-\u218F\u2C00-\u2FEF\u3001-\uD7FF\uF900-\uFDCF\uFDF0-\uFFFD]/, _ = /[:_A-Za-z\u00C0-\u00D6\u00D8-\u00F6\u00F8-\u02FF\u0370-\u037D\u037F-\u1FFF\u200C-\u200D\u2070-\u218F\u2C00-\u2FEF\u3001-\uD7FF\uF900-\uFDCF\uFDF0-\uFFFD\u00B7\u0300-\u036F\u203F-\u2040.\d-]/, b = /[#:_A-Za-z\u00C0-\u00D6\u00D8-\u00F6\u00F8-\u02FF\u0370-\u037D\u037F-\u1FFF\u200C-\u200D\u2070-\u218F\u2C00-\u2FEF\u3001-\uD7FF\uF900-\uFDCF\uFDF0-\uFFFD]/, k = /[#:_A-Za-z\u00C0-\u00D6\u00D8-\u00F6\u00F8-\u02FF\u0370-\u037D\u037F-\u1FFF\u200C-\u200D\u2070-\u218F\u2C00-\u2FEF\u3001-\uD7FF\uF900-\uFDCF\uFDF0-\uFFFD\u00B7\u0300-\u036F\u203F-\u2040.\d-]/;
    function N(h) {
      return h === " " || h === `
` || h === "\r" || h === "	";
    }
...
Char: ` + h.c), f = new Error(f), h.error = f, j(h, "onerror", f), h;
    ...
    function D(h) {
      return h.sawRoot && !h.closedRoot && A(h, "Unclosed root tag"), h.state !== y.BEGIN && h.state !== y.BEGIN_WHITESPACE && h.state !== y.TEXT && I(h, "Unexpected end"), ee(h), h.c = "", h.closed = !0, j(h, "onend"), n.call(h, h.strict, h.opt), h;
    }
    function A(h, f) {
    ...
    function O(h, f) {
      var S = h.indexOf(":"), v = S < 0 ? ["", h] : h.split(":"), Q = v[0], ie = v[1];
      return f && h === "xmlns" && (Q = "xmlns", ie = ""), { prefix: Q, local: ie };
    }
    function M(h) {
...
Actual: ` + h.attribValue
            ...
            var Q = h.tag, ie = h.tags[h.tags.length - 1] || h;
            Q.ns === ie.ns && (Q.ns = Object.create(ie.ns)), Q.ns[v] = h.attribValue;
          }
    ...
    function W(h, f) {
      if (h.opt.xmlns) {
        ...
        var Q = h.tags[h.tags.length - 1] || h;
        S.ns && Q.ns !== S.ns && Object.keys(S.ns).forEach(function(bn) {
          B(h, "onopennamespace", {
            prefix: bn,
            uri: S.ns[bn]
          });
        ...
        for (var ie = 0, ce = h.attribList.length; ie < ce; ie++) {
          var we = h.attribList[ie], Se = we[0], ht = we[1], de = O(Se, !0), We = de.prefix, Ki = de.local, _n = We === "" ? "" : S.ns[We] || "", Rr = {
            name: Se,
            value: ht,
            prefix: We,
            local: Ki,
    ...
    function te(h) {
      var f = h.entity, S = f.toLowerCase(), v, Q = "";
      return h.ENTITIES[f] ? h.ENTITIES[f] : h.ENTITIES[S] ? h.ENTITIES[S] : (f = S, f.charAt(0) === "#" && (f.charAt(1) === "x" ? (f = f.slice(2), v = parseInt(f, 16), Q = v.toString(16)) : (f = f.slice(1), v = parseInt(f, 10), Q = v.toString(10))), f = f.replace(/^0+/, ""), isNaN(v) || Q.toLowerCase() !== f || v < 0 || v > 1114111 ? (A(h, "Invalid character entity"), "&" + h.entity + ";") : String.fromCodePoint(v));
    }
    function he(h, f) {
      f === "<" ? (h.state = y.OPEN_WAKA, h.startTagPosition = h.position) : N(f) || (A(h, "Non-whitespace before first tag."), h.textNode = f, h.state = y.TEXT);
    }
    function U(h, f) {
      var S = "";
          ...
          case y.OPEN_WAKA:
            if (v === "!")
              ...
              if (A(f, "Unencoded <"), f.startTagPosition + 1 < f.position) {
                var Q = f.position - f.startTagPosition;
                v = new Array(Q).join(" ") + v;
              }
...
` ? (f.line++, f.column = 0) : f.column++);
          ...
          case y.PROC_INST_ENDING:
            ...
            continue;
          case y.OPEN_TAG:
            K(_, v) ? f.tagName += v : (F(f), v === ">" ? W(f) : v === "/" ? f.state = y.OPEN_TAG_SLASH : (N(v) || A(f, "Invalid character in tag name"), f.state = y.ATTRIB));
            continue;
          ...
          case y.ATTRIB:
            if (N(v))
              continue;
            v === ">" ? W(f) : v === "/" ? f.state = y.OPEN_TAG_SLASH : K(T, v) ? (f.attribName = v, f.attribValue = "", f.state = y.ATTRIB_NAME) : A(f, "Invalid attribute name");
            continue;
          case y.ATTRIB_NAME:
            v === "=" ? f.state = y.ATTRIB_VALUE : v === ">" ? (A(f, "Attribute without value"), f.attribValue = f.attribName, M(f), W(f)) : N(v) ? f.state = y.ATTRIB_NAME_SAW_WHITE : K(_, v) ? f.attribName += v : A(f, "Invalid attribute name");
            continue;
          case y.ATTRIB_NAME_SAW_WHITE:
            if (v === "=")
              ...
              A(f, "Attribute without value"), f.tag.attributes[f.attribName] = "", f.attribValue = "", B(f, "onattribute", {
                name: f.attribName,
                value: ""
              }), f.attribName = "", v === ">" ? W(f) : K(T, v) ? (f.attribName = v, f.state = y.ATTRIB_NAME) : (A(f, "Invalid attribute name"), f.state = y.ATTRIB);
            }
            continue;
          case y.ATTRIB_VALUE:
            if (N(v))
          ...
          case y.ATTRIB_VALUE_CLOSED:
            N(v) ? f.state = y.ATTRIB : v === ">" ? W(f) : v === "/" ? f.state = y.OPEN_TAG_SLASH : K(T, v) ? (A(f, "No whitespace between attributes"), f.attribName = v, f.attribValue = "", f.state = y.ATTRIB_NAME) : A(f, "Invalid attribute name");
            continue;
          case y.ATTRIB_VALUE_UNQUOTED:
            ...
            M(f), v === ">" ? W(f) : f.state = y.ATTRIB;
            continue;
          case y.CLOSE_TAG:
            if (f.tagName)
              v === ">" ? z(f) : K(_, v) ? f.tagName += v : f.script ? (f.script += "</" + f.tagName, f.tagName = "", f.state = y.SCRIPT) : (N(v) || A(f, "Invalid tagname in closing tag"), f.state = y.CLOSE_TAG_SAW_WHITE);
            else {
              if (N(v))
                continue;
              be(T, v) ? f.script ? (f.script += "</" + v, f.state = y.SCRIPT) : A(f, "Invalid tagname in closing tag.") : f.tagName = v;
            }
            continue;
          ...
          case y.ATTRIB_VALUE_ENTITY_U:
            ...
            if (v === ";") {
              var Se = te(f);
              f.opt.unparsedEntities && !Object.values(t.XML_ENTITIES).includes(Se) ? (f.entity = "", f.state = ce, f.write(Se)) : (f[we] += Se, f.entity = "", f.state = ce);
            } else K(f.entity.length ? k : b, v) ? f.entity += v : (A(f, "Invalid character in entity name"), f[we] += "&" + f.entity + v, f.entity = "", f.state = ce);
            continue;
          default:
    ...
    String.fromCodePoint || function() {
      var h = String.fromCharCode, f = Math.floor, S = function() {
        var v = 16384, Q = [], ie, ce, we = -1, Se = arguments.length;
        if (!Se)
          return "";
        for (var ht = ""; ++we < Se; ) {
          ...
          de <= 65535 ? Q.push(de) : (de -= 65536, ie = (de >> 10) + 55296, ce = de % 1024 + 56320, Q.push(ie, ce)), (we + 1 === Se || Q.length > v) && (ht += h.apply(null, Q), Q.length = 0);
        }
        return ht;
      };
...
function Zg(e, t) {
  var r = !0, n, i, a, s = e.tag, o, l = e.anchor, d, c, u, p, m, w = /* @__PURE__ */ Object.create(null), x, T, _, b;
  ...
  for (e.anchor !== null && (e.anchorMap[e.anchor] = o), b = e.input.charCodeAt(++e.position); b !== 0; ) {
    ...
    r ? b === 44 && L(e, "expected the node content, but found ','") : L(e, "missed comma between flow collection entries"), T = x = _ = null, u = p = !1, b === 63 && (d = e.input.charCodeAt(e.position + 1), Me(d) && (u = p = !0, e.position++, fe(e, !0, t))), n = e.line, i = e.lineStart, a = e.position, Tr(e, t, pi, !1, !0), T = e.tag, x = e.result, fe(e, !0, t), b = e.input.charCodeAt(e.position), (p || e.line === n) && b === 58 && (u = !0, b = e.input.charCodeAt(++e.position), fe(e, !0, t), Tr(e, t, pi, !1, !0), _ = e.result), m ? dr(e, o, w, T, x, _, n, i, a) : u ? o.push(dr(e, null, w, T, x, _, n, i, a)) : o.push(x), fe(e, !0, t), b = e.input.charCodeAt(e.position), b === 44 ? (r = !0, b = e.input.charCodeAt(++e.position)) : r = !1;
  }
...
function ty(e, t, r) {
  var n, i, a, s, o, l, d = e.tag, c = e.anchor, u = {}, p = /* @__PURE__ */ Object.create(null), m = null, w = null, x = null, T = !1, _ = !1, b;
  if (e.firstTabInLine !== -1) return !1;
  for (e.anchor !== null && (e.anchorMap[e.anchor] = u), b = e.input.charCodeAt(e.position); b !== 0; ) {
    if (!T && e.firstTabInLine !== -1 && (e.position = e.firstTabInLine, L(e, "tab characters must not be used in indentation")), n = e.input.charCodeAt(e.position + 1), a = e.line, (b === 63 || b === 58) && Me(n))
      b === 63 ? (T && (dr(e, u, p, m, w, null, s, o, l), m = w = x = null), _ = !0, T = !0, i = !0) : T ? (T = !1, i = !0) : L(e, "incomplete explicit mapping pair; a key node is missed; or followed by a non-tabulated empty line"), e.position += 1, b = n;
    else {
      ...
      if (e.line === a) {
        ...
        if (b === 58)
          b = e.input.charCodeAt(++e.position), Me(b) || L(e, "a whitespace character is expected after the key-value separator within a block mapping"), T && (dr(e, u, p, m, w, null, s, o, l), m = w = x = null), _ = !0, T = !1, i = !1, m = e.tag, w = e.result;
        else if (_)
    ...
    if ((e.line === a || e.lineIndent > t) && (T && (s = e.line, o = e.lineStart, l = e.position), Tr(e, t, hi, !0, i) && (T ? w = e.result : x = e.result), T || (dr(e, u, p, m, w, x, s, o, l), m = w = x = null), fe(e, !0, -1), b = e.input.charCodeAt(e.position)), (e.line === a || e.lineIndent > t) && b !== 0)
      L(e, "bad indentation of a mapping entry");
    else if (e.lineIndent < t)
      break;
  }
  return T && dr(e, u, p, m, w, null, s, o, l), _ && (e.tag = d, e.anchor = c, e.kind = "mapping", e.result = u), _;
}
function ry(e) {
  var t, r = !1, n = !1, i, a, s;
...
function Tr(e, t, r, n, i) {
  var a, s, o, l = 1, d = !1, c = !1, u, p, m, w, x, T;
  ...
  if (o && (o = d || i), (l === 1 || hi === r) && (pi === r || Yu === r ? x = t : x = t + 1, T = e.position - e.lineStart, l === 1 ? o && (Qo(e, T) || ty(e, T, x)) || Zg(e, x) ? c = !0 : (s && ey(e, x) || Jg(e, x) || Qg(e, x) ? c = !0 : iy(e) ? (c = !0, (e.tag !== null || e.anchor !== null) && L(e, "alias node should not have any properties")) : Kg(e, x, pi === r) && (c = !0, e.tag === null && (e.tag = "?")), e.anchor !== null && (e.anchorMap[e.anchor] = e.result)) : l === 0 && (c = o && Qo(e, T))), e.tag === null)
    ...
    if (Ct.call(e.typeMap[e.kind || "fallback"], e.tag))
      ...
      for (w = null, m = e.typeMap.multi[e.kind || "fallback"], u = 0, p = m.length; u < p; u += 1)
...
function Ny(e, t, r, n, i, a, s, o) {
  var l, d = 0, c = null, u = !1, p = !1, m = n !== -1, w = -1, x = Py(jr(e, 0)) && ky(jr(e, e.length - 1));
  if (t || s)
...
(function(e, t) {
  ...
  const p = "[a-zA-Z0-9-]", m = [
    ...
    const k = w(_), N = u++;
    a(T, N, _), c[T] = N, l[N] = _, d[N] = k, s[N] = new RegExp(_, b ? "g" : void 0), o[N] = new RegExp(k, b ? "g" : void 0);
  };
...
function Ze() {
  ...
  class t {
    ...
    parseRange(I) {
      const A = ((this.options.includePrerelease && m) | (this.options.loose && w)) + ":" + I, F = n.get(A);
      if (F)
        return F;
      ...
      let W = I.split(" ").map((U) => b(U, this.options)).join(" ").split(/\s+/).map((U) => j(U, this.options));
      O && (W = W.filter((U) => (s("loose invalid filter", U, this.options), !!U.match(l[d.COMPARATORLOOSE])))), s("range list", W);
      const z = /* @__PURE__ */ new Map(), te = W.map((U) => new a(U, this.options));
      for (const U of te) {
        if (x(U))
          return [U];
        z.set(U.value, U);
    ...
    intersects(I, D) {
      ...
      return this.set.some((A) => _(A, D) && I.set.some((F) => _(F, D) && A.every((O) => F.every((M) => O.intersects(M, D)))));
    }
    ...
    test(I) {
      ...
      for (let D = 0; D < this.set.length; D++)
        if (ee(this.set[D], I, this.options))
          return !0;
      return !1;
    }
  }
  ...
  const r = uw, n = new r(), i = Ds, a = $i(), s = Ni, o = Le, {
    ...
    tildeTrimReplace: u,
    caretTrimReplace: p
  } = gn, { FLAG_INCLUDE_PRERELEASE: m, FLAG_LOOSE: w } = ki, x = (R) => R.value === "<0.0.0-0", T = (R) => R.value === "", _ = (R, I) => {
    let D = !0;
    const A = R.slice();
    let F = A.pop();
    for (; D && A.length; )
      D = A.every((O) => F.intersects(O, I)), F = A.pop();
    return D;
  }, b = (R, I) => (R = R.replace(l[d.BUILD], ""), s("comp", R, I), R = Y(R, I), s("caret", R), R = N(R, I), s("tildes", R), R = be(R, I), s("xrange", R), R = X(R, I), s("stars", R), R), k = (R) => !R || R.toLowerCase() === "x" || R === "*", N = (R, I) => R.trim().split(/\s+/).map((D) => q(D, I)).join(" "), q = (R, I) => {
    const D = I.loose ? l[d.TILDELOOSE] : l[d.TILDE];
    return R.replace(D, (A, F, O, M, W) => {
      s("tilde", R, A, F, O, M, W);
      let z;
      return k(F) ? z = "" : k(O) ? z = `>=${F}.0.0 <${+F + 1}.0.0-0` : k(M) ? z = `>=${F}.${O}.0 <${F}.${+O + 1}.0-0` : W ? (s("replaceTilde pr", W), z = `>=${F}.${O}.${M}-${W} <${F}.${+O + 1}.0-0`) : z = `>=${F}.${O}.${M} <${F}.${+O + 1}.0-0`, s("tilde return", z), z;
    });
  }, Y = (R, I) => R.trim().split(/\s+/).map((D) => K(D, I)).join(" "), K = (R, I) => {
    s("caret", R, I);
    const D = I.loose ? l[d.CARETLOOSE] : l[d.CARET], A = I.includePrerelease ? "-0" : "";
    return R.replace(D, (F, O, M, W, z) => {
      s("caret", R, F, O, M, W, z);
      let te;
      return k(O) ? te = "" : k(M) ? te = `>=${O}.0.0${A} <${+O + 1}.0.0-0` : k(W) ? O === "0" ? te = `>=${O}.${M}.0${A} <${O}.${+M + 1}.0-0` : te = `>=${O}.${M}.0${A} <${+O + 1}.0.0-0` : z ? (s("replaceCaret pr", z), O === "0" ? M === "0" ? te = `>=${O}.${M}.${W}-${z} <${O}.${M}.${+W + 1}-0` : te = `>=${O}.${M}.${W}-${z} <${O}.${+M + 1}.0-0` : te = `>=${O}.${M}.${W}-${z} <${+O + 1}.0.0-0`) : (s("no pr"), O === "0" ? M === "0" ? te = `>=${O}.${M}.${W}${A} <${O}.${M}.${+W + 1}-0` : te = `>=${O}.${M}.${W}${A} <${O}.${+M + 1}.0-0` : te = `>=${O}.${M}.${W} <${+O + 1}.0.0-0`), s("caret return", te), te;
    });
  }, be = (R, I) => (s("replaceXRanges", R, I), R.split(/\s+/).map((D) => y(D, I)).join(" ")), y = (R, I) => {
    R = R.trim();
    const D = I.loose ? l[d.XRANGELOOSE] : l[d.XRANGE];
    return R.replace(D, (A, F, O, M, W, z) => {
      s("xRange", R, A, F, O, M, W, z);
      const te = k(O), he = te || k(M), U = he || k(W), et = U;
      return F === "=" && et && (F = ""), z = I.includePrerelease ? "-0" : "", te ? F === ">" || F === "<" ? A = "<0.0.0-0" : A = "*" : F && et ? (he && (M = 0), W = 0, F === ">" ? (F = ">=", he ? (O = +O + 1, M = 0, W = 0) : (M = +M + 1, W = 0)) : F === "<=" && (F = "<", he ? O = +O + 1 : M = +M + 1), F === "<" && (z = "-0"), A = `${F + O}.${M}.${W}${z}`) : he ? A = `>=${O}.0.0${z} <${+O + 1}.0.0-0` : U && (A = `>=${O}.${M}.0${z} <${O}.${+M + 1}.0-0`), s("xRange return", A), A;
    });
  }, X = (R, I) => (s("replaceStars", R, I), R.trim().replace(l[d.STAR], "")), j = (R, I) => (s("replaceGTE0", R, I), R.trim().replace(l[I.includePrerelease ? d.GTE0PRE : d.GTE0], "")), B = (R) => (I, D, A, F, O, M, W, z, te, he, U, et) => (k(A) ? D = "" : k(F) ? D = `>=${A}.0.0${R ? "-0" : ""}` : k(O) ? D = `>=${A}.${F}.0${R ? "-0" : ""}` : M ? D = `>=${D}` : D = `>=${D}${R ? "-0" : ""}`, k(te) ? z = "" : k(he) ? z = `<${+te + 1}.0.0-0` : k(U) ? z = `<${te}.${+he + 1}.0-0` : et ? z = `<=${te}.${he}.${U}-${et}` : R ? z = `<${te}.${he}.${+U + 1}-0` : z = `<=${z}`, `${D} ${z}`.trim()), ee = (R, I, D) => {
...
const Ow = Le, bf = $i(), { ANY: Dw } = bf, Pw = Ze(), kw = Li, yl = Fi, xl = ks, Nw = Fs, Fw = Ns, $w = (e, t, r, n) => {
  ...
  for (let d = 0; d < t.set.length; ++d) {
    ...
    let u = null, p = null;
    if (c.forEach((m) => {
      m.semver === Dw && (m = new bf(">=0.0.0")), u = u || m, p = p || m, i(m.semver, u.semver, n) ? u = m : s(m.semver, p.semver, n) && (p = m);
...
xi.exports;
(function(e, t) {
  var r = 200, n = "__lodash_hash_undefined__", i = 1, a = 2, s = 9007199254740991, o = "[object Arguments]", l = "[object Array]", d = "[object AsyncFunction]", c = "[object Boolean]", u = "[object Date]", p = "[object Error]", m = "[object Function]", w = "[object GeneratorFunction]", x = "[object Map]", T = "[object Number]", _ = "[object Null]", b = "[object Object]", k = "[object Promise]", N = "[object Proxy]", q = "[object RegExp]", Y = "[object Set]", K = "[object String]", be = "[object Symbol]", y = "[object Undefined]", X = "[object WeakMap]", j = "[object ArrayBuffer]", B = "[object DataView]", ee = "[object Float32Array]", R = "[object Float64Array]", I = "[object Int8Array]", D = "[object Int16Array]", A = "[object Int32Array]", F = "[object Uint8Array]", O = "[object Uint8ClampedArray]", M = "[object Uint16Array]", W = "[object Uint32Array]", z = /[\\^$.*+?()[\]{}|]/g, te = /^\[object .+?Constructor\]$/, he = /^(?:0|[1-9]\d*)$/, U = {};
  U[ee] = U[R] = U[I] = U[D] = U[A] = U[F] = U[O] = U[M] = U[W] = !0, U[o] = U[l] = U[j] = U[c] = U[B] = U[u] = U[p] = U[m] = U[x] = U[T] = U[b] = U[q] = U[Y] = U[K] = U[X] = !1;
  var et = typeof De == "object" && De && De.Object === Object && De, h = typeof self == "object" && self && self.Object === Object && self, f = et || h || Function("return this")(), S = t && !t.nodeType && t, v = S && !0 && e && !e.nodeType && e, Q = v && v.exports === S, ie = Q && et.process, ce = function() {
    try {
  ...
  function Se(g, E) {
    for (var C = -1, $ = g == null ? 0 : g.length, ae = 0, H = []; ++C < $; ) {
      var ue = g[C];
      E(ue, C, g) && (H[ae++] = ue);
    }
    return H;
  ...
  function ht(g, E) {
    for (var C = -1, $ = E.length, ae = g.length; ++C < $; )
      g[ae + C] = E[C];
    return g;
  }
  function de(g, E) {
  ...
  function Gd(g, E) {
    var C = On(g), $ = !C && ip(g), ae = !C && !$ && na(g), H = !C && !$ && !ae && uo(g), ue = C || $ || ae || H, me = ue ? We(g.length, String) : [], Ee = me.length;
    for (var se in g)
  ...
  function no(g, E, C, $, ae) {
    return g === E ? !0 : g == null || E == null || !kr(g) && !kr(E) ? g !== g && E !== E : qd(g, E, C, $, no, ae);
  }
  function qd(g, E, C, $, ae, H) {
    var ue = On(g), me = On(E), Ee = ue ? l : gt(g), se = me ? l : gt(E);
    Ee = Ee == o ? b : Ee, se = se == o ? b : se;
    var Be = Ee == b, Ve = se == b, Ae = Ee == se;
    if (Ae && na(g)) {
      if (!na(E))
        return !1;
      ue = !0, Be = !1;
    ...
    if (Ae && !Be)
      return H || (H = new mt()), ue || uo(g) ? io(g, E, C, $, ae, H) : Yd(g, E, Ee, C, $, ae, H);
    if (!(C & i)) {
      var Ge = Be && tt.call(g, "__wrapped__"), He = Ve && tt.call(E, "__wrapped__");
      if (Ge || He) {
        var yt = Ge ? g.value() : g, ct = He ? E.value() : E;
        return H || (H = new mt()), ae(yt, ct, C, $, H);
      }
    }
    return Ae ? (H || (H = new mt()), Kd(g, E, C, $, ae, H)) : !1;
  }
  function Xd(g) {
    if (!co(g) || tp(g))
      return !1;
  ...
  function io(g, E, C, $, ae, H) {
    ...
    for (H.set(g, E), H.set(E, g); ++Be < me; ) {
      var Ge = g[Be], He = E[Be];
      if ($)
        var yt = ue ? $(He, Ge, Be, E, g, H) : $(Ge, He, Be, g, E, H);
      if (yt !== void 0) {
        if (yt)
          continue;
        Ve = !1;
      ...
      if (Ae) {
        if (!de(E, function(ct, Ut) {
          if (!_n(Ae, Ut) && (Ge === ct || ae(Ge, ct, C, $, H)))
            return Ae.push(Ut);
        })) {
          Ve = !1;
          break;
        }
      } else if (!(Ge === He || ae(Ge, He, C, $, H))) {
        Ve = !1;
        break;
      }
    }
  ...
  function Kd(g, E, C, $, ae, H) {
    ...
    for (var yt = ue; ++Ve < Ee; ) {
      ...
      var ct = g[Ae], Ut = E[Ae];
      if ($)
        var fo = ue ? $(Ut, ct, Ae, E, g, H) : $(ct, Ut, Ae, g, E, H);
      if (!(fo === void 0 ? ct === Ut || ae(ct, Ut, C, $, H) : fo)) {
        He = !1;
        break;
      }
  ...
  function Jd(g) {
    ...
    var ae = Ks.call(g);
    return $ && (E ? g[Nt] = C : delete g[Nt]), ae;
  }
  var Qd = eo ? function(g) {
    return g == null ? [] : (g = Object(g), Se(eo(g), function(E) {
      return Zs.call(g, E);
    }));
  } : lp, gt = Pr;
  (Qi && gt(new Qi(new ArrayBuffer(1))) != B || Or && gt(new Or()) != x || Zi && gt(Zi.resolve()) != k || ea && gt(new ea()) != Y || ta && gt(new ta()) != X) && (gt = function(g) {
      ...
      if (this.updater.allowPrerelease) {
        ...
        if (T === null)
          ...
          for (const _ of l.getElements("entry")) {
            ...
            if (b === null)
              continue;
            const k = b[1], N = ((n = pr.prerelease(k)) === null || n === void 0 ? void 0 : n[0]) || null, q = !T || ["alpha", "beta"].includes(T), Y = N !== null && !["alpha", "beta"].includes(String(N));
            if (q && !Y && !(T === "beta" && N === "alpha")) {
              c = k;
              break;
            }
            if (N && N === T) {
...
${o}`, "ERR_UPDATER_INVALID_RELEASE_FEED");
    ...
    const x = (0, es.parseUpdateInfo)(u, p, m);
...
function Rv(e, t, r) {
  ...
  const c = i.get(l);
  let u = 0;
  const { checksumToOffset: p, checksumToOldSize: m } = Dv(n.get(l), d.offset, r);
  let w = s.offset;
  for (let x = 0; x < c.checksums.length; w += c.sizes[x], x++) {
    const T = c.sizes[x], _ = c.checksums[x];
    let b = p.get(_);
    b != null && m.get(_) !== T && (r.warn(`Checksum ("${_}") matches, but size differs (old: ${m.get(_)}, new: ${T})`), b = void 0), b === void 0 ? (u++, a != null && a.kind === Xt.DOWNLOAD && a.end === w ? a.end += T : (a = {
      kind: Xt.DOWNLOAD,
      start: w,
      end: w + T
      // oldBlocks: null,
...
function Lv(e, t, r, n, i) {
  ...
  if (s <= 1) {
    const u = (p) => {
      ...
      if (m.kind === Gl.OperationKind.COPY)
        (0, zl.copyData)(m, r, t.oldFileFd, i, () => u(p));
      else {
  ...
  const c = e.httpExecutor.createRequest(d, (u) => {
    if (!rs(u, i))
      return;
    const p = (0, ts.safeGetHeader)(u, "content-type"), m = /^multipart\/.+?(?:; boundary=(?:(?:"(.+)")|(?:([^\s]+))))$/i.exec(p);
    if (m == null) {
  ...
  async doDownloadFile(t, r) {
    ...
    await new Promise((s, o) => {
      ...
      if (!this.options.isUseMultipleRangeRequest && this.options.onProgress) {
        ...
        d = new Gv.ProgressDifferentialDownloadCallbackTransform(k, this.options.cancellationToken, this.options.onProgress), l.push(d);
      }
      ...
      T.redirect = "manual", m = (_) => {
        ...
        if (N.kind === Wn.OperationKind.COPY) {
          d && d.beginFileCopy(), (0, jv.copyData)(N, p, n, o, () => m(_));
          return;
        }
        const q = `bytes=${N.start}-${N.end - 1}`;
        T.headers.range = q, (k = (b = this.logger) === null || b === void 0 ? void 0 : b.debug) === null || k === void 0 || k.call(b, `download range: ${q}`), d && d.beginRangeDownload();
        const Y = this.httpExecutor.createRequest(T, (K) => {
          K.on("error", o), K.on("aborted", () => {
            o(new Error("response has been aborted by the server"));
          }), K.statusCode >= 400 && o((0, Lr.createHttpError)(K)), K.pipe(p, {
            end: !1
          }), K.once("end", () => {
            d && d.endRangeDownload(), ++w === 100 ? (w = 0, setTimeout(() => m(_), 1e3)) : m(_);
          });
        });
        Y.on("redirect", (K, be, y) => {
          this.logger.info(`Redirect to ${qv(y)}`), x = y, (0, Lr.configureRequestUrl)(new zv.URL(x), T), Y.followRedirect();
...
class Bs extends Kv.EventEmitter {
  ...
  async executeDownload(t) {
    ...
    const c = o();
    let u = Mt.join(d, c);
    const p = s == null ? null : Mt.join(d, `package-${a}${Mt.extname(s.path) || ".7z"}`), m = async (b) => (await l.setDownloadedFile(u, p, i, r, c, b), await t.done({
      ...i,
      downloadedFile: u
    ...
    try {
      await t.task(_, n, p, T), await (0, Oe.retry)(() => (0, sr.rename)(_, u), 60, 500, 0, 0, (b) => b instanceof Error && /^EBUSY:/.test(b.message));
    } catch (b) {
...
class RT extends IT.AppUpdater {
  ...
  async updateDownloaded(t, r) {
    ...
    return await new Promise((d, c) => {
      const u = (0, ic.randomBytes)(64).toString("base64").replace(/\//g, "_").replace(/\+/g, "-"), p = Buffer.from(`autoupdater:${u}`, "ascii"), m = `/${(0, ic.randomBytes)(64).toString("hex")}.zip`;
      this.server.on("request", (w, x) => {
        ...
        if (s.info(`${T} requested`), T === "/") {
          ...
          const k = w.headers.authorization.split(" ")[1], N = Buffer.from(k, "base64").toString("ascii"), [q, Y] = N.split(":");
          if (q !== "autoupdater" || Y !== u) {
            x.statusCode = 401, x.statusMessage = "Invalid Authentication Credentials", x.end(), s.warn("Invalid authenthication credentials");
            return;
          }
          const K = Buffer.from(`{ "url": "${l(this.server)}${m}" }`);
          x.writeHead(200, { "Content-Type": "application/json", "Content-Length": K.length }), x.end(K);
          return;
        }
        if (!T.startsWith(m)) {
      ...
      try {
        ...
        if (c.Status === 0) {
          ...
          for (const w of e) {
            ...
            if (x.size ? m = Array.from(x.keys()).every((_) => x.get(_) === p.get(_)) : w === p.get("CN") && (r.warn(`Signature validated using only CN ${w}. Please add your full Distinguished Name (DN) to publisherNames configuration`), m = !0), m) {
              n(null);
              return;
            }
          }
...
var Wi = function(e, t, r, n, i) {
  ...
  var s, o, l, d = a * 8 - i - 1, c = (1 << d) - 1, u = c >> 1, p = i === 23 ? Math.pow(2, -24) - Math.pow(2, -77) : 0, m = n ? 0 : a - 1, w = n ? 1 : -1, x = t < 0 || t === 0 && 1 / t < 0 ? 1 : 0;
  for (t = Math.abs(t), isNaN(t) || t === 1 / 0 ? (o = isNaN(t) ? 1 : 0, s = c) : (s = Math.floor(Math.log(t) / Math.LN2), t * (l = Math.pow(2, -s)) < 1 && (s--, l *= 2), s + u >= 1 ? t += p / l : t += p * Math.pow(2, 1 - u), t * l >= 2 && (s++, l /= 2), s + u >= c ? (o = 0, s = c) : s + u >= 1 ? (o = (t * l - 1) * Math.pow(2, i), s = s + u) : (o = t * Math.pow(2, u - 1) * Math.pow(2, i), s = 0)); i >= 8; e[r + m] = o & 255, m += w, o /= 256, i -= 8)
    ;
  for (s = s << i | o, d += i; d > 0; e[r + m] = s & 255, m += w, s /= 256, d -= 8)
    ;
  e[r + m - w] |= x * 128;
};
const is = {
...
`, { offset: 2, encoding: r }) ? {
  ...
  async readTiffHeader(t) {
    const r = (t ? qt : ne).get(this.buffer, 2), n = (t ? wi : V).get(this.buffer, 4);
    if (r === 42) {
      if (n >= 6) {
...
const Ub = {
  ...
  async load() {
    return (await import("./MpegParser-DYYrhmQq.js")).MpegParser;
  }
}, Mb = {
  parserType: "apev2",
  extensions: [".ape"],
  ...
  async load() {
    return (await import("./AsfParser-B05TcX3u.js")).AsfParser;
  }
}, jb = {
  parserType: "dsdiff",
  extensions: [".dff"],
  ...
  async load() {
    return (await import("./DsdiffParser-DWZF1wS7.js")).DsdiffParser;
  }
}, zb = {
  parserType: "aiff",
  ...
  async load() {
    return (await import("./AiffParser-B_-ioGUG.js")).AIFFParser;
  }
}, Gb = {
  parserType: "dsf",
  extensions: [".dsf"],
  mimeTypes: ["audio/dsf"],
  async load() {
    return (await import("./DsfParser-CD36hF1I.js")).DsfParser;
  }
}, Hb = {
  parserType: "flac",
  extensions: [".flac"],
  ...
  async load() {
    return (await import("./FlacParser-DuajPy7U.js").then((e) => e.d)).FlacParser;
  }
}, qb = {
  parserType: "matroska",
  ...
  async load() {
    return (await import("./MatroskaParser-DrcpPiUM.js")).MatroskaParser;
  }
}, Xb = {
  parserType: "mp4",
  ...
  async load() {
    return (await import("./MP4Parser-DfvOcnl2.js")).MP4Parser;
  }
}, Wb = {
  parserType: "musepack",
  extensions: [".mpc"],
  ...
  async load() {
    return (await import("./MusepackParser-Ci8dXcvJ.js")).MusepackParser;
  }
}, Vb = {
  parserType: "ogg",
  ...
  async load() {
    return (await import("./OggParser-BBFOIi9t.js")).OggParser;
  }
}, Yb = {
  parserType: "wavpack",
  extensions: [".wv", ".wvp"],
  ...
  async load() {
    return (await import("./WavPackParser-CZ9_FCCP.js")).WavPackParser;
  }
}, Kb = {
  parserType: "riff",
  ...
  async load() {
    return (await import("./WaveParser-D4oBT_vp.js")).WaveParser;
  }
...
function od() {
  ...
  }), cs ? Z.loadURL(cs) : Z.loadFile(ve.join(sd, "index.html"));
}
Ke.on("window-all-closed", () => {
  process.platform !== "darwin" && (Ke.quit(), Z = null);
});
Ke.on("activate", () => {
...
st.autoUpdater.on("update-downloaded", (e) => {
  Z == null || Z.webContents.send("update-status", { status: "downloaded", info: e }), new dp({
    title: "NeonWave 更新",
...
Ke.whenReady().then(() => {
  process.platform === "win32" && Ke.setAppUserModelId("NeonWave"), od(), qe.handle("dialog:openDirectory", async () => {
    const { canceled: r, filePaths: n } = await po.showOpenDialog(Z, {
...
`).map((o) => {
    ...
    try {
      ...
      const { filePath: d } = await po.showSaveDialog(Z, {
        title: "下載歌曲",
        defaultPath: `${l}.m4a`,
    ...
    try {
      const s = Mr(import.meta.url)("get-artist-title"), o = Mr(import.meta.url)("genius-lyrics"), l = new o.Client(), d = async (m, w = "") => {
        try {
          const x = `https://lrclib.net/api/search?q=${encodeURIComponent(m)}`, T = await fetch(x);
          if (T.ok) {
            const _ = await T.json();
            if (Array.isArray(_) && _.length > 0) {
              const b = (w || "").split(" ")[0].toLowerCase();
              let k = _.find((N) => N.syncedLyrics && (!b || N.artistName.toLowerCase().includes(b)));
              if (k || (k = _.find((N) => N.syncedLyrics)), k && k.syncedLyrics) return k.syncedLyrics;
            }
          }
        } catch (x) {
          console.error("LRC Search Error", m, x);
        }
        return null;
      };
      ...
      let c = n, u = i;
      if (a) {
        let m = ve.basename(a, ve.extname(a));
        console.log(`[Lyrics] Raw Filename: ${m}`);
        let w = /\b(Official|Music Video|MV|Live|Cover|4K|1080p|Lyric|Video)\b/gi;
        const x = m.match(/《(.+?)》/), T = m.match(/【(.+?)】/);
        let _ = null;
        if (x)
          _ = x[1];
        else if (T) {
          const q = T[1], Y = /[\u4e00-\u9fa5]/.test(q), K = /[a-zA-Z]/.test(q);
          if (Y && K) {
            const be = q.match(/[\u4e00-\u9fa5]+/);
            be ? _ = be[0] : _ = q;
          } else
            _ = q;
        }
        let b = m;
        if (_) {
          const q = x ? x[0] : T ? T[0] : null;
          if (q) {
            const Y = m.split(q);
            Y[0] && Y[0].trim().length > 1 ? b = Y[0] : Y[1] && Y[1].trim().length > 1 && (b = Y[1]);
          }
        }
        b = b.replace(w, " ").replace(/[\[\]【】《》]/g, " ");
        const k = /[\s_&,]+|(?:\s+feat\.?\s+)/i, N = b.split(k).filter((q) => q.trim());
        if (N.length > 0) {
          const q = N[0];
          q.length > 1 && (u = q);
        }
        if (_)
          ...
          let q = m.replace(/_/g, " - ").replace(w, "");
          const Y = s(q);
          Y && Y.length === 2 && Y[1] && ((!u || u === i) && (u = Y[0]), c = Y[1]);
        }
        console.log(`[Lyrics] Advanced Clean Result: ${u} - ${c}`);
      }
      if (n && i) {
        const m = await d(`${n} ${i}`, i);
        if (m)
          return console.log("[Lyrics] S1 Success"), m;
      }
      if (c) {
        const m = `${c} ${u || ""}`.trim(), w = await d(m, u);
        if (w)
          return console.log("[Lyrics] S2 Success"), w;
      }
      let p = null;
      try {
        let m = `${c} ${u || ""}`.trim(), w = await l.songs.search(m);
        if (w.length === 0 && a) {
          const x = ve.basename(a, ve.extname(a)).replace(/_/g, " ");
          console.log(`[Lyrics] Genius fallback search: ${x}`), w = await l.songs.search(x);
        }
        if (w.length > 0) {
          p = w[0];
          const x = p.title, T = p.artist.name;
          console.log(`[Lyrics] Genius ID: ${T} - ${x}`);
          const _ = await d(`${x} ${T}`, T);
          if (_)
            return console.log("[Lyrics] S3-1 Success (Genius)"), _;
          if (c && c.toLowerCase() !== x.toLowerCase()) {
            console.log(`[Lyrics] Hybrid Retry: ${c} (Native) + ${T} (Genius)`);
            const b = await d(`${c} ${T}`, T);
            if (b)
              return console.log("[Lyrics] S3-2 Success (Hybrid)"), b;
          }
        }
      } catch (m) {
        console.warn("[Lyrics] Genius search failed", m);
      }
      if (p)
        try {
          console.log("[Lyrics] Stage 4: Fetching text from Genius");
          const m = await p.lyrics();
          if (m)
            return m.split(`
`).filter((w) => w.trim()).map((w) => `[00:00.00]${w}`).join(`
`);
        } catch (m) {
          console.error("[Lyrics] Failed to fetch lyrics from Genius object", m);
        }
