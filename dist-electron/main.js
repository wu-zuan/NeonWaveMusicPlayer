import Nt, { app as Dt, BrowserWindow as al, ipcMain as kt, dialog as Cf } from "electron";
...
import ul from "zlib";
import Rf from "http";
var Se = typeof globalThis < "u" ? globalThis : typeof window < "u" ? window : typeof global < "u" ? global : typeof self < "u" ? self : {}, Qe = {}, Ft = {}, be = {};
...
var ot = Of, Pf = process.cwd, Tn = null, Nf = process.env.GRACEFUL_FS_PLATFORM || process.platform;
process.cwd = function() {
  return Tn || (Tn = Pf.call(process)), Tn;
};
try {
  process.cwd();
} catch {
...
var Lf = kf, Uf = Object.getPrototypeOf || function(e) {
  return e.__proto__;
};
function kf(e) {
...
var re = gt, Mf = Df, Bf = Ff, jf = Lf, ln = ho, ge, In;
...
var Rt = Hf;
ln.debuglog ? Rt = ln.debuglog("gfs4") : /\bgfs4\b/i.test(process.env.NODE_DEBUG || "") && (Rt = function() {
...
if (!re[ge]) {
  ...
  fl(re, qf), re.close = function(e) {
    ...
    Rt(re[ge]), sl.equal(re[ge].length, 0);
  });
}
Se[ge] || fl(Se, re[ge]);
var Oe = po(jf(re));
...
function po(e) {
  Mf(e), e.gracefulify = po, e.createReadStream = ee, e.createWriteStream = ae;
  var t = e.readFile;
  e.readFile = r;
  function r(E, q, B) {
...
function Mt(e) {
  Rt("ENQUEUE", e[0].name, e[1]), re[ge].push(e), mo();
}
var cn;
function da() {
...
function mo() {
  if (clearTimeout(cn), cn = void 0, re[ge].length !== 0) {
    ...
    if (i === void 0)
      ...
      s >= m ? (Rt("RETRY", t.name, r), t.apply(null, r.concat([i]))) : re[ge].push(e);
    }
...
dl.checkPath = function(t) {
  if (process.platform === "win32" && /[<>:"|?*]/.test(t.replace(Gf.parse(t).root, ""))) {
    const n = new Error(`Path contains invalid characters: ${t}`);
    throw n.code = "EINVAL", n;
  }
};
const hl = Ft, { checkPath: pl } = dl, ml = (e) => {
  const t = { mode: 511 };
...
const Vf = be.fromPromise, { makeDir: Wf, makeDirSync: yi } = go, vi = Vf(Wf);
var Ye = {
  mkdirs: vi,
  mkdirsSync: yi,
  // alias
...
function td(e, t, r, n) {
  const { srcStat: i, destStat: o } = Zf(e, t, n);
  if (o) {
    if (jr(i, o)) {
...
const Pe = Oe, Tr = ne, rd = Ye.mkdirs, nd = xt.pathExists, id = El.utimesMillis, Cr = ir;
function od(e, t, r, n) {
...
function Rn(e, t, r, n, i) {
  (n.dereference ? Pe.stat : Pe.lstat)(t, (a, s) => a ? i(a) : s.isDirectory() ? hd(s, e, t, r, n, i) : s.isFile() || s.isCharacterDevice() || s.isBlockDevice() ? sd(s, e, t, r, n, i) : s.isSymbolicLink() ? gd(e, t, r, n, i) : s.isSocket() ? i(new Error(`Cannot copy a socket file: ${t}`)) : s.isFIFO() ? i(new Error(`Cannot copy a FIFO pipe: ${t}`)) : i(new Error(`Unknown file: ${t}`)));
}
function sd(e, t, r, n, i, o) {
  return t ? ld(e, r, n, i, o) : _l(e, r, n, i, o);
}
...
function _l(e, t, r, n, i) {
  Pe.copyFile(t, r, (o) => o ? i(o) : n.preserveTimestamps ? cd(e.mode, t, r, i) : qn(r, e.mode, i));
}
function cd(e, t, r, n) {
  return ud(e) ? fd(r, e, (i) => i ? n(i) : pa(e, t, r, n)) : pa(e, t, r, n);
}
function ud(e) {
  return (e & 128) === 0;
}
...
function pa(e, t, r, n) {
  dd(t, r, (i) => i ? n(i) : qn(r, e, n));
}
function qn(e, t, r) {
  return Pe.chmod(e, t, r);
}
function dd(e, t, r) {
  Pe.stat(e, (n, i) => n ? r(n) : id(t, i.atime, i.mtime, r));
}
function hd(e, t, r, n, i, o) {
  return t ? Al(r, n, i, o) : pd(e.mode, r, n, i, o);
}
...
function md(e, t, r, n, i, o) {
  ...
  Cr.checkPaths(a, s, "copy", i, (l, m) => {
    if (l) return o(l);
    const { destStat: c } = m;
    ad(c, a, s, i, (f) => f ? o(f) : Sl(e, r, n, i, o));
  });
}
function gd(e, t, r, n, i) {
  Pe.readlink(t, (o, a) => {
    ...
    if (n.dereference && (a = Tr.resolve(process.cwd(), a)), e)
      Pe.readlink(r, (s, l) => s ? s.code === "EINVAL" || s.code === "UNKNOWN" ? Pe.symlink(a, r, i) : i(s) : (n.dereference && (l = Tr.resolve(process.cwd(), l)), Cr.isSrcSubdir(a, l) ? i(new Error(`Cannot copy '${a}' to a subdirectory of itself, '${l}'.`)) : e.isDirectory() && Cr.isSrcSubdir(l, a) ? i(new Error(`Cannot overwrite '${l}' with '${a}'.`)) : Ed(a, r, i)));
    else
...
var yd = od;
const we = Oe, br = ne, vd = Ye.mkdirsSync, wd = El.utimesMillisSync, Or = ir;
function _d(e, t, r) {
  ...
  return Or.checkParentPathsSync(e, n, t, "copy"), Ad(i, e, t, r);
}
function Ad(e, t, r, n) {
  if (n.filter && !n.filter(t, r)) return;
  const i = br.dirname(r);
  return we.existsSync(i) || vd(i), Tl(e, t, r, n);
}
function Sd(e, t, r, n) {
...
function Tl(e, t, r, n) {
  ...
  if (o.isDirectory()) return Pd(o, e, t, r, n);
  if (o.isFile() || o.isCharacterDevice() || o.isBlockDevice()) return Td(o, e, t, r, n);
  if (o.isSymbolicLink()) return $d(e, t, r, n);
  throw o.isSocket() ? new Error(`Cannot copy a socket file: ${t}`) : o.isFIFO() ? new Error(`Cannot copy a FIFO pipe: ${t}`) : new Error(`Unknown file: ${t}`);
}
function Td(e, t, r, n, i) {
  return t ? Cd(e, r, n, i) : Cl(e, r, n, i);
}
function Cd(e, t, r, n) {
  if (n.overwrite)
...
function Cl(e, t, r, n) {
  return we.copyFileSync(t, r), n.preserveTimestamps && bd(e.mode, t, r), yo(r, e.mode);
}
function bd(e, t, r) {
  return Od(e) && Id(r, e), Rd(t, r);
}
function Od(e) {
  return (e & 128) === 0;
}
...
function Rd(e, t) {
  ...
  return wd(t, r.atime, r.mtime);
}
function Pd(e, t, r, n, i) {
  return t ? bl(r, n, i) : Nd(e.mode, r, n, i);
}
function Nd(e, t, r, n) {
  return we.mkdirSync(r), bl(t, r, n), yo(r, e);
}
function bl(e, t, r) {
  we.readdirSync(e).forEach((n) => Dd(n, e, t, r));
}
function Dd(e, t, r, n) {
...
function Cn(e, t, r, n) {
  J(e), J(t), J(typeof n == "function"), t.rmdir(e, (i) => {
    i && (i.code === "ENOTEMPTY" || i.code === "EEXIST" || i.code === "EPERM") ? Ud(e, t, n) : i && i.code === "ENOTDIR" ? n(r) : n(i);
  });
}
function Ud(e, t, r) {
...
var Md = wo;
wo.sync = Rl;
const Pn = Oe, Bd = be.fromCallback, Pl = Md;
function jd(e, t) {
...
const qd = be.fromPromise, Nl = Ft, Dl = ne, $l = Ye, Fl = Gn, va = qd(async function(t) {
  let r;
  try {
...
const Vd = be.fromCallback, xl = ne, lt = Oe, Ll = Ye;
function Wd(e, t) {
  function r() {
    lt.writeFile(e, "", (n) => {
      if (n) return t(n);
...
const Xd = be.fromCallback, Ul = ne, st = Oe, kl = Ye, Kd = xt.pathExists, { areIdentical: Ml } = ir;
function Jd(e, t, r) {
  function n(i, o) {
    st.link(i, o, (a) => {
      if (a) return r(a);
...
function Qd(e, t) {
  ...
  return st.existsSync(n) || kl.mkdirsSync(n), st.linkSync(e, t);
}
var Zd = {
  createLink: Xd(Jd),
  createLinkSync: Qd
};
const ct = ne, wr = Oe, eh = xt.pathExists;
function th(e, t, r) {
  if (ct.isAbsolute(e))
    ...
    }));
  {
    ...
    return eh(i, (o, a) => o ? r(o) : a ? r(null, {
      toCwd: i,
      toDst: e
...
const sh = be.fromCallback, jl = ne, Me = Ft, Hl = Ye, lh = Hl.mkdirs, ch = Hl.mkdirsSync, ql = nh, uh = ql.symlinkPaths, fh = ql.symlinkPathsSync, Gl = ah, dh = Gl.symlinkType, hh = Gl.symlinkTypeSync, ph = xt.pathExists, { areIdentical: Vl } = ir;
function mh(e, t, r, n) {
...
function gh(e, t, r) {
  ...
  const i = fh(e, t);
  e = i.toDst, r = hh(i.toCwd, r);
  const o = jl.dirname(t);
  return Me.existsSync(o) || ch(o), Me.symlinkSync(e, t, r);
}
var Eh = {
  createSymlink: sh(mh),
  createSymlinkSync: gh
};
const { createFile: Aa, createFileSync: Sa } = zd, { createLink: Ta, createLinkSync: Ca } = Zd, { createSymlink: ba, createSymlinkSync: Oa } = Eh;
var yh = {
  // file
  createFile: Aa,
  createFileSync: Sa,
...
var _o = { stringify: vh, stripBom: wh };
let er;
try {
  er = Oe;
} catch {
...
const Rh = be.fromCallback, _r = Oe, zl = ne, Xl = Ye, Ph = xt.pathExists;
function Nh(e, t, r, n) {
...
const { stringify: $h } = _o, { outputFile: Fh } = Ao;
...
var Hh = Ce;
const qh = Oe, Xi = ne, Gh = vo.copy, Kl = Gn.remove, Vh = Ye.mkdirp, Wh = xt.pathExists, Ia = ir;
function Yh(e, t, r, n) {
  ...
  Ia.checkPaths(e, t, "move", r, (o, a) => {
    ...
    Ia.checkParentPaths(e, s, t, "move", (m) => {
      if (m) return n(m);
      if (zh(t)) return Ra(e, t, i, l, n);
      Vh(Xi.dirname(t), (c) => c ? n(c) : Ra(e, t, i, l, n));
    });
  });
}
function zh(e) {
...
var Kh = Yh;
const Jl = Oe, Ki = ne, Jh = vo.copySync, Ql = Gn.removeSync, Qh = Ye.mkdirpSync, Pa = ir;
function Zh(e, t, r) {
  r = r || {};
  const n = r.overwrite || r.clobber || !1, { srcStat: i, isChangingCase: o = !1 } = Pa.checkPathsSync(e, t, "move", r);
  return Pa.checkParentPathsSync(e, i, t, "move"), ep(t) || Qh(Ki.dirname(t)), tp(e, t, n, o);
}
function ep(e) {
...
function dp() {
  if (xa) return Ci;
  xa = 1;
  const e = jn, t = cl, r = fp(), { env: n } = process;
  let i;
...
typeof process > "u" || process.type === "renderer" || process.browser === !0 || process.__nwjs ? Qi.exports = up() : Qi.exports = hp();
var pp = Qi.exports, Hr = {};
...
Hr.ProgressCallbackTransform = gp;
...
const Ep = Br, yp = pp, vp = gt, wp = Mr, ec = nr, _p = dt, Ua = or, Ap = Hr, hr = (0, yp.default)("electron-builder");
...
`));
  ...
  doDownload(t, r, n) {
    const i = this.createRequest(t, (o) => {
      ...
      r.responseHandler == null ? bp(r, o) : r.responseHandler(o, r.callback);
    });
...
function bp(e, t) {
  if (!Cp(Qt(t, "X-Checksum-Sha2"), e.options.sha2, e.callback))
    return;
  const r = [];
...
Yn.githubUrl = Ip;
Yn.getS3LikeProviderBaseUrl = Rp;
function Ip(e, t = "github.com") {
...
async function ic(e, t, r, n = 0, i = 0, o) {
  var a;
  const s = new Dp.CancellationToken();
  try {
    return await e();
  } catch (l) {
...
const oc = Br, ac = or, Fp = "options.name must be either a string or a Buffer", ka = (0, oc.randomBytes)(16);
ka[0] = ka[0] | 1;
const On = {}, V = [];
for (let e = 0; e < 256; e++) {
...
function xp(e, t, r, n, i = Ar.ASCII) {
  const o = (0, oc.createHash)(t);
  if (typeof e != "string" && !Buffer.isBuffer(e))
    throw (0, ac.newError)(Fp, "ERR_INVALID_UUID_NAME");
...
tr.nil = new $t("00000000-0000-0000-0000-000000000000");
var qr = {}, sc = {};
(function(e) {
  (function(t) {
...
var fc = to, Zp = Ie, dc = new Zp("tag:yaml.org,2002:str", {
  kind: "scalar",
  construct: function(e) {
    return e !== null ? e : "";
  }
}), em = Ie, hc = new em("tag:yaml.org,2002:seq", {
  kind: "sequence",
  construct: function(e) {
    return e !== null ? e : [];
  }
}), tm = Ie, pc = new tm("tag:yaml.org,2002:map", {
  kind: "mapping",
  construct: function(e) {
    return e !== null ? e : {};
  }
...
var gc = new nm("tag:yaml.org,2002:null", {
  kind: "scalar",
  resolve: im,
  construct: om,
  predicate: am,
...
var Ec = new sm("tag:yaml.org,2002:bool", {
  kind: "scalar",
  resolve: lm,
  construct: cm,
  predicate: um,
...
var yc = new dm("tag:yaml.org,2002:int", {
  kind: "scalar",
  resolve: gm,
  construct: Em,
  predicate: ym,
...
var wc = new vm("tag:yaml.org,2002:float", {
  kind: "scalar",
  resolve: _m,
  construct: Am,
  predicate: Cm,
...
var Cc = new bm("tag:yaml.org,2002:timestamp", {
  kind: "scalar",
  resolve: Om,
  construct: Im,
  instanceOf: Date,
...
var bc = new Pm("tag:yaml.org,2002:merge", {
  kind: "scalar",
  resolve: Nm
}), Dm = Ie, Io = `ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789+/=
\r`;
function $m(e) {
  if (e === null) return !1;
...
var Oc = new Dm("tag:yaml.org,2002:binary", {
  kind: "scalar",
  resolve: $m,
  construct: Fm,
  predicate: Lm,
  represent: xm
}), Um = Ie, km = Object.prototype.hasOwnProperty, Mm = Object.prototype.toString;
function Bm(e) {
  if (e === null) return !0;
  var t = [], r, n, i, o, a, s = e;
...
var Ic = new Um("tag:yaml.org,2002:omap", {
  kind: "sequence",
  resolve: Bm,
  construct: jm
}), Hm = Ie, qm = Object.prototype.toString;
function Gm(e) {
  if (e === null) return !0;
  var t, r, n, i, o, a = e;
...
var Rc = new Hm("tag:yaml.org,2002:pairs", {
  kind: "sequence",
  resolve: Gm,
  construct: Vm
}), Wm = Ie, Ym = Object.prototype.hasOwnProperty;
function zm(e) {
  if (e === null) return !0;
  var t, r = e;
  for (t in r)
...
var Pc = new Wm("tag:yaml.org,2002:set", {
  kind: "mapping",
  resolve: zm,
  construct: Xm
}), Ro = Ac.extend({
...
}), Ot = Be, Nc = Gr, Km = Yp, Jm = Ro, ht = Object.prototype.hasOwnProperty, Fn = 1, Dc = 2, $c = 3, xn = 4, Ri = 1, Qm = 2, qa = 3, Zm = /[\x00-\x08\x0B\x0C\x0E-\x1F\x7F-\x84\x86-\x9F\uFFFE\uFFFF]|[\uD800-\uDBFF](?![\uDC00-\uDFFF])|(?:[^\uD800-\uDBFF]|^)[\uDC00-\uDFFF]/, e0 = /[\x85\u2028\u2029]/, t0 = /[,\[\]\{\}]/, Fc = /^(?:!|!!|![a-z\-]+!)$/i, xc = /^(?:!|[^,\[\]\{\}])(?:%[0-9a-f]{2}|[0-9a-z\-#;\/\?:@&=\+\$,_\.!~\*'\(\)\[\]])*$/i;
function Ga(e) {
...
function Mc(e, t) {
  ...
  return r.snippet = Km(r), new Nc(t, r);
}
function L(e, t) {
  throw Mc(e, t);
}
...
var Wa = {
  ...
  TAG: function(t, r, n) {
    var i, o;
    n.length !== 2 && L(t, "TAG directive accepts exactly two arguments"), i = n[0], o = n[1], Fc.test(i) || L(t, "ill-formed tag handle (first argument) of the TAG directive"), ht.call(t.tagMap, i) && L(t, 'there is a previously declared suffix for "' + i + '" tag handle'), xc.test(o) || L(t, "ill-formed tag prefix (second argument) of the TAG directive");
    try {
...
function Ya(e, t, r, n) {
  ...
  for (Ot.isObject(r) || L(e, "cannot merge mappings; the provided source object is unacceptable"), i = Object.keys(r), a = 0, s = i.length; a < s; a += 1)
    o = i[a], ht.call(t, o) || (Lc(t, o, r[o]), n[o] = !0);
}
function Yt(e, t, r, n, i, o, a, s, l) {
  ...
  if (typeof i == "object" && Ga(i) === "[object Object]" && (i = "[object Object]"), i = String(i), t === null && (t = {}), n === "tag:yaml.org,2002:merge")
    ...
    !e.json && !ht.call(r, i) && ht.call(t, i) && (e.line = a || e.line, e.lineStart = s || e.lineStart, e.position = l || e.position, L(e, "duplicated mapping key")), Lc(t, i, o), delete r[i];
  return t;
}
function Po(e) {
  var t;
...
function s0(e, t, r) {
  ...
  for (e.kind = "scalar", e.result = "", o = a = e.position, s = !1; g !== 0; ) {
    ...
    s && (ut(e, o, a, !1), No(e, e.line - l), o = a = e.position, s = !1), Pt(g) || (a = e.position + 1), g = e.input.charCodeAt(++e.position);
  }
  ...
  for (e.kind = "scalar", e.result = "", e.position++, n = i = e.position; (r = e.input.charCodeAt(e.position)) !== 0; )
    if (r === 39)
      if (ut(e, n, e.position, !0), r = e.input.charCodeAt(++e.position), r === 39)
        ...
        return !0;
    else We(r) ? (ut(e, n, i, !0), No(e, se(e, !1, t)), n = i = e.position) : e.position === e.lineStart && zn(e) ? L(e, "unexpected end of the document within a single quoted scalar") : (e.position++, i = e.position);
  ...
  for (e.kind = "scalar", e.result = "", e.position++, r = n = e.position; (s = e.input.charCodeAt(e.position)) !== 0; ) {
    ...
    if (s === 92) {
      if (ut(e, r, e.position, !0), s = e.input.charCodeAt(++e.position), We(s))
        ...
        for (i = a, o = 0; i > 0; i--)
          s = e.input.charCodeAt(++e.position), (a = r0(s)) >= 0 ? o = (o << 4) + a : L(e, "expected hexadecimal character");
        e.result += o0(o), e.position++;
      } else
        L(e, "unknown escape sequence");
      r = n = e.position;
    } else We(s) ? (ut(e, r, n, !0), No(e, se(e, !1, t)), r = n = e.position) : e.position === e.lineStart && zn(e) ? L(e, "unexpected end of the document within a double quoted scalar") : (e.position++, n = e.position);
  }
...
function f0(e, t) {
  ...
  for (e.kind = "scalar", e.result = ""; f !== 0; )
    if (f = e.input.charCodeAt(++e.position), f === 43 || f === 45)
      Ri === i ? i = f === 43 ? qa : Qm : L(e, "repeat of a chomping mode identifier");
    else if ((c = i0(f)) >= 0)
...
function rr(e, t, r, n, i) {
  ...
  if (s && (s = m || i), (l === 1 || xn === r) && (Fn === r || Dc === r ? y = t : y = t + 1, A = e.position - e.lineStart, l === 1 ? s && (za(e, A) || d0(e, A, y)) || u0(e, y) ? c = !0 : (a && f0(e, y) || l0(e, y) || c0(e, y) ? c = !0 : m0(e) ? (c = !0, (e.tag !== null || e.anchor !== null) && L(e, "alias node should not have any properties")) : s0(e, y, Fn === r) && (c = !0, e.tag === null && (e.tag = "?")), e.anchor !== null && (e.anchorMap[e.anchor] = e.result)) : l === 0 && (c = s && za(e, A))), e.tag === null)
...
function g0(e) {
  ...
  for (e.version = null, e.checkLineBreaks = e.legacy, e.tagMap = /* @__PURE__ */ Object.create(null), e.anchorMap = /* @__PURE__ */ Object.create(null); (a = e.input.charCodeAt(e.position)) !== 0 && (se(e, !0, -1), a = e.input.charCodeAt(e.position), !(e.lineIndent > 0 || a !== 37)); ) {
    ...
    a !== 0 && Po(e), ht.call(Wa, n) ? Wa[n](e, n, i) : Ln(e, 'unknown document directive "' + n + '"');
  }
  if (se(e, !0, -1), e.lineIndent === 0 && e.input.charCodeAt(e.position) === 45 && e.input.charCodeAt(e.position + 1) === 45 && e.input.charCodeAt(e.position + 2) === 45 ? (e.position += 3, se(e, !0, -1)) : o && L(e, "directives end mark is expected"), rr(e, e.lineIndent - 1, xn, !1, !0), se(e, !0, -1), e.checkLineBreaks && e0.test(e.input.slice(t, e.position)) && Ln(e, "non-ASCII line breaks are interpreted as content"), e.documents.push(e.result), e.position === e.lineStart && zn(e)) {
...
Oo.loadAll = E0;
Oo.load = y0;
var jc = {}, Xn = Be, Vr = Gr, v0 = Ro, Hc = Object.prototype.toString, qc = Object.prototype.hasOwnProperty, Do = 65279, w0 = 9, Pr = 10, _0 = 13, A0 = 32, S0 = 33, T0 = 34, ro = 35, C0 = 37, b0 = 38, O0 = 39, I0 = 42, Gc = 44, R0 = 45, Un = 58, P0 = 61, N0 = 62, D0 = 63, $0 = 64, Vc = 91, Wc = 93, F0 = 96, Yc = 123, x0 = 124, zc = 125, _e = {};
_e[0] = "\\0";
_e[7] = "\\a";
_e[8] = "\\b";
_e[9] = "\\t";
...
var B0 = 1, Nr = 2;
function j0(e) {
  this.schema = e.schema || v0, this.indent = Math.max(1, e.indent || 2), this.noArrayIndent = e.noArrayIndent || !1, this.skipInvalid = e.skipInvalid || !1, this.flowLevel = Xn.isNothing(e.flowLevel) ? -1 : e.flowLevel, this.styleMap = k0(this.schema, e.styles || null), this.sortKeys = e.sortKeys || !1, this.lineWidth = e.lineWidth || 80, this.noRefs = e.noRefs || !1, this.noCompatMode = e.noCompatMode || !1, this.condenseFlow = e.condenseFlow || !1, this.quotingType = e.quotingType === '"' ? Nr : B0, this.forceQuotes = e.forceQuotes || !1, this.replacer = typeof e.replacer == "function" ? e.replacer : null, this.implicitTypes = this.schema.compiledImplicit, this.explicitTypes = this.schema.compiledExplicit, this.tag = null, this.result = "", this.duplicates = [], this.usedDuplicates = null;
}
function Xa(e, t) {
...
function q0(e) {
  return Dr(e) && e !== Do && !kn(e) && e !== R0 && e !== D0 && e !== Un && e !== Gc && e !== Vc && e !== Wc && e !== Yc && e !== zc && e !== ro && e !== b0 && e !== I0 && e !== S0 && e !== x0 && e !== P0 && e !== N0 && e !== O0 && e !== T0 && e !== C0 && e !== $0 && e !== F0;
}
function G0(e) {
  return !kn(e) && e !== Un;
}
...
function V0(e, t, r, n, i, o, a, s) {
  var l, m = 0, c = null, f = !1, h = !1, g = n !== -1, _ = -1, y = q0(vr(e, 0)) && G0(vr(e, e.length - 1));
  if (t || a)
...
function W0(e, t, r, n, i) {
  e.dump = function() {
    ...
    switch (V0(
      ...
      case Qc:
        return ">" + Qa(t, e.indent) + Za(Xa(Y0(t, a), o));
      case Vt:
        return '"' + z0(t) + '"';
      default:
...
function z0(e) {
  for (var t = "", r = 0, n, i = 0; i < e.length; r >= 65536 ? i += 2 : i++)
    r = vr(e, i), n = _e[r], !n && Dr(r) ? (t += e[i], r >= 65536 && (t += e[i + 1])) : t += n || M0(r);
  return t;
}
function X0(e, t, r) {
  var n = "", i = e.tag, o, a, s;
...
function Ze(e, t, r, n, i, o, a) {
  ...
  if (c && (f = e.duplicates.indexOf(r), h = f !== -1), (e.tag !== null && e.tag !== "?" || h || e.indent !== 2 && t > 0) && (i = !1), h && e.usedDuplicates[f])
    ...
    if (c && h && !e.usedDuplicates[f] && (e.usedDuplicates[f] = !0), s === "[object Object]")
      n && Object.keys(e.dump).length !== 0 ? (J0(e, t, e.dump, i), h && (e.dump = "&ref_" + f + e.dump)) : (K0(e, t, e.dump), h && (e.dump = "&ref_" + f + " " + e.dump));
    else if (s === "[object Array]")
      n && e.dump.length !== 0 ? (e.noArrayIndent && !a && t > 0 ? ts(e, t - 1, e.dump, i) : ts(e, t, e.dump, i), h && (e.dump = "&ref_" + f + e.dump)) : (X0(e, t, e.dump), h && (e.dump = "&ref_" + f + " " + e.dump));
...
Kn.Lazy = tg;
var ao = { exports: {} };
const rg = "2.0.0", eu = 256, ng = Number.MAX_SAFE_INTEGER || /* istanbul ignore next */
9007199254740991, ig = 16, og = eu - 6, ag = [
  "major",
  "premajor",
  "minor",
  "preminor",
...
const sg = typeof process == "object" && process.env && process.env.NODE_DEBUG && /\bsemver\b/i.test(process.env.NODE_DEBUG) ? (...e) => console.error("SEMVER", ...e) : () => {
};
var Qn = sg;
(function(e, t) {
  const {
...
var Wr = ao.exports;
const lg = Object.freeze({ loose: !0 }), cg = Object.freeze({}), ug = (e) => e ? typeof e != "object" ? lg : e : cg;
var Fo = ug;
const ns = /^[0-9]+$/, tu = (e, t) => {
...
const pn = Qn, { MAX_LENGTH: is, MAX_SAFE_INTEGER: mn } = Jn, { safeRe: gn, t: En } = Wr, dg = Fo, { compareIdentifiers: Pi } = ru;
let hg = class Ve {
  constructor(t, r) {
    if (r = dg(r), t instanceof Ve) {
...
var Eg = gg;
const yg = ar, vg = (e, t) => {
  const r = yg(e.trim().replace(/^[=v]+/, ""), t);
  return r ? r.version : null;
};
var wg = vg;
const as = Re, _g = (e, t, r, n, i) => {
...
var Tg = Sg;
const Cg = Re, bg = (e, t) => new Cg(e, t).major;
var Og = bg;
const Ig = Re, Rg = (e, t) => new Ig(e, t).minor;
var Pg = Rg;
const Ng = Re, Dg = (e, t) => new Ng(e, t).patch;
var $g = Dg;
const Fg = ar, xg = (e, t) => {
  const r = Fg(e, t);
...
var Lg = xg;
const ls = Re, Ug = (e, t, r) => new ls(e, r).compare(new ls(t, r));
var je = Ug;
const kg = je, Mg = (e, t, r) => kg(t, e, r);
var Bg = Mg;
const jg = je, Hg = (e, t) => jg(e, t, !0);
var qg = Hg;
const cs = Re, Gg = (e, t, r) => {
  const n = new cs(e, r), i = new cs(t, r);
  return n.compare(i) || n.compareBuild(i);
};
var xo = Gg;
const Vg = xo, Wg = (e, t) => e.sort((r, n) => Vg(r, n, t));
var Yg = Wg;
const zg = xo, Xg = (e, t) => e.sort((r, n) => zg(n, r, t));
var Kg = Xg;
const Jg = je, Qg = (e, t, r) => Jg(e, t, r) > 0;
var Zn = Qg;
...
var ko = lE;
const cE = nu, uE = iu, fE = Zn, dE = Uo, hE = Lo, pE = ko, mE = (e, t, r, n) => {
  switch (t) {
    case "===":
...
var ou = mE;
const gE = Re, EE = ar, { safeRe: yn, t: vn } = Wr, yE = (e, t) => {
  if (e instanceof gE)
    return e;
...
function He() {
  ...
  Ni = t;
  const r = _E, n = new r(), i = Fo, o = ei(), a = Qn, s = Re, {
    safeRe: l,
    t: m,
    ...
    return R.replace(N, (b, D, P, k, G, j) => {
      ...
      const X = $(P), ue = X || $(k), U = ue || $(G), qe = U;
      return D === "=" && qe && (D = ""), j = O.includePrerelease ? "-0" : "", X ? D === ">" || D === "<" ? b = "<0.0.0-0" : b = "*" : D && qe ? (ue && (k = 0), G = 0, D === ">" ? (D = ">=", ue ? (P = +P + 1, k = 0, G = 0) : (k = +k + 1, G = 0)) : D === "<=" && (D = "<", ue ? P = +P + 1 : k = +k + 1), D === "<" && (j = "-0"), b = `${D + P}.${k}.${G}${j}`) : ue ? b = `>=${P}.0.0${j} <${+P + 1}.0.0-0` : U && (b = `>=${P}.${k}.0${j} <${P}.${+k + 1}.0-0`), a("xRange return", b), b;
    });
  }, q = (R, O) => (a("replaceStars", R, O), R.trim().replace(l[m.STAR], "")), B = (R, O) => (a("replaceGTE0", R, O), R.trim().replace(l[O.includePrerelease ? m.GTE0PRE : m.GTE0], "")), M = (R) => (O, N, b, D, P, k, G, j, X, ue, U, qe) => ($(b) ? N = "" : $(D) ? N = `>=${b}.0.0${R ? "-0" : ""}` : $(P) ? N = `>=${b}.${D}.0${R ? "-0" : ""}` : k ? N = `>=${N}` : N = `>=${N}${R ? "-0" : ""}`, $(X) ? j = "" : $(ue) ? j = `<${+X + 1}.0.0-0` : $(U) ? j = `<${X}.${+ue + 1}.0-0` : qe ? j = `<=${X}.${ue}.${U}-${qe}` : R ? j = `<${X}.${ue}.${+U + 1}-0` : j = `<=${j}`, `${N} ${j}`.trim()), z = (R, O, N) => {
...
var BE = ME;
const jE = Re, au = ei(), { ANY: HE } = au, qE = He(), GE = ti, hs = Zn, ps = Lo, VE = ko, WE = Uo, YE = (e, t, r, n) => {
  ...
  for (let m = 0; m < t.set.length; ++m) {
    ...
    let f = null, h = null;
    if (c.forEach((g) => {
      g.semver === HE && (g = new au(">=0.0.0")), f = f || g, h = h || g, i(g.semver, f.semver, n) ? f = g : a(g.semver, h.semver, n) && (h = g);
...
var ZE = QE;
const ms = He(), ey = (e, t, r) => (e = new ms(e, r), t = new ms(t, r), e.intersects(t, r));
var ty = ey;
const ry = ti, ny = je;
var iy = (e, t, r) => {
  const n = [];
...
const gs = He(), Bo = ei(), { ANY: Fi } = Bo, mr = ti, jo = je, oy = (e, t, r = {}) => {
  if (e === t)
    return !0;
  ...
  return !0;
}, ay = [new Bo(">=0.0.0-0")], Es = [new Bo(">=0.0.0")], sy = (e, t, r) => {
  if (e === t)
    return !0;
  if (e.length === 1 && e[0].semver === Fi) {
    if (t.length === 1 && t[0].semver === Fi)
      return !0;
    r.includePrerelease ? e = ay : e = Es;
  }
  if (t.length === 1 && t[0].semver === Fi) {
...
var ly = oy;
const xi = Wr, ws = Jn, cy = Re, _s = ru, uy = ar, fy = Eg, dy = wg, hy = Ag, py = Tg, my = Og, gy = Pg, Ey = $g, yy = Lg, vy = je, wy = Bg, _y = qg, Ay = xo, Sy = Yg, Ty = Kg, Cy = Zn, by = Lo, Oy = nu, Iy = iu, Ry = Uo, Py = ko, Ny = ou, Dy = vE, $y = ei(), Fy = He(), xy = ti, Ly = bE, Uy = PE, ky = FE, My = UE, By = BE, jy = Mo, Hy = KE, qy = ZE, Gy = ty, Vy = iy, Wy = ly;
var su = {
  parse: uy,
  valid: fy,
  clean: dy,
...
(function(e, t) {
  ...
  U[z] = U[R] = U[O] = U[N] = U[b] = U[D] = U[P] = U[k] = U[G] = !0, U[s] = U[l] = U[B] = U[c] = U[M] = U[f] = U[h] = U[g] = U[y] = U[A] = U[S] = U[ee] = U[ae] = U[W] = U[q] = !1;
  ...
  ), zo = Y ? u.Buffer : void 0, en = u.Symbol, Xo = u.Uint8Array, Ko = Zr.propertyIsEnumerable, Ou = Tu.splice, vt = en ? en.toStringTag : void 0, Jo = Object.getOwnPropertySymbols, Iu = zo ? zo.isBuffer : void 0, Ru = Au(Object.keys, Object), di = Ut(u, "DataView"), cr = Ut(u, "Map"), hi = Ut(u, "Promise"), pi = Ut(u, "Set"), mi = Ut(u, "WeakMap"), ur = Ut(Object, "create"), Pu = At(di), Nu = At(cr), Du = At(hi), $u = At(pi), Fu = At(mi), Qo = en ? en.prototype : void 0, gi = Qo ? Qo.valueOf : void 0;
  function wt(p) {
  ...
  ze.prototype.clear = Bu, ze.prototype.delete = ju, ze.prototype.get = Hu, ze.prototype.has = qu, ze.prototype.set = Gu;
  function _t(p) {
    var v = -1, I = p == null ? 0 : p.length;
    for (this.clear(); ++v < I; ) {
      var F = p[v];
  ...
  function fr(p) {
    return p == null ? p === void 0 ? E : T : vt && vt in Object(p) ? df(p) : yf(p);
  }
  function Zo(p) {
    return dr(p) && fr(p) == s;
  }
  ...
  function af(p, v, I, F, Z, H) {
    ...
    if (!(I & i)) {
      ...
      if (Fe || xe) {
        var it = Fe ? p.value() : p, Xe = xe ? v.value() : v;
        return H || (H = new rt()), Z(it, Xe, I, F, H);
      }
    }
    ...
    for (H.set(p, v), H.set(v, p); ++$e < fe; ) {
      ...
      if (ve) {
        if (!le(v, function(Xe, St) {
          if (!Jr(ve, St) && (Fe === Xe || Z(Fe, Xe, I, F, H)))
            return ve.push(St);
        })) {
          ke = !1;
          break;
  ...
  function ff(p, v, I, F, Z, H) {
    ...
    for (var it = oe; ++ke < me; ) {
      ...
      var Xe = p[ve], St = v[ve];
      if (F)
        var la = oe ? F(St, Xe, ve, v, p, H) : F(Xe, St, ve, p, v, H);
      if (!(la === void 0 ? Xe === St || Z(Xe, St, I, F, H) : la)) {
        xe = !1;
        break;
      }
  ...
  function df(p) {
    ...
    var Z = Yo.call(p);
    return F && (v ? p[vt] = I : delete p[vt]), Z;
  }
  ...
  (di && nt(new di(new ArrayBuffer(1))) != M || cr && nt(new cr()) != y || hi && nt(hi.resolve()) != $ || pi && nt(new pi()) != ae || mi && nt(new mi()) != q) && (nt = function(p) {
    var v = fr(p), I = v == S ? p.constructor : void 0, F = I ? At(I) : "";
    if (F)
      switch (F) {
        case Pu:
          return M;
...
Yr.createTempUpdateFile = Qy;
const zy = Br, Xy = gt, As = Yy, Ct = Et, Sr = ne;
class Ky {
  constructor(t) {
  ...
  async validateDownloadedPath(t, r, n, i) {
    if (this.versionInfo != null && this.file === t && this.fileInfo != null)
      return As(this.versionInfo, r) && As(this.fileInfo.info, n.info) && await (0, Ct.pathExists)(t) ? t : null;
...
var zr = {}, Le = {}, nv = "[object Symbol]", cu = /[\\^$.*+?()[\]{}|]/g, iv = RegExp(cu.source), ov = typeof Se == "object" && Se && Se.Object === Object && Se, av = typeof self == "object" && self && self.Object === Object && self, sv = ov || av || Function("return this")(), lv = Object.prototype, cv = lv.toString, Ts = sv.Symbol, Cs = Ts ? Ts.prototype : void 0, bs = Cs ? Cs.toString : void 0;
function uv(e) {
  if (typeof e == "string")
    return e;
  if (dv(e))
...
function pv(e) {
  return e = hv(e), e && iv.test(e) ? e.replace(cu, "\\$&") : e;
}
var mv = pv;
...
function vv(e, t, r) {
  ...
  return [so(`${e.pathname.replace(new RegExp(gv(r), "g"), t)}.blockmap`, e), n];
}
var ce = {};
...
ii.BitbucketProvider = bv;
var mt = {};
Object.defineProperty(mt, "__esModule", { value: !0 });
mt.GitHubProvider = mt.BaseGitHubProvider = void 0;
mt.computeReleaseNotes = hu;
const Ke = he, zt = su, Ov = nr, Xt = Le, lo = ce, ji = /\/tag\/([^/]+)$/;
class du extends lo.Provider {
  constructor(t, r, n) {
    super({
      ...
      isUseMultipleRangeRequest: !1
    }), this.options = t, this.baseUrl = (0, Xt.newBaseUrl)((0, Ke.githubUrl)(t, r));
    const i = r === "github.com" ? "api.github.com" : r;
    this.baseApiUrl = (0, Xt.newBaseUrl)((0, Ke.githubUrl)(t, i));
  }
...
class Iv extends du {
  ...
  async getLatestVersion() {
    var t, r, n, i, o;
    const a = new Ke.CancellationToken(), s = await this.httpRequest((0, Xt.newUrlFromBase)(`${this.basePath}.atom`, this.baseUrl), {
...
${s}`, "ERR_UPDATER_INVALID_RELEASE_FEED");
  ...
  async getLatestTagName(t) {
    const r = this.options, n = r.host == null || r.host === "github.com" ? (0, Xt.newUrlFromBase)(`${this.basePath}/latest`, this.baseUrl) : new Ov.URL(`${this.computeGithubBasePath(`/repos/${r.owner}/${r.repo}/releases`)}/latest`, this.baseApiUrl);
    try {
...
oi.KeygenProvider = Rv;
var ai = {};
Object.defineProperty(ai, "__esModule", { value: !0 });
ai.PrivateGitHubProvider = void 0;
const jt = he, Pv = Ee, Nv = ne, Ds = nr, $s = Le, Dv = mt, $v = ce;
class Fv extends Dv.BaseGitHubProvider {
  constructor(t, r, n, i) {
  ...
  async getLatestVersion() {
    ...
    let a;
    try {
      a = (0, Pv.load)(await this.httpRequest(o, this.configureHeaders("application/octet-stream"), t));
    } catch (s) {
  ...
  resolveFiles(t) {
    return (0, $v.getFileList)(t).map((r) => {
...
ni.createClient = Mv;
const wn = he, xv = ii, Fs = zr, Lv = mt, Uv = oi, kv = ai;
function pu(e) {
...
function Bv(e, t, r) {
  ...
  for (let y = 0; y < c.checksums.length; _ += c.sizes[y], y++) {
    ...
    S != null && g.get(T) !== A && (r.warn(`Checksum ("${T}") matches, but size differs (old: ${g.get(T)}, new: ${A})`), S = void 0), S === void 0 ? (f++, o != null && o.kind === It.DOWNLOAD && o.end === _ ? o.end += A : (o = {
      ...
      // oldBlocks: null,
    }, xs(o, s, T, y))) : o != null && o.kind === It.COPY && o.end === S ? o.end += A : (o = {
      kind: It.COPY,
      start: S,
      end: S + A
      // oldBlocks: [checksum]
...
sr.copyData = mu;
const _n = he, qv = gt, Gv = Mr, Vv = Lt, Us = Buffer.from(`\r
\r
`);
var at;
(function(e) {
...
const gr = he, Gi = Et, Jv = gt, Qv = sr, Zv = nr, An = Lt, Bs = li, ew = ci;
class tw {
  ...
  async doDownloadFile(t, r) {
    ...
    await new Promise((a, s) => {
      ...
      if (!this.options.isUseMultipleRangeRequest && this.options.onProgress) {
        ...
        m = new ew.ProgressDifferentialDownloadCallbackTransform($, this.options.cancellationToken, this.options.onProgress), l.push(m);
      }
      ...
      A.redirect = "manual", g = (T) => {
        ...
        ae.on("redirect", (W, De, E) => {
          this.logger.info(`Redirect to ${rw(E)}`), y = E, (0, gr.configureRequestUrl)(new Zv.URL(y), A), ae.followRedirect();
...
const Ae = he, ow = Br, aw = jn, sw = ll, Ht = Et, lw = Ee, Vi = Kn, Tt = ne, bt = su, Hs = Yr, cw = ri, qs = lu, uw = zr, Wi = ni, fw = ul, dw = Le, hw = si, qt = yt;
class qo extends sw.EventEmitter {
  ...
  constructor(t, r) {
    ...
    }), r == null ? (this.app = new cw.ElectronAppAdapter(), this.httpExecutor = new qs.ElectronHttpExecutor((o, a) => this.emit("login", o, a))) : (this.app = r, this.httpExecutor = null);
  ...
  async loadUpdateConfig() {
    return this._appUpdateConfigPath == null && (this._appUpdateConfigPath = this.app.appUpdateConfigPath), (0, lw.load)(await (0, Ht.readFile)(this._appUpdateConfigPath, "utf-8"));
  }
...
Kr.FileWithEmbeddedBlockMapDifferentialDownloader = vw;
function Eu(e) {
...
const Vs = he, Ws = Bn, _w = Et, Aw = gt, Er = ne, Sw = et, Tw = Kr, Cw = ce, Ys = yt;
class bw extends Sw.BaseUpdater {
  constructor(t, r) {
    super(t, r);
  }
  isUpdaterActive() {
  ...
  async downloadDifferential(t, r, n, i, o) {
    try {
      ...
      return this.listenerCount(Ys.DOWNLOAD_PROGRESS) > 0 && (a.onProgress = (s) => this.emit(Ys.DOWNLOAD_PROGRESS, s)), await new Tw.FileWithEmbeddedBlockMapDifferentialDownloader(t.info, this.httpExecutor, a).download(), !1;
    } catch (a) {
...
$r.AppImageUpdater = bw;
var Fr = {};
Object.defineProperty(Fr, "__esModule", { value: !0 });
Fr.DebUpdater = void 0;
const Ow = et, Iw = ce, zs = yt;
class Rw extends Ow.BaseUpdater {
  constructor(t, r) {
    super(t, r);
  }
  /*** @private */
  doDownloadUpdate(t) {
    const r = t.updateInfoAndProvider.provider, n = (0, Iw.findFile)(r.resolveFiles(t.updateInfoAndProvider.info), "deb", ["AppImage", "rpm", "pacman"]);
    return this.executeDownload({
      fileExtension: "deb",
      fileInfo: n,
      downloadUpdateOptions: t,
...
const Pw = et, Xs = yt, Nw = ce;
class Dw extends Pw.BaseUpdater {
  constructor(t, r) {
    super(t, r);
  }
  /*** @private */
...
const Js = he, Yi = Et, Lw = gt, Qs = ne, Uw = Rf, kw = ft, Mw = ce, Zs = Bn, el = Br;
class Bw extends kw.AppUpdater {
  constructor(t, r) {
    super(t, r), this.nativeUpdater = Nt.autoUpdater, this.squirrelDownloadedUpdate = !1, this.nativeUpdater.on("error", (n) => {
...
const Sn = he, nl = ne, Vw = et, Ww = Kr, il = yt, Yw = ce, zw = Et, Xw = Go, ol = nr;
class Kw extends Vw.BaseUpdater {
  ...
  doInstall(t) {
    ...
    return t.isAdminRightsRequired ? (this._logger.info("isAdminRightsRequired is set to true, run installer using elevate.exe"), o(), !0) : (this.spawnLog(r, n).catch((a) => {
      const s = a.code;
      this._logger.info(`Cannot run installer: error code: ${s}, error message: "${a.message}", will be executed again using elevate if EACCES, and will try to use electron.shell.openItem if ENOENT`), s === "UNKNOWN" || s === "EACCES" ? o() : s === "ENOENT" ? Nt.shell.openPath(r).catch((l) => this.dispatchError(l)) : this.dispatchError(a);
    }), !0);
  }
  async differentialDownloadWebPackage(t, r, n, i) {
    ...
    try {
      ...
      this.listenerCount(il.DOWNLOAD_PROGRESS) > 0 && (o.onProgress = (a) => this.emit(il.DOWNLOAD_PROGRESS, a)), await new Ww.FileWithEmbeddedBlockMapDifferentialDownloader(r, this.httpExecutor, o).download();
    } catch (o) {
...
const Jw = Dt.requestSingleInstanceLock();
Jw || Dt.quit();
const vu = Je.dirname(bf(import.meta.url));
process.env.APP_ROOT = Je.join(vu, "..");
const fo = process.env.VITE_DEV_SERVER_URL, E_ = Je.join(process.env.APP_ROOT, "dist-electron"), wu = Je.join(process.env.APP_ROOT, "dist");
process.env.VITE_PUBLIC = fo ? Je.join(process.env.APP_ROOT, "public") : wu;
let K;
function _u() {
  K = new al({
    width: 1200,
    ...
    webPreferences: {
      preload: Je.join(vu, "preload.mjs"),
      webSecurity: !1
  ...
  }), fo ? K.loadURL(fo) : K.loadFile(Je.join(wu, "index.html"));
}
Dt.on("window-all-closed", () => {
  process.platform !== "darwin" && (Dt.quit(), K = null);
});
Dt.on("activate", () => {
  al.getAllWindows().length === 0 && _u();
});
Qe.autoUpdater.on("checking-for-update", () => {
  K == null || K.webContents.send("update-status", { status: "checking" });
});
Qe.autoUpdater.on("update-available", (e) => {
  K == null || K.webContents.send("update-status", { status: "available", info: e });
});
Qe.autoUpdater.on("update-not-available", (e) => {
  K == null || K.webContents.send("update-status", { status: "not-available", info: e });
});
Qe.autoUpdater.on("error", (e) => {
  K == null || K.webContents.send("update-status", { status: "error", error: e.message });
});
Qe.autoUpdater.on("download-progress", (e) => {
  K == null || K.webContents.send("update-status", { status: "downloading", progress: e });
});
Qe.autoUpdater.on("update-downloaded", (e) => {
  K == null || K.webContents.send("update-status", { status: "downloaded", info: e });
});
Dt.whenReady().then(() => {
  _u(), kt.handle("dialog:openDirectory", async () => {
    const { canceled: e, filePaths: t } = await Cf.showOpenDialog(K, {
      properties: ["openDirectory"]
    });
    return e ? null : t[0];
  }), kt.handle("files:listMusic", async (e, t) => {
    if (!t) return [];
    try {
      const r = await ca.readdir(t), n = [".mp3", ".wav", ".wma", ".m4a", ".flac", ".ogg", ".mp4", ".mov", ".wmv", ".avi"];
      return r.filter((i) => n.includes(Je.extname(i).toLowerCase())).map((i) => Je.join(t, i));
    } catch (r) {
      return console.error("Error reading directory:", r), [];
    }
  }), kt.handle("files:readBuffer", async (e, t) => {
    try {
    ...
    Qe.autoUpdater.checkForUpdatesAndNotify();
