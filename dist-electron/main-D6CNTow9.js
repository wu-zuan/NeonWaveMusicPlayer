...
function _p(e) {
  xt.hasOwnProperty("O_SYMLINK") && process.version.match(/^v0\.6\.[0-2]|^v0\.5\./) && t(e), e.lutimes || r(e), e.chown = a(e.chown), e.fchown = a(e.fchown), e.lchown = a(e.lchown), e.chmod = n(e.chmod), e.fchmod = n(e.fchmod), e.lchmod = n(e.lchmod), e.chownSync = s(e.chownSync), e.fchownSync = s(e.fchownSync), e.lchownSync = s(e.lchownSync), e.chmodSync = i(e.chmodSync), e.fchmodSync = i(e.fchmodSync), e.lchmodSync = i(e.lchmodSync), e.stat = o(e.stat), e.fstat = o(e.fstat), e.lstat = o(e.lstat), e.statSync = l(e.statSync), e.fstatSync = l(e.fstatSync), e.lstatSync = l(e.lstatSync), e.chmod && !e.lchmod && (e.lchmod = function(c, u, p) {
  ...
  }), e.chown && !e.lchown && (e.lchown = function(c, u, p, h) {
    ...
    function u(p, h, w) {
      ...
      c(p, h, function _(b) {
        if (b && (b.code === "EACCES" || b.code === "EPERM" || b.code === "EBUSY") && Date.now() - x < 6e4) {
          setTimeout(function() {
            e.stat(h, function(D, N) {
              D && D.code === "ENOENT" ? c(p, h, _) : w(b);
            });
          }, T), T < 100 && (T += 10);
          return;
        }
    ...
    function u(p, h, w, x, T, _) {
      var b;
      if (_ && typeof _ == "function") {
        var D = 0;
        b = function(N, ie, ue) {
          if (N && N.code === "EAGAIN" && D < 10)
            return D++, c.call(e, p, h, w, x, T, b);
          _.apply(this, arguments);
        };
      }
      return c.call(e, p, h, w, x, T, b);
    }
    return Object.setPrototypeOf && Object.setPrototypeOf(u, c), u;
  }(e.read), e.readSync = typeof e.readSync != "function" ? e.readSync : /* @__PURE__ */ function(c) {
    return function(u, p, h, w, x) {
      for (var T = 0; ; )
        try {
          return c.call(e, u, p, h, w, x);
        } catch (_) {
  ...
  function t(c) {
    c.lchmod = function(u, p, h) {
      ...
      var h = c.openSync(u, xt.O_WRONLY | xt.O_SYMLINK, p), w = !0, x;
      try {
        x = c.fchmodSync(h, p), w = !1;
      } finally {
        if (w)
          try {
            c.closeSync(h);
  ...
  function r(c) {
    xt.hasOwnProperty("O_SYMLINK") && c.futimes ? (c.lutimes = function(u, p, h, w) {
      c.open(u, xt.O_SYMLINK, function(x, T) {
        if (x) {
          w && w(x);
          return;
        }
        c.futimes(T, p, h, function(_) {
          c.close(T, function(b) {
            w && w(_ || b);
          });
        });
      });
    }, c.lutimesSync = function(u, p, h) {
      var w = c.openSync(u, xt.O_SYMLINK), x, T = !0;
      try {
        x = c.futimesSync(w, p, h), T = !1;
      } finally {
        if (T)
          try {
            c.closeSync(w);
      ...
      return x;
    }) : c.futimes && (c.lutimes = function(u, p, h, w) {
      w && process.nextTick(w);
    }, c.lutimesSync = function() {
    });
  }
  function n(c) {
    return c && function(u, p, h) {
  ...
  function a(c) {
    return c && function(u, p, h, w) {
      return c.call(e, u, p, h, function(x) {
  ...
  function o(c) {
    return c && function(u, p, h) {
      ...
      function w(x, T) {
        T && (T.uid < 0 && (T.uid += 4294967296), T.gid < 0 && (T.gid += 4294967296)), h && h.apply(this, arguments);
      }
  ...
  function l(c) {
    return c && function(u, p) {
      var h = p ? c.call(e, u, p) : c.call(e, u);
...
var se = Dt, Rp = Tp, Op = bp, Dp = Ap, kn = us, Te, oi;
...
if (!se[Te]) {
  ...
  Ic(se, kp), se.close = function(e) {
    ...
    Wt(se[Te]), _c.equal(se[Te].length, 0);
  });
}
Oe[Te] || Ic(Oe, se[Te]);
var Ne = fs(Dp(se));
process.env.TEST_GRACEFUL_FS_GLOBAL_PATCH && !se.__patched && (Ne = fs(se), se.__patched = !0);
function fs(e) {
  Rp(e), e.gracefulify = fs, e.createReadStream = ie, e.createWriteStream = ue;
  var t = e.readFile;
  e.readFile = r;
  function r(y, q, j) {
    ...
    function B(Q, R, I, P) {
      return t(Q, R, function(A) {
        A && (A.code === "EMFILE" || A.code === "ENFILE") ? nr([B, [Q, R, I], A, P || Date.now(), Date.now()]) : typeof I == "function" && I.apply(this, arguments);
      });
    }
  }
  var n = e.writeFile;
  ...
  function i(y, q, j, B) {
    ...
    function Q(R, I, P, A, F) {
      return n(R, I, P, function(O) {
        O && (O.code === "EMFILE" || O.code === "ENFILE") ? nr([Q, [R, I, P, A], O, F || Date.now(), Date.now()]) : typeof A == "function" && A.apply(this, arguments);
      });
    }
  }
  var a = e.appendFile;
  ...
  function u(y, q, j) {
    ...
    var B = c.test(process.version) ? function(I, P, A, F) {
      return d(I, Q(
        I,
        P,
        A,
  ...
  if (process.version.substr(0, 4) === "v0.8") {
    var p = Op(e);
    _ = p.ReadStream, D = p.WriteStream;
  }
  var h = e.ReadStream;
  h && (_.prototype = Object.create(h.prototype), _.prototype.open = b);
  var w = e.WriteStream;
  w && (D.prototype = Object.create(w.prototype), D.prototype.open = N), Object.defineProperty(e, "ReadStream", {
    get: function() {
      return _;
    },
    set: function(y) {
...
function nr(e) {
  Wt("ENQUEUE", e[0].name, e[1]), se[Te].push(e), ds();
}
var Nn;
function go() {
...
function ds() {
  if (clearTimeout(Nn), Nn = void 0, se[Te].length !== 0) {
    var e = se[Te].shift(), t = e[0], r = e[1], n = e[2], i = e[3], a = e[4];
    if (i === void 0)
      ...
      o >= d ? (Wt("RETRY", t.name, r), t.apply(null, r.concat([i]))) : se[Te].push(e);
    }
...
const Le = Ne, Wr = oe, Xp = ot.mkdirs, Wp = er.pathExists, Vp = kc.utimesMillis, Vr = br;
function Yp(e, t, r, n) {
...
var lh = Yp;
const Ae = Ne, Yr = oe, ch = ot.mkdirsSync, uh = kc.utimesMillisSync, Kr = br;
function fh(e, t, r) {
...
function dh(e, t, r, n) {
  ...
  return Ae.existsSync(i) || ch(i), Bc(e, t, r, n);
}
function ph(e, t, r, n) {
...
function jc(e, t, r, n) {
  return Ae.copyFileSync(t, r), n.preserveTimestamps && gh(e.mode, t, r), ms(r, e.mode);
}
function gh(e, t, r) {
...
function zc(e, t, r) {
  Ae.readdirSync(e).forEach((n) => Th(n, e, t, r));
}
function Th(e, t, r, n) {
...
const wo = Ne, Gc = oe, ee = _c, Jr = process.platform === "win32";
function Hc(e) {
  [
    "unlink",
    "chmod",
...
function ys(e, t, r) {
  let n = 0;
  typeof t == "function" && (r = t, t = {}), ee(e, "rimraf: missing path"), ee.strictEqual(typeof e, "string", "rimraf: path should be a string"), ee.strictEqual(typeof r, "function", "rimraf: callback function required"), ee(t, "rimraf: invalid options argument provided"), ee.strictEqual(typeof t, "object", "rimraf: options should be object"), Hc(t), Eo(e, t, function i(a) {
    if (a) {
...
const kh = ke.fromPromise, Wc = Zt, Vc = oe, Yc = ot, Kc = Ai, _o = kh(async function(t) {
  let r;
  try {
...
const Fh = ke.fromCallback, Jc = oe, Tt = Ne, Qc = ot;
function $h(e, t) {
  function r() {
    Tt.writeFile(e, "", (n) => {
      if (n) return t(n);
...
const Mh = ke.fromCallback, Zc = oe, vt = Ne, eu = ot, Bh = er.pathExists, { areIdentical: tu } = br;
function jh(e, t, r) {
  function n(i, a) {
    vt.link(i, a, (s) => {
      if (s) return r(s);
...
const _t = oe, Gr = Ne, Hh = er.pathExists;
function qh(e, t, r) {
  if (_t.isAbsolute(e))
...
const Jh = ke.fromCallback, nu = oe, Ye = Zt, iu = ot, Qh = iu.mkdirs, Zh = iu.mkdirsSync, au = Wh, em = au.symlinkPaths, tm = au.symlinkPathsSync, su = Kh, rm = su.symlinkType, nm = su.symlinkTypeSync, im = er.pathExists, { areIdentical: ou } = br;
function am(e, t, r, n) {
...
const wm = ke.fromCallback, Hr = Ne, uu = oe, fu = ot, Em = er.pathExists;
function vm(e, t, r, n) {
...
var Pm = Pe;
const km = Ne, ja = oe, Nm = gs.copy, du = Ai.remove, Fm = ot.mkdirp, $m = er.pathExists, Po = br;
function Lm(e, t, r, n) {
...
var Bm = Lm;
const pu = Ne, za = oe, jm = gs.copySync, hu = Ai.removeSync, zm = ot.mkdirpSync, No = br;
function Gm(e, t, r) {
  r = r || {};
...
function mu() {
  ...
  $o = 1;
  function e(t) {
    n.debug = n, n.default = n, n.coerce = d, n.disable = o, n.enable = a, n.enabled = l, n.humanize = Zm(), n.destroy = c, Object.keys(t).forEach((u) => {
      n[u] = t[u];
    ...
    function n(u) {
      ...
      function T(..._) {
        if (!T.enabled)
          return;
        const b = T, D = Number(/* @__PURE__ */ new Date()), N = D - (p || D);
        b.diff = N, b.prev = p, b.curr = D, p = D, _[0] = n.coerce(_[0]), typeof _[0] != "string" && _.unshift("%O");
        let ie = 0;
      ...
      return T.namespace = u, T.useColors = n.useColors(), T.color = n.selectColor(u), T.extend = i, T.destroy = n.destroy, Object.defineProperty(T, "enabled", {
        enumerable: !0,
        configurable: !1,
        get: () => h !== null ? h : (w !== n.namespaces && (w = n.namespaces, x = n.enabled(u)), x),
        set: (_) => {
          h = _;
        }
...
function n0() {
  return Bo || (Bo = 1, function(e, t) {
    ...
    t.inspectOpts = Object.keys(process.env).filter((p) => /^debug_/i.test(p)).reduce((p, h) => {
      const w = h.substring(6).toLowerCase().replace(/_([a-z])/g, (T, _) => _.toUpperCase());
      let x = process.env[h];
    ...
    function a(p) {
      ...
      if (w) {
        const x = this.color, T = "\x1B[3" + (x < 8 ? x : "8;5;" + x), _ = `  ${T};1m${h} \x1B[0m`;
        p[0] = _ + p[0].split(`
`).join(`
...
`);
    ...
    function c(p) {
      ...
      for (let w = 0; w < h.length; w++)
        p.inspectOpts[h[w]] = t.inspectOpts[h[w]];
    }
    e.exports = mu()(t);
    ...
    t.on("error", a), t.on("data", (h) => p += h), t.on("end", () => {
      try {
        if (t.statusCode != null && t.statusCode >= 400) {
          const h = xr(t, "content-type"), w = h != null && (Array.isArray(h) ? h.find((x) => x.includes("json")) != null : h.includes("json"));
          a(qa(t, `method: ${r.method || "GET"} url: ${r.protocol || "https:"}//${r.hostname}${r.port ? `:${r.port}` : ""}${r.path}
  ...
  (function(t) {
    ...
    function n(m, f) {
      if (!(this instanceof n))
        return new n(m, f);
      var S = this;
      a(S), S.q = S.c = "", S.bufferCheckPosition = t.MAX_BUFFER_LENGTH, S.opt = f || {}, S.opt.lowercase = S.opt.lowercase || S.opt.lowercasetags, S.looseCase = S.opt.lowercase ? "toLowerCase" : "toUpperCase", S.tags = [], S.closed = S.closedRoot = S.sawRoot = !1, S.tag = S.error = null, S.strict = !!m, S.noscript = !!(m || S.opt.noscript), S.state = y.BEGIN, S.strictEntities = S.opt.strictEntities, S.ENTITIES = S.strictEntities ? Object.create(t.XML_ENTITIES) : Object.create(t.ENTITIES), S.attribList = [], S.opt.xmlns && (S.ns = Object.create(x)), S.opt.unquotedAttributeValues === void 0 && (S.opt.unquotedAttributeValues = !m), S.trackPosition = S.opt.position !== !1, S.trackPosition && (S.position = S.line = S.column = 0), j(S, "onready");
    }
    Object.create || (Object.create = function(m) {
      ...
      var f = [];
      for (var S in m) m.hasOwnProperty(S) && f.push(S);
      return f;
    });
    function i(m) {
        ...
        if (re > f)
          switch (r[v]) {
            case "textNode":
              ...
              break;
            case "cdata":
              B(m, "oncdata", m.cdata), m.cdata = "";
              break;
            case "script":
              B(m, "onscript", m.script), m.script = "";
              break;
            default:
              I(m, "Max buffer length exceeded: " + r[v]);
          }
        S = Math.max(S, re);
      }
      var le = t.MAX_BUFFER_LENGTH - S;
      m.bufferCheckPosition = le + m.position;
    }
    function a(m) {
    ...
    function s(m) {
      Q(m), m.cdata !== "" && (B(m, "oncdata", m.cdata), m.cdata = ""), m.script !== "" && (B(m, "onscript", m.script), m.script = "");
    }
    n.prototype = {
      end: function() {
        P(this);
    ...
    function c(m, f) {
      if (!(this instanceof c))
        return new c(m, f);
      o.apply(this), this._parser = new n(m, f), this.writable = !0, this.readable = !0;
      var S = this;
    ...
    c.prototype = Object.create(o.prototype, {
      ...
      return !S._parser["on" + m] && l.indexOf(m) !== -1 && (S._parser["on" + m] = function() {
        ...
        v.splice(0, 0, m), S.emit.apply(S, v);
      }), o.prototype.on.call(S, m, f);
    };
    var u = "[CDATA[", p = "DOCTYPE", h = "http://www.w3.org/XML/1998/namespace", w = "http://www.w3.org/2000/xmlns/", x = { xml: h, xmlns: w }, T = /[:_A-Za-z\u00C0-\u00D6\u00D8-\u00F6\u00F8-\u02FF\u0370-\u037D\u037F-\u1FFF\u200C-\u200D\u2070-\u218F\u2C00-\u2FEF\u3001-\uD7FF\uF900-\uFDCF\uFDF0-\uFFFD]/, _ = /[:_A-Za-z\u00C0-\u00D6\u00D8-\u00F6\u00F8-\u02FF\u0370-\u037D\u037F-\u1FFF\u200C-\u200D\u2070-\u218F\u2C00-\u2FEF\u3001-\uD7FF\uF900-\uFDCF\uFDF0-\uFFFD\u00B7\u0300-\u036F\u203F-\u2040.\d-]/, b = /[#:_A-Za-z\u00C0-\u00D6\u00D8-\u00F6\u00F8-\u02FF\u0370-\u037D\u037F-\u1FFF\u200C-\u200D\u2070-\u218F\u2C00-\u2FEF\u3001-\uD7FF\uF900-\uFDCF\uFDF0-\uFFFD]/, D = /[#:_A-Za-z\u00C0-\u00D6\u00D8-\u00F6\u00F8-\u02FF\u0370-\u037D\u037F-\u1FFF\u200C-\u200D\u2070-\u218F\u2C00-\u2FEF\u3001-\uD7FF\uF900-\uFDCF\uFDF0-\uFFFD\u00B7\u0300-\u036F\u203F-\u2040.\d-]/;
    function N(m) {
      return m === " " || m === `
` || m === "\r" || m === "	";
    }
    ...
    t.STATE = {
      ...
      var f = t.ENTITIES[m], S = typeof f == "number" ? String.fromCharCode(f) : f;
      t.ENTITIES[m] = S;
    });
    ...
    function B(m, f, S) {
      m.textNode && Q(m), j(m, f, S);
    }
    function Q(m) {
      m.textNode = R(m.opt, m.textNode), m.textNode && j(m, "ontext", m.textNode), m.textNode = "";
    }
    function R(m, f) {
      return m.trim && (f = f.trim()), m.normalize && (f = f.replace(/\s+/g, " ")), f;
    }
    function I(m, f) {
      return Q(m), m.trackPosition && (f += `
Line: ` + m.line + `
Column: ` + m.column + `
Char: ` + m.c), f = new Error(f), m.error = f, j(m, "onerror", f), m;
    }
    function P(m) {
      return m.sawRoot && !m.closedRoot && A(m, "Unclosed root tag"), m.state !== y.BEGIN && m.state !== y.BEGIN_WHITESPACE && m.state !== y.TEXT && I(m, "Unexpected end"), Q(m), m.c = "", m.closed = !0, j(m, "onend"), n.call(m, m.strict, m.opt), m;
    }
    function A(m, f) {
    ...
    function F(m) {
      ...
      var f = m.tags[m.tags.length - 1] || m, S = m.tag = { name: m.tagName, attributes: {} };
      m.opt.xmlns && (S.ns = f.ns), m.attribList.length = 0, B(m, "onopentagstart", S);
    }
    function O(m, f) {
      var S = m.indexOf(":"), v = S < 0 ? ["", m] : m.split(":"), K = v[0], re = v[1];
      return f && m === "xmlns" && (K = "xmlns", re = ""), { prefix: K, local: re };
    }
    function M(m) {
      ...
      if (m.opt.xmlns) {
        var f = O(m.attribName, !0), S = f.prefix, v = f.local;
        if (S === "xmlns")
          if (v === "xml" && m.attribValue !== h)
            A(
              m,
              "xml: prefix must be bound to " + h + `
Actual: ` + m.attribValue
            );
          else if (v === "xmlns" && m.attribValue !== w)
            A(
              m,
...
Actual: ` + m.attribValue
            ...
            var K = m.tag, re = m.tags[m.tags.length - 1] || m;
            K.ns === re.ns && (K.ns = Object.create(re.ns)), K.ns[v] = m.attribValue;
          }
        m.attribList.push([m.attribName, m.attribValue]);
      } else
        m.tag.attributes[m.attribName] = m.attribValue, B(m, "onattribute", {
          name: m.attribName,
          value: m.attribValue
        });
      m.attribName = m.attribValue = "";
    ...
    function X(m, f) {
      if (m.opt.xmlns) {
        ...
        for (var re = 0, le = m.attribList.length; re < le; re++) {
          var we = m.attribList[re], be = we[0], ht = we[1], de = O(be, !0), We = de.prefix, Ki = de.local, _n = We === "" ? "" : S.ns[We] || "", Rr = {
            name: be,
            value: ht,
            prefix: We,
            local: Ki,
          ...
          ), Rr.uri = We), m.tag.attributes[be] = Rr, B(m, "onattribute", Rr);
        }
        m.attribList.length = 0;
      }
      m.tag.isSelfClosing = !!f, m.sawRoot = !0, m.tags.push(m.tag), B(m, "onopentag", m.tag), f || (!m.noscript && m.tagName.toLowerCase() === "script" ? m.state = y.SCRIPT : m.state = y.TEXT, m.tag = null, m.tagName = ""), m.attribName = m.attribValue = "", m.attribList.length = 0;
    }
    function z(m) {
      if (!m.tagName) {
        A(m, "Weird empty close tag."), m.textNode += "</>", m.state = y.TEXT;
        return;
      }
      if (m.script) {
        if (m.tagName !== "script") {
      ...
      var f = m.tags.length, S = m.tagName;
      m.strict || (S = S[m.looseCase]());
      for (var v = S; f--; ) {
        var K = m.tags[f];
        if (K.name !== v)
          A(m, "Unexpected close tag");
        else
          break;
      }
      if (f < 0) {
        A(m, "Unmatched closing tag: " + m.tagName), m.textNode += "</" + m.tagName + ">", m.state = y.TEXT;
        return;
      }
      m.tagName = S;
      for (var re = m.tags.length; re-- > f; ) {
        var le = m.tag = m.tags.pop();
        m.tagName = m.tag.name, B(m, "onclosetag", m.tagName);
        var we = {};
        for (var be in le.ns)
          we[be] = le.ns[be];
        var ht = m.tags[m.tags.length - 1] || m;
        m.opt.xmlns && le.ns !== ht.ns && Object.keys(le.ns).forEach(function(de) {
          var We = le.ns[de];
          B(m, "onclosenamespace", { prefix: de, uri: We });
        });
      }
      f === 0 && (m.closedRoot = !0), m.tagName = m.attribValue = m.attribName = "", m.attribList.length = 0, m.state = y.TEXT;
    }
    function Z(m) {
      var f = m.entity, S = f.toLowerCase(), v, K = "";
      return m.ENTITIES[f] ? m.ENTITIES[f] : m.ENTITIES[S] ? m.ENTITIES[S] : (f = S, f.charAt(0) === "#" && (f.charAt(1) === "x" ? (f = f.slice(2), v = parseInt(f, 16), K = v.toString(16)) : (f = f.slice(1), v = parseInt(f, 10), K = v.toString(10))), f = f.replace(/^0+/, ""), isNaN(v) || K.toLowerCase() !== f || v < 0 || v > 1114111 ? (A(m, "Invalid character entity"), "&" + m.entity + ";") : String.fromCodePoint(v));
    }
    function he(m, f) {
      f === "<" ? (m.state = y.OPEN_WAKA, m.startTagPosition = m.position) : N(f) || (A(m, "Non-whitespace before first tag."), m.textNode = f, m.state = y.TEXT);
    }
    function U(m, f) {
      var S = "";
      return f < m.length && (S = m.charAt(f)), S;
    }
    function et(m) {
      var f = this;
      if (this.error)
          ...
          case y.TEXT:
            if (f.sawRoot && !f.closedRoot) {
              for (var re = S - 1; v && v !== "<" && v !== "&"; )
                v = U(m, S++), v && f.trackPosition && (f.position++, v === `
` ? (f.line++, f.column = 0) : f.column++);
              f.textNode += m.substring(re, S - 1);
            }
            v === "<" && !(f.sawRoot && f.closedRoot && !f.strict) ? (f.state = y.OPEN_WAKA, f.startTagPosition = f.position) : (!N(v) && (!f.sawRoot || f.closedRoot) && A(f, "Text data outside of root node."), v === "&" ? f.state = y.TEXT_ENTITY : f.textNode += v);
            continue;
          case y.SCRIPT:
          ...
          case y.CDATA:
            for (var re = S - 1; v && v !== "]"; )
              v = U(m, S++), v && f.trackPosition && (f.position++, v === `
` ? (f.line++, f.column = 0) : f.column++);
            f.cdata += m.substring(re, S - 1), v === "]" && (f.state = y.CDATA_ENDING);
            continue;
          case y.CDATA_ENDING:
          ...
          case y.CDATA_ENDING_2:
            ...
            continue;
          case y.PROC_INST:
            v === "?" ? f.state = y.PROC_INST_ENDING : N(v) ? f.state = y.PROC_INST_BODY : f.procInstName += v;
            continue;
          case y.PROC_INST_BODY:
            if (!f.procInstBody && N(v))
              continue;
          ...
          case y.PROC_INST_ENDING:
            ...
            continue;
          case y.OPEN_TAG:
            Y(_, v) ? f.tagName += v : (F(f), v === ">" ? X(f) : v === "/" ? f.state = y.OPEN_TAG_SLASH : (N(v) || A(f, "Invalid character in tag name"), f.state = y.ATTRIB));
            continue;
          ...
          case y.ATTRIB:
            ...
            continue;
          case y.ATTRIB_NAME:
            v === "=" ? f.state = y.ATTRIB_VALUE : v === ">" ? (A(f, "Attribute without value"), f.attribValue = f.attribName, M(f), X(f)) : N(v) ? f.state = y.ATTRIB_NAME_SAW_WHITE : Y(_, v) ? f.attribName += v : A(f, "Invalid attribute name");
            continue;
          ...
          case y.ATTRIB_VALUE_CLOSED:
            N(v) ? f.state = y.ATTRIB : v === ">" ? X(f) : v === "/" ? f.state = y.OPEN_TAG_SLASH : Y(T, v) ? (A(f, "No whitespace between attributes"), f.attribName = v, f.attribValue = "", f.state = y.ATTRIB_NAME) : A(f, "Invalid attribute name");
            continue;
          ...
          case y.CLOSE_TAG:
            if (f.tagName)
              v === ">" ? z(f) : Y(_, v) ? f.tagName += v : f.script ? (f.script += "</" + f.tagName, f.tagName = "", f.state = y.SCRIPT) : (N(v) || A(f, "Invalid tagname in closing tag"), f.state = y.CLOSE_TAG_SAW_WHITE);
            else {
              if (N(v))
                continue;
          ...
          case y.ATTRIB_VALUE_ENTITY_U:
            ...
            if (v === ";") {
              var be = Z(f);
              f.opt.unparsedEntities && !Object.values(t.XML_ENTITIES).includes(be) ? (f.entity = "", f.state = le, f.write(be)) : (f[we] += be, f.entity = "", f.state = le);
            } else Y(f.entity.length ? D : b, v) ? f.entity += v : (A(f, "Invalid character in entity name"), f[we] += "&" + f.entity + v, f.entity = "", f.state = le);
            continue;
          default:
    ...
    String.fromCodePoint || function() {
      var m = String.fromCharCode, f = Math.floor, S = function() {
        var v = 16384, K = [], re, le, we = -1, be = arguments.length;
        if (!be)
          return "";
        for (var ht = ""; ++we < be; ) {
          ...
          de <= 65535 ? K.push(de) : (de -= 65536, re = (de >> 10) + 55296, le = de % 1024 + 56320, K.push(re, le)), (we + 1 === be || K.length > v) && (ht += m.apply(null, K), K.length = 0);
        }
        return ht;
      };
...
function Kg(e, t, r) {
  var n, i, a, s, o, l, d, c, u = e.kind, p = e.result, h;
  if (h = e.input.charCodeAt(e.position), Ue(h) || fr(h) || h === 35 || h === 38 || h === 42 || h === 33 || h === 124 || h === 62 || h === 39 || h === 34 || h === 37 || h === 64 || h === 96 || (h === 63 || h === 45) && (i = e.input.charCodeAt(e.position + 1), Ue(i) || r && fr(i)))
    return !1;
  for (e.kind = "scalar", e.result = "", a = s = e.position, o = !1; h !== 0; ) {
    if (h === 58) {
      ...
      if (e.position === e.lineStart && Oi(e) || r && fr(h))
        break;
      if (at(h))
    ...
    o && (bt(e, a, s, !1), Cs(e, e.line - l), a = s = e.position, o = !1), Vt(h) || (s = e.position + 1), h = e.input.charCodeAt(++e.position);
  }
...
function Zg(e, t) {
  var r = !0, n, i, a, s = e.tag, o, l = e.anchor, d, c, u, p, h, w = /* @__PURE__ */ Object.create(null), x, T, _, b;
  ...
  for (e.anchor !== null && (e.anchorMap[e.anchor] = o), b = e.input.charCodeAt(++e.position); b !== 0; ) {
    ...
    r ? b === 44 && L(e, "expected the node content, but found ','") : L(e, "missed comma between flow collection entries"), T = x = _ = null, u = p = !1, b === 63 && (d = e.input.charCodeAt(e.position + 1), Ue(d) && (u = p = !0, e.position++, fe(e, !0, t))), n = e.line, i = e.lineStart, a = e.position, Tr(e, t, pi, !1, !0), T = e.tag, x = e.result, fe(e, !0, t), b = e.input.charCodeAt(e.position), (p || e.line === n) && b === 58 && (u = !0, b = e.input.charCodeAt(++e.position), fe(e, !0, t), Tr(e, t, pi, !1, !0), _ = e.result), h ? dr(e, o, w, T, x, _, n, i, a) : u ? o.push(dr(e, null, w, T, x, _, n, i, a)) : o.push(x), fe(e, !0, t), b = e.input.charCodeAt(e.position), b === 44 ? (r = !0, b = e.input.charCodeAt(++e.position)) : r = !1;
  }
...
function ty(e, t, r) {
  var n, i, a, s, o, l, d = e.tag, c = e.anchor, u = {}, p = /* @__PURE__ */ Object.create(null), h = null, w = null, x = null, T = !1, _ = !1, b;
  if (e.firstTabInLine !== -1) return !1;
  for (e.anchor !== null && (e.anchorMap[e.anchor] = u), b = e.input.charCodeAt(e.position); b !== 0; ) {
    if (!T && e.firstTabInLine !== -1 && (e.position = e.firstTabInLine, L(e, "tab characters must not be used in indentation")), n = e.input.charCodeAt(e.position + 1), a = e.line, (b === 63 || b === 58) && Ue(n))
      b === 63 ? (T && (dr(e, u, p, h, w, null, s, o, l), h = w = x = null), _ = !0, T = !0, i = !0) : T ? (T = !1, i = !0) : L(e, "incomplete explicit mapping pair; a key node is missed; or followed by a non-tabulated empty line"), e.position += 1, b = n;
    else {
      ...
      if (e.line === a) {
        ...
        if (b === 58)
          b = e.input.charCodeAt(++e.position), Ue(b) || L(e, "a whitespace character is expected after the key-value separator within a block mapping"), T && (dr(e, u, p, h, w, null, s, o, l), h = w = x = null), _ = !0, T = !1, i = !1, h = e.tag, w = e.result;
        else if (_)
    ...
    if ((e.line === a || e.lineIndent > t) && (T && (s = e.line, o = e.lineStart, l = e.position), Tr(e, t, hi, !0, i) && (T ? w = e.result : x = e.result), T || (dr(e, u, p, h, w, x, s, o, l), h = w = x = null), fe(e, !0, -1), b = e.input.charCodeAt(e.position)), (e.line === a || e.lineIndent > t) && b !== 0)
      L(e, "bad indentation of a mapping entry");
    else if (e.lineIndent < t)
      break;
  }
  return T && dr(e, u, p, h, w, null, s, o, l), _ && (e.tag = d, e.anchor = c, e.kind = "mapping", e.result = u), _;
}
function ry(e) {
  var t, r = !1, n = !1, i, a, s;
...
function Tr(e, t, r, n, i) {
  var a, s, o, l = 1, d = !1, c = !1, u, p, h, w, x, T;
  ...
  if (o && (o = d || i), (l === 1 || hi === r) && (pi === r || Yu === r ? x = t : x = t + 1, T = e.position - e.lineStart, l === 1 ? o && (Qo(e, T) || ty(e, T, x)) || Zg(e, x) ? c = !0 : (s && ey(e, x) || Jg(e, x) || Qg(e, x) ? c = !0 : iy(e) ? (c = !0, (e.tag !== null || e.anchor !== null) && L(e, "alias node should not have any properties")) : Kg(e, x, pi === r) && (c = !0, e.tag === null && (e.tag = "?")), e.anchor !== null && (e.anchorMap[e.anchor] = e.result)) : l === 0 && (c = o && Qo(e, T))), e.tag === null)
    ...
    if (Ct.call(e.typeMap[e.kind || "fallback"], e.tag))
      ...
      for (w = null, h = e.typeMap.multi[e.kind || "fallback"], u = 0, p = h.length; u < p; u += 1)
...
bs.loadAll = sy;
bs.load = oy;
var af = {}, Di = Je, mn = hn, ly = As, sf = Object.prototype.toString, of = Object.prototype.hasOwnProperty, Rs = 65279, cy = 9, Zr = 10, uy = 13, fy = 32, dy = 33, py = 34, Va = 35, hy = 37, my = 38, gy = 39, yy = 42, lf = 44, xy = 45, gi = 58, wy = 61, Ey = 62, vy = 63, Ty = 64, cf = 91, uf = 93, _y = 96, ff = 123, by = 124, df = 125, Ce = {};
Ce[0] = "\\0";
Ce[7] = "\\a";
Ce[8] = "\\b";
Ce[9] = "\\t";
...
function Ny(e, t, r, n, i, a, s, o) {
  var l, d = 0, c = null, u = !1, p = !1, h = n !== -1, w = -1, x = Py(jr(e, 0)) && ky(jr(e, e.length - 1));
  if (t || s)
  ...
  return !u && !p ? x && !s && !i(e) ? hf : a === en ? ur : Ka : r > 9 && pf(e) ? ur : s ? a === en ? ur : Ka : p ? gf : mf;
}
...
function Ly(e) {
  for (var t = "", r = 0, n, i = 0; i < e.length; r >= 65536 ? i += 2 : i++)
    r = jr(e, i), n = Ce[r], !n && tn(r) ? (t += e[i], r >= 65536 && (t += e[i + 1])) : t += n || Cy(r);
  return t;
}
function Uy(e, t, r) {
  var n = "", i = e.tag, a, s, o;
...
function dt(e, t, r, n, i, a, s) {
  ...
  if (c && (u = e.duplicates.indexOf(r), p = u !== -1), (e.tag !== null && e.tag !== "?" || p || e.indent !== 2 && t > 0) && (i = !1), p && e.usedDuplicates[u])
    ...
    if (c && p && !e.usedDuplicates[u] && (e.usedDuplicates[u] = !0), o === "[object Object]")
      n && Object.keys(e.dump).length !== 0 ? (By(e, t, e.dump, i), p && (e.dump = "&ref_" + u + e.dump)) : (My(e, t, e.dump), p && (e.dump = "&ref_" + u + " " + e.dump));
    else if (o === "[object Array]")
      n && e.dump.length !== 0 ? (e.noArrayIndent && !s && t > 0 ? al(e, t - 1, e.dump, i) : al(e, t, e.dump, i), p && (e.dump = "&ref_" + u + e.dump)) : (Uy(e, t, e.dump), p && (e.dump = "&ref_" + u + " " + e.dump));
...
(function(e, t) {
  ...
  const p = "[a-zA-Z0-9-]", h = [
    ...
    const D = w(_), N = u++;
    a(T, N, _), c[T] = N, l[N] = _, d[N] = D, s[N] = new RegExp(_, b ? "g" : void 0), o[N] = new RegExp(D, b ? "g" : void 0);
  };
...
function Ze() {
  ...
  class t {
    constructor(I, P) {
      ...
      if (this.options = P, this.loose = !!P.loose, this.includePrerelease = !!P.includePrerelease, this.raw = I.trim().replace(e, " "), this.set = this.raw.split("||").map((A) => this.parseRange(A.trim())).filter((A) => A.length), !this.set.length)
    ...
    parseRange(I) {
      const A = ((this.options.includePrerelease && h) | (this.options.loose && w)) + ":" + I, F = n.get(A);
      if (F)
        return F;
      ...
      let X = I.split(" ").map((U) => b(U, this.options)).join(" ").split(/\s+/).map((U) => j(U, this.options));
    ...
    intersects(I, P) {
      ...
      return this.set.some((A) => _(A, P) && I.set.some((F) => _(F, P) && A.every((O) => F.every((M) => O.intersects(M, P)))));
    }
    ...
    test(I) {
      ...
      for (let P = 0; P < this.set.length; P++)
        if (Q(this.set[P], I, this.options))
          return !0;
      return !1;
    }
  }
  ...
  const r = uw, n = new r(), i = Ds, a = $i(), s = Ni, o = $e, {
    ...
    tildeTrimReplace: u,
    caretTrimReplace: p
  } = gn, { FLAG_INCLUDE_PRERELEASE: h, FLAG_LOOSE: w } = ki, x = (R) => R.value === "<0.0.0-0", T = (R) => R.value === "", _ = (R, I) => {
    let P = !0;
    const A = R.slice();
    let F = A.pop();
    for (; P && A.length; )
      P = A.every((O) => F.intersects(O, I)), F = A.pop();
    return P;
  }, b = (R, I) => (R = R.replace(l[d.BUILD], ""), s("comp", R, I), R = ue(R, I), s("caret", R), R = N(R, I), s("tildes", R), R = Me(R, I), s("xrange", R), R = q(R, I), s("stars", R), R), D = (R) => !R || R.toLowerCase() === "x" || R === "*", N = (R, I) => R.trim().split(/\s+/).map((P) => ie(P, I)).join(" "), ie = (R, I) => {
    const P = I.loose ? l[d.TILDELOOSE] : l[d.TILDE];
    return R.replace(P, (A, F, O, M, X) => {
      s("tilde", R, A, F, O, M, X);
      let z;
      return D(F) ? z = "" : D(O) ? z = `>=${F}.0.0 <${+F + 1}.0.0-0` : D(M) ? z = `>=${F}.${O}.0 <${F}.${+O + 1}.0-0` : X ? (s("replaceTilde pr", X), z = `>=${F}.${O}.${M}-${X} <${F}.${+O + 1}.0-0`) : z = `>=${F}.${O}.${M} <${F}.${+O + 1}.0-0`, s("tilde return", z), z;
    });
  }, ue = (R, I) => R.trim().split(/\s+/).map((P) => Y(P, I)).join(" "), Y = (R, I) => {
    s("caret", R, I);
    const P = I.loose ? l[d.CARETLOOSE] : l[d.CARET], A = I.includePrerelease ? "-0" : "";
    return R.replace(P, (F, O, M, X, z) => {
      s("caret", R, F, O, M, X, z);
      let Z;
      return D(O) ? Z = "" : D(M) ? Z = `>=${O}.0.0${A} <${+O + 1}.0.0-0` : D(X) ? O === "0" ? Z = `>=${O}.${M}.0${A} <${O}.${+M + 1}.0-0` : Z = `>=${O}.${M}.0${A} <${+O + 1}.0.0-0` : z ? (s("replaceCaret pr", z), O === "0" ? M === "0" ? Z = `>=${O}.${M}.${X}-${z} <${O}.${M}.${+X + 1}-0` : Z = `>=${O}.${M}.${X}-${z} <${O}.${+M + 1}.0-0` : Z = `>=${O}.${M}.${X}-${z} <${+O + 1}.0.0-0`) : (s("no pr"), O === "0" ? M === "0" ? Z = `>=${O}.${M}.${X}${A} <${O}.${M}.${+X + 1}-0` : Z = `>=${O}.${M}.${X}${A} <${O}.${+M + 1}.0-0` : Z = `>=${O}.${M}.${X} <${+O + 1}.0.0-0`), s("caret return", Z), Z;
    });
  }, Me = (R, I) => (s("replaceXRanges", R, I), R.split(/\s+/).map((P) => y(P, I)).join(" ")), y = (R, I) => {
    R = R.trim();
    const P = I.loose ? l[d.XRANGELOOSE] : l[d.XRANGE];
    return R.replace(P, (A, F, O, M, X, z) => {
      s("xRange", R, A, F, O, M, X, z);
      const Z = D(O), he = Z || D(M), U = he || D(X), et = U;
      return F === "=" && et && (F = ""), z = I.includePrerelease ? "-0" : "", Z ? F === ">" || F === "<" ? A = "<0.0.0-0" : A = "*" : F && et ? (he && (M = 0), X = 0, F === ">" ? (F = ">=", he ? (O = +O + 1, M = 0, X = 0) : (M = +M + 1, X = 0)) : F === "<=" && (F = "<", he ? O = +O + 1 : M = +M + 1), F === "<" && (z = "-0"), A = `${F + O}.${M}.${X}${z}`) : he ? A = `>=${O}.0.0${z} <${+O + 1}.0.0-0` : U && (A = `>=${O}.${M}.0${z} <${O}.${+M + 1}.0-0`), s("xRange return", A), A;
    });
  }, q = (R, I) => (s("replaceStars", R, I), R.trim().replace(l[d.STAR], "")), j = (R, I) => (s("replaceGTE0", R, I), R.trim().replace(l[I.includePrerelease ? d.GTE0PRE : d.GTE0], "")), B = (R) => (I, P, A, F, O, M, X, z, Z, he, U, et) => (D(A) ? P = "" : D(F) ? P = `>=${A}.0.0${R ? "-0" : ""}` : D(O) ? P = `>=${A}.${F}.0${R ? "-0" : ""}` : M ? P = `>=${P}` : P = `>=${P}${R ? "-0" : ""}`, D(Z) ? z = "" : D(he) ? z = `<${+Z + 1}.0.0-0` : D(U) ? z = `<${Z}.${+he + 1}.0-0` : et ? z = `<=${Z}.${he}.${U}-${et}` : R ? z = `<${Z}.${he}.${+U + 1}-0` : z = `<=${z}`, `${P} ${z}`.trim()), Q = (R, I, P) => {
...
const Ow = $e, bf = $i(), { ANY: Dw } = bf, Pw = Ze(), kw = Li, yl = Fi, xl = ks, Nw = Fs, Fw = Ns, $w = (e, t, r, n) => {
  ...
  for (let d = 0; d < t.set.length; ++d) {
    ...
    let u = null, p = null;
    if (c.forEach((h) => {
      h.semver === Dw && (h = new bf(">=0.0.0")), u = u || h, p = p || h, i(h.semver, u.semver, n) ? u = h : s(h.semver, p.semver, n) && (p = h);
...
const El = Ze(), Ls = $i(), { ANY: Ta } = Ls, $r = Li, Us = Qe, Vw = (e, t, r = {}) => {
  ...
  let i, a;
  for (const h of e)
    h.operator === ">" || h.operator === ">=" ? i = Tl(i, h, r) : h.operator === "<" || h.operator === "<=" ? a = _l(a, h, r) : n.add(h.semver);
  if (n.size > 1)
    return null;
  let s;
  if (i && a) {
  ...
  for (const h of t) {
    if (c = c || h.operator === ">" || h.operator === ">=", d = d || h.operator === "<" || h.operator === "<=", i) {
...
xi.exports;
(function(e, t) {
  var r = 200, n = "__lodash_hash_undefined__", i = 1, a = 2, s = 9007199254740991, o = "[object Arguments]", l = "[object Array]", d = "[object AsyncFunction]", c = "[object Boolean]", u = "[object Date]", p = "[object Error]", h = "[object Function]", w = "[object GeneratorFunction]", x = "[object Map]", T = "[object Number]", _ = "[object Null]", b = "[object Object]", D = "[object Promise]", N = "[object Proxy]", ie = "[object RegExp]", ue = "[object Set]", Y = "[object String]", Me = "[object Symbol]", y = "[object Undefined]", q = "[object WeakMap]", j = "[object ArrayBuffer]", B = "[object DataView]", Q = "[object Float32Array]", R = "[object Float64Array]", I = "[object Int8Array]", P = "[object Int16Array]", A = "[object Int32Array]", F = "[object Uint8Array]", O = "[object Uint8ClampedArray]", M = "[object Uint16Array]", X = "[object Uint32Array]", z = /[\\^$.*+?()[\]{}|]/g, Z = /^\[object .+?Constructor\]$/, he = /^(?:0|[1-9]\d*)$/, U = {};
  U[Q] = U[R] = U[I] = U[P] = U[A] = U[F] = U[O] = U[M] = U[X] = !0, U[o] = U[l] = U[j] = U[c] = U[B] = U[u] = U[p] = U[h] = U[x] = U[T] = U[b] = U[ie] = U[ue] = U[Y] = U[q] = !1;
  var et = typeof Oe == "object" && Oe && Oe.Object === Object && Oe, m = typeof self == "object" && self && self.Object === Object && self, f = et || m || Function("return this")(), S = t && !t.nodeType && t, v = S && !0 && e && !e.nodeType && e, K = v && v.exports === S, re = K && et.process, le = function() {
    try {
  ...
  function be(g, E) {
    for (var C = -1, $ = g == null ? 0 : g.length, ne = 0, H = []; ++C < $; ) {
      var ce = g[C];
      E(ce, C, g) && (H[ne++] = ce);
    }
    return H;
  ...
  function ht(g, E) {
    for (var C = -1, $ = E.length, ne = g.length; ++C < $; )
      g[ne + C] = E[C];
    return g;
  }
  function de(g, E) {
    for (var C = -1, $ = g == null ? 0 : g.length; ++C < $; )
      if (E(g[C], C, g))
        return !0;
    return !1;
  }
  function We(g, E) {
    for (var C = -1, $ = Array(g); ++C < g; )
      $[C] = E(C);
    return $;
  }
  function Ki(g) {
  ...
  function Od(g, E) {
    var C = this.__data__, $ = Cn(C, g);
    return $ < 0 ? (++this.size, C.push([g, E])) : C[$][1] = E, this;
  }
  ...
  function Fd(g, E) {
    var C = Rn(this, g), $ = C.size;
    return C.set(g, E), this.size += C.size == $ ? 0 : 1, this;
  }
  ...
  function zd(g, E) {
    ...
    if (C instanceof lt) {
      var $ = C.__data__;
      if (!Or || $.length < r - 1)
        return $.push([g, E]), this.size = ++C.size, this;
  ...
  function Gd(g, E) {
    var C = On(g), $ = !C && ip(g), ne = !C && !$ && na(g), H = !C && !$ && !ne && uo(g), ce = C || $ || ne || H, me = ce ? We(g.length, String) : [], Ee = me.length;
    for (var ae in g)
      tt.call(g, ae) && !(ce && // Safari 9 has enumerable `arguments.length` in strict mode.
  ...
  function Pr(g) {
    return g == null ? g === void 0 ? y : _ : Nt && Nt in Object(g) ? Jd(g) : np(g);
  }
  function ro(g) {
    return kr(g) && Pr(g) == o;
  }
  function no(g, E, C, $, ne) {
    return g === E ? !0 : g == null || E == null || !kr(g) && !kr(E) ? g !== g && E !== E : qd(g, E, C, $, no, ne);
  }
  function qd(g, E, C, $, ne, H) {
    var ce = On(g), me = On(E), Ee = ce ? l : gt(g), ae = me ? l : gt(E);
    Ee = Ee == o ? b : Ee, ae = ae == o ? b : ae;
    var Be = Ee == b, Ve = ae == b, Se = Ee == ae;
    if (Se && na(g)) {
      if (!na(E))
        return !1;
      ce = !0, Be = !1;
    ...
    if (Se && !Be)
      return H || (H = new mt()), ce || uo(g) ? io(g, E, C, $, ne, H) : Yd(g, E, Ee, C, $, ne, H);
    if (!(C & i)) {
      var Ge = Be && tt.call(g, "__wrapped__"), He = Ve && tt.call(E, "__wrapped__");
      if (Ge || He) {
        var yt = Ge ? g.value() : g, ct = He ? E.value() : E;
        return H || (H = new mt()), ne(yt, ct, C, $, H);
      }
    }
    return Se ? (H || (H = new mt()), Kd(g, E, C, $, ne, H)) : !1;
  }
  function Xd(g) {
    if (!co(g) || tp(g))
      return !1;
  ...
  function io(g, E, C, $, ne, H) {
    var ce = C & i, me = g.length, Ee = E.length;
    if (me != Ee && !(ce && Ee > me))
      return !1;
    var ae = H.get(g);
    if (ae && H.get(E))
      return ae == E;
    var Be = -1, Ve = !0, Se = C & a ? new In() : void 0;
    for (H.set(g, E), H.set(E, g); ++Be < me; ) {
      var Ge = g[Be], He = E[Be];
      if ($)
        var yt = ce ? $(He, Ge, Be, E, g, H) : $(Ge, He, Be, g, E, H);
      if (yt !== void 0) {
        if (yt)
          continue;
        Ve = !1;
      ...
      if (Se) {
        if (!de(E, function(ct, Ut) {
          if (!_n(Se, Ut) && (Ge === ct || ne(Ge, ct, C, $, H)))
            return Se.push(Ut);
        })) {
          Ve = !1;
          break;
        }
      } else if (!(Ge === He || ne(Ge, He, C, $, H))) {
        Ve = !1;
        break;
      }
    }
    ...
    switch (C) {
      ...
      case ue:
        ...
        if (ae)
          return ae == E;
        $ |= a, ce.set(g, E);
        var Be = io(me(g), me(E), $, ne, H, ce);
        return ce.delete(g), Be;
      case Me:
        if (ra)
  ...
  function Kd(g, E, C, $, ne, H) {
    var ce = C & i, me = ao(g), Ee = me.length, ae = ao(E), Be = ae.length;
    if (Ee != Be && !ce)
      return !1;
    for (var Ve = Ee; Ve--; ) {
      var Se = me[Ve];
      if (!(ce ? Se in E : tt.call(E, Se)))
        return !1;
    }
    var Ge = H.get(g);
    if (Ge && H.get(E))
    ...
    for (var yt = ce; ++Ve < Ee; ) {
      ...
      var ct = g[Se], Ut = E[Se];
      if ($)
        var fo = ce ? $(Ut, ct, Se, E, g, H) : $(ct, Ut, Se, g, E, H);
      if (!(fo === void 0 ? ct === Ut || ne(ct, Ut, C, $, H) : fo)) {
        He = !1;
        break;
      }
  ...
  function Jd(g) {
    ...
    var ne = Ks.call(g);
    return $ && (E ? g[Nt] = C : delete g[Nt]), ne;
  }
  var Qd = eo ? function(g) {
    return g == null ? [] : (g = Object(g), be(eo(g), function(E) {
      return Zs.call(g, E);
    }));
  } : lp, gt = Pr;
  (Qi && gt(new Qi(new ArrayBuffer(1))) != B || Or && gt(new Or()) != x || Zi && gt(Zi.resolve()) != D || ea && gt(new ea()) != ue || ta && gt(new ta()) != q) && (gt = function(g) {
    var E = Pr(g), C = E == b ? g.constructor : void 0, $ = C ? Lt(C) : "";
    if ($)
      switch ($) {
        case gd:
          return B;
...
const LE = un, UE = Dt, Al = $E, zt = Pt, Xr = oe;
class ME {
  constructor(t) {
      ...
      if (this.updater.allowPrerelease) {
        ...
        if (T === null)
          ...
          for (const _ of l.getElements("entry")) {
            ...
            if (b === null)
              continue;
            const D = b[1], N = ((n = pr.prerelease(D)) === null || n === void 0 ? void 0 : n[0]) || null, ie = !T || ["alpha", "beta"].includes(T), ue = N !== null && !["alpha", "beta"].includes(String(N));
            if (ie && !ue && !(T === "beta" && N === "alpha")) {
              c = D;
              break;
            }
            if (N && N === T) {
...
${o}`, "ERR_UPDATER_INVALID_RELEASE_FEED");
    ...
    let u, p = "", h = "";
    const w = async (T) => {
      p = (0, hr.getChannelFilename)(T), h = (0, hr.newUrlFromBase)(this.getBaseDownloadPath(String(c), p), this.baseUrl);
      const _ = this.createRequestOptions(h);
      try {
        return await this.executor.request(_, s);
      } catch (b) {
        throw b instanceof ut.HttpError && b.statusCode === 404 ? (0, ut.newError)(`Cannot find ${p} in the latest release artifacts (${h}): ${b.stack || b.message}`, "ERR_UPDATER_CHANNEL_FILE_NOT_FOUND") : b;
      }
    };
    try {
      let T = this.channel;
    ...
    const x = (0, es.parseUpdateInfo)(u, p, h);
...
const ar = xe, wv = _e, Ev = oe, $l = _r, Ll = Xe, vv = Ot, Tv = pe;
...
function Rv(e, t, r) {
  ...
  const c = i.get(l);
  let u = 0;
  const { checksumToOffset: p, checksumToOldSize: h } = Dv(n.get(l), d.offset, r);
  let w = s.offset;
  for (let x = 0; x < c.checksums.length; w += c.sizes[x], x++) {
    const T = c.sizes[x], _ = c.checksums[x];
    let b = p.get(_);
    b != null && h.get(_) !== T && (r.warn(`Checksum ("${_}") matches, but size differs (old: ${h.get(_)}, new: ${T})`), b = void 0), b === void 0 ? (u++, a != null && a.kind === Xt.DOWNLOAD && a.end === w ? a.end += T : (a = {
      kind: Xt.DOWNLOAD,
      start: w,
      end: w + T
      // oldBlocks: null,
...
function Lv(e, t, r, n, i) {
  ...
  if (s <= 1) {
    const u = (p) => {
      ...
      const h = t.tasks[p++];
      if (h.kind === Gl.OperationKind.COPY)
        (0, zl.copyData)(h, r, t.oldFileFd, i, () => u(p));
      else {
  ...
  const c = e.httpExecutor.createRequest(d, (u) => {
    if (!rs(u, i))
      return;
    const p = (0, ts.safeGetHeader)(u, "content-type"), h = /^multipart\/.+?(?:; boundary=(?:(?:"(.+)")|(?:([^\s]+))))$/i.exec(p);
    if (h == null) {
      i(new Error(`Content-Type "multipart/byteranges" is expected, but got "${p}"`));
      return;
    }
    const w = new zl.DataSplitter(r, t, o, h[1] || h[2], l, n);
  ...
  async doDownloadFile(t, r) {
    ...
    await new Promise((s, o) => {
      ...
      if (!this.options.isUseMultipleRangeRequest && this.options.onProgress) {
        ...
        let b = 0;
        for (const N of t)
          N.kind === Wn.OperationKind.DOWNLOAD && (_.push(N.end - N.start), b += N.end - N.start);
        const D = {
          expectedByteCounts: _,
          grandTotal: b
        };
        d = new Gv.ProgressDifferentialDownloadCallbackTransform(D, this.options.cancellationToken, this.options.onProgress), l.push(d);
      }
      ...
      if (this.options.isUseMultipleRangeRequest) {
        h = (0, Hl.executeTasksUsingMultipleRangeRequests)(this, t, p, n, o), h(0);
        return;
      }
      let w = 0, x = null;
      this.logger.info(`Differential download: ${this.options.newUrl}`);
      const T = this.createRequestOptions();
      T.redirect = "manual", h = (_) => {
        var b, D;
        if (_ >= t.length) {
        ...
        const N = t[_++];
        if (N.kind === Wn.OperationKind.COPY) {
          d && d.beginFileCopy(), (0, jv.copyData)(N, p, n, o, () => h(_));
          return;
        }
        const ie = `bytes=${N.start}-${N.end - 1}`;
        T.headers.range = ie, (D = (b = this.logger) === null || b === void 0 ? void 0 : b.debug) === null || D === void 0 || D.call(b, `download range: ${ie}`), d && d.beginRangeDownload();
        const ue = this.httpExecutor.createRequest(T, (Y) => {
          Y.on("error", o), Y.on("aborted", () => {
            ...
            d && d.endRangeDownload(), ++w === 100 ? (w = 0, setTimeout(() => h(_), 1e3)) : h(_);
          });
        });
        ue.on("redirect", (Y, Me, y) => {
          this.logger.info(`Redirect to ${qv(y)}`), x = y, (0, Lr.configureRequestUrl)(new zv.URL(x), T), ue.followRedirect();
...
const Re = xe, Vv = un, Yv = _i, Kv = bc, sr = Pt, Jv = _e, ka = Pi, Mt = oe, Gt = Sf, Xl = yn, Qv = Ui, Wl = Af, Zv = xn, Na = Mi, eT = Ac, tT = Xe, rT = Gi, or = kt;
class Bs extends Kv.EventEmitter {
  ...
  async getOrCreateStagingUserId() {
    ...
    const r = Re.UUID.v5((0, Vv.randomBytes)(4096), Re.UUID.OID);
  ...
  async executeDownload(t) {
    ...
    const c = o();
    let u = Mt.join(d, c);
    const p = s == null ? null : Mt.join(d, `package-${a}${Mt.extname(s.path) || ".7z"}`), h = async (b) => (await l.setDownloadedFile(u, p, i, r, c, b), await t.done({
      ...i,
      downloadedFile: u
    ...
    })), _ = await (0, Xl.createTempUpdateFile)(`temp-${c}`, d, w);
    try {
      await t.task(_, n, p, T), await (0, Re.retry)(() => (0, sr.rename)(_, u), 60, 500, 0, 0, (b) => b instanceof Error && /^EBUSY:/.test(b.message));
    } catch (b) {
      throw await T(), b instanceof Re.CancellationError && (w.info("cancelled"), this.emit("update-cancelled", i)), b;
    }
    return w.info(`New version ${a} has been downloaded to ${u}`), await h(!0);
  }
...
const Yl = xe, Kl = Ti, uT = Pt, fT = Dt, Ur = oe, dT = pt, pT = En, hT = pe, Jl = kt;
...
const tc = xe, Fa = Pt, ST = Dt, rc = oe, AT = yp, IT = At, CT = pe, nc = Ti, ic = un;
class RT extends IT.AppUpdater {
  ...
  async doDownloadUpdate(t) {
    ...
    return this.executeDownload({
      ...
      downloadUpdateOptions: t,
      task: async (u, p) => {
        const h = rc.join(this.downloadedUpdateHelper.cacheDir, c), w = () => (0, Fa.pathExistsSync)(h) ? !t.disableDifferentialDownload : (n.info("Unable to locate previous update.zip for differential download (is this first install?), falling back to full download"), !1);
        let x = !0;
  ...
  async updateDownloaded(t, r) {
    ...
    return await new Promise((d, c) => {
      const u = (0, ic.randomBytes)(64).toString("base64").replace(/\//g, "_").replace(/\+/g, "-"), p = Buffer.from(`autoupdater:${u}`, "ascii"), h = `/${(0, ic.randomBytes)(64).toString("hex")}.zip`;
      this.server.on("request", (w, x) => {
        ...
        if (s.info(`${T} requested`), T === "/") {
          ...
          const D = w.headers.authorization.split(" ")[1], N = Buffer.from(D, "base64").toString("ascii"), [ie, ue] = N.split(":");
        ...
        const b = (0, ST.createReadStream)(i);
        b.on("error", (D) => {
          try {
            x.end();
          } catch (N) {
            s.warn(`cannot end response: ${N}`);
          }
          _ = !0, this.nativeUpdater.removeListener("error", c), c(new Error(`Cannot pipe "${i}": ${D}`));
        }), x.writeHead(200, {
      ...
      try {
        ...
        if (c.Status === 0) {
          ...
          for (const w of e) {
            ...
            if (x.size ? h = Array.from(x.keys()).every((_) => x.get(_) === p.get(_)) : w === p.get("CN") && (r.warn(`Signature validated using only CN ${w}. Please add your full Distinguished Name (DN) to publisherNames configuration`), h = !0), h) {
              n(null);
              return;
            }
          }
        }
        const u = `publisherNames: ${e.join(" | ")}, raw info: ` + JSON.stringify(c, (p, h) => p === "RawData" ? void 0 : h, 2);
...
const Vn = xe, oc = oe, NT = pt, FT = En, lc = kt, $T = pe, LT = Pt, UT = js, cc = _r;
...
ln.NsisUpdater = MT;
(function(e) {
  var t = Oe && Oe.__createBinding || (Object.create ? function(T, _, b, D) {
    D === void 0 && (D = b);
    var N = Object.getOwnPropertyDescriptor(_, b);
    (!N || ("get" in N ? !_.__esModule : N.writable || N.configurable)) && (N = { enumerable: !0, get: function() {
      return _[b];
    } }), Object.defineProperty(T, D, N);
  } : function(T, _, b, D) {
    D === void 0 && (D = b), T[D] = _[b];
...
var Wi = function(e, t, r, n, i) {
  var a, s, o = i * 8 - n - 1, l = (1 << o) - 1, d = l >> 1, c = -7, u = r ? i - 1 : 0, p = r ? -1 : 1, h = e[t + u];
  for (u += p, a = h & (1 << -c) - 1, h >>= -c, c += o; c > 0; a = a * 256 + e[t + u], u += p, c -= 8)
    ;
  ...
  var s, o, l, d = a * 8 - i - 1, c = (1 << d) - 1, u = c >> 1, p = i === 23 ? Math.pow(2, -24) - Math.pow(2, -77) : 0, h = n ? 0 : a - 1, w = n ? 1 : -1, x = t < 0 || t === 0 && 1 / t < 0 ? 1 : 0;
  for (t = Math.abs(t), isNaN(t) || t === 1 / 0 ? (o = isNaN(t) ? 1 : 0, s = c) : (s = Math.floor(Math.log(t) / Math.LN2), t * (l = Math.pow(2, -s)) < 1 && (s--, l *= 2), s + u >= 1 ? t += p / l : t += p * Math.pow(2, 1 - u), t * l >= 2 && (s++, l /= 2), s + u >= c ? (o = 0, s = c) : s + u >= 1 ? (o = (t * l - 1) * Math.pow(2, i), s = s + u) : (o = t * Math.pow(2, u - 1) * Math.pow(2, i), s = 0)); i >= 8; e[r + h] = o & 255, h += w, o /= 256, i -= 8)
    ;
  for (s = s << i | o, d += i; d > 0; e[r + h] = s & 255, h += w, s /= 256, d -= 8)
    ;
  e[r + h - w] |= x * 128;
};
const is = {
...
const Ub = {
  ...
  async load() {
    return (await import("./MpegParser-2tKpOGDI.js")).MpegParser;
  }
}, Mb = {
  parserType: "apev2",
  extensions: [".ape"],
  ...
  async load() {
    return (await import("./AsfParser-DouHYuJG.js")).AsfParser;
  }
}, jb = {
  parserType: "dsdiff",
  extensions: [".dff"],
  ...
  async load() {
    return (await import("./DsdiffParser-D2_Mf2-z.js")).DsdiffParser;
  }
}, zb = {
  parserType: "aiff",
  ...
  async load() {
    return (await import("./AiffParser-K8Ei1w-p.js")).AIFFParser;
  }
}, Gb = {
  parserType: "dsf",
  extensions: [".dsf"],
  mimeTypes: ["audio/dsf"],
  async load() {
    return (await import("./DsfParser-B60sI-Ld.js")).DsfParser;
  }
}, Hb = {
  parserType: "flac",
  extensions: [".flac"],
  ...
  async load() {
    return (await import("./FlacParser-_CiEbiTX.js").then((e) => e.d)).FlacParser;
  }
}, qb = {
  parserType: "matroska",
  ...
  async load() {
    return (await import("./MatroskaParser-B6A-inm2.js")).MatroskaParser;
  }
}, Xb = {
  parserType: "mp4",
  ...
  async load() {
    return (await import("./MP4Parser-DIf0JeXk.js")).MP4Parser;
  }
}, Wb = {
  parserType: "musepack",
  extensions: [".mpc"],
  ...
  async load() {
    return (await import("./MusepackParser-Bvx7W8-A.js")).MusepackParser;
  }
}, Vb = {
  parserType: "ogg",
  ...
  async load() {
    return (await import("./OggParser-DuQy-nAy.js")).OggParser;
  }
}, Yb = {
  parserType: "wavpack",
  extensions: [".wv", ".wvp"],
  ...
  async load() {
    return (await import("./WavPackParser-4JHMIk2m.js")).WavPackParser;
  }
}, Kb = {
  parserType: "riff",
  ...
  async load() {
    return (await import("./WaveParser-a4mGx8ym.js")).WaveParser;
  }
...
`).map((o) => {
    ...
    try {
      const s = Mr(import.meta.url)("get-artist-title"), o = Mr(import.meta.url)("genius-lyrics"), l = new o.Client(), d = async (h, w = "") => {
        try {
          const x = `https://lrclib.net/api/search?q=${encodeURIComponent(h)}`, T = await fetch(x);
          if (T.ok) {
            const _ = await T.json();
            if (Array.isArray(_) && _.length > 0) {
              const b = (w || "").split(" ")[0].toLowerCase();
              let D = _.find((N) => N.syncedLyrics && (!b || N.artistName.toLowerCase().includes(b)));
              if (D || (D = _.find((N) => N.syncedLyrics)), D && D.syncedLyrics) return D.syncedLyrics;
            }
          }
        } catch (x) {
          console.error("LRC Search Error", h, x);
        }
        return null;
      };
      console.log(`[Lyrics] Starting search for: ${n} / ${i}`);
      let c = n, u = i;
      if (a) {
        let h = ve.basename(a, ve.extname(a));
        console.log(`[Lyrics] Raw Filename: ${h}`);
        const w = h.match(/《(.+?)》/), x = h.match(/【(.+?)】/), T = /\b(Official|Music Video|MV|Live|Cover|4K|1080p|Lyric|Video)\b/gi;
        h = h.replace(T, " "), h = h.replace(/_/g, " ");
        let _ = w ? w[1] : x ? x[1] : null;
        _ && (_ = _.replace(T, "").trim());
        const b = h.replace(/[《》【】\[\]]/g, " ").replace(/\s+/g, " ").trim(), D = s(b, { defaultArtist: i });
        if (D && D.length === 2 && D[1] && (u = D[0] || i, c = D[1]), _ && (c = _, !u || u === i)) {
          const N = h.replace(w ? w[0] : x[0], "").replace(T, "").trim();
          N.length > 1 && (u = N);
        }
        console.log(`[Lyrics] Advanced Clean Result: ${u} - ${c}`);
      }
      if (n && i) {
        const h = await d(`${n} ${i}`, i);
        if (h)
          return console.log("[Lyrics] Stage 1 success (Raw)"), h;
      }
      if (c) {
        const h = `${c} ${u || ""}`.trim(), w = await d(h, u);
        if (w)
          return console.log("[Lyrics] Stage 2 success (Cleaned)"), w;
      }
      let p = null;
      try {
        let h = `${c} ${u || ""}`.trim(), w = await l.songs.search(h);
        if (w.length === 0 && a) {
          const x = ve.basename(a, ve.extname(a)).replace(/_/g, " ");
          console.log(`[Lyrics] Stage 3 Retry: Searching Genius with raw filename: ${x}`), w = await l.songs.search(x);
        }
        if (w.length > 0) {
          p = w[0];
          const x = p.title, T = p.artist.name;
          console.log(`[Lyrics] Genius identified: ${T} - ${x}`);
          const _ = await d(`${x} ${T}`, T);
          if (_)
            return console.log("[Lyrics] Stage 3 success (Genius Correction)"), _;
        }
      } catch (h) {
        console.warn("[Lyrics] Genius search failed", h);
      }
      if (p)
        try {
          console.log("[Lyrics] Stage 4: Fetching text from Genius");
          const h = await p.lyrics();
          if (h)
            return h.split(`
`).filter((w) => w.trim()).map((w) => `[00:00.00]${w}`).join(`
`);
        } catch (h) {
          console.error("[Lyrics] Failed to fetch lyrics from Genius object", h);
        }
      return console.log("[Lyrics] All stages failed."), null;
    } catch (s) {
