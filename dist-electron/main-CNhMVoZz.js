...
import Jt, { app as Ke, BrowserWindow as Ac, Notification as yp, ipcMain as de, dialog as mo } from "electron";
...
import { Client as bp, GatewayIntentBits as go, ChannelType as yo } from "discord.js";
import { createAudioPlayer as Sp, AudioPlayerStatus as xo, joinVoiceChannel as Ap, createAudioResource as sa, StreamType as Ip } from "@discordjs/voice";
...
var wt = Ep, Rp = process.cwd, ii = null, Dp = process.env.GRACEFUL_FS_PLATFORM || process.platform;
process.cwd = function() {
  return ii || (ii = Rp.call(process)), ii;
};
try {
  process.cwd();
} catch {
...
if (typeof process.chdir == "function") {
  var wo = process.chdir;
  process.chdir = function(e) {
    ii = null, wo.call(process, e);
  }, Object.setPrototypeOf && Object.setPrototypeOf(process.chdir, wo);
}
var Op = Pp;
function Pp(e) {
...
var le = Pt, Up = Op, Mp = kp, Bp = Fp, Nn = ds, _e, ci;
...
Pe[_e] || Oc(Pe, le[_e]);
var $e = ps(Bp(le));
process.env.TEST_GRACEFUL_FS_GLOBAL_PATCH && !le.__patched && ($e = ps(le), le.__patched = !0);
function ps(e) {
  Up(e), e.gracefulify = ps, e.createReadStream = k, e.createWriteStream = H;
  var t = e.readFile;
  e.readFile = r;
  function r(y, j, U) {
...
function ir(e) {
  Vt("ENQUEUE", e[0].name, e[1]), le[_e].push(e), hs();
}
var Fn;
function vo() {
...
ms.makeDir = async (e, t) => (Nc(e), kc.mkdir(e, {
  mode: Fc(t),
  recursive: !0
}));
ms.makeDirSync = (e, t) => (Nc(e), kc.mkdirSync(e, {
  mode: Fc(t),
  recursive: !0
}));
const Hp = Fe.fromPromise, { makeDir: qp, makeDirSync: oa } = ms, la = Hp(qp);
var ot = {
  mkdirs: la,
  mkdirsSync: oa,
  // alias
...
function Zp(e, t, r, n, i) {
  Kp.callbackify(Jp)(e, t, n, (a, s) => {
    ...
    return o.isDirectory() && gs(e, t) ? i(new Error(Ai(e, t, r))) : i(null, { srcStat: o, destStat: l });
  });
}
function eh(e, t, r, n) {
...
const Me = $e, Wr = ce, th = ot.mkdirs, rh = tr.pathExists, nh = Lc.utimesMillis, Vr = Sr;
function ih(e, t, r, n) {
...
function jc(e, t, r, n, i) {
  Me.copyFile(t, r, (a) => a ? i(a) : n.preserveTimestamps ? lh(e.mode, t, r, i) : Ii(r, e.mode, i));
}
function lh(e, t, r, n) {
...
function hh(e, t, r, n, i, a) {
  ...
  Vr.checkPaths(s, o, "copy", i, (l, d) => {
    if (l) return a(l);
    const { destStat: c } = d;
    ah(c, s, o, i, (u) => u ? a(u) : zc(e, r, n, i, a));
  });
}
...
var yh = ih;
const Ie = $e, Yr = ce, xh = ot.mkdirsSync, wh = Lc.utimesMillisSync, Kr = Sr;
function Eh(e, t, r) {
...
function vh(e, t, r, n) {
  ...
  return Ie.existsSync(i) || xh(i), Hc(e, t, r, n);
}
function Th(e, t, r, n) {
...
function qc(e, t, r, n) {
  return Ie.copyFileSync(t, r), n.preserveTimestamps && Sh(e.mode, t, r), ys(r, e.mode);
}
function Sh(e, t, r) {
...
function Dh(e, t, r, n) {
  return Ie.mkdirSync(r), Xc(t, r, n), ys(r, e);
}
function Xc(e, t, r) {
...
const bo = $e, Wc = ce, ne = Ic, Jr = process.platform === "win32";
function Vc(e) {
  [
    "unlink",
    "chmod",
...
function ws(e, t, r) {
  let n = 0;
  typeof t == "function" && (r = t, t = {}), ne(e, "rimraf: missing path"), ne.strictEqual(typeof e, "string", "rimraf: path should be a string"), ne.strictEqual(typeof r, "function", "rimraf: callback function required"), ne(t, "rimraf: invalid options argument provided"), ne.strictEqual(typeof t, "object", "rimraf: options should be object"), Vc(t), So(e, t, function i(a) {
    if (a) {
    ...
    t.unlink(e, (a) => {
      if (a) {
        if (a.code === "ENOENT")
          return r(null);
        if (a.code === "EPERM")
          return Jr ? Ao(e, t, a, r) : ai(e, t, a, r);
        if (a.code === "EISDIR")
          return ai(e, t, a, r);
      }
      return r(a);
...
var Uh = ws;
ws.sync = Yc;
const fi = $e, Mh = Fe.fromCallback, Kc = Uh;
function Bh(e, t) {
...
const Gh = Fe.fromPromise, Jc = er, Qc = ce, Zc = ot, eu = Ci, Co = Gh(async function(t) {
  let r;
  try {
...
const Hh = Fe.fromCallback, tu = ce, _t = $e, ru = ot;
function qh(e, t) {
  function r() {
    _t.writeFile(e, "", (n) => {
      if (n) return t(n);
...
const Vh = Fe.fromCallback, nu = ce, Tt = $e, iu = ot, Yh = tr.pathExists, { areIdentical: au } = Sr;
function Kh(e, t, r) {
  function n(i, a) {
    Tt.link(i, a, (s) => {
      if (s) return r(s);
...
const bt = ce, zr = $e, Zh = tr.pathExists;
function em(e, t, r) {
  if (bt.isAbsolute(e))
...
const sm = Fe.fromCallback, ou = ce, Ye = er, lu = ot, om = lu.mkdirs, lm = lu.mkdirsSync, cu = rm, cm = cu.symlinkPaths, um = cu.symlinkPathsSync, uu = am, fm = uu.symlinkType, dm = uu.symlinkTypeSync, pm = tr.pathExists, { areIdentical: fu } = Sr;
function hm(e, t, r, n) {
...
const { createFile: Oo, createFileSync: Po } = Wh, { createLink: ko, createLinkSync: No } = Qh, { createSymlink: Fo, createSymlinkSync: $o } = gm;
var ym = {
  // file
  createFile: Oo,
  createFileSync: Po,
...
var Es = { stringify: xm, stripBom: wm };
let vr;
try {
  vr = $e;
} catch {
...
const Ri = Fe, { stringify: du, stripBom: pu } = Es;
...
const Cm = Fe.fromCallback, Hr = $e, hu = ce, mu = ot, Rm = tr.pathExists;
function Dm(e, t, r, n) {
...
const { stringify: Pm } = Es, { outputFile: km } = vs;
async function Nm(e, t, r = {}) {
  const n = Pm(t, r);
  await km(e, n, r);
}
var Fm = Nm;
const { stringify: $m } = Es, { outputFileSync: Lm } = vs;
function Um(e, t, r) {
  const n = $m(t, r);
  Lm(e, n, r);
}
...
var jm = Ne;
const Gm = $e, Ga = ce, zm = xs.copy, gu = Ci.remove, Hm = ot.mkdirp, qm = tr.pathExists, Lo = Sr;
function Xm(e, t, r, n) {
  ...
  Lo.checkPaths(e, t, "move", r, (a, s) => {
    ...
    Lo.checkParentPaths(e, o, t, "move", (d) => {
      ...
      Hm(Ga.dirname(t), (c) => c ? n(c) : Uo(e, t, i, l, n));
    });
  });
}
function Wm(e) {
...
function Uo(e, t, r, n, i) {
  ...
  if (r)
    return gu(t, (a) => a ? i(a) : ca(e, t, r, i));
  qm(t, (a, s) => a ? i(a) : s ? i(new Error("dest already exists.")) : ca(e, t, r, i));
}
function ca(e, t, r, n) {
...
var Ym = Xm;
const yu = $e, za = ce, Km = xs.copySync, xu = Ci.removeSync, Jm = ot.mkdirpSync, Mo = Sr;
function Qm(e, t, r) {
  r = r || {};
  const n = r.overwrite || r.clobber || !1, { srcStat: i, isChangingCase: a = !1 } = Mo.checkPathsSync(e, t, "move", r);
  return Mo.checkParentPathsSync(e, i, t, "move"), Zm(t) || Jm(za.dirname(t)), e0(e, t, n, a);
}
function Zm(e) {
...
function e0(e, t, r, n) {
  if (n) return ua(e, t, r);
  if (r)
    return xu(t), ua(e, t, r);
...
var ke = {}, qa = { exports: {} }, Ln = { exports: {} }, fa, Bo;
function l0() {
  if (Bo) return fa;
  Bo = 1;
...
var Un = { exports: {} }, pa, zo;
function u0() {
  return zo || (zo = 1, pa = (e, t = process.argv) => {
...
function f0() {
  if (Ho) return ha;
  Ho = 1;
  const e = Si, t = Rc, r = u0(), { env: n } = process;
  let i;
...
typeof process > "u" || process.type === "renderer" || process.browser === !0 || process.__nwjs ? qa.exports = c0() : qa.exports = d0();
var Eu = qa.exports;
...
ke.createHttpError = Xa;
ke.parseJson = T0;
ke.configureRequestOptionsFromUrl = Tu;
ke.configureRequestUrl = _s;
ke.safeGetHeader = wr;
ke.configureRequestOptions = pi;
ke.safeStringifyJson = hi;
const m0 = un, g0 = Eu, y0 = Pt, x0 = cn, vu = br, w0 = Ct, Xo = Ar, E0 = dn, Fr = (0, g0.default)("electron-builder");
function Xa(e, t = null) {
  return new Ts(e.statusCode || -1, `${e.statusCode} ${e.statusMessage}` + (t == null ? "" : `
  ...
  static retryOnServerError(t, r = 3) {
    for (let n = 0; ; n++)
      try {
        ...
        if (n < r && (i instanceof Ts && i.isServerError() || i.code === "EPIPE"))
          continue;
        throw i;
      }
  }
...
function Tu(e, t) {
  const r = pi(t);
  return _s(new vu.URL(e), r), r;
}
function _s(e, t) {
  t.protocol = e.protocol, t.hostname = e.hostname, e.port ? t.port = e.port : t.port && delete t.port, t.path = e.pathname + e.search;
}
class Wa extends x0.Transform {
...
function b0(e, t) {
  if (!_0(wr(t, "X-Checksum-Sha2"), e.options.sha2, e.callback))
    return;
  const r = [];
  ...
  n != null ? r.push(new Wa(n, "sha512", n.length === 128 && !n.includes("+") && !n.includes("Z") && !n.includes("=") ? "hex" : "base64")) : e.options.sha2 != null && r.push(new Wa(e.options.sha2, "sha256", "hex"));
...
Oi.githubUrl = A0;
Oi.getS3LikeProviderBaseUrl = I0;
...
function H0(e, t) {
  ...
  for (l = 1; l <= t.linesBefore && !(s - l < 0); l++)
    d = ma(
      ...
      u
    ), o = Br.repeat(" ", t.indent) + ga((e.line - l + 1).toString(), c) + " | " + d.str + `
` + o;
  for (d = ma(e.buffer, n[s], i[s], e.position, u), o += Br.repeat(" ", t.indent) + ga((e.line + 1).toString(), c) + " | " + d.str + `
...
Va.prototype.extend = function(t) {
  var r = [], n = [];
  if (t instanceof ya)
    n.push(t);
  ...
  var i = Object.create(Va.prototype);
...
var Pu = Va, J0 = Le, ku = new J0("tag:yaml.org,2002:str", {
  kind: "scalar",
...
var Wu = new Cg("tag:yaml.org,2002:merge", {
  kind: "scalar",
  resolve: Rg
}), Dg = Le, Is = `ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789+/=
\r`;
function Og(e) {
  if (e === null) return !1;
...
}), qt = Je, Qu = hn, Vg = q0, Yg = Cs, Rt = Object.prototype.hasOwnProperty, mi = 1, Zu = 2, ef = 3, gi = 4, xa = 1, Kg = 2, Qo = 3, Jg = /[\x00-\x08\x0B\x0C\x0E-\x1F\x7F-\x84\x86-\x9F\uFFFE\uFFFF]|[\uD800-\uDBFF](?![\uDC00-\uDFFF])|(?:[^\uD800-\uDBFF]|^)[\uDC00-\uDFFF]/, Qg = /[\x85\u2028\u2029]/, Zg = /[,\[\]\{\}]/, tf = /^(?:!|!!|![a-z\-]+!)$/i, rf = /^(?:!|[^,\[\]\{\}])(?:%[0-9a-f]{2}|[0-9a-z\-#;\/\?:@&=\+\$,_\.!~\*'\(\)\[\]])*$/i;
function Zo(e) {
...
function St(e, t, r, n) {
  ...
  if (t < r) {
    ...
    else Jg.test(o) && B(e, "the stream contains non-printable characters");
    e.result += o;
  }
}
function rl(e, t, r, n) {
...
function pr(e, t, r, n, i, a, s, o, l) {
  ...
  if (Array.isArray(i))
    for (i = Array.prototype.slice.call(i), d = 0, c = i.length; d < c; d += 1)
      Array.isArray(i[d]) && B(e, "nested arrays are not supported inside keys"), typeof i == "object" && Zo(i[d]) === "[object Object]" && (i[d] = "[object Object]");
...
function pe(e, t, r) {
  for (var n = 0, i = e.input.charCodeAt(e.position); i !== 0; ) {
    ...
    if (t && i === 35)
      ...
      while (i !== 10 && i !== 13 && i !== 0);
    if (at(i))
      for (Rs(e), i = e.input.charCodeAt(e.position), n++, e.lineIndent = 0; i === 32; )
...
function ay(e, t, r) {
  ...
  for (e.kind = "scalar", e.result = "", a = s = e.position, o = !1; g !== 0; ) {
    ...
    o && (St(e, a, s, !1), Ds(e, e.line - l), a = s = e.position, o = !1), Yt(g) || (s = e.position + 1), g = e.input.charCodeAt(++e.position);
  }
  ...
  for (e.kind = "scalar", e.result = "", e.position++, n = i = e.position; (r = e.input.charCodeAt(e.position)) !== 0; )
    if (r === 39)
      if (St(e, n, e.position, !0), r = e.input.charCodeAt(++e.position), r === 39)
        ...
        return !0;
    else at(r) ? (St(e, n, i, !0), Ds(e, pe(e, !1, t)), n = i = e.position) : e.position === e.lineStart && Pi(e) ? B(e, "unexpected end of the document within a single quoted scalar") : (e.position++, i = e.position);
  ...
  for (e.kind = "scalar", e.result = "", e.position++, r = n = e.position; (o = e.input.charCodeAt(e.position)) !== 0; ) {
    ...
    if (o === 92) {
      if (St(e, r, e.position, !0), o = e.input.charCodeAt(++e.position), at(o))
        ...
        for (i = s, a = 0; i > 0; i--)
          o = e.input.charCodeAt(++e.position), (s = ey(o)) >= 0 ? a = (a << 4) + s : B(e, "expected hexadecimal character");
        e.result += ny(a), e.position++;
      } else
        B(e, "unknown escape sequence");
      r = n = e.position;
    } else at(o) ? (St(e, r, n, !0), Ds(e, pe(e, !1, t)), r = n = e.position) : e.position === e.lineStart && Pi(e) ? B(e, "unexpected end of the document within a double quoted scalar") : (e.position++, n = e.position);
  }
...
function cy(e, t) {
  ...
  for (e.kind = "scalar", e.result = ""; u !== 0; )
    if (u = e.input.charCodeAt(++e.position), u === 43 || u === 45)
      xa === i ? i = u === 43 ? Qo : Kg : B(e, "repeat of a chomping mode identifier");
    else if ((c = ry(u)) >= 0)
  ...
  for (; u !== 0; ) {
    for (Rs(e), e.lineIndent = 0, u = e.input.charCodeAt(e.position); (!s || e.lineIndent < o) && u === 32; )
...
function _r(e, t, r, n, i) {
  ...
  if (o && (o = d || i), (l === 1 || gi === r) && (mi === r || Zu === r ? x = t : x = t + 1, T = e.position - e.lineStart, l === 1 ? o && (nl(e, T) || uy(e, T, x)) || ly(e, x) ? c = !0 : (s && cy(e, x) || sy(e, x) || oy(e, x) ? c = !0 : py(e) ? (c = !0, (e.tag !== null || e.anchor !== null) && B(e, "alias node should not have any properties")) : ay(e, x, mi === r) && (c = !0, e.tag === null && (e.tag = "?")), e.anchor !== null && (e.anchorMap[e.anchor] = e.result)) : l === 0 && (c = o && nl(e, T))), e.tag === null)
...
function hy(e) {
  ...
  for (e.version = null, e.checkLineBreaks = e.legacy, e.tagMap = /* @__PURE__ */ Object.create(null), e.anchorMap = /* @__PURE__ */ Object.create(null); (s = e.input.charCodeAt(e.position)) !== 0 && (pe(e, !0, -1), s = e.input.charCodeAt(e.position), !(e.lineIndent > 0 || s !== 37)); ) {
    ...
    s !== 0 && Rs(e), Rt.call(tl, n) ? tl[n](e, n, i) : yi(e, 'unknown document directive "' + n + '"');
  }
  if (pe(e, !0, -1), e.lineIndent === 0 && e.input.charCodeAt(e.position) === 45 && e.input.charCodeAt(e.position + 1) === 45 && e.input.charCodeAt(e.position + 2) === 45 ? (e.position += 3, pe(e, !0, -1)) : a && B(e, "directives end mark is expected"), _r(e, e.lineIndent - 1, gi, !1, !0), pe(e, !0, -1), e.checkLineBreaks && Qg.test(e.input.slice(t, e.position)) && yi(e, "non-ASCII line breaks are interpreted as content"), e.documents.push(e.result), e.position === e.lineStart && Pi(e)) {
...
As.loadAll = my;
As.load = gy;
var cf = {}, ki = Je, mn = hn, yy = Cs, uf = Object.prototype.toString, ff = Object.prototype.hasOwnProperty, Os = 65279, xy = 9, Zr = 10, wy = 13, Ey = 32, vy = 33, Ty = 34, Ya = 35, _y = 37, by = 38, Sy = 39, Ay = 42, df = 44, Iy = 45, xi = 58, Cy = 61, Ry = 62, Dy = 63, Oy = 64, pf = 91, hf = 93, Py = 96, mf = 123, ky = 124, gf = 125, Re = {};
Re[0] = "\\0";
Re[7] = "\\a";
Re[8] = "\\b";
Re[9] = "\\t";
...
function sl(e, t, r) {
  ...
  return (
    ...
    (r ? (
      // c = flow-in
      n
    ) : n && e !== df && e !== pf && e !== hf && e !== mf && e !== gf) && e !== Ya && !(t === xi && !i) || al(t) && !wi(t) && e === Ya || t === xi && i
  );
}
function jy(e) {
  return tn(e) && e !== Os && !wi(e) && e !== Iy && e !== Dy && e !== xi && e !== df && e !== pf && e !== hf && e !== mf && e !== gf && e !== Ya && e !== by && e !== Ay && e !== vy && e !== ky && e !== Cy && e !== Ry && e !== Sy && e !== Ty && e !== _y && e !== Oy && e !== Py;
}
function Gy(e) {
  return !wi(e) && e !== xi;
}
...
var xf = 1, Ja = 2, wf = 3, Ef = 4, fr = 5;
function zy(e, t, r, n, i, a, s, o) {
  var l, d = 0, c = null, u = !1, p = !1, g = n !== -1, w = -1, x = jy(jr(e, 0)) && Gy(jr(e, e.length - 1));
  if (t || s)
  ...
  return !u && !p ? x && !s && !i(e) ? xf : a === en ? fr : Ja : r > 9 && yf(e) ? fr : s ? a === en ? fr : Ja : p ? Ef : wf;
}
...
function ul(e, t, r, n) {
  ...
  for (s = 0, o = r.length; s < o; s += 1)
    l = r[s], e.replacer && (l = e.replacer.call(r, String(s), l)), (pt(e, t + 1, l, !0, !0, !1, !0) || typeof l > "u" && pt(e, t + 1, null, !0, !0, !1, !0)) && ((!n || i !== "") && (i += Ka(e, t)), e.dump && Zr === e.dump.charCodeAt(0) ? i += "-" : i += "- ", i += e.dump);
  e.tag = a, e.dump = i || "[]";
}
function Vy(e, t, r) {
...
function Yy(e, t, r, n) {
  ...
  for (o = 0, l = s.length; o < l; o += 1)
    p = "", (!n || i !== "") && (p += Ka(e, t)), d = s[o], c = r[d], e.replacer && (c = e.replacer.call(r, d, c)), pt(e, t + 1, d, !0, !0, !0) && (u = e.tag !== null && e.tag !== "?" || e.dump && e.dump.length > 1024, u && (e.dump && Zr === e.dump.charCodeAt(0) ? p += "?" : p += "? "), p += e.dump, u && (p += Ka(e, t)), pt(e, t + 1, c, !0, u) && (e.dump && Zr === e.dump.charCodeAt(0) ? p += ":" : p += ": ", p += e.dump, i += p));
  e.tag = a, e.dump = i || "{}";
}
function fl(e, t, r) {
  var n, i, a, s, o, l;
...
function Ky(e, t) {
  var r = [], n = [], i, a;
  for (Qa(e, r, n), i = 0, a = n.length; i < a; i += 1)
...
Ni.Lazy = Zy;
var Za = { exports: {} };
const ex = "2.0.0", Tf = 256, tx = Number.MAX_SAFE_INTEGER || /* istanbul ignore next */
9007199254740991, rx = 16, nx = Tf - 6, ix = [
  "major",
  "premajor",
  "minor",
  "preminor",
...
var Fi = {
  MAX_LENGTH: Tf,
  MAX_SAFE_COMPONENT_LENGTH: rx,
  MAX_SAFE_BUILD_LENGTH: nx,
  MAX_SAFE_INTEGER: tx,
  RELEASE_TYPES: ix,
  SEMVER_SPEC_VERSION: ex,
  FLAG_INCLUDE_PRERELEASE: 1,
  FLAG_LOOSE: 2
};
const ax = typeof process == "object" && process.env && process.env.NODE_DEBUG && /\bsemver\b/i.test(process.env.NODE_DEBUG) ? (...e) => console.error("SEMVER", ...e) : () => {
};
var $i = ax;
(function(e, t) {
  const {
...
var gn = Za.exports;
const sx = Object.freeze({ loose: !0 }), ox = Object.freeze({}), lx = (e) => e ? typeof e != "object" ? sx : e : ox;
var ks = lx;
const dl = /^[0-9]+$/, _f = (e, t) => {
...
var bf = {
  ...
  rcompareIdentifiers: cx
};
const Bn = $i, { MAX_LENGTH: pl, MAX_SAFE_INTEGER: jn } = Fi, { safeRe: Gn, t: zn } = gn, ux = ks, { compareIdentifiers: wa } = bf;
let fx = class it {
  constructor(t, r) {
    if (r = ux(r), t instanceof it) {
...
var mx = hx;
const gx = Cr, yx = (e, t) => {
  const r = gx(e.trim().replace(/^[=v]+/, ""), t);
  return r ? r.version : null;
};
var xx = yx;
const ml = Ue, wx = (e, t, r, n, i) => {
...
var Tx = vx;
const _x = Ue, bx = (e, t) => new _x(e, t).major;
var Sx = bx;
const Ax = Ue, Ix = (e, t) => new Ax(e, t).minor;
var Cx = Ix;
const Rx = Ue, Dx = (e, t) => new Rx(e, t).patch;
var Ox = Dx;
const Px = Cr, kx = (e, t) => {
  const r = Px(e, t);
...
var Nx = kx;
const yl = Ue, Fx = (e, t, r) => new yl(e, r).compare(new yl(t, r));
var Qe = Fx;
const $x = Qe, Lx = (e, t, r) => $x(t, e, r);
var Ux = Lx;
const Mx = Qe, Bx = (e, t) => Mx(e, t, !0);
var jx = Bx;
const xl = Ue, Gx = (e, t, r) => {
  const n = new xl(e, r), i = new xl(t, r);
  return n.compare(i) || n.compareBuild(i);
};
var Ns = Gx;
const zx = Ns, Hx = (e, t) => e.sort((r, n) => zx(r, n, t));
var qx = Hx;
const Xx = Ns, Wx = (e, t) => e.sort((r, n) => Xx(n, r, t));
var Vx = Wx;
const Yx = Qe, Kx = (e, t, r) => Yx(e, t, r) > 0;
var Li = Kx;
const Jx = Qe, Qx = (e, t, r) => Jx(e, t, r) < 0;
var Fs = Qx;
const Zx = Qe, ew = (e, t, r) => Zx(e, t, r) === 0;
var Sf = ew;
const tw = Qe, rw = (e, t, r) => tw(e, t, r) !== 0;
var Af = rw;
const nw = Qe, iw = (e, t, r) => nw(e, t, r) >= 0;
var $s = iw;
const aw = Qe, sw = (e, t, r) => aw(e, t, r) <= 0;
var Ls = sw;
const ow = Sf, lw = Af, cw = Li, uw = $s, fw = Fs, dw = Ls, pw = (e, t, r, n) => {
  switch (t) {
    case "===":
...
var If = pw;
const hw = Ue, mw = Cr, { safeRe: Hn, t: qn } = gn, gw = (e, t) => {
  if (e instanceof hw)
    return e;
...
function Ze() {
  ...
  Ea = t;
  const r = ww, n = new r(), i = ks, a = Ui(), s = $i, o = Ue, {
    safeRe: l,
    t: d,
...
function Ui() {
  ...
  va = t;
  const r = ks, { safeRe: n, t: i } = gn, a = If, s = $i, o = Ue, l = Ze();
  return va;
}
const Ew = Ze(), vw = (e, t, r) => {
  try {
    t = new Ew(t, r);
  } catch {
    return !1;
...
var Mi = vw;
const Tw = Ze(), _w = (e, t) => new Tw(e, t).set.map((r) => r.map((n) => n.value).join(" ").trim().split(" "));
var bw = _w;
const Sw = Ue, Aw = Ze(), Iw = (e, t, r) => {
  ...
  return e.forEach((s) => {
    a.test(s) && (!n || i.compare(s) === -1) && (n = s, i = new Sw(n, r));
  }), n;
};
var Cw = Iw;
const Rw = Ue, Dw = Ze(), Ow = (e, t, r) => {
  let n = null, i = null, a = null;
  try {
    a = new Dw(t, r);
  } catch {
  ...
  return e.forEach((s) => {
    a.test(s) && (!n || i.compare(s) === 1) && (n = s, i = new Rw(n, r));
  }), n;
};
var Pw = Ow;
const Ta = Ue, kw = Ze(), vl = Li, Nw = (e, t) => {
  e = new kw(e, t);
  let r = new Ta("0.0.0");
  if (e.test(r) || (r = new Ta("0.0.0-0"), e.test(r)))
    return r;
  r = null;
  for (let n = 0; n < e.set.length; ++n) {
    ...
    let a = null;
    i.forEach((s) => {
      const o = new Ta(s.semver.version);
      switch (s.operator) {
        case ">":
...
var Uw = Lw;
const Mw = Ue, Cf = Ui(), { ANY: Bw } = Cf, jw = Ze(), Gw = Mi, Tl = Li, _l = Fs, zw = Ls, Hw = $s, qw = (e, t, r, n) => {
  e = new Mw(e, n), t = new jw(t, n);
  let i, a, s, o, l;
  switch (r) {
    case ">":
      i = Tl, a = zw, s = _l, o = ">", l = ">=";
  ...
  for (let d = 0; d < t.set.length; ++d) {
    ...
    let u = null, p = null;
    if (c.forEach((g) => {
      g.semver === Bw && (g = new Cf(">=0.0.0")), u = u || g, p = p || g, i(g.semver, u.semver, n) ? u = g : s(g.semver, p.semver, n) && (p = g);
...
var Us = qw;
const Xw = Us, Ww = (e, t, r) => Xw(e, t, ">", r);
var Vw = Ww;
const Yw = Us, Kw = (e, t, r) => Yw(e, t, "<", r);
var Jw = Kw;
const bl = Ze(), Qw = (e, t, r) => (e = new bl(e, r), t = new bl(t, r), e.intersects(t, r));
var Zw = Qw;
const eE = Mi, tE = Qe;
var rE = (e, t, r) => {
  const n = [];
...
const Sl = Ze(), Ms = Ui(), { ANY: _a } = Ms, Lr = Mi, Bs = Qe, nE = (e, t, r = {}) => {
  if (e === t)
    return !0;
  ...
  return !0;
}, iE = [new Ms(">=0.0.0-0")], Al = [new Ms(">=0.0.0")], aE = (e, t, r) => {
  if (e === t)
    return !0;
  if (e.length === 1 && e[0].semver === _a) {
    if (t.length === 1 && t[0].semver === _a)
      return !0;
  ...
  let s;
  if (i && a) {
    if (s = Bs(i.semver, a.semver, r), s > 0)
      return null;
...
var sE = nE;
const ba = gn, Rl = Fi, oE = Ue, Dl = bf, lE = Cr, cE = mx, uE = xx, fE = Ex, dE = Tx, pE = Sx, hE = Cx, mE = Ox, gE = Nx, yE = Qe, xE = Ux, wE = jx, EE = Ns, vE = qx, TE = Vx, _E = Li, bE = Fs, SE = Sf, AE = Af, IE = $s, CE = Ls, RE = If, DE = yw, OE = Ui(), PE = Ze(), kE = Mi, NE = bw, FE = Cw, $E = Pw, LE = Fw, UE = Uw, ME = Us, BE = Vw, jE = Jw, GE = Zw, zE = rE, HE = sE;
var Rf = {
  parse: lE,
  valid: cE,
  clean: uE,
...
(function(e, t) {
  ...
  var md = Array.prototype, gd = Function.prototype, Sn = Object.prototype, Zi = f["__core-js_shared__"], Ks = gd.toString, tt = Sn.hasOwnProperty, Js = function() {
    var m = /[^.]+$/.exec(Zi && Zi.keys && Zi.keys.IE_PROTO || "");
    return m ? "Symbol(src)_1." + m : "";
  }(), Qs = Sn.toString, yd = RegExp(
    "^" + Ks.call(tt).replace(X, "\\$&").replace(/hasOwnProperty|(function).*?(?=\\\()| for .+?(?=\\\])/g, "$1.*?") + "$"
  ), Zs = Z ? f.Buffer : void 0, An = f.Symbol, eo = f.Uint8Array, to = Sn.propertyIsEnumerable, xd = md.splice, Ft = An ? An.toStringTag : void 0, ro = Object.getOwnPropertySymbols, wd = Zs ? Zs.isBuffer : void 0, Ed = pd(Object.keys, Object), ea = nr(f, "DataView"), Or = nr(f, "Map"), ta = nr(f, "Promise"), ra = nr(f, "Set"), na = nr(f, "WeakMap"), Pr = nr(Object, "create"), vd = Ut(ea), Td = Ut(Or), _d = Ut(ta), bd = Ut(ra), Sd = Ut(na), no = An ? An.prototype : void 0, ia = no ? no.valueOf : void 0;
  function $t(m) {
  ...
  function Vd(m, E) {
    var C = Dn(m), L = !C && cp(m), se = !C && !L && aa(m), V = !C && !L && !se && po(m), fe = C || L || se || V, ye = fe ? We(m.length, String) : [], Te = ye.length;
    for (var oe in m)
  ...
  function ao(m, E, C, L, se) {
    return m === E ? !0 : m == null || E == null || !Nr(m) && !Nr(E) ? m !== m && E !== E : Kd(m, E, C, L, ao, se);
  }
  function Kd(m, E, C, L, se, V) {
    ...
    if (Ae && !je)
      return V || (V = new gt()), fe || po(m) ? so(m, E, C, L, se, V) : ep(m, E, Te, C, L, se, V);
    if (!(C & i)) {
  ...
  function Qd(m) {
    return Nr(m) && uo(m.length) && !!G[kr(m)];
  }
  function Zd(m) {
    if (!op(m))
      return Ed(m);
  ...
  function ep(m, E, C, L, se, V, fe) {
    switch (C) {
      ...
      case U:
        return !(m.byteLength != E.byteLength || !V(new eo(m), new eo(E)));
      case c:
      case u:
      case T:
        return lo(+m, +E);
  ...
  function tp(m, E, C, L, se, V) {
    var fe = C & i, ye = oo(m), Te = ye.length, oe = oo(E), je = oe.length;
    if (Te != je && !fe)
      return !1;
    for (var Ve = Te; Ve--; ) {
      var Ae = ye[Ve];
    ...
    for (var xt = fe; ++Ve < Te; ) {
      ...
      var ct = m[Ae], Mt = E[Ae];
      if (L)
        var ho = fe ? L(Mt, ct, Ae, E, m, V) : L(ct, Mt, Ae, m, E, V);
      if (!(ho === void 0 ? ct === Mt || se(ct, Mt, C, L, V) : ho)) {
        qe = !1;
        break;
      }
  ...
  var np = ro ? function(m) {
    return m == null ? [] : (m = Object(m), Se(ro(m), function(E) {
      return to.call(m, E);
    }));
  } : pp, yt = kr;
  ...
  var cp = io(/* @__PURE__ */ function() {
    return arguments;
  }()) ? io : function(m) {
    return Nr(m) && tt.call(m, "callee") && !to.call(m, "callee");
  }, Dn = Array.isArray;
  function up(m) {
    return m != null && uo(m.length) && !co(m);
  }
  var aa = wd || hp;
  function fp(m, E) {
    return ao(m, E);
...
const XE = un, WE = Pt, Ol = qE, zt = kt, Xr = ce;
class VE {
  constructor(t) {
...
js.getAppCacheDir = QE;
const Sa = ce, JE = Si;
function QE() {
  const e = (0, JE.homedir)();
  let t;
  return process.platform === "win32" ? t = process.env.LOCALAPPDATA || Sa.join(e, "AppData", "Local") : process.platform === "darwin" ? t = Sa.join(e, "Library", "Caches") : t = process.env.XDG_CACHE_HOME || Sa.join(e, ".cache"), t;
}
...
var xn = {}, Xe = {}, tv = "[object Symbol]", Of = /[\\^$.*+?()[\]{}|]/g, rv = RegExp(Of.source), nv = typeof Pe == "object" && Pe && Pe.Object === Object && Pe, iv = typeof self == "object" && self && self.Object === Object && self, av = nv || iv || Function("return this")(), sv = Object.prototype, ov = sv.toString, kl = av.Symbol, Nl = kl ? kl.prototype : void 0, Fl = Nl ? Nl.toString : void 0;
function lv(e) {
  if (typeof e == "string")
    return e;
  if (uv(e))
...
function yv(e, t, r) {
  const n = es(`${e.pathname}.blockmap`, e);
  return [es(`${e.pathname.replace(new RegExp(hv(r), "g"), t)}.blockmap`, e), n];
}
var me = {};
...
const Ll = Ee, Aa = Xe, Ia = me;
class _v extends Ia.Provider {
  constructor(t, r, n) {
    super(n), this.configuration = t, this.updater = r, this.baseUrl = (0, Aa.newBaseUrl)(this.configuration.url);
  }
  get channel() {
  ...
  async getLatestVersion() {
    const t = (0, Aa.getChannelFilename)(this.channel), r = (0, Aa.newUrlFromBase)(t, this.baseUrl, this.updater.isAddNoCacheQuery);
    for (let n = 0; ; n++)
      try {
...
class bv extends Ra.Provider {
  ...
  async getLatestVersion() {
    const t = new Ul.CancellationToken(), r = (0, Ca.getChannelFilename)(this.getCustomChannelName(this.channel)), n = (0, Ca.newUrlFromBase)(r, this.baseUrl, this.updater.isAddNoCacheQuery);
    try {
...
Gi.BitbucketProvider = bv;
var Ot = {};
Object.defineProperty(Ot, "__esModule", { value: !0 });
Ot.GitHubProvider = Ot.BaseGitHubProvider = void 0;
Ot.computeReleaseNotes = Ff;
const ft = Ee, hr = Rf, Sv = br, mr = Xe, ts = me, Da = /\/tag\/([^/]+)$/;
class Nf extends ts.Provider {
  constructor(t, r, n) {
    super({
      ...n,
...
${o}`, "ERR_UPDATER_INVALID_RELEASE_FEED");
    ...
    const x = (0, ts.parseUpdateInfo)(u, p, g);
  ...
  resolveFiles(t) {
    return (0, ts.resolveFiles)(t, this.baseUrl, (r) => this.getBaseDownloadPath(t.tag, r.replace(/ /g, "-")));
  }
...
const Bl = Ee, Oa = Xe, Pa = me;
class Iv extends Pa.Provider {
  constructor(t, r, n) {
    super({
      ...n,
      isUseMultipleRangeRequest: !1
  ...
  async getLatestVersion() {
    const t = new Bl.CancellationToken(), r = (0, Oa.getChannelFilename)(this.getCustomChannelName(this.channel)), n = (0, Oa.newUrlFromBase)(r, this.baseUrl, this.updater.isAddNoCacheQuery);
    try {
...
zi.KeygenProvider = Iv;
var Hi = {};
Object.defineProperty(Hi, "__esModule", { value: !0 });
Hi.PrivateGitHubProvider = void 0;
const sr = Ee, Cv = be, Rv = ce, jl = br, Gl = Xe, Dv = Ot, Ov = me;
...
Hi.PrivateGitHubProvider = Pv;
Object.defineProperty(ji, "__esModule", { value: !0 });
ji.isUrlProbablySupportMultiRangeRequests = $f;
ji.createClient = Lv;
const Xn = Ee, kv = Gi, zl = xn, Nv = Ot, Fv = zi, $v = Hi;
function $f(e) {
...
function Uv(e, t, r) {
  ...
  for (let x = 0; x < c.checksums.length; w += c.sizes[x], x++) {
    ...
    _ != null && g.get(b) !== T && (r.warn(`Checksum ("${b}") matches, but size differs (old: ${g.get(b)}, new: ${T})`), _ = void 0), _ === void 0 ? (u++, a != null && a.kind === Wt.DOWNLOAD && a.end === w ? a.end += T : (a = {
      ...
      // oldBlocks: null,
    }, Hl(a, o, b, x))) : a != null && a.kind === Wt.COPY && a.end === _ ? a.end += T : (a = {
      kind: Wt.COPY,
      start: _,
      end: _ + T
      // oldBlocks: [checksum]
...
Rr.copyData = Lf;
const Wn = Ee, jv = Pt, Gv = cn, zv = rr, Xl = Buffer.from(`\r
\r
`);
var vt;
(function(e) {
  ...
  copyExistingData(t, r) {
    return new Promise((n, i) => {
      const a = () => {
        ...
        if (s.kind !== zv.OperationKind.COPY) {
...
Xi.executeTasksUsingMultipleRangeRequests = qv;
Xi.checkIsRangesSupported = ns;
const rs = Ee, Wl = Rr, Vl = rr;
...
function Xv(e, t, r, n, i) {
  ...
  const c = e.httpExecutor.createRequest(d, (u) => {
    if (!ns(u, i))
      return;
    const p = (0, rs.safeGetHeader)(u, "content-type"), g = /^multipart\/.+?(?:; boundary=(?:(?:"(.+)")|(?:([^\s]+))))$/i.exec(p);
    if (g == null) {
      i(new Error(`Content-Type "multipart/byteranges" is expected, but got "${p}"`));
      return;
    }
    const w = new Wl.DataSplitter(r, t, o, g[1] || g[2], l, n);
...
Wi.ProgressDifferentialDownloadCallbackTransform = Vv;
Object.defineProperty(wn, "__esModule", { value: !0 });
wn.DifferentialDownloader = void 0;
const Ur = Ee, ka = kt, Yv = Pt, Kv = Rr, Jv = br, Vn = rr, Yl = Xi, Qv = Wi;
class Zv {
  ...
  async doDownloadFile(t, r) {
    ...
    await new Promise((s, o) => {
      ...
      if (this.options.isUseMultipleRangeRequest) {
        g = (0, Yl.executeTasksUsingMultipleRangeRequests)(this, t, p, n, o), g(0);
        return;
      }
      let w = 0, x = null;
      ...
      T.redirect = "manual", g = (b) => {
        ...
        if (D.kind === Vn.OperationKind.COPY) {
          d && d.beginFileCopy(), (0, Kv.copyData)(D, p, n, o, () => g(b));
          return;
        }
        ...
        H.on("redirect", (q, te, y) => {
          this.logger.info(`Redirect to ${eT(y)}`), x = y, (0, Ur.configureRequestUrl)(new Jv.URL(x), T), H.followRedirect();
...
qi.GenericDifferentialDownloader = rT;
var Nt = {};
(function(e) {
...
const De = Ee, nT = un, iT = Si, aT = Cc, or = kt, sT = be, Na = Ni, Bt = ce, Ht = Rf, Jl = yn, oT = Bi, Ql = Df, lT = xn, Fa = ji, cT = Dc, uT = Xe, fT = qi, lr = Nt;
class Gs extends aT.EventEmitter {
  ...
  setFeedURL(t) {
    ...
    typeof t == "string" ? n = new lT.GenericProvider({ provider: "generic", url: t }, this, {
      ...r,
      isUseMultipleRangeRequest: (0, Fa.isUrlProbablySupportMultiRangeRequests)(t)
    }) : n = (0, Fa.createClient)(t, this, r), this.clientPromise = Promise.resolve(n);
  }
  /**
  ...
  async getUpdateInfoAndProvider() {
    await this.app.whenReady(), this.clientPromise == null && (this.clientPromise = this.configOnDisk.value.then((n) => (0, Fa.createClient)(n, this, this.createProviderRuntimeOptions())));
  ...
  async executeDownload(t) {
    ...
    })), b = await (0, Jl.createTempUpdateFile)(`temp-${c}`, d, w);
    try {
...
const ec = Ee, tc = bi, wT = kt, ET = Pt, Mr = ce, vT = ht, TT = En, _T = me, rc = Nt;
  ...
  doDownloadUpdate(t) {
    ...
    return this.executeDownload({
      ...
      task: async (i, a) => {
        ...
        (t.disableDifferentialDownload || await this.downloadDifferential(n, s, i, r, t)) && await this.httpExecutor.download(n.url, i, a), await (0, wT.chmod)(i, 493);
      }
    });
  }
...
const sc = Ee, $a = kt, NT = Pt, oc = ce, FT = Tp, $T = It, LT = me, lc = bi, cc = un;
class UT extends $T.AppUpdater {
  ...
  async doDownloadUpdate(t) {
    ...
    return this.executeDownload({
      ...
      downloadUpdateOptions: t,
      task: async (u, p) => {
        const g = oc.join(this.downloadedUpdateHelper.cacheDir, c), w = () => (0, $a.pathExistsSync)(g) ? !t.disableDifferentialDownload : (n.info("Unable to locate previous update.zip for differential download (is this first install?), falling back to full download"), !1);
        let x = !0;
        ...
        if (!t.disableDifferentialDownload)
          try {
            ...
            await (0, $a.copyFile)(u.downloadedFile, p);
          } catch (p) {
  ...
  async updateDownloaded(t, r) {
    var n;
    const i = r.downloadedFile, a = (n = t.info.size) !== null && n !== void 0 ? n : (await (0, $a.stat)(i)).size, s = this._logger, o = `fileToProxy=${t.url.href}`;
...
zs.verifySignature = BT;
const uc = Ee, Bf = bi, MT = Si, fc = ce;
function BT(e, t, r) {
  return new Promise((n, i) => {
    const a = t.replace(/'/g, "''");
    r.info(`Verifying signature ${a}`), (0, Bf.execFile)('set "PSModulePath=" & chcp 65001 >NUL & powershell.exe', ["-NoProfile", "-NonInteractive", "-InputFormat", "None", "-Command", `"Get-AuthenticodeSignature -LiteralPath '${a}' | ConvertTo-Json -Compress"`], {
      ...
      try {
        ...
        if (c.Status === 0) {
          try {
            const w = fc.normalize(c.Path), x = fc.normalize(t);
            if (r.info(`LiteralPath: ${w}. Update Path: ${x}`), w !== x) {
              La(r, new Error(`LiteralPath of ${w} is different than ${x}`), l, i), n(null);
              return;
            }
          } catch (w) {
...
const Yn = Ee, dc = ce, zT = ht, HT = En, pc = Nt, qT = me, XT = kt, WT = zs, hc = br;
  ...
  async differentialDownloadWebPackage(t, r, n, i) {
    ...
    try {
      const a = {
        ...
        oldFile: dc.join(this.downloadedUpdateHelper.cacheDir, Yn.CURRENT_APP_PACKAGE_FILE_NAME),
        logger: this._logger,
        newFile: n,
...
class Hs extends Vi {
  ...
  static async fromFile(t) {
    ...
    return new Hs(r, { fileInfo: { path: t, size: n.size } });
  }
  constructor(t, r) {
...
for (const [e, t] of Object.entries(as))
  ;
...
function d_(e) {
  let t = "";
  for (const r of e)
    r >= 128 && r <= 159 && as[r] ? t += as[r] : t += String.fromCharCode(r);
  return t;
}
function W(e) {
...
const rt = Ir("tokenizer:inflate"), Ua = 256 * 1024, N_ = Wf(yr.DataDescriptor), Kn = Wf(yr.EndOfCentralDirectory);
class qs {
  constructor(t) {
    this.tokenizer = t, this.syncBuffer = new Uint8Array(Ua);
  }
  async isZip() {
  ...
  async unzip(t) {
    ...
    do {
      ...
      if (await this.tokenizer.ignore(i.extraFieldLength), i.dataDescriptor && i.compressedSize === 0) {
        ...
        rt(`Found data-descriptor-signature at pos=${this.tokenizer.position}`), a.handler && await this.inflate(i, $_(o), a.handler);
      } else
      ...
      if (rt(`Reading data-descriptor at pos=${this.tokenizer.position}`), i.dataDescriptor && (await this.tokenizer.readToken(gc)).signature !== 134695760)
  ...
  async inflate(t, r, n) {
    ...
    const i = await qs.decompressDeflateRaw(r);
    return n(i);
  }
...
class K_ {
  constructor(t) {
    ...
    ut(this, "detectConfident", async (t) => {
      if (this.buffer = new Uint8Array(Ma), t.fileInfo.size === void 0 && (t.fileInfo.size = Number.MAX_SAFE_INTEGER), this.tokenizer = t, await t.peekBuffer(this.buffer, { length: 32, mayBeLess: !0 }), this.check([66, 77]))
        return {
          ext: "bmp",
          mime: "image/bmp"
        };
              ...
              return {
                async handler(i) {
                  ...
                  if (s === -1) {
                    ...
                    a.includes(`ContentType="${o}"`) && (r = Ba(o));
                  } else {
...
`, { offset: 2, encoding: r }) ? {
    ...
    ut(this, "detectImprecise", async (t) => {
      if (this.buffer = new Uint8Array(Ma), await t.peekBuffer(this.buffer, { length: Math.min(8, t.fileInfo.size), mayBeLess: !0 }), this.check([0, 0, 1, 186]) || this.check([0, 0, 1, 179]))
        return {
          ext: "mpg",
          mime: "video/mpeg"
        };
  ...
  async fromBuffer(t) {
    ...
    if ((r == null ? void 0 : r.length) > 1)
      return this.fromTokenizer(is(r, this.tokenizerOptions));
  }
  async fromBlob(t) {
 ...
 * MIT Licensed
 */
var xc = /; *([!#$%&'*+.^_`|~0-9A-Za-z-]+) *= *("(?:[\u000b\u0020\u0021\u0023-\u005b\u005d-\u007e\u0080-\u00ff]|\\[\u000b\u0020-\u00ff])*"|[!#$%&'*+.^_`|~0-9A-Za-z-]+) */g, J_ = /^[\u000b\u0020-\u007e\u0080-\u00ff]+$/, Yf = /^[!#$%&'*+.^_`|~0-9A-Za-z-]+$/, Q_ = /\\([\u000b\u0020-\u00ff])/g, Z_ = /([\\"])/g, Kf = /^[!#$%&'*+.^_`|~0-9A-Za-z-]+\/[!#$%&'*+.^_`|~0-9A-Za-z-]+$/;
Xs.format = eb;
Xs.parse = tb;
function eb(e) {
...
class Ws extends vn("FieldDecodingError") {
}
...
function pb(e) {
  const t = e.length;
  if (t & 1)
    throw new Ws("Buffer length must be even");
  for (let r = 0; r < t; r += 2) {
    const n = e[r];
    e[r] = e[r + 1], e[r + 1] = n;
  }
...
function ls(e, t) {
  if (e[0] === 255 && e[1] === 254)
    return ls(e.subarray(2), t);
  if (t === "utf-16le" && e[0] === 254 && e[1] === 255) {
    if (e.length & 1)
      throw new Ws("Expected even number of octets for 16-bit unicode string");
    return ls(pb(e), t);
  }
  ...
  postMap(t, r) {
    switch (t.id) {
      case "UFID":
        {
          const n = t.value;
          n.owner_identifier === "http://musicbrainz.org" && (t.id += `:${n.owner_identifier}`, t.value = ls(n.identifier, "latin1"));
        }
        break;
      case "PRIV":
        {
  ...
  postMap(t) {
    switch (t.id) {
      case "WM/SharedUserRating": {
        const r = t.id.split(":");
        t.value = Ys.toRating(t.value), t.id = r[0];
        break;
      }
    }
  }
...
const cs = /\[(\d{2}):(\d{2})\.(\d{2,3})]/;
function jb(e) {
  return cs.test(e) ? zb(e) : Gb(e);
}
function Gb(e) {
  return {
...
`), r = [];
  for (const n of t) {
    const i = n.match(cs);
    if (i) {
      const a = Number.parseInt(i[1], 10), s = Number.parseInt(i[2], 10), o = i[3].length === 3 ? Number.parseInt(i[3], 10) : Number.parseInt(i[3], 10) * 10, l = (a * 60 + s) * 1e3 + o, d = n.replace(cs, "").trim();
...
const Wb = {
  ...
  async load() {
    return (await import("./MpegParser-BNlp8eTj.js")).MpegParser;
  }
}, Vb = {
  parserType: "apev2",
  extensions: [".ape"],
  ...
  async load() {
    return (await import("./AsfParser-CWnb89PW.js")).AsfParser;
  }
}, Kb = {
  parserType: "dsdiff",
  extensions: [".dff"],
  ...
  async load() {
    return (await import("./DsdiffParser-BSpuv7Lb.js")).DsdiffParser;
  }
}, Jb = {
  parserType: "aiff",
  ...
  async load() {
    return (await import("./AiffParser-CeCmxqbX.js")).AIFFParser;
  }
}, Qb = {
  parserType: "dsf",
  extensions: [".dsf"],
  mimeTypes: ["audio/dsf"],
  async load() {
    return (await import("./DsfParser-BRFLVkRW.js")).DsfParser;
  }
}, Zb = {
  parserType: "flac",
  extensions: [".flac"],
  ...
  async load() {
    return (await import("./FlacParser-asfRC1mj.js").then((e) => e.d)).FlacParser;
  }
}, eS = {
  parserType: "matroska",
  ...
  async load() {
    return (await import("./MatroskaParser-BrujjJvo.js")).MatroskaParser;
  }
}, tS = {
  parserType: "mp4",
  ...
  async load() {
    return (await import("./MP4Parser-CWguQ-v0.js")).MP4Parser;
  }
}, rS = {
  parserType: "musepack",
  extensions: [".mpc"],
  ...
  async load() {
    return (await import("./MusepackParser-epUY9ECf.js")).MusepackParser;
  }
}, nS = {
  parserType: "ogg",
  ...
  async load() {
    return (await import("./OggParser-BPc2nT6-.js")).OggParser;
  }
}, iS = {
  parserType: "wavpack",
  extensions: [".wv", ".wvp"],
  ...
  async load() {
    return (await import("./WavPackParser-BPmrQ7O6.js")).WavPackParser;
  }
}, aS = {
  parserType: "riff",
  ...
  async load() {
    return (await import("./WaveParser-BGOfao_H.js")).WaveParser;
  }
}, Gt = Ir("music-metadata:parser:factory");
function sS(e) {
  const t = Xs.parse(e), r = sb(t.type);
  return {
    type: r.type,
    subtype: r.subtype,
    suffix: r.suffix,
...
const TS = /^[\x21-\x7e©][\x20-\x7e\x00()]{3}/, sd = {
  ...
  get: (e, t) => {
    ...
    if (!r.match(TS))
      throw new Ws(`FourCC contains invalid characters: ${hb(r)} "${r}"`);
    return r;
  },
  put: (e, t, r) => {
    const n = fS(r, "latin1");
...
class At extends nd {
  ...
  static parseTagFooter(t, r, n) {
    ...
    return is(r), new At(t, is(r), n).parseTags(i);
  }
  /**
  ...
  async parseTags(t) {
    ...
    for (let i = 0; i < t.fields; i++) {
      ...
      const a = await this.tokenizer.readToken(ja);
      n -= ja.len + a.size, await this.tokenizer.peekBuffer(r, { length: Math.min(r.length, n) });
      let s = wc(r, 0, r.length);
      ...
      switch (await this.tokenizer.ignore(1), n -= o.length + 1, a.flags.dataType) {
        ...
        case Zn.binary:
          if (this.options.skipCovers)
            ...
            await this.tokenizer.readBuffer(l), s = wc(l, 0, l.length);
...
}, Symbol.toStringTag, { value: "Module" })), ti = Ir("music-metadata:parser:ID3v1"), bc = [
  "Blues",
  "Classic Rock",
  "Country",
  "Dance",
...
class OS {
  constructor() {
    ...
    }), this.player.on(xo.Playing, () => {
      console.log("[DiscordBot] Audio Player Playing");
    }), this.player.on(xo.Idle, () => {
  ...
  getChannels(t) {
    ...
    return r.channels.cache.filter((i) => i.type === yo.GuildVoice).map((i) => ({
      id: i.id,
      name: i.name,
  ...
  async joinChannel(t, r) {
    ...
    if (!i || i.type !== yo.GuildVoice) throw new Error("Invalid channel");
    try {
  ...
  async playFile(t, r) {
    try {
      if (console.log(`[DiscordBot] Playing file: ${t}`), !r) {
        const o = sa(t);
        this.player.play(o);
        return;
      }
      const { spawn: n } = await import("node:child_process"), a = n(r, [
        "-i",
        t,
        "-f",
        "s16le",
      ...
      a.on("error", (o) => {
        console.error("[DiscordBot] FFmpeg Spawn Error:", o);
      });
      const s = sa(a.stdout, {
        inputType: Ip.Raw
      });
      ...
      console.error("[DiscordBot] Play File Error:", n);
    }
  }
...
let us = cd("ffmpeg-static");
Ke.isPackaged && (us = us.replace("app.asar", "app.asar.unpacked"));
function PS(e) {
...
const fs = process.env.VITE_DEV_SERVER_URL, gA = Oe.join(process.env.APP_ROOT, "dist-electron"), fd = Oe.join(process.env.APP_ROOT, "dist");
process.env.VITE_PUBLIC = fs ? Oe.join(process.env.APP_ROOT, "public") : fd;
let ee;
function dd() {
  ee = new Ac({
    width: 1200,
  ...
  }), fs ? ee.loadURL(fs) : ee.loadFile(Oe.join(fd, "index.html"));
}
...
`).map((l) => {
    ...
    try {
      ...
      const { filePath: c } = await mo.showSaveDialog(ee, {
        title: "下載歌曲",
        defaultPath: `${d}.m4a`,
