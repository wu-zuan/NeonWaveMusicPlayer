...
` ? (f.line++, f.column = 0) : f.column++);
          ...
          case y.PROC_INST_ENDING:
            ...
            continue;
          case y.OPEN_TAG:
            z(b, v) ? f.tagName += v : (F(f), v === ">" ? K(f) : v === "/" ? f.state = y.OPEN_TAG_SLASH : ($(v) || A(f, "Invalid character in tag name"), f.state = y.ATTRIB));
            continue;
          ...
          case y.ATTRIB:
            ...
            continue;
          case y.ATTRIB_NAME:
            v === "=" ? f.state = y.ATTRIB_VALUE : v === ">" ? (A(f, "Attribute without value"), f.attribValue = f.attribName, q(f), K(f)) : $(v) ? f.state = y.ATTRIB_NAME_SAW_WHITE : z(b, v) ? f.attribName += v : A(f, "Invalid attribute name");
            continue;
          ...
          case y.CLOSE_TAG:
            if (f.tagName)
              v === ">" ? X(f) : z(b, v) ? f.tagName += v : f.script ? (f.script += "</" + f.tagName, f.tagName = "", f.state = y.SCRIPT) : ($(v) || A(f, "Invalid tagname in closing tag"), f.state = y.CLOSE_TAG_SAW_WHITE);
            else {
              if ($(v))
                continue;
          ...
          case y.ATTRIB_VALUE_ENTITY_U:
            ...
            } else z(f.entity.length ? N : _, v) ? f.entity += v : (A(f, "Invalid character in entity name"), f[ve] += "&" + f.entity + v, f.entity = "", f.state = fe);
            continue;
          default:
...
function cy(e, t) {
  ...
  for (e.anchor !== null && (e.anchorMap[e.anchor] = o), _ = e.input.charCodeAt(++e.position); _ !== 0; ) {
    ...
    r ? _ === 44 && G(e, "expected the node content, but found ','") : G(e, "missed comma between flow collection entries"), T = w = b = null, u = p = !1, _ === 63 && (d = e.input.charCodeAt(e.position + 1), Be(d) && (u = p = !0, e.position++, pe(e, !0, t))), n = e.line, i = e.lineStart, a = e.position, _r(e, t, gi, !1, !0), T = e.tag, w = e.result, pe(e, !0, t), _ = e.input.charCodeAt(e.position), (p || e.line === n) && _ === 58 && (u = !0, _ = e.input.charCodeAt(++e.position), pe(e, !0, t), _r(e, t, gi, !1, !0), b = e.result), m ? pr(e, o, x, T, w, b, n, i, a) : u ? o.push(pr(e, null, x, T, w, b, n, i, a)) : o.push(w), pe(e, !0, t), _ = e.input.charCodeAt(e.position), _ === 44 ? (r = !0, _ = e.input.charCodeAt(++e.position)) : r = !1;
  }
...
function fy(e, t, r) {
  ...
  for (e.anchor !== null && (e.anchorMap[e.anchor] = u), _ = e.input.charCodeAt(e.position); _ !== 0; ) {
    if (!T && e.firstTabInLine !== -1 && (e.position = e.firstTabInLine, G(e, "tab characters must not be used in indentation")), n = e.input.charCodeAt(e.position + 1), a = e.line, (_ === 63 || _ === 58) && Be(n))
      _ === 63 ? (T && (pr(e, u, p, m, x, null, s, o, l), m = x = w = null), b = !0, T = !0, i = !0) : T ? (T = !1, i = !0) : G(e, "incomplete explicit mapping pair; a key node is missed; or followed by a non-tabulated empty line"), e.position += 1, _ = n;
    else {
      ...
      if (e.line === a) {
        ...
        if (_ === 58)
          _ = e.input.charCodeAt(++e.position), Be(_) || G(e, "a whitespace character is expected after the key-value separator within a block mapping"), T && (pr(e, u, p, m, x, null, s, o, l), m = x = w = null), b = !0, T = !1, i = !1, m = e.tag, x = e.result;
        else if (b)
    ...
    if ((e.line === a || e.lineIndent > t) && (T && (s = e.line, o = e.lineStart, l = e.position), _r(e, t, yi, !0, i) && (T ? x = e.result : w = e.result), T || (pr(e, u, p, m, x, w, s, o, l), m = x = w = null), pe(e, !0, -1), _ = e.input.charCodeAt(e.position)), (e.line === a || e.lineIndent > t) && _ !== 0)
      G(e, "bad indentation of a mapping entry");
    else if (e.lineIndent < t)
      break;
  }
  return T && pr(e, u, p, m, x, null, s, o, l), b && (e.tag = d, e.anchor = c, e.kind = "mapping", e.result = u), b;
}
function dy(e) {
  var t, r = !1, n = !1, i, a, s;
...
function et() {
  ...
  class t {
    ...
    intersects(S, O) {
      ...
      return this.set.some((A) => b(A, O) && S.set.some((F) => b(F, O) && A.every((P) => F.every((q) => P.intersects(q, O)))));
    }
  ...
  const r = Ex, n = new r(), i = Ns, a = Bi(), s = Ui, o = Ue, {
    ...
    tildeTrimReplace: u,
    caretTrimReplace: p
  } = gn, { FLAG_INCLUDE_PRERELEASE: m, FLAG_LOOSE: x } = Li, w = (R) => R.value === "<0.0.0-0", T = (R) => R.value === "", b = (R, S) => {
    let O = !0;
    const A = R.slice();
    let F = A.pop();
    for (; O && A.length; )
    ...
    return O;
  }, _ = (R, S) => (R = R.replace(l[d.BUILD], ""), s("comp", R, S), R = D(R, S), s("caret", R), R = $(R, S), s("tildes", R), R = ae(R, S), s("xrange", R), R = M(R, S), s("stars", R), R), N = (R) => !R || R.toLowerCase() === "x" || R === "*", $ = (R, S) => R.trim().split(/\s+/).map((O) => B(O, S)).join(" "), B = (R, S) => {
...
(function(e, t) {
  ...
  H[Y] = H[R] = H[S] = H[O] = H[A] = H[F] = H[P] = H[q] = H[K] = !0, H[o] = H[l] = H[j] = H[c] = H[U] = H[u] = H[p] = H[m] = H[w] = H[T] = H[_] = H[B] = H[D] = H[z] = H[M] = !1;
  ...
  (ra && yt(new ra(new ArrayBuffer(1))) != U || Or && yt(new Or()) != w || na && yt(na.resolve()) != N || ia && yt(new ia()) != D || aa && yt(new aa()) != M) && (yt = function(g) {
    var E = kr(g), I = E == _ ? g.constructor : void 0, L = I ? Ut(I) : "";
    if (L)
      switch (L) {
        case Td:
          return U;
      ...
      if (this.updater.allowPrerelease) {
        ...
        if (T === null)
          ...
          for (const b of l.getElements("entry")) {
            const _ = Da.exec(b.element("link").attribute("href"));
            if (_ === null)
              continue;
            const N = _[1], $ = ((n = hr.prerelease(N)) === null || n === void 0 ? void 0 : n[0]) || null, B = !T || ["alpha", "beta"].includes(T), D = $ !== null && !["alpha", "beta"].includes(String($));
            if (B && !D && !(T === "beta" && $ === "alpha")) {
              c = N;
              break;
            }
...
class zs extends sT.EventEmitter {
  ...
  async executeDownload(t) {
    ...
    try {
      await t.task(b, n, p, T), await (0, Oe.retry)(() => (0, or.rename)(b, u), 60, 500, 0, 0, (_) => _ instanceof Error && /^EBUSY:/.test(_.message));
    } catch (_) {
      throw await T(), _ instanceof Oe.CancellationError && (x.info("cancelled"), this.emit("update-cancelled", i)), _;
    }
...
ln.NsisUpdater = YT;
(function(e) {
  var t = De && De.__createBinding || (Object.create ? function(T, b, _, N) {
    N === void 0 && (N = _);
...
const Vb = {
  ...
  async load() {
    return (await import("./MpegParser-ZL-HUHFb.js")).MpegParser;
  }
}, Yb = {
  parserType: "apev2",
  extensions: [".ape"],
  ...
  async load() {
    return (await import("./AsfParser-Csgi-ryv.js")).AsfParser;
  }
}, Jb = {
  parserType: "dsdiff",
  extensions: [".dff"],
  ...
  async load() {
    return (await import("./DsdiffParser-QZQb_hb9.js")).DsdiffParser;
  }
}, Qb = {
  parserType: "aiff",
  ...
  async load() {
    return (await import("./AiffParser-CDwGFvdT.js")).AIFFParser;
  }
}, Zb = {
  parserType: "dsf",
  extensions: [".dsf"],
  mimeTypes: ["audio/dsf"],
  async load() {
    return (await import("./DsfParser-BpJMa3fn.js")).DsfParser;
  }
}, eS = {
  parserType: "flac",
  extensions: [".flac"],
  ...
  async load() {
    return (await import("./FlacParser-5SmubKJH.js").then((e) => e.d)).FlacParser;
  }
}, tS = {
  parserType: "matroska",
  ...
  async load() {
    return (await import("./MatroskaParser-C_7LGkHq.js")).MatroskaParser;
  }
}, rS = {
  parserType: "mp4",
  ...
  async load() {
    return (await import("./MP4Parser--qfoXv8f.js")).MP4Parser;
  }
}, nS = {
  parserType: "musepack",
  extensions: [".mpc"],
  ...
  async load() {
    return (await import("./MusepackParser-DrNJHNYA.js")).MusepackParser;
  }
}, iS = {
  parserType: "ogg",
  ...
  async load() {
    return (await import("./OggParser-CXihdlu5.js")).OggParser;
  }
}, aS = {
  parserType: "wavpack",
  extensions: [".wv", ".wvp"],
  ...
  async load() {
    return (await import("./WavPackParser-DhBZSc1B.js")).WavPackParser;
  }
}, sS = {
  parserType: "riff",
  ...
  async load() {
    return (await import("./WaveParser-B5XsCK5v.js")).WaveParser;
  }
...
`).map((d) => {
    ...
    try {
      ...
      let d = 0;
      l.heatmap && l.heatmap.length > 0 ? d = [...l.heatmap].sort((x, w) => w.value - x.value)[0].start_time : l.duration && (d = Math.floor(l.duration / 3));
      const c = l.formats || [], u = c.filter((m) => m.acodec !== "none" && m.vcodec === "none");
      let p = "";
      return u.length > 0 ? (u.sort((m, x) => (x.tbr || 0) - (m.tbr || 0)), p = u[0].url) : (c.sort((m, x) => (x.tbr || 0) - (m.tbr || 0)), c.length > 0 && (p = c[0].url)), {
        url: p,
        startTime: d
      };
    } catch (s) {
