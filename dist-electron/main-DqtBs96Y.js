...
var ia = (e, t, r) => up(e, typeof t != "symbol" ? t + "" : t, r);
import Kt, { app as Ke, BrowserWindow as vc, Notification as fp, ipcMain as je, dialog as po } from "electron";
import { createRequire as Ba } from "node:module";
import { fileURLToPath as dp } from "node:url";
import Se from "node:path";
import Nr, { open as pp } from "node:fs/promises";
import Dt from "fs";
...
import Sc from "zlib";
import gp from "http";
import { execFile as yp, exec as xp } from "node:child_process";
...
var xt = hp, Ep = process.cwd, ri = null, vp = process.env.GRACEFUL_FS_PLATFORM || process.platform;
...
ps.makeDir = async (e, t) => (Rc(e), Cc.mkdir(e, {
  mode: Oc(t),
  recursive: !0
}));
ps.makeDirSync = (e, t) => (Rc(e), Cc.mkdirSync(e, {
  mode: Oc(t),
  recursive: !0
}));
const Fp = ke.fromPromise, { makeDir: $p, makeDirSync: aa } = ps, sa = Fp($p);
var ot = {
  mkdirs: sa,
  mkdirsSync: aa,
  // alias
...
function kc(e, t, r, n, i) {
  ...
  wr.stat(s, { bigint: !0 }, (o, l) => o ? o.code === "ENOENT" ? i() : i(o) : fn(t, l) ? i(new Error(bi(e, r, n))) : kc(e, t, s, n, i));
}
function Nc(e, t, r, n) {
...
const Le = Ne, Wr = oe, Xp = ot.mkdirs, Wp = er.pathExists, Vp = Pc.utimesMillis, Vr = br;
function Yp(e, t, r, n) {
  typeof r == "function" && !n ? (n = r, r = {}) : typeof r == "function" && (r = { filter: r }), n = n || function() {
    ...
    Vr.checkParentPaths(e, s, t, "copy", (l) => l ? n(l) : r.filter ? Fc(yo, o, e, t, r, n) : yo(o, e, t, r, n));
  });
}
...
function Kp(e, t, r, n, i) {
  return n.filter ? Fc(li, e, t, r, n, i) : li(e, t, r, n, i);
}
...
function Jp(e, t, r, n, i, a) {
  return t ? Qp(e, r, n, i, a) : $c(e, r, n, i, a);
}
...
function nh(e, t, r, n, i, a) {
  return t ? Lc(r, n, i, a) : ih(e.mode, r, n, i, a);
}
function ih(e, t, r, n, i) {
  Le.mkdir(r, (a) => {
    if (a) return i(a);
    Lc(t, r, n, (s) => s ? i(s) : Si(r, e, i));
  });
}
function Lc(e, t, r, n) {
...
function ah(e, t, r, n, i, a) {
  ...
  Vr.checkPaths(s, o, "copy", i, (l, d) => {
    if (l) return a(l);
    const { destStat: c } = d;
    Kp(c, s, o, i, (u) => u ? a(u) : Uc(e, r, n, i, a));
  });
}
...
var lh = Yp;
const Ae = Ne, Yr = oe, ch = ot.mkdirsSync, uh = Pc.utimesMillisSync, Kr = br;
function fh(e, t, r) {
...
function dh(e, t, r, n) {
  ...
  return Ae.existsSync(i) || ch(i), Mc(e, t, r, n);
}
function ph(e, t, r, n) {
...
function hh(e, t, r, n, i) {
  return t ? mh(e, r, n, i) : Bc(e, r, n, i);
}
function mh(e, t, r, n) {
  if (n.overwrite)
    return Ae.unlinkSync(r), Bc(e, t, r, n);
  if (n.errorOnExist)
...
function Eh(e, t, r, n, i) {
  return t ? jc(r, n, i) : vh(e.mode, r, n, i);
}
function vh(e, t, r, n) {
  return Ae.mkdirSync(r), jc(t, r, n), ms(r, e);
}
function jc(e, t, r) {
...
const wo = Ne, zc = oe, ee = Tc, Jr = process.platform === "win32";
function Gc(e) {
  [
    "unlink",
    "chmod",
...
function Ch(e, t) {
  if (ee(e), ee(t), t.readdirSync(e).forEach((r) => Hc(zc.join(e, r), t)), Jr) {
    const r = Date.now();
    do
      try {
...
var Rh = ys;
ys.sync = Hc;
const ci = Ne, Oh = ke.fromCallback, qc = Rh;
function Dh(e, t) {
...
const kh = ke.fromPromise, Xc = Zt, Wc = oe, Vc = ot, Yc = Ai, _o = kh(async function(t) {
  let r;
  try {
...
const Fh = ke.fromCallback, Kc = oe, Tt = Ne, Jc = ot;
function $h(e, t) {
  function r() {
    Tt.writeFile(e, "", (n) => {
      if (n) return t(n);
...
const Mh = ke.fromCallback, Qc = oe, vt = Ne, Zc = ot, Bh = er.pathExists, { areIdentical: eu } = br;
function jh(e, t, r) {
  function n(i, a) {
    vt.link(i, a, (s) => {
      if (s) return r(s);
...
const Jh = ke.fromCallback, ru = oe, Ye = Zt, nu = ot, Qh = nu.mkdirs, Zh = nu.mkdirsSync, iu = Wh, em = iu.symlinkPaths, tm = iu.symlinkPathsSync, au = Kh, rm = au.symlinkType, nm = au.symlinkTypeSync, im = er.pathExists, { areIdentical: su } = br;
function am(e, t, r, n) {
...
const Ii = ke, { stringify: ou, stripBom: lu } = xs;
...
const wm = ke.fromCallback, Hr = Ne, cu = oe, uu = ot, Em = er.pathExists;
function vm(e, t, r, n) {
...
function Tm(e, ...t) {
  ...
  uu.mkdirsSync(r), Hr.writeFileSync(e, ...t);
}
var ws = {
  outputFile: wm(vm),
  outputFileSync: Tm
...
var Pm = Pe;
const km = Ne, ja = oe, Nm = gs.copy, fu = Ai.remove, Fm = ot.mkdirp, $m = er.pathExists, Po = br;
function Lm(e, t, r, n) {
...
function ko(e, t, r, n, i) {
  ...
  $m(t, (a, s) => a ? i(a) : s ? i(new Error("dest already exists.")) : oa(e, t, r, i));
}
function oa(e, t, r, n) {
...
var Bm = Lm;
const du = Ne, za = oe, jm = gs.copySync, pu = Ai.removeSync, zm = ot.mkdirpSync, No = br;
function Gm(e, t, r) {
  r = r || {};
...
var De = {}, Ha = { exports: {} }, $n = { exports: {} }, ca, Fo;
function Zm() {
  if (Fo) return ca;
  Fo = 1;
...
function r0() {
  if (Mo) return da;
  Mo = 1;
  const e = _i, t = bc, r = t0(), { env: n } = process;
  let i;
...
const s0 = un, o0 = mu, l0 = Dt, c0 = cn, gu = _r, u0 = It, jo = Sr, f0 = dn, Fr = (0, o0.default)("electron-builder");
...
const vu = un, Tu = Sr, _0 = "options.name must be either a string or a Buffer", zo = (0, vu.randomBytes)(16);
zo[0] = zo[0] | 1;
const ai = {}, V = [];
for (let e = 0; e < 256; e++) {
...
function b0(e, t, r, n, i = qr.ASCII) {
  ...
  if (typeof e != "string" && !Buffer.isBuffer(e))
    throw (0, Tu.newError)(_0, "ERR_INVALID_UUID_NAME");
    ...
    function X(h, f) {
      if (h.opt.xmlns) {
        ...
        for (var re = 0, le = h.attribList.length; re < le; re++) {
          var we = h.attribList[re], _e = we[0], ht = we[1], de = O(_e, !0), We = de.prefix, Ki = de.local, _n = We === "" ? "" : S.ns[We] || "", Rr = {
            name: _e,
            value: ht,
            prefix: We,
            local: Ki,
...
var Iu = Wa, z0 = Fe, Cu = new z0("tag:yaml.org,2002:str", {
  kind: "scalar",
  construct: function(e) {
    return e !== null ? e : "";
  }
}), G0 = Fe, Ru = new G0("tag:yaml.org,2002:seq", {
  kind: "sequence",
  construct: function(e) {
    return e !== null ? e : [];
  }
}), H0 = Fe, Ou = new H0("tag:yaml.org,2002:map", {
  kind: "mapping",
  construct: function(e) {
    return e !== null ? e : {};
  }
...
var Pu = new X0("tag:yaml.org,2002:null", {
  kind: "scalar",
  resolve: W0,
  construct: V0,
  predicate: Y0,
...
var ku = new K0("tag:yaml.org,2002:bool", {
  kind: "scalar",
  resolve: J0,
  construct: Q0,
  predicate: Z0,
...
var Nu = new tg("tag:yaml.org,2002:int", {
  kind: "scalar",
  resolve: ag,
  construct: sg,
  predicate: og,
...
var ju = new mg("tag:yaml.org,2002:timestamp", {
  kind: "scalar",
  resolve: gg,
  construct: yg,
  instanceOf: Date,
...
var zu = new wg("tag:yaml.org,2002:merge", {
  kind: "scalar",
  resolve: Eg
...
var Gu = new vg("tag:yaml.org,2002:binary", {
  kind: "scalar",
  resolve: Tg,
  construct: _g,
  predicate: Sg,
...
var Hu = new Ag("tag:yaml.org,2002:omap", {
  kind: "sequence",
  resolve: Rg,
  construct: Og
...
var qu = new Dg("tag:yaml.org,2002:pairs", {
  kind: "sequence",
  resolve: kg,
  construct: Ng
...
var Xu = new Fg("tag:yaml.org,2002:set", {
  kind: "mapping",
  resolve: Lg,
  construct: Ug
}), As = Uu.extend({
...
}), Ht = Je, Wu = hn, Mg = $0, Bg = As, Ct = Object.prototype.hasOwnProperty, pi = 1, Vu = 2, Yu = 3, hi = 4, ga = 1, jg = 2, Wo = 3, zg = /[\x00-\x08\x0B\x0C\x0E-\x1F\x7F-\x84\x86-\x9F\uFFFE\uFFFF]|[\uD800-\uDBFF](?![\uDC00-\uDFFF])|(?:[^\uD800-\uDBFF]|^)[\uDC00-\uDFFF]/, Gg = /[\x85\u2028\u2029]/, Hg = /[,\[\]\{\}]/, Ku = /^(?:!|!!|![a-z\-]+!)$/i, Ju = /^(?:!|[^,\[\]\{\}])(?:%[0-9a-f]{2}|[0-9a-z\-#;\/\?:@&=\+\$,_\.!~\*'\(\)\[\]])*$/i;
function Vo(e) {
...
function tf(e, t) {
  ...
  return r.snippet = Mg(r), new Wu(t, r);
}
function L(e, t) {
  throw tf(e, t);
}
...
function ey(e, t) {
  ...
  for (e.kind = "scalar", e.result = ""; u !== 0; )
    if (u = e.input.charCodeAt(++e.position), u === 43 || u === 45)
      ga === i ? i = u === 43 ? Wo : jg : L(e, "repeat of a chomping mode identifier");
    else if ((c = Wg(u)) >= 0)
...
bs.loadAll = sy;
bs.load = oy;
var nf = {}, Di = Je, mn = hn, ly = As, af = Object.prototype.toString, sf = Object.prototype.hasOwnProperty, Rs = 65279, cy = 9, Zr = 10, uy = 13, fy = 32, dy = 33, py = 34, Va = 35, hy = 37, my = 38, gy = 39, yy = 42, of = 44, xy = 45, gi = 58, wy = 61, Ey = 62, vy = 63, Ty = 64, lf = 91, cf = 93, _y = 96, uf = 123, by = 124, ff = 125, Ce = {};
Ce[0] = "\\0";
Ce[7] = "\\a";
Ce[8] = "\\b";
Ce[9] = "\\t";
...
function tl(e, t, r) {
  ...
  return (
    ...
    (r ? (
      // c = flow-in
      n
    ) : n && e !== of && e !== lf && e !== cf && e !== uf && e !== ff) && e !== Va && !(t === gi && !i) || el(t) && !yi(t) && e === Va || t === gi && i
  );
}
function Py(e) {
  return tn(e) && e !== Rs && !yi(e) && e !== xy && e !== vy && e !== gi && e !== of && e !== lf && e !== cf && e !== uf && e !== ff && e !== Va && e !== my && e !== yy && e !== dy && e !== by && e !== wy && e !== Ey && e !== gy && e !== py && e !== hy && e !== Ty && e !== _y;
}
function ky(e) {
  return !yi(e) && e !== gi;
}
...
function Ny(e, t, r, n, i, a, s, o) {
  ...
  return !u && !p ? x && !s && !i(e) ? pf : a === en ? ur : Ka : r > 9 && df(e) ? ur : s ? a === en ? ur : Ka : p ? mf : hf;
}
...
Pi.Lazy = Hy;
var Qa = { exports: {} };
const qy = "2.0.0", yf = 256, Xy = Number.MAX_SAFE_INTEGER || /* istanbul ignore next */
9007199254740991, Wy = 16, Vy = yf - 6, Yy = [
  "major",
  "premajor",
  "minor",
  "preminor",
...
const Mn = Ni, { MAX_LENGTH: ll, MAX_SAFE_INTEGER: Bn } = ki, { safeRe: jn, t: zn } = gn, tx = Ds, { compareIdentifiers: ya } = wf;
let rx = class it {
  constructor(t, r) {
...
var Fs = Jx;
const Qx = Ef, Zx = vf, ew = Fi, tw = Ns, rw = ks, nw = Fs, iw = (e, t, r, n) => {
  switch (t) {
    case "===":
...
function $i() {
  ...
  wa = t;
  const r = Ds, { safeRe: n, t: i } = gn, a = Tf, s = Ni, o = $e, l = Ze();
  return wa;
}
...
var Rw = Cw;
const Ow = $e, _f = $i(), { ANY: Dw } = _f, Pw = Ze(), kw = Li, yl = Fi, xl = ks, Nw = Fs, Fw = Ns, $w = (e, t, r, n) => {
  ...
  for (let d = 0; d < t.set.length; ++d) {
    ...
    let u = null, p = null;
    if (c.forEach((m) => {
      m.semver === Dw && (m = new _f(">=0.0.0")), u = u || m, p = p || m, i(m.semver, u.semver, n) ? u = m : s(m.semver, p.semver, n) && (p = m);
...
const El = Ze(), Ls = $i(), { ANY: va } = Ls, Lr = Li, Us = Qe, Vw = (e, t, r = {}) => {
  if (e === t)
    return !0;
...
var Jw = Vw;
const Ta = gn, bl = ki, Qw = $e, Sl = wf, Zw = Ir, eE = sx, tE = cx, rE = fx, nE = px, iE = gx, aE = wx, sE = Tx, oE = Sx, lE = Qe, cE = Rx, uE = Px, fE = Ps, dE = $x, pE = Mx, hE = Fi, mE = ks, gE = Ef, yE = vf, xE = Ns, wE = Fs, EE = Tf, vE = lw, TE = $i(), _E = Ze(), bE = Li, SE = mw, AE = ww, IE = _w, CE = Aw, RE = Rw, OE = $s, DE = Mw, PE = zw, kE = Hw, NE = Ww, FE = Jw;
var bf = {
  parse: Zw,
  valid: eE,
  clean: tE,
...
(function(e, t) {
  ...
  var cd = Array.prototype, ud = Function.prototype, Sn = Object.prototype, Ji = f["__core-js_shared__"], Vs = ud.toString, tt = Sn.hasOwnProperty, Ys = function() {
    var g = /[^.]+$/.exec(Ji && Ji.keys && Ji.keys.IE_PROTO || "");
    return g ? "Symbol(src)_1." + g : "";
  }(), Ks = Sn.toString, fd = RegExp(
    "^" + Vs.call(tt).replace(z, "\\$&").replace(/hasOwnProperty|(function).*?(?=\\\()| for .+?(?=\\\])/g, "$1.*?") + "$"
  ), Js = K ? f.Buffer : void 0, An = f.Symbol, Qs = f.Uint8Array, Zs = Sn.propertyIsEnumerable, dd = cd.splice, Nt = An ? An.toStringTag : void 0, eo = Object.getOwnPropertySymbols, pd = Js ? Js.isBuffer : void 0, hd = od(Object.keys, Object), Qi = rr(f, "DataView"), Or = rr(f, "Map"), Zi = rr(f, "Promise"), ea = rr(f, "Set"), ta = rr(f, "WeakMap"), Dr = rr(Object, "create"), md = Lt(Qi), gd = Lt(Or), yd = Lt(Zi), xd = Lt(ea), wd = Lt(ta), to = An ? An.prototype : void 0, ra = to ? to.valueOf : void 0;
  function Ft(g) {
  ...
  function Ad(g) {
    ...
    if (C < 0)
      return !1;
    var F = E.length - 1;
    return C == F ? E.pop() : dd.call(E, C, 1), --this.size, !0;
  }
  function Id(g) {
    var E = this.__data__, C = Cn(E, g);
  ...
  In.prototype.add = In.prototype.push = Fd, In.prototype.has = $d;
  function mt(g) {
  ...
  function zd(g, E) {
    var C = On(g), F = !C && np(g), ne = !C && !F && na(g), H = !C && !F && !ne && uo(g), ce = C || F || ne || H, me = ce ? We(g.length, String) : [], Ee = me.length;
    for (var ae in g)
  ...
  function Pr(g) {
    return g == null ? g === void 0 ? y : b : Nt && Nt in Object(g) ? Kd(g) : rp(g);
  }
  function ro(g) {
    return kr(g) && Pr(g) == o;
  }
  function no(g, E, C, F, ne) {
    return g === E ? !0 : g == null || E == null || !kr(g) && !kr(E) ? g !== g && E !== E : Hd(g, E, C, F, no, ne);
  }
  function Hd(g, E, C, F, ne, H) {
    ...
    if (be && !Be)
      return H || (H = new mt()), ce || uo(g) ? io(g, E, C, F, ne, H) : Vd(g, E, Ee, C, F, ne, H);
    if (!(C & i)) {
      var He = Be && tt.call(g, "__wrapped__"), qe = Ve && tt.call(E, "__wrapped__");
      if (He || qe) {
        var yt = He ? g.value() : g, ct = qe ? E.value() : E;
        return H || (H = new mt()), ne(yt, ct, C, F, H);
      }
    }
    return be ? (H || (H = new mt()), Yd(g, E, C, F, ne, H)) : !1;
  }
  function qd(g) {
    if (!co(g) || ep(g))
      return !1;
  ...
  function Vd(g, E, C, F, ne, H, ce) {
    switch (C) {
      ...
      case ue:
        var Ee = F & i;
        if (me || (me = ld), g.size != E.size && !Ee)
          return !1;
        var ae = ce.get(g);
        if (ae)
          return ae == E;
        F |= a, ce.set(g, E);
        var Be = io(me(g), me(E), F, ne, H, ce);
  ...
  function Yd(g, E, C, F, ne, H) {
    ...
    for (var yt = ce; ++Ve < Ee; ) {
      ...
      var ct = g[be], Ut = E[be];
      if (F)
        var fo = ce ? F(Ut, ct, be, E, g, H) : F(ct, Ut, be, g, E, H);
      if (!(fo === void 0 ? ct === Ut || ne(ct, Ut, C, F, H) : fo)) {
        qe = !1;
        break;
      }
  ...
  function Rn(g, E) {
    var C = g.__data__;
    return Zd(E) ? C[typeof E == "string" ? "string" : "hash"] : C.map;
  }
  function rr(g, E) {
    var C = Rr(g, E);
...
var xn = {}, Xe = {}, XE = "[object Symbol]", Af = /[\\^$.*+?()[\]{}|]/g, WE = RegExp(Af.source), VE = typeof Oe == "object" && Oe && Oe.Object === Object && Oe, YE = typeof self == "object" && self && self.Object === Object && self, KE = VE || YE || Function("return this")(), JE = Object.prototype, QE = JE.toString, Cl = KE.Symbol, Rl = Cl ? Cl.prototype : void 0, Ol = Rl ? Rl.toString : void 0;
function ZE(e) {
  if (typeof e == "string")
    return e;
  if (tv(e))
...
function nv(e) {
  return e = rv(e), e && WE.test(e) ? e.replace(Af, "\\$&") : e;
}
var iv = nv;
...
const ut = xe, pr = bf, gv = _r, hr = Xe, es = pe, Ca = /\/tag\/([^/]+)$/;
class Rf extends es.Provider {
  constructor(t, r, n) {
    super({
      ...n,
...
Mi.isUrlProbablySupportMultiRangeRequests = Df;
Mi.createClient = Cv;
...
const Ur = xe, Da = Pt, Bv = Dt, jv = Cr, zv = _r, Wn = tr, Hl = Hi, Gv = qi;
class Hv {
  ...
  async doDownloadFile(t, r) {
    ...
    await new Promise((s, o) => {
      ...
      if (!this.options.isUseMultipleRangeRequest && this.options.onProgress) {
        ...
        d = new Gv.ProgressDifferentialDownloadCallbackTransform(N, this.options.cancellationToken, this.options.onProgress), l.push(d);
      }
      ...
      T.redirect = "manual", m = (b) => {
        ...
        ue.on("redirect", (Y, Me, y) => {
          this.logger.info(`Redirect to ${qv(y)}`), x = y, (0, Ur.configureRequestUrl)(new zv.URL(x), T), ue.followRedirect();
...
const Re = xe, Vv = un, Yv = _i, Kv = _c, sr = Pt, Jv = Te, Pa = Pi, Mt = oe, Gt = bf, Xl = yn, Qv = Ui, Wl = Sf, Zv = xn, ka = Mi, eT = Sc, tT = Xe, rT = Gi, or = kt;
...
const Yl = xe, Kl = Ti, uT = Pt, fT = Dt, Mr = oe, dT = pt, pT = En, hT = pe, Jl = kt;
class mT extends dT.BaseUpdater {
  ...
  doInstall(t) {
    ...
    if (a == null)
      return this.dispatchError(new Error("No valid update available, can't quit and install")), !1;
    Mr.basename(a) === i || !/\d+\.\d+\.\d+/.test(i) ? n = r : n = Mr.join(Mr.dirname(r), Mr.basename(a)), (0, Kl.execFileSync)("mv", ["-f", a, n]), n !== r && this.emit("appimage-filename-updated", n);
    const s = {
      ...process.env,
...
const tc = xe, Na = Pt, ST = Dt, rc = oe, AT = gp, IT = At, CT = pe, nc = Ti, ic = un;
class RT extends IT.AppUpdater {
  ...
  async doDownloadUpdate(t) {
    ...
    return this.executeDownload({
      ...
      downloadUpdateOptions: t,
      task: async (u, p) => {
        const m = rc.join(this.downloadedUpdateHelper.cacheDir, c), w = () => (0, Na.pathExistsSync)(m) ? !t.disableDifferentialDownload : (n.info("Unable to locate previous update.zip for differential download (is this first install?), falling back to full download"), !1);
        let x = !0;
...
const rt = Ar("tokenizer:inflate"), $a = 256 * 1024, S_ = zf(gr.DataDescriptor), Yn = zf(gr.EndOfCentralDirectory);
class Gs {
  constructor(t) {
 ...
 * MIT Licensed
 */
var pc = /; *([!#$%&'*+.^_`|~0-9A-Za-z-]+) *= *("(?:[\u000b\u0020\u0021\u0023-\u005b\u005d-\u007e\u0080-\u00ff]|\\[\u000b\u0020-\u00ff])*"|[!#$%&'*+.^_`|~0-9A-Za-z-]+) */g, z_ = /^[\u000b\u0020-\u007e\u0080-\u00ff]+$/, Hf = /^[!#$%&'*+.^_`|~0-9A-Za-z-]+$/, G_ = /\\([\u000b\u0020-\u00ff])/g, H_ = /([\\"])/g, qf = /^[!#$%&'*+.^_`|~0-9A-Za-z-]+\/[!#$%&'*+.^_`|~0-9A-Za-z-]+$/;
Hs.format = q_;
Hs.parse = X_;
function q_(e) {
...
class Xf extends vn("CouldNotDetermineFileTypeError") {
}
class Wf extends vn("UnsupportedFileTypeError") {
}
...
class Vf extends vn("InternalParserError") {
}
...
const Ub = {
  ...
  async load() {
    return (await import("./MpegParser-CkvYKno9.js")).MpegParser;
  }
}, Mb = {
  parserType: "apev2",
  extensions: [".ape"],
  ...
  async load() {
    return (await import("./AsfParser-D8H_Ys56.js")).AsfParser;
  }
}, jb = {
  parserType: "dsdiff",
  extensions: [".dff"],
  ...
  async load() {
    return (await import("./DsdiffParser-3HvwxGUx.js")).DsdiffParser;
  }
}, zb = {
  parserType: "aiff",
  ...
  async load() {
    return (await import("./AiffParser-CbuGPDZr.js")).AIFFParser;
  }
}, Gb = {
  parserType: "dsf",
  extensions: [".dsf"],
  mimeTypes: ["audio/dsf"],
  async load() {
    return (await import("./DsfParser-P3inyUOK.js")).DsfParser;
  }
}, Hb = {
  parserType: "flac",
  extensions: [".flac"],
  ...
  async load() {
    return (await import("./FlacParser-B0IpDEKH.js").then((e) => e.d)).FlacParser;
  }
}, qb = {
  parserType: "matroska",
  ...
  async load() {
    return (await import("./MatroskaParser-e14TpZim.js")).MatroskaParser;
  }
}, Xb = {
  parserType: "mp4",
  ...
  async load() {
    return (await import("./MP4Parser-DslxQ9-r.js")).MP4Parser;
  }
}, Wb = {
  parserType: "musepack",
  extensions: [".mpc"],
  ...
  async load() {
    return (await import("./MusepackParser-8oX-98r-.js")).MusepackParser;
  }
}, Vb = {
  parserType: "ogg",
  ...
  async load() {
    return (await import("./OggParser-B1RN8PDt.js")).OggParser;
  }
}, Yb = {
  parserType: "wavpack",
  extensions: [".wv", ".wvp"],
  ...
  async load() {
    return (await import("./WavPackParser-D3guXvIa.js")).WavPackParser;
  }
}, Kb = {
  parserType: "riff",
  ...
  async load() {
    return (await import("./WaveParser-DtmU7YKr.js")).WaveParser;
  }
...
const pS = /^[\x21-\x7e©][\x20-\x7e\x00()]{3}/, td = {
  len: 4,
  get: (e, t) => {
    const r = Yi(e.subarray(t, t + td.len), "latin1");
    if (!r.match(pS))
...
const TS = Ba(import.meta.url), _S = TS("ffmpeg-static");
function bS(e) {
...
const SS = Ke.requestSingleInstanceLock();
SS ? Ke.on("second-instance", () => {
  J && (J.isMinimized() && J.restore(), J.focus());
}) : Ke.quit();
const id = Se.dirname(dp(import.meta.url));
process.env.APP_ROOT = Se.join(id, "..");
const cs = process.env.VITE_DEV_SERVER_URL, sA = Se.join(process.env.APP_ROOT, "dist-electron"), ad = Se.join(process.env.APP_ROOT, "dist");
process.env.VITE_PUBLIC = cs ? Se.join(process.env.APP_ROOT, "public") : ad;
let J;
function sd() {
  J = new vc({
    width: 1200,
    ...
    webPreferences: {
      preload: Se.join(id, "preload.mjs"),
      webSecurity: !1,
  ...
  }), cs ? J.loadURL(cs) : J.loadFile(Se.join(ad, "index.html"));
}
...
Ke.whenReady().then(() => {
  process.platform === "win32" && Ke.setAppUserModelId("NeonWave"), sd(), je.handle("dialog:openDirectory", async () => {
  ...
  const e = Ba(import.meta.url)("yt-dlp-wrap").default, t = async () => {
    const r = process.platform === "win32" ? "yt-dlp.exe" : "yt-dlp", n = Se.join(Ke.getPath("userData"), r);
    try {
      await Nr.access(n);
    } catch {
...
`).map((o) => {
    ...
    const a = Se.join(Ke.getPath("temp"), `whisper_${Date.now()}.mp3`);
    try {
...
`) : null;
  ...
  }), je.handle("app:version", () => Ke.getVersion());
});
export {
  rA as A,
  Qf as B,
