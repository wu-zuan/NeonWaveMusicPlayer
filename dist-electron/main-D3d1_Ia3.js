...
import { createRequire as Br } from "node:module";
import { fileURLToPath as xp } from "node:url";
import _e from "node:path";
import Nn, { open as Ep } from "node:fs/promises";
import Dt from "fs";
  ...
  xt.hasOwnProperty("O_SYMLINK") && process.version.match(/^v0\.6\.[0-2]|^v0\.5\./) && t(e), e.lutimes || r(e), e.chown = a(e.chown), e.fchown = a(e.fchown), e.lchown = a(e.lchown), e.chmod = n(e.chmod), e.fchmod = n(e.fchmod), e.lchmod = n(e.lchmod), e.chownSync = s(e.chownSync), e.fchownSync = s(e.fchownSync), e.lchownSync = s(e.lchownSync), e.chmodSync = i(e.chmodSync), e.fchmodSync = i(e.fchmodSync), e.lchmodSync = i(e.lchmodSync), e.stat = o(e.stat), e.fstat = o(e.fstat), e.lstat = o(e.lstat), e.statSync = l(e.statSync), e.fstatSync = l(e.fstatSync), e.lstatSync = l(e.lstatSync), e.chmod && !e.lchmod && (e.lchmod = function(c, u, p) {
    ...
    function u(p, m, x) {
      ...
      c(p, m, function _(b) {
        if (b && (b.code === "EACCES" || b.code === "EPERM" || b.code === "EBUSY") && Date.now() - w < 6e4) {
          setTimeout(function() {
            e.stat(m, function(k, F) {
              k && k.code === "ENOENT" ? c(p, m, _) : x(b);
            });
          }, T), T < 100 && (T += 10);
          return;
        }
    ...
    function u(p, m, x, w, T, _) {
      ...
      if (_ && typeof _ == "function") {
        var k = 0;
        b = function(F, U, D) {
          if (F && F.code === "EAGAIN" && k < 10)
            return k++, c.call(e, p, m, x, w, T, b);
...
function hs(e) {
  Mp(e), e.gracefulify = hs, e.createReadStream = U, e.createWriteStream = D;
  var t = e.readFile;
  e.readFile = r;
  function r(y, B, M) {
    ...
    function L(X, R, S, O) {
      return t(X, R, function(A) {
        A && (A.code === "EMFILE" || A.code === "ENFILE") ? ir([L, [X, R, S], A, O || Date.now(), Date.now()]) : typeof S == "function" && S.apply(this, arguments);
      });
    }
  }
  var n = e.writeFile;
  ...
  function i(y, B, M, L) {
    ...
    function X(R, S, O, A, $) {
      return n(R, S, O, function(P) {
        P && (P.code === "EMFILE" || P.code === "ENFILE") ? ir([X, [R, S, O, A], P, $ || Date.now(), Date.now()]) : typeof A == "function" && A.apply(this, arguments);
      });
    }
  }
  var a = e.appendFile;
  ...
  function u(y, B, M) {
    ...
    var L = c.test(process.version) ? function(S, O, A, $) {
      return d(S, X(
        S,
        O,
        A,
    ...
    function X(R, S, O, A) {
      return function($, P) {
        $ && ($.code === "EMFILE" || $.code === "ENFILE") ? ir([
          ...
          A || Date.now(),
          Date.now()
        ]) : (P && P.sort && P.sort(), typeof O == "function" && O.call(this, $, P));
      };
    }
  }
  if (process.version.substr(0, 4) === "v0.8") {
    var p = Bp(e);
    _ = p.ReadStream, k = p.WriteStream;
  }
  var m = e.ReadStream;
  m && (_.prototype = Object.create(m.prototype), _.prototype.open = b);
  var x = e.WriteStream;
  x && (k.prototype = Object.create(x.prototype), k.prototype.open = F), Object.defineProperty(e, "ReadStream", {
    get: function() {
      return _;
    },
    set: function(y) {
...
function Mc(e, t, r, n, i) {
  ...
  Er.stat(s, { bigint: !0 }, (o, l) => o ? o.code === "ENOENT" ? i() : i(o) : dn(t, l) ? i(new Error(Ii(e, r, n))) : Mc(e, t, s, n, i));
}
function Bc(e, t, r, n) {
...
const Me = $e, Vr = ue, rh = lt.mkdirs, nh = tr.pathExists, ih = Uc.utimesMillis, Yr = Sr;
function ah(e, t, r, n) {
  typeof r == "function" && !n ? (n = r, r = {}) : typeof r == "function" && (r = { filter: r }), n = n || function() {
    ...
    Yr.checkParentPaths(e, s, t, "copy", (l) => l ? n(l) : r.filter ? jc(To, o, e, t, r, n) : To(o, e, t, r, n));
  });
}
...
function mh(e, t, r, n, i, a) {
  const s = Vr.join(r, t), o = Vr.join(n, t);
  Yr.checkPaths(s, o, "copy", i, (l, d) => {
    if (l) return a(l);
    const { destStat: c } = d;
...
function gh(e, t, r, n, i) {
  Me.readlink(t, (a, s) => {
    if (a) return i(a);
    if (n.dereference && (s = Vr.resolve(process.cwd(), s)), e)
      Me.readlink(r, (o, l) => o ? o.code === "EINVAL" || o.code === "UNKNOWN" ? Me.symlink(s, r, i) : i(o) : (n.dereference && (l = Vr.resolve(process.cwd(), l)), Yr.isSrcSubdir(s, l) ? i(new Error(`Cannot copy '${s}' to a subdirectory of itself, '${l}'.`)) : e.isDirectory() && Yr.isSrcSubdir(l, s) ? i(new Error(`Cannot overwrite '${l}' with '${s}'.`)) : yh(s, r, i)));
    else
...
var wh = ah;
const Ie = $e, Kr = ue, xh = lt.mkdirsSync, Eh = Uc.utimesMillisSync, Jr = Sr;
function vh(e, t, r) {
  ...
  return Jr.checkParentPathsSync(e, n, t, "copy"), Th(i, e, t, r);
}
function Th(e, t, r, n) {
...
function Dh(e, t, r, n) {
  const i = Kr.join(t, e), a = Kr.join(r, e), { destStat: s } = Jr.checkPathsSync(i, a, "copy", n);
  return _h(s, i, a, n);
}
function kh(e, t, r, n) {
...
const bo = $e, Vc = ue, ie = Ic, Qr = process.platform === "win32";
function Yc(e) {
  [
    "unlink",
    "chmod",
    ...
    t.unlink(e, (a) => {
      if (a) {
        if (a.code === "ENOENT")
          return r(null);
        if (a.code === "EPERM")
          return Qr ? Ao(e, t, a, r) : si(e, t, a, r);
        if (a.code === "EISDIR")
          return si(e, t, a, r);
      }
      return r(a);
...
function Uh(e, t) {
  if (ie(e), ie(t), t.readdirSync(e).forEach((r) => Kc(Vc.join(e, r), t)), Qr) {
    const r = Date.now();
    do
      try {
...
const bt = ue, Hr = $e, em = tr.pathExists;
function tm(e, t, r) {
  if (bt.isAbsolute(e))
    ...
    }));
  {
    ...
    return em(i, (a, s) => a ? r(a) : s ? r(null, {
      toCwd: i,
      toDst: e
    }) : Hr.lstat(e, (o) => o ? (o.message = o.message.replace("lstat", "ensureSymlink"), r(o)) : r(null, {
      toCwd: e,
...
const Rm = Fe.fromCallback, qr = $e, mu = ue, gu = lt, Pm = tr.pathExists;
function Om(e, t, r, n) {
  typeof r == "function" && (n = r, r = "utf8");
  const i = mu.dirname(e);
  Pm(i, (a, s) => {
    if (a) return n(a);
    if (s) return qr.writeFile(e, t, r, n);
    gu.mkdirs(i, (o) => {
      if (o) return n(o);
...
function Dm(e, ...t) {
  ...
  gu.mkdirsSync(r), qr.writeFileSync(e, ...t);
}
var Ts = {
  outputFile: Rm(Om),
  outputFileSync: Dm
  ...
  function e(t) {
    ...
    function n(u) {
      ...
      function T(..._) {
        if (!T.enabled)
          return;
        const b = T, k = Number(/* @__PURE__ */ new Date()), F = k - (p || k);
        b.diff = F, b.prev = p, b.curr = k, p = k, _[0] = n.coerce(_[0]), typeof _[0] != "string" && _.unshift("%O");
        let U = 0;
...
pn.ProgressCallbackTransform = m0;
...
const g0 = fn, y0 = vu, w0 = Dt, x0 = un, Tu = br, E0 = It, Xo = Ar, v0 = pn, Fr = (0, y0.default)("electron-builder");
...
const Cu = fn, Iu = Ar, k0 = "options.name must be either a string or a Buffer", Wo = (0, Cu.randomBytes)(16);
Wo[0] = Wo[0] | 1;
const li = {}, Z = [];
for (let e = 0; e < 256; e++) {
...
function N0(e, t, r, n, i = Xr.ASCII) {
...
(function(e) {
  (function(t) {
    ...
    var u = "[CDATA[", p = "DOCTYPE", m = "http://www.w3.org/XML/1998/namespace", x = "http://www.w3.org/2000/xmlns/", w = { xml: m, xmlns: x }, T = /[:_A-Za-z\u00C0-\u00D6\u00D8-\u00F6\u00F8-\u02FF\u0370-\u037D\u037F-\u1FFF\u200C-\u200D\u2070-\u218F\u2C00-\u2FEF\u3001-\uD7FF\uF900-\uFDCF\uFDF0-\uFFFD]/, _ = /[:_A-Za-z\u00C0-\u00D6\u00D8-\u00F6\u00F8-\u02FF\u0370-\u037D\u037F-\u1FFF\u200C-\u200D\u2070-\u218F\u2C00-\u2FEF\u3001-\uD7FF\uF900-\uFDCF\uFDF0-\uFFFD\u00B7\u0300-\u036F\u203F-\u2040.\d-]/, b = /[#:_A-Za-z\u00C0-\u00D6\u00D8-\u00F6\u00F8-\u02FF\u0370-\u037D\u037F-\u1FFF\u200C-\u200D\u2070-\u218F\u2C00-\u2FEF\u3001-\uD7FF\uF900-\uFDCF\uFDF0-\uFFFD]/, k = /[#:_A-Za-z\u00C0-\u00D6\u00D8-\u00F6\u00F8-\u02FF\u0370-\u037D\u037F-\u1FFF\u200C-\u200D\u2070-\u218F\u2C00-\u2FEF\u3001-\uD7FF\uF900-\uFDCF\uFDF0-\uFFFD\u00B7\u0300-\u036F\u203F-\u2040.\d-]/;
    function F(h) {
      return h === " " || h === `
` || h === "\r" || h === "	";
    }
...
Char: ` + h.c), f = new Error(f), h.error = f, M(h, "onerror", f), h;
    ...
    function q(h) {
      ...
      if (h.opt.xmlns) {
        var f = P(h.attribName, !0), C = f.prefix, v = f.local;
        if (C === "xmlns")
...
Actual: ` + h.attribValue
    ...
    function K(h, f) {
      if (h.opt.xmlns) {
        ...
        C.ns && ee.ns !== C.ns && Object.keys(C.ns).forEach(function(Sn) {
          L(h, "onopennamespace", {
            prefix: Sn,
            uri: C.ns[Sn]
          });
        ...
        for (var se = 0, fe = h.attribList.length; se < fe; se++) {
          var ve = h.attribList[se], Ae = ve[0], mt = ve[1], he = P(Ae, !0), Ye = he.prefix, ea = he.local, bn = Ye === "" ? "" : C.ns[Ye] || "", Pr = {
            name: Ae,
            value: mt,
            prefix: Ye,
            local: ea,
...
` ? (f.line++, f.column = 0) : f.column++);
          ...
          case y.ATTRIB_VALUE_ENTITY_U:
            ...
            } else G(f.entity.length ? k : b, v) ? f.entity += v : (A(f, "Invalid character in entity name"), f[ve] += "&" + f.entity + v, f.entity = "", f.state = fe);
            continue;
          default:
...
function q0(e, t) {
  ...
  for (l = 1; l <= t.linesBefore && !(s - l < 0); l++)
    d = ya(
      ...
      u
    ), o = jr.repeat(" ", t.indent) + wa((e.line - l + 1).toString(), c) + " | " + d.str + `
` + o;
  for (d = ya(e.buffer, n[s], i[s], e.position, u), o += jr.repeat(" ", t.indent) + wa((e.line + 1).toString(), c) + " | " + d.str + `
`, o += jr.repeat("-", t.indent + c + 3 + d.pos) + `^
...
}), qt = Qe, Zu = mn, Yg = X0, Kg = Rs, Rt = Object.prototype.hasOwnProperty, gi = 1, ef = 2, tf = 3, yi = 4, Ea = 1, Jg = 2, Qo = 3, Qg = /[\x00-\x08\x0B\x0C\x0E-\x1F\x7F-\x84\x86-\x9F\uFFFE\uFFFF]|[\uD800-\uDBFF](?![\uDC00-\uDFFF])|(?:[^\uD800-\uDBFF]|^)[\uDC00-\uDFFF]/, Zg = /[\x85\u2028\u2029]/, ey = /[,\[\]\{\}]/, rf = /^(?:!|!!|![a-z\-]+!)$/i, nf = /^(?:!|[^,\[\]\{\}])(?:%[0-9a-f]{2}|[0-9a-z\-#;\/\?:@&=\+\$,_\.!~\*'\(\)\[\]])*$/i;
function Zo(e) {
...
Cs.loadAll = gy;
Cs.load = yy;
var uf = {}, Fi = Qe, gn = mn, wy = Rs, ff = Object.prototype.toString, df = Object.prototype.hasOwnProperty, Ds = 65279, xy = 9, en = 10, Ey = 13, vy = 32, Ty = 33, _y = 34, Ja = 35, by = 37, Sy = 38, Ay = 39, Cy = 42, pf = 44, Iy = 45, xi = 58, Ry = 61, Py = 62, Oy = 63, Dy = 64, hf = 91, mf = 93, ky = 96, gf = 123, Ny = 124, yf = 125, Pe = {};
Pe[0] = "\\0";
Pe[7] = "\\a";
Pe[8] = "\\b";
Pe[9] = "\\t";
...
var My = 1, tn = 2;
function By(e) {
  this.schema = e.schema || wy, this.indent = Math.max(1, e.indent || 2), this.noArrayIndent = e.noArrayIndent || !1, this.skipInvalid = e.skipInvalid || !1, this.flowLevel = Fi.isNothing(e.flowLevel) ? -1 : e.flowLevel, this.styleMap = Ly(this.schema, e.styles || null), this.sortKeys = e.sortKeys || !1, this.lineWidth = e.lineWidth || 80, this.noRefs = e.noRefs || !1, this.noCompatMode = e.noCompatMode || !1, this.condenseFlow = e.condenseFlow || !1, this.quotingType = e.quotingType === '"' ? tn : My, this.forceQuotes = e.forceQuotes || !1, this.replacer = typeof e.replacer == "function" ? e.replacer : null, this.implicitTypes = this.schema.compiledImplicit, this.explicitTypes = this.schema.compiledExplicit, this.tag = null, this.result = "", this.duplicates = [], this.usedDuplicates = null;
}
function il(e, t) {
...
function Gy(e) {
  return rn(e) && e !== Ds && !Ei(e) && e !== Iy && e !== Oy && e !== xi && e !== pf && e !== hf && e !== mf && e !== gf && e !== yf && e !== Ja && e !== Sy && e !== Cy && e !== Ty && e !== Ny && e !== Ry && e !== Py && e !== Ay && e !== _y && e !== by && e !== Dy && e !== ky;
}
function zy(e) {
  return !Ei(e) && e !== xi;
}
...
function Hy(e, t, r, n, i, a, s, o) {
  var l, d = 0, c = null, u = !1, p = !1, m = n !== -1, x = -1, w = Gy(Gr(e, 0)) && zy(Gr(e, e.length - 1));
  if (t || s)
  ...
  return !u && !p ? w && !s && !i(e) ? xf : a === tn ? fr : Za : r > 9 && wf(e) ? fr : s ? a === tn ? fr : Za : p ? vf : Ef;
}
...
function Wy(e) {
  for (var t = "", r = 0, n, i = 0; i < e.length; r >= 65536 ? i += 2 : i++)
    r = Gr(e, i), n = Pe[r], !n && rn(r) ? (t += e[i], r >= 65536 && (t += e[i + 1])) : t += n || Uy(r);
  return t;
}
function Vy(e, t, r) {
  var n = "", i = e.tag, a, s, o;
...
function ul(e, t, r, n) {
  ...
  for (s = 0, o = r.length; s < o; s += 1)
    l = r[s], e.replacer && (l = e.replacer.call(r, String(s), l)), (pt(e, t + 1, l, !0, !0, !1, !0) || typeof l > "u" && pt(e, t + 1, null, !0, !0, !1, !0)) && ((!n || i !== "") && (i += Qa(e, t)), e.dump && en === e.dump.charCodeAt(0) ? i += "-" : i += "- ", i += e.dump);
  e.tag = a, e.dump = i || "[]";
}
function Yy(e, t, r) {
...
function Ky(e, t, r, n) {
  ...
  for (o = 0, l = s.length; o < l; o += 1)
    p = "", (!n || i !== "") && (p += Qa(e, t)), d = s[o], c = r[d], e.replacer && (c = e.replacer.call(r, d, c)), pt(e, t + 1, d, !0, !0, !0) && (u = e.tag !== null && e.tag !== "?" || e.dump && e.dump.length > 1024, u && (e.dump && en === e.dump.charCodeAt(0) ? p += "?" : p += "? "), p += e.dump, u && (p += Qa(e, t)), pt(e, t + 1, c, !0, u) && (e.dump && en === e.dump.charCodeAt(0) ? p += ":" : p += ": ", p += e.dump, i += p));
  e.tag = a, e.dump = i || "{}";
}
function fl(e, t, r) {
  var n, i, a, s, o, l;
    ...
    if (o = i[a], (o.instanceOf || o.predicate) && (!o.instanceOf || typeof t == "object" && t instanceof o.instanceOf) && (!o.predicate || o.predicate(t))) {
      if (r ? o.multi && o.representName ? e.tag = o.representName(t) : e.tag = o.tag : e.tag = "?", o.represent) {
        if (l = e.styleMap[o.tag] || o.defaultStyle, ff.call(o.represent) === "[object Function]")
          ...
          throw new gn("!<" + o.tag + '> tag resolver accepts not "' + l + '" style');
        e.dump = n;
      }
      return !0;
    }
...
function pt(e, t, r, n, i, a, s) {
  ...
  if (c && (u = e.duplicates.indexOf(r), p = u !== -1), (e.tag !== null && e.tag !== "?" || p || e.indent !== 2 && t > 0) && (i = !1), p && e.usedDuplicates[u])
    ...
    if (c && p && !e.usedDuplicates[u] && (e.usedDuplicates[u] = !0), o === "[object Object]")
      ...
      throw new gn("unacceptable kind of an object to dump " + o);
    }
...
(function(e, t) {
  ...
  const p = "[a-zA-Z0-9-]", m = [
    ...
    const k = x(_), F = u++;
    a(T, F, _), c[T] = F, l[F] = _, d[F] = k, s[F] = new RegExp(_, b ? "g" : void 0), o[F] = new RegExp(k, b ? "g" : void 0);
  };
...
const Gn = Ui, { MAX_LENGTH: pl, MAX_SAFE_INTEGER: zn } = Li, { safeRe: Hn, t: qn } = yn, fw = Ns, { compareIdentifiers: va } = Sf;
let dw = class at {
  constructor(t, r) {
...
var If = hx;
const mx = Ue, gx = Ir, { safeRe: Xn, t: Wn } = yn, yx = (e, t) => {
  if (e instanceof mx)
    return e;
...
function et() {
  ...
  class t {
    ...
    parseRange(S) {
      ...
      if ($)
        return $;
      const P = this.options.loose, q = P ? l[d.HYPHENRANGELOOSE] : l[d.HYPHENRANGE];
      ...
      P && (K = K.filter((H) => (s("loose invalid filter", H, this.options), !!H.match(l[d.COMPARATORLOOSE])))), s("range list", K);
    ...
    intersects(S, O) {
      ...
      return this.set.some((A) => _(A, O) && S.set.some(($) => _($, O) && A.every((P) => $.every((q) => P.intersects(q, O)))));
    }
    ...
    test(S) {
      ...
      for (let O = 0; O < this.set.length; O++)
        if (X(this.set[O], S, this.options))
          return !0;
      return !1;
    }
  }
  ...
  const r = Ex, n = new r(), i = Ns, a = Bi(), s = Ui, o = Ue, {
    ...
    tildeTrimReplace: u,
    caretTrimReplace: p
  } = yn, { FLAG_INCLUDE_PRERELEASE: m, FLAG_LOOSE: x } = Li, w = (R) => R.value === "<0.0.0-0", T = (R) => R.value === "", _ = (R, S) => {
    let O = !0;
    const A = R.slice();
    let $ = A.pop();
    for (; O && A.length; )
      O = A.every((P) => $.intersects(P, S)), $ = A.pop();
    return O;
  }, b = (R, S) => (R = R.replace(l[d.BUILD], ""), s("comp", R, S), R = D(R, S), s("caret", R), R = F(R, S), s("tildes", R), R = Q(R, S), s("xrange", R), R = B(R, S), s("stars", R), R), k = (R) => !R || R.toLowerCase() === "x" || R === "*", F = (R, S) => R.trim().split(/\s+/).map((O) => U(O, S)).join(" "), U = (R, S) => {
    const O = S.loose ? l[d.TILDELOOSE] : l[d.TILDE];
    return R.replace(O, (A, $, P, q, K) => {
      s("tilde", R, A, $, P, q, K);
      let W;
      return k($) ? W = "" : k(P) ? W = `>=${$}.0.0 <${+$ + 1}.0.0-0` : k(q) ? W = `>=${$}.${P}.0 <${$}.${+P + 1}.0-0` : K ? (s("replaceTilde pr", K), W = `>=${$}.${P}.${q}-${K} <${$}.${+P + 1}.0-0`) : W = `>=${$}.${P}.${q} <${$}.${+P + 1}.0-0`, s("tilde return", W), W;
    });
  }, D = (R, S) => R.trim().split(/\s+/).map((O) => G(O, S)).join(" "), G = (R, S) => {
    s("caret", R, S);
    const O = S.loose ? l[d.CARETLOOSE] : l[d.CARET], A = S.includePrerelease ? "-0" : "";
    return R.replace(O, ($, P, q, K, W) => {
      s("caret", R, $, P, q, K, W);
      let ne;
      return k(P) ? ne = "" : k(q) ? ne = `>=${P}.0.0${A} <${+P + 1}.0.0-0` : k(K) ? P === "0" ? ne = `>=${P}.${q}.0${A} <${P}.${+q + 1}.0-0` : ne = `>=${P}.${q}.0${A} <${+P + 1}.0.0-0` : W ? (s("replaceCaret pr", W), P === "0" ? q === "0" ? ne = `>=${P}.${q}.${K}-${W} <${P}.${q}.${+K + 1}-0` : ne = `>=${P}.${q}.${K}-${W} <${P}.${+q + 1}.0-0` : ne = `>=${P}.${q}.${K}-${W} <${+P + 1}.0.0-0`) : (s("no pr"), P === "0" ? q === "0" ? ne = `>=${P}.${q}.${K}${A} <${P}.${q}.${+K + 1}-0` : ne = `>=${P}.${q}.${K}${A} <${P}.${+q + 1}.0-0` : ne = `>=${P}.${q}.${K} <${+P + 1}.0.0-0`), s("caret return", ne), ne;
    });
  }, Q = (R, S) => (s("replaceXRanges", R, S), R.split(/\s+/).map((O) => y(O, S)).join(" ")), y = (R, S) => {
    R = R.trim();
    const O = S.loose ? l[d.XRANGELOOSE] : l[d.XRANGE];
    return R.replace(O, (A, $, P, q, K, W) => {
      s("xRange", R, A, $, P, q, K, W);
      const ne = k(P), ge = ne || k(q), H = ge || k(K), tt = H;
      return $ === "=" && tt && ($ = ""), W = S.includePrerelease ? "-0" : "", ne ? $ === ">" || $ === "<" ? A = "<0.0.0-0" : A = "*" : $ && tt ? (ge && (q = 0), K = 0, $ === ">" ? ($ = ">=", ge ? (P = +P + 1, q = 0, K = 0) : (q = +q + 1, K = 0)) : $ === "<=" && ($ = "<", ge ? P = +P + 1 : q = +q + 1), $ === "<" && (W = "-0"), A = `${$ + P}.${q}.${K}${W}`) : ge ? A = `>=${P}.0.0${W} <${+P + 1}.0.0-0` : H && (A = `>=${P}.${q}.0${W} <${P}.${+q + 1}.0-0`), s("xRange return", A), A;
    });
  }, B = (R, S) => (s("replaceStars", R, S), R.trim().replace(l[d.STAR], "")), M = (R, S) => (s("replaceGTE0", R, S), R.trim().replace(l[S.includePrerelease ? d.GTE0PRE : d.GTE0], "")), L = (R) => (S, O, A, $, P, q, K, W, ne, ge, H, tt) => (k(A) ? O = "" : k($) ? O = `>=${A}.0.0${R ? "-0" : ""}` : k(P) ? O = `>=${A}.${$}.0${R ? "-0" : ""}` : q ? O = `>=${O}` : O = `>=${O}${R ? "-0" : ""}`, k(ne) ? W = "" : k(ge) ? W = `<${+ne + 1}.0.0-0` : k(H) ? W = `<${ne}.${+ge + 1}.0-0` : tt ? W = `<=${ne}.${ge}.${H}-${tt}` : R ? W = `<${ne}.${ge}.${+H + 1}-0` : W = `<=${W}`, `${O} ${W}`.trim()), X = (R, S, O) => {
...
function Bi() {
  ...
  _a = t;
  const r = Ns, { safeRe: n, t: i } = yn, a = If, s = Ui, o = Ue, l = et();
  return _a;
}
...
var oE = iE;
const Aa = yn, Rl = Li, lE = Ue, Pl = Sf, cE = Ir, uE = gw, fE = xw, dE = vw, pE = _w, hE = Aw, mE = Rw, gE = Dw, yE = Fw, wE = Ze, xE = Mw, EE = Gw, vE = Fs, TE = Xw, _E = Yw, bE = Mi, SE = $s, AE = Af, CE = Cf, IE = Ls, RE = Us, PE = If, OE = wx, DE = Bi(), kE = et(), NE = ji, FE = Sx, $E = Rx, LE = kx, UE = $x, ME = Mx, BE = Ms, jE = Yx, GE = Qx, zE = eE, HE = nE, qE = oE;
var Pf = {
  parse: cE,
  valid: uE,
  clean: fE,
...
vi.exports;
(function(e, t) {
  var r = 200, n = "__lodash_hash_undefined__", i = 1, a = 2, s = 9007199254740991, o = "[object Arguments]", l = "[object Array]", d = "[object AsyncFunction]", c = "[object Boolean]", u = "[object Date]", p = "[object Error]", m = "[object Function]", x = "[object GeneratorFunction]", w = "[object Map]", T = "[object Number]", _ = "[object Null]", b = "[object Object]", k = "[object Promise]", F = "[object Proxy]", U = "[object RegExp]", D = "[object Set]", G = "[object String]", Q = "[object Symbol]", y = "[object Undefined]", B = "[object WeakMap]", M = "[object ArrayBuffer]", L = "[object DataView]", X = "[object Float32Array]", R = "[object Float64Array]", S = "[object Int8Array]", O = "[object Int16Array]", A = "[object Int32Array]", $ = "[object Uint8Array]", P = "[object Uint8ClampedArray]", q = "[object Uint16Array]", K = "[object Uint32Array]", W = /[\\^$.*+?()[\]{}|]/g, ne = /^\[object .+?Constructor\]$/, ge = /^(?:0|[1-9]\d*)$/, H = {};
  H[X] = H[R] = H[S] = H[O] = H[A] = H[$] = H[P] = H[q] = H[K] = !0, H[o] = H[l] = H[M] = H[c] = H[L] = H[u] = H[p] = H[m] = H[w] = H[T] = H[b] = H[U] = H[D] = H[G] = H[B] = !1;
  ...
  var gd = Array.prototype, yd = Function.prototype, An = Object.prototype, ta = f["__core-js_shared__"], Js = yd.toString, rt = An.hasOwnProperty, Qs = function() {
    var g = /[^.]+$/.exec(ta && ta.keys && ta.keys.IE_PROTO || "");
    return g ? "Symbol(src)_1." + g : "";
  }(), Zs = An.toString, wd = RegExp(
    "^" + Js.call(rt).replace(W, "\\$&").replace(/hasOwnProperty|(function).*?(?=\\\()| for .+?(?=\\\])/g, "$1.*?") + "$"
  ), eo = ee ? f.Buffer : void 0, Cn = f.Symbol, to = f.Uint8Array, ro = An.propertyIsEnumerable, xd = gd.splice, Ft = Cn ? Cn.toStringTag : void 0, no = Object.getOwnPropertySymbols, Ed = eo ? eo.isBuffer : void 0, vd = hd(Object.keys, Object), ra = nr(f, "DataView"), Or = nr(f, "Map"), na = nr(f, "Promise"), ia = nr(f, "Set"), aa = nr(f, "WeakMap"), Dr = nr(Object, "create"), Td = Ut(ra), _d = Ut(Or), bd = Ut(na), Sd = Ut(ia), Ad = Ut(aa), io = Cn ? Cn.prototype : void 0, sa = io ? io.valueOf : void 0;
  function $t(g) {
  ...
  In.prototype.add = In.prototype.push = Gd, In.prototype.has = zd;
  function gt(g) {
  ...
  function Yd(g, E) {
    var I = On(g), j = !I && up(g), oe = !I && !j && oa(g), Y = !I && !j && !oe && ho(g), de = I || j || oe || Y, ye = de ? Ye(g.length, String) : [], Te = ye.length;
    for (var le in g)
  ...
  function Jd(g, E, I, j, oe, Y) {
    var de = On(g), ye = On(E), Te = de ? l : yt(g), le = ye ? l : yt(E);
  ...
  function oo(g, E, I, j, oe, Y) {
    ...
    if (le && Y.get(E))
      return le == E;
    var je = -1, Ke = !0, Ce = I & a ? new In() : void 0;
    for (Y.set(g, E), Y.set(E, g); ++je < ye; ) {
      ...
      if (Ce) {
        if (!he(E, function(ut, Mt) {
          if (!bn(Ce, Mt) && (He === ut || oe(He, ut, I, j, Y)))
            return Ce.push(Mt);
        })) {
          Ke = !1;
          break;
  ...
  function rp(g, E, I, j, oe, Y) {
    ...
    if (qe && !wt) {
      var Dn = g.constructor, kn = E.constructor;
      Dn != kn && "constructor" in g && "constructor" in E && !(typeof Dn == "function" && Dn instanceof Dn && typeof kn == "function" && kn instanceof kn) && (qe = !1);
    }
  ...
  (ra && yt(new ra(new ArrayBuffer(1))) != L || Or && yt(new Or()) != w || na && yt(na.resolve()) != k || ia && yt(new ia()) != D || aa && yt(new aa()) != B) && (yt = function(g) {
  ...
  function lp(g) {
    var E = g && g.constructor, I = typeof E == "function" && E.prototype || An;
    return g === I;
  }
  function cp(g) {
    return Zs.call(g);
...
wn.createTempUpdateFile = JE;
const WE = fn, VE = Dt, Ol = XE, zt = kt, Wr = ue;
class YE {
  constructor(t) {
  ...
  async getValidCachedUpdateFile(t, r) {
    ...
    const o = Wr.join(this.cacheDirForPendingUpdate, a.fileName);
...
async function JE(e, t, r) {
  ...
  for (let a = 0; a < 3; a++)
    try {
      ...
      if (s.code === "ENOENT")
        return i;
      r.warn(`Error on remove temp update file: ${s}`), i = Wr.join(t, `${n++}-${e}`);
    }
  return i;
}
var Gi = {}, Gs = {};
...
var xn = {}, Ve = {}, rv = "[object Symbol]", Df = /[\\^$.*+?()[\]{}|]/g, nv = RegExp(Df.source), iv = typeof De == "object" && De && De.Object === Object && De, av = typeof self == "object" && self && self.Object === Object && self, sv = iv || av || Function("return this")(), ov = Object.prototype, lv = ov.toString, kl = sv.Symbol, Nl = kl ? kl.prototype : void 0, Fl = Nl ? Nl.toString : void 0;
function cv(e) {
  if (typeof e == "string")
    return e;
  if (fv(e))
      ...
      if (this.updater.allowPrerelease) {
        ...
        if (T === null)
          ...
          for (const _ of l.getElements("entry")) {
            ...
            if (b === null)
              continue;
            const k = b[1], F = ((n = hr.prerelease(k)) === null || n === void 0 ? void 0 : n[0]) || null, U = !T || ["alpha", "beta"].includes(T), D = F !== null && !["alpha", "beta"].includes(String(F));
            if (U && !D && !(T === "beta" && F === "alpha")) {
              c = k;
              break;
            }
            if (F && F === T) {
...
zi.createClient = Uv;
const Vn = Ee, Nv = Hi, zl = xn, Fv = Ot, $v = qi, Lv = Xi;
function Lf(e) {
...
Rr.copyData = Uf;
const Yn = Ee, Gv = Dt, zv = un, Hv = rr, Xl = Buffer.from(`\r
\r
`);
var vt;
(function(e) {
...
const Ur = Ee, Fa = kt, Kv = Dt, Jv = Rr, Qv = br, Kn = rr, Yl = Vi, Zv = Yi;
class eT {
  ...
  async doDownloadFile(t, r) {
    ...
    await new Promise((s, o) => {
      ...
      if (!this.options.isUseMultipleRangeRequest && this.options.onProgress) {
        ...
        d = new Zv.ProgressDifferentialDownloadCallbackTransform(k, this.options.cancellationToken, this.options.onProgress), l.push(d);
      }
      ...
      T.redirect = "manual", m = (_) => {
        ...
        T.headers.range = U, (k = (b = this.logger) === null || b === void 0 ? void 0 : b.debug) === null || k === void 0 || k.call(b, `download range: ${U}`), d && d.beginRangeDownload();
        const D = this.httpExecutor.createRequest(T, (G) => {
        ...
        D.on("redirect", (G, Q, y) => {
          this.logger.info(`Redirect to ${tT(y)}`), w = y, (0, Ur.configureRequestUrl)(new Qv.URL(w), T), D.followRedirect();
...
const Oe = Ee, iT = fn, aT = Ci, sT = Rc, or = kt, oT = Se, $a = $i, Bt = ue, Ht = Pf, Jl = wn, lT = Gi, Ql = Of, cT = xn, La = zi, uT = Oc, fT = Ve, dT = Wi, lr = Nt;
...
vn.FileWithEmbeddedBlockMapDifferentialDownloader = wT;
function Bf(e) {
...
const ec = Ee, tc = Ai, ET = kt, vT = Dt, Mr = ue, TT = ht, _T = vn, bT = me, rc = Nt;
...
const sc = Ee, Ua = kt, FT = Dt, oc = ue, $T = _p, LT = Ct, UT = me, lc = Ai, cc = fn;
    ...
    return await new Promise((d, c) => {
      ...
      this.server.on("request", (x, w) => {
        ...
        if (s.info(`${T} requested`), T === "/") {
          ...
          const k = x.headers.authorization.split(" ")[1], F = Buffer.from(k, "base64").toString("ascii"), [U, D] = F.split(":");
          if (U !== "autoupdater" || D !== u) {
        ...
        b.on("error", (k) => {
          ...
          _ = !0, this.nativeUpdater.removeListener("error", c), c(new Error(`Cannot pipe "${i}": ${k}`));
        }), w.writeHead(200, {
...
const Jn = Ee, dc = ue, HT = ht, qT = vn, pc = Nt, XT = me, WT = kt, VT = Hs, hc = br;
...
class Qf extends Tn("CouldNotDetermineFileTypeError") {
}
class Zf extends Tn("UnsupportedFileTypeError") {
}
class fb extends Tn("UnexpectedFileContentError") {
  constructor(t, r) {
...
class Vs extends Tn("FieldDecodingError") {
}
class ed extends Tn("InternalParserError") {
}
...
const Vb = {
  ...
  async load() {
    return (await import("./MpegParser-tmb5pUc1.js")).MpegParser;
  }
}, Yb = {
  parserType: "apev2",
  extensions: [".ape"],
  ...
  async load() {
    return (await import("./AsfParser-DHbx2YeF.js")).AsfParser;
  }
}, Jb = {
  parserType: "dsdiff",
  extensions: [".dff"],
  ...
  async load() {
    return (await import("./DsdiffParser-BYBgdu34.js")).DsdiffParser;
  }
}, Qb = {
  parserType: "aiff",
  ...
  async load() {
    return (await import("./AiffParser-BKEN0YqJ.js")).AIFFParser;
  }
}, Zb = {
  parserType: "dsf",
  extensions: [".dsf"],
  mimeTypes: ["audio/dsf"],
  async load() {
    return (await import("./DsfParser-BDJ4dlRL.js")).DsfParser;
  }
}, eS = {
  parserType: "flac",
  extensions: [".flac"],
  ...
  async load() {
    return (await import("./FlacParser-Pt-fnZgr.js").then((e) => e.d)).FlacParser;
  }
}, tS = {
  parserType: "matroska",
  ...
  async load() {
    return (await import("./MatroskaParser-C69vJ8yu.js")).MatroskaParser;
  }
}, rS = {
  parserType: "mp4",
  ...
  async load() {
    return (await import("./MP4Parser-B-Z375U8.js")).MP4Parser;
  }
}, nS = {
  parserType: "musepack",
  extensions: [".mpc"],
  ...
  async load() {
    return (await import("./MusepackParser-Dkj8oOdo.js")).MusepackParser;
  }
}, iS = {
  parserType: "ogg",
  ...
  async load() {
    return (await import("./OggParser-Dm_T48zx.js")).OggParser;
  }
}, aS = {
  parserType: "wavpack",
  extensions: [".wv", ".wvp"],
  ...
  async load() {
    return (await import("./WavPackParser-ByikK2-_.js")).WavPackParser;
  }
}, sS = {
  parserType: "riff",
  ...
  async load() {
    return (await import("./WaveParser-B1eV7av_.js")).WaveParser;
  }
...
We.whenReady().then(() => {
  ...
  const t = Br(import.meta.url)("yt-dlp-wrap").default, r = async () => {
...
`), U = [], D = /\[(\d{2}):(\d{2}\.\d{2})\]\s*(.*)/;
    ...
    try {
      const l = await n(), d = Br(import.meta.url)("ffmpeg-static").replace("app.asar", "app.asar.unpacked");
  ...
  }), re.handle("download:youtubeToDir", async (i, a, s, o, l) => {
    try {
      const d = await n(), c = Br(import.meta.url)("ffmpeg-static").replace("app.asar", "app.asar.unpacked");
      let u = s.replace(/[\\/:*?"<>|]/g, "_").trim();
      const p = _e.join(l, `${u}.m4a`);
      return new Promise((m, x) => {
        ...
        o && (w.push("--parse-metadata", `${o}:%(artist)s`), w.push("--parse-metadata", `${o}:%(album_artist)s`)), s && w.push("--parse-metadata", `${s}:%(title)s`);
        const T = d.exec(w);
        T.on("error", (_) => {
          console.error("yt-dlp error:", _), x(new Error(`下載錯誤: ${_.message}`));
        }), T.on("close", () => {
          m(p);
        });
      });
    } catch (d) {
      throw console.error("Download fatal error:", d), new Error(d.message);
    }
    ...
    try {
      const d = Br(import.meta.url)("get-artist-title");
      ...
      const c = (U) => {
        ...
        const G = [
          ...
          const S = (A) => "\\" + A, O = new RegExp(`${S(X)}([^${S(R)}]*)?${S(R)}`, "gi");
          return L.replace(O, (A, $) => !$ || Q($) ? " " : " " + $ + " ");
        };
        return D = y(D, "(", ")"), D = y(D, "（", "）"), D = y(D, "[", "]"), D = y(D, "【", "】"), D = y(D, "{", "}"), D = y(D, "《", "》"), [
          ...
          /^[a-z0-9]+$/i.test(L) ? D = D.replace(new RegExp(`\\b${L}\\b`, "gi"), " ") : D = D.replace(new RegExp(L, "gi"), " ");
        }), D = D.replace(/[:"'_\|\.,!@#$%^&*+=?\/\\♪♫~`\-]/g, " "), D.replace(/\s+/g, " ").trim();
      }, u = (U, D) => D ? Math.abs(U - D) : 0, p = async (U, D) => {
        try {
        ...
        try {
          ...
          let B = y.result.songs.map((S) => {
            ...
            return {
              ...
              // ms to s
              diff: D ? u(S.duration / 1e3, D) : 0
            };
          });
          if (D && (B = B.filter((S) => S.diff <= 5), B.sort((S, O) => S.diff - O.diff)), B.length === 0) return [];
      ...
      if (o) {
        ...
        const D = U.match(/(.+?)《(.+?)》(.*)/);
        if (D) {
          const y = D[1], B = D[2], M = c(y).replace(/合唱/g, "").trim(), L = c(B);
          if (L) {
            const X = `${L} ${M}`;
      ...
      w.forEach((U) => {
        const D = `${U.source}-${U.id}`;
        b.has(D) || b.set(D, U);
      });
      let k = Array.from(b.values());
      if (l && l > 0) {
        const U = k.filter((D) => D.diff <= 4);
        if (U.length > 0)
          console.log(`[Lyrics] Calibration: Found ${U.length} strict duration matches.`), k = U;
        else {
          const D = k.filter((G) => G.diff <= 10);
          D.length > 0 ? (console.log(`[Lyrics] Calibration: Found ${D.length} lenient duration matches.`), k = D) : console.log(`[Lyrics] Calibration: No duration matches found. Closest is ${Math.min(...k.map((G) => G.diff))}s off.`);
        }
      }
      k.sort((U, D) => Math.abs(U.diff - D.diff) > 0.5 ? U.diff - D.diff : 0);
      const F = k[0];
